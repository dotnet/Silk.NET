...
/// <summary>Provides validation of the <see cref = "SDL_MessageBoxData"/> struct.</summary>
public static unsafe partial class SDL_MessageBoxDataTests
{
    /// <summary>Validates that the <see cref = "SDL_MessageBoxData"/> struct is blittable.</summary>
    ...
    /// <summary>Validates that the <see cref = "SDL_MessageBoxData"/> struct has the correct size.</summary>
