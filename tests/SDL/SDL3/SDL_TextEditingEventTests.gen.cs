...
public static unsafe partial class SDL_TextEditingEventTests
{
    ...
    {
        Assert.That(Marshal.SizeOf<SDL_TextEditingEvent>(), Is.EqualTo(sizeof(TextEditingEvent)));
    }
    ...
    {
        Assert.That(typeof(TextEditingEvent).IsLayoutSequential, Is.True);
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(sizeof(TextEditingEvent), Is.EqualTo(40));
        }
        else
        {
            Assert.That(sizeof(TextEditingEvent), Is.EqualTo(32));
        }
    }
}
