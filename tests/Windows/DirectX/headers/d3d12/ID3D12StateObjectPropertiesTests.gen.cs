...
public static unsafe partial class ID3D12StateObjectPropertiesTests
{
    ...
    {
        Assert.That(
            typeof(ID3D12StateObjectProperties).GUID,
            Is.EqualTo(IID_ID3D12StateObjectProperties)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12StateObjectProperties>(),
            Is.EqualTo(sizeof(ID3D12StateObjectProperties))
        );
    }
