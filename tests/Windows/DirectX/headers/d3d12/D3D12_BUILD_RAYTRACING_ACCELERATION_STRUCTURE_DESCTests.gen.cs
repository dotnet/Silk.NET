...
public static unsafe partial class D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESCTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC>(),
            Is.EqualTo(sizeof(D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC).IsLayoutSequential,
            Is.True
        );
    }
