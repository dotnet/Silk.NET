...
public static unsafe partial class ID3D12ProtectedResourceSession1Tests
{
    ...
    {
        Assert.That(
            typeof(ID3D12ProtectedResourceSession1).GUID,
            Is.EqualTo(IID_ID3D12ProtectedResourceSession1)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12ProtectedResourceSession1>(),
            Is.EqualTo(sizeof(ID3D12ProtectedResourceSession1))
        );
    }
