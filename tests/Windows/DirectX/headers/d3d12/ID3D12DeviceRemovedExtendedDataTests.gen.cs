...
public static unsafe partial class ID3D12DeviceRemovedExtendedDataTests
{
    ...
    {
        Assert.That(
            typeof(ID3D12DeviceRemovedExtendedData).GUID,
            Is.EqualTo(IID_ID3D12DeviceRemovedExtendedData)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12DeviceRemovedExtendedData>(),
            Is.EqualTo(sizeof(ID3D12DeviceRemovedExtendedData))
        );
    }
