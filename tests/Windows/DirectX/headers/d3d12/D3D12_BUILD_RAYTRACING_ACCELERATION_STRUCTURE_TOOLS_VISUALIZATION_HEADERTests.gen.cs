...
public static unsafe partial class D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_TOOLS_VISUALIZATION_HEADERTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_TOOLS_VISUALIZATION_HEADER>(),
            Is.EqualTo(
    ...
    {
        Assert.That(
            typeof(D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_TOOLS_VISUALIZATION_HEADER).IsLayoutSequential,
            Is.True
        );
    }
