...
public static unsafe partial class D3D12_DEBUG_COMMAND_LIST_GPU_BASED_VALIDATION_SETTINGSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_DEBUG_COMMAND_LIST_GPU_BASED_VALIDATION_SETTINGS>(),
            Is.EqualTo(sizeof(D3D12_DEBUG_COMMAND_LIST_GPU_BASED_VALIDATION_SETTINGS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_DEBUG_COMMAND_LIST_GPU_BASED_VALIDATION_SETTINGS).IsLayoutSequential,
            Is.True
        );
    }
