...
public static unsafe partial class D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS),
                Is.EqualTo(56)
            );
        }
        else
