...
public static unsafe partial class D3D12_VIDEO_ENCODER_REFERENCE_PICTURE_DESCRIPTOR_HEVCTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_REFERENCE_PICTURE_DESCRIPTOR_HEVC>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_REFERENCE_PICTURE_DESCRIPTOR_HEVC))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_REFERENCE_PICTURE_DESCRIPTOR_HEVC).IsLayoutSequential,
            Is.True
        );
    }
