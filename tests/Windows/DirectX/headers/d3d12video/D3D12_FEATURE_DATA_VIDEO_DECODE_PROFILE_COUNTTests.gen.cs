...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_DECODE_PROFILE_COUNTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_DECODE_PROFILE_COUNT>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_DECODE_PROFILE_COUNT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_DECODE_PROFILE_COUNT).IsLayoutSequential,
            Is.True
        );
    }
