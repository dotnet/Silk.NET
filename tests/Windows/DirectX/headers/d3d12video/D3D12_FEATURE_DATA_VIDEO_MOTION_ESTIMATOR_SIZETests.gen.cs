...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_MOTION_ESTIMATOR_SIZETests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_MOTION_ESTIMATOR_SIZE>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_MOTION_ESTIMATOR_SIZE))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_MOTION_ESTIMATOR_SIZE).IsLayoutSequential,
            Is.True
        );
    }
