...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMAND_SUPPORTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMAND_SUPPORT>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMAND_SUPPORT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMAND_SUPPORT).IsLayoutSequential,
            Is.True
        );
    }
