...
public static unsafe partial class D3D12_VIDEO_ENCODER_FRAME_SUBREGION_METADATATests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_FRAME_SUBREGION_METADATA>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_FRAME_SUBREGION_METADATA))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_FRAME_SUBREGION_METADATA).IsLayoutSequential,
            Is.True
        );
    }
