...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_ENCODER_OUTPUT_RESOLUTIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_ENCODER_OUTPUT_RESOLUTION>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_OUTPUT_RESOLUTION))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_OUTPUT_RESOLUTION).IsLayoutSequential,
            Is.True
        );
    }
