...
public static unsafe partial class D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVCTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_CODEC_PICTURE_CONTROL_SUPPORT_HEVC).IsLayoutSequential,
            Is.True
        );
    }
