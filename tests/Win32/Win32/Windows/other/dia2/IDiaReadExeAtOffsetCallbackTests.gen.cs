...
public static unsafe partial class IDiaReadExeAtOffsetCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IDiaReadExeAtOffsetCallback).GUID,
            Is.EqualTo(IID_IDiaReadExeAtOffsetCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDiaReadExeAtOffsetCallback>(),
            Is.EqualTo(sizeof(IDiaReadExeAtOffsetCallback))
        );
    }
