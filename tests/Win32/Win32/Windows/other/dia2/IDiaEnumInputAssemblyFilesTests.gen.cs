...
public static unsafe partial class IDiaEnumInputAssemblyFilesTests
{
    ...
    {
        Assert.That(
            typeof(IDiaEnumInputAssemblyFiles).GUID,
            Is.EqualTo(IID_IDiaEnumInputAssemblyFiles)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDiaEnumInputAssemblyFiles>(),
            Is.EqualTo(sizeof(IDiaEnumInputAssemblyFiles))
        );
    }
