...
public static unsafe partial class TRANSACTION_NOTIFICATION_SAVEPOINT_ARGUMENTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<TRANSACTION_NOTIFICATION_SAVEPOINT_ARGUMENT>(),
            Is.EqualTo(sizeof(TRANSACTION_NOTIFICATION_SAVEPOINT_ARGUMENT))
        );
    }
    ...
    {
        Assert.That(
            typeof(TRANSACTION_NOTIFICATION_SAVEPOINT_ARGUMENT).IsLayoutSequential,
            Is.True
        );
    }
