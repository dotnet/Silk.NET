...
public static unsafe partial class KSDATAFORMAT_SUBTYPE_PCMTests
{
    ...
    {
        Assert.That(
            typeof(KSDATAFORMAT_SUBTYPE_PCM).GUID,
            Is.EqualTo(IID_KSDATAFORMAT_SUBTYPE_PCM)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<KSDATAFORMAT_SUBTYPE_PCM>(),
            Is.EqualTo(sizeof(KSDATAFORMAT_SUBTYPE_PCM))
        );
    }
