...
public static unsafe partial class KSDATAFORMAT_SUBTYPE_IEEE_FLOATTests
{
    ...
    {
        Assert.That(
            typeof(KSDATAFORMAT_SUBTYPE_IEEE_FLOAT).GUID,
            Is.EqualTo(IID_KSDATAFORMAT_SUBTYPE_IEEE_FLOAT)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<KSDATAFORMAT_SUBTYPE_IEEE_FLOAT>(),
            Is.EqualTo(sizeof(KSDATAFORMAT_SUBTYPE_IEEE_FLOAT))
        );
    }
