...
public static unsafe partial class PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICYTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY>(),
            Is.EqualTo(sizeof(PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY))
        );
    }
    ...
    {
        Assert.That(
            typeof(PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY).IsLayoutSequential,
            Is.True
        );
    }
