...
public static unsafe partial class PROCESS_MITIGATION_SYSTEM_CALL_FILTER_POLICYTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<PROCESS_MITIGATION_SYSTEM_CALL_FILTER_POLICY>(),
            Is.EqualTo(sizeof(PROCESS_MITIGATION_SYSTEM_CALL_FILTER_POLICY))
        );
    }
    ...
    {
        Assert.That(
            typeof(PROCESS_MITIGATION_SYSTEM_CALL_FILTER_POLICY).IsLayoutSequential,
            Is.True
        );
    }
