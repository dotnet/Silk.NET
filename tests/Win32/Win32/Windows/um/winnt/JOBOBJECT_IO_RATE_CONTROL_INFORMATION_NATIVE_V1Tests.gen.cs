...
public static unsafe partial class JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V1Tests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V1>(),
            Is.EqualTo(sizeof(JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V1))
        );
    }
    ...
    {
        Assert.That(
            typeof(JOBOBJECT_IO_RATE_CONTROL_INFORMATION_NATIVE_V1).IsLayoutSequential,
            Is.True
        );
    }
