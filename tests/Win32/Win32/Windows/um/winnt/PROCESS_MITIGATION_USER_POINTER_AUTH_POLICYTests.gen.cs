...
public static unsafe partial class PROCESS_MITIGATION_USER_POINTER_AUTH_POLICYTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<PROCESS_MITIGATION_USER_POINTER_AUTH_POLICY>(),
            Is.EqualTo(sizeof(PROCESS_MITIGATION_USER_POINTER_AUTH_POLICY))
        );
    }
    ...
    {
        Assert.That(
            typeof(PROCESS_MITIGATION_USER_POINTER_AUTH_POLICY).IsLayoutSequential,
            Is.True
        );
    }
