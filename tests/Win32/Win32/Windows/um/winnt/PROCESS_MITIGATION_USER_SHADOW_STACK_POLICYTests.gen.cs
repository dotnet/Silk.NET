...
public static unsafe partial class PROCESS_MITIGATION_USER_SHADOW_STACK_POLICYTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<PROCESS_MITIGATION_USER_SHADOW_STACK_POLICY>(),
            Is.EqualTo(sizeof(PROCESS_MITIGATION_USER_SHADOW_STACK_POLICY))
        );
    }
    ...
    {
        Assert.That(
            typeof(PROCESS_MITIGATION_USER_SHADOW_STACK_POLICY).IsLayoutSequential,
            Is.True
        );
    }
