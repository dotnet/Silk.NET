...
public static unsafe partial class MEMORY_PARTITION_DEDICATED_MEMORY_INFORMATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<MEMORY_PARTITION_DEDICATED_MEMORY_INFORMATION>(),
            Is.EqualTo(sizeof(MEMORY_PARTITION_DEDICATED_MEMORY_INFORMATION))
        );
    }
    ...
    {
        Assert.That(
            typeof(MEMORY_PARTITION_DEDICATED_MEMORY_INFORMATION).IsLayoutSequential,
            Is.True
        );
    }
