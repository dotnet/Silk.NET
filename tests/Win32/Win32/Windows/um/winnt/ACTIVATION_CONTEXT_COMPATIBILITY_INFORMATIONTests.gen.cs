...
public static unsafe partial class ACTIVATION_CONTEXT_COMPATIBILITY_INFORMATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<ACTIVATION_CONTEXT_COMPATIBILITY_INFORMATION>(),
            Is.EqualTo(sizeof(ACTIVATION_CONTEXT_COMPATIBILITY_INFORMATION))
        );
    }
    ...
    {
        Assert.That(
            typeof(ACTIVATION_CONTEXT_COMPATIBILITY_INFORMATION).IsLayoutSequential,
            Is.True
        );
    }
