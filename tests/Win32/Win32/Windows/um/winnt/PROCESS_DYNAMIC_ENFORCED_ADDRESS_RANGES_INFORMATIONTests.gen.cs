...
public static unsafe partial class PROCESS_DYNAMIC_ENFORCED_ADDRESS_RANGES_INFORMATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<PROCESS_DYNAMIC_ENFORCED_ADDRESS_RANGES_INFORMATION>(),
            Is.EqualTo(sizeof(PROCESS_DYNAMIC_ENFORCED_ADDRESS_RANGES_INFORMATION))
        );
    }
    ...
    {
        Assert.That(
            typeof(PROCESS_DYNAMIC_ENFORCED_ADDRESS_RANGES_INFORMATION).IsLayoutSequential,
            Is.True
        );
    }
