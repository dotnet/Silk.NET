...
public static unsafe partial class IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION>(),
            Is.EqualTo(sizeof(IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION))
        );
    }
    ...
    {
        Assert.That(
            typeof(IMAGE_INDIR_CONTROL_TRANSFER_DYNAMIC_RELOCATION).IsLayoutSequential,
            Is.True
        );
    }
