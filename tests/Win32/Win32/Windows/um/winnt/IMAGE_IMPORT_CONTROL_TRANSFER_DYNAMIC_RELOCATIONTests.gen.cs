...
public static unsafe partial class IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION>(),
            Is.EqualTo(sizeof(IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION))
        );
    }
    ...
    {
        Assert.That(
            typeof(IMAGE_IMPORT_CONTROL_TRANSFER_DYNAMIC_RELOCATION).IsLayoutSequential,
            Is.True
        );
    }
