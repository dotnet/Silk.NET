...
public static unsafe partial class IObjectWithAppUserModelIDTests
{
    ...
    {
        Assert.That(
            typeof(IObjectWithAppUserModelID).GUID,
            Is.EqualTo(IID_IObjectWithAppUserModelID)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IObjectWithAppUserModelID>(),
            Is.EqualTo(sizeof(IObjectWithAppUserModelID))
        );
    }
