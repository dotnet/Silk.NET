...
public static unsafe partial class ILaunchUIContextProviderTests
{
    ...
    {
        Assert.That(
            typeof(ILaunchUIContextProvider).GUID,
            Is.EqualTo(IID_ILaunchUIContextProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ILaunchUIContextProvider>(),
            Is.EqualTo(sizeof(ILaunchUIContextProvider))
        );
    }
