...
public static unsafe partial class IThumbnailHandlerFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IThumbnailHandlerFactory).GUID,
            Is.EqualTo(IID_IThumbnailHandlerFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IThumbnailHandlerFactory>(),
            Is.EqualTo(sizeof(IThumbnailHandlerFactory))
        );
    }
