...
public static unsafe partial class INameSpaceTreeControlFolderCapabilitiesTests
{
    ...
    {
        Assert.That(
            typeof(INameSpaceTreeControlFolderCapabilities).GUID,
            Is.EqualTo(IID_INameSpaceTreeControlFolderCapabilities)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<INameSpaceTreeControlFolderCapabilities>(),
            Is.EqualTo(sizeof(INameSpaceTreeControlFolderCapabilities))
        );
    }
