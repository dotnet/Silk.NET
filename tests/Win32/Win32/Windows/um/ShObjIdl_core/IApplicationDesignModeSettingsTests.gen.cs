...
public static unsafe partial class IApplicationDesignModeSettingsTests
{
    ...
    {
        Assert.That(
            typeof(IApplicationDesignModeSettings).GUID,
            Is.EqualTo(IID_IApplicationDesignModeSettings)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IApplicationDesignModeSettings>(),
            Is.EqualTo(sizeof(IApplicationDesignModeSettings))
        );
    }
