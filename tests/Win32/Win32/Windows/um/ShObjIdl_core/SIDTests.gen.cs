...
public static unsafe partial class SIDTests
{
    ...
    public static void SID_URLExecutionContextTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xFB5F8EBC, 0xBBB6, 0x4D10, 0xA4, 0x61, 0x77, 0x72, 0x91, 0xA0, 0x90, 0x30)
            )
        );
    }
    ...
    public static void SID_LaunchSourceViewSizePreferenceTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x80605492, 0x67d9, 0x414f, 0xaf, 0x89, 0xa1, 0xcd, 0xf1, 0x24, 0x2b, 0xc1)
            )
        );
    }
    ...
    public static void SID_LaunchTargetViewSizePreferenceTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x26db2472, 0xb7b7, 0x406b, 0x97, 0x2, 0x73, 0xa, 0x4e, 0x20, 0xd3, 0xbf)
            )
        );
    }
    ...
    public static void SID_LaunchSourceAppUserModelIdTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x2ce78010, 0x74db, 0x48bc, 0x9c, 0x6a, 0x10, 0xf3, 0x72, 0x49, 0x57, 0x23)
            )
        );
    }
    ...
    public static void SID_ShellExecuteNamedPropertyStoreTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xeb84ada2, 0x00ff, 0x4992, 0x83, 0x24, 0xed, 0x5c, 0xe0, 0x61, 0xcb, 0x29)
            )
        );
    }
}
