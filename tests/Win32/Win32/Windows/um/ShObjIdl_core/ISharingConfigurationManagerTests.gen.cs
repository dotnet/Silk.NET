...
public static unsafe partial class ISharingConfigurationManagerTests
{
    ...
    {
        Assert.That(
            typeof(ISharingConfigurationManager).GUID,
            Is.EqualTo(IID_ISharingConfigurationManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISharingConfigurationManager>(),
            Is.EqualTo(sizeof(ISharingConfigurationManager))
        );
    }
