...
public static unsafe partial class EnumerableObjectCollectionTests
{
    ...
    {
        Assert.That(
            typeof(EnumerableObjectCollection).GUID,
            Is.EqualTo(IID_EnumerableObjectCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<EnumerableObjectCollection>(),
            Is.EqualTo(sizeof(EnumerableObjectCollection))
        );
    }
