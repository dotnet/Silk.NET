...
public static unsafe partial class SuspensionDependencyManagerTests
{
    ...
    {
        Assert.That(
            typeof(SuspensionDependencyManager).GUID,
            Is.EqualTo(IID_SuspensionDependencyManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SuspensionDependencyManager>(),
            Is.EqualTo(sizeof(SuspensionDependencyManager))
        );
    }
