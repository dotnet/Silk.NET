...
public static unsafe partial class IInitializeNetworkFolderTests
{
    ...
    {
        Assert.That(
            typeof(IInitializeNetworkFolder).GUID,
            Is.EqualTo(IID_IInitializeNetworkFolder)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IInitializeNetworkFolder>(),
            Is.EqualTo(sizeof(IInitializeNetworkFolder))
        );
    }
