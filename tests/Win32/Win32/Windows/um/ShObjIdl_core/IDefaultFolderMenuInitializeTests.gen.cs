...
public static unsafe partial class IDefaultFolderMenuInitializeTests
{
    ...
    {
        Assert.That(
            typeof(IDefaultFolderMenuInitialize).GUID,
            Is.EqualTo(IID_IDefaultFolderMenuInitialize)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDefaultFolderMenuInitialize>(),
            Is.EqualTo(sizeof(IDefaultFolderMenuInitialize))
        );
    }
