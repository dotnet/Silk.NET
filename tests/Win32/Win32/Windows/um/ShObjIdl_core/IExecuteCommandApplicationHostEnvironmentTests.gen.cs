...
public static unsafe partial class IExecuteCommandApplicationHostEnvironmentTests
{
    ...
    {
        Assert.That(
            typeof(IExecuteCommandApplicationHostEnvironment).GUID,
            Is.EqualTo(IID_IExecuteCommandApplicationHostEnvironment)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IExecuteCommandApplicationHostEnvironment>(),
            Is.EqualTo(sizeof(IExecuteCommandApplicationHostEnvironment))
        );
    }
