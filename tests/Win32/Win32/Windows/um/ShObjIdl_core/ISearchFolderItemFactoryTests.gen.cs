...
public static unsafe partial class ISearchFolderItemFactoryTests
{
    ...
    {
        Assert.That(
            typeof(ISearchFolderItemFactory).GUID,
            Is.EqualTo(IID_ISearchFolderItemFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISearchFolderItemFactory>(),
            Is.EqualTo(sizeof(ISearchFolderItemFactory))
        );
    }
