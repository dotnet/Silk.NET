...
public static unsafe partial class IFileOperationProgressSinkTests
{
    ...
    {
        Assert.That(
            typeof(IFileOperationProgressSink).GUID,
            Is.EqualTo(IID_IFileOperationProgressSink)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IFileOperationProgressSink>(),
            Is.EqualTo(sizeof(IFileOperationProgressSink))
        );
    }
