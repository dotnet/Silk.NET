...
public static unsafe partial class SharingConfigurationManagerTests
{
    ...
    {
        Assert.That(
            typeof(SharingConfigurationManager).GUID,
            Is.EqualTo(IID_SharingConfigurationManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SharingConfigurationManager>(),
            Is.EqualTo(sizeof(SharingConfigurationManager))
        );
    }
