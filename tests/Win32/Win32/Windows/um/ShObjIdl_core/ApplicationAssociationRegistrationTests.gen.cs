...
public static unsafe partial class ApplicationAssociationRegistrationTests
{
    ...
    {
        Assert.That(
            typeof(ApplicationAssociationRegistration).GUID,
            Is.EqualTo(IID_ApplicationAssociationRegistration)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ApplicationAssociationRegistration>(),
            Is.EqualTo(sizeof(ApplicationAssociationRegistration))
        );
    }
