...
public static unsafe partial class ACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATATests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<ACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA>(),
            Is.EqualTo(sizeof(ACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA))
        );
    }
    ...
    {
        Assert.That(
            typeof(ACTCTX_SECTION_KEYED_DATA_ASSEMBLY_METADATA).IsLayoutSequential,
            Is.True
        );
    }
