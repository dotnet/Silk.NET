...
public static unsafe partial class IInputPanelConfigurationTests
{
    ...
    {
        Assert.That(
            typeof(IInputPanelConfiguration).GUID,
            Is.EqualTo(IID_IInputPanelConfiguration)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IInputPanelConfiguration>(),
            Is.EqualTo(sizeof(IInputPanelConfiguration))
        );
    }
