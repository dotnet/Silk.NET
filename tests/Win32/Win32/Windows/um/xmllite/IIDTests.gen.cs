...
public static partial class IIDTests
{
    ...
    public static void IID_IXmlReaderTest()
    {
        Assert.That(
            IID_IXmlReader,
            Is.EqualTo(
                new Guid(0x7279FC81, 0x709D, 0x4095, 0xB6, 0x3D, 0x69, 0xFE, 0x4B, 0x0D, 0x90, 0x30)
            )
        );
    }
    ...
    public static void IID_IXmlWriterTest()
    {
        Assert.That(
            IID_IXmlWriter,
            Is.EqualTo(
                new Guid(0x7279FC88, 0x709D, 0x4095, 0xB6, 0x3D, 0x69, 0xFE, 0x4B, 0x0D, 0x90, 0x30)
            )
        );
    }
    ...
    public static void IID_IXmlResolverTest()
    {
        Assert.That(
            IID_IXmlResolver,
            Is.EqualTo(
                new Guid(0x7279FC82, 0x709D, 0x4095, 0xB6, 0x3D, 0x69, 0xFE, 0x4B, 0x0D, 0x90, 0x30)
            )
        );
    }
}
