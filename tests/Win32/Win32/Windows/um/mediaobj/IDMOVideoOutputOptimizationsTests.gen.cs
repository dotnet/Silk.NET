...
public static unsafe partial class IDMOVideoOutputOptimizationsTests
{
    ...
    {
        Assert.That(
            typeof(IDMOVideoOutputOptimizations).GUID,
            Is.EqualTo(IID_IDMOVideoOutputOptimizations)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDMOVideoOutputOptimizations>(),
            Is.EqualTo(sizeof(IDMOVideoOutputOptimizations))
        );
    }
