...
public static unsafe partial class IMFMuxStreamAttributesManagerTests
{
    ...
    {
        Assert.That(
            typeof(IMFMuxStreamAttributesManager).GUID,
            Is.EqualTo(IID_IMFMuxStreamAttributesManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMuxStreamAttributesManager>(),
            Is.EqualTo(sizeof(IMFMuxStreamAttributesManager))
        );
    }
