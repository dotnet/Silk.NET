...
public static unsafe partial class IMFMuxStreamMediaTypeManagerTests
{
    ...
    {
        Assert.That(
            typeof(IMFMuxStreamMediaTypeManager).GUID,
            Is.EqualTo(IID_IMFMuxStreamMediaTypeManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMuxStreamMediaTypeManager>(),
            Is.EqualTo(sizeof(IMFMuxStreamMediaTypeManager))
        );
    }
