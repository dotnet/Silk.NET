...
public static unsafe partial class IMFMuxStreamSampleManagerTests
{
    ...
    {
        Assert.That(
            typeof(IMFMuxStreamSampleManager).GUID,
            Is.EqualTo(IID_IMFMuxStreamSampleManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMuxStreamSampleManager>(),
            Is.EqualTo(sizeof(IMFMuxStreamSampleManager))
        );
    }
