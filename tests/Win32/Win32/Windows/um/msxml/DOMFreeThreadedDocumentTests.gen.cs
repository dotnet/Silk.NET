...
public static unsafe partial class DOMFreeThreadedDocumentTests
{
    ...
    {
        Assert.That(
            typeof(DOMFreeThreadedDocument).GUID,
            Is.EqualTo(CLSID_DOMFreeThreadedDocument)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DOMFreeThreadedDocument>(),
            Is.EqualTo(sizeof(DOMFreeThreadedDocument))
        );
    }
