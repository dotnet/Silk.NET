...
public static unsafe partial class HTMLControlElementEventsTests
{
    ...
    {
        Assert.That(
            typeof(HTMLControlElementEvents).GUID,
            Is.EqualTo(IID_HTMLControlElementEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLControlElementEvents>(),
            Is.EqualTo(sizeof(HTMLControlElementEvents))
        );
    }
