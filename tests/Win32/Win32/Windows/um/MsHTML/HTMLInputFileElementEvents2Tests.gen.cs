...
public static unsafe partial class HTMLInputFileElementEvents2Tests
{
    ...
    {
        Assert.That(
            typeof(HTMLInputFileElementEvents2).GUID,
            Is.EqualTo(IID_HTMLInputFileElementEvents2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLInputFileElementEvents2>(),
            Is.EqualTo(sizeof(HTMLInputFileElementEvents2))
        );
    }
