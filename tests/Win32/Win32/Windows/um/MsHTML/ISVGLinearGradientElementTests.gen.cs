...
public static unsafe partial class ISVGLinearGradientElementTests
{
    ...
    {
        Assert.That(
            typeof(ISVGLinearGradientElement).GUID,
            Is.EqualTo(IID_ISVGLinearGradientElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGLinearGradientElement>(),
            Is.EqualTo(sizeof(ISVGLinearGradientElement))
        );
    }
