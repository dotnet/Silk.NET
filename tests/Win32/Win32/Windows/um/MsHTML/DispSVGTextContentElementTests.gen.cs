...
public static unsafe partial class DispSVGTextContentElementTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGTextContentElement).GUID,
            Is.EqualTo(IID_DispSVGTextContentElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGTextContentElement>(),
            Is.EqualTo(sizeof(DispSVGTextContentElement))
        );
    }
