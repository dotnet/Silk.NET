...
public static unsafe partial class IHTMLOptionButtonElementTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLOptionButtonElement).GUID,
            Is.EqualTo(IID_IHTMLOptionButtonElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLOptionButtonElement>(),
            Is.EqualTo(sizeof(IHTMLOptionButtonElement))
        );
    }
