...
public static unsafe partial class IHTMLAttributeCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLAttributeCollection).GUID,
            Is.EqualTo(IID_IHTMLAttributeCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLAttributeCollection>(),
            Is.EqualTo(sizeof(IHTMLAttributeCollection))
        );
    }
