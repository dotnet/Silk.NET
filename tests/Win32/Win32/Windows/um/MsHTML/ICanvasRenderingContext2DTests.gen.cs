...
public static unsafe partial class ICanvasRenderingContext2DTests
{
    ...
    {
        Assert.That(
            typeof(ICanvasRenderingContext2D).GUID,
            Is.EqualTo(IID_ICanvasRenderingContext2D)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICanvasRenderingContext2D>(),
            Is.EqualTo(sizeof(ICanvasRenderingContext2D))
        );
    }
