...
public static unsafe partial class IHTMLStyleSheetRulesCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLStyleSheetRulesCollection).GUID,
            Is.EqualTo(IID_IHTMLStyleSheetRulesCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLStyleSheetRulesCollection>(),
            Is.EqualTo(sizeof(IHTMLStyleSheetRulesCollection))
        );
    }
