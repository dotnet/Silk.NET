...
public static unsafe partial class DispHTMLWndOptionElementTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLWndOptionElement).GUID,
            Is.EqualTo(IID_DispHTMLWndOptionElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLWndOptionElement>(),
            Is.EqualTo(sizeof(DispHTMLWndOptionElement))
        );
    }
