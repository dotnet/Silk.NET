...
public static unsafe partial class DOMProcessingInstructionTests
{
    ...
    {
        Assert.That(
            typeof(DOMProcessingInstruction).GUID,
            Is.EqualTo(IID_DOMProcessingInstruction)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DOMProcessingInstruction>(),
            Is.EqualTo(sizeof(DOMProcessingInstruction))
        );
    }
