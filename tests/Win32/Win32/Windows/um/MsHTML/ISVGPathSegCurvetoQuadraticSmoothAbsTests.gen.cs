...
public static unsafe partial class ISVGPathSegCurvetoQuadraticSmoothAbsTests
{
    ...
    {
        Assert.That(
            typeof(ISVGPathSegCurvetoQuadraticSmoothAbs).GUID,
            Is.EqualTo(IID_ISVGPathSegCurvetoQuadraticSmoothAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGPathSegCurvetoQuadraticSmoothAbs>(),
            Is.EqualTo(sizeof(ISVGPathSegCurvetoQuadraticSmoothAbs))
        );
    }
