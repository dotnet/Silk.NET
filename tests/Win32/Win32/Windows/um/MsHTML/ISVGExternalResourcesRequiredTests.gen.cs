...
public static unsafe partial class ISVGExternalResourcesRequiredTests
{
    ...
    {
        Assert.That(
            typeof(ISVGExternalResourcesRequired).GUID,
            Is.EqualTo(IID_ISVGExternalResourcesRequired)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGExternalResourcesRequired>(),
            Is.EqualTo(sizeof(ISVGExternalResourcesRequired))
        );
    }
