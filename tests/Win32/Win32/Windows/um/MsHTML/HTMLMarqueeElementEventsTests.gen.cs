...
public static unsafe partial class HTMLMarqueeElementEventsTests
{
    ...
    {
        Assert.That(
            typeof(HTMLMarqueeElementEvents).GUID,
            Is.EqualTo(IID_HTMLMarqueeElementEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLMarqueeElementEvents>(),
            Is.EqualTo(sizeof(HTMLMarqueeElementEvents))
        );
    }
