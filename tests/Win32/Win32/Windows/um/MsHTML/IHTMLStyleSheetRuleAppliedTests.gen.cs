...
public static unsafe partial class IHTMLStyleSheetRuleAppliedTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLStyleSheetRuleApplied).GUID,
            Is.EqualTo(IID_IHTMLStyleSheetRuleApplied)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLStyleSheetRuleApplied>(),
            Is.EqualTo(sizeof(IHTMLStyleSheetRuleApplied))
        );
    }
