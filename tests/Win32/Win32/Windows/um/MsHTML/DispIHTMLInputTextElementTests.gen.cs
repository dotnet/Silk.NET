...
public static unsafe partial class DispIHTMLInputTextElementTests
{
    ...
    {
        Assert.That(
            typeof(DispIHTMLInputTextElement).GUID,
            Is.EqualTo(IID_DispIHTMLInputTextElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispIHTMLInputTextElement>(),
            Is.EqualTo(sizeof(DispIHTMLInputTextElement))
        );
    }
