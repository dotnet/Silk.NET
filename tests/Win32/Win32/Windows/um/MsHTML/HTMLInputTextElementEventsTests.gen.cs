...
public static unsafe partial class HTMLInputTextElementEventsTests
{
    ...
    {
        Assert.That(
            typeof(HTMLInputTextElementEvents).GUID,
            Is.EqualTo(IID_HTMLInputTextElementEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLInputTextElementEvents>(),
            Is.EqualTo(sizeof(HTMLInputTextElementEvents))
        );
    }
