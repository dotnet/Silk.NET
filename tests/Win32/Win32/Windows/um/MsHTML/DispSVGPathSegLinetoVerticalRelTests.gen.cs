...
public static unsafe partial class DispSVGPathSegLinetoVerticalRelTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGPathSegLinetoVerticalRel).GUID,
            Is.EqualTo(IID_DispSVGPathSegLinetoVerticalRel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGPathSegLinetoVerticalRel>(),
            Is.EqualTo(sizeof(DispSVGPathSegLinetoVerticalRel))
        );
    }
