...
public static unsafe partial class DispDOMMSManipulationEventTests
{
    ...
    {
        Assert.That(
            typeof(DispDOMMSManipulationEvent).GUID,
            Is.EqualTo(IID_DispDOMMSManipulationEvent)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispDOMMSManipulationEvent>(),
            Is.EqualTo(sizeof(DispDOMMSManipulationEvent))
        );
    }
