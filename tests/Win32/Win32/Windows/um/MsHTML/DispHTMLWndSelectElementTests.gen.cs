...
public static unsafe partial class DispHTMLWndSelectElementTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLWndSelectElement).GUID,
            Is.EqualTo(IID_DispHTMLWndSelectElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLWndSelectElement>(),
            Is.EqualTo(sizeof(DispHTMLWndSelectElement))
        );
    }
