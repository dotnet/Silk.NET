...
public static unsafe partial class DispHTMLMSCSSKeyframeRuleTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLMSCSSKeyframeRule).GUID,
            Is.EqualTo(IID_DispHTMLMSCSSKeyframeRule)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLMSCSSKeyframeRule>(),
            Is.EqualTo(sizeof(DispHTMLMSCSSKeyframeRule))
        );
    }
