...
public static unsafe partial class ISVGAnimatedPreserveAspectRatioTests
{
    ...
    {
        Assert.That(
            typeof(ISVGAnimatedPreserveAspectRatio).GUID,
            Is.EqualTo(IID_ISVGAnimatedPreserveAspectRatio)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGAnimatedPreserveAspectRatio>(),
            Is.EqualTo(sizeof(ISVGAnimatedPreserveAspectRatio))
        );
    }
