...
public static unsafe partial class SVGAnimatedPreserveAspectRatioTests
{
    ...
    {
        Assert.That(
            typeof(SVGAnimatedPreserveAspectRatio).GUID,
            Is.EqualTo(IID_SVGAnimatedPreserveAspectRatio)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SVGAnimatedPreserveAspectRatio>(),
            Is.EqualTo(sizeof(SVGAnimatedPreserveAspectRatio))
        );
    }
