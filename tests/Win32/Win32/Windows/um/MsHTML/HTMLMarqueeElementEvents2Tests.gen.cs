...
public static unsafe partial class HTMLMarqueeElementEvents2Tests
{
    ...
    {
        Assert.That(
            typeof(HTMLMarqueeElementEvents2).GUID,
            Is.EqualTo(IID_HTMLMarqueeElementEvents2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLMarqueeElementEvents2>(),
            Is.EqualTo(sizeof(HTMLMarqueeElementEvents2))
        );
    }
