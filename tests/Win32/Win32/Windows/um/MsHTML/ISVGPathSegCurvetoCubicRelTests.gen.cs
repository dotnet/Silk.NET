...
public static unsafe partial class ISVGPathSegCurvetoCubicRelTests
{
    ...
    {
        Assert.That(
            typeof(ISVGPathSegCurvetoCubicRel).GUID,
            Is.EqualTo(IID_ISVGPathSegCurvetoCubicRel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGPathSegCurvetoCubicRel>(),
            Is.EqualTo(sizeof(ISVGPathSegCurvetoCubicRel))
        );
    }
