...
public static unsafe partial class ISVGPathSegCurvetoCubicSmoothRelTests
{
    ...
    {
        Assert.That(
            typeof(ISVGPathSegCurvetoCubicSmoothRel).GUID,
            Is.EqualTo(IID_ISVGPathSegCurvetoCubicSmoothRel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGPathSegCurvetoCubicSmoothRel>(),
            Is.EqualTo(sizeof(ISVGPathSegCurvetoCubicSmoothRel))
        );
    }
