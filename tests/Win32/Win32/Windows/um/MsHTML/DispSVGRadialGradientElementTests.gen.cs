...
public static unsafe partial class DispSVGRadialGradientElementTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGRadialGradientElement).GUID,
            Is.EqualTo(IID_DispSVGRadialGradientElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGRadialGradientElement>(),
            Is.EqualTo(sizeof(DispSVGRadialGradientElement))
        );
    }
