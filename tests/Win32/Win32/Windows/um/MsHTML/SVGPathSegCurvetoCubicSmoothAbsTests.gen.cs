...
public static unsafe partial class SVGPathSegCurvetoCubicSmoothAbsTests
{
    ...
    {
        Assert.That(
            typeof(SVGPathSegCurvetoCubicSmoothAbs).GUID,
            Is.EqualTo(IID_SVGPathSegCurvetoCubicSmoothAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SVGPathSegCurvetoCubicSmoothAbs>(),
            Is.EqualTo(sizeof(SVGPathSegCurvetoCubicSmoothAbs))
        );
    }
