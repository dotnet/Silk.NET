...
public static unsafe partial class IDOMXmlSerializerFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IDOMXmlSerializerFactory).GUID,
            Is.EqualTo(IID_IDOMXmlSerializerFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDOMXmlSerializerFactory>(),
            Is.EqualTo(sizeof(IDOMXmlSerializerFactory))
        );
    }
