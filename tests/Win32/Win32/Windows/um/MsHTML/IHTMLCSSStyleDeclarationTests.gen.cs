...
public static unsafe partial class IHTMLCSSStyleDeclarationTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLCSSStyleDeclaration).GUID,
            Is.EqualTo(IID_IHTMLCSSStyleDeclaration)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLCSSStyleDeclaration>(),
            Is.EqualTo(sizeof(IHTMLCSSStyleDeclaration))
        );
    }
