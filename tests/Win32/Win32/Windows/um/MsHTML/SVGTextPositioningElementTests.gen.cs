...
public static unsafe partial class SVGTextPositioningElementTests
{
    ...
    {
        Assert.That(
            typeof(SVGTextPositioningElement).GUID,
            Is.EqualTo(IID_SVGTextPositioningElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SVGTextPositioningElement>(),
            Is.EqualTo(sizeof(SVGTextPositioningElement))
        );
    }
