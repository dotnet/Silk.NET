...
public static unsafe partial class IElementNamespaceFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IElementNamespaceFactory).GUID,
            Is.EqualTo(IID_IElementNamespaceFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IElementNamespaceFactory>(),
            Is.EqualTo(sizeof(IElementNamespaceFactory))
        );
    }
