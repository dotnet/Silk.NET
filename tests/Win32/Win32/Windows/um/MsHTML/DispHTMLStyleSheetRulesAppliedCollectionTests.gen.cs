...
public static unsafe partial class DispHTMLStyleSheetRulesAppliedCollectionTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLStyleSheetRulesAppliedCollection).GUID,
            Is.EqualTo(IID_DispHTMLStyleSheetRulesAppliedCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLStyleSheetRulesAppliedCollection>(),
            Is.EqualTo(sizeof(DispHTMLStyleSheetRulesAppliedCollection))
        );
    }
