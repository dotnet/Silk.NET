...
public static unsafe partial class IHTMLDOMChildrenCollection2Tests
{
    ...
    {
        Assert.That(
            typeof(IHTMLDOMChildrenCollection2).GUID,
            Is.EqualTo(IID_IHTMLDOMChildrenCollection2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLDOMChildrenCollection2>(),
            Is.EqualTo(sizeof(IHTMLDOMChildrenCollection2))
        );
    }
