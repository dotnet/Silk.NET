...
public static unsafe partial class IHTMLStyleSheetsCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLStyleSheetsCollection).GUID,
            Is.EqualTo(IID_IHTMLStyleSheetsCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLStyleSheetsCollection>(),
            Is.EqualTo(sizeof(IHTMLStyleSheetsCollection))
        );
    }
