...
public static unsafe partial class IHTMLOptionElementFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLOptionElementFactory).GUID,
            Is.EqualTo(IID_IHTMLOptionElementFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLOptionElementFactory>(),
            Is.EqualTo(sizeof(IHTMLOptionElementFactory))
        );
    }
