...
public static unsafe partial class DispSVGPathSegLinetoVerticalAbsTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGPathSegLinetoVerticalAbs).GUID,
            Is.EqualTo(IID_DispSVGPathSegLinetoVerticalAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGPathSegLinetoVerticalAbs>(),
            Is.EqualTo(sizeof(DispSVGPathSegLinetoVerticalAbs))
        );
    }
