...
public static unsafe partial class IScriptEventHandlerSourceInfoTests
{
    ...
    {
        Assert.That(
            typeof(IScriptEventHandlerSourceInfo).GUID,
            Is.EqualTo(IID_IScriptEventHandlerSourceInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IScriptEventHandlerSourceInfo>(),
            Is.EqualTo(sizeof(IScriptEventHandlerSourceInfo))
        );
    }
