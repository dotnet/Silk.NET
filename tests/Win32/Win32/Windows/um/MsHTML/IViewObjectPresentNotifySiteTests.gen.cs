...
public static unsafe partial class IViewObjectPresentNotifySiteTests
{
    ...
    {
        Assert.That(
            typeof(IViewObjectPresentNotifySite).GUID,
            Is.EqualTo(IID_IViewObjectPresentNotifySite)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IViewObjectPresentNotifySite>(),
            Is.EqualTo(sizeof(IViewObjectPresentNotifySite))
        );
    }
