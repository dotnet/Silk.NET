...
public static unsafe partial class DispHTMLPerformanceTimingTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLPerformanceTiming).GUID,
            Is.EqualTo(IID_DispHTMLPerformanceTiming)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLPerformanceTiming>(),
            Is.EqualTo(sizeof(DispHTMLPerformanceTiming))
        );
    }
