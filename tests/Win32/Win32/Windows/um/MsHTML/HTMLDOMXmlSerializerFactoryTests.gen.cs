...
public static unsafe partial class HTMLDOMXmlSerializerFactoryTests
{
    ...
    {
        Assert.That(
            typeof(HTMLDOMXmlSerializerFactory).GUID,
            Is.EqualTo(IID_HTMLDOMXmlSerializerFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLDOMXmlSerializerFactory>(),
            Is.EqualTo(sizeof(HTMLDOMXmlSerializerFactory))
        );
    }
