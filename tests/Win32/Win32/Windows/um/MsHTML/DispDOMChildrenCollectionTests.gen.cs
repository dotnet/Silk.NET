...
public static unsafe partial class DispDOMChildrenCollectionTests
{
    ...
    {
        Assert.That(
            typeof(DispDOMChildrenCollection).GUID,
            Is.EqualTo(IID_DispDOMChildrenCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispDOMChildrenCollection>(),
            Is.EqualTo(sizeof(DispDOMChildrenCollection))
        );
    }
