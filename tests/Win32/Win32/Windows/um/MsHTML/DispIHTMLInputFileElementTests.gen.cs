...
public static unsafe partial class DispIHTMLInputFileElementTests
{
    ...
    {
        Assert.That(
            typeof(DispIHTMLInputFileElement).GUID,
            Is.EqualTo(IID_DispIHTMLInputFileElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispIHTMLInputFileElement>(),
            Is.EqualTo(sizeof(DispIHTMLInputFileElement))
        );
    }
