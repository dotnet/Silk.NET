...
public static unsafe partial class DispSVGPathSegCurvetoCubicAbsTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGPathSegCurvetoCubicAbs).GUID,
            Is.EqualTo(IID_DispSVGPathSegCurvetoCubicAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGPathSegCurvetoCubicAbs>(),
            Is.EqualTo(sizeof(DispSVGPathSegCurvetoCubicAbs))
        );
    }
