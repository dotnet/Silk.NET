...
public static unsafe partial class IHTMLAttributeCollection2Tests
{
    ...
    {
        Assert.That(
            typeof(IHTMLAttributeCollection2).GUID,
            Is.EqualTo(IID_IHTMLAttributeCollection2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLAttributeCollection2>(),
            Is.EqualTo(sizeof(IHTMLAttributeCollection2))
        );
    }
