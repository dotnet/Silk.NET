...
public static unsafe partial class HTMLOptionElementFactoryTests
{
    ...
    {
        Assert.That(
            typeof(HTMLOptionElementFactory).GUID,
            Is.EqualTo(IID_HTMLOptionElementFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLOptionElementFactory>(),
            Is.EqualTo(sizeof(HTMLOptionElementFactory))
        );
    }
