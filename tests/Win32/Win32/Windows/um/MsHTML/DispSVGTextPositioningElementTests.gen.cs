...
public static unsafe partial class DispSVGTextPositioningElementTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGTextPositioningElement).GUID,
            Is.EqualTo(IID_DispSVGTextPositioningElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGTextPositioningElement>(),
            Is.EqualTo(sizeof(DispSVGTextPositioningElement))
        );
    }
