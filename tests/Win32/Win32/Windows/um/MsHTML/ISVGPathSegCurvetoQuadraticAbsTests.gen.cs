...
public static unsafe partial class ISVGPathSegCurvetoQuadraticAbsTests
{
    ...
    {
        Assert.That(
            typeof(ISVGPathSegCurvetoQuadraticAbs).GUID,
            Is.EqualTo(IID_ISVGPathSegCurvetoQuadraticAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGPathSegCurvetoQuadraticAbs>(),
            Is.EqualTo(sizeof(ISVGPathSegCurvetoQuadraticAbs))
        );
    }
