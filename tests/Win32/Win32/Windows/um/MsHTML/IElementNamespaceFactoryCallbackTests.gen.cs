...
public static unsafe partial class IElementNamespaceFactoryCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IElementNamespaceFactoryCallback).GUID,
            Is.EqualTo(IID_IElementNamespaceFactoryCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IElementNamespaceFactoryCallback>(),
            Is.EqualTo(sizeof(IElementNamespaceFactoryCallback))
        );
    }
