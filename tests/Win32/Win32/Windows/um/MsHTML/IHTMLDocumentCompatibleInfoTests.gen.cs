...
public static unsafe partial class IHTMLDocumentCompatibleInfoTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLDocumentCompatibleInfo).GUID,
            Is.EqualTo(IID_IHTMLDocumentCompatibleInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLDocumentCompatibleInfo>(),
            Is.EqualTo(sizeof(IHTMLDocumentCompatibleInfo))
        );
    }
