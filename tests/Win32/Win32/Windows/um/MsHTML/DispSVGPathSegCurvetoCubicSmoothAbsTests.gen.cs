...
public static unsafe partial class DispSVGPathSegCurvetoCubicSmoothAbsTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGPathSegCurvetoCubicSmoothAbs).GUID,
            Is.EqualTo(IID_DispSVGPathSegCurvetoCubicSmoothAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGPathSegCurvetoCubicSmoothAbs>(),
            Is.EqualTo(sizeof(DispSVGPathSegCurvetoCubicSmoothAbs))
        );
    }
