...
public static unsafe partial class IHTMLFontNamesCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLFontNamesCollection).GUID,
            Is.EqualTo(IID_IHTMLFontNamesCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLFontNamesCollection>(),
            Is.EqualTo(sizeof(IHTMLFontNamesCollection))
        );
    }
