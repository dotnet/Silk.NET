...
public static unsafe partial class DispIHTMLOptionButtonElementTests
{
    ...
    {
        Assert.That(
            typeof(DispIHTMLOptionButtonElement).GUID,
            Is.EqualTo(IID_DispIHTMLOptionButtonElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispIHTMLOptionButtonElement>(),
            Is.EqualTo(sizeof(DispIHTMLOptionButtonElement))
        );
    }
