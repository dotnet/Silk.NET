...
public static unsafe partial class ISVGTextPositioningElementTests
{
    ...
    {
        Assert.That(
            typeof(ISVGTextPositioningElement).GUID,
            Is.EqualTo(IID_ISVGTextPositioningElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGTextPositioningElement>(),
            Is.EqualTo(sizeof(ISVGTextPositioningElement))
        );
    }
