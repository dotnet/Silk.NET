...
public static unsafe partial class HTMLControlElementEvents2Tests
{
    ...
    {
        Assert.That(
            typeof(HTMLControlElementEvents2).GUID,
            Is.EqualTo(IID_HTMLControlElementEvents2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLControlElementEvents2>(),
            Is.EqualTo(sizeof(HTMLControlElementEvents2))
        );
    }
