...
public static unsafe partial class ISelectionServicesListenerTests
{
    ...
    {
        Assert.That(
            typeof(ISelectionServicesListener).GUID,
            Is.EqualTo(IID_ISelectionServicesListener)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISelectionServicesListener>(),
            Is.EqualTo(sizeof(ISelectionServicesListener))
        );
    }
