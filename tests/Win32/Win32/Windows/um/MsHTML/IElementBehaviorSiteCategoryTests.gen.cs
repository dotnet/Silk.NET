...
public static unsafe partial class IElementBehaviorSiteCategoryTests
{
    ...
    {
        Assert.That(
            typeof(IElementBehaviorSiteCategory).GUID,
            Is.EqualTo(IID_IElementBehaviorSiteCategory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IElementBehaviorSiteCategory>(),
            Is.EqualTo(sizeof(IElementBehaviorSiteCategory))
        );
    }
