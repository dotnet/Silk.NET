...
public static unsafe partial class HTMLXMLHttpRequestEventsTests
{
    ...
    {
        Assert.That(
            typeof(HTMLXMLHttpRequestEvents).GUID,
            Is.EqualTo(IID_HTMLXMLHttpRequestEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLXMLHttpRequestEvents>(),
            Is.EqualTo(sizeof(HTMLXMLHttpRequestEvents))
        );
    }
