...
public static unsafe partial class DispSVGPathSegLinetoHorizontalAbsTests
{
    ...
    {
        Assert.That(
            typeof(DispSVGPathSegLinetoHorizontalAbs).GUID,
            Is.EqualTo(IID_DispSVGPathSegLinetoHorizontalAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispSVGPathSegLinetoHorizontalAbs>(),
            Is.EqualTo(sizeof(DispSVGPathSegLinetoHorizontalAbs))
        );
    }
