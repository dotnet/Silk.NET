...
public static unsafe partial class IHTMLFontSizesCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLFontSizesCollection).GUID,
            Is.EqualTo(IID_IHTMLFontSizesCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLFontSizesCollection>(),
            Is.EqualTo(sizeof(IHTMLFontSizesCollection))
        );
    }
