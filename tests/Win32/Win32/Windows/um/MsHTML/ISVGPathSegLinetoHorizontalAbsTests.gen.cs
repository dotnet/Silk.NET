...
public static unsafe partial class ISVGPathSegLinetoHorizontalAbsTests
{
    ...
    {
        Assert.That(
            typeof(ISVGPathSegLinetoHorizontalAbs).GUID,
            Is.EqualTo(IID_ISVGPathSegLinetoHorizontalAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGPathSegLinetoHorizontalAbs>(),
            Is.EqualTo(sizeof(ISVGPathSegLinetoHorizontalAbs))
        );
    }
