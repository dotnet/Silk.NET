...
public static unsafe partial class HTMLDocumentCompatibleInfoTests
{
    ...
    {
        Assert.That(
            typeof(HTMLDocumentCompatibleInfo).GUID,
            Is.EqualTo(IID_HTMLDocumentCompatibleInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLDocumentCompatibleInfo>(),
            Is.EqualTo(sizeof(HTMLDocumentCompatibleInfo))
        );
    }
