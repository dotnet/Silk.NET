...
public static unsafe partial class ISVGPathSegCurvetoCubicAbsTests
{
    ...
    {
        Assert.That(
            typeof(ISVGPathSegCurvetoCubicAbs).GUID,
            Is.EqualTo(IID_ISVGPathSegCurvetoCubicAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISVGPathSegCurvetoCubicAbs>(),
            Is.EqualTo(sizeof(ISVGPathSegCurvetoCubicAbs))
        );
    }
