...
public static unsafe partial class SVGRadialGradientElementTests
{
    ...
    {
        Assert.That(
            typeof(SVGRadialGradientElement).GUID,
            Is.EqualTo(IID_SVGRadialGradientElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SVGRadialGradientElement>(),
            Is.EqualTo(sizeof(SVGRadialGradientElement))
        );
    }
