...
public static unsafe partial class DispHTMLCSSNamespaceRuleTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLCSSNamespaceRule).GUID,
            Is.EqualTo(IID_DispHTMLCSSNamespaceRule)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLCSSNamespaceRule>(),
            Is.EqualTo(sizeof(DispHTMLCSSNamespaceRule))
        );
    }
