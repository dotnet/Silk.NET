...
public static unsafe partial class HTMLPerformanceNavigationTests
{
    ...
    {
        Assert.That(
            typeof(HTMLPerformanceNavigation).GUID,
            Is.EqualTo(IID_HTMLPerformanceNavigation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLPerformanceNavigation>(),
            Is.EqualTo(sizeof(HTMLPerformanceNavigation))
        );
    }
