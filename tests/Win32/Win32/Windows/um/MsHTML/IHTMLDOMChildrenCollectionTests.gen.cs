...
public static unsafe partial class IHTMLDOMChildrenCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IHTMLDOMChildrenCollection).GUID,
            Is.EqualTo(IID_IHTMLDOMChildrenCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHTMLDOMChildrenCollection>(),
            Is.EqualTo(sizeof(IHTMLDOMChildrenCollection))
        );
    }
