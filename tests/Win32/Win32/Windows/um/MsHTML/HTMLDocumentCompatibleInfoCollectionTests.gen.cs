...
public static unsafe partial class HTMLDocumentCompatibleInfoCollectionTests
{
    ...
    {
        Assert.That(
            typeof(HTMLDocumentCompatibleInfoCollection).GUID,
            Is.EqualTo(IID_HTMLDocumentCompatibleInfoCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<HTMLDocumentCompatibleInfoCollection>(),
            Is.EqualTo(sizeof(HTMLDocumentCompatibleInfoCollection))
        );
    }
