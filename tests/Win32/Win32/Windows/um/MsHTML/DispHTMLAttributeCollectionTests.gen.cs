...
public static unsafe partial class DispHTMLAttributeCollectionTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLAttributeCollection).GUID,
            Is.EqualTo(IID_DispHTMLAttributeCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLAttributeCollection>(),
            Is.EqualTo(sizeof(DispHTMLAttributeCollection))
        );
    }
