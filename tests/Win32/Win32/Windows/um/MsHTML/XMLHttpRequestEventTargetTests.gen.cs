...
public static unsafe partial class XMLHttpRequestEventTargetTests
{
    ...
    {
        Assert.That(
            typeof(XMLHttpRequestEventTarget).GUID,
            Is.EqualTo(IID_XMLHttpRequestEventTarget)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<XMLHttpRequestEventTarget>(),
            Is.EqualTo(sizeof(XMLHttpRequestEventTarget))
        );
    }
