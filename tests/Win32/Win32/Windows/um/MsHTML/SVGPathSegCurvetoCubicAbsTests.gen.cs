...
public static unsafe partial class SVGPathSegCurvetoCubicAbsTests
{
    ...
    {
        Assert.That(
            typeof(SVGPathSegCurvetoCubicAbs).GUID,
            Is.EqualTo(IID_SVGPathSegCurvetoCubicAbs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SVGPathSegCurvetoCubicAbs>(),
            Is.EqualTo(sizeof(SVGPathSegCurvetoCubicAbs))
        );
    }
