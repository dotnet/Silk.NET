...
public static unsafe partial class DispHTMLStyleSheetsCollectionTests
{
    ...
    {
        Assert.That(
            typeof(DispHTMLStyleSheetsCollection).GUID,
            Is.EqualTo(IID_DispHTMLStyleSheetsCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DispHTMLStyleSheetsCollection>(),
            Is.EqualTo(sizeof(DispHTMLStyleSheetsCollection))
        );
    }
