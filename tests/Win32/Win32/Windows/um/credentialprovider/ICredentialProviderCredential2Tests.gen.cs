...
public static unsafe partial class ICredentialProviderCredential2Tests
{
    ...
    {
        Assert.That(
            typeof(ICredentialProviderCredential2).GUID,
            Is.EqualTo(IID_ICredentialProviderCredential2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICredentialProviderCredential2>(),
            Is.EqualTo(sizeof(ICredentialProviderCredential2))
        );
    }
