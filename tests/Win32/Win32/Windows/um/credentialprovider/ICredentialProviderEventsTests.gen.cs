...
public static unsafe partial class ICredentialProviderEventsTests
{
    ...
    {
        Assert.That(
            typeof(ICredentialProviderEvents).GUID,
            Is.EqualTo(IID_ICredentialProviderEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICredentialProviderEvents>(),
            Is.EqualTo(sizeof(ICredentialProviderEvents))
        );
    }
