...
public static unsafe partial class PINLogonCredentialProviderTests
{
    ...
    {
        Assert.That(
            typeof(PINLogonCredentialProvider).GUID,
            Is.EqualTo(IID_PINLogonCredentialProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<PINLogonCredentialProvider>(),
            Is.EqualTo(sizeof(PINLogonCredentialProvider))
        );
    }
