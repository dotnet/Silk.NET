...
public static unsafe partial class ICredentialProviderCredentialEventsTests
{
    ...
    {
        Assert.That(
            typeof(ICredentialProviderCredentialEvents).GUID,
            Is.EqualTo(IID_ICredentialProviderCredentialEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICredentialProviderCredentialEvents>(),
            Is.EqualTo(sizeof(ICredentialProviderCredentialEvents))
        );
    }
