...
public static unsafe partial class GenericCredentialProviderTests
{
    ...
    {
        Assert.That(
            typeof(GenericCredentialProvider).GUID,
            Is.EqualTo(IID_GenericCredentialProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<GenericCredentialProvider>(),
            Is.EqualTo(sizeof(GenericCredentialProvider))
        );
    }
