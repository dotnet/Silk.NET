...
public static unsafe partial class ICredentialProviderSetUserArrayTests
{
    ...
    {
        Assert.That(
            typeof(ICredentialProviderSetUserArray).GUID,
            Is.EqualTo(IID_ICredentialProviderSetUserArray)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICredentialProviderSetUserArray>(),
            Is.EqualTo(sizeof(ICredentialProviderSetUserArray))
        );
    }
