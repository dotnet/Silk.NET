...
public static unsafe partial class IConnectableCredentialProviderCredentialTests
{
    ...
    {
        Assert.That(
            typeof(IConnectableCredentialProviderCredential).GUID,
            Is.EqualTo(IID_IConnectableCredentialProviderCredential)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IConnectableCredentialProviderCredential>(),
            Is.EqualTo(sizeof(IConnectableCredentialProviderCredential))
        );
    }
