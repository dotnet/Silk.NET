...
public static unsafe partial class WinBioCredentialProviderTests
{
    ...
    {
        Assert.That(
            typeof(WinBioCredentialProvider).GUID,
            Is.EqualTo(IID_WinBioCredentialProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<WinBioCredentialProvider>(),
            Is.EqualTo(sizeof(WinBioCredentialProvider))
        );
    }
