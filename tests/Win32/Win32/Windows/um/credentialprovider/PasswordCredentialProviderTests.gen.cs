...
public static unsafe partial class PasswordCredentialProviderTests
{
    ...
    {
        Assert.That(
            typeof(PasswordCredentialProvider).GUID,
            Is.EqualTo(IID_PasswordCredentialProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<PasswordCredentialProvider>(),
            Is.EqualTo(sizeof(PasswordCredentialProvider))
        );
    }
