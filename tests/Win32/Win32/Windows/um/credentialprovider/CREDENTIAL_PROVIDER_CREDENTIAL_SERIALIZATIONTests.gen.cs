...
public static unsafe partial class CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION>(),
            Is.EqualTo(sizeof(CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION))
        );
    }
    ...
    {
        Assert.That(
            typeof(CREDENTIAL_PROVIDER_CREDENTIAL_SERIALIZATION).IsLayoutSequential,
            Is.True
        );
    }
