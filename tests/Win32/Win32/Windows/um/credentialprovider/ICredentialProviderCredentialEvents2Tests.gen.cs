...
public static unsafe partial class ICredentialProviderCredentialEvents2Tests
{
    ...
    {
        Assert.That(
            typeof(ICredentialProviderCredentialEvents2).GUID,
            Is.EqualTo(IID_ICredentialProviderCredentialEvents2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICredentialProviderCredentialEvents2>(),
            Is.EqualTo(sizeof(ICredentialProviderCredentialEvents2))
        );
    }
