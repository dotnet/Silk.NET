...
public static unsafe partial class V1PasswordCredentialProviderTests
{
    ...
    {
        Assert.That(
            typeof(V1PasswordCredentialProvider).GUID,
            Is.EqualTo(IID_V1PasswordCredentialProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<V1PasswordCredentialProvider>(),
            Is.EqualTo(sizeof(V1PasswordCredentialProvider))
        );
    }
