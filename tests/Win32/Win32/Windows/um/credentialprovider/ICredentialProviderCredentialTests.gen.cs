...
public static unsafe partial class ICredentialProviderCredentialTests
{
    ...
    {
        Assert.That(
            typeof(ICredentialProviderCredential).GUID,
            Is.EqualTo(IID_ICredentialProviderCredential)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICredentialProviderCredential>(),
            Is.EqualTo(sizeof(ICredentialProviderCredential))
        );
    }
