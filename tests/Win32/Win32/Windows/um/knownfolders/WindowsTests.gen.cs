...
public static partial class WindowsTests
{
    ...
    public static void FOLDERID_UserProgramFilesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x5cd7aee2, 0x2219, 0x4a67, 0xb8, 0x5d, 0x6c, 0x9c, 0xe1, 0x56, 0x60, 0xcb)
            )
        );
    }
    ...
    public static void FOLDERID_UserProgramFilesCommonTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xbcbd3057, 0xca5c, 0x4622, 0xb4, 0x2d, 0xbc, 0x56, 0xdb, 0x0a, 0xe5, 0x16)
            )
        );
    }
    ...
    public static void FOLDERID_RingtonesTest()
    {
        Assert.That(
            FOLDERID_Ringtones,
            Is.EqualTo(
                new Guid(0xC870044B, 0xF49E, 0x4126, 0xA9, 0xC3, 0xB5, 0x2A, 0x1F, 0xF4, 0x11, 0xE8)
            )
        );
    }
    ...
    public static void FOLDERID_PublicRingtonesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xE555AB60, 0x153B, 0x4D17, 0x9F, 0x04, 0xA5, 0xFE, 0x99, 0xFC, 0x15, 0xEC)
            )
        );
    }
    ...
    public static void FOLDERID_UsersLibrariesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xa302545d, 0xdeff, 0x464b, 0xab, 0xe8, 0x61, 0xc8, 0x64, 0x8d, 0x93, 0x9b)
            )
        );
    }
    ...
    public static void FOLDERID_DocumentsLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x7b0db17d, 0x9cd2, 0x4a93, 0x97, 0x33, 0x46, 0xcc, 0x89, 0x02, 0x2e, 0x7c)
            )
        );
    }
    ...
    public static void FOLDERID_MusicLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x2112ab0a, 0xc86a, 0x4ffe, 0xa3, 0x68, 0xd, 0xe9, 0x6e, 0x47, 0x1, 0x2e)
            )
        );
    }
    ...
    public static void FOLDERID_PicturesLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xa990ae9f, 0xa03b, 0x4e80, 0x94, 0xbc, 0x99, 0x12, 0xd7, 0x50, 0x41, 0x4)
            )
        );
    }
    ...
    public static void FOLDERID_VideosLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x491e922f, 0x5643, 0x4af4, 0xa7, 0xeb, 0x4e, 0x7a, 0x13, 0x8d, 0x81, 0x74)
            )
        );
    }
    ...
    public static void FOLDERID_RecordedTVLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1a6fdba2, 0xf42d, 0x4358, 0xa7, 0x98, 0xb7, 0x4d, 0x74, 0x59, 0x26, 0xc5)
            )
        );
    }
    ...
    public static void FOLDERID_HomeGroupTest()
    {
        Assert.That(
            FOLDERID_HomeGroup,
            Is.EqualTo(
                new Guid(0x52528a6b, 0xb9e3, 0x4add, 0xb6, 0xd, 0x58, 0x8c, 0x2d, 0xba, 0x84, 0x2d)
            )
        );
    }
    ...
    public static void FOLDERID_HomeGroupCurrentUserTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x9b74b6a3, 0xdfd, 0x4f11, 0x9e, 0x78, 0x5f, 0x78, 0x0, 0xf2, 0xe7, 0x72)
            )
        );
    }
    ...
    public static void FOLDERID_DeviceMetadataStoreTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x5ce4a5e9, 0xe4eb, 0x479d, 0xb8, 0x9f, 0x13, 0x0c, 0x02, 0x88, 0x61, 0x55)
            )
        );
    }
    ...
    public static void FOLDERID_LibrariesTest()
    {
        Assert.That(
            FOLDERID_Libraries,
            Is.EqualTo(
                new Guid(0x1b3ea5dc, 0xb587, 0x4786, 0xb4, 0xef, 0xbd, 0x1d, 0xc3, 0x32, 0xae, 0xae)
            )
        );
    }
    ...
    public static void FOLDERID_PublicLibrariesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x48daf80b, 0xe6cf, 0x4f4e, 0xb8, 0x00, 0x0e, 0x69, 0xd8, 0x4e, 0xe3, 0x84)
            )
        );
    }
    ...
    public static void FOLDERID_UserPinnedTest()
    {
        Assert.That(
            FOLDERID_UserPinned,
            Is.EqualTo(
                new Guid(0x9e3995ab, 0x1f9c, 0x4f13, 0xb8, 0x27, 0x48, 0xb2, 0x4b, 0x6c, 0x71, 0x74)
            )
        );
    }
    ...
    public static void FOLDERID_ImplicitAppShortcutsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xbcb5256f, 0x79f6, 0x4cee, 0xb7, 0x25, 0xdc, 0x34, 0xe4, 0x2, 0xfd, 0x46)
            )
        );
    }
    ...
    public static void FOLDERID_AccountPicturesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x008ca0b1, 0x55b4, 0x4c56, 0xb8, 0xa8, 0x4d, 0xe4, 0xb2, 0x99, 0xd3, 0xbe)
            )
        );
    }
    ...
    public static void FOLDERID_PublicUserTilesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x0482af6c, 0x08f1, 0x4c34, 0x8c, 0x90, 0xe1, 0x7e, 0xc9, 0x8b, 0x1e, 0x17)
            )
        );
    }
    ...
    public static void FOLDERID_AppsFolderTest()
    {
        Assert.That(
            FOLDERID_AppsFolder,
            Is.EqualTo(
                new Guid(0x1e87508d, 0x89c2, 0x42f0, 0x8a, 0x7e, 0x64, 0x5a, 0x0f, 0x50, 0xca, 0x58)
            )
        );
    }
    ...
    public static void FOLDERID_StartMenuAllProgramsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xf26305ef, 0x6948, 0x40b9, 0xb2, 0x55, 0x81, 0x45, 0x3d, 0x9, 0xc7, 0x85)
            )
        );
    }
    ...
    public static void FOLDERID_CommonStartMenuPlacesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xa440879f, 0x87a0, 0x4f7d, 0xb7, 0x0, 0x2, 0x7, 0xb9, 0x66, 0x19, 0x4a)
            )
        );
    }
    ...
    public static void FOLDERID_ApplicationShortcutsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xa3918781, 0xe5f2, 0x4890, 0xb3, 0xd9, 0xa7, 0xe5, 0x43, 0x32, 0x32, 0x8c)
            )
        );
    }
    ...
    public static void FOLDERID_RoamingTilesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xbcfc5a, 0xed94, 0x4e48, 0x96, 0xa1, 0x3f, 0x62, 0x17, 0xf2, 0x19, 0x90)
            )
        );
    }
    ...
    public static void FOLDERID_RoamedTileImagesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xaaa8d5a5, 0xf1d6, 0x4259, 0xba, 0xa8, 0x78, 0xe7, 0xef, 0x60, 0x83, 0x5e)
            )
        );
    }
    ...
    public static void FOLDERID_ScreenshotsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xb7bede81, 0xdf94, 0x4682, 0xa7, 0xd8, 0x57, 0xa5, 0x26, 0x20, 0xb8, 0x6f)
            )
        );
    }
    ...
    public static void FOLDERID_CameraRollTest()
    {
        Assert.That(
            FOLDERID_CameraRoll,
            Is.EqualTo(
                new Guid(0xab5fb87b, 0x7ce2, 0x4f83, 0x91, 0x5d, 0x55, 0x8, 0x46, 0xc9, 0x53, 0x7b)
            )
        );
    }
    ...
    public static void FOLDERID_SkyDriveTest()
    {
        Assert.That(
            FOLDERID_SkyDrive,
            Is.EqualTo(
                new Guid(0xa52bba46, 0xe9e1, 0x435f, 0xb3, 0xd9, 0x28, 0xda, 0xa6, 0x48, 0xc0, 0xf6)
            )
        );
    }
    ...
    public static void FOLDERID_SkyDriveDocumentsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x24d89e24, 0x2f19, 0x4534, 0x9d, 0xde, 0x6a, 0x66, 0x71, 0xfb, 0xb8, 0xfe)
            )
        );
    }
    ...
    public static void FOLDERID_SkyDrivePicturesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x339719b5, 0x8c47, 0x4894, 0x94, 0xc2, 0xd8, 0xf7, 0x7a, 0xdd, 0x44, 0xa6)
            )
        );
    }
    ...
    public static void FOLDERID_SkyDriveMusicTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xc3f2459e, 0x80d6, 0x45dc, 0xbf, 0xef, 0x1f, 0x76, 0x9f, 0x2b, 0xe7, 0x30)
            )
        );
    }
    ...
    public static void FOLDERID_SkyDriveCameraRollTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x767e6811, 0x49cb, 0x4273, 0x87, 0xc2, 0x20, 0xf3, 0x55, 0xe1, 0x08, 0x5b)
            )
        );
    }
    ...
    public static void FOLDERID_SearchHistoryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x0d4c3db6, 0x03a3, 0x462f, 0xa0, 0xe6, 0x08, 0x92, 0x4c, 0x41, 0xb5, 0xd4)
            )
        );
    }
    ...
    public static void FOLDERID_SearchTemplatesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x7e636bfe, 0xdfa9, 0x4d5e, 0xb4, 0x56, 0xd7, 0xb3, 0x98, 0x51, 0xd8, 0xa9)
            )
        );
    }
    ...
    public static void FOLDERID_CameraRollLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x2b20df75, 0x1eda, 0x4039, 0x80, 0x97, 0x38, 0x79, 0x82, 0x27, 0xd5, 0xb7)
            )
        );
    }
    ...
    public static void FOLDERID_SavedPicturesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x3b193882, 0xd3ad, 0x4eab, 0x96, 0x5a, 0x69, 0x82, 0x9d, 0x1f, 0xb5, 0x9f)
            )
        );
    }
    ...
    public static void FOLDERID_SavedPicturesLibraryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xe25b5812, 0xbe88, 0x4bd9, 0x94, 0xb0, 0x29, 0x23, 0x34, 0x77, 0xb6, 0xc3)
            )
        );
    }
    ...
    public static void FOLDERID_RetailDemoTest()
    {
        Assert.That(
            FOLDERID_RetailDemo,
            Is.EqualTo(
                new Guid(0x12d4c69e, 0x24ad, 0x4923, 0xbe, 0x19, 0x31, 0x32, 0x1c, 0x43, 0xa7, 0x67)
            )
        );
    }
    ...
    public static void FOLDERID_DeviceTest()
    {
        Assert.That(
            FOLDERID_Device,
            Is.EqualTo(
                new Guid(0x1C2AC1DC, 0x4358, 0x4B6C, 0x97, 0x33, 0xAF, 0x21, 0x15, 0x65, 0x76, 0xF0)
            )
        );
    }
    ...
    public static void FOLDERID_DevelopmentFilesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xdbe8e08e, 0x3053, 0x4bbc, 0xb1, 0x83, 0x2a, 0x7b, 0x2b, 0x19, 0x1e, 0x59)
            )
        );
    }
    ...
    public static void FOLDERID_Objects3DTest()
    {
        Assert.That(
            FOLDERID_Objects3D,
            Is.EqualTo(
                new Guid(0x31c0dd25, 0x9439, 0x4f12, 0xbf, 0x41, 0x7f, 0xf4, 0xed, 0xa3, 0x87, 0x22)
            )
        );
    }
    ...
    public static void FOLDERID_AppCapturesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xedc0fe71, 0x98d8, 0x4f4a, 0xb9, 0x20, 0xc8, 0xdc, 0x13, 0x3c, 0xb1, 0x65)
            )
        );
    }
    ...
    public static void FOLDERID_LocalDocumentsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xf42ee2d3, 0x909f, 0x4907, 0x88, 0x71, 0x4c, 0x22, 0xfc, 0x0b, 0xf7, 0x56)
            )
        );
    }
    ...
    public static void FOLDERID_LocalPicturesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x0ddd015d, 0xb06c, 0x45d5, 0x8c, 0x4c, 0xf5, 0x97, 0x13, 0x85, 0x46, 0x39)
            )
        );
    }
    ...
    public static void FOLDERID_LocalVideosTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x35286a68, 0x3c57, 0x41a1, 0xbb, 0xb1, 0x0e, 0xae, 0x73, 0xd7, 0x6c, 0x95)
            )
        );
    }
    ...
    public static void FOLDERID_LocalMusicTest()
    {
        Assert.That(
            FOLDERID_LocalMusic,
            Is.EqualTo(
                new Guid(0xa0c69a99, 0x21c8, 0x4671, 0x87, 0x03, 0x79, 0x34, 0x16, 0x2f, 0xcf, 0x1d)
            )
        );
    }
    ...
    public static void FOLDERID_LocalDownloadsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x7d83ee9b, 0x2244, 0x4e70, 0xb1, 0xf5, 0x53, 0x93, 0x04, 0x2a, 0xf1, 0xe4)
            )
        );
    }
    ...
    public static void FOLDERID_RecordedCallsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x2f8b40c2, 0x83ed, 0x48ee, 0xb3, 0x83, 0xa1, 0xf1, 0x57, 0xec, 0x6f, 0x9a)
            )
        );
    }
    ...
    public static void FOLDERID_AllAppModsTest()
    {
        Assert.That(
            FOLDERID_AllAppMods,
            Is.EqualTo(
                new Guid(0x7ad67899, 0x66af, 0x43ba, 0x91, 0x56, 0x6a, 0xad, 0x42, 0xe6, 0xc5, 0x96)
            )
        );
    }
    ...
    public static void FOLDERID_CurrentAppModsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x3db40b20, 0x2a30, 0x4dbe, 0x91, 0x7e, 0x77, 0x1d, 0xd2, 0x1d, 0xd0, 0x99)
            )
        );
    }
    ...
    public static void FOLDERID_AppDataDesktopTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xb2c5e279, 0x7add, 0x439f, 0xb2, 0x8c, 0xc4, 0x1f, 0xe1, 0xbb, 0xf6, 0x72)
            )
        );
    }
    ...
    public static void FOLDERID_AppDataDocumentsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x7be16610, 0x1f7f, 0x44ac, 0xbf, 0xf0, 0x83, 0xe1, 0x5f, 0x2f, 0xfc, 0xa1)
            )
        );
    }
    ...
    public static void FOLDERID_AppDataFavoritesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x7cfbefbc, 0xde1f, 0x45aa, 0xb8, 0x43, 0xa5, 0x42, 0xac, 0x53, 0x6c, 0xc9)
            )
        );
    }
    ...
    public static void FOLDERID_AppDataProgramDataTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x559d40a3, 0xa036, 0x40fa, 0xaf, 0x61, 0x84, 0xcb, 0x43, 0xa, 0x4d, 0x34)
            )
        );
    }
    ...
    public static void FOLDERID_LocalStorageTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xB3EB08D3, 0xA1F3, 0x496B, 0x86, 0x5A, 0x42, 0xB5, 0x36, 0xCD, 0xA0, 0xEC)
            )
        );
    }
}
