...
public static unsafe partial class ISupportAllowLowerTrustActivationTests
{
    ...
    {
        Assert.That(
            typeof(ISupportAllowLowerTrustActivation).GUID,
            Is.EqualTo(IID_ISupportAllowLowerTrustActivation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISupportAllowLowerTrustActivation>(),
            Is.EqualTo(sizeof(ISupportAllowLowerTrustActivation))
        );
    }
