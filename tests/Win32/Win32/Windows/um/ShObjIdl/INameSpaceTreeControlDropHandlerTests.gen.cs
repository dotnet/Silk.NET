...
public static unsafe partial class INameSpaceTreeControlDropHandlerTests
{
    ...
    {
        Assert.That(
            typeof(INameSpaceTreeControlDropHandler).GUID,
            Is.EqualTo(IID_INameSpaceTreeControlDropHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<INameSpaceTreeControlDropHandler>(),
            Is.EqualTo(sizeof(INameSpaceTreeControlDropHandler))
        );
    }
