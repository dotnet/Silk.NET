...
public static unsafe partial class IComputerInfoChangeNotifyTests
{
    ...
    {
        Assert.That(
            typeof(IComputerInfoChangeNotify).GUID,
            Is.EqualTo(IID_IComputerInfoChangeNotify)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IComputerInfoChangeNotify>(),
            Is.EqualTo(sizeof(IComputerInfoChangeNotify))
        );
    }
