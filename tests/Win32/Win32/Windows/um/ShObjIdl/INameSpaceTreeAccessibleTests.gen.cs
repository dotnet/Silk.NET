...
public static unsafe partial class INameSpaceTreeAccessibleTests
{
    ...
    {
        Assert.That(
            typeof(INameSpaceTreeAccessible).GUID,
            Is.EqualTo(IID_INameSpaceTreeAccessible)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<INameSpaceTreeAccessible>(),
            Is.EqualTo(sizeof(INameSpaceTreeAccessible))
        );
    }
