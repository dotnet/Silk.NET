...
public static unsafe partial class IFileDialogControlEventsTests
{
    ...
    {
        Assert.That(
            typeof(IFileDialogControlEvents).GUID,
            Is.EqualTo(IID_IFileDialogControlEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IFileDialogControlEvents>(),
            Is.EqualTo(sizeof(IFileDialogControlEvents))
        );
    }
