...
public static unsafe partial class INameSpaceTreeControlEventsTests
{
    ...
    {
        Assert.That(
            typeof(INameSpaceTreeControlEvents).GUID,
            Is.EqualTo(IID_INameSpaceTreeControlEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<INameSpaceTreeControlEvents>(),
            Is.EqualTo(sizeof(INameSpaceTreeControlEvents))
        );
    }
