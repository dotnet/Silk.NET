...
public static unsafe partial class IAccessibilityDockingServiceTests
{
    ...
    {
        Assert.That(
            typeof(IAccessibilityDockingService).GUID,
            Is.EqualTo(IID_IAccessibilityDockingService)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAccessibilityDockingService>(),
            Is.EqualTo(sizeof(IAccessibilityDockingService))
        );
    }
