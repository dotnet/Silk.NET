...
public static unsafe partial class IApplicationAssociationRegistrationUITests
{
    ...
    {
        Assert.That(
            typeof(IApplicationAssociationRegistrationUI).GUID,
            Is.EqualTo(IID_IApplicationAssociationRegistrationUI)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IApplicationAssociationRegistrationUI>(),
            Is.EqualTo(sizeof(IApplicationAssociationRegistrationUI))
        );
    }
