...
public static unsafe partial class ISpatialAudioObjectRenderStreamForMetadataTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialAudioObjectRenderStreamForMetadata).GUID,
            Is.EqualTo(IID_ISpatialAudioObjectRenderStreamForMetadata)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialAudioObjectRenderStreamForMetadata>(),
            Is.EqualTo(sizeof(ISpatialAudioObjectRenderStreamForMetadata))
        );
    }
