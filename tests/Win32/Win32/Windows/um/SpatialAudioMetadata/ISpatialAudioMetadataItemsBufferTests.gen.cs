...
public static unsafe partial class ISpatialAudioMetadataItemsBufferTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialAudioMetadataItemsBuffer).GUID,
            Is.EqualTo(IID_ISpatialAudioMetadataItemsBuffer)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialAudioMetadataItemsBuffer>(),
            Is.EqualTo(sizeof(ISpatialAudioMetadataItemsBuffer))
        );
    }
