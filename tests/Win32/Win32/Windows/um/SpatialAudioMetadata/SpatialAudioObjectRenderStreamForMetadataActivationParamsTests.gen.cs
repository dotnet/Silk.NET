...
public static unsafe partial class SpatialAudioObjectRenderStreamForMetadataActivationParamsTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<SpatialAudioObjectRenderStreamForMetadataActivationParams>(),
            Is.EqualTo(sizeof(SpatialAudioObjectRenderStreamForMetadataActivationParams))
        );
    }
    ...
    {
        Assert.That(
            typeof(SpatialAudioObjectRenderStreamForMetadataActivationParams).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(SpatialAudioObjectRenderStreamForMetadataActivationParams),
                Is.EqualTo(66)
            );
        }
        else
