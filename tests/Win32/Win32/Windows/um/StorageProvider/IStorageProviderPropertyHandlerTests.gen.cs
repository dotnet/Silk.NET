...
public static unsafe partial class IStorageProviderPropertyHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IStorageProviderPropertyHandler).GUID,
            Is.EqualTo(IID_IStorageProviderPropertyHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IStorageProviderPropertyHandler>(),
            Is.EqualTo(sizeof(IStorageProviderPropertyHandler))
        );
    }
