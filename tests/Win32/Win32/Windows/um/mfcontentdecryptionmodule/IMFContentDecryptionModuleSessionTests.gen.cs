...
public static unsafe partial class IMFContentDecryptionModuleSessionTests
{
    ...
    {
        Assert.That(
            typeof(IMFContentDecryptionModuleSession).GUID,
            Is.EqualTo(IID_IMFContentDecryptionModuleSession)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFContentDecryptionModuleSession>(),
            Is.EqualTo(sizeof(IMFContentDecryptionModuleSession))
        );
    }
