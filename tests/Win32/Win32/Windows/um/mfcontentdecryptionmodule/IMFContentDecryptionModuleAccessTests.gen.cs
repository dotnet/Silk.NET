...
public static unsafe partial class IMFContentDecryptionModuleAccessTests
{
    ...
    {
        Assert.That(
            typeof(IMFContentDecryptionModuleAccess).GUID,
            Is.EqualTo(IID_IMFContentDecryptionModuleAccess)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFContentDecryptionModuleAccess>(),
            Is.EqualTo(sizeof(IMFContentDecryptionModuleAccess))
        );
    }
