...
public static unsafe partial class IMFHttpDownloadSessionProviderTests
{
    ...
    {
        Assert.That(
            typeof(IMFHttpDownloadSessionProvider).GUID,
            Is.EqualTo(IID_IMFHttpDownloadSessionProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFHttpDownloadSessionProvider>(),
            Is.EqualTo(sizeof(IMFHttpDownloadSessionProvider))
        );
    }
