...
public static unsafe partial class IMFSampleAllocatorControlTests
{
    ...
    {
        Assert.That(
            typeof(IMFSampleAllocatorControl).GUID,
            Is.EqualTo(IID_IMFSampleAllocatorControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSampleAllocatorControl>(),
            Is.EqualTo(sizeof(IMFSampleAllocatorControl))
        );
    }
