...
public static unsafe partial class IMFVideoProcessorControl2Tests
{
    ...
    {
        Assert.That(
            typeof(IMFVideoProcessorControl2).GUID,
            Is.EqualTo(IID_IMFVideoProcessorControl2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFVideoProcessorControl2>(),
            Is.EqualTo(sizeof(IMFVideoProcessorControl2))
        );
    }
