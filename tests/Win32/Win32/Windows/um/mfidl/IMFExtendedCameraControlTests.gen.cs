...
public static unsafe partial class IMFExtendedCameraControlTests
{
    ...
    {
        Assert.That(
            typeof(IMFExtendedCameraControl).GUID,
            Is.EqualTo(IID_IMFExtendedCameraControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFExtendedCameraControl>(),
            Is.EqualTo(sizeof(IMFExtendedCameraControl))
        );
    }
