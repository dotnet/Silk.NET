...
public static unsafe partial class IMFVideoSampleAllocatorExTests
{
    ...
    {
        Assert.That(
            typeof(IMFVideoSampleAllocatorEx).GUID,
            Is.EqualTo(IID_IMFVideoSampleAllocatorEx)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFVideoSampleAllocatorEx>(),
            Is.EqualTo(sizeof(IMFVideoSampleAllocatorEx))
        );
    }
