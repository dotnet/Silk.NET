...
public static unsafe partial class IMFSensorActivityMonitorTests
{
    ...
    {
        Assert.That(
            typeof(IMFSensorActivityMonitor).GUID,
            Is.EqualTo(IID_IMFSensorActivityMonitor)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSensorActivityMonitor>(),
            Is.EqualTo(sizeof(IMFSensorActivityMonitor))
        );
    }
