...
public static unsafe partial class IMFVideoRendererEffectControlTests
{
    ...
    {
        Assert.That(
            typeof(IMFVideoRendererEffectControl).GUID,
            Is.EqualTo(IID_IMFVideoRendererEffectControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFVideoRendererEffectControl>(),
            Is.EqualTo(sizeof(IMFVideoRendererEffectControl))
        );
    }
