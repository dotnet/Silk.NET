...
public static unsafe partial class IMFExtendedCameraIntrinsicModelTests
{
    ...
    {
        Assert.That(
            typeof(IMFExtendedCameraIntrinsicModel).GUID,
            Is.EqualTo(IID_IMFExtendedCameraIntrinsicModel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFExtendedCameraIntrinsicModel>(),
            Is.EqualTo(sizeof(IMFExtendedCameraIntrinsicModel))
        );
    }
