...
public static unsafe partial class IMFObjectReferenceStreamTests
{
    ...
    {
        Assert.That(
            typeof(IMFObjectReferenceStream).GUID,
            Is.EqualTo(IID_IMFObjectReferenceStream)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFObjectReferenceStream>(),
            Is.EqualTo(sizeof(IMFObjectReferenceStream))
        );
    }
