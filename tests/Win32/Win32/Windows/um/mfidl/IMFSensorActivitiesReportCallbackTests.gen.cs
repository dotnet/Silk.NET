...
public static unsafe partial class IMFSensorActivitiesReportCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IMFSensorActivitiesReportCallback).GUID,
            Is.EqualTo(IID_IMFSensorActivitiesReportCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSensorActivitiesReportCallback>(),
            Is.EqualTo(sizeof(IMFSensorActivitiesReportCallback))
        );
    }
