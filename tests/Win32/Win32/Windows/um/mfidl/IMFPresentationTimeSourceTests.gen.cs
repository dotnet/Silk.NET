...
public static unsafe partial class IMFPresentationTimeSourceTests
{
    ...
    {
        Assert.That(
            typeof(IMFPresentationTimeSource).GUID,
            Is.EqualTo(IID_IMFPresentationTimeSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFPresentationTimeSource>(),
            Is.EqualTo(sizeof(IMFPresentationTimeSource))
        );
    }
