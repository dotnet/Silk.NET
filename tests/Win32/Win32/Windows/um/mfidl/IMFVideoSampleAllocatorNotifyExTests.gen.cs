...
public static unsafe partial class IMFVideoSampleAllocatorNotifyExTests
{
    ...
    {
        Assert.That(
            typeof(IMFVideoSampleAllocatorNotifyEx).GUID,
            Is.EqualTo(IID_IMFVideoSampleAllocatorNotifyEx)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFVideoSampleAllocatorNotifyEx>(),
            Is.EqualTo(sizeof(IMFVideoSampleAllocatorNotifyEx))
        );
    }
