...
public static unsafe partial class IMFCameraOcclusionStateReportTests
{
    ...
    {
        Assert.That(
            typeof(IMFCameraOcclusionStateReport).GUID,
            Is.EqualTo(IID_IMFCameraOcclusionStateReport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFCameraOcclusionStateReport>(),
            Is.EqualTo(sizeof(IMFCameraOcclusionStateReport))
        );
    }
