...
public static unsafe partial class IMFSensorActivitiesReportTests
{
    ...
    {
        Assert.That(
            typeof(IMFSensorActivitiesReport).GUID,
            Is.EqualTo(IID_IMFSensorActivitiesReport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSensorActivitiesReport>(),
            Is.EqualTo(sizeof(IMFSensorActivitiesReport))
        );
    }
