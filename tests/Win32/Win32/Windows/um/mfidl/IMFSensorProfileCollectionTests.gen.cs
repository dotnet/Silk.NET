...
public static unsafe partial class IMFSensorProfileCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IMFSensorProfileCollection).GUID,
            Is.EqualTo(IID_IMFSensorProfileCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSensorProfileCollection>(),
            Is.EqualTo(sizeof(IMFSensorProfileCollection))
        );
    }
