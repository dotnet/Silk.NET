...
public static unsafe partial class IMFSensorTransformFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IMFSensorTransformFactory).GUID,
            Is.EqualTo(IID_IMFSensorTransformFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSensorTransformFactory>(),
            Is.EqualTo(sizeof(IMFSensorTransformFactory))
        );
    }
