...
public static unsafe partial class IMFVideoSampleAllocatorNotifyTests
{
    ...
    {
        Assert.That(
            typeof(IMFVideoSampleAllocatorNotify).GUID,
            Is.EqualTo(IID_IMFVideoSampleAllocatorNotify)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFVideoSampleAllocatorNotify>(),
            Is.EqualTo(sizeof(IMFVideoSampleAllocatorNotify))
        );
    }
