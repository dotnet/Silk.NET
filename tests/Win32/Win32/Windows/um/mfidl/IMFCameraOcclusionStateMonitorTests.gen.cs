...
public static unsafe partial class IMFCameraOcclusionStateMonitorTests
{
    ...
    {
        Assert.That(
            typeof(IMFCameraOcclusionStateMonitor).GUID,
            Is.EqualTo(IID_IMFCameraOcclusionStateMonitor)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFCameraOcclusionStateMonitor>(),
            Is.EqualTo(sizeof(IMFCameraOcclusionStateMonitor))
        );
    }
