...
public static unsafe partial class IMFByteStreamCacheControlTests
{
    ...
    {
        Assert.That(
            typeof(IMFByteStreamCacheControl).GUID,
            Is.EqualTo(IID_IMFByteStreamCacheControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFByteStreamCacheControl>(),
            Is.EqualTo(sizeof(IMFByteStreamCacheControl))
        );
    }
