...
public static unsafe partial class IMFMediaSourceTopologyProviderTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaSourceTopologyProvider).GUID,
            Is.EqualTo(IID_IMFMediaSourceTopologyProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaSourceTopologyProvider>(),
            Is.EqualTo(sizeof(IMFMediaSourceTopologyProvider))
        );
    }
