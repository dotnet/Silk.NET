...
public static unsafe partial class IMFSSLCertificateManagerTests
{
    ...
    {
        Assert.That(
            typeof(IMFSSLCertificateManager).GUID,
            Is.EqualTo(IID_IMFSSLCertificateManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSSLCertificateManager>(),
            Is.EqualTo(sizeof(IMFSSLCertificateManager))
        );
    }
