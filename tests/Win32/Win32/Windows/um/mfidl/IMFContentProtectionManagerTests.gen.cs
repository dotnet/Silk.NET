...
public static unsafe partial class IMFContentProtectionManagerTests
{
    ...
    {
        Assert.That(
            typeof(IMFContentProtectionManager).GUID,
            Is.EqualTo(IID_IMFContentProtectionManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFContentProtectionManager>(),
            Is.EqualTo(sizeof(IMFContentProtectionManager))
        );
    }
