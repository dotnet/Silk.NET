...
public static unsafe partial class IMFVideoProcessorControlTests
{
    ...
    {
        Assert.That(
            typeof(IMFVideoProcessorControl).GUID,
            Is.EqualTo(IID_IMFVideoProcessorControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFVideoProcessorControl>(),
            Is.EqualTo(sizeof(IMFVideoProcessorControl))
        );
    }
