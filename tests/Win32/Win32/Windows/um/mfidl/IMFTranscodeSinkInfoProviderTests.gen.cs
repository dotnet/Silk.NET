...
public static unsafe partial class IMFTranscodeSinkInfoProviderTests
{
    ...
    {
        Assert.That(
            typeof(IMFTranscodeSinkInfoProvider).GUID,
            Is.EqualTo(IID_IMFTranscodeSinkInfoProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFTranscodeSinkInfoProvider>(),
            Is.EqualTo(sizeof(IMFTranscodeSinkInfoProvider))
        );
    }
