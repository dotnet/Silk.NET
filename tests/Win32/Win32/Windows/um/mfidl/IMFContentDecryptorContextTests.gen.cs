...
public static unsafe partial class IMFContentDecryptorContextTests
{
    ...
    {
        Assert.That(
            typeof(IMFContentDecryptorContext).GUID,
            Is.EqualTo(IID_IMFContentDecryptorContext)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFContentDecryptorContext>(),
            Is.EqualTo(sizeof(IMFContentDecryptorContext))
        );
    }
