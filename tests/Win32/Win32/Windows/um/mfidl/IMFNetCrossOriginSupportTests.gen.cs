...
public static unsafe partial class IMFNetCrossOriginSupportTests
{
    ...
    {
        Assert.That(
            typeof(IMFNetCrossOriginSupport).GUID,
            Is.EqualTo(IID_IMFNetCrossOriginSupport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFNetCrossOriginSupport>(),
            Is.EqualTo(sizeof(IMFNetCrossOriginSupport))
        );
    }
