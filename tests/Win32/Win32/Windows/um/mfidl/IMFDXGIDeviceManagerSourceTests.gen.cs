...
public static unsafe partial class IMFDXGIDeviceManagerSourceTests
{
    ...
    {
        Assert.That(
            typeof(IMFDXGIDeviceManagerSource).GUID,
            Is.EqualTo(IID_IMFDXGIDeviceManagerSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFDXGIDeviceManagerSource>(),
            Is.EqualTo(sizeof(IMFDXGIDeviceManagerSource))
        );
    }
