...
public static unsafe partial class MsftDiscFormat2TrackAtOnceTests
{
    ...
    {
        Assert.That(
            typeof(MsftDiscFormat2TrackAtOnce).GUID,
            Is.EqualTo(CLSID_MsftDiscFormat2TrackAtOnce)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<MsftDiscFormat2TrackAtOnce>(),
            Is.EqualTo(sizeof(MsftDiscFormat2TrackAtOnce))
        );
    }
