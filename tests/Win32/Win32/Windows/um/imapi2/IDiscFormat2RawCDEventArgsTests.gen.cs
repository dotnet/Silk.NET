...
public static unsafe partial class IDiscFormat2RawCDEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IDiscFormat2RawCDEventArgs).GUID,
            Is.EqualTo(IID_IDiscFormat2RawCDEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDiscFormat2RawCDEventArgs>(),
            Is.EqualTo(sizeof(IDiscFormat2RawCDEventArgs))
        );
    }
