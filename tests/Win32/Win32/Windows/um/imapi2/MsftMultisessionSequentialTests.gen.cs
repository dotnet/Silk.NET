...
public static unsafe partial class MsftMultisessionSequentialTests
{
    ...
    {
        Assert.That(
            typeof(MsftMultisessionSequential).GUID,
            Is.EqualTo(CLSID_MsftMultisessionSequential)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<MsftMultisessionSequential>(),
            Is.EqualTo(sizeof(MsftMultisessionSequential))
        );
    }
