...
public static unsafe partial class IDiscFormat2DataEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IDiscFormat2DataEventArgs).GUID,
            Is.EqualTo(IID_IDiscFormat2DataEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDiscFormat2DataEventArgs>(),
            Is.EqualTo(sizeof(IDiscFormat2DataEventArgs))
        );
    }
