...
public static unsafe partial class MsftMultisessionRandomWriteTests
{
    ...
    {
        Assert.That(
            typeof(MsftMultisessionRandomWrite).GUID,
            Is.EqualTo(CLSID_MsftMultisessionRandomWrite)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<MsftMultisessionRandomWrite>(),
            Is.EqualTo(sizeof(MsftMultisessionRandomWrite))
        );
    }
