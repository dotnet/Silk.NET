...
public static unsafe partial class IWICBitmapSourceTransformTests
{
    ...
    {
        Assert.That(
            typeof(IWICBitmapSourceTransform).GUID,
            Is.EqualTo(IID_IWICBitmapSourceTransform)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IWICBitmapSourceTransform>(),
            Is.EqualTo(sizeof(IWICBitmapSourceTransform))
        );
    }
