...
public static partial class GUIDTests
{
    ...
    public static void GUID_VendorMicrosoftTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xf0e749ca, 0xedef, 0x4589, 0xa7, 0x3a, 0xee, 0xe, 0x62, 0x6a, 0x2a, 0x2b)
            )
        );
    }
    ...
    public static void GUID_VendorMicrosoftBuiltInTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x257a30fd, 0x6b6, 0x462b, 0xae, 0xa4, 0x63, 0xf7, 0xb, 0x86, 0xe5, 0x33)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatBmpTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x0af1d87e, 0xfcfe, 0x4188, 0xbd, 0xeb, 0xa7, 0x90, 0x64, 0x71, 0xcb, 0xe3)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatPngTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b7cfaf4, 0x713f, 0x473c, 0xbb, 0xcd, 0x61, 0x37, 0x42, 0x5f, 0xae, 0xaf)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatIcoTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xa3a860c4, 0x338f, 0x4c17, 0x91, 0x9a, 0xfb, 0xa4, 0xb5, 0x62, 0x8f, 0x21)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatTiffTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x163bcc30, 0xe2e9, 0x4f0b, 0x96, 0x1d, 0xa3, 0xe9, 0xfd, 0xb7, 0x88, 0xa3)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatGifTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1f8a5601, 0x7d4d, 0x4cbd, 0x9c, 0x82, 0x1b, 0xc8, 0xd4, 0xee, 0xb9, 0xa5)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatWmpTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x57a37caa, 0x367a, 0x4540, 0x91, 0x6b, 0xf1, 0x83, 0xc5, 0x09, 0x3a, 0x4b)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatDdsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x9967cb95, 0x2e85, 0x4ac8, 0x8c, 0xa2, 0x83, 0xd7, 0xcc, 0xd4, 0x25, 0xc9)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatAdngTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xf3ff6d0d, 0x38c0, 0x41c4, 0xb1, 0xfe, 0x1f, 0x38, 0x24, 0xf1, 0x7b, 0x84)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatHeifTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xe1e62521, 0x6787, 0x405b, 0xa3, 0x39, 0x50, 0x07, 0x15, 0xb5, 0x76, 0x3f)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatWebpTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xe094b0e2, 0x67f2, 0x45b3, 0xb0, 0xea, 0x11, 0x53, 0x37, 0xca, 0x7c, 0xf3)
            )
        );
    }
    ...
    public static void GUID_ContainerFormatRawTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xfe99ce60, 0xf19c, 0x433c, 0xa3, 0xae, 0x00, 0xac, 0xef, 0xa9, 0xca, 0x21)
            )
        );
    }
    ...
    {
        Assert.That(
            GUID_ContainerFormatJpegXL,
            Is.EqualTo(
                new Guid(0xfec14e3f, 0x427a, 0x4736, 0xaa, 0xe6, 0x27, 0xed, 0x84, 0xf6, 0x93, 0x22)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat1bppIndexedTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x01)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat2bppIndexedTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x02)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat4bppIndexedTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x03)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat2bppGrayTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x06)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat4bppGrayTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x07)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat8bppAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xe6cd0116, 0xeeba, 0x4161, 0xaa, 0x85, 0x27, 0xdd, 0x9f, 0xb3, 0xa8, 0x95)
            )
        );
    }
    ...
    public static void GUID_WICPixelForm
test()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x25238D72, 0xFCF9, 0x4522, 0xb5, 0x14, 0x55, 0x78, 0xe5, 0xad, 0x55, 0xe0)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat32bppRGBA1010102XRTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x00DE6B9A, 0xC101, 0x434b, 0xb5, 0x02, 0xd0, 0x16, 0x5e, 0xe1, 0x12, 0x2c)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat32bppR10G10B10A2Test()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x604e1bb5, 0x8a3c, 0x4b65, 0xb1, 0x1c, 0xbc, 0x0b, 0x8d, 0xd7, 0x5b, 0x7f)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat32bppR10G10B10A2HDR10Test()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x9c215c5d, 0x1acc, 0x4f0e, 0xa4, 0xbc, 0x70, 0xfb, 0x3a, 0xe8, 0xfd, 0x28)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat64bppCMYKTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x1f)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat24bpp3ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x20)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat32bpp4ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x21)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat40bpp5ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x22)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat48bpp6ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x23)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat56bpp7ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x24)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat64bpp8ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x25)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat48bpp3ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x26)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat64bpp4ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x27)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat80bpp5ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x28)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat96bpp6ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x29)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat112bpp7ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x2a)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat128bpp8ChannelsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x2b)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat40bppCMYKAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x2c)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat80bppCMYKAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x2d)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat32bpp3ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x2e)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat40bpp4ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x2f)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat48bpp5ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x30)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat56bpp6ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x31)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat64bpp7ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x32)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat72bpp8ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x33)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat64bpp3ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x34)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat80bpp4ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x35)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat96bpp5ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x36)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat112bpp6ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x37)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat128bpp7ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x38)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat144bpp8ChannelsAlphaTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6fddc324, 0x4e03, 0x4bfe, 0xb1, 0x85, 0x3d, 0x77, 0x76, 0x8d, 0xc9, 0x39)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat8bppYTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x91B4DB54, 0x2DF9, 0x42F0, 0xB4, 0x49, 0x29, 0x09, 0xBB, 0x3D, 0xF8, 0x8E)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat8bppCbTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1339F224, 0x6BFE, 0x4C3E, 0x93, 0x02, 0xE4, 0xF3, 0xA6, 0xD0, 0xCA, 0x2A)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat8bppCrTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xB8145053, 0x2116, 0x49F0, 0x88, 0x35, 0xED, 0x84, 0x4B, 0x20, 0x5C, 0x51)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat16bppCbCrTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xFF95BA6E, 0x11E0, 0x4263, 0xBB, 0x45, 0x01, 0x72, 0x1F, 0x34, 0x60, 0xA4)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat16bppYQuantizedDctCoefficientsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xA355F433, 0x48E8, 0x4A42, 0x84, 0xD8, 0xE2, 0xAA, 0x26, 0xCA, 0x80, 0xA4)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat16bppCbQuantizedDctCoefficientsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xD2C4FF61, 0x56A5, 0x49C2, 0x8B, 0x5C, 0x4C, 0x19, 0x25, 0x96, 0x48, 0x37)
            )
        );
    }
    ...
    public static void GUID_WICPixelFormat16bppCrQuantizedDctCoefficientsTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x2FE354F0, 0x1680, 0x42D8, 0x92, 0x31, 0xE7, 0x3C, 0x05, 0x65, 0xBF, 0xC1)
            )
        );
    }
}
