...
public static unsafe partial class IWICPlanarBitmapFrameEncodeTests
{
    ...
    {
        Assert.That(
            typeof(IWICPlanarBitmapFrameEncode).GUID,
            Is.EqualTo(IID_IWICPlanarBitmapFrameEncode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IWICPlanarBitmapFrameEncode>(),
            Is.EqualTo(sizeof(IWICPlanarBitmapFrameEncode))
        );
    }
