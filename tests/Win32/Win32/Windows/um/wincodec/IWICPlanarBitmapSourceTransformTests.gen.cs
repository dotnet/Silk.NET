...
public static unsafe partial class IWICPlanarBitmapSourceTransformTests
{
    ...
    {
        Assert.That(
            typeof(IWICPlanarBitmapSourceTransform).GUID,
            Is.EqualTo(IID_IWICPlanarBitmapSourceTransform)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IWICPlanarBitmapSourceTransform>(),
            Is.EqualTo(sizeof(IWICPlanarBitmapSourceTransform))
        );
    }
