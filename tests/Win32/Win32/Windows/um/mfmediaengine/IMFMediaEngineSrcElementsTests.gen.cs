...
public static unsafe partial class IMFMediaEngineSrcElementsTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaEngineSrcElements).GUID,
            Is.EqualTo(IID_IMFMediaEngineSrcElements)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaEngineSrcElements>(),
            Is.EqualTo(sizeof(IMFMediaEngineSrcElements))
        );
    }
