...
public static unsafe partial class IMFMediaEngineWebSupportTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaEngineWebSupport).GUID,
            Is.EqualTo(IID_IMFMediaEngineWebSupport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaEngineWebSupport>(),
            Is.EqualTo(sizeof(IMFMediaEngineWebSupport))
        );
    }
