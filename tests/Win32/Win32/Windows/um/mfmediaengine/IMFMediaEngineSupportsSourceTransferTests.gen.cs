...
public static unsafe partial class IMFMediaEngineSupportsSourceTransferTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaEngineSupportsSourceTransfer).GUID,
            Is.EqualTo(IID_IMFMediaEngineSupportsSourceTransfer)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaEngineSupportsSourceTransfer>(),
            Is.EqualTo(sizeof(IMFMediaEngineSupportsSourceTransfer))
        );
    }
