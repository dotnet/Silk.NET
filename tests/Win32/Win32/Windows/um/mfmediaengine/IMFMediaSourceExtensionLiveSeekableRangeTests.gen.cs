...
public static unsafe partial class IMFMediaSourceExtensionLiveSeekableRangeTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaSourceExtensionLiveSeekableRange).GUID,
            Is.EqualTo(IID_IMFMediaSourceExtensionLiveSeekableRange)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaSourceExtensionLiveSeekableRange>(),
            Is.EqualTo(sizeof(IMFMediaSourceExtensionLiveSeekableRange))
        );
    }
