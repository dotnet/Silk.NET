...
public static unsafe partial class IMFMediaSourceExtensionNotifyTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaSourceExtensionNotify).GUID,
            Is.EqualTo(IID_IMFMediaSourceExtensionNotify)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaSourceExtensionNotify>(),
            Is.EqualTo(sizeof(IMFMediaSourceExtensionNotify))
        );
    }
