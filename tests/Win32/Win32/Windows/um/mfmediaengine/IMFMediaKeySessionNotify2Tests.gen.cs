...
public static unsafe partial class IMFMediaKeySessionNotify2Tests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaKeySessionNotify2).GUID,
            Is.EqualTo(IID_IMFMediaKeySessionNotify2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaKeySessionNotify2>(),
            Is.EqualTo(sizeof(IMFMediaKeySessionNotify2))
        );
    }
