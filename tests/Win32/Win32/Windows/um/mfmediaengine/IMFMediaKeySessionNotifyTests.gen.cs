...
public static unsafe partial class IMFMediaKeySessionNotifyTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaKeySessionNotify).GUID,
            Is.EqualTo(IID_IMFMediaKeySessionNotify)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaKeySessionNotify>(),
            Is.EqualTo(sizeof(IMFMediaKeySessionNotify))
        );
    }
