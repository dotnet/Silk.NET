...
public static unsafe partial class IMFMediaEngineTransferSourceTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaEngineTransferSource).GUID,
            Is.EqualTo(IID_IMFMediaEngineTransferSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaEngineTransferSource>(),
            Is.EqualTo(sizeof(IMFMediaEngineTransferSource))
        );
    }
