...
public static unsafe partial class IMFMediaEngineClassFactory2Tests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaEngineClassFactory2).GUID,
            Is.EqualTo(IID_IMFMediaEngineClassFactory2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaEngineClassFactory2>(),
            Is.EqualTo(sizeof(IMFMediaEngineClassFactory2))
        );
    }
