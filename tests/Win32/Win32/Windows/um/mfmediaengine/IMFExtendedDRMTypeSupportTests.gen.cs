...
public static unsafe partial class IMFExtendedDRMTypeSupportTests
{
    ...
    {
        Assert.That(
            typeof(IMFExtendedDRMTypeSupport).GUID,
            Is.EqualTo(IID_IMFExtendedDRMTypeSupport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFExtendedDRMTypeSupport>(),
            Is.EqualTo(sizeof(IMFExtendedDRMTypeSupport))
        );
    }
