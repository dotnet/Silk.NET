...
public static unsafe partial class IMFSourceBufferAppendModeTests
{
    ...
    {
        Assert.That(
            typeof(IMFSourceBufferAppendMode).GUID,
            Is.EqualTo(IID_IMFSourceBufferAppendMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSourceBufferAppendMode>(),
            Is.EqualTo(sizeof(IMFSourceBufferAppendMode))
        );
    }
