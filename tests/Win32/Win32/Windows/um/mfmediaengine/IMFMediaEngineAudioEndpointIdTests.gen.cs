...
public static unsafe partial class IMFMediaEngineAudioEndpointIdTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaEngineAudioEndpointId).GUID,
            Is.EqualTo(IID_IMFMediaEngineAudioEndpointId)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaEngineAudioEndpointId>(),
            Is.EqualTo(sizeof(IMFMediaEngineAudioEndpointId))
        );
    }
