...
public static unsafe partial class WindowsTests
{
    ...
    public static void MFP_POSITIONTYPE_100NSTest()
    {
        Assert.That(
            ...
            Is.EqualTo(new Guid(0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0))
        );
    }
    ...
    {
        Assert.That(
            MFP_PKEY_StreamIndex.fmtid,
            Is.EqualTo(
                new Guid(0xa7cf9740, 0xe8d9, 0x4a87, 0xbd, 0x8e, 0x29, 0x67, 0x0, 0x1f, 0xd3, 0xad)
            )
        );
    ...
    {
        Assert.That(
            MFP_PKEY_StreamRenderingResults.fmtid,
            Is.EqualTo(
                new Guid(0xa7cf9740, 0xe8d9, 0x4a87, 0xbd, 0x8e, 0x29, 0x67, 0x0, 0x1f, 0xd3, 0xad)
            )
        );
