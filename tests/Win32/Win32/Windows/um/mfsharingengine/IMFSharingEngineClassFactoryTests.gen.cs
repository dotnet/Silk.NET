...
public static unsafe partial class IMFSharingEngineClassFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IMFSharingEngineClassFactory).GUID,
            Is.EqualTo(IID_IMFSharingEngineClassFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSharingEngineClassFactory>(),
            Is.EqualTo(sizeof(IMFSharingEngineClassFactory))
        );
    }
