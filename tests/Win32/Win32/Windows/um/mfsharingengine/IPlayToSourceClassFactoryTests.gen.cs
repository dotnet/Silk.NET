...
public static unsafe partial class IPlayToSourceClassFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IPlayToSourceClassFactory).GUID,
            Is.EqualTo(IID_IPlayToSourceClassFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPlayToSourceClassFactory>(),
            Is.EqualTo(sizeof(IPlayToSourceClassFactory))
        );
    }
