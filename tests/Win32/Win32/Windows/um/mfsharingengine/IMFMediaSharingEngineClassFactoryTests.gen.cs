...
public static unsafe partial class IMFMediaSharingEngineClassFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IMFMediaSharingEngineClassFactory).GUID,
            Is.EqualTo(IID_IMFMediaSharingEngineClassFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFMediaSharingEngineClassFactory>(),
            Is.EqualTo(sizeof(IMFMediaSharingEngineClassFactory))
        );
    }
