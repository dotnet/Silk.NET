...
public static partial class CLSIDTests
{
    ...
    public static void CLSID_MFMediaSharingEngineClassFactoryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xf8e307fb, 0x6d45, 0x4ad3, 0x99, 0x93, 0x66, 0xcd, 0x5a, 0x52, 0x96, 0x59)
            )
        );
    }
    ...
    public static void CLSID_MFImageSharingEngineClassFactoryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xb22c3339, 0x87f3, 0x4059, 0xa0, 0xc5, 0x3, 0x7a, 0xa9, 0x70, 0x7e, 0xaf)
            )
        );
    }
    ...
    public static void CLSID_PlayToSourceClassFactoryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xDA17539A, 0x3DC3, 0x42C1, 0xA7, 0x49, 0xA1, 0x83, 0xB5, 0x1F, 0x08, 0x5E)
            )
        );
    }
}
