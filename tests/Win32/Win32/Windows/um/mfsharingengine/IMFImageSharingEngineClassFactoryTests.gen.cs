...
public static unsafe partial class IMFImageSharingEngineClassFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IMFImageSharingEngineClassFactory).GUID,
            Is.EqualTo(IID_IMFImageSharingEngineClassFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFImageSharingEngineClassFactory>(),
            Is.EqualTo(sizeof(IMFImageSharingEngineClassFactory))
        );
    }
