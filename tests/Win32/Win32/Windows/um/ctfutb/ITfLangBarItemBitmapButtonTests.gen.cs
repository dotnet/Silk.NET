...
public static unsafe partial class ITfLangBarItemBitmapButtonTests
{
    ...
    {
        Assert.That(
            typeof(ITfLangBarItemBitmapButton).GUID,
            Is.EqualTo(IID_ITfLangBarItemBitmapButton)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfLangBarItemBitmapButton>(),
            Is.EqualTo(sizeof(ITfLangBarItemBitmapButton))
        );
    }
