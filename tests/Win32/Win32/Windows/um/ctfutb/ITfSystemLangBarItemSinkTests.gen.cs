...
public static unsafe partial class ITfSystemLangBarItemSinkTests
{
    ...
    {
        Assert.That(
            typeof(ITfSystemLangBarItemSink).GUID,
            Is.EqualTo(IID_ITfSystemLangBarItemSink)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfSystemLangBarItemSink>(),
            Is.EqualTo(sizeof(ITfSystemLangBarItemSink))
        );
    }
