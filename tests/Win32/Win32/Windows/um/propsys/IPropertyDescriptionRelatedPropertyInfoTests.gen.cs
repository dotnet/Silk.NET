...
public static unsafe partial class IPropertyDescriptionRelatedPropertyInfoTests
{
    ...
    {
        Assert.That(
            typeof(IPropertyDescriptionRelatedPropertyInfo).GUID,
            Is.EqualTo(IID_IPropertyDescriptionRelatedPropertyInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPropertyDescriptionRelatedPropertyInfo>(),
            Is.EqualTo(sizeof(IPropertyDescriptionRelatedPropertyInfo))
        );
    }
