...
public static unsafe partial class IDelayedPropertyStoreFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IDelayedPropertyStoreFactory).GUID,
            Is.EqualTo(IID_IDelayedPropertyStoreFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDelayedPropertyStoreFactory>(),
            Is.EqualTo(sizeof(IDelayedPropertyStoreFactory))
        );
    }
