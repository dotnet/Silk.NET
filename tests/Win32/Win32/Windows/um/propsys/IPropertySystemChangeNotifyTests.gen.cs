...
public static unsafe partial class IPropertySystemChangeNotifyTests
{
    ...
    {
        Assert.That(
            typeof(IPropertySystemChangeNotify).GUID,
            Is.EqualTo(IID_IPropertySystemChangeNotify)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPropertySystemChangeNotify>(),
            Is.EqualTo(sizeof(IPropertySystemChangeNotify))
        );
    }
