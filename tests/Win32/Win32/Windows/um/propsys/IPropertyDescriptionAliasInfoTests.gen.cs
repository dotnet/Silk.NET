...
public static unsafe partial class IPropertyDescriptionAliasInfoTests
{
    ...
    {
        Assert.That(
            typeof(IPropertyDescriptionAliasInfo).GUID,
            Is.EqualTo(IID_IPropertyDescriptionAliasInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPropertyDescriptionAliasInfo>(),
            Is.EqualTo(sizeof(IPropertyDescriptionAliasInfo))
        );
    }
