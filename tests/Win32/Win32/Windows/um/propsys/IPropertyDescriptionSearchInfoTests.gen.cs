...
public static unsafe partial class IPropertyDescriptionSearchInfoTests
{
    ...
    {
        Assert.That(
            typeof(IPropertyDescriptionSearchInfo).GUID,
            Is.EqualTo(IID_IPropertyDescriptionSearchInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPropertyDescriptionSearchInfo>(),
            Is.EqualTo(sizeof(IPropertyDescriptionSearchInfo))
        );
    }
