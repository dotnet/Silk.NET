...
public static unsafe partial class IPropertyStoreCapabilitiesTests
{
    ...
    {
        Assert.That(
            typeof(IPropertyStoreCapabilities).GUID,
            Is.EqualTo(IID_IPropertyStoreCapabilities)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPropertyStoreCapabilities>(),
            Is.EqualTo(sizeof(IPropertyStoreCapabilities))
        );
    }
