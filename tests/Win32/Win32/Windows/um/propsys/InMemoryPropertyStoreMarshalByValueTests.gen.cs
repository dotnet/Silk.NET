...
public static unsafe partial class InMemoryPropertyStoreMarshalByValueTests
{
    ...
    {
        Assert.That(
            typeof(InMemoryPropertyStoreMarshalByValue).GUID,
            Is.EqualTo(CLSID_InMemoryPropertyStoreMarshalByValue)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<InMemoryPropertyStoreMarshalByValue>(),
            Is.EqualTo(sizeof(InMemoryPropertyStoreMarshalByValue))
        );
    }
