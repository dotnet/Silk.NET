...
public static unsafe partial class IProtectedModeMenuServicesTests
{
    ...
    {
        Assert.That(
            typeof(IProtectedModeMenuServices).GUID,
            Is.EqualTo(IID_IProtectedModeMenuServices)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IProtectedModeMenuServices>(),
            Is.EqualTo(sizeof(IProtectedModeMenuServices))
        );
    }
