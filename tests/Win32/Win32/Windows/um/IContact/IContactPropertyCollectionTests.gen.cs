...
public static unsafe partial class IContactPropertyCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IContactPropertyCollection).GUID,
            Is.EqualTo(IID_IContactPropertyCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IContactPropertyCollection>(),
            Is.EqualTo(sizeof(IContactPropertyCollection))
        );
    }
