...
public static unsafe partial class ISpatialAudioObjectForHrtfTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialAudioObjectForHrtf).GUID,
            Is.EqualTo(IID_ISpatialAudioObjectForHrtf)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialAudioObjectForHrtf>(),
            Is.EqualTo(sizeof(ISpatialAudioObjectForHrtf))
        );
    }
