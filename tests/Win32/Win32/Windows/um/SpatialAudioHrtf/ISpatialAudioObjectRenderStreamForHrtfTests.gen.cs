...
public static unsafe partial class ISpatialAudioObjectRenderStreamForHrtfTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialAudioObjectRenderStreamForHrtf).GUID,
            Is.EqualTo(IID_ISpatialAudioObjectRenderStreamForHrtf)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialAudioObjectRenderStreamForHrtf>(),
            Is.EqualTo(sizeof(ISpatialAudioObjectRenderStreamForHrtf))
        );
    }
