...
public static unsafe partial class IActiveIMMMessagePumpOwnerTests
{
    ...
    {
        Assert.That(
            typeof(IActiveIMMMessagePumpOwner).GUID,
            Is.EqualTo(IID_IActiveIMMMessagePumpOwner)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IActiveIMMMessagePumpOwner>(),
            Is.EqualTo(sizeof(IActiveIMMMessagePumpOwner))
        );
    }
