...
public static unsafe partial class IUniformResourceLocatorWTests
{
    ...
    {
        Assert.That(
            typeof(IUniformResourceLocatorW).GUID,
            Is.EqualTo(IID_IUniformResourceLocatorW)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUniformResourceLocatorW>(),
            Is.EqualTo(sizeof(IUniformResourceLocatorW))
        );
    }
