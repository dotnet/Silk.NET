...
public static unsafe partial class IUIAnimationManagerEventHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationManagerEventHandler).GUID,
            Is.EqualTo(IID_IUIAnimationManagerEventHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationManagerEventHandler>(),
            Is.EqualTo(sizeof(IUIAnimationManagerEventHandler))
        );
    }
