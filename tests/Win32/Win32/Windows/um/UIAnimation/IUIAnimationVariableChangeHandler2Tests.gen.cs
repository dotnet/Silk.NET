...
public static unsafe partial class IUIAnimationVariableChangeHandler2Tests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationVariableChangeHandler2).GUID,
            Is.EqualTo(IID_IUIAnimationVariableChangeHandler2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationVariableChangeHandler2>(),
            Is.EqualTo(sizeof(IUIAnimationVariableChangeHandler2))
        );
    }
