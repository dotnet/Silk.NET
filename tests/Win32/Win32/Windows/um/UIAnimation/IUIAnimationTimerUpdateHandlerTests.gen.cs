...
public static unsafe partial class IUIAnimationTimerUpdateHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationTimerUpdateHandler).GUID,
            Is.EqualTo(IID_IUIAnimationTimerUpdateHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationTimerUpdateHandler>(),
            Is.EqualTo(sizeof(IUIAnimationTimerUpdateHandler))
        );
    }
