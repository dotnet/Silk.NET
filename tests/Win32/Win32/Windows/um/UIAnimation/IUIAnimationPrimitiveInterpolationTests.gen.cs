...
public static unsafe partial class IUIAnimationPrimitiveInterpolationTests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationPrimitiveInterpolation).GUID,
            Is.EqualTo(IID_IUIAnimationPrimitiveInterpolation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationPrimitiveInterpolation>(),
            Is.EqualTo(sizeof(IUIAnimationPrimitiveInterpolation))
        );
    }
