...
public static unsafe partial class IUIAnimationPriorityComparison2Tests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationPriorityComparison2).GUID,
            Is.EqualTo(IID_IUIAnimationPriorityComparison2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationPriorityComparison2>(),
            Is.EqualTo(sizeof(IUIAnimationPriorityComparison2))
        );
    }
