...
public static unsafe partial class IUIAnimationStoryboardEventHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationStoryboardEventHandler).GUID,
            Is.EqualTo(IID_IUIAnimationStoryboardEventHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationStoryboardEventHandler>(),
            Is.EqualTo(sizeof(IUIAnimationStoryboardEventHandler))
        );
    }
