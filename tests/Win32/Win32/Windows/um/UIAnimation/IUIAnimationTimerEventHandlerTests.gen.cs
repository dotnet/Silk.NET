...
public static unsafe partial class IUIAnimationTimerEventHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationTimerEventHandler).GUID,
            Is.EqualTo(IID_IUIAnimationTimerEventHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationTimerEventHandler>(),
            Is.EqualTo(sizeof(IUIAnimationTimerEventHandler))
        );
    }
