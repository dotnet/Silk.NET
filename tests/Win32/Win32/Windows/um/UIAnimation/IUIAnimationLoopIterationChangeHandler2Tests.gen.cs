...
public static unsafe partial class IUIAnimationLoopIterationChangeHandler2Tests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationLoopIterationChangeHandler2).GUID,
            Is.EqualTo(IID_IUIAnimationLoopIterationChangeHandler2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationLoopIterationChangeHandler2>(),
            Is.EqualTo(sizeof(IUIAnimationLoopIterationChangeHandler2))
        );
    }
