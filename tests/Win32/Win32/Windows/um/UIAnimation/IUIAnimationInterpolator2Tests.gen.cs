...
public static unsafe partial class IUIAnimationInterpolator2Tests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationInterpolator2).GUID,
            Is.EqualTo(IID_IUIAnimationInterpolator2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationInterpolator2>(),
            Is.EqualTo(sizeof(IUIAnimationInterpolator2))
        );
    }
