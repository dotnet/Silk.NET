...
public static unsafe partial class IUIAnimationVariableIntegerChangeHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IUIAnimationVariableIntegerChangeHandler).GUID,
            Is.EqualTo(IID_IUIAnimationVariableIntegerChangeHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUIAnimationVariableIntegerChangeHandler>(),
            Is.EqualTo(sizeof(IUIAnimationVariableIntegerChangeHandler))
        );
    }
