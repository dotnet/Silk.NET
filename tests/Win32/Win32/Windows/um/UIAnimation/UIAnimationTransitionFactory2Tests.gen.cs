...
public static unsafe partial class UIAnimationTransitionFactory2Tests
{
    ...
    {
        Assert.That(
            typeof(UIAnimationTransitionFactory2).GUID,
            Is.EqualTo(CLSID_UIAnimationTransitionFactory2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<UIAnimationTransitionFactory2>(),
            Is.EqualTo(sizeof(UIAnimationTransitionFactory2))
        );
    }
