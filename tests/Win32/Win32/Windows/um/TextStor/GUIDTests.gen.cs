...
public static partial class GUIDTests
{
    ...
    public static void GUID_TS_SERVICE_DATAOBJECTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6086fbb5, 0xe225, 0x46ce, 0xa7, 0x70, 0xc1, 0xbb, 0xd3, 0xe0, 0x5d, 0x7b)
            )
        );
    }
    ...
    public static void GUID_TS_SERVICE_ACCESSIBLETest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xf9786200, 0xa5bf, 0x4a0f, 0x8c, 0x24, 0xfb, 0x16, 0xf5, 0xd1, 0xaa, 0xbb)
            )
        );
    }
    ...
    public static void GUID_TS_SERVICE_ACTIVEXTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xea937a50, 0xc9a6, 0x4b7d, 0x89, 0x4a, 0x49, 0xd9, 0x9b, 0x78, 0x48, 0x34)
            )
        );
    }
}
