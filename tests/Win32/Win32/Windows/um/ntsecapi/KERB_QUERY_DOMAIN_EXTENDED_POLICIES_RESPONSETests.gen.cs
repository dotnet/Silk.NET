...
public static unsafe partial class KERB_QUERY_DOMAIN_EXTENDED_POLICIES_RESPONSETests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<KERB_QUERY_DOMAIN_EXTENDED_POLICIES_RESPONSE>(),
            Is.EqualTo(sizeof(KERB_QUERY_DOMAIN_EXTENDED_POLICIES_RESPONSE))
        );
    }
    ...
    {
        Assert.That(
            typeof(KERB_QUERY_DOMAIN_EXTENDED_POLICIES_RESPONSE).IsLayoutSequential,
            Is.True
        );
    }
