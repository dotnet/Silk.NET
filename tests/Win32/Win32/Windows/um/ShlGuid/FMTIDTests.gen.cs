...
public static partial class FMTIDTests
{
    ...
    public static void FMTID_IntshcutTest()
    {
        Assert.That(
            FMTID_Intshcut,
            Is.EqualTo(new Guid(0x000214A0, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void FMTID_InternetSiteTest()
    {
        Assert.That(
            FMTID_InternetSite,
            Is.EqualTo(new Guid(0x000214A1, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void FMTID_ShellDetailsTest()
    {
        Assert.That(
            FMTID_ShellDetails,
            Is.EqualTo(
                new Guid(0x28636aa6, 0x953d, 0x11d2, 0xb5, 0xd6, 0x0, 0xc0, 0x4f, 0xd9, 0x18, 0xd0)
            )
        );
    }
    ...
    public static void FMTID_CustomImagePropertiesTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x7ecd8b0e, 0xc136, 0x4a9b, 0x94, 0x11, 0x4e, 0xbd, 0x66, 0x73, 0xcc, 0xc3)
            )
        );
    }
    ...
    public static void FMTID_DisplacedTest()
    {
        Assert.That(
            FMTID_Displaced,
            Is.EqualTo(
                new Guid(0x9b174b33, 0x40ff, 0x11d2, 0xa2, 0x7e, 0x0, 0xc0, 0x4f, 0xc3, 0x8, 0x71)
            )
        );
    }
    ...
    public static void FMTID_BriefcaseTest()
    {
        Assert.That(
            FMTID_Briefcase,
            Is.EqualTo(
                new Guid(0x328d8b21, 0x7729, 0x4bfc, 0x95, 0x4c, 0x90, 0x2b, 0x32, 0x9d, 0x56, 0xb0)
            )
        );
    }
    ...
    public static void FMTID_MiscTest()
    {
        Assert.That(
            FMTID_Misc,
            Is.EqualTo(
                new Guid(0x9b174b34, 0x40ff, 0x11d2, 0xa2, 0x7e, 0x0, 0xc0, 0x4f, 0xc3, 0x8, 0x71)
            )
        );
    }
    ...
    public static void FMTID_MUSICTest()
    {
        Assert.That(
            FMTID_MUSIC,
            Is.EqualTo(
                new Guid(0x56a3372e, 0xce9c, 0x11d2, 0x9f, 0xe, 0x0, 0x60, 0x97, 0xc6, 0x86, 0xf6)
            )
        );
    }
    ...
    public static void FMTID_VolumeTest()
    {
        Assert.That(
            FMTID_Volume,
            Is.EqualTo(
                new Guid(0x9b174b35, 0x40ff, 0x11d2, 0xa2, 0x7e, 0x0, 0xc0, 0x4f, 0xc3, 0x8, 0x71)
            )
        );
    }
