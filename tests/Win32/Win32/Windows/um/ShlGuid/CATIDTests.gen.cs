...
public static partial class CATIDTests
{
    ...
    public static void CATID_BrowsableShellExtTest()
    {
        Assert.That(
            ...
            Is.EqualTo(new Guid(0x00021490, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void CATID_BrowseInPlaceTest()
    {
        Assert.That(
            CATID_BrowseInPlace,
            Is.EqualTo(new Guid(0x00021491, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void CATID_DeskBandTest()
    {
        Assert.That(
            CATID_DeskBand,
            Is.EqualTo(new Guid(0x00021492, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void CATID_InfoBandTest()
    {
        Assert.That(
            CATID_InfoBand,
            Is.EqualTo(new Guid(0x00021493, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void CATID_CommBandTest()
    {
        Assert.That(
            CATID_CommBand,
            Is.EqualTo(new Guid(0x00021494, 0, 0, 0xC0, 0, 0, 0, 0, 0, 0, 0x46))
        );
    }
    ...
    public static void CATID_FilePlaceholderMergeHandlerTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x3e9c9a51, 0xd4aa, 0x4870, 0xb4, 0x7c, 0x74, 0x24, 0xb4, 0x91, 0xf1, 0xcc)
            )
        );
    }
    ...
    public static void CATID_LocationFactoryTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x965c4d51, 0x8b76, 0x4e57, 0x80, 0xb7, 0x56, 0x4d, 0x2e, 0xa4, 0xb5, 0x5e)
            )
        );
    }
    ...
    public static void CATID_LocationProviderTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b3ca474, 0x2614, 0x414b, 0xb8, 0x13, 0x1a, 0xce, 0xca, 0x3e, 0x3d, 0xd8)
            )
        );
    }
    ...
    public static void CATID_SearchableApplicationTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x366c292a, 0xd9b3, 0x4dbf, 0xbb, 0x70, 0xe6, 0x2e, 0xc3, 0xd0, 0xbb, 0xbf)
            )
        );
    }
}
