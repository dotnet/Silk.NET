...
public static unsafe partial class ISyncMgrConflictPresenterTests
{
    ...
    {
        Assert.That(
            typeof(ISyncMgrConflictPresenter).GUID,
            Is.EqualTo(IID_ISyncMgrConflictPresenter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISyncMgrConflictPresenter>(),
            Is.EqualTo(sizeof(ISyncMgrConflictPresenter))
        );
    }
