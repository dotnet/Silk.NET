...
public static unsafe partial class ISyncMgrSyncItemContainerTests
{
    ...
    {
        Assert.That(
            typeof(ISyncMgrSyncItemContainer).GUID,
            Is.EqualTo(IID_ISyncMgrSyncItemContainer)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISyncMgrSyncItemContainer>(),
            Is.EqualTo(sizeof(ISyncMgrSyncItemContainer))
        );
    }
