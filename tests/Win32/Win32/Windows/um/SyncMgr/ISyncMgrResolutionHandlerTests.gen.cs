...
public static unsafe partial class ISyncMgrResolutionHandlerTests
{
    ...
    {
        Assert.That(
            typeof(ISyncMgrResolutionHandler).GUID,
            Is.EqualTo(IID_ISyncMgrResolutionHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISyncMgrResolutionHandler>(),
            Is.EqualTo(sizeof(ISyncMgrResolutionHandler))
        );
    }
