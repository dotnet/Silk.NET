...
public static unsafe partial class ISyncMgrScheduleWizardUIOperationTests
{
    ...
    {
        Assert.That(
            typeof(ISyncMgrScheduleWizardUIOperation).GUID,
            Is.EqualTo(IID_ISyncMgrScheduleWizardUIOperation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISyncMgrScheduleWizardUIOperation>(),
            Is.EqualTo(sizeof(ISyncMgrScheduleWizardUIOperation))
        );
    }
