...
public static unsafe partial class WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATETests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE>(),
            Is.EqualTo(sizeof(WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE))
        );
    }
    ...
    {
        Assert.That(
            typeof(WS_TCP_SSPI_KERBEROS_APREQ_BINDING_TEMPLATE).IsLayoutSequential,
            Is.True
        );
    }
