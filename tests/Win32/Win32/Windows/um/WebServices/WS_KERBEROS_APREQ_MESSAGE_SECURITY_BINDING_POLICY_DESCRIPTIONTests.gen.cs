...
public static unsafe partial class WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_POLICY_DESCRIPTIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_POLICY_DESCRIPTION>(),
            Is.EqualTo(sizeof(WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_POLICY_DESCRIPTION))
        );
    }
    ...
    {
        Assert.That(
            typeof(WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_POLICY_DESCRIPTION).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(WS_KERBEROS_APREQ_MESSAGE_SECURITY_BINDING_POLICY_DESCRIPTION),
                Is.EqualTo(24)
            );
        }
        else
