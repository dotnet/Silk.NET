...
public static unsafe partial class ITypeLibRegistrationReaderTests
{
    ...
    {
        Assert.That(
            typeof(ITypeLibRegistrationReader).GUID,
            Is.EqualTo(IID_ITypeLibRegistrationReader)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITypeLibRegistrationReader>(),
            Is.EqualTo(sizeof(ITypeLibRegistrationReader))
        );
    }
