...
public static unsafe partial class IAdvancedMediaCaptureInitializationSettingsTests
{
    ...
    {
        Assert.That(
            typeof(IAdvancedMediaCaptureInitializationSettings).GUID,
            Is.EqualTo(IID_IAdvancedMediaCaptureInitializationSettings)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAdvancedMediaCaptureInitializationSettings>(),
            Is.EqualTo(sizeof(IAdvancedMediaCaptureInitializationSettings))
        );
    }
    ...
    {
        Assert.That(
            typeof(IAdvancedMediaCaptureInitializationSettings).IsLayoutSequential,
            Is.True
        );
    }
