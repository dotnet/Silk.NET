...
public static unsafe partial class ISpatialAudioObjectRenderStreamNotifyTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialAudioObjectRenderStreamNotify).GUID,
            Is.EqualTo(IID_ISpatialAudioObjectRenderStreamNotify)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialAudioObjectRenderStreamNotify>(),
            Is.EqualTo(sizeof(ISpatialAudioObjectRenderStreamNotify))
        );
    }
