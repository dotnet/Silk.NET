...
public static unsafe partial class SpatialAudioObjectRenderStreamActivationParamsTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<SpatialAudioObjectRenderStreamActivationParams>(),
            Is.EqualTo(sizeof(SpatialAudioObjectRenderStreamActivationParams))
        );
    }
    ...
    {
        Assert.That(
            typeof(SpatialAudioObjectRenderStreamActivationParams).IsLayoutSequential,
            Is.True
        );
    }
