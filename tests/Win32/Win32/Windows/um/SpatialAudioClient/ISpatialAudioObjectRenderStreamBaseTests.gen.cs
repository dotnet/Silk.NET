...
public static unsafe partial class ISpatialAudioObjectRenderStreamBaseTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialAudioObjectRenderStreamBase).GUID,
            Is.EqualTo(IID_ISpatialAudioObjectRenderStreamBase)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialAudioObjectRenderStreamBase>(),
            Is.EqualTo(sizeof(ISpatialAudioObjectRenderStreamBase))
        );
    }
