...
public static unsafe partial class SpPhoneticAlphabetConverterTests
{
    ...
    {
        Assert.That(
            typeof(SpPhoneticAlphabetConverter).GUID,
            Is.EqualTo(IID_SpPhoneticAlphabetConverter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SpPhoneticAlphabetConverter>(),
            Is.EqualTo(sizeof(SpPhoneticAlphabetConverter))
        );
    }
