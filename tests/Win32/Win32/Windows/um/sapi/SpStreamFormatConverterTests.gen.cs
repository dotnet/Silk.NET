...
public static unsafe partial class SpStreamFormatConverterTests
{
    ...
    {
        Assert.That(
            typeof(SpStreamFormatConverter).GUID,
            Is.EqualTo(CLSID_SpStreamFormatConverter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<SpStreamFormatConverter>(),
            Is.EqualTo(sizeof(SpStreamFormatConverter))
        );
    }
