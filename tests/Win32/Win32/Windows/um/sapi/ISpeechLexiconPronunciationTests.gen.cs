...
public static unsafe partial class ISpeechLexiconPronunciationTests
{
    ...
    {
        Assert.That(
            typeof(ISpeechLexiconPronunciation).GUID,
            Is.EqualTo(IID_ISpeechLexiconPronunciation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpeechLexiconPronunciation>(),
            Is.EqualTo(sizeof(ISpeechLexiconPronunciation))
        );
    }
