...
public static unsafe partial class ISpStreamFormatConverterTests
{
    ...
    {
        Assert.That(
            typeof(ISpStreamFormatConverter).GUID,
            Is.EqualTo(IID_ISpStreamFormatConverter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpStreamFormatConverter>(),
            Is.EqualTo(sizeof(ISpStreamFormatConverter))
        );
    }
