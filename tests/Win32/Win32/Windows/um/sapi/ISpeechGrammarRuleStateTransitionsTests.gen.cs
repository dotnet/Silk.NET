...
public static unsafe partial class ISpeechGrammarRuleStateTransitionsTests
{
    ...
    {
        Assert.That(
            typeof(ISpeechGrammarRuleStateTransitions).GUID,
            Is.EqualTo(IID_ISpeechGrammarRuleStateTransitions)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpeechGrammarRuleStateTransitions>(),
            Is.EqualTo(sizeof(ISpeechGrammarRuleStateTransitions))
        );
    }
