...
public static unsafe partial class _ISpeechRecoContextEventsTests
{
    ...
    {
        Assert.That(
            typeof(_ISpeechRecoContextEvents).GUID,
            Is.EqualTo(DIID__ISpeechRecoContextEvents)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<_ISpeechRecoContextEvents>(),
            Is.EqualTo(sizeof(_ISpeechRecoContextEvents))
        );
    }
