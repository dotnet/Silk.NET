...
public static unsafe partial class ISpeechObjectTokenCategoryTests
{
    ...
    {
        Assert.That(
            typeof(ISpeechObjectTokenCategory).GUID,
            Is.EqualTo(IID_ISpeechObjectTokenCategory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpeechObjectTokenCategory>(),
            Is.EqualTo(sizeof(ISpeechObjectTokenCategory))
        );
    }
