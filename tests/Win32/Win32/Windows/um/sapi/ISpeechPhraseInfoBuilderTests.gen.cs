...
public static unsafe partial class ISpeechPhraseInfoBuilderTests
{
    ...
    {
        Assert.That(
            typeof(ISpeechPhraseInfoBuilder).GUID,
            Is.EqualTo(IID_ISpeechPhraseInfoBuilder)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpeechPhraseInfoBuilder>(),
            Is.EqualTo(sizeof(ISpeechPhraseInfoBuilder))
        );
    }
