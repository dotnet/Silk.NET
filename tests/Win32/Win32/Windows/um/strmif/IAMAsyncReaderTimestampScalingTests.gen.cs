...
public static unsafe partial class IAMAsyncReaderTimestampScalingTests
{
    ...
    {
        Assert.That(
            typeof(IAMAsyncReaderTimestampScaling).GUID,
            Is.EqualTo(IID_IAMAsyncReaderTimestampScaling)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAMAsyncReaderTimestampScaling>(),
            Is.EqualTo(sizeof(IAMAsyncReaderTimestampScaling))
        );
    }
