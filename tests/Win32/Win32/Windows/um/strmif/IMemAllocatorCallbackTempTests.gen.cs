...
public static unsafe partial class IMemAllocatorCallbackTempTests
{
    ...
    {
        Assert.That(
            typeof(IMemAllocatorCallbackTemp).GUID,
            Is.EqualTo(IID_IMemAllocatorCallbackTemp)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMemAllocatorCallbackTemp>(),
            Is.EqualTo(sizeof(IMemAllocatorCallbackTemp))
        );
    }
