...
public static unsafe partial class IDDrawExclModeVideoCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IDDrawExclModeVideoCallback).GUID,
            Is.EqualTo(IID_IDDrawExclModeVideoCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDDrawExclModeVideoCallback>(),
            Is.EqualTo(sizeof(IDDrawExclModeVideoCallback))
        );
    }
