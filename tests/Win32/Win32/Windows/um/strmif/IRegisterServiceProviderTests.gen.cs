...
public static unsafe partial class IRegisterServiceProviderTests
{
    ...
    {
        Assert.That(
            typeof(IRegisterServiceProvider).GUID,
            Is.EqualTo(IID_IRegisterServiceProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRegisterServiceProvider>(),
            Is.EqualTo(sizeof(IRegisterServiceProvider))
        );
    }
