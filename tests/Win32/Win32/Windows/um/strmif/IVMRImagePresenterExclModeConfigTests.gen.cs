...
public static unsafe partial class IVMRImagePresenterExclModeConfigTests
{
    ...
    {
        Assert.That(
            typeof(IVMRImagePresenterExclModeConfig).GUID,
            Is.EqualTo(IID_IVMRImagePresenterExclModeConfig)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IVMRImagePresenterExclModeConfig>(),
            Is.EqualTo(sizeof(IVMRImagePresenterExclModeConfig))
        );
    }
