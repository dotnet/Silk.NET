...
public static unsafe partial class IPersistMediaPropertyBagTests
{
    ...
    {
        Assert.That(
            typeof(IPersistMediaPropertyBag).GUID,
            Is.EqualTo(IID_IPersistMediaPropertyBag)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPersistMediaPropertyBag>(),
            Is.EqualTo(sizeof(IPersistMediaPropertyBag))
        );
    }
