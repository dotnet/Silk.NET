...
public static unsafe partial class INotificationActivationCallbackTests
{
    ...
    {
        Assert.That(
            typeof(INotificationActivationCallback).GUID,
            Is.EqualTo(IID_INotificationActivationCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<INotificationActivationCallback>(),
            Is.EqualTo(sizeof(INotificationActivationCallback))
        );
    }
