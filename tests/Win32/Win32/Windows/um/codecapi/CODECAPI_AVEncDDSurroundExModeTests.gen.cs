...
public static unsafe partial class CODECAPI_AVEncDDSurroundExModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDSurroundExMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDSurroundExMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDSurroundExMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDSurroundExMode))
        );
    }
