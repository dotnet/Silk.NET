...
public static unsafe partial class CODECAPI_AVEncDDRFPreEmphasisFilterTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDRFPreEmphasisFilter).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDRFPreEmphasisFilter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDRFPreEmphasisFilter>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDRFPreEmphasisFilter))
        );
    }
