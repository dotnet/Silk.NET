...
public static unsafe partial class CODECAPI_AVDecVideoDropPicWithMissingRefTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoDropPicWithMissingRef).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoDropPicWithMissingRef)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoDropPicWithMissingRef>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoDropPicWithMissingRef))
        );
    }
