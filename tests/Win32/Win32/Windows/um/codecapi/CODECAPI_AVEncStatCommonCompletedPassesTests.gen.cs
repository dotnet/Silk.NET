...
public static unsafe partial class CODECAPI_AVEncStatCommonCompletedPassesTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatCommonCompletedPasses).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatCommonCompletedPasses)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatCommonCompletedPasses>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatCommonCompletedPasses))
        );
    }
