...
public static unsafe partial class CODECAPI_GUID_AVEncWMALosslessTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncWMALossless).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncWMALossless)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncWMALossless>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncWMALossless))
        );
    }
