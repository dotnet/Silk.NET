...
public static unsafe partial class CODECAPI_AVEncDDHeadphoneModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDHeadphoneMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDHeadphoneMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDHeadphoneMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDHeadphoneMode))
        );
    }
