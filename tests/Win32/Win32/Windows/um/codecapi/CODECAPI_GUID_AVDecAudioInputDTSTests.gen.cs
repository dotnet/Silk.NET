...
public static unsafe partial class CODECAPI_GUID_AVDecAudioInputDTSTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioInputDTS).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVDecAudioInputDTS)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVDecAudioInputDTS>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVDecAudioInputDTS))
        );
    }
