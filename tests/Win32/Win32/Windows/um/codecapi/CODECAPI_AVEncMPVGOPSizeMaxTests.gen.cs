...
public static unsafe partial class CODECAPI_AVEncMPVGOPSizeMaxTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVGOPSizeMax).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVGOPSizeMax)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVGOPSizeMax>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVGOPSizeMax))
        );
    }
