...
public static unsafe partial class CODECAPI_AVEncMP12MuxLargestPacketSizeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxLargestPacketSize).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxLargestPacketSize)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxLargestPacketSize>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxLargestPacketSize))
        );
    }
