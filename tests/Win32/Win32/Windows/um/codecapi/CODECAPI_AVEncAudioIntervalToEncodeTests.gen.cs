...
public static unsafe partial class CODECAPI_AVEncAudioIntervalToEncodeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAudioIntervalToEncode).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAudioIntervalToEncode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAudioIntervalToEncode>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAudioIntervalToEncode))
        );
    }
