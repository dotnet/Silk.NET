...
public static unsafe partial class CODECAPI_AVEncVideoSourceFilmContentTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoSourceFilmContent).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoSourceFilmContent)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoSourceFilmContent>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoSourceFilmContent))
        );
    }
