...
public static unsafe partial class CODECAPI_AVEncCommonBufferSizeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonBufferSize).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonBufferSize)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonBufferSize>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonBufferSize))
        );
    }
