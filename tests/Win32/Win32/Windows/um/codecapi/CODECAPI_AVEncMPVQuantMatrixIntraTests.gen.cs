...
public static unsafe partial class CODECAPI_AVEncMPVQuantMatrixIntraTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVQuantMatrixIntra).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVQuantMatrixIntra)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVQuantMatrixIntra>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVQuantMatrixIntra))
        );
    }
