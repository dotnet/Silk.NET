...
public static unsafe partial class CODECAPI_AVEncMaxFrameRateTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMaxFrameRate).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMaxFrameRate)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMaxFrameRate>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMaxFrameRate))
        );
    }
