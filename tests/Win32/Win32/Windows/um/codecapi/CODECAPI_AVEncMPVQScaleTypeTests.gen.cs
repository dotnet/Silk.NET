...
public static unsafe partial class CODECAPI_AVEncMPVQScaleTypeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVQScaleType).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVQScaleType)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVQScaleType>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVQScaleType))
        );
    }
