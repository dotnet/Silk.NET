...
public static unsafe partial class CODECAPI_AVEncSliceControlSizeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncSliceControlSize).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncSliceControlSize)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncSliceControlSize>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncSliceControlSize))
        );
    }
