...
public static unsafe partial class CODECAPI_AVDecVideoImageSizeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoImageSize).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoImageSize)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoImageSize>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoImageSize))
        );
    }
