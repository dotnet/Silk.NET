...
public static unsafe partial class CODECAPI_AVEncAudioDualMonoTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAudioDualMono).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAudioDualMono)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAudioDualMono>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAudioDualMono))
        );
    }
