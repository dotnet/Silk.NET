...
public static unsafe partial class CODECAPI_AVEncCommonPassStartTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonPassStart).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonPassStart)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonPassStart>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonPassStart))
        );
    }
