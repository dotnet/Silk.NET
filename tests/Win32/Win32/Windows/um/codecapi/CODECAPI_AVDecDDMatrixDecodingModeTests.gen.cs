...
public static unsafe partial class CODECAPI_AVDecDDMatrixDecodingModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecDDMatrixDecodingMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecDDMatrixDecodingMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecDDMatrixDecodingMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecDDMatrixDecodingMode))
        );
    }
