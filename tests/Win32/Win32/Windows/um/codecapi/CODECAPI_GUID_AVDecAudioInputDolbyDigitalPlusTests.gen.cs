...
public static unsafe partial class CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlusTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioInputDolbyDigitalPlus).IsLayoutSequential,
            Is.True
        );
    }
