...
public static unsafe partial class CODECAPI_AVDecVideoProcDeinterlaceCSCTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoProcDeinterlaceCSC).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoProcDeinterlaceCSC)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoProcDeinterlaceCSC>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoProcDeinterlaceCSC))
        );
    }
