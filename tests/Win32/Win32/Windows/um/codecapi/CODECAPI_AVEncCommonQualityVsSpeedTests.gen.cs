...
public static unsafe partial class CODECAPI_AVEncCommonQualityVsSpeedTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonQualityVsSpeed).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonQualityVsSpeed)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonQualityVsSpeed>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonQualityVsSpeed))
        );
    }
