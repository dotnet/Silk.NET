...
public static unsafe partial class CODECAPI_AVEncVideoHeaderSecondsTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoHeaderSeconds).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoHeaderSeconds)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoHeaderSeconds>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoHeaderSeconds))
        );
    }
