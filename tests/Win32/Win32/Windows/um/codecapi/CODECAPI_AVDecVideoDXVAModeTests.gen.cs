...
public static unsafe partial class CODECAPI_AVDecVideoDXVAModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoDXVAMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoDXVAMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoDXVAMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoDXVAMode))
        );
    }
