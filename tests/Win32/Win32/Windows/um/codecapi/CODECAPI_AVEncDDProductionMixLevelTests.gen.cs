...
public static unsafe partial class CODECAPI_AVEncDDProductionMixLevelTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDProductionMixLevel).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDProductionMixLevel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDProductionMixLevel>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDProductionMixLevel))
        );
    }
