...
public static unsafe partial class CODECAPI_AVEncVideoMaxQPTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoMaxQP).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoMaxQP)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoMaxQP>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoMaxQP))
        );
    }
