...
public static unsafe partial class CODECAPI_AVEncMPVScanPatternTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVScanPattern).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVScanPattern)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVScanPattern>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVScanPattern))
        );
    }
