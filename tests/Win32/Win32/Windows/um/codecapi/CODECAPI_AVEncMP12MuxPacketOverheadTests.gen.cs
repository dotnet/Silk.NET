...
public static unsafe partial class CODECAPI_AVEncMP12MuxPacketOverheadTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxPacketOverhead).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxPacketOverhead)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxPacketOverhead>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxPacketOverhead))
        );
    }
