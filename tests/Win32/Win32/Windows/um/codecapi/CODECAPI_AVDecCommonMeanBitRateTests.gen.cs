...
public static unsafe partial class CODECAPI_AVDecCommonMeanBitRateTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecCommonMeanBitRate).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecCommonMeanBitRate)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecCommonMeanBitRate>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecCommonMeanBitRate))
        );
    }
