...
public static unsafe partial class CODECAPI_AVEncMPVDefaultBPictureCountTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVDefaultBPictureCount).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVDefaultBPictureCount)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVDefaultBPictureCount>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVDefaultBPictureCount))
        );
    }
