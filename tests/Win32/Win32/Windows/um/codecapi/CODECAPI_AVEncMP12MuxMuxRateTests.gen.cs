...
public static unsafe partial class CODECAPI_AVEncMP12MuxMuxRateTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxMuxRate).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxMuxRate)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxMuxRate>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxMuxRate))
        );
    }
