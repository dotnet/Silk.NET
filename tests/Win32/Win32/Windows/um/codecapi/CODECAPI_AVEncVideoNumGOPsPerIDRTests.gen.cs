...
public static unsafe partial class CODECAPI_AVEncVideoNumGOPsPerIDRTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoNumGOPsPerIDR).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoNumGOPsPerIDR)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoNumGOPsPerIDR>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoNumGOPsPerIDR))
        );
    }
