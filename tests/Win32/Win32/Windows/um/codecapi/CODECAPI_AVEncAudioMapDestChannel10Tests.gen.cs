...
public static unsafe partial class CODECAPI_AVEncAudioMapDestChannel10Tests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAudioMapDestChannel10).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAudioMapDestChannel10)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAudioMapDestChannel10>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAudioMapDestChannel10))
        );
    }
