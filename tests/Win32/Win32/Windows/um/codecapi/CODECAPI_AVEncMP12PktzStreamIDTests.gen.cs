...
public static unsafe partial class CODECAPI_AVEncMP12PktzStreamIDTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12PktzStreamID).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12PktzStreamID)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12PktzStreamID>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12PktzStreamID))
        );
    }
