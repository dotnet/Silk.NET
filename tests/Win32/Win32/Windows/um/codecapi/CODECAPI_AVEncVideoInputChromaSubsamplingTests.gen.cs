...
public static unsafe partial class CODECAPI_AVEncVideoInputChromaSubsamplingTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoInputChromaSubsampling).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoInputChromaSubsampling)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoInputChromaSubsampling>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoInputChromaSubsampling))
        );
    }
