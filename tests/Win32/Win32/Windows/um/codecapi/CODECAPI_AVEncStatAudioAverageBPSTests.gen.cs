...
public static unsafe partial class CODECAPI_AVEncStatAudioAverageBPSTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatAudioAverageBPS).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatAudioAverageBPS)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatAudioAverageBPS>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatAudioAverageBPS))
        );
    }
