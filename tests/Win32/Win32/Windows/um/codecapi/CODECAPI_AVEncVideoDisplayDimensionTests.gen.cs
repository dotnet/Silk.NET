...
public static unsafe partial class CODECAPI_AVEncVideoDisplayDimensionTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoDisplayDimension).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoDisplayDimension)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoDisplayDimension>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoDisplayDimension))
        );
    }
