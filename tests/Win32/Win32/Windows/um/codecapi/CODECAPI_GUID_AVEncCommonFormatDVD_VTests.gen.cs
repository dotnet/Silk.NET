...
public static unsafe partial class CODECAPI_GUID_AVEncCommonFormatDVD_VTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncCommonFormatDVD_V).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncCommonFormatDVD_V)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncCommonFormatDVD_V>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncCommonFormatDVD_V))
        );
    }
