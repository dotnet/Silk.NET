...
public static unsafe partial class CODECAPI_GUID_AVDecAudioInputDolbyTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioInputDolby).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVDecAudioInputDolby)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVDecAudioInputDolby>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVDecAudioInputDolby))
        );
    }
