...
public static unsafe partial class CODECAPI_AVEncChromaEncodeModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncChromaEncodeMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncChromaEncodeMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncChromaEncodeMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncChromaEncodeMode))
        );
    }
