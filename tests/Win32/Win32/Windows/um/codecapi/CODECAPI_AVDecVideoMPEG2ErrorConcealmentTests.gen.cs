...
public static unsafe partial class CODECAPI_AVDecVideoMPEG2ErrorConcealmentTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoMPEG2ErrorConcealment).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoMPEG2ErrorConcealment)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoMPEG2ErrorConcealment>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoMPEG2ErrorConcealment))
        );
    }
