...
public static unsafe partial class CODECAPI_AVEncDDLFELowPassFilterTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDLFELowPassFilter).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDLFELowPassFilter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDLFELowPassFilter>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDLFELowPassFilter))
        );
    }
