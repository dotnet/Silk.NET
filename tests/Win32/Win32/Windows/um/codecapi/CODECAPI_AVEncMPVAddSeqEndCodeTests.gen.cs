...
public static unsafe partial class CODECAPI_AVEncMPVAddSeqEndCodeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVAddSeqEndCode).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVAddSeqEndCode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVAddSeqEndCode>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVAddSeqEndCode))
        );
    }
