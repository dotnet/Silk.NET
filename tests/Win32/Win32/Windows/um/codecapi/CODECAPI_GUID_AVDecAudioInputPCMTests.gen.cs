...
public static unsafe partial class CODECAPI_GUID_AVDecAudioInputPCMTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioInputPCM).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVDecAudioInputPCM)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVDecAudioInputPCM>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVDecAudioInputPCM))
        );
    }
