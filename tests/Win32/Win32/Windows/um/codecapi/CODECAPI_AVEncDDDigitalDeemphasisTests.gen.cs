...
public static unsafe partial class CODECAPI_AVEncDDDigitalDeemphasisTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDDigitalDeemphasis).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDDigitalDeemphasis)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDDigitalDeemphasis>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDDigitalDeemphasis))
        );
    }
