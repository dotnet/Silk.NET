...
public static unsafe partial class CODECAPI_AVEncDDChannelBWLowPassFilterTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDChannelBWLowPassFilter).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDChannelBWLowPassFilter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDChannelBWLowPassFilter>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDChannelBWLowPassFilter))
        );
    }
