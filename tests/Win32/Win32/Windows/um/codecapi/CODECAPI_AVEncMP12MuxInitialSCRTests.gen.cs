...
public static unsafe partial class CODECAPI_AVEncMP12MuxInitialSCRTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxInitialSCR).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxInitialSCR)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxInitialSCR>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxInitialSCR))
        );
    }
