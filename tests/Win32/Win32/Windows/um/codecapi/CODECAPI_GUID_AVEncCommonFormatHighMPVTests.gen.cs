...
public static unsafe partial class CODECAPI_GUID_AVEncCommonFormatHighMPVTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncCommonFormatHighMPV).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncCommonFormatHighMPV)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncCommonFormatHighMPV>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncCommonFormatHighMPV))
        );
    }
