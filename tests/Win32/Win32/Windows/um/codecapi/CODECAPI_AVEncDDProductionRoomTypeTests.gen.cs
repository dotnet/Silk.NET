...
public static unsafe partial class CODECAPI_AVEncDDProductionRoomTypeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDProductionRoomType).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDProductionRoomType)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDProductionRoomType>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDProductionRoomType))
        );
    }
