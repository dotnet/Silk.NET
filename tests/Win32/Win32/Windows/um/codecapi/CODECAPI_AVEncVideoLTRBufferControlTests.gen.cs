...
public static unsafe partial class CODECAPI_AVEncVideoLTRBufferControlTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoLTRBufferControl).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoLTRBufferControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoLTRBufferControl>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoLTRBufferControl))
        );
    }
