...
public static unsafe partial class CODECAPI_AVEncMPVQuantMatrixChromaNonIntraTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVQuantMatrixChromaNonIntra).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVQuantMatrixChromaNonIntra)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVQuantMatrixChromaNonIntra>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVQuantMatrixChromaNonIntra))
        );
    }
