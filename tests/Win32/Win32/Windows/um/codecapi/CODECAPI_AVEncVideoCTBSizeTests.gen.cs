...
public static unsafe partial class CODECAPI_AVEncVideoCTBSizeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoCTBSize).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoCTBSize)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoCTBSize>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoCTBSize))
        );
    }
