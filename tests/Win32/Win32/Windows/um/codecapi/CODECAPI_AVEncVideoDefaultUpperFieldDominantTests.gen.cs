...
public static unsafe partial class CODECAPI_AVEncVideoDefaultUpperFieldDominantTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoDefaultUpperFieldDominant).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoDefaultUpperFieldDominant)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoDefaultUpperFieldDominant>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoDefaultUpperFieldDominant))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoDefaultUpperFieldDominant).IsLayoutSequential,
            Is.True
        );
    }
