...
public static unsafe partial class CODECAPI_AVEncMP12PktzCopyrightTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12PktzCopyright).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12PktzCopyright)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12PktzCopyright>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12PktzCopyright))
        );
    }
