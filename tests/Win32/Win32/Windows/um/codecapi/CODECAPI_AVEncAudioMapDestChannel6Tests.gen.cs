...
public static unsafe partial class CODECAPI_AVEncAudioMapDestChannel6Tests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAudioMapDestChannel6).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAudioMapDestChannel6)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAudioMapDestChannel6>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAudioMapDestChannel6))
        );
    }
