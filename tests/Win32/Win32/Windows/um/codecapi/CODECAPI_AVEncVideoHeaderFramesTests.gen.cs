...
public static unsafe partial class CODECAPI_AVEncVideoHeaderFramesTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoHeaderFrames).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoHeaderFrames)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoHeaderFrames>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoHeaderFrames))
        );
    }
