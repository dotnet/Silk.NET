...
public static unsafe partial class CODECAPI_AVDecVideoFastDecodeModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoFastDecodeMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoFastDecodeMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoFastDecodeMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoFastDecodeMode))
        );
    }
