...
public static unsafe partial class CODECAPI_AVEncAudioMapDestChannel14Tests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAudioMapDestChannel14).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAudioMapDestChannel14)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAudioMapDestChannel14>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAudioMapDestChannel14))
        );
    }
