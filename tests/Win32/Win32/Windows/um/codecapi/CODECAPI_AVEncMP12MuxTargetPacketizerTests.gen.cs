...
public static unsafe partial class CODECAPI_AVEncMP12MuxTargetPacketizerTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxTargetPacketizer).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxTargetPacketizer)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxTargetPacketizer>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxTargetPacketizer))
        );
    }
