...
public static unsafe partial class CODECAPI_AVEncCommonRealTimeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonRealTime).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonRealTime)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonRealTime>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonRealTime))
        );
    }
