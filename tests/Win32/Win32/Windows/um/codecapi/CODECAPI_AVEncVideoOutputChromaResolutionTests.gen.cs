...
public static unsafe partial class CODECAPI_AVEncVideoOutputChromaResolutionTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoOutputChromaResolution).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoOutputChromaResolution)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoOutputChromaResolution>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoOutputChromaResolution))
        );
    }
