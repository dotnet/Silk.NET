...
public static unsafe partial class CODECAPI_AVDecVideoAcceleration_VC1Tests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoAcceleration_VC1).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoAcceleration_VC1)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoAcceleration_VC1>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoAcceleration_VC1))
        );
    }
