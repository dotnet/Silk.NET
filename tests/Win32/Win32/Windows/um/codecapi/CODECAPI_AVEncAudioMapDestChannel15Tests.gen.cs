...
public static unsafe partial class CODECAPI_AVEncAudioMapDestChannel15Tests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAudioMapDestChannel15).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAudioMapDestChannel15)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAudioMapDestChannel15>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAudioMapDestChannel15))
        );
    }
