...
public static unsafe partial class CODECAPI_AVEncMP12MuxSysFixedTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxSysFixed).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxSysFixed)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxSysFixed>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxSysFixed))
        );
    }
