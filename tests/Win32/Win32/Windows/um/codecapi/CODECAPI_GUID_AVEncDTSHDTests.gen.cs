...
public static unsafe partial class CODECAPI_GUID_AVEncDTSHDTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncDTSHD).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncDTSHD)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncDTSHD>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncDTSHD))
        );
    }
