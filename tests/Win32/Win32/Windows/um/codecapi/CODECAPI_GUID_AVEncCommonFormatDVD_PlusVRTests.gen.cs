...
public static unsafe partial class CODECAPI_GUID_AVEncCommonFormatDVD_PlusVRTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncCommonFormatDVD_PlusVR).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncCommonFormatDVD_PlusVR)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncCommonFormatDVD_PlusVR>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncCommonFormatDVD_PlusVR))
        );
    }
