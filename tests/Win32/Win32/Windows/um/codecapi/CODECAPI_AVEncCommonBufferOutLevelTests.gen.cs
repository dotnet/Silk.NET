...
public static unsafe partial class CODECAPI_AVEncCommonBufferOutLevelTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonBufferOutLevel).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonBufferOutLevel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonBufferOutLevel>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonBufferOutLevel))
        );
    }
