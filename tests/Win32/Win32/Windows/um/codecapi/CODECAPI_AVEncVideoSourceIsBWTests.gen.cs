...
public static unsafe partial class CODECAPI_AVEncVideoSourceIsBWTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoSourceIsBW).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoSourceIsBW)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoSourceIsBW>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoSourceIsBW))
        );
    }
