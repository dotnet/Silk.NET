...
public static unsafe partial class CODECAPI_AVEncMPAEmphasisTypeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPAEmphasisType).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPAEmphasisType)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPAEmphasisType>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPAEmphasisType))
        );
    }
