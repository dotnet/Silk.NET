...
public static unsafe partial class CODECAPI_AVEncCommonStreamEndHandlingTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonStreamEndHandling).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonStreamEndHandling)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonStreamEndHandling>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonStreamEndHandling))
        );
    }
