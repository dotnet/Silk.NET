...
public static unsafe partial class CODECAPI_AVPriorityControlTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVPriorityControl).GUID,
            Is.EqualTo(IID_CODECAPI_AVPriorityControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVPriorityControl>(),
            Is.EqualTo(sizeof(CODECAPI_AVPriorityControl))
        );
    }
