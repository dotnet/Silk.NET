...
public static unsafe partial class CODECAPI_AVEncInputVideoSystemTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncInputVideoSystem).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncInputVideoSystem)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncInputVideoSystem>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncInputVideoSystem))
        );
    }
