...
public static unsafe partial class CODECAPI_SetHDCPManagerContextTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_SetHDCPManagerContext).GUID,
            Is.EqualTo(IID_CODECAPI_SetHDCPManagerContext)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_SetHDCPManagerContext>(),
            Is.EqualTo(sizeof(CODECAPI_SetHDCPManagerContext))
        );
    }
