...
public static unsafe partial class CODECAPI_AVAudioSampleRateTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVAudioSampleRate).GUID,
            Is.EqualTo(IID_CODECAPI_AVAudioSampleRate)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVAudioSampleRate>(),
            Is.EqualTo(sizeof(CODECAPI_AVAudioSampleRate))
        );
    }
