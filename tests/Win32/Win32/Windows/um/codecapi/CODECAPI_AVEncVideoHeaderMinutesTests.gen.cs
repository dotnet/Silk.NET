...
public static unsafe partial class CODECAPI_AVEncVideoHeaderMinutesTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoHeaderMinutes).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoHeaderMinutes)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoHeaderMinutes>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoHeaderMinutes))
        );
    }
