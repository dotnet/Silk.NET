...
public static unsafe partial class CODECAPI_AVEncVideoInputColorTransferFunctionTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoInputColorTransferFunction).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoInputColorTransferFunction)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoInputColorTransferFunction>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoInputColorTransferFunction))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoInputColorTransferFunction).IsLayoutSequential,
            Is.True
        );
    }
