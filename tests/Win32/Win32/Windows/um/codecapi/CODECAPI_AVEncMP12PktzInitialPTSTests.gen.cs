...
public static unsafe partial class CODECAPI_AVEncMP12PktzInitialPTSTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12PktzInitialPTS).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12PktzInitialPTS)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12PktzInitialPTS>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12PktzInitialPTS))
        );
    }
