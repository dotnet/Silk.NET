...
public static unsafe partial class CODECAPI_AVEncDDAtoDConverterTypeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDAtoDConverterType).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDAtoDConverterType)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDAtoDConverterType>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDAtoDConverterType))
        );
    }
