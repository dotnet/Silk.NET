...
public static unsafe partial class CODECAPI_AVEncStatAudioPeakPCMValueTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatAudioPeakPCMValue).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatAudioPeakPCMValue)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatAudioPeakPCMValue>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatAudioPeakPCMValue))
        );
    }
