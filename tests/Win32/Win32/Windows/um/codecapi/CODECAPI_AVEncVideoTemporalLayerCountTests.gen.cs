...
public static unsafe partial class CODECAPI_AVEncVideoTemporalLayerCountTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoTemporalLayerCount).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoTemporalLayerCount)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoTemporalLayerCount>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoTemporalLayerCount))
        );
    }
