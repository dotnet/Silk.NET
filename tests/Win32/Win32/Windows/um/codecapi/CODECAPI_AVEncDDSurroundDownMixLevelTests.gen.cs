...
public static unsafe partial class CODECAPI_AVEncDDSurroundDownMixLevelTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncDDSurroundDownMixLevel).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncDDSurroundDownMixLevel)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncDDSurroundDownMixLevel>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncDDSurroundDownMixLevel))
        );
    }
