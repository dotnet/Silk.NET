...
public static unsafe partial class CODECAPI_AVLowLatencyModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVLowLatencyMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVLowLatencyMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVLowLatencyMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVLowLatencyMode))
        );
    }
