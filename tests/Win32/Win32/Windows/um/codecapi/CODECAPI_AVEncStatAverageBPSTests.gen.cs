...
public static unsafe partial class CODECAPI_AVEncStatAverageBPSTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatAverageBPS).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatAverageBPS)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatAverageBPS>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatAverageBPS))
        );
    }
