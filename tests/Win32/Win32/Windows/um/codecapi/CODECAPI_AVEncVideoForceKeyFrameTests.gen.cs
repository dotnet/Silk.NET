...
public static unsafe partial class CODECAPI_AVEncVideoForceKeyFrameTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoForceKeyFrame).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoForceKeyFrame)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoForceKeyFrame>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoForceKeyFrame))
        );
    }
