...
public static unsafe partial class CODECAPI_AVEncStatMPVSkippedEmptyFramesTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatMPVSkippedEmptyFrames).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatMPVSkippedEmptyFrames)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatMPVSkippedEmptyFrames>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatMPVSkippedEmptyFrames))
        );
    }
