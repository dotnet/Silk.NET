...
public static unsafe partial class CODECAPI_AVDecVideoDXVABusEncryptionTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoDXVABusEncryption).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoDXVABusEncryption)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoDXVABusEncryption>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoDXVABusEncryption))
        );
    }
