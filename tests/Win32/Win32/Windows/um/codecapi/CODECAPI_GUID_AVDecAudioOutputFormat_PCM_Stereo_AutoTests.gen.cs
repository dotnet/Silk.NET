...
public static unsafe partial class CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_AutoTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_Auto).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_Auto)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_Auto>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_Auto))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_Auto).IsLayoutSequential,
            Is.True
        );
    }
