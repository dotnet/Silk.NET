...
public static unsafe partial class CODECAPI_AVEncStatWMVCBMaxTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatWMVCBMax).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatWMVCBMax)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatWMVCBMax>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatWMVCBMax))
        );
    }
