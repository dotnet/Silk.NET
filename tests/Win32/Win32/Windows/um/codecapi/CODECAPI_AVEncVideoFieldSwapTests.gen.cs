...
public static unsafe partial class CODECAPI_AVEncVideoFieldSwapTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoFieldSwap).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoFieldSwap)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoFieldSwap>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoFieldSwap))
        );
    }
