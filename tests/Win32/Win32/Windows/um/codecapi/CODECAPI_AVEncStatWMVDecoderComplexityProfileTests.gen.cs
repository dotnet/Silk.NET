...
public static unsafe partial class CODECAPI_AVEncStatWMVDecoderComplexityProfileTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatWMVDecoderComplexityProfile).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncStatWMVDecoderComplexityProfile)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncStatWMVDecoderComplexityProfile>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncStatWMVDecoderComplexityProfile))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncStatWMVDecoderComplexityProfile).IsLayoutSequential,
            Is.True
        );
    }
