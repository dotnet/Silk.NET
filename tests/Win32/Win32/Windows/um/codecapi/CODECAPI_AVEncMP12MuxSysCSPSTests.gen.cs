...
public static unsafe partial class CODECAPI_AVEncMP12MuxSysCSPSTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxSysCSPS).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxSysCSPS)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxSysCSPS>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxSysCSPS))
        );
    }
