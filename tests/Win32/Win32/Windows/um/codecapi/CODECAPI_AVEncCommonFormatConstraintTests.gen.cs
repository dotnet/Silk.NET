...
public static unsafe partial class CODECAPI_AVEncCommonFormatConstraintTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonFormatConstraint).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonFormatConstraint)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonFormatConstraint>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonFormatConstraint))
        );
    }
