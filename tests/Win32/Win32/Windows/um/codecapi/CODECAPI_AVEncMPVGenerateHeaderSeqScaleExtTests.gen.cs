...
public static unsafe partial class CODECAPI_AVEncMPVGenerateHeaderSeqScaleExtTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVGenerateHeaderSeqScaleExt).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVGenerateHeaderSeqScaleExt)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVGenerateHeaderSeqScaleExt>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVGenerateHeaderSeqScaleExt))
        );
    }
