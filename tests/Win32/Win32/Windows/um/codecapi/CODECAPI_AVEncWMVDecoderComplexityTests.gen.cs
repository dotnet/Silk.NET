...
public static unsafe partial class CODECAPI_AVEncWMVDecoderComplexityTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncWMVDecoderComplexity).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncWMVDecoderComplexity)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncWMVDecoderComplexity>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncWMVDecoderComplexity))
        );
    }
