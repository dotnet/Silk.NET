...
public static unsafe partial class CODECAPI_AVDecNumWorkerThreadsTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecNumWorkerThreads).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecNumWorkerThreads)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecNumWorkerThreads>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecNumWorkerThreads))
        );
    }
