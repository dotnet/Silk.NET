...
public static unsafe partial class CODECAPI_AVEncVideoSupportedControlsTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoSupportedControls).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoSupportedControls)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoSupportedControls>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoSupportedControls))
        );
    }
