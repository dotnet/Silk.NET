...
public static unsafe partial class CODECAPI_AVEncVideoOutputColorLightingTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoOutputColorLighting).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoOutputColorLighting)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoOutputColorLighting>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoOutputColorLighting))
        );
    }
