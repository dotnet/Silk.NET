...
public static unsafe partial class CODECAPI_GUID_AVEncCommonFormatSVCDTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncCommonFormatSVCD).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncCommonFormatSVCD)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncCommonFormatSVCD>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncCommonFormatSVCD))
        );
    }
