...
public static unsafe partial class CODECAPI_AVEncVideoNoOfFieldsToSkipTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoNoOfFieldsToSkip).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoNoOfFieldsToSkip)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoNoOfFieldsToSkip>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoNoOfFieldsToSkip))
        );
    }
