...
public static unsafe partial class CODECAPI_AVDecVideoSoftwareDeinterlaceModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecVideoSoftwareDeinterlaceMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecVideoSoftwareDeinterlaceMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecVideoSoftwareDeinterlaceMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecVideoSoftwareDeinterlaceMode))
        );
    }
