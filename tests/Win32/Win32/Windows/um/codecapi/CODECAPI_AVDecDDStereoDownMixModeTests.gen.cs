...
public static unsafe partial class CODECAPI_AVDecDDStereoDownMixModeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecDDStereoDownMixMode).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecDDStereoDownMixMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecDDStereoDownMixMode>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecDDStereoDownMixMode))
        );
    }
