...
public static unsafe partial class CODECAPI_AVEncVideoOutputScanTypeTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoOutputScanType).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoOutputScanType)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoOutputScanType>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoOutputScanType))
        );
    }
