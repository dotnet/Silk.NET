...
public static unsafe partial class CODECAPI_AVEncVideoEncodeQPTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoEncodeQP).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoEncodeQP)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoEncodeQP>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoEncodeQP))
        );
    }
