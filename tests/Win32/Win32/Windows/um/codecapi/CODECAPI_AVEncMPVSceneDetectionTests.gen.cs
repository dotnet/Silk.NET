...
public static unsafe partial class CODECAPI_AVEncMPVSceneDetectionTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVSceneDetection).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVSceneDetection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVSceneDetection>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVSceneDetection))
        );
    }
