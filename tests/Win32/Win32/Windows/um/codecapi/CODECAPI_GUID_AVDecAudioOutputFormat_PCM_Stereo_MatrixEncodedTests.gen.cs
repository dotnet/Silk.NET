...
public static unsafe partial class CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncodedTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncoded).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncoded)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncoded>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncoded))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncoded).IsLayoutSequential,
            Is.True
        );
    }
    ...
    {
        Assert.That(
            sizeof(CODECAPI_GUID_AVDecAudioOutputFormat_PCM_Stereo_MatrixEncoded),
            Is.EqualTo(1)
        );
    }
}
