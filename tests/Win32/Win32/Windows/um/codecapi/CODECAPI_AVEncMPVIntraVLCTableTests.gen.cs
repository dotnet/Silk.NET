...
public static unsafe partial class CODECAPI_AVEncMPVIntraVLCTableTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMPVIntraVLCTable).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMPVIntraVLCTable)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMPVIntraVLCTable>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMPVIntraVLCTable))
        );
    }
