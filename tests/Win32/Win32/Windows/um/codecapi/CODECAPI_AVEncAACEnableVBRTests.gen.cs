...
public static unsafe partial class CODECAPI_AVEncAACEnableVBRTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncAACEnableVBR).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncAACEnableVBR)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncAACEnableVBR>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncAACEnableVBR))
        );
    }
