...
public static unsafe partial class CODECAPI_AVDecDDDynamicRangeScaleHighTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVDecDDDynamicRangeScaleHigh).GUID,
            Is.EqualTo(IID_CODECAPI_AVDecDDDynamicRangeScaleHigh)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVDecDDDynamicRangeScaleHigh>(),
            Is.EqualTo(sizeof(CODECAPI_AVDecDDDynamicRangeScaleHigh))
        );
    }
