...
public static unsafe partial class CODECAPI_AVEncVideoOutputFrameRateTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoOutputFrameRate).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoOutputFrameRate)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoOutputFrameRate>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoOutputFrameRate))
        );
    }
