...
public static unsafe partial class CODECAPI_AVEncCommonQualityTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncCommonQuality).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncCommonQuality)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncCommonQuality>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncCommonQuality))
        );
    }
