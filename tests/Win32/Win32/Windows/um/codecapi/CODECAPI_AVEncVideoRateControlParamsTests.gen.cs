...
public static unsafe partial class CODECAPI_AVEncVideoRateControlParamsTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoRateControlParams).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoRateControlParams)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoRateControlParams>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoRateControlParams))
        );
    }
