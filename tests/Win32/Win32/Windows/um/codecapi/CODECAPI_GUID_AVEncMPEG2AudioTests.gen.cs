...
public static unsafe partial class CODECAPI_GUID_AVEncMPEG2AudioTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_GUID_AVEncMPEG2Audio).GUID,
            Is.EqualTo(IID_CODECAPI_GUID_AVEncMPEG2Audio)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_GUID_AVEncMPEG2Audio>(),
            Is.EqualTo(sizeof(CODECAPI_GUID_AVEncMPEG2Audio))
        );
    }
