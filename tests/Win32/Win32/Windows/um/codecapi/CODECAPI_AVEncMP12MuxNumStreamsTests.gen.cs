...
public static unsafe partial class CODECAPI_AVEncMP12MuxNumStreamsTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncMP12MuxNumStreams).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncMP12MuxNumStreams)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncMP12MuxNumStreams>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncMP12MuxNumStreams))
        );
    }
