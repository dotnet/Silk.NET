...
public static unsafe partial class CODECAPI_AVEncVideoOutputColorTransferFunctionTests
{
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoOutputColorTransferFunction).GUID,
            Is.EqualTo(IID_CODECAPI_AVEncVideoOutputColorTransferFunction)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<CODECAPI_AVEncVideoOutputColorTransferFunction>(),
            Is.EqualTo(sizeof(CODECAPI_AVEncVideoOutputColorTransferFunction))
        );
    }
    ...
    {
        Assert.That(
            typeof(CODECAPI_AVEncVideoOutputColorTransferFunction).IsLayoutSequential,
            Is.True
        );
    }
