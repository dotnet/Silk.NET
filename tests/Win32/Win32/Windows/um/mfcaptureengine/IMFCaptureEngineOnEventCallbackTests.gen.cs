...
public static unsafe partial class IMFCaptureEngineOnEventCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IMFCaptureEngineOnEventCallback).GUID,
            Is.EqualTo(IID_IMFCaptureEngineOnEventCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFCaptureEngineOnEventCallback>(),
            Is.EqualTo(sizeof(IMFCaptureEngineOnEventCallback))
        );
    }
