...
public static unsafe partial class IMFCaptureEngineOnSampleCallback2Tests
{
    ...
    {
        Assert.That(
            typeof(IMFCaptureEngineOnSampleCallback2).GUID,
            Is.EqualTo(IID_IMFCaptureEngineOnSampleCallback2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFCaptureEngineOnSampleCallback2>(),
            Is.EqualTo(sizeof(IMFCaptureEngineOnSampleCallback2))
        );
    }
