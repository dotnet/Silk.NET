...
public static partial class IIDTests
{
    ...
    public static void IID_IInkD2DRendererTest()
    {
        Assert.That(
            IID_IInkD2DRenderer,
            Is.EqualTo(
                new Guid(0x407fb1de, 0xf85a, 0x4150, 0x97, 0xcf, 0xb7, 0xfb, 0x27, 0x4f, 0xb4, 0xf8)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_IInkD2DRenderer2,
            Is.EqualTo(
                new Guid(0x0a95dcd9, 0x4578, 0x4b71, 0xb2, 0x0b, 0xbf, 0x66, 0x4d, 0x4b, 0xfe, 0xee)
            )
        );
    }
}
