...
public static unsafe partial class ITfFnGetLinguisticAlternatesTests
{
    ...
    {
        Assert.That(
            typeof(ITfFnGetLinguisticAlternates).GUID,
            Is.EqualTo(IID_ITfFnGetLinguisticAlternates)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfFnGetLinguisticAlternates>(),
            Is.EqualTo(sizeof(ITfFnGetLinguisticAlternates))
        );
    }
