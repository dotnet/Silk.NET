...
public static unsafe partial class ITfFnGetPreferredTouchKeyboardLayoutTests
{
    ...
    {
        Assert.That(
            typeof(ITfFnGetPreferredTouchKeyboardLayout).GUID,
            Is.EqualTo(IID_ITfFnGetPreferredTouchKeyboardLayout)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfFnGetPreferredTouchKeyboardLayout>(),
            Is.EqualTo(sizeof(ITfFnGetPreferredTouchKeyboardLayout))
        );
    }
