...
public static unsafe partial class ITfFnConfigureRegisterEudcTests
{
    ...
    {
        Assert.That(
            typeof(ITfFnConfigureRegisterEudc).GUID,
            Is.EqualTo(IID_ITfFnConfigureRegisterEudc)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfFnConfigureRegisterEudc>(),
            Is.EqualTo(sizeof(ITfFnConfigureRegisterEudc))
        );
    }
