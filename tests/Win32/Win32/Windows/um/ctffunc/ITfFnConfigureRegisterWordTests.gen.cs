...
public static unsafe partial class ITfFnConfigureRegisterWordTests
{
    ...
    {
        Assert.That(
            typeof(ITfFnConfigureRegisterWord).GUID,
            Is.EqualTo(IID_ITfFnConfigureRegisterWord)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfFnConfigureRegisterWord>(),
            Is.EqualTo(sizeof(ITfFnConfigureRegisterWord))
        );
    }
