...
public static unsafe partial class ITfFnCustomSpeechCommandTests
{
    ...
    {
        Assert.That(
            typeof(ITfFnCustomSpeechCommand).GUID,
            Is.EqualTo(IID_ITfFnCustomSpeechCommand)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfFnCustomSpeechCommand>(),
            Is.EqualTo(sizeof(ITfFnCustomSpeechCommand))
        );
    }
