...
public static unsafe partial class IMFSinkWriterEncoderConfigTests
{
    ...
    {
        Assert.That(
            typeof(IMFSinkWriterEncoderConfig).GUID,
            Is.EqualTo(IID_IMFSinkWriterEncoderConfig)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSinkWriterEncoderConfig>(),
            Is.EqualTo(sizeof(IMFSinkWriterEncoderConfig))
        );
    }
