...
public static unsafe partial class IMFSourceReaderCallback2Tests
{
    ...
    {
        Assert.That(
            typeof(IMFSourceReaderCallback2).GUID,
            Is.EqualTo(IID_IMFSourceReaderCallback2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSourceReaderCallback2>(),
            Is.EqualTo(sizeof(IMFSourceReaderCallback2))
        );
    }
