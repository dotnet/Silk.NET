...
public static unsafe partial class IAudioClientDuckingControlTests
{
    ...
    {
        Assert.That(
            typeof(IAudioClientDuckingControl).GUID,
            Is.EqualTo(IID_IAudioClientDuckingControl)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAudioClientDuckingControl>(),
            Is.EqualTo(sizeof(IAudioClientDuckingControl))
        );
    }
