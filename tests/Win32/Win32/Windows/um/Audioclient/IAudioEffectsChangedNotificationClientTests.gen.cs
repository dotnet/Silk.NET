...
public static unsafe partial class IAudioEffectsChangedNotificationClientTests
{
    ...
    {
        Assert.That(
            typeof(IAudioEffectsChangedNotificationClient).GUID,
            Is.EqualTo(IID_IAudioEffectsChangedNotificationClient)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAudioEffectsChangedNotificationClient>(),
            Is.EqualTo(sizeof(IAudioEffectsChangedNotificationClient))
        );
    }
