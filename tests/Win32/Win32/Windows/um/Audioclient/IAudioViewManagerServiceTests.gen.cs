...
public static unsafe partial class IAudioViewManagerServiceTests
{
    ...
    {
        Assert.That(
            typeof(IAudioViewManagerService).GUID,
            Is.EqualTo(IID_IAudioViewManagerService)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAudioViewManagerService>(),
            Is.EqualTo(sizeof(IAudioViewManagerService))
        );
    }
