...
public static unsafe partial class IInkCommitRequestHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IInkCommitRequestHandler).GUID,
            Is.EqualTo(IID_IInkCommitRequestHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IInkCommitRequestHandler>(),
            Is.EqualTo(sizeof(IInkCommitRequestHandler))
        );
    }
