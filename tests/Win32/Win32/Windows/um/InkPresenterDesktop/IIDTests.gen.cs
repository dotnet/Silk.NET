...
public static partial class IIDTests
{
    ...
    {
        Assert.That(
            IID_IInkCommitRequestHandler,
            Is.EqualTo(
                new Guid(0xfabea3fc, 0xb108, 0x45b6, 0xa9, 0xfc, 0x8d, 0x08, 0xfa, 0x9f, 0x85, 0xcf)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_IInkPresenterDesktop,
            Is.EqualTo(
                new Guid(0x73f3c0d9, 0x2e8b, 0x48f3, 0x89, 0x5e, 0x20, 0xcb, 0xd2, 0x7b, 0x72, 0x3b)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_IInkHostWorkItem,
            Is.EqualTo(
                new Guid(0xccda0a9a, 0x1b78, 0x4632, 0xbb, 0x96, 0x97, 0x80, 0x06, 0x62, 0xe2, 0x6c)
            )
        );
    }
    ...
    public static void IID_IInkDesktopHostTest()
    {
        Assert.That(
            IID_IInkDesktopHost,
            Is.EqualTo(
                new Guid(0x4ce7d875, 0xa981, 0x4140, 0xa1, 0xff, 0xad, 0x93, 0x25, 0x8e, 0x8d, 0x59)
            )
        );
    }
}
