...
public static unsafe partial class AUTHENTICODE_TS_EXTRA_CERT_CHAIN_POLICY_PARATests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<AUTHENTICODE_TS_EXTRA_CERT_CHAIN_POLICY_PARA>(),
            Is.EqualTo(sizeof(AUTHENTICODE_TS_EXTRA_CERT_CHAIN_POLICY_PARA))
        );
    }
    ...
    {
        Assert.That(
            typeof(AUTHENTICODE_TS_EXTRA_CERT_CHAIN_POLICY_PARA).IsLayoutSequential,
            Is.True
        );
    }
