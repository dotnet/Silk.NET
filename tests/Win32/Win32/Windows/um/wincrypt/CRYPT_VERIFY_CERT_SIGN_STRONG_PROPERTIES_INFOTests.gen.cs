...
public static unsafe partial class CRYPT_VERIFY_CERT_SIGN_STRONG_PROPERTIES_INFOTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<CRYPT_VERIFY_CERT_SIGN_STRONG_PROPERTIES_INFO>(),
            Is.EqualTo(sizeof(CRYPT_VERIFY_CERT_SIGN_STRONG_PROPERTIES_INFO))
        );
    }
    ...
    {
        Assert.That(
            typeof(CRYPT_VERIFY_CERT_SIGN_STRONG_PROPERTIES_INFO).IsLayoutSequential,
            Is.True
        );
    }
