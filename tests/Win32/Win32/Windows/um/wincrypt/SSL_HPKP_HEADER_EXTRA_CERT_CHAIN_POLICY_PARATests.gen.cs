...
public static unsafe partial class SSL_HPKP_HEADER_EXTRA_CERT_CHAIN_POLICY_PARATests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<SSL_HPKP_HEADER_EXTRA_CERT_CHAIN_POLICY_PARA>(),
            Is.EqualTo(sizeof(SSL_HPKP_HEADER_EXTRA_CERT_CHAIN_POLICY_PARA))
        );
    }
    ...
    {
        Assert.That(
            typeof(SSL_HPKP_HEADER_EXTRA_CERT_CHAIN_POLICY_PARA).IsLayoutSequential,
            Is.True
        );
    }
