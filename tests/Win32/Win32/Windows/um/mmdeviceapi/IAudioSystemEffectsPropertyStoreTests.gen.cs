...
public static unsafe partial class IAudioSystemEffectsPropertyStoreTests
{
    ...
    {
        Assert.That(
            typeof(IAudioSystemEffectsPropertyStore).GUID,
            Is.EqualTo(IID_IAudioSystemEffectsPropertyStore)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAudioSystemEffectsPropertyStore>(),
            Is.EqualTo(sizeof(IAudioSystemEffectsPropertyStore))
        );
    }
