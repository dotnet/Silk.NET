...
public static partial class PKEYTests
{
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_FormFactor.fmtid,
            Is.EqualTo(
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_ControlPanelPageProvider.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_Association.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_PhysicalSpeakers.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_Disable_SysFx.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_FullRangeSpeakers.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_Supports_EventDriven_Mode.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_JackSubType.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpoint_Default_VolumeInDb.fmtid,
            Is.EqualTo(
                new Guid(0x1da5d803, 0xd492, 0x4edd, 0x8c, 0x23, 0xe0, 0xc0, 0xff, 0xee, 0x7f, 0x0e)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEngine_DeviceFormat.fmtid,
            Is.EqualTo(
    ...
    {
        Assert.That(
            PKEY_AudioEngine_OEMFormat.fmtid,
            Is.EqualTo(
                new Guid(0xe4870e26, 0x3cc5, 0x4cd2, 0xba, 0x46, 0xca, 0xa, 0x9a, 0x70, 0xed, 0x4)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpointLogo_IconEffects.fmtid,
            Is.EqualTo(
                new Guid(0xf1ab780d, 0x2010, 0x4ed3, 0xa3, 0xa6, 0x8b, 0x87, 0xf0, 0xf0, 0xc4, 0x76)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpointLogo_IconPath.fmtid,
            Is.EqualTo(
                new Guid(0xf1ab780d, 0x2010, 0x4ed3, 0xa3, 0xa6, 0x8b, 0x87, 0xf0, 0xf0, 0xc4, 0x76)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpointSettings_MenuText.fmtid,
            Is.EqualTo(
                new Guid(0x14242002, 0x0320, 0x4de4, 0x95, 0x55, 0xa7, 0xd8, 0x2b, 0x73, 0xc2, 0x86)
            )
        );
    ...
    {
        Assert.That(
            PKEY_AudioEndpointSettings_LaunchContract.fmtid,
            Is.EqualTo(
                new Guid(0x14242002, 0x0320, 0x4de4, 0x95, 0x55, 0xa7, 0xd8, 0x2b, 0x73, 0xc2, 0x86)
            )
        );
