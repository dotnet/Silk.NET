...
public static unsafe partial class IActivateAudioInterfaceCompletionHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IActivateAudioInterfaceCompletionHandler).GUID,
            Is.EqualTo(IID_IActivateAudioInterfaceCompletionHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IActivateAudioInterfaceCompletionHandler>(),
            Is.EqualTo(sizeof(IActivateAudioInterfaceCompletionHandler))
        );
    }
