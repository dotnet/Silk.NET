...
public static unsafe partial class IActivateAudioInterfaceAsyncOperationTests
{
    ...
    {
        Assert.That(
            typeof(IActivateAudioInterfaceAsyncOperation).GUID,
            Is.EqualTo(IID_IActivateAudioInterfaceAsyncOperation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IActivateAudioInterfaceAsyncOperation>(),
            Is.EqualTo(sizeof(IActivateAudioInterfaceAsyncOperation))
        );
    }
