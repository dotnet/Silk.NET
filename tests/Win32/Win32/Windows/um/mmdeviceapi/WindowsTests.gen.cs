...
public static unsafe partial class WindowsTests
{
    ...
    public static void DEVINTERFACE_AUDIO_RENDERTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xe6327cad, 0xdcec, 0x4949, 0xae, 0x8a, 0x99, 0x1e, 0x97, 0x6a, 0x79, 0xd2)
            )
        );
    }
    ...
    public static void DEVINTERFACE_AUDIO_CAPTURETest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x2eef81be, 0x33fa, 0x4800, 0x96, 0x70, 0x1c, 0xd4, 0x74, 0x97, 0x2c, 0x3f)
            )
        );
    }
    ...
    public static void DEVINTERFACE_MIDI_OUTPUTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6dc23320, 0xab33, 0x4ce4, 0x80, 0xd4, 0xbb, 0xb3, 0xeb, 0xbf, 0x28, 0x14)
            )
        );
    }
    ...
    public static void DEVINTERFACE_MIDI_INPUTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x504be32c, 0xccf6, 0x4d2c, 0xb7, 0x3f, 0x6f, 0x8b, 0x37, 0x47, 0xe2, 0x2b)
            )
        );
    }
}
