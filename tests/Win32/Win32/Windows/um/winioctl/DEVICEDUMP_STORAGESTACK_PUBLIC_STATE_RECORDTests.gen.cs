...
public static unsafe partial class DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORDTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD>(),
            Is.EqualTo(sizeof(DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD))
        );
    }
    ...
    {
        Assert.That(
            typeof(DEVICEDUMP_STORAGESTACK_PUBLIC_STATE_RECORD).IsLayoutSequential,
            Is.True
        );
    }
