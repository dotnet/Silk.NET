...
public static unsafe partial class IAppxManifestHostRuntimeDependencyTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestHostRuntimeDependency).GUID,
            Is.EqualTo(IID_IAppxManifestHostRuntimeDependency)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestHostRuntimeDependency>(),
            Is.EqualTo(sizeof(IAppxManifestHostRuntimeDependency))
        );
    }
