...
public static unsafe partial class IAppxManifestApplicationsEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestApplicationsEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestApplicationsEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestApplicationsEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestApplicationsEnumerator))
        );
    }
