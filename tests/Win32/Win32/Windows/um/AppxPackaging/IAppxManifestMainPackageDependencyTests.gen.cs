...
public static unsafe partial class IAppxManifestMainPackageDependencyTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestMainPackageDependency).GUID,
            Is.EqualTo(IID_IAppxManifestMainPackageDependency)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestMainPackageDependency>(),
            Is.EqualTo(sizeof(IAppxManifestMainPackageDependency))
        );
    }
