...
public static unsafe partial class IAppxManifestApplicationTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestApplication).GUID,
            Is.EqualTo(IID_IAppxManifestApplication)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestApplication>(),
            Is.EqualTo(sizeof(IAppxManifestApplication))
        );
    }
