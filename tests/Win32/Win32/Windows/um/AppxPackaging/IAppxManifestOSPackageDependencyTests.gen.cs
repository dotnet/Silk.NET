...
public static unsafe partial class IAppxManifestOSPackageDependencyTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestOSPackageDependency).GUID,
            Is.EqualTo(IID_IAppxManifestOSPackageDependency)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestOSPackageDependency>(),
            Is.EqualTo(sizeof(IAppxManifestOSPackageDependency))
        );
    }
