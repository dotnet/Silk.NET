...
public static unsafe partial class IAppxContentGroupMapReaderTests
{
    ...
    {
        Assert.That(
            typeof(IAppxContentGroupMapReader).GUID,
            Is.EqualTo(IID_IAppxContentGroupMapReader)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxContentGroupMapReader>(),
            Is.EqualTo(sizeof(IAppxContentGroupMapReader))
        );
    }
