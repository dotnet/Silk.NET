...
public static unsafe partial class IAppxManifestTargetDeviceFamilyTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestTargetDeviceFamily).GUID,
            Is.EqualTo(IID_IAppxManifestTargetDeviceFamily)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestTargetDeviceFamily>(),
            Is.EqualTo(sizeof(IAppxManifestTargetDeviceFamily))
        );
    }
