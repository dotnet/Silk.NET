...
public static unsafe partial class IAppxBundleManifestOptionalBundleInfoTests
{
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestOptionalBundleInfo).GUID,
            Is.EqualTo(IID_IAppxBundleManifestOptionalBundleInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBundleManifestOptionalBundleInfo>(),
            Is.EqualTo(sizeof(IAppxBundleManifestOptionalBundleInfo))
        );
    }
