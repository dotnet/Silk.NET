...
public static unsafe partial class IAppxBundleManifestPackageInfoEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestPackageInfoEnumerator).GUID,
            Is.EqualTo(IID_IAppxBundleManifestPackageInfoEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBundleManifestPackageInfoEnumerator>(),
            Is.EqualTo(sizeof(IAppxBundleManifestPackageInfoEnumerator))
        );
    }
