...
public static unsafe partial class IAppxManifestOSPackageDependenciesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestOSPackageDependenciesEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestOSPackageDependenciesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestOSPackageDependenciesEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestOSPackageDependenciesEnumerator))
        );
    }
    ...
    {
        Assert.That(
            typeof(IAppxManifestOSPackageDependenciesEnumerator).IsLayoutSequential,
            Is.True
        );
    }
