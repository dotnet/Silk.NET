...
public static unsafe partial class IAppxManifestTargetDeviceFamiliesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestTargetDeviceFamiliesEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestTargetDeviceFamiliesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestTargetDeviceFamiliesEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestTargetDeviceFamiliesEnumerator))
        );
    }
    ...
    {
        Assert.That(
            typeof(IAppxManifestTargetDeviceFamiliesEnumerator).IsLayoutSequential,
            Is.True
        );
    }
