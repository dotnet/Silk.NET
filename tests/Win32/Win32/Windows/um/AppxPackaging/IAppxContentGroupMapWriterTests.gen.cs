...
public static unsafe partial class IAppxContentGroupMapWriterTests
{
    ...
    {
        Assert.That(
            typeof(IAppxContentGroupMapWriter).GUID,
            Is.EqualTo(IID_IAppxContentGroupMapWriter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxContentGroupMapWriter>(),
            Is.EqualTo(sizeof(IAppxContentGroupMapWriter))
        );
    }
