...
public static unsafe partial class IAppxBundleManifestPackageInfo4Tests
{
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestPackageInfo4).GUID,
            Is.EqualTo(IID_IAppxBundleManifestPackageInfo4)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBundleManifestPackageInfo4>(),
            Is.EqualTo(sizeof(IAppxBundleManifestPackageInfo4))
        );
    }
