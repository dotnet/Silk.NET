...
public static unsafe partial class IAppxBundleManifestOptionalBundleInfoEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestOptionalBundleInfoEnumerator).GUID,
            Is.EqualTo(IID_IAppxBundleManifestOptionalBundleInfoEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBundleManifestOptionalBundleInfoEnumerator>(),
            Is.EqualTo(sizeof(IAppxBundleManifestOptionalBundleInfoEnumerator))
        );
    }
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestOptionalBundleInfoEnumerator).IsLayoutSequential,
            Is.True
        );
    }
