...
public static unsafe partial class IAppxManifestPackageDependenciesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestPackageDependenciesEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestPackageDependenciesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestPackageDependenciesEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestPackageDependenciesEnumerator))
        );
    }
