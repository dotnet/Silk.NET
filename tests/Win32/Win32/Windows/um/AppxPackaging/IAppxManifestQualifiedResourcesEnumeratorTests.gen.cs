...
public static unsafe partial class IAppxManifestQualifiedResourcesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestQualifiedResourcesEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestQualifiedResourcesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestQualifiedResourcesEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestQualifiedResourcesEnumerator))
        );
    }
