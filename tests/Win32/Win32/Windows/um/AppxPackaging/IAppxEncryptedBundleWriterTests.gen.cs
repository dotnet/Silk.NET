...
public static unsafe partial class IAppxEncryptedBundleWriterTests
{
    ...
    {
        Assert.That(
            typeof(IAppxEncryptedBundleWriter).GUID,
            Is.EqualTo(IID_IAppxEncryptedBundleWriter)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxEncryptedBundleWriter>(),
            Is.EqualTo(sizeof(IAppxEncryptedBundleWriter))
        );
    }
