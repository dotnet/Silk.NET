...
public static unsafe partial class IAppxBundleManifestPackageInfo2Tests
{
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestPackageInfo2).GUID,
            Is.EqualTo(IID_IAppxBundleManifestPackageInfo2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBundleManifestPackageInfo2>(),
            Is.EqualTo(sizeof(IAppxBundleManifestPackageInfo2))
        );
    }
