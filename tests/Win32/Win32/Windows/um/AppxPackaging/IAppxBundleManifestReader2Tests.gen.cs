...
public static unsafe partial class IAppxBundleManifestReader2Tests
{
    ...
    {
        Assert.That(
            typeof(IAppxBundleManifestReader2).GUID,
            Is.EqualTo(IID_IAppxBundleManifestReader2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBundleManifestReader2>(),
            Is.EqualTo(sizeof(IAppxBundleManifestReader2))
        );
    }
