...
public static unsafe partial class IAppxSourceContentGroupMapReaderTests
{
    ...
    {
        Assert.That(
            typeof(IAppxSourceContentGroupMapReader).GUID,
            Is.EqualTo(IID_IAppxSourceContentGroupMapReader)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxSourceContentGroupMapReader>(),
            Is.EqualTo(sizeof(IAppxSourceContentGroupMapReader))
        );
    }
