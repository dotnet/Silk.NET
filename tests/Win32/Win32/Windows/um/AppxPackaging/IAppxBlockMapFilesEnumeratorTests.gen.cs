...
public static unsafe partial class IAppxBlockMapFilesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxBlockMapFilesEnumerator).GUID,
            Is.EqualTo(IID_IAppxBlockMapFilesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxBlockMapFilesEnumerator>(),
            Is.EqualTo(sizeof(IAppxBlockMapFilesEnumerator))
        );
    }
