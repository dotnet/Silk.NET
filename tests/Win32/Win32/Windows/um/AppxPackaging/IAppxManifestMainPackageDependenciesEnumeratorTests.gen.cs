...
public static unsafe partial class IAppxManifestMainPackageDependenciesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestMainPackageDependenciesEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestMainPackageDependenciesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestMainPackageDependenciesEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestMainPackageDependenciesEnumerator))
        );
    }
    ...
    {
        Assert.That(
            typeof(IAppxManifestMainPackageDependenciesEnumerator).IsLayoutSequential,
            Is.True
        );
    }
