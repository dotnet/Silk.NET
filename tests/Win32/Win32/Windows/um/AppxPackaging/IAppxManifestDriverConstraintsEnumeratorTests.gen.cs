...
public static unsafe partial class IAppxManifestDriverConstraintsEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestDriverConstraintsEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestDriverConstraintsEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestDriverConstraintsEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestDriverConstraintsEnumerator))
        );
    }
