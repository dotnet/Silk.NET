...
public static unsafe partial class IAppxManifestQualifiedResourceTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestQualifiedResource).GUID,
            Is.EqualTo(IID_IAppxManifestQualifiedResource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestQualifiedResource>(),
            Is.EqualTo(sizeof(IAppxManifestQualifiedResource))
        );
    }
