...
public static unsafe partial class IAppxManifestDeviceCapabilitiesEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IAppxManifestDeviceCapabilitiesEnumerator).GUID,
            Is.EqualTo(IID_IAppxManifestDeviceCapabilitiesEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxManifestDeviceCapabilitiesEnumerator>(),
            Is.EqualTo(sizeof(IAppxManifestDeviceCapabilitiesEnumerator))
        );
    }
