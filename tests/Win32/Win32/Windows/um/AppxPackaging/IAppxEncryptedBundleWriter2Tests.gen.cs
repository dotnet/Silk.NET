...
public static unsafe partial class IAppxEncryptedBundleWriter2Tests
{
    ...
    {
        Assert.That(
            typeof(IAppxEncryptedBundleWriter2).GUID,
            Is.EqualTo(IID_IAppxEncryptedBundleWriter2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppxEncryptedBundleWriter2>(),
            Is.EqualTo(sizeof(IAppxEncryptedBundleWriter2))
        );
    }
