...
public static unsafe partial class SP_DEVICE_INTERFACE_DETAIL_DATA_WTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<SP_DEVICE_INTERFACE_DETAIL_DATA_W>(),
            Is.EqualTo(sizeof(SP_DEVICE_INTERFACE_DETAIL_DATA_W))
        );
    }
    ...
    {
        Assert.That(sizeof(SP_DEVICE_INTERFACE_DETAIL_DATA_W), Is.EqualTo(8));
    }
}
