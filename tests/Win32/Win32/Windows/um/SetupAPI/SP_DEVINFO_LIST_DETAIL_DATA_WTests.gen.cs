...
public static unsafe partial class SP_DEVINFO_LIST_DETAIL_DATA_WTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<SP_DEVINFO_LIST_DETAIL_DATA_W>(),
            Is.EqualTo(sizeof(SP_DEVINFO_LIST_DETAIL_DATA_W))
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(sizeof(SP_DEVINFO_LIST_DETAIL_DATA_W), Is.EqualTo(560));
        }
        else
        {
            Assert.That(sizeof(SP_DEVINFO_LIST_DETAIL_DATA_W), Is.EqualTo(552));
        }
    }
}
