...
public static unsafe partial class IInternetSecurityMgrSiteTests
{
    ...
    {
        Assert.That(
            typeof(IInternetSecurityMgrSite).GUID,
            Is.EqualTo(IID_IInternetSecurityMgrSite)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IInternetSecurityMgrSite>(),
            Is.EqualTo(sizeof(IInternetSecurityMgrSite))
        );
    }
