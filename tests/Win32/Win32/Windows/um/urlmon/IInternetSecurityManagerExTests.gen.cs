...
public static unsafe partial class IInternetSecurityManagerExTests
{
    ...
    {
        Assert.That(
            typeof(IInternetSecurityManagerEx).GUID,
            Is.EqualTo(IID_IInternetSecurityManagerEx)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IInternetSecurityManagerEx>(),
            Is.EqualTo(sizeof(IInternetSecurityManagerEx))
        );
    }
