...
public static unsafe partial class IInternetSecurityManagerTests
{
    ...
    {
        Assert.That(
            typeof(IInternetSecurityManager).GUID,
            Is.EqualTo(IID_IInternetSecurityManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IInternetSecurityManager>(),
            Is.EqualTo(sizeof(IInternetSecurityManager))
        );
    }
