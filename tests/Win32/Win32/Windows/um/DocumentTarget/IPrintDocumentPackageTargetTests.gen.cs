...
public static unsafe partial class IPrintDocumentPackageTargetTests
{
    ...
    {
        Assert.That(
            typeof(IPrintDocumentPackageTarget).GUID,
            Is.EqualTo(IID_IPrintDocumentPackageTarget)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPrintDocumentPackageTarget>(),
            Is.EqualTo(sizeof(IPrintDocumentPackageTarget))
        );
    }
