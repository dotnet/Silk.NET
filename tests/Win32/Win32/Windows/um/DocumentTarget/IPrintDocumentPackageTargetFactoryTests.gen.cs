...
public static unsafe partial class IPrintDocumentPackageTargetFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IPrintDocumentPackageTargetFactory).GUID,
            Is.EqualTo(IID_IPrintDocumentPackageTargetFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPrintDocumentPackageTargetFactory>(),
            Is.EqualTo(sizeof(IPrintDocumentPackageTargetFactory))
        );
    }
