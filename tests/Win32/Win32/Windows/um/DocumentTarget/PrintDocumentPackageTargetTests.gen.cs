...
public static unsafe partial class PrintDocumentPackageTargetTests
{
    ...
    {
        Assert.That(
            typeof(PrintDocumentPackageTarget).GUID,
            Is.EqualTo(CLSID_PrintDocumentPackageTarget)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<PrintDocumentPackageTarget>(),
            Is.EqualTo(sizeof(PrintDocumentPackageTarget))
        );
    }
