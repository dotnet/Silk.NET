...
using static Silk.NET.Windows.ID;
...
public static partial class IDTests
{
    ...
    public static void ID_DOCUMENTPACKAGETARGET_MSXPSTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x9cae40a8, 0xded1, 0x41c9, 0xa9, 0xfd, 0xd7, 0x35, 0xef, 0x33, 0xae, 0xda)
            )
        );
    }
    ...
    public static void ID_DOCUMENTPACKAGETARGET_OPENXPSTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x0056bb72, 0x8c9c, 0x4612, 0xbd, 0x0f, 0x93, 0x01, 0x2a, 0x87, 0x09, 0x9d)
            )
        );
    }
    ...
    public static void ID_DOCUMENTPACKAGETARGET_OPENXPS_WITH_3DTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x63dbd720, 0x8b14, 0x4577, 0xb0, 0x74, 0x7b, 0xb1, 0x1b, 0x59, 0x6d, 0x28)
            )
        );
    }
}
