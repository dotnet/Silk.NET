...
public static unsafe partial class IPrintDocumentPackageStatusEventTests
{
    ...
    {
        Assert.That(
            typeof(IPrintDocumentPackageStatusEvent).GUID,
            Is.EqualTo(IID_IPrintDocumentPackageStatusEvent)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPrintDocumentPackageStatusEvent>(),
            Is.EqualTo(sizeof(IPrintDocumentPackageStatusEvent))
        );
    }
