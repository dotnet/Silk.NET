...
public static unsafe partial class PrintDocumentPackageTargetFactoryTests
{
    ...
    {
        Assert.That(
            typeof(PrintDocumentPackageTargetFactory).GUID,
            Is.EqualTo(CLSID_PrintDocumentPackageTargetFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<PrintDocumentPackageTargetFactory>(),
            Is.EqualTo(sizeof(PrintDocumentPackageTargetFactory))
        );
    }
