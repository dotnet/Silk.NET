...
public static unsafe partial class IProvideMultipleClassInfoTests
{
    ...
    {
        Assert.That(
            typeof(IProvideMultipleClassInfo).GUID,
            Is.EqualTo(IID_IProvideMultipleClassInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IProvideMultipleClassInfo>(),
            Is.EqualTo(sizeof(IProvideMultipleClassInfo))
        );
    }
