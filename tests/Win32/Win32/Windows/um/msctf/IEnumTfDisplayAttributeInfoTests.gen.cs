...
public static unsafe partial class IEnumTfDisplayAttributeInfoTests
{
    ...
    {
        Assert.That(
            typeof(IEnumTfDisplayAttributeInfo).GUID,
            Is.EqualTo(IID_IEnumTfDisplayAttributeInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IEnumTfDisplayAttributeInfo>(),
            Is.EqualTo(sizeof(IEnumTfDisplayAttributeInfo))
        );
    }
