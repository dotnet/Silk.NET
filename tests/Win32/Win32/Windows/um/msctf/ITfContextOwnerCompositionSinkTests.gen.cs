...
public static unsafe partial class ITfContextOwnerCompositionSinkTests
{
    ...
    {
        Assert.That(
            typeof(ITfContextOwnerCompositionSink).GUID,
            Is.EqualTo(IID_ITfContextOwnerCompositionSink)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfContextOwnerCompositionSink>(),
            Is.EqualTo(sizeof(ITfContextOwnerCompositionSink))
        );
    }
