...
public static unsafe partial class IEnumTfInputProcessorProfilesTests
{
    ...
    {
        Assert.That(
            typeof(IEnumTfInputProcessorProfiles).GUID,
            Is.EqualTo(IID_IEnumTfInputProcessorProfiles)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IEnumTfInputProcessorProfiles>(),
            Is.EqualTo(sizeof(IEnumTfInputProcessorProfiles))
        );
    }
