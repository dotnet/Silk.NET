...
public static unsafe partial class ITfInputProcessorProfileSubstituteLayoutTests
{
    ...
    {
        Assert.That(
            typeof(ITfInputProcessorProfileSubstituteLayout).GUID,
            Is.EqualTo(IID_ITfInputProcessorProfileSubstituteLayout)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfInputProcessorProfileSubstituteLayout>(),
            Is.EqualTo(sizeof(ITfInputProcessorProfileSubstituteLayout))
        );
    }
