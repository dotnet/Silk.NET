...
public static unsafe partial class ITfCandidateListUIElementBehaviorTests
{
    ...
    {
        Assert.That(
            typeof(ITfCandidateListUIElementBehavior).GUID,
            Is.EqualTo(IID_ITfCandidateListUIElementBehavior)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfCandidateListUIElementBehavior>(),
            Is.EqualTo(sizeof(ITfCandidateListUIElementBehavior))
        );
    }
