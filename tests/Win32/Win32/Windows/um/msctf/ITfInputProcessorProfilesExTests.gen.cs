...
public static unsafe partial class ITfInputProcessorProfilesExTests
{
    ...
    {
        Assert.That(
            typeof(ITfInputProcessorProfilesEx).GUID,
            Is.EqualTo(IID_ITfInputProcessorProfilesEx)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfInputProcessorProfilesEx>(),
            Is.EqualTo(sizeof(ITfInputProcessorProfilesEx))
        );
    }
