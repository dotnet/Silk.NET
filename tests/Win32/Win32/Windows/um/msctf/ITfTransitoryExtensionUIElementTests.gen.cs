...
public static unsafe partial class ITfTransitoryExtensionUIElementTests
{
    ...
    {
        Assert.That(
            typeof(ITfTransitoryExtensionUIElement).GUID,
            Is.EqualTo(IID_ITfTransitoryExtensionUIElement)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ITfTransitoryExtensionUIElement>(),
            Is.EqualTo(sizeof(ITfTransitoryExtensionUIElement))
        );
    }
