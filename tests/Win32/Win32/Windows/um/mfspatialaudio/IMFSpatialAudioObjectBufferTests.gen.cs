...
public static unsafe partial class IMFSpatialAudioObjectBufferTests
{
    ...
    {
        Assert.That(
            typeof(IMFSpatialAudioObjectBuffer).GUID,
            Is.EqualTo(IID_IMFSpatialAudioObjectBuffer)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMFSpatialAudioObjectBuffer>(),
            Is.EqualTo(sizeof(IMFSpatialAudioObjectBuffer))
        );
    }
