...
public static partial class IIDTests
{
    ...
    {
        Assert.That(
            IID_ID3D12CommandQueueDownlevel,
            Is.EqualTo(
                new Guid(0x38a8c5ef, 0x7ccb, 0x4e81, 0x91, 0x4f, 0xa6, 0xe9, 0xd0, 0x72, 0xc4, 0x94)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_ID3D12DeviceDownlevel,
            Is.EqualTo(
                new Guid(0x74eaee3f, 0x2f4b, 0x476d, 0x82, 0xba, 0x2b, 0x85, 0xcb, 0x49, 0xe3, 0x10)
            )
        );
    }
}
