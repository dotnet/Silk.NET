...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMANDSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMANDS>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMANDS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_EXTENSION_COMMANDS).IsLayoutSequential,
            Is.True
        );
    }
