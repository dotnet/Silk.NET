...
public static unsafe partial class D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT>(),
            Is.EqualTo(sizeof(D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_INPUT).IsLayoutSequential,
            Is.True
        );
    }
