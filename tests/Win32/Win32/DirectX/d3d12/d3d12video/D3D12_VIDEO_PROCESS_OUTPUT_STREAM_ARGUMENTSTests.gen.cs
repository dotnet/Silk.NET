...
public static unsafe partial class D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_PROCESS_OUTPUT_STREAM_ARGUMENTS).IsLayoutSequential,
            Is.True
        );
    }
