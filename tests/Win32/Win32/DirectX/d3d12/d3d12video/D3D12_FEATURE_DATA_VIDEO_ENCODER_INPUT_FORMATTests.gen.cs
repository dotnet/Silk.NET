...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_ENCODER_INPUT_FORMATTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_ENCODER_INPUT_FORMAT>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_INPUT_FORMAT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_INPUT_FORMAT).IsLayoutSequential,
            Is.True
        );
    }
