...
public static unsafe partial class D3D12_VIDEO_ENCODER_ENCODE_OPERATION_METADATA_BUFFERTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_ENCODE_OPERATION_METADATA_BUFFER>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_ENCODE_OPERATION_METADATA_BUFFER))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_ENCODE_OPERATION_METADATA_BUFFER).IsLayoutSequential,
            Is.True
        );
    }
