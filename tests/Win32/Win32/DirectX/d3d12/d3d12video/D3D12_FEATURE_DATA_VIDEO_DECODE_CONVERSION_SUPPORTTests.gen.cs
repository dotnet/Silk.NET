...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_DECODE_CONVERSION_SUPPORTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_DECODE_CONVERSION_SUPPORT>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_DECODE_CONVERSION_SUPPORT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_DECODE_CONVERSION_SUPPORT).IsLayoutSequential,
            Is.True
        );
    }
