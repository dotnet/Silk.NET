...
public static unsafe partial class D3D12_FEATURE_DATA_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_MODETests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_MODE>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_MODE))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_MODE).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(D3D12_FEATURE_DATA_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_MODE),
                Is.EqualTo(48)
            );
        }
        else
