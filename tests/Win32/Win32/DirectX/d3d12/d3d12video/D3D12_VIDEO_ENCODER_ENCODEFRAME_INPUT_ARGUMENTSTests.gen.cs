...
public static unsafe partial class D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS).IsLayoutSequential,
            Is.True
        );
    }
