...
public static partial class IIDTests
{
    ...
    {
        Assert.That(
            IID_ID3D12CompatibilityDevice,
            Is.EqualTo(
                new Guid(0x8f1c0e3c, 0xfae3, 0x4a82, 0xb0, 0x98, 0xbf, 0xe1, 0x70, 0x82, 0x07, 0xff)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_D3D11On12CreatorID,
            Is.EqualTo(
                new Guid(0xedbf5678, 0x2960, 0x4e81, 0x84, 0x29, 0x99, 0xd4, 0xb2, 0x63, 0x0c, 0x4e)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_D3D9On12CreatorID,
            Is.EqualTo(
                new Guid(0xfffcbb7f, 0x15d3, 0x42a2, 0x84, 0x1e, 0x9d, 0x8d, 0x32, 0xf3, 0x7d, 0xdd)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_OpenGLOn12CreatorID,
            Is.EqualTo(
                new Guid(0x6bb3cd34, 0x0d19, 0x45ab, 0x97, 0xed, 0xd7, 0x20, 0xba, 0x3d, 0xfc, 0x80)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_OpenCLOn12CreatorID,
            Is.EqualTo(
                new Guid(0x3f76bb74, 0x91b5, 0x4a88, 0xb1, 0x26, 0x20, 0xca, 0x03, 0x31, 0xcd, 0x60)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_VulkanOn12CreatorID,
            Is.EqualTo(
                new Guid(0xbc806e01, 0x3052, 0x406c, 0xa3, 0xe8, 0x9f, 0xc0, 0x7f, 0x04, 0x8f, 0x98)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_DirectMLTensorFlowCreatorID,
            Is.EqualTo(
                new Guid(0xcb7490ac, 0x8a0f, 0x44ec, 0x9b, 0x7b, 0x6f, 0x4c, 0xaf, 0xe8, 0xe9, 0xab)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_DirectMLPyTorchCreatorID,
            Is.EqualTo(
                new Guid(0xaf029192, 0xfba1, 0x4b05, 0x91, 0x16, 0x23, 0x5e, 0x06, 0x56, 0x03, 0x54)
            )
        );
    }
}
