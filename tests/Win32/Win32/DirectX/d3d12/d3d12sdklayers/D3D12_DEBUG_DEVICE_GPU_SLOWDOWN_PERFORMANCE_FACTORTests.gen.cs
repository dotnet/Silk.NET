...
public static unsafe partial class D3D12_DEBUG_DEVICE_GPU_SLOWDOWN_PERFORMANCE_FACTORTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_DEBUG_DEVICE_GPU_SLOWDOWN_PERFORMANCE_FACTOR>(),
            Is.EqualTo(sizeof(D3D12_DEBUG_DEVICE_GPU_SLOWDOWN_PERFORMANCE_FACTOR))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_DEBUG_DEVICE_GPU_SLOWDOWN_PERFORMANCE_FACTOR).IsLayoutSequential,
            Is.True
        );
    }
