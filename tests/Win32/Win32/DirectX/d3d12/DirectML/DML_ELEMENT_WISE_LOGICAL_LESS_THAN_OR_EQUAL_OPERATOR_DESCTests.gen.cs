...
public static unsafe partial class DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OR_EQUAL_OPERATOR_DESCTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OR_EQUAL_OPERATOR_DESC>(),
            Is.EqualTo(sizeof(DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OR_EQUAL_OPERATOR_DESC))
        );
    }
    ...
    {
        Assert.That(
            typeof(DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OR_EQUAL_OPERATOR_DESC).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OR_EQUAL_OPERATOR_DESC),
                Is.EqualTo(24)
            );
        }
        else
