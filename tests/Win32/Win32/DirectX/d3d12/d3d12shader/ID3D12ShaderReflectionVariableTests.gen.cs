...
public static unsafe partial class ID3D12ShaderReflectionVariableTests
{
    ...
    {
        Assert.That(
            typeof(ID3D12ShaderReflectionVariable).GUID,
            Is.EqualTo(IID_ID3D12ShaderReflectionVariable)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12ShaderReflectionVariable>(),
            Is.EqualTo(sizeof(ID3D12ShaderReflectionVariable))
        );
    }
