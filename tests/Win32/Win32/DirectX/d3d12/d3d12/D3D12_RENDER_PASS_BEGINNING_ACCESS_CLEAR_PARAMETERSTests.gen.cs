...
public static unsafe partial class D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS>(),
            Is.EqualTo(sizeof(D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_RENDER_PASS_BEGINNING_ACCESS_CLEAR_PARAMETERS).IsLayoutSequential,
            Is.True
        );
    }
