...
public static unsafe partial class D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS>(),
            Is.EqualTo(sizeof(D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_RENDER_PASS_ENDING_ACCESS_RESOLVE_PARAMETERS).IsLayoutSequential,
            Is.True
        );
    }
