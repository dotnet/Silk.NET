...
public static unsafe partial class ID3D12SwapChainAssistantTests
{
    ...
    {
        Assert.That(
            typeof(ID3D12SwapChainAssistant).GUID,
            Is.EqualTo(IID_ID3D12SwapChainAssistant)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12SwapChainAssistant>(),
            Is.EqualTo(sizeof(ID3D12SwapChainAssistant))
        );
    }
