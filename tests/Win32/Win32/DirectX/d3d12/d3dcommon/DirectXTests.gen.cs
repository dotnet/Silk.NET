...
{
    /// <summary>Validates that the value of the <see cref = "WkpdidD3DDebugObjectName"/> property is correct.</summary>

    [Test]
    public static void WKPDID_D3DDebugObjectNameTest()
    {
        Assert.That(
            WkpdidD3DDebugObjectName,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "WkpdidD3DDebugObjectNameW"/> property is correct.</summary>

    [Test]
    public static void WKPDID_D3DDebugObjectNameWTest()
    {
        Assert.That(
            WkpdidD3DDebugObjectNameW,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "WkpdidCommentStringW"/> property is correct.</summary>

    [Test]
    public static void WKPDID_CommentStringWTest()
    {
        Assert.That(
            WkpdidCommentStringW,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "WkpdidD3D12UniqueObjectId"/> property is correct.</summary>

    [Test]
    public static void WKPDID_D3D12UniqueObjectIdTest()
    {
        Assert.That(
            WkpdidD3D12UniqueObjectId,
            Is.EqualTo(
