...
{
    /// <summary>Validates that the value of the <see cref = "TextureLayoutRowMajor"/> property is correct.</summary>

    [Test]
    public static void D3D_TEXTURE_LAYOUT_ROW_MAJORTest()
    {
        Assert.That(
            TextureLayoutRowMajor,
            Is.EqualTo(
    ...
    /// <summary>Validates that the value of the <see cref = "TextureLayout64KbStandardSwizzle"/> property is correct.</summary>

    [Test]
    public static void D3D_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLETest()
    {
        Assert.That(
            TextureLayout64KbStandardSwizzle,
            Is.EqualTo(
