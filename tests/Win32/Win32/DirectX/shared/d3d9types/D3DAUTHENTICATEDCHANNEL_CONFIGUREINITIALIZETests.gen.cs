...
public static unsafe partial class D3DAUTHENTICATEDCHANNEL_CONFIGUREINITIALIZETests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3DAUTHENTICATEDCHANNEL_CONFIGUREINITIALIZE>(),
            Is.EqualTo(sizeof(D3DAUTHENTICATEDCHANNEL_CONFIGUREINITIALIZE))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3DAUTHENTICATEDCHANNEL_CONFIGUREINITIALIZE).IsLayoutSequential,
            Is.True
        );
    }
