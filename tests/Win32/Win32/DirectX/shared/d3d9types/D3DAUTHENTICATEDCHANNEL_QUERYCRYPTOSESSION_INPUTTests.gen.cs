...
public static unsafe partial class D3DAUTHENTICATEDCHANNEL_QUERYCRYPTOSESSION_INPUTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3DAUTHENTICATEDCHANNEL_QUERYCRYPTOSESSION_INPUT>(),
            Is.EqualTo(sizeof(D3DAUTHENTICATEDCHANNEL_QUERYCRYPTOSESSION_INPUT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3DAUTHENTICATEDCHANNEL_QUERYCRYPTOSESSION_INPUT).IsLayoutSequential,
            Is.True
        );
    }
