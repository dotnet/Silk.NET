...
public static unsafe partial class D3DDEVINFO_D3D9CACHEUTILIZATIONTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3DDEVINFO_D3D9CACHEUTILIZATION>(),
            Is.EqualTo(sizeof(D3DDEVINFO_D3D9CACHEUTILIZATION))
        );
    }
    ...
    {
        Assert.That(typeof(D3DDEVINFO_D3D9CACHEUTILIZATION).IsLayoutSequential, Is.True);
    }
    ...
    {
        Assert.That(sizeof(D3DDEVINFO_D3D9CACHEUTILIZATION), Is.EqualTo(8));
    }
}
