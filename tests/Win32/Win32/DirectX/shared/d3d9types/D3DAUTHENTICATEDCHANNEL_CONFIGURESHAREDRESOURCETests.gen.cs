...
public static unsafe partial class D3DAUTHENTICATEDCHANNEL_CONFIGURESHAREDRESOURCETests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3DAUTHENTICATEDCHANNEL_CONFIGURESHAREDRESOURCE>(),
            Is.EqualTo(sizeof(D3DAUTHENTICATEDCHANNEL_CONFIGURESHAREDRESOURCE))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3DAUTHENTICATEDCHANNEL_CONFIGURESHAREDRESOURCE).IsLayoutSequential,
            Is.True
        );
    }
