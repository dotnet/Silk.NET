...
public static unsafe partial class IDirect3DCryptoSession9Tests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirect3DCryptoSession9>(),
            Is.EqualTo(sizeof(IDirect3DCryptoSession9))
        );
    }
    ...
    {
        Assert.That(typeof(IDirect3DCryptoSession9).IsLayoutSequential, Is.True);
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(sizeof(IDirect3DCryptoSession9), Is.EqualTo(8));
        }
        else
        {
            Assert.That(sizeof(IDirect3DCryptoSession9), Is.EqualTo(4));
        }
    }
}
