...
public static unsafe partial class IDirect3D9ExOverlayExtensionTests
{
    ...
    {
        Assert.That(
            typeof(IDirect3D9ExOverlayExtension).GUID,
            Is.EqualTo(IID_IDirect3D9ExOverlayExtension)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirect3D9ExOverlayExtension>(),
            Is.EqualTo(sizeof(IDirect3D9ExOverlayExtension))
        );
    }
    ...
    {
        Assert.That(typeof(IDirect3D9ExOverlayExtension).IsLayoutSequential, Is.True);
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(sizeof(IDirect3D9ExOverlayExtension), Is.EqualTo(8));
        }
        else
        {
            Assert.That(sizeof(IDirect3D9ExOverlayExtension), Is.EqualTo(4));
        }
    }
}
