...
public static unsafe partial class D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS>(),
            Is.EqualTo(sizeof(D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_INPUTS).IsLayoutSequential,
            Is.True
        );
    }
