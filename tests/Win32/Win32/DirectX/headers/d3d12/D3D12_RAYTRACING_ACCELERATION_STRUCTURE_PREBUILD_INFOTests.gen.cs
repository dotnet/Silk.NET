...
public static unsafe partial class D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFOTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFO>(),
            Is.EqualTo(sizeof(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFO))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_RAYTRACING_ACCELERATION_STRUCTURE_PREBUILD_INFO).IsLayoutSequential,
            Is.True
        );
    }
