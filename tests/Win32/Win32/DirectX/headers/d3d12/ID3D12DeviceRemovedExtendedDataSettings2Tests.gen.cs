...
public static unsafe partial class ID3D12DeviceRemovedExtendedDataSettings2Tests
{
    ...
    {
        Assert.That(
            typeof(ID3D12DeviceRemovedExtendedDataSettings2).GUID,
            Is.EqualTo(IID_ID3D12DeviceRemovedExtendedDataSettings2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D12DeviceRemovedExtendedDataSettings2>(),
            Is.EqualTo(sizeof(ID3D12DeviceRemovedExtendedDataSettings2))
        );
    }
