...
public static unsafe partial class D3D12_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT>(),
            Is.EqualTo(sizeof(D3D12_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_FEATURE_DATA_GPU_VIRTUAL_ADDRESS_SUPPORT).IsLayoutSequential,
            Is.True
        );
    }
