...
public static unsafe partial class D3D12_VIDEO_ENCODER_RATE_CONTROL_CONFIGURATION_PARAMSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_VIDEO_ENCODER_RATE_CONTROL_CONFIGURATION_PARAMS>(),
            Is.EqualTo(sizeof(D3D12_VIDEO_ENCODER_RATE_CONTROL_CONFIGURATION_PARAMS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_VIDEO_ENCODER_RATE_CONTROL_CONFIGURATION_PARAMS).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(D3D12_VIDEO_ENCODER_RATE_CONTROL_CONFIGURATION_PARAMS),
                Is.EqualTo(16)
            );
        }
        else
