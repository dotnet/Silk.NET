...
public static unsafe partial class D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT>(),
            Is.EqualTo(sizeof(D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D12_RESOLVE_VIDEO_MOTION_VECTOR_HEAP_OUTPUT).IsLayoutSequential,
            Is.True
        );
    }
