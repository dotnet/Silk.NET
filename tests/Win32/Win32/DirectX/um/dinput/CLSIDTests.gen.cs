...
public static partial class CLSIDTests
{
    ...
    public static void CLSID_DirectInputTest()
    {
        Assert.That(
            CLSID_DirectInput,
            Is.EqualTo(
                new Guid(0x25E609E0, 0xB259, 0x11CF, 0xBF, 0xC7, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00)
            )
        );
    }
    ...
    public static void CLSID_DirectInputDeviceTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x25E609E1, 0xB259, 0x11CF, 0xBF, 0xC7, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00)
            )
        );
    }
    ...
    public static void CLSID_DirectInput8Test()
    {
        Assert.That(
            CLSID_DirectInput8,
            Is.EqualTo(
                new Guid(0x25E609E4, 0xB259, 0x11CF, 0xBF, 0xC7, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00)
            )
        );
    }
    ...
    public static void CLSID_DirectInputDevice8Test()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x25E609E5, 0xB259, 0x11CF, 0xBF, 0xC7, 0x44, 0x45, 0x53, 0x54, 0x00, 0x00)
            )
        );
    }
}
