...
public static partial class IIDTests
{
    ...
    public static void IID_ID3D10DebugTest()
    {
        Assert.That(
            IID_ID3D10Debug,
            Is.EqualTo(
                new Guid(0x9B7E4E01, 0x342C, 0x4106, 0xA1, 0x9F, 0x4F, 0x27, 0x04, 0xF6, 0x89, 0xF0)
            )
        );
    }
    ...
    public static void IID_ID3D10SwitchToRefTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x9B7E4E02, 0x342C, 0x4106, 0xA1, 0x9F, 0x4F, 0x27, 0x04, 0xF6, 0x89, 0xF0)
            )
        );
    }
    ...
    public static void IID_ID3D10InfoQueueTest()
    {
        Assert.That(
            IID_ID3D10InfoQueue,
            Is.EqualTo(
                new Guid(0x1b940b17, 0x2642, 0x4d1f, 0xab, 0x1f, 0xb9, 0x9b, 0xad, 0x0c, 0x39, 0x5f)
            )
        );
    }
}
