...
public static unsafe partial class ID3D11FunctionParameterReflectionTests
{
    ...
    {
        Assert.That(
            typeof(ID3D11FunctionParameterReflection).GUID,
            Is.EqualTo(IID_ID3D11FunctionParameterReflection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D11FunctionParameterReflection>(),
            Is.EqualTo(sizeof(ID3D11FunctionParameterReflection))
        );
    }
