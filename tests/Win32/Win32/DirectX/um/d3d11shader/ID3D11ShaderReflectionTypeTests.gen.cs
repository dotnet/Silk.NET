...
public static unsafe partial class ID3D11ShaderReflectionTypeTests
{
    ...
    {
        Assert.That(
            typeof(ID3D11ShaderReflectionType).GUID,
            Is.EqualTo(IID_ID3D11ShaderReflectionType)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D11ShaderReflectionType>(),
            Is.EqualTo(sizeof(ID3D11ShaderReflectionType))
        );
    }
