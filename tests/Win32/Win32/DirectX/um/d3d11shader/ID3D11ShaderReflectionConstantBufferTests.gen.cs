...
public static unsafe partial class ID3D11ShaderReflectionConstantBufferTests
{
    ...
    {
        Assert.That(
            typeof(ID3D11ShaderReflectionConstantBuffer).GUID,
            Is.EqualTo(IID_ID3D11ShaderReflectionConstantBuffer)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D11ShaderReflectionConstantBuffer>(),
            Is.EqualTo(sizeof(ID3D11ShaderReflectionConstantBuffer))
        );
    }
