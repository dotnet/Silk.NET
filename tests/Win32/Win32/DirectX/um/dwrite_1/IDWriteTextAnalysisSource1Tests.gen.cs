...
public static unsafe partial class IDWriteTextAnalysisSource1Tests
{
    ...
    {
        Assert.That(
            typeof(IDWriteTextAnalysisSource1).GUID,
            Is.EqualTo(IID_IDWriteTextAnalysisSource1)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteTextAnalysisSource1>(),
            Is.EqualTo(sizeof(IDWriteTextAnalysisSource1))
        );
    }
