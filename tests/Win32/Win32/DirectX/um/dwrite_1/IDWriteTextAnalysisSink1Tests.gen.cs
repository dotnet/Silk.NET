...
public static unsafe partial class IDWriteTextAnalysisSink1Tests
{
    ...
    {
        Assert.That(
            typeof(IDWriteTextAnalysisSink1).GUID,
            Is.EqualTo(IID_IDWriteTextAnalysisSink1)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteTextAnalysisSink1>(),
            Is.EqualTo(sizeof(IDWriteTextAnalysisSink1))
        );
    }
