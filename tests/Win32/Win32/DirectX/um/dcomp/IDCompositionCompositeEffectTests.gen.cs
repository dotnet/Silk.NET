...
public static unsafe partial class IDCompositionCompositeEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionCompositeEffect).GUID,
            Is.EqualTo(IID_IDCompositionCompositeEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionCompositeEffect>(),
            Is.EqualTo(sizeof(IDCompositionCompositeEffect))
        );
    }
