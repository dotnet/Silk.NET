...
public static unsafe partial class IDCompositionTableTransferEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionTableTransferEffect).GUID,
            Is.EqualTo(IID_IDCompositionTableTransferEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionTableTransferEffect>(),
            Is.EqualTo(sizeof(IDCompositionTableTransferEffect))
        );
    }
