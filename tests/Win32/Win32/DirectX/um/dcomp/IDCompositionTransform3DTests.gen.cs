...
public static unsafe partial class IDCompositionTransform3DTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionTransform3D).GUID,
            Is.EqualTo(IID_IDCompositionTransform3D)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionTransform3D>(),
            Is.EqualTo(sizeof(IDCompositionTransform3D))
        );
    }
