...
public static unsafe partial class IDCompositionRotateTransformTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionRotateTransform).GUID,
            Is.EqualTo(IID_IDCompositionRotateTransform)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionRotateTransform>(),
            Is.EqualTo(sizeof(IDCompositionRotateTransform))
        );
    }
