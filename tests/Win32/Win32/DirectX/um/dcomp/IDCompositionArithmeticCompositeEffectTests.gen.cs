...
public static unsafe partial class IDCompositionArithmeticCompositeEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionArithmeticCompositeEffect).GUID,
            Is.EqualTo(IID_IDCompositionArithmeticCompositeEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionArithmeticCompositeEffect>(),
            Is.EqualTo(sizeof(IDCompositionArithmeticCompositeEffect))
        );
    }
