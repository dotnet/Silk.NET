...
public static unsafe partial class IDCompositionRotateTransform3DTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionRotateTransform3D).GUID,
            Is.EqualTo(IID_IDCompositionRotateTransform3D)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionRotateTransform3D>(),
            Is.EqualTo(sizeof(IDCompositionRotateTransform3D))
        );
    }
