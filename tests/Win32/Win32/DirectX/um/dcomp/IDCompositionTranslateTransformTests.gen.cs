...
public static unsafe partial class IDCompositionTranslateTransformTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionTranslateTransform).GUID,
            Is.EqualTo(IID_IDCompositionTranslateTransform)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionTranslateTransform>(),
            Is.EqualTo(sizeof(IDCompositionTranslateTransform))
        );
    }
