...
public static unsafe partial class IDCompositionSurfaceFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionSurfaceFactory).GUID,
            Is.EqualTo(IID_IDCompositionSurfaceFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionSurfaceFactory>(),
            Is.EqualTo(sizeof(IDCompositionSurfaceFactory))
        );
    }
