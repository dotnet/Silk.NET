...
public static unsafe partial class IDCompositionDesktopDeviceTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionDesktopDevice).GUID,
            Is.EqualTo(IID_IDCompositionDesktopDevice)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionDesktopDevice>(),
            Is.EqualTo(sizeof(IDCompositionDesktopDevice))
        );
    }
