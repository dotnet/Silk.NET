...
public static unsafe partial class IDCompositionVirtualSurfaceTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionVirtualSurface).GUID,
            Is.EqualTo(IID_IDCompositionVirtualSurface)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionVirtualSurface>(),
            Is.EqualTo(sizeof(IDCompositionVirtualSurface))
        );
    }
