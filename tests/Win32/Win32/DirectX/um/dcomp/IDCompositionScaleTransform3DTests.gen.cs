...
public static unsafe partial class IDCompositionScaleTransform3DTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionScaleTransform3D).GUID,
            Is.EqualTo(IID_IDCompositionScaleTransform3D)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionScaleTransform3D>(),
            Is.EqualTo(sizeof(IDCompositionScaleTransform3D))
        );
    }
