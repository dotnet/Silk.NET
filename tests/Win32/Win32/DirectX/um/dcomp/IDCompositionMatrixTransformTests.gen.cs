...
public static unsafe partial class IDCompositionMatrixTransformTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionMatrixTransform).GUID,
            Is.EqualTo(IID_IDCompositionMatrixTransform)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionMatrixTransform>(),
            Is.EqualTo(sizeof(IDCompositionMatrixTransform))
        );
    }
