...
public static unsafe partial class IDCompositionScaleTransformTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionScaleTransform).GUID,
            Is.EqualTo(IID_IDCompositionScaleTransform)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionScaleTransform>(),
            Is.EqualTo(sizeof(IDCompositionScaleTransform))
        );
    }
