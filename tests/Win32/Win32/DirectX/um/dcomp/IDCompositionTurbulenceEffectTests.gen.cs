...
public static unsafe partial class IDCompositionTurbulenceEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionTurbulenceEffect).GUID,
            Is.EqualTo(IID_IDCompositionTurbulenceEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionTurbulenceEffect>(),
            Is.EqualTo(sizeof(IDCompositionTurbulenceEffect))
        );
    }
