...
public static unsafe partial class IDCompositionShadowEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionShadowEffect).GUID,
            Is.EqualTo(IID_IDCompositionShadowEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionShadowEffect>(),
            Is.EqualTo(sizeof(IDCompositionShadowEffect))
        );
    }
