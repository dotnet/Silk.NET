...
public static unsafe partial class IDCompositionVisualDebugTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionVisualDebug).GUID,
            Is.EqualTo(IID_IDCompositionVisualDebug)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionVisualDebug>(),
            Is.EqualTo(sizeof(IDCompositionVisualDebug))
        );
    }
