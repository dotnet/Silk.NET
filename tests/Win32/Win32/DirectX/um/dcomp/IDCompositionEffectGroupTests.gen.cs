...
public static unsafe partial class IDCompositionEffectGroupTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionEffectGroup).GUID,
            Is.EqualTo(IID_IDCompositionEffectGroup)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionEffectGroup>(),
            Is.EqualTo(sizeof(IDCompositionEffectGroup))
        );
    }
