...
public static unsafe partial class IDCompositionColorMatrixEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionColorMatrixEffect).GUID,
            Is.EqualTo(IID_IDCompositionColorMatrixEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionColorMatrixEffect>(),
            Is.EqualTo(sizeof(IDCompositionColorMatrixEffect))
        );
    }
