...
public static unsafe partial class IDCompositionHueRotationEffectTests
{
    ...
    {
        Assert.That(
            typeof(IDCompositionHueRotationEffect).GUID,
            Is.EqualTo(IID_IDCompositionHueRotationEffect)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDCompositionHueRotationEffect>(),
            Is.EqualTo(sizeof(IDCompositionHueRotationEffect))
        );
    }
