...
public static unsafe partial class ID2D1TransformedImageSourceTests
{
    ...
    {
        Assert.That(
            typeof(ID2D1TransformedImageSource).GUID,
            Is.EqualTo(IID_ID2D1TransformedImageSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID2D1TransformedImageSource>(),
            Is.EqualTo(sizeof(ID2D1TransformedImageSource))
        );
    }
