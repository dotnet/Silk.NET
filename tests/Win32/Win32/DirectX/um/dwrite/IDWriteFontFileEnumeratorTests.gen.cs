...
public static unsafe partial class IDWriteFontFileEnumeratorTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteFontFileEnumerator).GUID,
            Is.EqualTo(IID_IDWriteFontFileEnumerator)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteFontFileEnumerator>(),
            Is.EqualTo(sizeof(IDWriteFontFileEnumerator))
        );
    }
