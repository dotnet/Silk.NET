...
public static unsafe partial class IDWriteBitmapRenderTargetTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteBitmapRenderTarget).GUID,
            Is.EqualTo(IID_IDWriteBitmapRenderTarget)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteBitmapRenderTarget>(),
            Is.EqualTo(sizeof(IDWriteBitmapRenderTarget))
        );
    }
