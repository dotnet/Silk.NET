...
public static unsafe partial class IDWriteTextAnalysisSourceTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteTextAnalysisSource).GUID,
            Is.EqualTo(IID_IDWriteTextAnalysisSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteTextAnalysisSource>(),
            Is.EqualTo(sizeof(IDWriteTextAnalysisSource))
        );
    }
