...
public static unsafe partial class IDirectManipulationViewportEventHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationViewportEventHandler).GUID,
            Is.EqualTo(IID_IDirectManipulationViewportEventHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationViewportEventHandler>(),
            Is.EqualTo(sizeof(IDirectManipulationViewportEventHandler))
        );
    }
