...
public static unsafe partial class IDirectManipulationManagerTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationManager).GUID,
            Is.EqualTo(IID_IDirectManipulationManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationManager>(),
            Is.EqualTo(sizeof(IDirectManipulationManager))
        );
    }
