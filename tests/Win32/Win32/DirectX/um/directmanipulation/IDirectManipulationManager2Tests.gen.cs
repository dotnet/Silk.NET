...
public static unsafe partial class IDirectManipulationManager2Tests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationManager2).GUID,
            Is.EqualTo(IID_IDirectManipulationManager2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationManager2>(),
            Is.EqualTo(sizeof(IDirectManipulationManager2))
        );
    }
