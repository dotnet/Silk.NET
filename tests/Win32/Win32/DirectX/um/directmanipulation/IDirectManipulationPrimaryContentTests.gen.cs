...
public static unsafe partial class IDirectManipulationPrimaryContentTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationPrimaryContent).GUID,
            Is.EqualTo(IID_IDirectManipulationPrimaryContent)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationPrimaryContent>(),
            Is.EqualTo(sizeof(IDirectManipulationPrimaryContent))
        );
    }
