...
public static unsafe partial class DirectManipulationSharedManagerTests
{
    ...
    {
        Assert.That(
            typeof(DirectManipulationSharedManager).GUID,
            Is.EqualTo(CLSID_DirectManipulationSharedManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DirectManipulationSharedManager>(),
            Is.EqualTo(sizeof(DirectManipulationSharedManager))
        );
    }
