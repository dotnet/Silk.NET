...
public static unsafe partial class DCompManipulationCompositorTests
{
    ...
    {
        Assert.That(
            typeof(DCompManipulationCompositor).GUID,
            Is.EqualTo(CLSID_DCompManipulationCompositor)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DCompManipulationCompositor>(),
            Is.EqualTo(sizeof(DCompManipulationCompositor))
        );
    }
