...
public static unsafe partial class IDirectManipulationCompositorTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationCompositor).GUID,
            Is.EqualTo(IID_IDirectManipulationCompositor)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationCompositor>(),
            Is.EqualTo(sizeof(IDirectManipulationCompositor))
        );
    }
