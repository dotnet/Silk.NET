...
public static unsafe partial class IDirectManipulationDeferContactServiceTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationDeferContactService).GUID,
            Is.EqualTo(IID_IDirectManipulationDeferContactService)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationDeferContactService>(),
            Is.EqualTo(sizeof(IDirectManipulationDeferContactService))
        );
    }
