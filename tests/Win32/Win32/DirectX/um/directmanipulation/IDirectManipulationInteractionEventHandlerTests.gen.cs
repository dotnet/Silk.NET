...
public static unsafe partial class IDirectManipulationInteractionEventHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationInteractionEventHandler).GUID,
            Is.EqualTo(IID_IDirectManipulationInteractionEventHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationInteractionEventHandler>(),
            Is.EqualTo(sizeof(IDirectManipulationInteractionEventHandler))
        );
    }
