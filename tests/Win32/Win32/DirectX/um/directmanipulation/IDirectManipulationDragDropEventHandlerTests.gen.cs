...
public static unsafe partial class IDirectManipulationDragDropEventHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationDragDropEventHandler).GUID,
            Is.EqualTo(IID_IDirectManipulationDragDropEventHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationDragDropEventHandler>(),
            Is.EqualTo(sizeof(IDirectManipulationDragDropEventHandler))
        );
    }
