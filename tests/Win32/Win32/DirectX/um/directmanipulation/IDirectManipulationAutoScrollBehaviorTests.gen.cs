...
public static unsafe partial class IDirectManipulationAutoScrollBehaviorTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationAutoScrollBehavior).GUID,
            Is.EqualTo(IID_IDirectManipulationAutoScrollBehavior)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationAutoScrollBehavior>(),
            Is.EqualTo(sizeof(IDirectManipulationAutoScrollBehavior))
        );
    }
