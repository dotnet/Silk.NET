...
public static unsafe partial class IDirectManipulationUpdateHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationUpdateHandler).GUID,
            Is.EqualTo(IID_IDirectManipulationUpdateHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationUpdateHandler>(),
            Is.EqualTo(sizeof(IDirectManipulationUpdateHandler))
        );
    }
