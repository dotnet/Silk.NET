...
public static unsafe partial class IDirectManipulationViewportTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationViewport).GUID,
            Is.EqualTo(IID_IDirectManipulationViewport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationViewport>(),
            Is.EqualTo(sizeof(IDirectManipulationViewport))
        );
    }
