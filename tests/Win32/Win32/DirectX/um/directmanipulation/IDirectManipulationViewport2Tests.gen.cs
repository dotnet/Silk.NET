...
public static unsafe partial class IDirectManipulationViewport2Tests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationViewport2).GUID,
            Is.EqualTo(IID_IDirectManipulationViewport2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationViewport2>(),
            Is.EqualTo(sizeof(IDirectManipulationViewport2))
        );
    }
