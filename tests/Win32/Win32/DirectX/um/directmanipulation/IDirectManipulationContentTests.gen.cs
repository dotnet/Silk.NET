...
public static unsafe partial class IDirectManipulationContentTests
{
    ...
    {
        Assert.That(
            typeof(IDirectManipulationContent).GUID,
            Is.EqualTo(IID_IDirectManipulationContent)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDirectManipulationContent>(),
            Is.EqualTo(sizeof(IDirectManipulationContent))
        );
    }
