...
public static unsafe partial class DirectManipulationManagerTests
{
    ...
    {
        Assert.That(
            typeof(DirectManipulationManager).GUID,
            Is.EqualTo(CLSID_DirectManipulationManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<DirectManipulationManager>(),
            Is.EqualTo(sizeof(DirectManipulationManager))
        );
    }
