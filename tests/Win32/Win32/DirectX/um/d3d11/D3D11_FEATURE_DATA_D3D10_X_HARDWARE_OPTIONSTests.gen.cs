...
public static unsafe partial class D3D11_FEATURE_DATA_D3D10_X_HARDWARE_OPTIONSTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D11_FEATURE_DATA_D3D10_X_HARDWARE_OPTIONS>(),
            Is.EqualTo(sizeof(D3D11_FEATURE_DATA_D3D10_X_HARDWARE_OPTIONS))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D11_FEATURE_DATA_D3D10_X_HARDWARE_OPTIONS).IsLayoutSequential,
            Is.True
        );
    }
