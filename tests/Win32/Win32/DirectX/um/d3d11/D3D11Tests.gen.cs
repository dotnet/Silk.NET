...
public static partial class D3D11Tests
{
    ...
    public static void D3D11_DECODER_PROFILE_MPEG2_MOCOMPTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xe6a9f44b, 0x61b0, 0x4563, 0x9e, 0xa4, 0x63, 0xd2, 0xa3, 0xc6, 0xfe, 0x66)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_MPEG2_IDCTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xbf22ad00, 0x03ea, 0x4690, 0x80, 0x77, 0x47, 0x33, 0x46, 0x20, 0x9b, 0x7e)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_MPEG1_VLDTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x6f3ec719, 0x3735, 0x42cc, 0x80, 0x63, 0x65, 0xcc, 0x3c, 0xb3, 0x66, 0x16)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_H264_MOCOMP_NOFGTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be64, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_H264_MOCOMP_FGTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be65, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_H264_IDCT_NOFGTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be66, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_H264_IDCT_FGTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be67, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_H264_VLD_FGTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be69, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_H264_VLD_WITHFMOASO_NOFGTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xd5f04ff9, 0x3418, 0x45d8, 0x95, 0x61, 0x32, 0xa7, 0x6a, 0xae, 0x2d, 0xdd)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_WMV8_POSTPROCTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be80, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_WMV8_MOCOMPTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be81, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_WMV9_POSTPROCTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be90, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_WMV9_MOCOMPTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be91, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_WMV9_IDCTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81be94, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_VC1_POSTPROCTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81beA0, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_VC1_MOCOMPTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81beA1, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_VC1_IDCTTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1b81beA2, 0xa0c7, 0x11d3, 0xb9, 0x84, 0x00, 0xc0, 0x4f, 0x2e, 0x73, 0xc5)
            )
        );
    }
    ...
    public static void D3D11_DECODER_PROFILE_MPEG4PT2_VLD_ADVSIMPLE_GMCTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xab998b5b, 0x4258, 0x44a9, 0x9f, 0xeb, 0x94, 0xe5, 0x97, 0xa6, 0xba, 0xae)
            )
        );
    }
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_HEVC_VLD_MONOCHROME,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_HEVC_VLD_MONOCHROME10,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_HEVC_VLD_MAIN12,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_HEVC_VLD_MAIN12_422,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_HEVC_VLD_MAIN10_EXT,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_HEVC_VLD_MAIN16,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_MJPEG_VLD_420,
            Is.EqualTo(
                new Guid(0x725cb506, 0x0c29, 0x43c4, 0x94, 0x40, 0x8e, 0x93, 0x97, 0x90, 0x3a, 0x04)
            )
        );
    }
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_MJPEG_VLD_422,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_MJPEG_VLD_444,
            Is.EqualTo(
                new Guid(0xd95161f9, 0x0d44, 0x47e6, 0xbc, 0xf5, 0x1b, 0xfb, 0xfb, 0x26, 0x8f, 0x97)
            )
        );
    }
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_MJPEG_VLD_4444,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_JPEG_VLD_420,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_JPEG_VLD_422,
            Is.EqualTo(
    ...
    {
        Assert.That(
            D3D11_DECODER_PROFILE_JPEG_VLD_444,
            Is.EqualTo(
    ...
    public static void D3D11_DECODER_ENCRYPTION_HW_CENCTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x89d6ac4f, 0x9f2, 0x4229, 0xb2, 0xcd, 0x37, 0x74, 0xa, 0x6d, 0xfd, 0x81)
            )
        );
    }
    ...
    public static void D3D11_DECODER_BITSTREAM_ENCRYPTION_TYPE_CENCTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xb0405235, 0xc13d, 0x44f2, 0x9a, 0xe5, 0xdd, 0x48, 0xe0, 0x8e, 0x5b, 0x67)
            )
        );
    }
    ...
    public static void D3D11_DECODER_BITSTREAM_ENCRYPTION_TYPE_CBCSTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x422d9319, 0x9d21, 0x4bb7, 0x93, 0x71, 0xfa, 0xf5, 0xa8, 0x2c, 0x3e, 0x04)
            )
        );
    }
    ...
    public static void D3D11_KEY_EXCHANGE_HW_PROTECTIONTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xb1170d8a, 0x628d, 0x4da3, 0xad, 0x3b, 0x82, 0xdd, 0xb0, 0x8b, 0x49, 0x70)
            )
        );
    }
