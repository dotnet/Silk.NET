...
public static unsafe partial class ID3D11UnorderedAccessViewTests
{
    ...
    {
        Assert.That(
            typeof(ID3D11UnorderedAccessView).GUID,
            Is.EqualTo(IID_ID3D11UnorderedAccessView)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D11UnorderedAccessView>(),
            Is.EqualTo(sizeof(ID3D11UnorderedAccessView))
        );
    }
