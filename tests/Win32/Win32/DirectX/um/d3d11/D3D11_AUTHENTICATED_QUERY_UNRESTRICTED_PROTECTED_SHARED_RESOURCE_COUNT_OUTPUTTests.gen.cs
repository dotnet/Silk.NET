...
public static unsafe partial class D3D11_AUTHENTICATED_QUERY_UNRESTRICTED_PROTECTED_SHARED_RESOURCE_COUNT_OUTPUTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D11_AUTHENTICATED_QUERY_UNRESTRICTED_PROTECTED_SHARED_RESOURCE_COUNT_OUTPUT>(),
            Is.EqualTo(
                sizeof(D3D11_AUTHENTICATED_QUERY_UNRESTRICTED_PROTECTED_SHARED_RESOURCE_COUNT_OUTPUT)
            )
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D11_AUTHENTICATED_QUERY_UNRESTRICTED_PROTECTED_SHARED_RESOURCE_COUNT_OUTPUT).IsLayoutSequential,
            Is.True
        );
    }
