...
public static unsafe partial class D3D11_FEATURE_DATA_D3D9_SIMPLE_INSTANCING_SUPPORTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D11_FEATURE_DATA_D3D9_SIMPLE_INSTANCING_SUPPORT>(),
            Is.EqualTo(sizeof(D3D11_FEATURE_DATA_D3D9_SIMPLE_INSTANCING_SUPPORT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D11_FEATURE_DATA_D3D9_SIMPLE_INSTANCING_SUPPORT).IsLayoutSequential,
            Is.True
        );
    }
