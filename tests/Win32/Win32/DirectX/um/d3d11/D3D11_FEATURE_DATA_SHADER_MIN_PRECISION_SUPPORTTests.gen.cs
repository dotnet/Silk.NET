...
public static unsafe partial class D3D11_FEATURE_DATA_SHADER_MIN_PRECISION_SUPPORTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D11_FEATURE_DATA_SHADER_MIN_PRECISION_SUPPORT>(),
            Is.EqualTo(sizeof(D3D11_FEATURE_DATA_SHADER_MIN_PRECISION_SUPPORT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D11_FEATURE_DATA_SHADER_MIN_PRECISION_SUPPORT).IsLayoutSequential,
            Is.True
        );
    }
