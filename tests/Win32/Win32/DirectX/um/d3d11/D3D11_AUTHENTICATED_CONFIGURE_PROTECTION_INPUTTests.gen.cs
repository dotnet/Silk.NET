...
public static unsafe partial class D3D11_AUTHENTICATED_CONFIGURE_PROTECTION_INPUTTests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D11_AUTHENTICATED_CONFIGURE_PROTECTION_INPUT>(),
            Is.EqualTo(sizeof(D3D11_AUTHENTICATED_CONFIGURE_PROTECTION_INPUT))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D11_AUTHENTICATED_CONFIGURE_PROTECTION_INPUT).IsLayoutSequential,
            Is.True
        );
    }
