...
public static unsafe partial class ID3D11RefDefaultTrackingOptionsTests
{
    ...
    {
        Assert.That(
            typeof(ID3D11RefDefaultTrackingOptions).GUID,
            Is.EqualTo(IID_ID3D11RefDefaultTrackingOptions)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D11RefDefaultTrackingOptions>(),
            Is.EqualTo(sizeof(ID3D11RefDefaultTrackingOptions))
        );
    }
