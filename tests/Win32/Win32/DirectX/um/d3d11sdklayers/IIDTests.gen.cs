...
public static partial class IIDTests
{
    ...
    public static void IID_ID3D11DebugTest()
    {
        Assert.That(
            IID_ID3D11Debug,
            Is.EqualTo(
                new Guid(0x79cf2233, 0x7536, 0x4948, 0x9d, 0x36, 0x1e, 0x46, 0x92, 0xdc, 0x57, 0x60)
            )
        );
    }
    ...
    public static void IID_ID3D11SwitchToRefTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1ef337e3, 0x58e7, 0x4f83, 0xa6, 0x92, 0xdb, 0x22, 0x1f, 0x5e, 0xd4, 0x7e)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_ID3D11TracingDevice,
            Is.EqualTo(
                new Guid(0x1911c771, 0x1587, 0x413e, 0xa7, 0xe0, 0xfb, 0x26, 0xc3, 0xde, 0x02, 0x68)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_ID3D11RefTrackingOptions,
            Is.EqualTo(
                new Guid(0x193dacdf, 0x0db2, 0x4c05, 0xa5, 0x5c, 0xef, 0x06, 0xca, 0xc5, 0x6f, 0xd9)
            )
        );
    }
    ...
    {
        Assert.That(
            IID_ID3D11RefDefaultTrackingOptions,
            Is.EqualTo(
                new Guid(0x03916615, 0xc644, 0x418c, 0x9b, 0xf4, 0x75, 0xdb, 0x5b, 0xe6, 0x3c, 0xa0)
            )
        );
    }
    ...
    public static void IID_ID3D11InfoQueueTest()
    {
        Assert.That(
            IID_ID3D11InfoQueue,
            Is.EqualTo(
                new Guid(0x6543dbb6, 0x1b48, 0x42f5, 0xab, 0x82, 0xe9, 0x7e, 0xc7, 0x43, 0x26, 0xf6)
            )
        );
    }
}
