...
public static unsafe partial class ID3DUserDefinedAnnotationTests
{
    ...
    {
        Assert.That(
            typeof(ID3DUserDefinedAnnotation).GUID,
            Is.EqualTo(IID_ID3DUserDefinedAnnotation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3DUserDefinedAnnotation>(),
            Is.EqualTo(sizeof(ID3DUserDefinedAnnotation))
        );
    }
