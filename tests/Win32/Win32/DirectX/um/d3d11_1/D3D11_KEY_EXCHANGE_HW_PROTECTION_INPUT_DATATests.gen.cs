...
public static unsafe partial class D3D11_KEY_EXCHANGE_HW_PROTECTION_INPUT_DATATests
{
    ...
    {
        Assert.That(
            Marshal.SizeOf<D3D11_KEY_EXCHANGE_HW_PROTECTION_INPUT_DATA>(),
            Is.EqualTo(sizeof(D3D11_KEY_EXCHANGE_HW_PROTECTION_INPUT_DATA))
        );
    }
    ...
    {
        Assert.That(
            typeof(D3D11_KEY_EXCHANGE_HW_PROTECTION_INPUT_DATA).IsLayoutSequential,
            Is.True
        );
    }
