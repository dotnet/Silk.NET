...
public static partial class IIDTests
{
    ...
    public static void IID_ID3D10BlendState1Test()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xEDAD8D99, 0x8A35, 0x4d6d, 0x85, 0x66, 0x2E, 0xA2, 0x76, 0xCD, 0xE1, 0x61)
            )
        );
    }
    ...
    public static void IID_ID3D10ShaderResourceView1Test()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x9B7E4C87, 0x342C, 0x4106, 0xA1, 0x9F, 0x4F, 0x27, 0x04, 0xF6, 0x89, 0xF0)
            )
        );
    }
    ...
    public static void IID_ID3D10Device1Test()
    {
        Assert.That(
            IID_ID3D10Device1,
            Is.EqualTo(
                new Guid(0x9B7E4C8F, 0x342C, 0x4106, 0xA1, 0x9F, 0x4F, 0x27, 0x04, 0xF6, 0x89, 0xF0)
            )
        );
    }
}
