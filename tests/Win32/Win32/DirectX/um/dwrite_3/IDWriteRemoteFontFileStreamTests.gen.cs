...
public static unsafe partial class IDWriteRemoteFontFileStreamTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteRemoteFontFileStream).GUID,
            Is.EqualTo(IID_IDWriteRemoteFontFileStream)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteRemoteFontFileStream>(),
            Is.EqualTo(sizeof(IDWriteRemoteFontFileStream))
        );
    }
