...
public static unsafe partial class IDWriteFontDownloadListenerTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteFontDownloadListener).GUID,
            Is.EqualTo(IID_IDWriteFontDownloadListener)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteFontDownloadListener>(),
            Is.EqualTo(sizeof(IDWriteFontDownloadListener))
        );
    }
