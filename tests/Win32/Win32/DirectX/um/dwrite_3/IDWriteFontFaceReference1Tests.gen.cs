...
public static unsafe partial class IDWriteFontFaceReference1Tests
{
    ...
    {
        Assert.That(
            typeof(IDWriteFontFaceReference1).GUID,
            Is.EqualTo(IID_IDWriteFontFaceReference1)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteFontFaceReference1>(),
            Is.EqualTo(sizeof(IDWriteFontFaceReference1))
        );
    }
