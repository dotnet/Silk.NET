...
public static unsafe partial class IDWriteRemoteFontFileLoaderTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteRemoteFontFileLoader).GUID,
            Is.EqualTo(IID_IDWriteRemoteFontFileLoader)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteRemoteFontFileLoader>(),
            Is.EqualTo(sizeof(IDWriteRemoteFontFileLoader))
        );
    }
