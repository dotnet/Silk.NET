...
public static unsafe partial class IDWriteInMemoryFontFileLoaderTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteInMemoryFontFileLoader).GUID,
            Is.EqualTo(IID_IDWriteInMemoryFontFileLoader)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteInMemoryFontFileLoader>(),
            Is.EqualTo(sizeof(IDWriteInMemoryFontFileLoader))
        );
    }
