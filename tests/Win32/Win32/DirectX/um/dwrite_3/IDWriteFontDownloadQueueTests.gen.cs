...
public static unsafe partial class IDWriteFontDownloadQueueTests
{
    ...
    {
        Assert.That(
            typeof(IDWriteFontDownloadQueue).GUID,
            Is.EqualTo(IID_IDWriteFontDownloadQueue)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDWriteFontDownloadQueue>(),
            Is.EqualTo(sizeof(IDWriteFontDownloadQueue))
        );
    }
