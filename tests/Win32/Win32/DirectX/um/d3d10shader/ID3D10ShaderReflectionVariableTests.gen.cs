...
public static unsafe partial class ID3D10ShaderReflectionVariableTests
{
    ...
    {
        Assert.That(
            typeof(ID3D10ShaderReflectionVariable).GUID,
            Is.EqualTo(IID_ID3D10ShaderReflectionVariable)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID3D10ShaderReflectionVariable>(),
            Is.EqualTo(sizeof(ID3D10ShaderReflectionVariable))
        );
    }
