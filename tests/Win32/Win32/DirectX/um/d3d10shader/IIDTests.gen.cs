...
public static partial class IIDTests
{
    ...
    public static void IID_ID3D10ShaderReflectionTypeTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xc530ad7d, 0x9b16, 0x4395, 0xa9, 0x79, 0xba, 0x2e, 0xcf, 0xf8, 0x3a, 0xdd)
            )
        );
    }
    ...
    public static void IID_ID3D10ShaderReflectionVariableTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x1bf63c95, 0x2650, 0x405d, 0x99, 0xc1, 0x36, 0x36, 0xbd, 0x1d, 0xa0, 0xa1)
            )
        );
    }
    ...
    public static void IID_ID3D10ShaderReflectionConstantBufferTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0x66c66a94, 0xdddd, 0x4b62, 0xa6, 0x6a, 0xf0, 0xda, 0x33, 0xc2, 0xb4, 0xd0)
            )
        );
    }
    ...
    public static void IID_ID3D10ShaderReflectionTest()
    {
        Assert.That(
            ...
            Is.EqualTo(
                new Guid(0xd40e20b6, 0xf8f7, 0x42ad, 0xab, 0x20, 0x4b, 0xaf, 0x8f, 0x15, 0xdf, 0xaa)
            )
        );
    }
}
