...
public static unsafe partial class ID2D1LinearGradientBrushTests
{
    ...
    {
        Assert.That(
            typeof(ID2D1LinearGradientBrush).GUID,
            Is.EqualTo(IID_ID2D1LinearGradientBrush)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ID2D1LinearGradientBrush>(),
            Is.EqualTo(sizeof(ID2D1LinearGradientBrush))
        );
    }
