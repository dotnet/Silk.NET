...
public static unsafe partial class IGraphicsEffectD2D1InteropTests
{
    ...
    {
        Assert.That(
            typeof(IGraphicsEffectD2D1Interop).GUID,
            Is.EqualTo(IID_IGraphicsEffectD2D1Interop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IGraphicsEffectD2D1Interop>(),
            Is.EqualTo(sizeof(IGraphicsEffectD2D1Interop))
        );
    }
