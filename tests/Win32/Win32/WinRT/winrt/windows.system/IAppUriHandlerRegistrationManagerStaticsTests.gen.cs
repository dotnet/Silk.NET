...
public static unsafe partial class IAppUriHandlerRegistrationManagerStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IAppUriHandlerRegistrationManagerStatics).GUID,
            Is.EqualTo(IID_IAppUriHandlerRegistrationManagerStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppUriHandlerRegistrationManagerStatics>(),
            Is.EqualTo(sizeof(IAppUriHandlerRegistrationManagerStatics))
        );
    }
