...
public static unsafe partial class IShutdownManagerStatics2Tests
{
    ...
    {
        Assert.That(
            typeof(IShutdownManagerStatics2).GUID,
            Is.EqualTo(IID_IShutdownManagerStatics2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IShutdownManagerStatics2>(),
            Is.EqualTo(sizeof(IShutdownManagerStatics2))
        );
    }
