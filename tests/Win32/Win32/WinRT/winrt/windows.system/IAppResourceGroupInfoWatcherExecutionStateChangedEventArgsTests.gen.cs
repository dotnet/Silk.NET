...
public static unsafe partial class IAppResourceGroupInfoWatcherExecutionStateChangedEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs).GUID,
            Is.EqualTo(IID_IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs>(),
            Is.EqualTo(sizeof(IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs))
        );
    }
    ...
    {
        Assert.That(
            typeof(IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs).IsLayoutSequential,
            Is.True
        );
    }
    ...
    public static void SizeOfTest()
    {
        ...
        {
            Assert.That(
                sizeof(IAppResourceGroupInfoWatcherExecutionStateChangedEventArgs),
                Is.EqualTo(8)
            );
        }
        else
