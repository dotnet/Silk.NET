...
public static unsafe partial class IAppDiagnosticInfoWatcherEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IAppDiagnosticInfoWatcherEventArgs).GUID,
            Is.EqualTo(IID_IAppDiagnosticInfoWatcherEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppDiagnosticInfoWatcherEventArgs>(),
            Is.EqualTo(sizeof(IAppDiagnosticInfoWatcherEventArgs))
        );
    }
