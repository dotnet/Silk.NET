...
public static unsafe partial class IAppUriHandlerRegistrationManagerTests
{
    ...
    {
        Assert.That(
            typeof(IAppUriHandlerRegistrationManager).GUID,
            Is.EqualTo(IID_IAppUriHandlerRegistrationManager)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppUriHandlerRegistrationManager>(),
            Is.EqualTo(sizeof(IAppUriHandlerRegistrationManager))
        );
    }
