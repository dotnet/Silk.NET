...
public static unsafe partial class IDateTimeSettingsStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IDateTimeSettingsStatics).GUID,
            Is.EqualTo(IID_IDateTimeSettingsStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDateTimeSettingsStatics>(),
            Is.EqualTo(sizeof(IDateTimeSettingsStatics))
        );
    }
