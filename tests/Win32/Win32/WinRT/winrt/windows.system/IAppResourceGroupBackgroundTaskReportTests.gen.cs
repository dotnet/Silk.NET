...
public static unsafe partial class IAppResourceGroupBackgroundTaskReportTests
{
    ...
    {
        Assert.That(
            typeof(IAppResourceGroupBackgroundTaskReport).GUID,
            Is.EqualTo(IID_IAppResourceGroupBackgroundTaskReport)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppResourceGroupBackgroundTaskReport>(),
            Is.EqualTo(sizeof(IAppResourceGroupBackgroundTaskReport))
        );
    }
