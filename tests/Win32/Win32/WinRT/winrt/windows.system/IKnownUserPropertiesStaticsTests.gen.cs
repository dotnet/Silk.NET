...
public static unsafe partial class IKnownUserPropertiesStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IKnownUserPropertiesStatics).GUID,
            Is.EqualTo(IID_IKnownUserPropertiesStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IKnownUserPropertiesStatics>(),
            Is.EqualTo(sizeof(IKnownUserPropertiesStatics))
        );
    }
