...
public static unsafe partial class IAppDiagnosticInfoStatics2Tests
{
    ...
    {
        Assert.That(
            typeof(IAppDiagnosticInfoStatics2).GUID,
            Is.EqualTo(IID_IAppDiagnosticInfoStatics2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppDiagnosticInfoStatics2>(),
            Is.EqualTo(sizeof(IAppDiagnosticInfoStatics2))
        );
    }
