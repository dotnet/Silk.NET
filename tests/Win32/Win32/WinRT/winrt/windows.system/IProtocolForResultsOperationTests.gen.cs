...
public static unsafe partial class IProtocolForResultsOperationTests
{
    ...
    {
        Assert.That(
            typeof(IProtocolForResultsOperation).GUID,
            Is.EqualTo(IID_IProtocolForResultsOperation)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IProtocolForResultsOperation>(),
            Is.EqualTo(sizeof(IProtocolForResultsOperation))
        );
    }
