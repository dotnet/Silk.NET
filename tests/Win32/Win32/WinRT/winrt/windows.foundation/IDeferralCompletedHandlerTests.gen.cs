...
public static unsafe partial class IDeferralCompletedHandlerTests
{
    ...
    {
        Assert.That(
            typeof(IDeferralCompletedHandler).GUID,
            Is.EqualTo(IID_IDeferralCompletedHandler)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDeferralCompletedHandler>(),
            Is.EqualTo(sizeof(IDeferralCompletedHandler))
        );
    }
