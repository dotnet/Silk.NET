...
public static unsafe partial class IWwwFormUrlDecoderRuntimeClassFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IWwwFormUrlDecoderRuntimeClassFactory).GUID,
            Is.EqualTo(IID_IWwwFormUrlDecoderRuntimeClassFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IWwwFormUrlDecoderRuntimeClassFactory>(),
            Is.EqualTo(sizeof(IWwwFormUrlDecoderRuntimeClassFactory))
        );
    }
