...
public static unsafe partial class ICompositionGraphicsDeviceInteropTests
{
    ...
    {
        Assert.That(
            typeof(ICompositionGraphicsDeviceInterop).GUID,
            Is.EqualTo(IID_ICompositionGraphicsDeviceInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICompositionGraphicsDeviceInterop>(),
            Is.EqualTo(sizeof(ICompositionGraphicsDeviceInterop))
        );
    }
