...
public static unsafe partial class ICompositionCapabilitiesInteropFactoryTests
{
    ...
    {
        Assert.That(
            typeof(ICompositionCapabilitiesInteropFactory).GUID,
            Is.EqualTo(IID_ICompositionCapabilitiesInteropFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICompositionCapabilitiesInteropFactory>(),
            Is.EqualTo(sizeof(ICompositionCapabilitiesInteropFactory))
        );
    }
