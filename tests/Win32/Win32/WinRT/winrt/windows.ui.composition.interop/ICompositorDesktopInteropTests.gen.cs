...
public static unsafe partial class ICompositorDesktopInteropTests
{
    ...
    {
        Assert.That(
            typeof(ICompositorDesktopInterop).GUID,
            Is.EqualTo(IID_ICompositorDesktopInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICompositorDesktopInterop>(),
            Is.EqualTo(sizeof(ICompositorDesktopInterop))
        );
    }
