...
public static unsafe partial class IVisualInteractionSourceInteropTests
{
    ...
    {
        Assert.That(
            typeof(IVisualInteractionSourceInterop).GUID,
            Is.EqualTo(IID_IVisualInteractionSourceInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IVisualInteractionSourceInterop>(),
            Is.EqualTo(sizeof(IVisualInteractionSourceInterop))
        );
    }
