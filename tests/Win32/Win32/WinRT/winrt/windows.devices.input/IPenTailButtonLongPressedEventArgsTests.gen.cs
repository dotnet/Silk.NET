...
public static unsafe partial class IPenTailButtonLongPressedEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IPenTailButtonLongPressedEventArgs).GUID,
            Is.EqualTo(IID_IPenTailButtonLongPressedEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPenTailButtonLongPressedEventArgs>(),
            Is.EqualTo(sizeof(IPenTailButtonLongPressedEventArgs))
        );
    }
