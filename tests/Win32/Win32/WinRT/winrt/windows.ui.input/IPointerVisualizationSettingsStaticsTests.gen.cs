...
public static unsafe partial class IPointerVisualizationSettingsStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IPointerVisualizationSettingsStatics).GUID,
            Is.EqualTo(IID_IPointerVisualizationSettingsStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPointerVisualizationSettingsStatics>(),
            Is.EqualTo(sizeof(IPointerVisualizationSettingsStatics))
        );
    }
