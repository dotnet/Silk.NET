...
public static unsafe partial class IRadialControllerStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerStatics).GUID,
            Is.EqualTo(IID_IRadialControllerStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerStatics>(),
            Is.EqualTo(sizeof(IRadialControllerStatics))
        );
    }
