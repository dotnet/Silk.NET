...
public static unsafe partial class IAttachableInputObjectFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IAttachableInputObjectFactory).GUID,
            Is.EqualTo(IID_IAttachableInputObjectFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAttachableInputObjectFactory>(),
            Is.EqualTo(sizeof(IAttachableInputObjectFactory))
        );
    }
