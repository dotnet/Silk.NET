...
public static unsafe partial class IManipulationInertiaStartingEventArgs2Tests
{
    ...
    {
        Assert.That(
            typeof(IManipulationInertiaStartingEventArgs2).GUID,
            Is.EqualTo(IID_IManipulationInertiaStartingEventArgs2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IManipulationInertiaStartingEventArgs2>(),
            Is.EqualTo(sizeof(IManipulationInertiaStartingEventArgs2))
        );
    }
