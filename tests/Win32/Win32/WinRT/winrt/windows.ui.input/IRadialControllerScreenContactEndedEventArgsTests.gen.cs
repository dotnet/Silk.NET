...
public static unsafe partial class IRadialControllerScreenContactEndedEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerScreenContactEndedEventArgs).GUID,
            Is.EqualTo(IID_IRadialControllerScreenContactEndedEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerScreenContactEndedEventArgs>(),
            Is.EqualTo(sizeof(IRadialControllerScreenContactEndedEventArgs))
        );
    }
    ...
    {
        Assert.That(
            typeof(IRadialControllerScreenContactEndedEventArgs).IsLayoutSequential,
            Is.True
        );
    }
