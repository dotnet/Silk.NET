...
public static unsafe partial class IKeyboardDeliveryInterceptorStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IKeyboardDeliveryInterceptorStatics).GUID,
            Is.EqualTo(IID_IKeyboardDeliveryInterceptorStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IKeyboardDeliveryInterceptorStatics>(),
            Is.EqualTo(sizeof(IKeyboardDeliveryInterceptorStatics))
        );
    }
