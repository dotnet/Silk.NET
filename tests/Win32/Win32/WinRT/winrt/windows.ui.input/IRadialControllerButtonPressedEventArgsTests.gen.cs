...
public static unsafe partial class IRadialControllerButtonPressedEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerButtonPressedEventArgs).GUID,
            Is.EqualTo(IID_IRadialControllerButtonPressedEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerButtonPressedEventArgs>(),
            Is.EqualTo(sizeof(IRadialControllerButtonPressedEventArgs))
        );
    }
