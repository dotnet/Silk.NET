...
public static unsafe partial class IPointerVisualizationSettingsTests
{
    ...
    {
        Assert.That(
            typeof(IPointerVisualizationSettings).GUID,
            Is.EqualTo(IID_IPointerVisualizationSettings)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPointerVisualizationSettings>(),
            Is.EqualTo(sizeof(IPointerVisualizationSettings))
        );
    }
