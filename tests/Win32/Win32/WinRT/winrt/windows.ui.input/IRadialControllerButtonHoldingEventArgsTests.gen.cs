...
public static unsafe partial class IRadialControllerButtonHoldingEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerButtonHoldingEventArgs).GUID,
            Is.EqualTo(IID_IRadialControllerButtonHoldingEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerButtonHoldingEventArgs>(),
            Is.EqualTo(sizeof(IRadialControllerButtonHoldingEventArgs))
        );
    }
