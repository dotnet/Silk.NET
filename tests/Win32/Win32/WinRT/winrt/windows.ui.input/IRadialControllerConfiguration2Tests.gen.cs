...
public static unsafe partial class IRadialControllerConfiguration2Tests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerConfiguration2).GUID,
            Is.EqualTo(IID_IRadialControllerConfiguration2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerConfiguration2>(),
            Is.EqualTo(sizeof(IRadialControllerConfiguration2))
        );
    }
