...
public static unsafe partial class IStorageFolderQueryOperationsTests
{
    ...
    {
        Assert.That(
            typeof(IStorageFolderQueryOperations).GUID,
            Is.EqualTo(IID_IStorageFolderQueryOperations)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IStorageFolderQueryOperations>(),
            Is.EqualTo(sizeof(IStorageFolderQueryOperations))
        );
    }
