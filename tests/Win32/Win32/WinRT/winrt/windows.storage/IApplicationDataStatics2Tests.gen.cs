...
public static unsafe partial class IApplicationDataStatics2Tests
{
    ...
    {
        Assert.That(
            typeof(IApplicationDataStatics2).GUID,
            Is.EqualTo(IID_IApplicationDataStatics2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IApplicationDataStatics2>(),
            Is.EqualTo(sizeof(IApplicationDataStatics2))
        );
    }
