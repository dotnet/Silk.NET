...
public static unsafe partial class ICoreImmersiveApplication3Tests
{
    ...
    {
        Assert.That(
            typeof(ICoreImmersiveApplication3).GUID,
            Is.EqualTo(IID_ICoreImmersiveApplication3)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICoreImmersiveApplication3>(),
            Is.EqualTo(sizeof(ICoreImmersiveApplication3))
        );
    }
