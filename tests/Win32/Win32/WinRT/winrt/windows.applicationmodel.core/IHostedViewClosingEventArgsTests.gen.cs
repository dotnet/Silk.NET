...
public static unsafe partial class IHostedViewClosingEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IHostedViewClosingEventArgs).GUID,
            Is.EqualTo(IID_IHostedViewClosingEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHostedViewClosingEventArgs>(),
            Is.EqualTo(sizeof(IHostedViewClosingEventArgs))
        );
    }
