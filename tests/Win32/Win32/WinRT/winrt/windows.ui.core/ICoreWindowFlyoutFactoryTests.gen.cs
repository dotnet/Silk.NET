...
public static unsafe partial class ICoreWindowFlyoutFactoryTests
{
    ...
    {
        Assert.That(
            typeof(ICoreWindowFlyoutFactory).GUID,
            Is.EqualTo(IID_ICoreWindowFlyoutFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICoreWindowFlyoutFactory>(),
            Is.EqualTo(sizeof(ICoreWindowFlyoutFactory))
        );
    }
