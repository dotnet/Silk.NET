...
public static unsafe partial class ISystemNavigationManager2Tests
{
    ...
    {
        Assert.That(
            typeof(ISystemNavigationManager2).GUID,
            Is.EqualTo(IID_ISystemNavigationManager2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISystemNavigationManager2>(),
            Is.EqualTo(sizeof(ISystemNavigationManager2))
        );
    }
