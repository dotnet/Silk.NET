...
public static unsafe partial class IWindowActivatedEventArgsTests
{
    ...
    {
        Assert.That(
            typeof(IWindowActivatedEventArgs).GUID,
            Is.EqualTo(IID_IWindowActivatedEventArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IWindowActivatedEventArgs>(),
            Is.EqualTo(sizeof(IWindowActivatedEventArgs))
        );
    }
