...
public static unsafe partial class ICoreWindowDialogFactoryTests
{
    ...
    {
        Assert.That(
            typeof(ICoreWindowDialogFactory).GUID,
            Is.EqualTo(IID_ICoreWindowDialogFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICoreWindowDialogFactory>(),
            Is.EqualTo(sizeof(ICoreWindowDialogFactory))
        );
    }
