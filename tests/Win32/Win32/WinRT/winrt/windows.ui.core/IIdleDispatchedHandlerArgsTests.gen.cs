...
public static unsafe partial class IIdleDispatchedHandlerArgsTests
{
    ...
    {
        Assert.That(
            typeof(IIdleDispatchedHandlerArgs).GUID,
            Is.EqualTo(IID_IIdleDispatchedHandlerArgs)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IIdleDispatchedHandlerArgs>(),
            Is.EqualTo(sizeof(IIdleDispatchedHandlerArgs))
        );
    }
