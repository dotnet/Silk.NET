...
public static unsafe partial class IPrintPreviewPageCollectionTests
{
    ...
    {
        Assert.That(
            typeof(IPrintPreviewPageCollection).GUID,
            Is.EqualTo(IID_IPrintPreviewPageCollection)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPrintPreviewPageCollection>(),
            Is.EqualTo(sizeof(IPrintPreviewPageCollection))
        );
    }
