...
public static unsafe partial class IPrintDocumentPageSourceTests
{
    ...
    {
        Assert.That(
            typeof(IPrintDocumentPageSource).GUID,
            Is.EqualTo(IID_IPrintDocumentPageSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPrintDocumentPageSource>(),
            Is.EqualTo(sizeof(IPrintDocumentPageSource))
        );
    }
