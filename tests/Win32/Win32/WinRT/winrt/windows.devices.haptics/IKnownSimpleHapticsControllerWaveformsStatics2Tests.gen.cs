...
public static unsafe partial class IKnownSimpleHapticsControllerWaveformsStatics2Tests
{
    ...
    {
        Assert.That(
            typeof(IKnownSimpleHapticsControllerWaveformsStatics2).GUID,
            Is.EqualTo(IID_IKnownSimpleHapticsControllerWaveformsStatics2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IKnownSimpleHapticsControllerWaveformsStatics2>(),
            Is.EqualTo(sizeof(IKnownSimpleHapticsControllerWaveformsStatics2))
        );
    }
    ...
    {
        Assert.That(
            typeof(IKnownSimpleHapticsControllerWaveformsStatics2).IsLayoutSequential,
            Is.True
        );
    }
