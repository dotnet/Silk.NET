...
public static unsafe partial class ISimpleHapticsControllerTests
{
    ...
    {
        Assert.That(
            typeof(ISimpleHapticsController).GUID,
            Is.EqualTo(IID_ISimpleHapticsController)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISimpleHapticsController>(),
            Is.EqualTo(sizeof(ISimpleHapticsController))
        );
    }
