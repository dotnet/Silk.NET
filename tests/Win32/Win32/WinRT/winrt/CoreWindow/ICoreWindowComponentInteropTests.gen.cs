...
public static unsafe partial class ICoreWindowComponentInteropTests
{
    ...
    {
        Assert.That(
            typeof(ICoreWindowComponentInterop).GUID,
            Is.EqualTo(IID_ICoreWindowComponentInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICoreWindowComponentInterop>(),
            Is.EqualTo(sizeof(ICoreWindowComponentInterop))
        );
    }
