...
public static unsafe partial class IRandomAccessStreamReferenceStaticsTests
{
    ...
    {
        Assert.That(
            typeof(IRandomAccessStreamReferenceStatics).GUID,
            Is.EqualTo(IID_IRandomAccessStreamReferenceStatics)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRandomAccessStreamReferenceStatics>(),
            Is.EqualTo(sizeof(IRandomAccessStreamReferenceStatics))
        );
    }
