...
public static unsafe partial class IMLOperatorShapeInferenceContextTests
{
    ...
    {
        Assert.That(
            typeof(IMLOperatorShapeInferenceContext).GUID,
            Is.EqualTo(IID_IMLOperatorShapeInferenceContext)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMLOperatorShapeInferenceContext>(),
            Is.EqualTo(sizeof(IMLOperatorShapeInferenceContext))
        );
    }
