...
public static unsafe partial class IMLOperatorKernelContextTests
{
    ...
    {
        Assert.That(
            typeof(IMLOperatorKernelContext).GUID,
            Is.EqualTo(IID_IMLOperatorKernelContext)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMLOperatorKernelContext>(),
            Is.EqualTo(sizeof(IMLOperatorKernelContext))
        );
    }
