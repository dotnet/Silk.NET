...
public static unsafe partial class IMLOperatorTypeInferenceContextTests
{
    ...
    {
        Assert.That(
            typeof(IMLOperatorTypeInferenceContext).GUID,
            Is.EqualTo(IID_IMLOperatorTypeInferenceContext)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMLOperatorTypeInferenceContext>(),
            Is.EqualTo(sizeof(IMLOperatorTypeInferenceContext))
        );
    }
