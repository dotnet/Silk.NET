...
public static unsafe partial class IMLOperatorKernelCreationContextTests
{
    ...
    {
        Assert.That(
            typeof(IMLOperatorKernelCreationContext).GUID,
            Is.EqualTo(IID_IMLOperatorKernelCreationContext)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IMLOperatorKernelCreationContext>(),
            Is.EqualTo(sizeof(IMLOperatorKernelCreationContext))
        );
    }
