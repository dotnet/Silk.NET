...
public static unsafe partial class IUserActivityRequestManagerInteropTests
{
    ...
    {
        Assert.That(
            typeof(IUserActivityRequestManagerInterop).GUID,
            Is.EqualTo(IID_IUserActivityRequestManagerInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUserActivityRequestManagerInterop>(),
            Is.EqualTo(sizeof(IUserActivityRequestManagerInterop))
        );
    }
