...
public static unsafe partial class IRandomAccessStreamFileAccessModeTests
{
    ...
    {
        Assert.That(
            typeof(IRandomAccessStreamFileAccessMode).GUID,
            Is.EqualTo(IID_IRandomAccessStreamFileAccessMode)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRandomAccessStreamFileAccessMode>(),
            Is.EqualTo(sizeof(IRandomAccessStreamFileAccessMode))
        );
    }
