...
public static unsafe partial class IUnbufferedFileHandleOplockCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IUnbufferedFileHandleOplockCallback).GUID,
            Is.EqualTo(IID_IUnbufferedFileHandleOplockCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUnbufferedFileHandleOplockCallback>(),
            Is.EqualTo(sizeof(IUnbufferedFileHandleOplockCallback))
        );
    }
