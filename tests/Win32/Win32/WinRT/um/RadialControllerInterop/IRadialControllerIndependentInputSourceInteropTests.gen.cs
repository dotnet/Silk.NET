...
public static unsafe partial class IRadialControllerIndependentInputSourceInteropTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerIndependentInputSourceInterop).GUID,
            Is.EqualTo(IID_IRadialControllerIndependentInputSourceInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerIndependentInputSourceInterop>(),
            Is.EqualTo(sizeof(IRadialControllerIndependentInputSourceInterop))
        );
    }
    ...
    {
        Assert.That(
            typeof(IRadialControllerIndependentInputSourceInterop).IsLayoutSequential,
            Is.True
        );
    }
