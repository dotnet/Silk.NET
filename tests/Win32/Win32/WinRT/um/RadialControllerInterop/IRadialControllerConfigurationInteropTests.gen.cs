...
public static unsafe partial class IRadialControllerConfigurationInteropTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerConfigurationInterop).GUID,
            Is.EqualTo(IID_IRadialControllerConfigurationInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerConfigurationInterop>(),
            Is.EqualTo(sizeof(IRadialControllerConfigurationInterop))
        );
    }
