...
public static unsafe partial class IRadialControllerInteropTests
{
    ...
    {
        Assert.That(
            typeof(IRadialControllerInterop).GUID,
            Is.EqualTo(IID_IRadialControllerInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRadialControllerInterop>(),
            Is.EqualTo(sizeof(IRadialControllerInterop))
        );
    }
