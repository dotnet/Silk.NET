...
public static unsafe partial class IVideoFrameNativeFactoryTests
{
    ...
    {
        Assert.That(
            typeof(IVideoFrameNativeFactory).GUID,
            Is.EqualTo(IID_IVideoFrameNativeFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IVideoFrameNativeFactory>(),
            Is.EqualTo(sizeof(IVideoFrameNativeFactory))
        );
    }
