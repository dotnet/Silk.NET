...
public static unsafe partial class IContentPrefetcherTaskTriggerTests
{
    ...
    {
        Assert.That(
            typeof(IContentPrefetcherTaskTrigger).GUID,
            Is.EqualTo(IID_IContentPrefetcherTaskTrigger)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IContentPrefetcherTaskTrigger>(),
            Is.EqualTo(sizeof(IContentPrefetcherTaskTrigger))
        );
    }
