...
public static unsafe partial class ICorrelationVectorSourceTests
{
    ...
    {
        Assert.That(
            typeof(ICorrelationVectorSource).GUID,
            Is.EqualTo(IID_ICorrelationVectorSource)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ICorrelationVectorSource>(),
            Is.EqualTo(sizeof(ICorrelationVectorSource))
        );
    }
