...
public static unsafe partial class IAppServiceConnectionExtendedExecutionTests
{
    ...
    {
        Assert.That(
            typeof(IAppServiceConnectionExtendedExecution).GUID,
            Is.EqualTo(IID_IAppServiceConnectionExtendedExecution)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAppServiceConnectionExtendedExecution>(),
            Is.EqualTo(sizeof(IAppServiceConnectionExtendedExecution))
        );
    }
