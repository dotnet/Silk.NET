...
public static unsafe partial class IProtectionPolicyManagerInteropTests
{
    ...
    {
        Assert.That(
            typeof(IProtectionPolicyManagerInterop).GUID,
            Is.EqualTo(IID_IProtectionPolicyManagerInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IProtectionPolicyManagerInterop>(),
            Is.EqualTo(sizeof(IProtectionPolicyManagerInterop))
        );
    }
