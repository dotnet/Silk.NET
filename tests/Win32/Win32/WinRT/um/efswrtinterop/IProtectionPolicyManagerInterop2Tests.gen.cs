...
public static unsafe partial class IProtectionPolicyManagerInterop2Tests
{
    ...
    {
        Assert.That(
            typeof(IProtectionPolicyManagerInterop2).GUID,
            Is.EqualTo(IID_IProtectionPolicyManagerInterop2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IProtectionPolicyManagerInterop2>(),
            Is.EqualTo(sizeof(IProtectionPolicyManagerInterop2))
        );
    }
