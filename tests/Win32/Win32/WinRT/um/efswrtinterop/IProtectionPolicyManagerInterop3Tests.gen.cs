...
public static unsafe partial class IProtectionPolicyManagerInterop3Tests
{
    ...
    {
        Assert.That(
            typeof(IProtectionPolicyManagerInterop3).GUID,
            Is.EqualTo(IID_IProtectionPolicyManagerInterop3)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IProtectionPolicyManagerInterop3>(),
            Is.EqualTo(sizeof(IProtectionPolicyManagerInterop3))
        );
    }
