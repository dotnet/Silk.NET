...
public static unsafe partial class IRemoteSystemAdditionalInfoProviderTests
{
    ...
    {
        Assert.That(
            typeof(IRemoteSystemAdditionalInfoProvider).GUID,
            Is.EqualTo(IID_IRemoteSystemAdditionalInfoProvider)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IRemoteSystemAdditionalInfoProvider>(),
            Is.EqualTo(sizeof(IRemoteSystemAdditionalInfoProvider))
        );
    }
