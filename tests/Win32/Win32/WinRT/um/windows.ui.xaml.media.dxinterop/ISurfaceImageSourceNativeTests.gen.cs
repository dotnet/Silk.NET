...
public static unsafe partial class ISurfaceImageSourceNativeTests
{
    ...
    {
        Assert.That(
            typeof(ISurfaceImageSourceNative).GUID,
            Is.EqualTo(IID_ISurfaceImageSourceNative)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISurfaceImageSourceNative>(),
            Is.EqualTo(sizeof(ISurfaceImageSourceNative))
        );
    }
