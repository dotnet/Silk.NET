...
public static unsafe partial class IVirtualSurfaceImageSourceNativeTests
{
    ...
    {
        Assert.That(
            typeof(IVirtualSurfaceImageSourceNative).GUID,
            Is.EqualTo(IID_IVirtualSurfaceImageSourceNative)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IVirtualSurfaceImageSourceNative>(),
            Is.EqualTo(sizeof(IVirtualSurfaceImageSourceNative))
        );
    }
