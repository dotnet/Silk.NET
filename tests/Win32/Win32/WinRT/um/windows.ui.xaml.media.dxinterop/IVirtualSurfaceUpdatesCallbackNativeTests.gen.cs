...
public static unsafe partial class IVirtualSurfaceUpdatesCallbackNativeTests
{
    ...
    {
        Assert.That(
            typeof(IVirtualSurfaceUpdatesCallbackNative).GUID,
            Is.EqualTo(IID_IVirtualSurfaceUpdatesCallbackNative)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IVirtualSurfaceUpdatesCallbackNative>(),
            Is.EqualTo(sizeof(IVirtualSurfaceUpdatesCallbackNative))
        );
    }
