...
public static unsafe partial class ISpatialInteractionManagerInteropTests
{
    ...
    {
        Assert.That(
            typeof(ISpatialInteractionManagerInterop).GUID,
            Is.EqualTo(IID_ISpatialInteractionManagerInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISpatialInteractionManagerInterop>(),
            Is.EqualTo(sizeof(ISpatialInteractionManagerInterop))
        );
    }
