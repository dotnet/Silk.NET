...
public static unsafe partial class ILearningModelDeviceFactoryNativeTests
{
    ...
    {
        Assert.That(
            typeof(ILearningModelDeviceFactoryNative).GUID,
            Is.EqualTo(IID_ILearningModelDeviceFactoryNative)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ILearningModelDeviceFactoryNative>(),
            Is.EqualTo(sizeof(ILearningModelDeviceFactoryNative))
        );
    }
