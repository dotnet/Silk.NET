...
public static unsafe partial class IVisualTreeServiceCallbackTests
{
    ...
    {
        Assert.That(
            typeof(IVisualTreeServiceCallback).GUID,
            Is.EqualTo(IID_IVisualTreeServiceCallback)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IVisualTreeServiceCallback>(),
            Is.EqualTo(sizeof(IVisualTreeServiceCallback))
        );
    }
