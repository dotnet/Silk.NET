...
public static unsafe partial class IAccountsSettingsPaneInteropTests
{
    ...
    {
        Assert.That(
            typeof(IAccountsSettingsPaneInterop).GUID,
            Is.EqualTo(IID_IAccountsSettingsPaneInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IAccountsSettingsPaneInterop>(),
            Is.EqualTo(sizeof(IAccountsSettingsPaneInterop))
        );
    }
