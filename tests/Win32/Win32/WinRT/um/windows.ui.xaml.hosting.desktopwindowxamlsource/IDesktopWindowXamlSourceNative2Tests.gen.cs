...
public static unsafe partial class IDesktopWindowXamlSourceNative2Tests
{
    ...
    {
        Assert.That(
            typeof(IDesktopWindowXamlSourceNative2).GUID,
            Is.EqualTo(IID_IDesktopWindowXamlSourceNative2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IDesktopWindowXamlSourceNative2>(),
            Is.EqualTo(sizeof(IDesktopWindowXamlSourceNative2))
        );
    }
