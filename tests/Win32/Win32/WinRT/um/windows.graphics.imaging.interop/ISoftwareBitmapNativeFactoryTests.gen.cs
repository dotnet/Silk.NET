...
public static unsafe partial class ISoftwareBitmapNativeFactoryTests
{
    ...
    {
        Assert.That(
            typeof(ISoftwareBitmapNativeFactory).GUID,
            Is.EqualTo(IID_ISoftwareBitmapNativeFactory)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISoftwareBitmapNativeFactory>(),
            Is.EqualTo(sizeof(ISoftwareBitmapNativeFactory))
        );
    }
