...
public static unsafe partial class IHolographicQuadLayerUpdateParametersInteropTests
{
    ...
    {
        Assert.That(
            typeof(IHolographicQuadLayerUpdateParametersInterop).GUID,
            Is.EqualTo(IID_IHolographicQuadLayerUpdateParametersInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHolographicQuadLayerUpdateParametersInterop>(),
            Is.EqualTo(sizeof(IHolographicQuadLayerUpdateParametersInterop))
        );
    }
    ...
    {
        Assert.That(
            typeof(IHolographicQuadLayerUpdateParametersInterop).IsLayoutSequential,
            Is.True
        );
    }
