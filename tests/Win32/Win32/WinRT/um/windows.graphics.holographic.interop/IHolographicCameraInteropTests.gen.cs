...
public static unsafe partial class IHolographicCameraInteropTests
{
    ...
    {
        Assert.That(
            typeof(IHolographicCameraInterop).GUID,
            Is.EqualTo(IID_IHolographicCameraInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IHolographicCameraInterop>(),
            Is.EqualTo(sizeof(IHolographicCameraInterop))
        );
    }
