...
public static unsafe partial class ILanguageExceptionErrorInfo2Tests
{
    ...
    {
        Assert.That(
            typeof(ILanguageExceptionErrorInfo2).GUID,
            Is.EqualTo(IID_ILanguageExceptionErrorInfo2)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ILanguageExceptionErrorInfo2>(),
            Is.EqualTo(sizeof(ILanguageExceptionErrorInfo2))
        );
    }
