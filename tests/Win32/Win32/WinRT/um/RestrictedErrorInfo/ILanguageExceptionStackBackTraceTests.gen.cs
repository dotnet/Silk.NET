...
public static unsafe partial class ILanguageExceptionStackBackTraceTests
{
    ...
    {
        Assert.That(
            typeof(ILanguageExceptionStackBackTrace).GUID,
            Is.EqualTo(IID_ILanguageExceptionStackBackTrace)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ILanguageExceptionStackBackTrace>(),
            Is.EqualTo(sizeof(ILanguageExceptionStackBackTrace))
        );
    }
