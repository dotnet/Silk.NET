...
public static unsafe partial class ILanguageExceptionErrorInfoTests
{
    ...
    {
        Assert.That(
            typeof(ILanguageExceptionErrorInfo).GUID,
            Is.EqualTo(IID_ILanguageExceptionErrorInfo)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ILanguageExceptionErrorInfo>(),
            Is.EqualTo(sizeof(ILanguageExceptionErrorInfo))
        );
    }
