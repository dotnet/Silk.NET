...
public static unsafe partial class IUserConsentVerifierInteropTests
{
    ...
    {
        Assert.That(
            typeof(IUserConsentVerifierInterop).GUID,
            Is.EqualTo(IID_IUserConsentVerifierInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IUserConsentVerifierInterop>(),
            Is.EqualTo(sizeof(IUserConsentVerifierInterop))
        );
    }
