...
public static unsafe partial class IPrinting3DManagerInteropTests
{
    ...
    {
        Assert.That(
            typeof(IPrinting3DManagerInterop).GUID,
            Is.EqualTo(IID_IPrinting3DManagerInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<IPrinting3DManagerInterop>(),
            Is.EqualTo(sizeof(IPrinting3DManagerInterop))
        );
    }
