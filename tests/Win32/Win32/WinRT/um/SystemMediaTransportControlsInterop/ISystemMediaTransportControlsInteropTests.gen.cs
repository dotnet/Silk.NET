...
public static unsafe partial class ISystemMediaTransportControlsInteropTests
{
    ...
    {
        Assert.That(
            typeof(ISystemMediaTransportControlsInterop).GUID,
            Is.EqualTo(IID_ISystemMediaTransportControlsInterop)
        );
    }
    ...
    {
        Assert.That(
            Marshal.SizeOf<ISystemMediaTransportControlsInterop>(),
            Is.EqualTo(sizeof(ISystemMediaTransportControlsInterop))
        );
    }
