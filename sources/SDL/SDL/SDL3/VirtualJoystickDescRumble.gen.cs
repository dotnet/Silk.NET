...
public readonly unsafe struct VirtualJoystickDescRumble : IDisposable
{
    ...
    public VirtualJoystickDescRumble(delegate* unmanaged<void*, ushort, ushort, byte> ptr) =>
        Pointer = ptr;

    public VirtualJoystickDescRumble(VirtualJoystickDescRumbleDelegate proc) =>
        Pointer = SilkMarshal.DelegateToPtr(proc);

    public void Dispose() => SilkMarshal.Free(Pointer);

    public static implicit operator VirtualJoystickDescRumble(
        delegate* unmanaged<void*, ushort, ushort, byte> pfn
    ) => new(pfn);

    public static implicit operator delegate* unmanaged<void*, ushort, ushort, byte>(
        VirtualJoystickDescRumble pfn
