...
public readonly unsafe struct FreeFunc : IDisposable
{
    ...
    public FreeFunc(delegate* unmanaged<void*, void> ptr) => Pointer = ptr;

    public FreeFunc(FreeFuncDelegate proc) => Pointer = SilkMarshal.DelegateToPtr(proc);

    public void Dispose() => SilkMarshal.Free(Pointer);

    public static implicit operator FreeFunc(delegate* unmanaged<void*, void> pfn) => new(pfn);

    public static implicit operator delegate* unmanaged<void*, void>(FreeFunc pfn) =>
