...
public readonly unsafe partial struct ThreadHandle
{
    ...
    public static bool operator ==(ThreadHandle left, ThreadHandle right) => left.Equals(right);

    public static bool operator !=(ThreadHandle left, ThreadHandle right) => !left.Equals(right);

    public bool Equals(NullPtr _) => Handle is null;

    public static bool operator ==(ThreadHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(ThreadHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator ThreadHandle(NullPtr _) => default;
}
