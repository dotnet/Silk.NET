...
public readonly unsafe partial struct RwLockHandle
{
    ...
    public static bool operator ==(RwLockHandle left, RwLockHandle right) => left.Equals(right);

    public static bool operator !=(RwLockHandle left, RwLockHandle right) => !left.Equals(right);

    public bool Equals(NullPtr _) => Handle is null;

    public static bool operator ==(RwLockHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(RwLockHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator RwLockHandle(NullPtr _) => default;
}
