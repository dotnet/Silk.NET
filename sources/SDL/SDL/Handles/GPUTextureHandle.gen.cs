...
public readonly unsafe partial struct GPUTextureHandle
{
    ...
    public static bool operator ==(GPUTextureHandle left, GPUTextureHandle right) =>
        left.Equals(right);
    ...
    public static bool operator ==(GPUTextureHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(GPUTextureHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator GPUTextureHandle(NullPtr _) => default;
}
