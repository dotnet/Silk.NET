...
public readonly unsafe partial struct TextureHandle
{
    ...
    public bool Equals(TextureHandle other) => Handle == other.Handle;
    ...
    public static bool operator ==(TextureHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(TextureHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator TextureHandle(NullPtr _) => default;
}
