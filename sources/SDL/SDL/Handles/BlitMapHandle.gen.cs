...
public readonly unsafe partial struct BlitMapHandle
{
    public readonly void* Handle;

    public bool Equals(BlitMapHandle other) => Handle == other.Handle;

    public override bool Equals(object? obj) => obj is BlitMapHandle other && Equals(other);

    public override int GetHashCode() => HashCode.Combine((nuint)Handle);

    public static bool operator ==(BlitMapHandle left, BlitMapHandle right) => left.Equals(right);

    public static bool operator !=(BlitMapHandle left, BlitMapHandle right) => !left.Equals(right);

    public bool Equals(NullPtr _) => Handle is null;

    public static bool operator ==(BlitMapHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(BlitMapHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator BlitMapHandle(NullPtr _) => default;
}
