namespace Silk.NET.Maths
{
    ...
    partial struct Matrix4x2F<T> : IEquatable<Matrix4x2F<T>> where T : IFloatingPointIeee754<T>
    {
        ...
        public Matrix4x2F(Vector2F<T> row1, Vector2F<T> row2, Vector2F<T> row3, Vector2F<T> row4) => (Row1, Row2, Row3, Row4) = (row1, row2, row3, row4);
        [UnscopedRef]
        ...
        public static Matrix4x2F<T> operator +(Matrix4x2F<T> left, Matrix4x2F<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2, left.Row3 + right.Row3, left.Row4 + right.Row4);
        ...
        public static Matrix4x2F<T> operator *(Matrix4x2F<T> left, Matrix2x2F<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2, left.M31 * right.Row1 + left.M32 * right.Row2, left.M41 * right.Row1 + left.M42 * right.Row2);
        /// <summary>Multiplies a matrix by another matrix.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x3F<T> operator *(Matrix4x2F<T> left, Matrix2x3F<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2, left.M31 * right.Row1 + left.M32 * right.Row2, left.M41 * right.Row1 + left.M42 * right.Row2);
        /// <summary>Multiplies a matrix by another matrix.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x4F<T> operator *(Matrix4x2F<T> left, Matrix2x4F<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2, left.M31 * right.Row1 + left.M32 * right.Row2, left.M41 * right.Row1 + left.M42 * right.Row2);
    }
}