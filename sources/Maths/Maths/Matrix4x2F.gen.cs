namespace Silk.NET.Maths
{
    ...
    partial struct Matrix4x2F<T> :
        IEquatable<Matrix4x2F<T>>
        where T : IFloatingPointIeee754<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix4x2F{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix4x2F<T> left, Matrix4x2F<T> right) =>
        ...
        public static Matrix4x2F<T> operator +(Matrix4x2F<T> left, Matrix4x2F<T> right) =>
        ...
        public static Matrix4x2F<T> operator -(Matrix4x2F<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3,
                -value.Row4);
        ...
        public static Matrix4x2F<T> operator *(Matrix4x2F<T> left, Matrix2x2F<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x3F<T> operator *(Matrix4x2F<T> left, Matrix2x3F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2,
                left.M21 * right.Row1 + left.M22 * right.Row2,
                left.M31 * right.Row1 + left.M32 * right.Row2,
                left.M41 * right.Row1 + left.M42 * right.Row2);
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x4F<T> operator *(Matrix4x2F<T> left, Matrix2x4F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2,
                left.M21 * right.Row1 + left.M22 * right.Row2,
                left.M31 * right.Row1 + left.M32 * right.Row2,
                left.M41 * right.Row1 + left.M42 * right.Row2);
    ...
    static partial class Matrix4x2F
    {
        public static Matrix4x2F<T> Lerp<T>(Matrix4x2F<T> value1, Matrix4x2F<T> value2, T amount)
            where T : IFloatingPointIeee754<T> =>
            new(new(T.Lerp(value1.M11, value2.M11, amount), T.Lerp(value1.M12, value2.M12, amount)),
                ...
                new(T.Lerp(value1.M41, value2.M41, amount), T.Lerp(value1.M42, value2.M42, amount)));
    }
}
