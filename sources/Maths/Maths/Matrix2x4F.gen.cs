namespace Silk.NET.Maths
{
    ...
    partial struct Matrix2x4F<T> : IEquatable<Matrix2x4F<T>> where T : IFloatingPointIeee754<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix2x4F{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix2x4F<T> left, Matrix2x4F<T> right) =>
        ...
        public static Matrix2x4F<T> operator +(Matrix2x4F<T> left, Matrix2x4F<T> right) =>
        ...
        public static Matrix2x4F<T> operator -(Matrix2x4F<T> value) =>
            new(-value.Row1,
                -value.Row2);
        ...
        public static Matrix2x4F<T> operator *(Matrix2x2F<T> left, Matrix2x4F<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix2x2F<T> operator *(Matrix2x4F<T> left, Matrix4x2F<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix3x4F<T> operator *(Matrix3x2F<T> left, Matrix2x4F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2,
                left.M21 * right.Row1 + left.M22 * right.Row2,
