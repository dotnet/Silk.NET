namespace Silk.NET.Maths
{
    ...
    partial struct Matrix4x4F<T> :
        IEquatable<Matrix4x4F<T>>
        where T : IFloatingPointIeee754<T>
    {
        /// <summary>The multiplicative identity matrix of size 4x4.</summary>
        public static readonly Matrix4x4F<T> Identity = new(
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix4x4F{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix4x4F<T> left, Matrix4x4F<T> right) =>
        ...
        public static Matrix4x4F<T> operator +(Matrix4x4F<T> left, Matrix4x4F<T> right) =>
        ...
        public static Matrix4x4F<T> operator -(Matrix4x4F<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3,
                -value.Row4);
        ...
        public static Matrix2x4F<T> operator *(Matrix2x4F<T> left, Matrix4x4F<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix3x4F<T> operator *(Matrix3x4F<T> left, Matrix4x4F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3 + left.M14 * right.Row4,
                left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3 + left.M24 * right.Row4,
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x2F<T> operator *(Matrix4x4F<T> left, Matrix4x2F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3 + left.M14 * right.Row4,
                left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3 + left.M24 * right.Row4,
                left.M31 * right.Row1 + left.M32 * right.Row2 + left.M33 * right.Row3 + left.M34 * right.Row4,
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x3F<T> operator *(Matrix4x4F<T> left, Matrix4x3F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3 + left.M14 * right.Row4,
                left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3 + left.M24 * right.Row4,
                left.M31 * right.Row1 + left.M32 * right.Row2 + left.M33 * right.Row3 + left.M34 * right.Row4,
                left.M41 * right.Row1 + left.M42 * right.Row2 + left.M43 * right.Row3 + left.M44 * right.Row4);
    ...
    static partial class Matrix4x4F
    {
        public static Matrix4x4F<T> Lerp<T>(Matrix4x4F<T> value1, Matrix4x4F<T> value2, T amount)
            where T : IFloatingPointIeee754<T> =>
