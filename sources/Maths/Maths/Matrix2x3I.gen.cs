namespace Silk.NET.Maths
{
    ...
    partial struct Matrix2x3I<T> : IEquatable<Matrix2x3I<T>> where T : IBinaryInteger<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix2x3I{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix2x3I<T> left, Matrix2x3I<T> right) =>
        ...
        public static Matrix2x3I<T> operator +(Matrix2x3I<T> left, Matrix2x3I<T> right) =>
        ...
        public static Matrix2x3I<T> operator -(Matrix2x3I<T> value) =>
            new(-value.Row1,
                -value.Row2);
        ...
        public static Matrix2x3I<T> operator *(Matrix2x2I<T> left, Matrix2x3I<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix2x2I<T> operator *(Matrix2x3I<T> left, Matrix3x2I<T> right) =>
