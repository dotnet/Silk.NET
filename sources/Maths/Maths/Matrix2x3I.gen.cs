namespace Silk.NET.Maths
{
    ...
    partial struct Matrix2x3I<T> : IEquatable<Matrix2x3I<T>> where T : IBinaryInteger<T>
    {
        ...
        public Matrix2x3I(Vector3I<T> row1, Vector3I<T> row2) => (Row1, Row2) = (row1, row2);
        [UnscopedRef]
        ...
        public static Matrix2x3I<T> operator +(Matrix2x3I<T> left, Matrix2x3I<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2);
        ...
        public static Matrix2x3I<T> operator *(Matrix2x2I<T> left, Matrix2x3I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2);
        /// <summary>Multiplies a matrix by another matrix.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix2x2I<T> operator *(Matrix2x3I<T> left, Matrix3x2I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3, left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3);
    }
}