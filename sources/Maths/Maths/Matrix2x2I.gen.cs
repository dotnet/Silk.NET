namespace Silk.NET.Maths
{
    ...
    partial struct Matrix2x2I<T> : IEquatable<Matrix2x2I<T>> where T : IBinaryInteger<T>
    {
        ...
        public static Matrix2x2I<T> operator +(Matrix2x2I<T> left, Matrix2x2I<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2);
        ...
        public static Matrix2x2I<T> operator *(Matrix2x2I<T> left, Matrix2x2I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2);
    }
}