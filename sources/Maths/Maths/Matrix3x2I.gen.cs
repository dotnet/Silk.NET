namespace Silk.NET.Maths
{
    ...
    partial struct Matrix3x2I<T> : IEquatable<Matrix3x2I<T>> where T : IBinaryInteger<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix3x2I{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix3x2I<T> left, Matrix3x2I<T> right) =>
        ...
        public static Matrix3x2I<T> operator +(Matrix3x2I<T> left, Matrix3x2I<T> right) =>
        ...
        public static Matrix3x2I<T> operator -(Matrix3x2I<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3);
        ...
        public static Matrix3x2I<T> operator *(Matrix3x2I<T> left, Matrix2x2I<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix3x3I<T> operator *(Matrix3x2I<T> left, Matrix2x3I<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2,
                left.M21 * right.Row1 + left.M22 * right.Row2,
                left.M31 * right.Row1 + left.M32 * right.Row2);
    }
