namespace Silk.NET.Maths
{
    ...
    partial struct Matrix3x2I<T> : IEquatable<Matrix3x2I<T>> where T : IBinaryInteger<T>
    {
        ...
        public Matrix3x2I(Vector2I<T> row1, Vector2I<T> row2, Vector2I<T> row3) => (Row1, Row2, Row3) = (row1, row2, row3);
        [UnscopedRef]
        ...
        public static Matrix3x2I<T> operator +(Matrix3x2I<T> left, Matrix3x2I<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2, left.Row3 + right.Row3);
        ...
        public static Matrix3x2I<T> operator *(Matrix3x2I<T> left, Matrix2x2I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2, left.M31 * right.Row1 + left.M32 * right.Row2);
        /// <summary>Multiplies a matrix by another matrix.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix3x3I<T> operator *(Matrix3x2I<T> left, Matrix2x3I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2, left.M31 * right.Row1 + left.M32 * right.Row2);
    }
}