...
namespace Silk.NET.Maths
{
    ...
    public static partial class Vector2D
    {
        ...
        public static Vector128<float> ToVector128(this Vector2D<float> vector) =>
        ...
        public static Vector256<float> ToVector256(this Vector2D<float> vector) =>
        ...
        public static Vector512<float> ToVector512(this Vector2D<float> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<double> ToVector128(this Vector2D<double> vector) =>
            Vector128.Create(vector.X, vector.Y);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<double> ToVector256(this Vector2D<double> vector) =>
            Vector256.Create(vector.X, vector.Y, (double)0, (double)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<double> ToVector512(this Vector2D<double> vector) =>
            Vector512.Create(vector.X, vector.Y, (double)0, (double)0, (double)0, (double)0, (double)0, (double)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<byte> ToVector64(this Vector2D<byte> vector) =>
            Vector64.Create(vector.X, vector.Y, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<byte> ToVector128(this Vector2D<byte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<byte> ToVector256(this Vector2D<byte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<byte> ToVector512(this Vector2D<byte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<short> ToVector64(this Vector2D<short> vector) =>
            Vector64.Create(vector.X, vector.Y, (short)0, (short)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<short> ToVector128(this Vector2D<short> vector) =>
            Vector128.Create(vector.X, vector.Y, (short)0, (short)0, (short)0, (short)0, (short)0, (short)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<short> ToVector256(this Vector2D<short> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<short> ToVector512(this Vector2D<short> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<int> ToVector64(this Vector2D<int> vector) =>
            Vector64.Create(vector.X, vector.Y);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<int> ToVector128(this Vector2D<int> vector) =>
            Vector128.Create(vector.X, vector.Y, (int)0, (int)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<int> ToVector256(this Vector2D<int> vector) =>
            Vector256.Create(vector.X, vector.Y, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<int> ToVector512(this Vector2D<int> vector) =>
            Vector512.Create(vector.X, vector.Y, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0, (int)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<long> ToVector128(this Vector2D<long> vector) =>
            Vector128.Create(vector.X, vector.Y);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<long> ToVector256(this Vector2D<long> vector) =>
            Vector256.Create(vector.X, vector.Y, (long)0, (long)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<long> ToVector512(this Vector2D<long> vector) =>
            Vector512.Create(vector.X, vector.Y, (long)0, (long)0, (long)0, (long)0, (long)0, (long)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<sbyte> ToVector64(this Vector2D<sbyte> vector) =>
            Vector64.Create(vector.X, vector.Y, (sbyte)0, (sbyte)0, (sbyte)0, (sbyte)0, (sbyte)0, (sbyte)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<sbyte> ToVector128(this Vector2D<sbyte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<sbyte> ToVector256(this Vector2D<sbyte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<sbyte> ToVector512(this Vector2D<sbyte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<ushort> ToVector64(this Vector2D<ushort> vector) =>
            Vector64.Create(vector.X, vector.Y, (ushort)0, (ushort)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<ushort> ToVector128(this Vector2D<ushort> vector) =>
            Vector128.Create(vector.X, vector.Y, (ushort)0, (ushort)0, (ushort)0, (ushort)0, (ushort)0, (ushort)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<ushort> ToVector256(this Vector2D<ushort> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<ushort> ToVector512(this Vector2D<ushort> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<uint> ToVector64(this Vector2D<uint> vector) =>
            Vector64.Create(vector.X, vector.Y);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<uint> ToVector128(this Vector2D<uint> vector) =>
            Vector128.Create(vector.X, vector.Y, (uint)0, (uint)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<uint> ToVector256(this Vector2D<uint> vector) =>
            Vector256.Create(vector.X, vector.Y, (uint)0, (uint)0, (uint)0, (uint)0, (uint)0, (uint)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<uint> ToVector512(this Vector2D<uint> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<ulong> ToVector128(this Vector2D<ulong> vector) =>
            Vector128.Create(vector.X, vector.Y);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<ulong> ToVector256(this Vector2D<ulong> vector) =>
            Vector256.Create(vector.X, vector.Y, (ulong)0, (ulong)0);

        /// <summary>Converts a <see cref="Vector2D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<ulong> ToVector512(this Vector2D<ulong> vector) =>
