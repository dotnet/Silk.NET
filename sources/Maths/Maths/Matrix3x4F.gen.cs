namespace Silk.NET.Maths
{
    ...
    partial struct Matrix3x4F<T> :
        IEquatable<Matrix3x4F<T>>
        where T : IFloatingPointIeee754<T>
    {
        ...
        public static Matrix3x4F<T> operator -(Matrix3x4F<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3);
    ...
    static partial class Matrix3x4F
    {
        public static Matrix3x4F<T> Lerp<T>(Matrix3x4F<T> value1, Matrix3x4F<T> value2, T amount)
            where T : IFloatingPointIeee754<T> =>
