namespace Silk.NET.Maths
{
        ...
        where T : IFloatingPointIeee754<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix3x3F{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix3x3F<T> left, Matrix3x3F<T> right) =>
        ...
        public static Matrix3x3F<T> operator +(Matrix3x3F<T> left, Matrix3x3F<T> right) =>
        ...
        public static Matrix3x3F<T> operator -(Matrix3x3F<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3);
        ...
        public static Matrix2x3F<T> operator *(Matrix2x3F<T> left, Matrix3x3F<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix3x2F<T> operator *(Matrix3x3F<T> left, Matrix3x2F<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3,
                left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3,
