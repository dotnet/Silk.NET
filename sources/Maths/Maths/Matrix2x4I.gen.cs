namespace Silk.NET.Maths
{
    ...
    partial struct Matrix2x4I<T> : IEquatable<Matrix2x4I<T>> where T : IBinaryInteger<T>
    {
        ...
        public static Matrix2x4I<T> operator +(Matrix2x4I<T> left, Matrix2x4I<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2);
        ...
        public static Matrix2x4I<T> operator *(Matrix2x2I<T> left, Matrix2x4I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2);
        /// <summary>Multiplies a matrix by another matrix.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix2x2I<T> operator *(Matrix2x4I<T> left, Matrix4x2I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3 + left.M14 * right.Row4, left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3 + left.M24 * right.Row4);
        /// <summary>Multiplies a matrix by another matrix.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix3x4I<T> operator *(Matrix3x2I<T> left, Matrix2x4I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2, left.M21 * right.Row1 + left.M22 * right.Row2, left.M31 * right.Row1 + left.M32 * right.Row2);
    }
}