    ...
    public static partial class Vector3D
    {
            ...
            public TSelf Length
            {
                get
                {
                    if (typeof(TSelf) == typeof(float))
                        return Unsafe.BitCast<float, TSelf>(Unsafe.BitCast<Vector3D<TSelf>, Vector3>(vector).Length());
            ...
            where TSelf : INumberBase<TSelf>
        {
            ...
            public TSelf LengthSquared
            {
                ...
                {
                    if (typeof(TSelf) == typeof(float))
                        return Unsafe.BitCast<float, TSelf>(Unsafe.BitCast<Vector3D<TSelf>, Vector3>(vector).LengthSquared());
            ...
            where T : INumberBase<T>
        {
            if (typeof(T) == typeof(float))
                return Unsafe.BitCast<float, T>(Vector3.Dot(Unsafe.BitCast<Vector3D<T>, Vector3>(left), Unsafe.BitCast<Vector3D<T>, Vector3>(right)));
        ...
        {
            if (typeof(T) == typeof(float))
                return Unsafe.BitCast<Vector3, Vector3D<T>>(Vector3.Reflect(Unsafe.BitCast<Vector3D<T>, Vector3>(vector), Unsafe.BitCast<Vector3D<T>, Vector3>(normal)));
        ...
        {
            if (typeof(T) == typeof(float))
                return Unsafe.BitCast<Vector3, Vector3D<T>>(Vector3.Normalize(Unsafe.BitCast<Vector3D<T>, Vector3>(vector)));
        ...
        public static T Distance<T>(Vector3D<T> start, Vector3D<T> end)
            where T : IRootFunctions<T>
        {
            if (typeof(T) == typeof(float))
                return Unsafe.BitCast<float, T>(Vector3.Distance(Unsafe.BitCast<Vector3D<T>, Vector3>(start), Unsafe.BitCast<Vector3D<T>, Vector3>(end)));
        ...
        public static T DistanceSquared<T>(Vector3D<T> start, Vector3D<T> end)
            where T : INumberBase<T>
        {
            if (typeof(T) == typeof(float))
                return Unsafe.BitCast<float, T>(Vector3.DistanceSquared(Unsafe.BitCast<Vector3D<T>, Vector3>(start), Unsafe.BitCast<Vector3D<T>, Vector3>(end)));
        ...
        public static Vector256<float> ToVector256(this Vector3D<float> vector) =>
        ...
        public static Vector512<float> ToVector512(this Vector3D<float> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<double> ToVector256(this Vector3D<double> vector) =>
            Vector256.Create(vector.X, vector.Y, vector.Z, (double)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<double> ToVector512(this Vector3D<double> vector) =>
        ...
        public static Vector64<byte> ToVector64(this Vector3D<byte> vector) =>
            Vector64.Create(vector.X, vector.Y, vector.Z, (byte)0, (byte)0, (byte)0, (byte)0, (byte)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<byte> ToVector128(this Vector3D<byte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<byte> ToVector256(this Vector3D<byte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<byte> ToVector512(this Vector3D<byte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<short> ToVector64(this Vector3D<short> vector) =>
            Vector64.Create(vector.X, vector.Y, vector.Z, (short)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<short> ToVector128(this Vector3D<short> vector) =>
            Vector128.Create(vector.X, vector.Y, vector.Z, (short)0, (short)0, (short)0, (short)0, (short)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<short> ToVector256(this Vector3D<short> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<short> ToVector512(this Vector3D<short> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<int> ToVector128(this Vector3D<int> vector) =>
            Vector128.Create(vector.X, vector.Y, vector.Z, (int)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<int> ToVector256(this Vector3D<int> vector) =>
            Vector256.Create(vector.X, vector.Y, vector.Z, (int)0, (int)0, (int)0, (int)0, (int)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<int> ToVector512(this Vector3D<int> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<long> ToVector256(this Vector3D<long> vector) =>
            Vector256.Create(vector.X, vector.Y, vector.Z, (long)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<long> ToVector512(this Vector3D<long> vector) =>
            Vector512.Create(vector.X, vector.Y, vector.Z, (long)0, (long)0, (long)0, (long)0, (long)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<sbyte> ToVector64(this Vector3D<sbyte> vector) =>
            Vector64.Create(vector.X, vector.Y, vector.Z, (sbyte)0, (sbyte)0, (sbyte)0, (sbyte)0, (sbyte)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<sbyte> ToVector128(this Vector3D<sbyte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<sbyte> ToVector256(this Vector3D<sbyte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<sbyte> ToVector512(this Vector3D<sbyte> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector64{T}"/>.</summary>
        public static Vector64<ushort> ToVector64(this Vector3D<ushort> vector) =>
            Vector64.Create(vector.X, vector.Y, vector.Z, (ushort)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<ushort> ToVector128(this Vector3D<ushort> vector) =>
            Vector128.Create(vector.X, vector.Y, vector.Z, (ushort)0, (ushort)0, (ushort)0, (ushort)0, (ushort)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<ushort> ToVector256(this Vector3D<ushort> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<ushort> ToVector512(this Vector3D<ushort> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector128{T}"/>.</summary>
        public static Vector128<uint> ToVector128(this Vector3D<uint> vector) =>
            Vector128.Create(vector.X, vector.Y, vector.Z, (uint)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<uint> ToVector256(this Vector3D<uint> vector) =>
            Vector256.Create(vector.X, vector.Y, vector.Z, (uint)0, (uint)0, (uint)0, (uint)0, (uint)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<uint> ToVector512(this Vector3D<uint> vector) =>
        ...
        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector256{T}"/>.</summary>
        public static Vector256<ulong> ToVector256(this Vector3D<ulong> vector) =>
            Vector256.Create(vector.X, vector.Y, vector.Z, (ulong)0);

        /// <summary>Converts a <see cref="Vector3D{T}"/> to a <see cref="Vector512{T}"/>.</summary>
        public static Vector512<ulong> ToVector512(this Vector3D<ulong> vector) =>
        ...
        public static Vector3D<T> LerpClamped<T>(Vector3D<T> value1, Vector3D<T> value2, T amount)
        ...
        public static Vector3D<T> LerpClamped<T>(Vector3D<T> value1, Vector3D<T> value2, Vector3D<T> amount)
            where T : IFloatingPointIeee754<T> =>
            new(T.Lerp(value1.X, value2.X, T.Clamp(amount.X, T.Zero, T.One)),
                T.Lerp(value1.Y, value2.Y, T.Clamp(amount.Y, T.Zero, T.One)),
                T.Lerp(value1.Z, value2.Z, T.Clamp(amount.Z, T.Zero, T.One)));
        ...
        public static Vector3D<T> Transform<T>(Vector3D<T> vector, Matrix5X4<T> matrix)
            where T : INumberBase<T> =>
            new((vector.X * matrix.M11) + (vector.Y * matrix.M21) + (vector.Z * matrix.M31) + matrix.M51,
