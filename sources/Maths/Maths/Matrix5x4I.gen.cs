namespace Silk.NET.Maths
{
    ...
    partial struct Matrix5x4I<T> : IEquatable<Matrix5x4I<T>> where T : IBinaryInteger<T>
    {
        ...
        public static Matrix5x4I<T> operator +(Matrix5x4I<T> left, Matrix5x4I<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2, left.Row3 + right.Row3, left.Row4 + right.Row4, left.Row5 + right.Row5);
        ...
        public static Matrix5x4I<T> operator *(Matrix5x4I<T> left, Matrix4x4I<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3 + left.M14 * right.Row4, left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3 + left.M24 * right.Row4, left.M31 * right.Row1 + left.M32 * right.Row2 + left.M33 * right.Row3 + left.M34 * right.Row4, left.M41 * right.Row1 + left.M42 * right.Row2 + left.M43 * right.Row3 + left.M44 * right.Row4, left.M51 * right.Row1 + left.M52 * right.Row2 + left.M53 * right.Row3 + left.M54 * right.Row4);
    }
}