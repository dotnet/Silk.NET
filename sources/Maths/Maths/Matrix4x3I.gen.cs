namespace Silk.NET.Maths
{
    ...
    partial struct Matrix4x3I<T> :
        IEquatable<Matrix4x3I<T>>
        where T : IBinaryInteger<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix4x3I{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix4x3I<T> left, Matrix4x3I<T> right) =>
        ...
        public static Matrix4x3I<T> operator +(Matrix4x3I<T> left, Matrix4x3I<T> right) =>
        ...
        public static Matrix4x3I<T> operator -(Matrix4x3I<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3,
                -value.Row4);
        ...
        public static Matrix2x3I<T> operator *(Matrix2x4I<T> left, Matrix4x3I<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x2I<T> operator *(Matrix4x3I<T> left, Matrix3x2I<T> right) =>
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x3I<T> operator *(Matrix4x3I<T> left, Matrix3x3I<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3,
                left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3,
                left.M31 * right.Row1 + left.M32 * right.Row2 + left.M33 * right.Row3,
                left.M41 * right.Row1 + left.M42 * right.Row2 + left.M43 * right.Row3);
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4x4I<T> operator *(Matrix4x3I<T> left, Matrix3x4I<T> right) =>
            new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3,
                left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3,
                left.M31 * right.Row1 + left.M32 * right.Row2 + left.M33 * right.Row3,
                left.M41 * right.Row1 + left.M42 * right.Row2 + left.M43 * right.Row3);
