namespace Silk.NET.Maths
{
    ...
    partial struct Matrix5x4F<T> : IEquatable<Matrix5x4F<T>> where T : IFloatingPointIeee754<T>
    {
        ...
        /// <summary>
        /// Constructs a <see cref="Matrix5x4F{T}"/> from the given rows.
        /// </summary>
        ...
        public static bool operator ==(Matrix5x4F<T> left, Matrix5x4F<T> right) =>
        ...
        public static Matrix5x4F<T> operator +(Matrix5x4F<T> left, Matrix5x4F<T> right) =>
        ...
        public static Matrix5x4F<T> operator -(Matrix5x4F<T> value) =>
            new(-value.Row1,
                -value.Row2,
                -value.Row3,
                -value.Row4,
        ...
        public static Matrix5x4F<T> operator *(Matrix5x4F<T> left, Matrix4x4F<T> right) =>
