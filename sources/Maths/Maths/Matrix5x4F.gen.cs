namespace Silk.NET.Maths
{
    ...
    partial struct Matrix5x4F<T> : IEquatable<Matrix5x4F<T>> where T : IFloatingPointIeee754<T>
    {
        ...
        public Vector4F<T> Row5;
        public Matrix5x4F(Vector4F<T> row1, Vector4F<T> row2, Vector4F<T> row3, Vector4F<T> row4, Vector4F<T> row5) => (Row1, Row2, Row3, Row4, Row5) = (row1, row2, row3, row4, row5);
        [UnscopedRef]
        ...
        public T M54 => Row5.W;
        /// <inheridoc/>
        public override bool Equals(object? obj) => obj is Matrix5x4F<T> other && Equals(other);
        /// <inheridoc/>
        public bool Equals(Matrix5x4F<T> other) => this == other;
        /// <inheridoc/>
        ...
        public static bool operator ==(Matrix5x4F<T> left, Matrix5x4F<T> right) => left.Row1 == right.Row1 && left.Row2 == right.Row2 && left.Row3 == right.Row3 && left.Row4 == right.Row4 && left.Row5 == right.Row5;
        /// <summary>Returns a boolean indicating whether the given two matrices are not equal.</summary>
        /// <param name = "left">The first matrix to compare.</param>
        /// <param name = "right">The second matrix to compare.</param>
        /// <returns><c>true</c> if the given matrices are not equal; <c>false</c> otherwise.</returns>
        public static bool operator !=(Matrix5x4F<T> left, Matrix5x4F<T> right) => !(left == right);
        /// <summary>Adds two matrices together.</summary>
        /// <param name = "left">The first source matrix.</param>
        /// <param name = "right">The second source matrix.</param>
        /// <returns>The result of the addition.</returns>
        public static Matrix5x4F<T> operator +(Matrix5x4F<T> left, Matrix5x4F<T> right) => new(left.Row1 + right.Row1, left.Row2 + right.Row2, left.Row3 + right.Row3, left.Row4 + right.Row4, left.Row5 + right.Row5);
        ...
        public static Matrix5x4F<T> operator *(Matrix5x4F<T> left, Matrix4x4F<T> right) => new(left.M11 * right.Row1 + left.M12 * right.Row2 + left.M13 * right.Row3 + left.M14 * right.Row4, left.M21 * right.Row1 + left.M22 * right.Row2 + left.M23 * right.Row3 + left.M24 * right.Row4, left.M31 * right.Row1 + left.M32 * right.Row2 + left.M33 * right.Row3 + left.M34 * right.Row4, left.M41 * right.Row1 + left.M42 * right.Row2 + left.M43 * right.Row3 + left.M44 * right.Row4, left.M51 * right.Row1 + left.M52 * right.Row2 + left.M53 * right.Row3 + left.M54 * right.Row4);
    }
}