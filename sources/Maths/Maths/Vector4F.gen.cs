namespace Silk.NET.Maths
{
        ...
        where T : IFloatingPointIeee754<T>
    {
        ...
        public static Vector4F<T> One => new(T.One);
        ...
        public static Vector4F<T> UnitX => new(T.One, T.Zero, T.Zero, T.Zero);

        /// <summary>Gets the vector (0, 1, 0, 0).</summary>
        public static Vector4F<T> UnitY => new(T.Zero, T.One, T.Zero, T.Zero);

        /// <summary>Gets the vector (0, 0, 1, 0).</summary>
        public static Vector4F<T> UnitZ => new(T.Zero, T.Zero, T.One, T.Zero);

        /// <summary>Gets the vector (0, 0, 0, 1).</summary>
        public static Vector4F<T> UnitW => new(T.Zero, T.Zero, T.Zero, T.One);
        ...
        /// <summary>Implicitly casts a <see cref="ValueTuple{T, T, T, T}"/> to a <see cref="Vector4F{T}"/>.</summary>
        public static implicit operator Vector4F<T>((T X, T Y, T Z, T W) v) =>
            new(v.X, v.Y, v.Z, v.W);

        /// <summary>Implicitly casts a <see cref="Vector4F{T}"/> to a <see cref="ValueTuple{T, T, T, T}"/>.</summary>
        public static implicit operator (T X, T Y, T Z, T W)(Vector4F<T> v) =>
            (v.X, v.Y, v.Z, v.W);
    ...
    static partial class Vector4F
    {
        ...
        public static Vector4I<int> Sign<TSelf>(this Vector4F<TSelf> value)
        ...
        public static Vector4F<TSelf> Max<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> Max<TSelf>(this Vector4F<TSelf> x, TSelf y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MaxNumber<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A single value provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MaxNumber<TSelf>(this Vector4F<TSelf> x, TSelf y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> Min<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A single value provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> Min<TSelf>(this Vector4F<TSelf> x, TSelf y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MinNumber<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A single value provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MinNumber<TSelf>(this Vector4F<TSelf> x, TSelf y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> Clamp<TSelf>(this Vector4F<TSelf> value, Vector4F<TSelf> min, Vector4F<TSelf> max)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> Clamp<TSelf>(this Vector4F<TSelf> value, TSelf min, TSelf max)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> CopySign<TSelf>(this Vector4F<TSelf> value, Vector4F<TSelf> sign)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> CopySign<TSelf>(this Vector4F<TSelf> value, TSelf sign)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="value">A vector whose members will be provided for <parameref name="value"/>.</param>
        public static Vector4F<TSelf> Abs<TSelf>(this Vector4F<TSelf> value)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MaxMagnitude<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MaxMagnitudeNumber<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MinMagnitude<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> MinMagnitudeNumber<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Ceiling<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Floor<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Round<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> Round<TSelf>(this Vector4F<TSelf> x, int digits, MidpointRounding mode)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Truncate<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Atan2<TSelf>(this Vector4F<TSelf> y, Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Atan2Pi<TSelf>(this Vector4F<TSelf> y, Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> Lerp<TSelf>(this Vector4F<TSelf> value1, Vector4F<TSelf> value2, TSelf amount)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> BitDecrement<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> BitIncrement<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> FusedMultiplyAdd<TSelf>(this Vector4F<TSelf> left, Vector4F<TSelf> right, Vector4F<TSelf> addend)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> FusedMultiplyAdd<TSelf>(this Vector4F<TSelf> left, TSelf right, TSelf addend)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="left">A vector whose members will be provided for <parameref name="left"/>.</param>
        /// <param name="right">A vector whose members will be provided for <parameref name="right"/>.</param>
        public static Vector4F<TSelf> Ieee754Remainder<TSelf>(this Vector4F<TSelf> left, Vector4F<TSelf> right)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="left">A vector whose members will be provided for <parameref name="left"/>.</param>
        /// <param name="right">A single value provided for <parameref name="right"/>.</param>
        public static Vector4F<TSelf> Ieee754Remainder<TSelf>(this Vector4F<TSelf> left, TSelf right)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4I<int> ILogB<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> ReciprocalEstimate<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> ReciprocalSqrtEstimate<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> ScaleB<TSelf>(this Vector4F<TSelf> x, Vector4I<int> n)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> ScaleB<TSelf>(this Vector4F<TSelf> x, int n)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> Pow<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A single value provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> Pow<TSelf>(this Vector4F<TSelf> x, TSelf y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Cbrt<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Sqrt<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="n">A single value provided for <parameref name="n"/>.</param>
        public static Vector4F<TSelf> RootN<TSelf>(this Vector4F<TSelf> x, int n)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="n">A vector whose members will be provided for <parameref name="n"/>.</param>
        public static Vector4F<TSelf> RootN<TSelf>(this Vector4F<TSelf> x, Vector4I<int> n)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        /// <param name="y">A vector whose members will be provided for <parameref name="y"/>.</param>
        public static Vector4F<TSelf> Hypot<TSelf>(this Vector4F<TSelf> x, Vector4F<TSelf> y)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> Log<TSelf>(this Vector4F<TSelf> x, TSelf newBase)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Acos<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> AcosPi<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Asin<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> AsinPi<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Atan<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> AtanPi<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Cos<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> CosPi<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Sin<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> SinPi<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Tan<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> TanPi<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> DegreesToRadians<TSelf>(this Vector4F<TSelf> degrees)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        public static Vector4F<TSelf> RadiansToDegrees<TSelf>(this Vector4F<TSelf> radians)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Acosh<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Asinh<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Atanh<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Cosh<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Sinh<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
        ...
        /// <param name="x">A vector whose members will be provided for <parameref name="x"/>.</param>
        public static Vector4F<TSelf> Tanh<TSelf>(this Vector4F<TSelf> x)
            where TSelf : IFloatingPointIeee754<TSelf> =>
