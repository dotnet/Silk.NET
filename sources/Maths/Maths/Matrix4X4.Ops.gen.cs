...
namespace Silk.NET.Maths
{
    ...
    public static partial class Matrix4X4
    {
        ...
        /// <returns>The scaled matrix.</returns>
        public static Matrix4X4<T> Multiply<T>(T left, Matrix4X4<T> right)
            where T : INumberBase<T> =>
            left * right;
        ...
        public static Vector4D<T> Multiply<T>(Vector4D<T> rowVector, Matrix4X4<T> matrix)
            where T : INumberBase<T> =>
            rowVector * matrix;
        ...
        public static Vector4D<T> Multiply<T>(Matrix4X4<T> matrix, Vector4D<T> columnVector)
            where T : INumberBase<T> =>
            matrix * columnVector;
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4X2<T> Multiply<T>(Matrix4X4<T> left, Matrix4X2<T> right)
            where T : INumberBase<T> =>
            left * right;
        ...
        /// <param name="right">The second source matrix.</param>
        /// <returns>The result of the multiplication.</returns>
        public static Matrix4X3<T> Multiply<T>(Matrix4X4<T> left, Matrix4X3<T> right)
            where T : INumberBase<T> =>
            left * right;
