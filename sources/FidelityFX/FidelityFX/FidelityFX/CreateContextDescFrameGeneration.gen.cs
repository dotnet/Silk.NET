...
public partial struct CreateContextDescFrameGeneration
{
    [NativeTypeName("ffxCreateContextDescHeader")]
    ...
    public ApiDimensions2D DisplaySize;

    [NativeTypeName("struct FfxApiDimensions2D")]
    public ApiDimensions2D MaxRenderSize;
