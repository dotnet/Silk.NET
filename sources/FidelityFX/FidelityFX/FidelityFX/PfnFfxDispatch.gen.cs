...
public readonly unsafe struct PfnFfxDispatch : IDisposable
{
    private readonly void* Pointer;
    public delegate* unmanaged<void**, ApiHeader*, uint> Handle =>
        (delegate* unmanaged<void**, ApiHeader*, uint>)Pointer;

    public PfnFfxDispatch(delegate* unmanaged<void**, ApiHeader*, uint> ptr) => Pointer = ptr;

    public PfnFfxDispatch(PfnFfxDispatchDelegate proc) => Pointer = SilkMarshal.DelegateToPtr(proc);

    public void Dispose() => SilkMarshal.Free(Pointer);

    public static implicit operator PfnFfxDispatch(
