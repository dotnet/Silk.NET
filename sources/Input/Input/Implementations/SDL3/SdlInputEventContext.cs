...
internal sealed class SdlInputEventContext : IDisposable
{
    ...
    private sealed class GenericEventQueueSdl : SdlInputEventQueue<GenericEvent>
    {
        ...
        public unsafe void StoreReferencesTo<T>(in SdlInputEventQueue<T> queueSdl, SdlEventDiscriminator discriminator,
            bool consume = true) where T : struct
        {
        ...
        private static readonly Comparison<FractionalTimestamp> _timestampComparer =
            (timeA, timeB) => timeA.CompareTo(timeB);
    }
}
