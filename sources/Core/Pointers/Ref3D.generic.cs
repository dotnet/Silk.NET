	...
	where T : unmanaged
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public unsafe static implicit operator Ref3D<T>(NullPtr ptr) => (void*)ptr;
    ...
    /// <param name="ptr"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator void*(Ref3D<T> ptr) => Unsafe.AsPointer(ref Unsafe.AsRef(in ptr.InteriorRef));
    ...
    /// <param name="ptr"></param>
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static explicit operator T***(Ref3D<T> ptr) => (T***)Unsafe.AsPointer(ref ptr.InteriorRef);
    ...
    /// </summary>
    /// <param name="ptr"></param>
    public static implicit operator Ref3D(Ref3D<T> ptr) => new Ref3D(ref ptr.InteriorRef);
}
