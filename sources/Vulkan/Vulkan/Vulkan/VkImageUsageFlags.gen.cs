...
[NativeName("VkImageUsageFlagBits")]
...
public enum VkImageUsageFlags : uint
{
    ...
    VkImageUsageHostTransferBit = 0x00400000,
    ...
    VkImageUsageVideoDecodeDstBitKHR = 0x00000400,
    ...
    VkImageUsageVideoDecodeSrcBitKHR = 0x00000800,
    ...
    VkImageUsageVideoDecodeDpbBitKHR = 0x00001000,
    ...
    VkImageUsageFragmentDensityMapBitEXT = 0x00000200,
    ...
    VkImageUsageFragmentShadingRateAttachmentBitKHR = 0x00000100,
    ...
    VkImageUsageVideoEncodeDstBitKHR = 0x00002000,
    ...
    VkImageUsageVideoEncodeSrcBitKHR = 0x00004000,
    ...
    VkImageUsageVideoEncodeDpbBitKHR = 0x00008000,
    ...
    VkImageUsageAttachmentFeedbackLoopBitEXT = 0x00080000,
    ...
    VkImageUsageInvocationMaskBitHUAWEI = 0x00040000,
    ...
    VkImageUsageSampleWeightBitQCOM = 0x00100000,
    ...
    VkImageUsageTileMemoryBitQCOM = 0x08000000,
    ...
    VkImageUsageVideoEncodeQuantizationDeltaMapBitKHR = 0x02000000,
    ...
    VkImageUsageVideoEncodeEmphasisMapBitKHR = 0x04000000,
    ...
    VkImageUsageShadingRateImageBitNV = VkImageUsageFragmentShadingRateAttachmentBitKHR,
    ...
    VkImageUsageHostTransferBitEXT = VkImageUsageHostTransferBit,

    [NativeName("VK_IMAGE_USAGE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkImageUsageFlagBitsMaxEnum = 0x7FFFFFFF,
}
