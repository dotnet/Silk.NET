...
public enum VkBufferCreateFlags : uint
{
    ...
    VkBufferCreateSparseBindingBit = 0x00000001,
    ...
    VkBufferCreateSparseResidencyBit = 0x00000002,
    ...
    VkBufferCreateSparseAliasedBit = 0x00000004,
    ...
    VkBufferCreateProtectedBit = 0x00000008,
    ...
    VkBufferCreateDeviceAddressCaptureReplayBit = 0x00000010,
    ...
    VkBufferCreateDescriptorBufferCaptureReplayBitEXT = 0x00000020,
    ...
    VkBufferCreateVideoProfileIndependentBitKHR = 0x00000040,
    ...
    VkBufferCreateDeviceAddressCaptureReplayBitEXT = VkBufferCreateDeviceAddressCaptureReplayBit,
    ...
    VkBufferCreateDeviceAddressCaptureReplayBitKHR = VkBufferCreateDeviceAddressCaptureReplayBit,

    [NativeName("VK_BUFFER_CREATE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkBufferCreateFlagBitsMaxEnum = 0x7FFFFFFF,
}
