...
public enum VkQueryResultFlags : uint
{
    ...
    VkQueryResultWithStatusBitKHR = 0x00000010,

    [NativeName("VK_QUERY_RESULT_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkQueryResultFlagBitsMaxEnum = 0x7FFFFFFF,
}
