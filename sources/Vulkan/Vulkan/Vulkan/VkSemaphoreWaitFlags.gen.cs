...
public enum VkSemaphoreWaitFlags : uint
{
    ...
    VkSemaphoreWaitAnyBit = 0x00000001,
    ...
    VkSemaphoreWaitAnyBitKHR = VkSemaphoreWaitAnyBit,

    [NativeName("VK_SEMAPHORE_WAIT_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_2",
    ...
    VkSemaphoreWaitFlagBitsMaxEnum = 0x7FFFFFFF,
}
