...
public enum VkSemaphoreImportFlags : uint
{
    ...
    VkSemaphoreImportTemporaryBit = 0x00000001,
    ...
    VkSemaphoreImportTemporaryBitKHR = VkSemaphoreImportTemporaryBit,

    [NativeName("VK_SEMAPHORE_IMPORT_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_1",
    ...
    VkSemaphoreImportFlagBitsMaxEnum = 0x7FFFFFFF,
}
