...
public enum VkTessellationDomainOrigin : uint
{
    ...
    VkTessellationDomainOriginUpperLeftKHR = VkTessellationDomainOriginUpperLeft,

    [NativeName("VK_TESSELLATION_DOMAIN_ORIGIN_LOWER_LEFT_KHR")]
    [NameAffix("Suffix", "KhronosVendor", "KHR")]
    [SupportedApiProfile("vulkan", ["VK_KHR_maintenance2"])]
    VkTessellationDomainOriginLowerLeftKHR = VkTessellationDomainOriginLowerLeft,

    [NativeName("VK_TESSELLATION_DOMAIN_ORIGIN_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_GRAPHICS_VERSION_1_1",
    ...
    VkTessellationDomainOriginMaxEnum = 0x7FFFFFFF,
}
