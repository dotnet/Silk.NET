...
{
    [NativeName("VK_QUEUE_GRAPHICS_BIT")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    [NativeName("VK_QUEUE_COMPUTE_BIT")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    [NativeName("VK_QUEUE_TRANSFER_BIT")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    [NativeName("VK_QUEUE_SPARSE_BINDING_BIT")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    [NativeName("VK_QUEUE_PROTECTED_BIT")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_1",
    ...
    VkQueueProtectedBit = 0x00000010,
    ...
    VkQueueVideoDecodeBitKHR = 0x00000020,
    ...
    VkQueueVideoEncodeBitKHR = 0x00000040,
    ...
    VkQueueOpticalFlowBitNV = 0x00000100,
    ...
    VkQueueDataGraphBitARM = 0x00000400,

    [NativeName("VK_QUEUE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkQueueFlagBitsMaxEnum = 0x7FFFFFFF,
}
