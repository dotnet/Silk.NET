...
public enum VkVideoEncodeAv1PredictionModeKHR : uint
{
    ...
    VkVideoEncodeAv1PredictionModeIntraOnly = 0,
    ...
    VkVideoEncodeAv1PredictionModeSingleReference = 1,
    ...
    VkVideoEncodeAv1PredictionModeUnidirectionalCompound = 2,
    ...
    VkVideoEncodeAv1PredictionModeBidirectionalCompound = 3,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_ENCODE_AV1_PREDICTION_MODE_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_encode_av1"],
        ImpliesSets = ["VK_KHR_video_encode_queue"]
    )]
    VkVideoEncodeAv1PredictionModeMaxEnum = 0x7FFFFFFF,
}
