...
public enum VkFenceImportFlags : uint
{
    ...
    VkFenceImportTemporaryBit = 0x00000001,
    ...
    VkFenceImportTemporaryBitKHR = VkFenceImportTemporaryBit,

    [NativeName("VK_FENCE_IMPORT_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_1",
    ...
    VkFenceImportFlagBitsMaxEnum = 0x7FFFFFFF,
}
