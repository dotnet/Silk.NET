...
public enum VkSampleCountFlags : uint
{
    ...
    VkSampleCount64Bit = 0x00000040,

    [NativeName("VK_SAMPLE_COUNT_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkSampleCountFlagBitsMaxEnum = 0x7FFFFFFF,
}
