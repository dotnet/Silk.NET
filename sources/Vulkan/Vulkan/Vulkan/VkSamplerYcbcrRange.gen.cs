...
public enum VkSamplerYcbcrRange : uint
{
    ...
    VkSamplerYcbcrRangeItuFullKHR = VkSamplerYcbcrRangeItuFull,
    ...
    VkSamplerYcbcrRangeItuNarrowKHR = VkSamplerYcbcrRangeItuNarrow,

    [NativeName("VK_SAMPLER_YCBCR_RANGE_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_COMPUTE_VERSION_1_1",
    ...
    VkSamplerYcbcrRangeMaxEnum = 0x7FFFFFFF,
}
