...
public enum VkQueryType : uint
{
    ...
    VkQueryTypeResultStatusOnlyKHR = 1000023000,
    ...
    VkQueryTypeVideoEncodeFeedbackKHR = 1000299000,
    ...
    VkQueryTypeMeshPrimitivesGeneratedEXT = 1000328000,
    ...
    VkQueryTypePrimitivesGeneratedEXT = 1000382000,
    ...
    VkQueryTypeAccelerationStructureSerializationBottomLevelPointersKHR = 1000386000,
    ...
    VkQueryTypeAccelerationStructureSizeKHR = 1000386001,
    ...
    VkQueryTypeMicromapSerializationSizeEXT = 1000396000,
    ...
    VkQueryTypeMicromapCompactedSizeEXT = 1000396001,

    [NativeName("VK_QUERY_TYPE_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
