...
public enum VkSubpassContents : uint
{
    ...
    VkSubpassContentsInlineAndSecondaryCommandBuffersKHR = 1000451000,
    ...
    VkSubpassContentsInlineAndSecondaryCommandBuffersEXT =
        VkSubpassContentsInlineAndSecondaryCommandBuffersKHR,

    [NativeName("VK_SUBPASS_CONTENTS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_GRAPHICS_VERSION_1_0",
    ...
    VkSubpassContentsMaxEnum = 0x7FFFFFFF,
}
