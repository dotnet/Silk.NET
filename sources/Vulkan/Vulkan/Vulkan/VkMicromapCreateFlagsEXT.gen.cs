...
public enum VkMicromapCreateFlagsEXT : uint
{
    ...
    VkMicromapCreateDeviceAddressCaptureReplayBit = 0x00000001,

    [NameAffix("Suffix", "KhronosImpliedVendor", "EXT")]
    [NativeName("VK_MICROMAP_CREATE_FLAG_BITS_MAX_ENUM_EXT")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_EXT_opacity_micromap"],
        ImpliesSets = [
    ...
    VkMicromapCreateFlagBitsMaxEnum = 0x7FFFFFFF,
}
