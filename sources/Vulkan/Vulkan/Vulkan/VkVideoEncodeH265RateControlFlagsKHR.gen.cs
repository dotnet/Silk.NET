...
public enum VkVideoEncodeH265RateControlFlagsKHR : uint
{
    ...
    VkVideoEncodeH265RateControlAttemptHrdComplianceBit = 0x00000001,
    ...
    VkVideoEncodeH265RateControlRegularGopBit = 0x00000002,
    ...
    VkVideoEncodeH265RateControlReferencePatternFlatBit = 0x00000004,
    ...
    VkVideoEncodeH265RateControlReferencePatternDyadicBit = 0x00000008,
    ...
    VkVideoEncodeH265RateControlTemporalSubLayerPatternDyadicBit = 0x00000010,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_ENCODE_H265_RATE_CONTROL_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_encode_h265"],
        ImpliesSets = ["VK_KHR_video_encode_queue"]
    )]
    VkVideoEncodeH265RateControlFlagBitsMaxEnum = 0x7FFFFFFF,
}
