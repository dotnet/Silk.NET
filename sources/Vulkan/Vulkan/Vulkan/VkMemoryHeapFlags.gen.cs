...
public enum VkMemoryHeapFlags : uint
{
    ...
    VkMemoryHeapMultiInstanceBit = 0x00000002,
    ...
    VkMemoryHeapTileMemoryBitQCOM = 0x00000008,

    [NativeName("VK_MEMORY_HEAP_MULTI_INSTANCE_BIT_KHR")]
    [NameAffix("Suffix", "KhronosVendor", "KHR")]
    [SupportedApiProfile("vulkan", ["VK_KHR_device_group_creation"])]
    VkMemoryHeapMultiInstanceBitKHR = VkMemoryHeapMultiInstanceBit,

    [NativeName("VK_MEMORY_HEAP_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkMemoryHeapFlagBitsMaxEnum = 0x7FFFFFFF,
}
