...
public readonly unsafe struct AllocationFunction : IDisposable
{
    [SupportedApiProfile(
        "vulkan",
        [
    ...
    public AllocationFunction(AllocationFunctionDelegate proc) =>
    ...
    public static implicit operator AllocationFunction(
