...
public enum VkMemoryPropertyFlags : uint
{
    ...
    VkMemoryPropertyProtectedBit = 0x00000020,
    ...
    VkMemoryPropertyDeviceCoherentBitAMD = 0x00000040,
    ...
    VkMemoryPropertyDeviceUncachedBitAMD = 0x00000080,
    ...
    VkMemoryPropertyRdmaCapableBitNV = 0x00000100,

    [NativeName("VK_MEMORY_PROPERTY_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkMemoryPropertyFlagBitsMaxEnum = 0x7FFFFFFF,
}
