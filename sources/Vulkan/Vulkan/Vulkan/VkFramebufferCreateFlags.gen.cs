...
public enum VkFramebufferCreateFlags : uint
{
    ...
    VkFramebufferCreateImagelessBit = 0x00000001,
    ...
    VkFramebufferCreateImagelessBitKHR = VkFramebufferCreateImagelessBit,

    [NativeName("VK_FRAMEBUFFER_CREATE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
    ...
    VkFramebufferCreateFlagBitsMaxEnum = 0x7FFFFFFF,
}
