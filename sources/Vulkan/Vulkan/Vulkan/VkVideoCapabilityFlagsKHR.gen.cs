...
public enum VkVideoCapabilityFlagsKHR : uint
{
    ...
    VkVideoCapabilityProtectedContentBit = 0x00000001,
    ...
    VkVideoCapabilitySeparateReferenceImagesBit = 0x00000002,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_CAPABILITY_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_queue"],
        ImpliesSets = ["VK_VERSION_1_1+VK_KHR_synchronization2", "VK_VERSION_1_3"]
    )]
    VkVideoCapabilityFlagBitsMaxEnum = 0x7FFFFFFF,
}
