...
public enum VkVideoChromaSubsamplingFlagsKHR : uint
{
    ...
    VkVideoChromaSubsamplingInvalid = 0,
    ...
    VkVideoChromaSubsamplingMonochromeBit = 0x00000001,
    ...
    VkVideoChromaSubsampling420Bit = 0x00000002,
    ...
    VkVideoChromaSubsampling422Bit = 0x00000004,
    ...
    VkVideoChromaSubsampling444Bit = 0x00000008,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_CHROMA_SUBSAMPLING_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_queue"],
        ImpliesSets = ["VK_VERSION_1_1+VK_KHR_synchronization2", "VK_VERSION_1_3"]
    )]
    VkVideoChromaSubsamplingFlagBitsMaxEnum = 0x7FFFFFFF,
}
