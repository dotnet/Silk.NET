...
public enum VkMemoryAllocateFlags : uint
{
    ...
    VkMemoryAllocateDeviceMaskBit = 0x00000001,
    ...
    VkMemoryAllocateDeviceAddressBit = 0x00000002,
    ...
    VkMemoryAllocateDeviceAddressCaptureReplayBit = 0x00000004,
    ...
    VkMemoryAllocateZeroInitializeBitEXT = 0x00000008,
    ...
    VkMemoryAllocateDeviceMaskBitKHR = VkMemoryAllocateDeviceMaskBit,
    ...
    VkMemoryAllocateDeviceAddressBitKHR = VkMemoryAllocateDeviceAddressBit,
    ...
    [NativeName("VK_MEMORY_ALLOCATE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_1",
    ...
    VkMemoryAllocateFlagBitsMaxEnum = 0x7FFFFFFF,
}
