...
public enum VkExternalFenceHandleTypeFlags : uint
{
    ...
    VkExternalFenceHandleTypeOpaqueFdBit = 0x00000001,
    ...
    VkExternalFenceHandleTypeOpaqueWin32Bit = 0x00000002,
    ...
    VkExternalFenceHandleTypeOpaqueWin32KmtBit = 0x00000004,
    ...
    VkExternalFenceHandleTypeSyncFdBit = 0x00000008,
    ...
    VkExternalFenceHandleTypeOpaqueFdBitKHR = VkExternalFenceHandleTypeOpaqueFdBit,
    ...
    VkExternalFenceHandleTypeOpaqueWin32BitKHR = VkExternalFenceHandleTypeOpaqueWin32Bit,
    ...
    VkExternalFenceHandleTypeOpaqueWin32KmtBitKHR = VkExternalFenceHandleTypeOpaqueWin32KmtBit,
    ...
    VkExternalFenceHandleTypeSyncFdBitKHR = VkExternalFenceHandleTypeSyncFdBit,

    [NativeName("VK_EXTERNAL_FENCE_HANDLE_TYPE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_1",
    ...
    VkExternalFenceHandleTypeFlagBitsMaxEnum = 0x7FFFFFFF,
}
