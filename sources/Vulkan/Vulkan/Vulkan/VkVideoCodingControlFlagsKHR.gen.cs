...
public enum VkVideoCodingControlFlagsKHR : uint
{
    ...
    VkVideoCodingControlResetBit = 0x00000001,
    ...
    VkVideoCodingControlEncodeRateControlBit = 0x00000002,
    ...
    VkVideoCodingControlEncodeQualityLevelBit = 0x00000004,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_CODING_CONTROL_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_queue"],
        ImpliesSets = ["VK_VERSION_1_1+VK_KHR_synchronization2", "VK_VERSION_1_3"]
    )]
    VkVideoCodingControlFlagBitsMaxEnum = 0x7FFFFFFF,
}
