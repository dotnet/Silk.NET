...
public enum VkVideoEncodeUsageFlagsKHR : uint
{
    ...
    VkVideoEncodeUsageTranscodingBit = 0x00000001,
    ...
    VkVideoEncodeUsageStreamingBit = 0x00000002,
    ...
    VkVideoEncodeUsageRecordingBit = 0x00000004,
    ...
    VkVideoEncodeUsageConferencingBit = 0x00000008,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_ENCODE_USAGE_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_encode_queue"],
        ImpliesSets = [
    ...
    VkVideoEncodeUsageFlagBitsMaxEnum = 0x7FFFFFFF,
}
