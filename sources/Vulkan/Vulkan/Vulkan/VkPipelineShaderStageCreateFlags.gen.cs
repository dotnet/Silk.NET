...
public enum VkPipelineShaderStageCreateFlags : uint
{
    ...
    VkPipelineShaderStageCreateAllowVaryingSubgroupSizeBit = 0x00000001,
    ...
    VkPipelineShaderStageCreateRequireFullSubgroupsBit = 0x00000002,
    ...
    VkPipelineShaderStageCreateAllowVaryingSubgroupSizeBitEXT =
        VkPipelineShaderStageCreateAllowVaryingSubgroupSizeBit,
    ...
    VkPipelineShaderStageCreateRequireFullSubgroupsBitEXT =
        VkPipelineShaderStageCreateRequireFullSubgroupsBit,

    [NativeName("VK_PIPELINE_SHADER_STAGE_CREATE_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
    ...
    VkPipelineShaderStageCreateFlagBitsMaxEnum = 0x7FFFFFFF,
}
