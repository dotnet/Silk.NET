...
public enum VkQueryPipelineStatisticFlags : uint
{
    ...
    VkQueryPipelineStatisticTaskShaderInvocationsBitEXT = 0x00000800,
    ...
    VkQueryPipelineStatisticMeshShaderInvocationsBitEXT = 0x00001000,
    ...
    VkQueryPipelineStatisticClusterCullingShaderInvocationsBitHUAWEI = 0x00002000,

    [NativeName("VK_QUERY_PIPELINE_STATISTIC_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_COMPUTE_VERSION_1_0",
    ...
    VkQueryPipelineStatisticFlagBitsMaxEnum = 0x7FFFFFFF,
}
