...
public enum VkAccelerationStructureTypeKHR : uint
{
    ...
    VkAccelerationStructureTypeTopLevel = 0,
    ...
    VkAccelerationStructureTypeBottomLevel = 1,
    ...
    VkAccelerationStructureTypeGeneric = 2,
    ...
    VkAccelerationStructureTypeTopLevelNV = VkAccelerationStructureTypeTopLevel,
    ...
    VkAccelerationStructureTypeBottomLevelNV = VkAccelerationStructureTypeBottomLevel,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_ACCELERATION_STRUCTURE_TYPE_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_acceleration_structure"],
        ImpliesSets = [
    ...
    VkAccelerationStructureTypeMaxEnum = 0x7FFFFFFF,
}
