...
public enum VkVendorId : uint
{
    ...
    VkVendorIdMobileye = 0x10007,

    [NativeName("VK_VENDOR_ID_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
