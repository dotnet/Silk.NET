...
public enum VkSemaphoreType : uint
{
    ...
    VkSemaphoreTypeBinaryKHR = VkSemaphoreTypeBinary,
    ...
    VkSemaphoreTypeTimelineKHR = VkSemaphoreTypeTimeline,

    [NativeName("VK_SEMAPHORE_TYPE_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_2",
    ...
    VkSemaphoreTypeMaxEnum = 0x7FFFFFFF,
}
