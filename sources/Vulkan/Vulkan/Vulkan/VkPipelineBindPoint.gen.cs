...
public enum VkPipelineBindPoint : uint
{
    ...
    VkPipelineBindPointDataGraphARM = 1000507000,
    ...
    VkPipelineBindPointRayTracingNV = VkPipelineBindPointRayTracingKHR,

    [NativeName("VK_PIPELINE_BIND_POINT_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_COMPUTE_VERSION_1_0",
    ...
    VkPipelineBindPointMaxEnum = 0x7FFFFFFF,
}
