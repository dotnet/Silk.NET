...
public enum VkVideoEncodeContentFlagsKHR : uint
{
    ...
    VkVideoEncodeContentCameraBit = 0x00000001,
    ...
    VkVideoEncodeContentDesktopBit = 0x00000002,
    ...
    VkVideoEncodeContentRenderedBit = 0x00000004,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_ENCODE_CONTENT_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_encode_queue"],
        ImpliesSets = [
    ...
    VkVideoEncodeContentFlagBitsMaxEnum = 0x7FFFFFFF,
}
