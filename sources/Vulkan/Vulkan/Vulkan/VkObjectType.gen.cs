...
public enum VkObjectType : uint
{
    ...
    VkObjectTypeVideoSessionKHR = 1000023000,
    ...
    VkObjectTypeVideoSessionParametersKHR = 1000023001,
    ...
    VkObjectTypeOpticalFlowSessionNV = 1000464000,
    ...
    VkObjectTypeShaderEXT = 1000482000,
    ...
    VkObjectTypePipelineBinaryKHR = 1000483000,
    ...
    VkObjectTypeIndirectCommandsLayoutEXT = 1000572000,
    ...
    VkObjectTypeIndirectExecutionSetEXT = 1000572001,

    [NativeName("VK_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_KHR")]
    [NameAffix("Suffix", "KhronosVendor", "KHR")]
    [SupportedApiProfile("vulkan", ["VK_KHR_descriptor_update_template"])]
    VkObjectTypeDescriptorUpdateTemplateKHR = VkObjectTypeDescriptorUpdateTemplate,
    ...
    VkObjectTypeSamplerYcbcrConversionKHR = VkObjectTypeSamplerYcbcrConversion,
    ...
    VkObjectTypePrivateDataSlotEXT = VkObjectTypePrivateDataSlot,

    [NativeName("VK_OBJECT_TYPE_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkObjectTypeMaxEnum = 0x7FFFFFFF,
}
