...
public enum VkDependencyFlags : uint
{
    ...
    VkDependencyDeviceGroupBit = 0x00000004,
    ...
    VkDependencyViewLocalBit = 0x00000002,
    ...
    VkDependencyFeedbackLoopBitEXT = 0x00000008,
    ...
    VkDependencyQueueFamilyOwnershipTransferUseAllStagesBitKHR = 0x00000020,
    ...
    VkDependencyAsymmetricEventBitKHR = 0x00000040,
    ...
    VkDependencyViewLocalBitKHR = VkDependencyViewLocalBit,
    ...
    VkDependencyDeviceGroupBitKHR = VkDependencyDeviceGroupBit,

    [NativeName("VK_DEPENDENCY_FLAG_BITS_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_BASE_VERSION_1_0",
    ...
    VkDependencyFlagBitsMaxEnum = 0x7FFFFFFF,
}
