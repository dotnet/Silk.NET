...
public enum VkPipelineCacheHeaderVersion : uint
{
    ...
    VkPipelineCacheHeaderVersionDataGraphQCOM = 1000629000,

    [NativeName("VK_PIPELINE_CACHE_HEADER_VERSION_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_COMPUTE_VERSION_1_0",
    ...
    VkPipelineCacheHeaderVersionMaxEnum = 0x7FFFFFFF,
}
