...
public enum VkVideoSessionParametersCreateFlagsKHR : uint
{
    ...
    VkVideoSessionParametersCreateQuantizationMapCompatibleBit = 0x00000001,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_SESSION_PARAMETERS_CREATE_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_queue"],
        ImpliesSets = ["VK_VERSION_1_1+VK_KHR_synchronization2", "VK_VERSION_1_3"]
    )]
    VkVideoSessionParametersCreateFlagBitsMaxEnum = 0x7FFFFFFF,
}
