...
public enum VkSamplerReductionMode : uint
{
    ...
    VkSamplerReductionModeWeightedAverageRangeclampQCOM = 1000521000,
    ...
    VkSamplerReductionModeWeightedAverageEXT = VkSamplerReductionModeWeightedAverage,
    ...
    VkSamplerReductionModeMinEXT = VkSamplerReductionModeMin,
    ...
    VkSamplerReductionModeMaxEXT = VkSamplerReductionModeMax,

    [NativeName("VK_SAMPLER_REDUCTION_MODE_MAX_ENUM")]
    [SupportedApiProfile(
        "vulkan",
        [
            "VK_COMPUTE_VERSION_1_2",
    ...
    VkSamplerReductionModeMaxEnum = 0x7FFFFFFF,
}
