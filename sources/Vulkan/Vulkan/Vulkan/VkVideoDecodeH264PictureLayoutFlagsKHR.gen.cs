...
public enum VkVideoDecodeH264PictureLayoutFlagsKHR : uint
{
    ...
    VkVideoDecodeH264PictureLayoutProgressive = 0,
    ...
    VkVideoDecodeH264PictureLayoutInterlacedInterleavedLinesBit = 0x00000001,
    ...
    VkVideoDecodeH264PictureLayoutInterlacedSeparatePlanesBit = 0x00000002,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_VIDEO_DECODE_H264_PICTURE_LAYOUT_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_video_decode_h264"],
        ImpliesSets = ["VK_KHR_video_decode_queue"]
    )]
    VkVideoDecodeH264PictureLayoutFlagBitsMaxEnum = 0x7FFFFFFF,
}
