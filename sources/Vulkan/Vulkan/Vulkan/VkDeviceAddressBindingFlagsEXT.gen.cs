...
public enum VkDeviceAddressBindingFlagsEXT : uint
{
    ...
    VkDeviceAddressBindingInternalObjectBit = 0x00000001,

    [NameAffix("Suffix", "KhronosImpliedVendor", "EXT")]
    [NativeName("VK_DEVICE_ADDRESS_BINDING_FLAG_BITS_MAX_ENUM_EXT")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_EXT_device_address_binding_report"],
        ImpliesSets = [
    ...
    VkDeviceAddressBindingFlagBitsMaxEnum = 0x7FFFFFFF,
}
