...
public enum VkPartitionedAccelerationStructureOpTypeNV : uint
{
    ...
    VkPartitionedAccelerationStructureOpTypeWriteInstance = 0,
    ...
    VkPartitionedAccelerationStructureOpTypeUpdateInstance = 1,
    ...
    VkPartitionedAccelerationStructureOpTypeWritePartitionTranslation = 2,

    [NameAffix("Suffix", "KhronosImpliedVendor", "NV")]
    [NativeName("VK_PARTITIONED_ACCELERATION_STRUCTURE_OP_TYPE_MAX_ENUM_NV")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_NV_partitioned_acceleration_structure"],
        ImpliesSets = ["VK_KHR_acceleration_structure"]
    )]
    VkPartitionedAccelerationStructureOpTypeMaxEnum = 0x7FFFFFFF,
}
