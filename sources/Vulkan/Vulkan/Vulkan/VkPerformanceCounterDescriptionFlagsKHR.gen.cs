...
public enum VkPerformanceCounterDescriptionFlagsKHR : uint
{
    ...
    VkPerformanceCounterDescriptionPerformanceImpactingBit = 0x00000001,
    ...
    VkPerformanceCounterDescriptionConcurrentlyImpactedBit = 0x00000002,

    [NameAffix("Suffix", "KhronosImpliedVendor", "KHR")]
    [NativeName("VK_PERFORMANCE_COUNTER_DESCRIPTION_FLAG_BITS_MAX_ENUM_KHR")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_KHR_performance_query"],
        ImpliesSets = [
    ...
    VkPerformanceCounterDescriptionFlagBitsMaxEnum = 0x7FFFFFFF,
}
