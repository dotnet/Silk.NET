...
public enum VkOpacityMicromapFormatEXT : uint
{
    ...
    VkOpacityMicromapFormat2State = 1,
    ...
    VkOpacityMicromapFormat4State = 2,

    [NameAffix("Suffix", "KhronosImpliedVendor", "EXT")]
    [NativeName("VK_OPACITY_MICROMAP_FORMAT_MAX_ENUM_EXT")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_EXT_opacity_micromap"],
        ImpliesSets = [
    ...
    VkOpacityMicromapFormatMaxEnum = 0x7FFFFFFF,
}
