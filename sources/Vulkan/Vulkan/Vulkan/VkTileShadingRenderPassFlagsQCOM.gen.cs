...
public enum VkTileShadingRenderPassFlagsQCOM : uint
{
    ...
    VkTileShadingRenderPassEnableBit = 0x00000001,
    ...
    VkTileShadingRenderPassPerTileExecutionBit = 0x00000002,

    [NameAffix("Suffix", "KhronosImpliedVendor", "QCOM")]
    [NativeName("VK_TILE_SHADING_RENDER_PASS_FLAG_BITS_MAX_ENUM_QCOM")]
    [SupportedApiProfile(
        "vulkan",
        ["VK_QCOM_tile_shading"],
        ImpliesSets = [
    ...
    VkTileShadingRenderPassFlagBitsMaxEnum = 0x7FFFFFFF,
}
