...
public readonly unsafe partial struct QueueHandle
{
    ...
    public static bool operator ==(QueueHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(QueueHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator QueueHandle(NullPtr _) => default;
}
