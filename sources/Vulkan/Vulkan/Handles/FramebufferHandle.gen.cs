...
public readonly unsafe partial struct FramebufferHandle : IEquatable<FramebufferHandle>
{
    ...
    public static bool operator ==(FramebufferHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(FramebufferHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator FramebufferHandle(NullPtr _) => default;
}
