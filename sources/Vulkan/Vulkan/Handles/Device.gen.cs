...
public readonly unsafe partial struct Device
{
    ...
    public static bool operator ==(Device left, NullPtr right) => left.Equals(right);

    public static bool operator !=(Device left, NullPtr right) => !left.Equals(right);

    public static implicit operator Device(NullPtr _) => default;
}
