...
[NameSuffix("Handle", 0)]
[NativeName("VkImageHandle")]
public readonly unsafe partial struct ImageHandle
{
    ...
    public static bool operator ==(ImageHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(ImageHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator ImageHandle(NullPtr _) => default;
}
