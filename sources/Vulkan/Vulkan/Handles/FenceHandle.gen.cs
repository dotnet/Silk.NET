...
public readonly unsafe partial struct FenceHandle
{
    ...
    public static bool operator ==(FenceHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(FenceHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator FenceHandle(NullPtr _) => default;
}
