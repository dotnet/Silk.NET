...
[NameSuffix("Handle", 0)]
[NativeName("VkPipelineHandle")]
public readonly unsafe partial struct PipelineHandle
{
    public readonly void* Handle;

    public PipelineHandle(void* handle)
    {
        Handle = handle;
    }
    ...
    public static bool operator ==(PipelineHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(PipelineHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator PipelineHandle(NullPtr _) => default;
}
