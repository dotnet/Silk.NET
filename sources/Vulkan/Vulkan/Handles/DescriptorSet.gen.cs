...
[NameSuffix("Handle", 0)]
[NativeName("VkDescriptorSet_T")]
public readonly unsafe partial struct DescriptorSet
{
    public readonly void* Handle;

    public DescriptorSet(void* handle)
    {
        Handle = handle;
    }
    ...
    public static bool operator ==(DescriptorSet left, NullPtr right) => left.Equals(right);

    public static bool operator !=(DescriptorSet left, NullPtr right) => !left.Equals(right);

    public static implicit operator DescriptorSet(NullPtr _) => default;
}
