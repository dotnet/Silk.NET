...
public readonly unsafe partial struct ShaderModuleHandle
{
    ...
    public static bool operator ==(ShaderModuleHandle left, ShaderModuleHandle right) =>
        left.Equals(right);
    ...
    public static bool operator ==(ShaderModuleHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(ShaderModuleHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator ShaderModuleHandle(NullPtr _) => default;
}
