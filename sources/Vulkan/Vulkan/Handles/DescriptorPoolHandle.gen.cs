...
[NativeName("VkDescriptorPool")]
public readonly unsafe partial struct DescriptorPoolHandle : IEquatable<DescriptorPoolHandle>
{
    public readonly void* Handle;

    public DescriptorPoolHandle(void* handle)
    {
        Handle = handle;
    }
