...
[NameSuffix("Handle", 0)]
[NativeName("VkBufferHandle")]
public readonly unsafe partial struct BufferHandle
{
    public readonly void* Handle;

    public BufferHandle(void* handle)
    {
        Handle = handle;
    }
    ...
    public static bool operator ==(BufferHandle left, NullPtr right) => left.Equals(right);

    public static bool operator !=(BufferHandle left, NullPtr right) => !left.Equals(right);

    public static implicit operator BufferHandle(NullPtr _) => default;
}
