...
public static partial class HIDP
{
    ...
    public const int HIDP_STATUS_INVALID_PREPARSED_DATA = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (1)))
    );

    [NativeTypeName("#define HIDP_STATUS_INVALID_REPORT_TYPE (HIDP_ERROR_CODES(0xC,2))")]
    public const int HIDP_STATUS_INVALID_REPORT_TYPE = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (2)))
    );

    [NativeTypeName("#define HIDP_STATUS_INVALID_REPORT_LENGTH (HIDP_ERROR_CODES(0xC,3))")]
    public const int HIDP_STATUS_INVALID_REPORT_LENGTH = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (3)))
    );
    ...
    public const int HIDP_STATUS_I8042_TRANS_UNKNOWN = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (9)))
    );

    [NativeTypeName("#define HIDP_STATUS_INCOMPATIBLE_REPORT_ID (HIDP_ERROR_CODES(0xC,0xA))")]
    public const int HIDP_STATUS_INCOMPATIBLE_REPORT_ID = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (0xA)))
    );
    ...
    public const int HIDP_STATUS_DATA_INDEX_NOT_FOUND = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (0xD)))
    );

    [NativeTypeName("#define HIDP_STATUS_DATA_INDEX_OUT_OF_RANGE (HIDP_ERROR_CODES(0xC,0xE))")]
    public const int HIDP_STATUS_DATA_INDEX_OUT_OF_RANGE = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (0xE)))
    );

    [NativeTypeName("#define HIDP_STATUS_BUTTON_NOT_PRESSED (HIDP_ERROR_CODES(0xC,0xF))")]
    public const int HIDP_STATUS_BUTTON_NOT_PRESSED = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (0xF)))
    );

    [NativeTypeName("#define HIDP_STATUS_REPORT_DOES_NOT_EXIST (HIDP_ERROR_CODES(0xC,0x10))")]
    public const int HIDP_STATUS_REPORT_DOES_NOT_EXIST = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (0x10)))
    );
    ...
    public const int HIDP_STATUS_NOT_BUTTON_ARRAY = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (0x21)))
    );

    [NativeTypeName("#define HIDP_STATUS_I8242_TRANS_UNKNOWN HIDP_STATUS_I8042_TRANS_UNKNOWN")]
    public const int HIDP_STATUS_I8242_TRANS_UNKNOWN = (
        ((int)(((0xC) << 28) | (0x11 << 16) | (9)))
    );
}
