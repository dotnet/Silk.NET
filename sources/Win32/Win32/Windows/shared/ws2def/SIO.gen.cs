...
public static partial class SIO
{
    ...
    public const uint SIO_GET_EXTENSION_FUNCTION_POINTER = (
    ...
    public const uint SIO_ROUTING_INTERFACE_QUERY = (
        (0x80000000 | 0x40000000) | (0x08000000) | (20)
    );
    ...
    public const uint SIO_GET_MULTIPLE_EXTENSION_FUNCTION_POINTER = (
        (0x80000000 | 0x40000000) | (0x08000000) | (36)
    );
}
