...
public static partial class E
{
    ...
    public const int E_BLUETOOTH_ATT_INSUFFICIENT_ENCRYPTION_KEY_SIZE = unchecked(
        (int)(0x8065000C)
    );
    ...
    public const int E_SKYDRIVE_ROOT_TARGET_FILE_SYSTEM_NOT_SUPPORTED = unchecked(
        (int)(0x80270260)
    );
    ...
    public const int E_SKYDRIVE_ROOT_TARGET_VOLUME_ROOT_NOT_SUPPORTED = unchecked(
        (int)(0x80270265)
    );
    ...
    public const int E_SYNCENGINE_REQUEST_BLOCKED_DUE_TO_CLIENT_ERROR = unchecked(
        (int)(0x8802C007)
    );
    ...
    public const int E_SYNCENGINE_STORAGE_SERVICE_PROVISIONING_FAILED = unchecked(
        (int)(0x8802D008)
    );
