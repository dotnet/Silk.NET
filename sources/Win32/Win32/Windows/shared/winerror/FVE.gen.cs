...
public static partial class FVE
{
    ...
    public const int FVE_E_POLICY_USER_CONFIGURE_FDV_AUTOUNLOCK_NOT_ALLOWED = unchecked(
        (int)(0x80310075)
    );
    ...
    public const int FVE_E_POLICY_USER_CONFIGURE_RDV_AUTOUNLOCK_NOT_ALLOWED = unchecked(
        (int)(0x80310076)
    );
    ...
    public const int FVE_E_POLICY_CONFLICT_RO_AND_STARTUP_KEY_REQUIRED = unchecked(
        (int)(0x80310087)
    );
    ...
    public const int FVE_E_PIN_PROTECTOR_CHANGE_BY_STD_USER_DISALLOWED = unchecked(
        (int)(0x803100A2)
    );
    ...
    public const int FVE_E_PROTECTOR_CHANGE_MAX_PIN_CHANGE_ATTEMPTS_REACHED = unchecked(
        (int)(0x803100A3)
    );
    ...
    public const int FVE_E_POLICY_REQUIRES_STARTUP_PIN_ON_TOUCH_DEVICE = unchecked(
        (int)(0x803100B7)
    );
    ...
    public const int FVE_E_POLICY_REQUIRES_RECOVERY_PASSWORD_ON_TOUCH_DEVICE = unchecked(
        (int)(0x803100B8)
    );
    ...
    public const int FVE_E_PROTECTOR_CHANGE_MAX_PASSPHRASE_CHANGE_ATTEMPTS_REACHED = unchecked(
        (int)(0x803100C0)
    );
    ...
    public const int FVE_E_PASSPHRASE_PROTECTOR_CHANGE_BY_STD_USER_DISALLOWED = unchecked(
        (int)(0x803100C1)
    );
    ...
    public const int FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_OS_DRIVE = unchecked(
        (int)(0x803100DA)
    );
    ...
    public const int FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_FIXED_DRIVE = unchecked(
        (int)(0x803100DB)
    );
    ...
    public const int FVE_E_AD_BACKUP_REQUIRED_POLICY_NOT_SET_REMOVABLE_DRIVE = unchecked(
        (int)(0x803100DC)
    );
