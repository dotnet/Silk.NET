...
public static partial class COMADMIN
{
    ...
    public const int COMADMIN_E_LEGACYCOMPS_NOT_ALLOWED_IN_1_0_FORMAT = unchecked(
        (int)(0x8011081A)
    );
    ...
    public const int COMADMIN_E_LEGACYCOMPS_NOT_ALLOWED_IN_NONBASE_PARTITIONS = unchecked(
        (int)(0x8011081B)
    );
