...
public static partial class EAS
{
    ...
    public const int EAS_E_REQUESTED_POLICY_PASSWORD_EXPIRATION_INCOMPATIBLE = unchecked(
        (int)(0x80550005)
    );
    ...
    public const int EAS_E_LOCAL_CONTROLLED_USERS_CANNOT_CHANGE_PASSWORD = unchecked(
        (int)(0x80550009)
    );
    ...
    public const int EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CONNECTED_ADMINS = unchecked(
        (int)(0x8055000A)
    );
    ...
    public const int EAS_E_PASSWORD_POLICY_NOT_ENFORCEABLE_FOR_CURRENT_CONNECTED_USER = unchecked(
        (int)(0x8055000C)
    );
    ...
    public const int EAS_E_CURRENT_CONNECTED_USER_NEED_TO_CHANGE_PASSWORD = unchecked(
        (int)(0x8055000D)
    );
}
