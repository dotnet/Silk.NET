        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ISpatialAudioObjectForMetadataItems));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<ISpatialAudioObjectForMetadataItems, Guid*, void**, int>)(
                (*lpVtbl)[0]
            )
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ISpatialAudioObjectForMetadataItems, uint>)((*lpVtbl)[1]))(
            this
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ISpatialAudioObjectForMetadataItems, uint>)((*lpVtbl)[2]))(
            this
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ISpatialAudioObjectForMetadataItems, byte**, uint*, int>)(
                (*lpVtbl)[3]
            )
    ...
    {
        return (
            (delegate* unmanaged<ISpatialAudioObjectForMetadataItems, uint, int>)((*lpVtbl)[4])
        )(this, frameCount);
    }
    ...
    {
        return (
            (delegate* unmanaged<ISpatialAudioObjectForMetadataItems, BOOL*, int>)((*lpVtbl)[5])
        )(this, isActive);
    }
    ...
    {
        return (
            (delegate* unmanaged<ISpatialAudioObjectForMetadataItems, AudioObjectType*, int>)(
                (*lpVtbl)[6]
            )
    ...
    /// <summary>Initializes a new instance of the <see cref = "ISpatialAudioObjectForMetadataItems"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ISpatialAudioObjectForMetadataItems(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.ISpatialAudioObjectBase"/> to <see cref = "ISpatialAudioObjectForMetadataItems"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.ISpatialAudioObjectBase"/> instance to be converted </param>
    public static explicit operator ISpatialAudioObjectForMetadataItems(
        Silk.NET.Windows.ISpatialAudioObjectBase value
    )
    {
        return new ISpatialAudioObjectForMetadataItems(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ISpatialAudioObjectForMetadataItems"/> to <see cref = "Silk.NET.Windows.ISpatialAudioObjectBase"/>.</summary>
    /// <param name = "value">The <see cref = "ISpatialAudioObjectForMetadataItems"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.ISpatialAudioObjectBase(
        ISpatialAudioObjectForMetadataItems value
    )
    {
        return new Silk.NET.Windows.ISpatialAudioObjectBase(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ISpatialAudioObjectForMetadataItems"/>.</summary>
    ...
    /// <summary>Upcasts <see cref = "ISpatialAudioObjectForMetadataItems"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ISpatialAudioObjectForMetadataItems"/> instance to be converted </param>
