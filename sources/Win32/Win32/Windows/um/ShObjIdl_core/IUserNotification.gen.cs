...
public unsafe partial struct IUserNotification : IUserNotification.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IUserNotification));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<IUserNotification, ushort*, ushort*, uint, int>)((*lpVtbl)[3])
    ...
    {
        return ((delegate* unmanaged<IUserNotification, uint, uint, uint, int>)((*lpVtbl)[4]))(
            this,
            dwShowTime,
            dwInterval,
            cRetryCount
    ...
    {
        return ((delegate* unmanaged<IUserNotification, HICON, ushort*, int>)((*lpVtbl)[5]))(
            this,
            hIcon,
            pszToolTip
        );
    ...
    {
        return ((delegate* unmanaged<IUserNotification, IQueryContinue, uint, int>)((*lpVtbl)[6]))(
            this,
            pqc,
    ...
    {
        return ((delegate* unmanaged<IUserNotification, ushort*, int>)((*lpVtbl)[7]))(
            this,
            pszSoundName
        );
    }
