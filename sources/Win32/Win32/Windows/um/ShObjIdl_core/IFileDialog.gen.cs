...
public unsafe partial struct IFileDialog : IFileDialog.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IFileDialog));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IFileDialog, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IFileDialog, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IFileDialog, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, HWND, int>)((*lpVtbl)[3]))(this, hwndOwner);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, uint, COMDLG_FILTERSPEC*, int>)((*lpVtbl)[4]))(
            this,
            cFileTypes,
            rgFilterSpec
        );
    ...
    {
        return ((delegate* unmanaged<IFileDialog, uint, int>)((*lpVtbl)[5]))(this, iFileType);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, uint*, int>)((*lpVtbl)[6]))(this, piFileType);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IFileDialogEvents, uint*, int>)((*lpVtbl)[7]))(
            this,
            pfde,
            pdwCookie
        );
    ...
    {
        return ((delegate* unmanaged<IFileDialog, uint, int>)((*lpVtbl)[8]))(this, dwCookie);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, uint, int>)((*lpVtbl)[9]))(this, fos);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, uint*, int>)((*lpVtbl)[10]))(this, pfos);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItem, int>)((*lpVtbl)[11]))(this, psi);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItem, int>)((*lpVtbl)[12]))(this, psi);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItem*, int>)((*lpVtbl)[13]))(this, ppsi);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItem*, int>)((*lpVtbl)[14]))(this, ppsi);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, ushort*, int>)((*lpVtbl)[15]))(this, pszName);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, ushort**, int>)((*lpVtbl)[16]))(this, pszName);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, ushort*, int>)((*lpVtbl)[17]))(this, pszTitle);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, ushort*, int>)((*lpVtbl)[18]))(this, pszText);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, ushort*, int>)((*lpVtbl)[19]))(this, pszLabel);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItem*, int>)((*lpVtbl)[20]))(this, ppsi);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItem, FDAP, int>)((*lpVtbl)[21]))(
            this,
            psi,
            fdap
        );
    ...
    {
        return ((delegate* unmanaged<IFileDialog, ushort*, int>)((*lpVtbl)[22]))(
            this,
            pszDefaultExtension
        );
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, HRESULT, int>)((*lpVtbl)[23]))(this, hr);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, Guid*, int>)((*lpVtbl)[24]))(this, guid);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, int>)((*lpVtbl)[25]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IFileDialog, IShellItemFilter, int>)((*lpVtbl)[26]))(
            this,
            pFilter
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IFileDialog"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IFileDialog(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IModalWindow"/> to <see cref = "IFileDialog"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IModalWindow"/> instance to be converted </param>
    public static explicit operator IFileDialog(Silk.NET.Windows.IModalWindow value)
    {
        return new IFileDialog(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFileDialog"/> to <see cref = "Silk.NET.Windows.IModalWindow"/>.</summary>
    /// <param name = "value">The <see cref = "IFileDialog"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IModalWindow(IFileDialog value)
    {
        return new Silk.NET.Windows.IModalWindow(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IFileDialog"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IFileDialog(Silk.NET.Windows.IUnknown value)
    {
        return new IFileDialog(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFileDialog"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IFileDialog"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IFileDialog value)
    {
