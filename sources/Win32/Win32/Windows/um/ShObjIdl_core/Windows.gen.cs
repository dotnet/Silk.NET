...
public static unsafe partial class Windows
{
    ...
    public static extern ITEMIDLIST* SHSimpleIDListFromPath(
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHCreateItemFromRelativeName(
    ...
    public static extern HRESULT SHCreateItemInKnownFolder(
        [NativeTypeName("const KNOWNFOLDERID &")] Guid* kfid,
        [NativeTypeName("DWORD")] uint dwKFFlags,
        [NativeTypeName("PCWSTR")] ushort* pszItem,
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHGetIDListFromObject(
        IUnknown punk,
        [NativeTypeName("LPITEMIDLIST *")] ITEMIDLIST** ppidl
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHGetItemFromObject(
        IUnknown punk,
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    );
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHGetPropertyStoreFromIDList(
        [NativeTypeName("LPCITEMIDLIST")] ITEMIDLIST* pidl,
    ...
    public static extern HRESULT SHGetNameFromIDList(
        [NativeTypeName("LPCITEMIDLIST")] ITEMIDLIST* pidl,
        SIGDN sigdnName,
        [NativeTypeName("PWSTR *")] ushort** ppszName
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHGetItemFromDataObject(
        IDataObject pdtobj,
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHCreateShellItemArray(
        [NativeTypeName("LPCITEMIDLIST")] ITEMIDLIST* pidlParent,
        IShellFolder psf,
        uint cidl,
        [NativeTypeName("LPCITEMIDLIST *")] ITEMIDLIST** ppidl,
        IShellItemArray* ppsiItemArray
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHCreateShellItemArrayFromDataObject(
        IDataObject pdo,
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    );
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHCreateShellItemArrayFromIDLists(
        uint cidl,
        [NativeTypeName("LPCITEMIDLIST *")] ITEMIDLIST** rgpidl,
        IShellItemArray* ppsiItemArray
    );
    ...
    public static void FreeIDListArray(
        [NativeTypeName("LPITEMIDLIST *")] ITEMIDLIST** ppidls,
        uint cItems
    )
    {
        uint i;
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHCreateAssociationRegistration(
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    );
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHCreateDefaultExtractIcon(
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    );
    ...
    public static extern HRESULT SetCurrentProcessExplicitAppUserModelID(
        [NativeTypeName("PCWSTR")] ushort* AppID
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT GetCurrentProcessExplicitAppUserModelID(
        [NativeTypeName("PWSTR *")] ushort** AppID
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHGetTemporaryPropertyForItem(
        IShellItem psi,
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHSetTemporaryPropertyForItem(
        IShellItem psi,
        [NativeTypeName("const PROPERTYKEY &")] PROPERTYKEY* propkey,
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHShowManageLibraryUI(
        IShellItem psiLibrary,
        HWND hwndOwner,
        [NativeTypeName("LPCWSTR")] ushort* pszTitle,
        [NativeTypeName("LPCWSTR")] ushort* pszInstruction,
    ...
    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHAssocEnumHandlers(
        [NativeTypeName("PCWSTR")] ushort* pszExtra,
        ASSOC_FILTER afFilter,
        IEnumAssocHandlers* ppEnumHandler
    );

    [DllImport("shell32", ExactSpelling = true)]
    public static extern HRESULT SHAssocEnumHandlersForProtocolByApplication(
        [NativeTypeName("PCWSTR")] ushort* protocol,
        [NativeTypeName("const IID &")] Guid* riid,
        void** enumHandlers
    );
