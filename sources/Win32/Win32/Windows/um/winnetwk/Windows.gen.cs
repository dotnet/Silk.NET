...
public static unsafe partial class Windows
{
    ...
    public static extern uint WNetAddConnectionA(
        [NativeTypeName("LPCSTR")] sbyte* lpRemoteName,
        [NativeTypeName("LPCSTR")] sbyte* lpPassword,
        [NativeTypeName("LPCSTR")] sbyte* lpLocalName
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetAddConnectionW(
        [NativeTypeName("LPCWSTR")] ushort* lpRemoteName,
        [NativeTypeName("LPCWSTR")] ushort* lpPassword,
        [NativeTypeName("LPCWSTR")] ushort* lpLocalName
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetAddConnection2A(
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPCSTR")] sbyte* lpPassword,
        [NativeTypeName("LPCSTR")] sbyte* lpUserName,
    ...
    public static extern uint WNetAddConnection2W(
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("LPCWSTR")] ushort* lpPassword,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetAddConnection3A(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPCSTR")] sbyte* lpPassword,
        [NativeTypeName("LPCSTR")] sbyte* lpUserName,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetAddConnection3W(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("LPCWSTR")] ushort* lpPassword,
        [NativeTypeName("LPCWSTR")] ushort* lpUserName,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetAddConnection4A(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("PVOID")] void* pAuthBuffer,
        [NativeTypeName("DWORD")] uint cbAuthBuffer,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("PBYTE")] byte* lpUseOptions,
        [NativeTypeName("DWORD")] uint cbUseOptions
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetAddConnection4W(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("PVOID")] void* pAuthBuffer,
        [NativeTypeName("DWORD")] uint cbAuthBuffer,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetCancelConnectionA(
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetCancelConnectionW(
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetCancelConnection2W(
        [NativeTypeName("LPCWSTR")] ushort* lpName,
        [NativeTypeName("DWORD")] uint dwFlags,
        BOOL fForce
    );
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetConnectionA(
        [NativeTypeName("LPCSTR")] sbyte* lpLocalName,
        [NativeTypeName("LPSTR")] sbyte* lpRemoteName,
        [NativeTypeName("LPDWORD")] uint* lpnLength
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetConnectionW(
        [NativeTypeName("LPCWSTR")] ushort* lpLocalName,
        [NativeTypeName("LPWSTR")] ushort* lpRemoteName,
        [NativeTypeName("LPDWORD")] uint* lpnLength
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetRestoreSingleConnectionW(
        HWND hwndParent,
        [NativeTypeName("LPCWSTR")] ushort* lpDevice,
        BOOL fUseUI
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetUseConnectionA(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPCSTR")] sbyte* lpPassword,
        [NativeTypeName("LPCSTR")] sbyte* lpUserId,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("LPSTR")] sbyte* lpAccessName,
        [NativeTypeName("LPDWORD")] uint* lpBufferSize,
        [NativeTypeName("LPDWORD")] uint* lpResult
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetUseConnectionW(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("LPCWSTR")] ushort* lpPassword,
        [NativeTypeName("LPCWSTR")] ushort* lpUserId,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("LPWSTR")] ushort* lpAccessName,
        [NativeTypeName("LPDWORD")] uint* lpBufferSize,
        [NativeTypeName("LPDWORD")] uint* lpResult
    );
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetUseConnection4W(
        HWND hwndOwner,
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("PVOID")] void* pAuthBuffer,
        [NativeTypeName("DWORD")] uint cbAuthBuffer,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetConnectionDialog(
        HWND hwnd,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetDisconnectDialog(
        HWND hwnd,
        [NativeTypeName("DWORD")] uint dwType
    );
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetConnectionDialog1A(
        [NativeTypeName("LPCONNECTDLGSTRUCTA")] CONNECTDLGSTRUCTA* lpConnDlgStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetConnectionDialog1W(
        [NativeTypeName("LPCONNECTDLGSTRUCTW")] CONNECTDLGSTRUCTW* lpConnDlgStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetDisconnectDialog1A(
        [NativeTypeName("LPDISCDLGSTRUCTA")] DISCDLGSTRUCTA* lpConnDlgStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetDisconnectDialog1W(
        [NativeTypeName("LPDISCDLGSTRUCTW")] DISCDLGSTRUCTW* lpConnDlgStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetOpenEnumA(
        [NativeTypeName("DWORD")] uint dwScope,
        [NativeTypeName("DWORD")] uint dwType,
        [NativeTypeName("DWORD")] uint dwUsage,
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPHANDLE")] HANDLE* lphEnum
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetOpenEnumW(
        [NativeTypeName("DWORD")] uint dwScope,
        [NativeTypeName("DWORD")] uint dwType,
        [NativeTypeName("DWORD")] uint dwUsage,
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetEnumResourceA(
        HANDLE hEnum,
        [NativeTypeName("LPDWORD")] uint* lpcCount,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetEnumResourceW(
        HANDLE hEnum,
        [NativeTypeName("LPDWORD")] uint* lpcCount,
        [NativeTypeName("LPVOID")] void* lpBuffer,
        [NativeTypeName("LPDWORD")] uint* lpBufferSize
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetResourceParentA(
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPVOID")] void* lpBuffer,
        [NativeTypeName("LPDWORD")] uint* lpcbBuffer
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetResourceParentW(
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("LPVOID")] void* lpBuffer,
        [NativeTypeName("LPDWORD")] uint* lpcbBuffer
    );
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetResourceInformationA(
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPVOID")] void* lpBuffer,
        [NativeTypeName("LPDWORD")] uint* lpcbBuffer,
        [NativeTypeName("LPSTR *")] sbyte** lplpSystem
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetResourceInformationW(
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("LPVOID")] void* lpBuffer,
        [NativeTypeName("LPDWORD")] uint* lpcbBuffer,
        [NativeTypeName("LPWSTR *")] ushort** lplpSystem
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetUniversalNameA(
        [NativeTypeName("LPCSTR")] sbyte* lpLocalPath,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetUniversalNameW(
        [NativeTypeName("LPCWSTR")] ushort* lpLocalPath,
        [NativeTypeName("DWORD")] uint dwInfoLevel,
        [NativeTypeName("LPVOID")] void* lpBuffer,
        [NativeTypeName("LPDWORD")] uint* lpBufferSize
    );
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetUserA(
        [NativeTypeName("LPCSTR")] sbyte* lpName,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetUserW(
        [NativeTypeName("LPCWSTR")] ushort* lpName,
        [NativeTypeName("LPWSTR")] ushort* lpUserName,
        [NativeTypeName("LPDWORD")] uint* lpnLength
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetProviderNameA(
        [NativeTypeName("DWORD")] uint dwNetType,
        [NativeTypeName("LPSTR")] sbyte* lpProviderName,
        [NativeTypeName("LPDWORD")] uint* lpBufferSize
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetProviderNameW(
        [NativeTypeName("DWORD")] uint dwNetType,
        [NativeTypeName("LPWSTR")] ushort* lpProviderName,
        [NativeTypeName("LPDWORD")] uint* lpBufferSize
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetNetworkInformationA(
        [NativeTypeName("LPCSTR")] sbyte* lpProvider,
        [NativeTypeName("LPNETINFOSTRUCT")] NETINFOSTRUCT* lpNetInfoStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetNetworkInformationW(
        [NativeTypeName("LPCWSTR")] ushort* lpProvider,
        [NativeTypeName("LPNETINFOSTRUCT")] NETINFOSTRUCT* lpNetInfoStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetLastErrorA(
        [NativeTypeName("LPDWORD")] uint* lpError,
        [NativeTypeName("LPSTR")] sbyte* lpErrorBuf,
        [NativeTypeName("DWORD")] uint nErrorBufSize,
        [NativeTypeName("LPSTR")] sbyte* lpNameBuf,
        [NativeTypeName("DWORD")] uint nNameBufSize
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint WNetGetLastErrorW(
        [NativeTypeName("LPDWORD")] uint* lpError,
        [NativeTypeName("LPWSTR")] ushort* lpErrorBuf,
        [NativeTypeName("DWORD")] uint nErrorBufSize,
    ...
    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint MultinetGetConnectionPerformanceA(
        [NativeTypeName("LPNETRESOURCEA")] NETRESOURCEA* lpNetResource,
        [NativeTypeName("LPNETCONNECTINFOSTRUCT")] NETCONNECTINFOSTRUCT* lpNetConnectInfoStruct
    );

    [DllImport("mpr", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint MultinetGetConnectionPerformanceW(
        [NativeTypeName("LPNETRESOURCEW")] NETRESOURCEW* lpNetResource,
        [NativeTypeName("LPNETCONNECTINFOSTRUCT")] NETCONNECTINFOSTRUCT* lpNetConnectInfoStruct
    );
    ...
    public static delegate* <ushort*, ushort*, ushort*, uint> WNetAddConnection =>
        &WNetAddConnectionW;

    [NativeTypeName("#define WNetAddConnection2 WNetAddConnection2W")]
    public static delegate* <NETRESOURCEW*, ushort*, ushort*, uint, uint> WNetAddConnection2 =>
        &WNetAddConnection2W;
    ...
    public static delegate* <
        ...
        ushort*,
        uint,
        uint> WNetAddConnection3 => &WNetAddConnection3W;
    ...
    public static delegate* <
        ...
        byte*,
        uint,
        uint> WNetAddConnection4 => &WNetAddConnection4W;
    ...
    public static delegate* <ushort*, uint, BOOL, uint> WNetCancelConnection2 =>
        &WNetCancelConnection2W;

    [NativeTypeName("#define WNetGetConnection WNetGetConnectionW")]
    public static delegate* <ushort*, ushort*, uint*, uint> WNetGetConnection =>
        &WNetGetConnectionW;
    ...
    public static delegate* <
        ...
        uint*,
        uint*,
        uint> WNetUseConnection => &WNetUseConnectionW;
    ...
    public static delegate* <
        ...
        uint*,
        uint*,
        uint> WNetUseConnection4 => &WNetUseConnection4W;
    ...
    public static delegate* <CONNECTDLGSTRUCTW*, uint> WNetConnectionDialog1 =>
    ...
    public static delegate* <DISCDLGSTRUCTW*, uint> WNetDisconnectDialog1 =>
        &WNetDisconnectDialog1W;

    [NativeTypeName("#define WNetOpenEnum WNetOpenEnumW")]
    public static delegate* <uint, uint, uint, NETRESOURCEW*, HANDLE*, uint> WNetOpenEnum =>
        &WNetOpenEnumW;

    [NativeTypeName("#define WNetEnumResource WNetEnumResourceW")]
    public static delegate* <HANDLE, uint*, void*, uint*, uint> WNetEnumResource =>
        &WNetEnumResourceW;

    [NativeTypeName("#define WNetGetResourceParent WNetGetResourceParentW")]
    public static delegate* <NETRESOURCEW*, void*, uint*, uint> WNetGetResourceParent =>
    ...
    public static delegate* <
        ...
        uint*,
        ushort**,
        uint> WNetGetResourceInformation => &WNetGetResourceInformationW;
    ...
    public static delegate* <ushort*, uint, void*, uint*, uint> WNetGetUniversalName =>
    ...
    public static delegate* <uint, ushort*, uint*, uint> WNetGetProviderName =>
    ...
    public static delegate* <ushort*, NETINFOSTRUCT*, uint> WNetGetNetworkInformation =>
        &WNetGetNetworkInformationW;

    [NativeTypeName("#define WNetGetLastError WNetGetLastErrorW")]
    public static delegate* <uint*, ushort*, uint, ushort*, uint, uint> WNetGetLastError =>
        &WNetGetLastErrorW;
    ...
    public static delegate* <
        ...
        uint> MultinetGetConnectionPerformance => &MultinetGetConnectionPerformanceW;
}
