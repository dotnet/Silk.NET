...
public unsafe partial struct ITfRange : ITfRange.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ITfRange));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ITfRange, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ITfRange, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ITfRange, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<ITfRange, uint, uint, ushort*, uint, uint*, int>)((*lpVtbl)[3])
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, uint, ushort*, int, int>)((*lpVtbl)[4]))(
            this,
            ec,
            dwFlags,
            pchText,
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, IDataObject*, int>)((*lpVtbl)[5]))(
            this,
            ec,
            ppDataObject
        );
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, Guid*, Guid*, IUnknown*, int>)((*lpVtbl)[6]))(
            this,
            ec,
            rguidService,
            riid,
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, uint, IDataObject, int>)((*lpVtbl)[7]))(
            this,
            ec,
            dwFlags,
            pDataObject
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, int, int*, TF_HALTCOND*, int>)((*lpVtbl)[8]))(
            this,
            ec,
            cchReq,
            pcch,
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, int, int*, TF_HALTCOND*, int>)((*lpVtbl)[9]))(
            this,
            ec,
            cchReq,
            pcch,
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, ITfRange, TfAnchor, int>)((*lpVtbl)[10]))(
            this,
            ec,
            pRange,
            aPos
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, ITfRange, TfAnchor, int>)((*lpVtbl)[11]))(
            this,
            ec,
            pRange,
            aPos
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, TfShiftDir, BOOL*, int>)((*lpVtbl)[12]))(
            this,
            ec,
            dir,
            pfNoRegion
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, TfShiftDir, BOOL*, int>)((*lpVtbl)[13]))(
            this,
            ec,
            dir,
            pfNoRegion
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, BOOL*, int>)((*lpVtbl)[14]))(
            this,
            ec,
            pfEmpty
        );
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, TfAnchor, int>)((*lpVtbl)[15]))(
            this,
            ec,
            aPos
        );
    ...
    {
        return (
            (delegate* unmanaged<ITfRange, uint, ITfRange, TfAnchor, BOOL*, int>)((*lpVtbl)[16])
    ...
    {
        return (
            (delegate* unmanaged<ITfRange, uint, ITfRange, TfAnchor, BOOL*, int>)((*lpVtbl)[17])
        )(this, ec, pWith, aPos, pfEqual);
    }
    ...
    {
        return (
            (delegate* unmanaged<ITfRange, uint, ITfRange, TfAnchor, int*, int>)((*lpVtbl)[18])
    ...
    {
        return (
            (delegate* unmanaged<ITfRange, uint, ITfRange, TfAnchor, int*, int>)((*lpVtbl)[19])
        )(this, ec, pWith, aPos, plResult);
    }
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, uint, BOOL*, int>)((*lpVtbl)[20]))(
            this,
            ec,
            cchInsert,
            pfInsertOk
    ...
    {
        return ((delegate* unmanaged<ITfRange, TfGravity*, TfGravity*, int>)((*lpVtbl)[21]))(
            this,
            pgStart,
            pgEnd
        );
    ...
    {
        return ((delegate* unmanaged<ITfRange, uint, TfGravity, TfGravity, int>)((*lpVtbl)[22]))(
            this,
            ec,
            gStart,
            gEnd
    ...
    {
        return ((delegate* unmanaged<ITfRange, ITfRange*, int>)((*lpVtbl)[23]))(this, ppClone);
    }
    ...
    {
        return ((delegate* unmanaged<ITfRange, ITfContext*, int>)((*lpVtbl)[24]))(this, ppContext);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ITfRange"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ITfRange(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ITfRange"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ITfRange(Silk.NET.Windows.IUnknown value)
    {
        return new ITfRange(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ITfRange"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ITfRange"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ITfRange value)
    {
