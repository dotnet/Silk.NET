...
public static unsafe partial class Windows
{
    ...
    public static void* DeviceDsmParameterBlock(
        [NativeTypeName("PDEVICE_DSM_INPUT")] DEVICE_MANAGE_DATA_SET_ATTRIBUTES* Input
    )
    {
    ...
    public static DEVICE_DATA_SET_RANGE* DeviceDsmDataSetRanges(
        [NativeTypeName("PDEVICE_DSM_INPUT")] DEVICE_MANAGE_DATA_SET_ATTRIBUTES* Input
    )
    {
    ...
    public static void DeviceDsmInitializeInput(
        [NativeTypeName("PDEVICE_DSM_DEFINITION")] DEVICE_DSM_DEFINITION* Definition,
        [NativeTypeName("PDEVICE_DSM_INPUT")] DEVICE_MANAGE_DATA_SET_ATTRIBUTES* Input,
        [NativeTypeName("DWORD")] uint InputLength,
        [NativeTypeName("DWORD")] uint Flags,
        [NativeTypeName("PVOID")] void* Parameters,
        [NativeTypeName("DWORD")] uint ParameterBlockLength
    )
    {
        uint Bytes = 28;
        ...
        unchecked(Bytes) = unchecked(
            ((Bytes) + ((Definition->ParameterBlockAlignment) - 1))
    ...
    public static byte DeviceDsmValidateInput(
        [NativeTypeName("PDEVICE_DSM_DEFINITION")] DEVICE_DSM_DEFINITION* Definition,
        [NativeTypeName("PDEVICE_DSM_INPUT")] DEVICE_MANAGE_DATA_SET_ATTRIBUTES* Input,
        [NativeTypeName("DWORD")] uint InputLength
    )
    {
        ...
        if (Definition->ParameterBlockLength != 0)
        {
            ...
            Max = InputLength;
            if (
                Input->ParameterBlockOffset < Min
                || Input->ParameterBlockOffset > Max
                || (Input->ParameterBlockOffset % Definition->ParameterBlockAlignment) != 0
            )
            {
                goto Cleanup;
            }
        ...
        if ((Input->Flags & 0x00000001) == 0)
        {
            ...
            Max = InputLength;
            if (
                Input->DataSetRangesOffset < Min
                || Input->DataSetRangesOffset > Max
                || (Input->DataSetRangesOffset % 8) != 0
            )
            {
                goto Cleanup;
            }
            ...
            if (
                ...
                || (Input->DataSetRangesLength % Min) != 0
            )
            {
                goto Cleanup;
            }
        ...
        if (
            Input->ParameterBlockOffset < Input->DataSetRangesOffset
            && Input->ParameterBlockOffset + Input->ParameterBlockLength
        ...
        if (
            Input->DataSetRangesOffset < Input->ParameterBlockOffset
    ...
    public static void* DeviceDsmOutputBlock(
        [NativeTypeName("PDEVICE_DSM_OUTPUT")] DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT* Output
    )
    {
    ...
    public static uint DeviceDsmGetOutputLength(
        [NativeTypeName("PDEVICE_DSM_DEFINITION")] DEVICE_DSM_DEFINITION* Definition,
        [NativeTypeName("DWORD")] uint OutputBlockLength
    )
    {
        uint Bytes = 0;
        ...
        Bytes = (
            ((Bytes) + ((Definition->OutputBlockAlignment) - 1))
    ...
    [return: NativeTypeName("BOOLEAN")]
    public static byte DeviceDsmValidateOutputLength(
        [NativeTypeName("PDEVICE_DSM_DEFINITION")] DEVICE_DSM_DEFINITION* Definition,
        [NativeTypeName("DWORD")] uint OutputLength
    )
    {
    ...
    [return: NativeTypeName("DWORD")]
    public static uint DeviceDsmGetOutputBlockLength(
        [NativeTypeName("PDEVICE_DSM_DEFINITION")] DEVICE_DSM_DEFINITION* Definition,
        [NativeTypeName("DWORD")] uint OutputLength
    )
    {
    ...
    [return: NativeTypeName("BOOLEAN")]
    [SupportedOSPlatform("windows6.2")]
    public static byte DeviceDsmValidateOutput(
        [NativeTypeName("PDEVICE_DSM_DEFINITION")] DEVICE_DSM_DEFINITION* Definition,
        [NativeTypeName("PDEVICE_DSM_OUTPUT")] DEVICE_MANAGE_DATA_SET_ATTRIBUTES_OUTPUT* Output,
        [NativeTypeName("DWORD")] uint OutputLength
    )
    {
        ...
        if (Definition->OutputBlockLength != 0)
        {
            ...
            Max = OutputLength;
            if (
                Output->OutputBlockOffset < Min
                || Output->OutputBlockOffset > Max
                || (Output->OutputBlockOffset % Definition->OutputBlockAlignment) != 0
            )
            {
                goto Cleanup;
            }
    ...
    public const int OBSOLETE_IOCTL_STORAGE_RESET_BUS = (
        ((0x0000002d) << 16) | (((0x0001) | (0x0002)) << 14) | ((0x0400) << 2) | (0)
    );

    [NativeTypeName(
        "#define OBSOLETE_IOCTL_STORAGE_RESET_DEVICE CTL_CODE(IOCTL_STORAGE_BASE, 0x0401, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)"
    )]
    public const int OBSOLETE_IOCTL_STORAGE_RESET_DEVICE = (
        ((0x0000002d) << 16) | (((0x0001) | (0x0002)) << 14) | ((0x0401) << 2) | (0)
    );
    ...
    public const int OBSOLETE_DISK_GET_WRITE_CACHE_STATE = (
        ((0x00000007) << 16) | (((0x0001)) << 14) | ((0x0037) << 2) | (0)
    );
