...
public partial struct STORAGE_QUERY_DEPENDENT_VOLUME_RESPONSE
{
    ...
    public Span<STORAGE_QUERY_DEPENDENT_VOLUME_LEV1_ENTRY> Lev1Depends
    {
        ...
        get { return Anonymous.Lev1Depends.AsSpan((int)(NumberEntries)); }
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get { return Anonymous.Lev2Depends.AsSpan((int)(NumberEntries)); }
    }
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        public partial struct _Lev1Depends_e__FixedBuffer
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            [UnscopedRef]
            public Span<STORAGE_QUERY_DEPENDENT_VOLUME_LEV1_ENTRY> AsSpan(int length) =>
        ...
        public partial struct _Lev2Depends_e__FixedBuffer
        {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            [UnscopedRef]
            public Span<STORAGE_QUERY_DEPENDENT_VOLUME_LEV2_ENTRY> AsSpan(int length) =>
                MemoryMarshal.CreateSpan(ref e0, length);
        }
    }
}
