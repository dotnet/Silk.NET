...
public static partial class SMART
{
    ...
    public const int SMART_GET_VERSION = (
        ((0x00000007) << 16) | (((0x0001)) << 14) | ((0x0020) << 2) | (0)
    );

    [NativeTypeName(
        "#define SMART_SEND_DRIVE_COMMAND CTL_CODE(IOCTL_DISK_BASE, 0x0021, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)"
    )]
    public const int SMART_SEND_DRIVE_COMMAND = (
        ((0x00000007) << 16) | (((0x0001) | (0x0002)) << 14) | ((0x0021) << 2) | (0)
    );

    [NativeTypeName(
        "#define SMART_RCV_DRIVE_DATA CTL_CODE(IOCTL_DISK_BASE, 0x0022, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)"
    )]
    public const int SMART_RCV_DRIVE_DATA = (
        ((0x00000007) << 16) | (((0x0001) | (0x0002)) << 14) | ((0x0022) << 2) | (0)
    );

    [NativeTypeName(
        "#define SMART_RCV_DRIVE_DATA_EX CTL_CODE(IOCTL_DISK_BASE, 0x0023, METHOD_BUFFERED, FILE_ANY_ACCESS)"
    )]
    public const int SMART_RCV_DRIVE_DATA_EX = (
        ((0x00000007) << 16) | ((0) << 14) | ((0x0023) << 2) | (0)
    );
