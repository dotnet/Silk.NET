...
public unsafe partial struct IMFCapturePhotoSink : IMFCapturePhotoSink.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IMFCapturePhotoSink));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, uint, IMFMediaType*, int>)((*lpVtbl)[3]))(
            this,
            dwSinkStreamIndex,
            ppMediaType
        );
    ...
    {
        return (
            (delegate* unmanaged<IMFCapturePhotoSink, uint, Guid*, Guid*, IUnknown*, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, int>)((*lpVtbl)[6]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, int>)((*lpVtbl)[7]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, ushort*, int>)((*lpVtbl)[8]))(
            this,
            fileName
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IMFCapturePhotoSink, IMFCaptureEngineOnSampleCallback, int>)(
                (*lpVtbl)[9]
            )
        )(this, pCallback);
    }
    ...
    {
        return ((delegate* unmanaged<IMFCapturePhotoSink, IMFByteStream, int>)((*lpVtbl)[10]))(
            this,
            pByteStream
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IMFCapturePhotoSink"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IMFCapturePhotoSink(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IMFCaptureSink"/> to <see cref = "IMFCapturePhotoSink"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IMFCaptureSink"/> instance to be converted </param>
    public static explicit operator IMFCapturePhotoSink(Silk.NET.Windows.IMFCaptureSink value)
    {
        return new IMFCapturePhotoSink(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IMFCapturePhotoSink"/> to <see cref = "Silk.NET.Windows.IMFCaptureSink"/>.</summary>
    /// <param name = "value">The <see cref = "IMFCapturePhotoSink"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IMFCaptureSink(IMFCapturePhotoSink value)
    {
        return new Silk.NET.Windows.IMFCaptureSink(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IMFCapturePhotoSink"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IMFCapturePhotoSink(Silk.NET.Windows.IUnknown value)
    {
        return new IMFCapturePhotoSink(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IMFCapturePhotoSink"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IMFCapturePhotoSink"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IMFCapturePhotoSink value)
    {
