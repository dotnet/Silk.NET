...
public unsafe partial struct IHTMLLocation : IHTMLLocation.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHTMLLocation));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IHTMLLocation, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IHTMLLocation, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, uint*, int>)((*lpVtbl)[3]))(this, pctinfo);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, uint, uint, ITypeInfo*, int>)((*lpVtbl)[4]))(
            this,
            iTInfo,
            lcid,
            ppTInfo
    ...
    {
        return (
            (delegate* unmanaged<IHTMLLocation, Guid*, ushort**, uint, uint, int*, int>)(
                (*lpVtbl)[5]
            )
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[7]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[8]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[9]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[10]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[11]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[12]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[13]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[14]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[15]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[16]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[17]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[18]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[19]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[20]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[21]))(this, v);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[22]))(this, p);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, short, int>)((*lpVtbl)[23]))(this, flag);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[24]))(this, bstr);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort*, int>)((*lpVtbl)[25]))(this, bstr);
    }
    ...
    {
        return ((delegate* unmanaged<IHTMLLocation, ushort**, int>)((*lpVtbl)[26]))(this, @string);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IHTMLLocation"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IHTMLLocation(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IDispatch"/> to <see cref = "IHTMLLocation"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IDispatch"/> instance to be converted </param>
    public static explicit operator IHTMLLocation(Silk.NET.Windows.IDispatch value)
    {
        return new IHTMLLocation(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IHTMLLocation"/> to <see cref = "Silk.NET.Windows.IDispatch"/>.</summary>
    /// <param name = "value">The <see cref = "IHTMLLocation"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IDispatch(IHTMLLocation value)
    {
        return new Silk.NET.Windows.IDispatch(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IHTMLLocation"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IHTMLLocation(Silk.NET.Windows.IUnknown value)
    {
        return new IHTMLLocation(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IHTMLLocation"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IHTMLLocation"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IHTMLLocation value)
    {
