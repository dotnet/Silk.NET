...
public unsafe partial struct IIE70DispatchEx : IIE70DispatchEx.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IIE70DispatchEx));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, Guid*, void**, int>)((*lpVtbl)[0]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, uint>)((*lpVtbl)[1]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, uint>)((*lpVtbl)[2]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, uint*, int>)((*lpVtbl)[3]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            pctinfo
        );
    }
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, uint, uint, ITypeInfo*, int>)((*lpVtbl)[4]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            iTInfo,
            lcid,
            ppTInfo
    ...
    {
        return (
            (delegate* unmanaged<IIE70DispatchEx*, Guid*, ushort**, uint, uint, int*, int>)(
                (*lpVtbl)[5]
            )
        )((IIE70DispatchEx*)Unsafe.AsPointer(ref this), riid, rgszNames, cNames, lcid, rgDispId);
    }
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, ushort*, uint, int*, int>)((*lpVtbl)[7]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            bstrName,
            grfdex,
            pid
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, ushort*, uint, int>)((*lpVtbl)[9]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            bstrName,
            grfdex
        );
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, int, int>)((*lpVtbl)[10]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            id
        );
    }
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, int, uint, uint*, int>)((*lpVtbl)[11]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            id,
            grfdexFetch,
            pgrfdex
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, int, ushort**, int>)((*lpVtbl)[12]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            id,
            pbstrName
        );
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, uint, int, int*, int>)((*lpVtbl)[13]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            grfdex,
            id,
            pid
    ...
    {
        return ((delegate* unmanaged<IIE70DispatchEx*, IUnknown*, int>)((*lpVtbl)[14]))(
            (IIE70DispatchEx*)Unsafe.AsPointer(ref this),
            ppunk
        );
    }
