...
public static unsafe partial class Windows
{
    ...
    public static extern uint WcmQueryProperty(
        [NativeTypeName("const GUID *")] Guid* pInterface,
        [NativeTypeName("LPCWSTR")] ushort* strProfileName,
        WCM_PROPERTY Property,
        void* pReserved,
        [NativeTypeName("PDWORD")] uint* pdwDataSize,
        [NativeTypeName("PBYTE *")] byte** ppData
    );

    [DllImport("wcmapi", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    [SupportedOSPlatform("windows6.2")]
    public static extern uint WcmSetProperty(
        [NativeTypeName("const GUID *")] Guid* pInterface,
        [NativeTypeName("LPCWSTR")] ushort* strProfileName,
        WCM_PROPERTY Property,
        void* pReserved,
    ...
    [return: NativeTypeName("DWORD")]
    [SupportedOSPlatform("windows6.2")]
    public static extern uint WcmGetProfileList(
        void* pReserved,
    ...
    [return: NativeTypeName("DWORD")]
    [SupportedOSPlatform("windows6.2")]
    public static extern uint WcmSetProfileList(
