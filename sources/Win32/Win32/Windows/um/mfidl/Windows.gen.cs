...
public static unsafe partial class Windows
{
    ...
    public static extern HRESULT MFCreatePresentationDescriptor(
        [NativeTypeName("DWORD")] uint cStreamDescriptors,
    ...
    public static extern HRESULT MFCreateStreamDescriptor(
        ...
        [NativeTypeName("DWORD")] uint cMediaTypes,
    ...
    public static extern HRESULT MFCreateSequencerSegmentOffset(
        ...
        [NativeTypeName("MFTIME")] long hnsOffset,
    ...
    public static extern HRESULT MFCreateNetSchemePlugin(
        [NativeTypeName("const IID &")] Guid* riid,
        [NativeTypeName("LPVOID *")] void** ppvHandler
    );
    ...
    public static extern HRESULT MFCreateTranscodeTopology(
        IMFMediaSource pSrc,
        [NativeTypeName("LPCWSTR")] ushort* pwszOutputFilePath,
    ...
    public static extern HRESULT MFTranscodeGetAudioOutputAvailableTypes(
        ...
        [NativeTypeName("DWORD")] uint dwMFTFlags,
    ...
    public static extern HRESULT MFEnumDeviceSources(
        ...
        [NativeTypeName("UINT32 *")] uint* pcSourceActivate
    );
    ...
    public static extern HRESULT MFGetLocalId(
        ...
        [NativeTypeName("LPWSTR *")] ushort** id
    );

    [DllImport("mfplat", ExactSpelling = true)]
    [SupportedOSPlatform("windows10.0")]
    public static extern HRESULT MFCreateContentProtectionDevice(
        [NativeTypeName("const GUID &")] Guid* ProtectionSystemId,
    ...
    public static extern HRESULT MFCreateContentDecryptorContext(
        [NativeTypeName("const GUID &")] Guid* guidMediaProtectionSystemId,
    ...
    public static extern HRESULT MFCreateSensorGroup(
        [NativeTypeName("LPCWSTR")] ushort* SensorGroupSymbolicLink,
        IMFSensorGroup* ppSensorGroup
    );

    [DllImport("mfsensorgroup", ExactSpelling = true)]
    [SupportedOSPlatform("windows10.0.15063.0")]
    public static extern HRESULT MFCreateSensorStream(
    ...
    public static extern HRESULT MFCreateSensorProfile(
        [NativeTypeName("const GUID &")] Guid* ProfileType,
        [NativeTypeName("UINT32")] uint ProfileIndex,
        [NativeTypeName("LPCWSTR")] ushort* Constraints,
        IMFSensorProfile* ppProfile
    );

    [DllImport("mfsensorgroup", ExactSpelling = true)]
    [SupportedOSPlatform("windows10.0.15063.0")]
    public static extern HRESULT MFCreateSensorProfileCollection(
        IMFSensorProfileCollection* ppSensorProfile
    );

    [DllImport("mfsensorgroup", ExactSpelling = true)]
    public static extern HRESULT MFCreateSensorActivityMonitor(
    ...
    public static extern HRESULT MFCreateExtendedCameraIntrinsics(
        IMFExtendedCameraIntrinsics* ppExtendedCameraIntrinsics
    );

    [DllImport("mfcore", ExactSpelling = true)]
    public static extern HRESULT MFCreateExtendedCameraIntrinsicModel(
        [NativeTypeName("const MFCameraIntrinsic_DistortionModelType")]
            MFCameraIntrinsic_DistortionModelType distortionModelType,
        IMFExtendedCameraIntrinsicModel* ppExtendedCameraIntrinsicModel
    );

    [DllImport("mfsensorgroup", ExactSpelling = true)]
    [SupportedOSPlatform("windows10.0.19041.0")]
    public static extern HRESULT MFCreateRelativePanelWatcher(
        [NativeTypeName("PCWSTR")] ushort* videoDeviceId,
        [NativeTypeName("PCWSTR")] ushort* displayMonitorDeviceId,
        IMFRelativePanelWatcher* ppRelativePanelWatcher
    );

    [DllImport("mfsensorgroup", ExactSpelling = true)]
    [SupportedOSPlatform("windows10.0.22000.0")]
    public static extern HRESULT MFCreateCameraOcclusionStateMonitor(
        [NativeTypeName("LPCWSTR")] ushort* symbolicLink,
    ...
    public static extern HRESULT MFCreateCameraControlMonitor(
        [NativeTypeName("LPCWSTR")] ushort* symbolicLink,
