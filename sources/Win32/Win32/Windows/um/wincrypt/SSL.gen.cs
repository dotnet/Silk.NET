...
public static partial class SSL
{
    ...
    public static ReadOnlySpan<byte> SSL_OBJECT_LOCATOR_PFX_FUNC =>
        "SslObjectLocatorInitializePfx"u8;

    [NativeTypeName(
        "#define SSL_OBJECT_LOCATOR_ISSUER_LIST_FUNC \"SslObjectLocatorInitializeIssuerList\""
    )]
    public static ReadOnlySpan<byte> SSL_OBJECT_LOCATOR_ISSUER_LIST_FUNC =>
        "SslObjectLocatorInitializeIssuerList"u8;

    [NativeTypeName(
        "#define SSL_OBJECT_LOCATOR_CERT_VALIDATION_CONFIG_FUNC \"SslObjectLocatorInitializeCertValidationConfig\""
    )]
    public static ReadOnlySpan<byte> SSL_OBJECT_LOCATOR_CERT_VALIDATION_CONFIG_FUNC =>
        "SslObjectLocatorInitializeCertValidationConfig"u8;
}
