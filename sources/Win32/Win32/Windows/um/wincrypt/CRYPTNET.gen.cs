...
public static partial class CRYPTNET
{
    ...
    public const string CRYPTNET_MAX_CACHED_OCSP_PER_CRL_COUNT_VALUE_NAME =
    ...
    public const string CRYPTNET_URL_CACHE_DEFAULT_FLUSH_EXEMPT_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_MIN_MAX_AGE_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_MAX_MAX_AGE_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_MIN_OCSP_VALIDITY_PERIOD_SECONDS_VALUE_NAME =
    ...
    public const int CRYPTNET_PRE_FETCH_MIN_OCSP_VALIDITY_PERIOD_SECONDS_DEFAULT = (
        14 * 24 * 60 * 60
    );
    ...
    public const string CRYPTNET_PRE_FETCH_AFTER_PUBLISH_PRE_FETCH_DIVISOR_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_BEFORE_NEXT_UPDATE_PRE_FETCH_DIVISOR_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_MIN_BEFORE_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME =
    ...
    public const int CRYPTNET_PRE_FETCH_MIN_BEFORE_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_DEFAULT = (
        1 * 60 * 60
    );
    ...
    public const string CRYPTNET_PRE_FETCH_VALIDITY_PERIOD_AFTER_NEXT_UPDATE_PRE_FETCH_DIVISOR_VALUE_NAME =
    ...
    public const int CRYPTNET_PRE_FETCH_VALIDITY_PERIOD_AFTER_NEXT_UPDATE_PRE_FETCH_DIVISOR_DEFAULT =
        10;
    ...
    public const string CRYPTNET_PRE_FETCH_MAX_AFTER_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME =
    ...
    public const int CRYPTNET_PRE_FETCH_MAX_AFTER_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_DEFAULT = (
        4 * 60 * 60
    );
    ...
    public const string CRYPTNET_PRE_FETCH_MIN_AFTER_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME =
    ...
    public const int CRYPTNET_PRE_FETCH_MIN_AFTER_NEXT_UPDATE_PRE_FETCH_PERIOD_SECONDS_DEFAULT = (
        30 * 60
    );
    ...
    public const string CRYPTNET_PRE_FETCH_AFTER_CURRENT_TIME_PRE_FETCH_PERIOD_SECONDS_VALUE_NAME =
    ...
    public const int CRYPTNET_PRE_FETCH_AFTER_CURRENT_TIME_PRE_FETCH_PERIOD_SECONDS_DEFAULT = (
        30 * 60
    );
    ...
    public const string CRYPTNET_PRE_FETCH_TRIGGER_PERIOD_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_SCAN_AFTER_TRIGGER_DELAY_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_PRE_FETCH_RETRIEVAL_TIMEOUT_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_CRL_PRE_FETCH_CONFIG_REGPATH =
    ...
    public const string CRYPTNET_CRL_PRE_FETCH_DISABLE_INFORMATION_EVENTS_VALUE_NAME =
    ...
    public const string CRYPTNET_CRL_PRE_FETCH_PUBLISH_BEFORE_NEXT_UPDATE_SECONDS_VALUE_NAME =
        "PublishBeforeNextUpdateSeconds";

    [NativeTypeName(
        "#define CRYPTNET_CRL_PRE_FETCH_PUBLISH_BEFORE_NEXT_UPDATE_SECONDS_DEFAULT (1 * 60 * 60)"
    )]
    public const int CRYPTNET_CRL_PRE_FETCH_PUBLISH_BEFORE_NEXT_UPDATE_SECONDS_DEFAULT = (
        1 * 60 * 60
    );
    ...
    public const string CRYPTNET_CRL_PRE_FETCH_PUBLISH_RANDOM_INTERVAL_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_CRL_PRE_FETCH_MIN_BEFORE_NEXT_UPDATE_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_CRL_PRE_FETCH_MIN_AFTER_NEXT_UPDATE_SECONDS_VALUE_NAME =
    ...
    public const string CRYPTNET_CACHED_OCSP_SWITCH_TO_CRL_COUNT_VALUE_NAME =
