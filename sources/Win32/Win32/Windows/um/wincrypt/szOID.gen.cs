...
public static partial class szOID
{
    ...
    public static ReadOnlySpan<byte> szOID_DH_SINGLE_PASS_STDDH_SHA1_KDF =>
        "1.3.133.16.840.63.0.2"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INFOSEC_sdnsConfidentiality =>
        "2.16.840.1.101.2.1.1.3"u8;

    [NativeTypeName("#define szOID_INFOSEC_mosaicConfidentiality \"2.16.840.1.101.2.1.1.4\"")]
    public static ReadOnlySpan<byte> szOID_INFOSEC_mosaicConfidentiality =>
        "2.16.840.1.101.2.1.1.4"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INFOSEC_sdnsTokenProtection =>
        "2.16.840.1.101.2.1.1.7"u8;

    [NativeTypeName("#define szOID_INFOSEC_mosaicTokenProtection \"2.16.840.1.101.2.1.1.8\"")]
    public static ReadOnlySpan<byte> szOID_INFOSEC_mosaicTokenProtection =>
        "2.16.840.1.101.2.1.1.8"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INFOSEC_mosaicKeyManagement =>
        "2.16.840.1.101.2.1.1.10"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INFOSEC_SuiteAConfidentiality =>
        "2.16.840.1.101.2.1.1.14"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INFOSEC_SuiteATokenProtection =>
        "2.16.840.1.101.2.1.1.16"u8;

    [NativeTypeName("#define szOID_INFOSEC_SuiteAKeyManagement \"2.16.840.1.101.2.1.1.17\"")]
    public static ReadOnlySpan<byte> szOID_INFOSEC_SuiteAKeyManagement =>
        "2.16.840.1.101.2.1.1.17"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INFOSEC_mosaicUpdatedInteg =>
        "2.16.840.1.101.2.1.1.21"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PKCS_12_KEY_PROVIDER_NAME_ATTR =>
        "1.3.6.1.4.1.311.17.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PKCS_12_PROTECTED_PASSWORD_SECRET_BAG_TYPE_ID =>
        "1.3.6.1.4.1.311.17.4"u8;
    ...
    public static ReadOnlySpan<byte> szOID_INTERNATIONALIZED_EMAIL_ADDRESS =>
        "1.3.6.1.4.1.311.20.2.4"u8;
    ...
    public static ReadOnlySpan<byte> szOID_APPLICATION_POLICY_CONSTRAINTS =>
        "1.3.6.1.4.1.311.21.12"u8;
    ...
    public static ReadOnlySpan<byte> szOID_KP_QUALIFIED_SUBORDINATION =>
        "1.3.6.1.4.1.311.10.3.10"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PLATFORM_MANIFEST_BINARY_ID =>
        "1.3.6.1.4.1.311.10.3.28"u8;
    ...
    public static ReadOnlySpan<byte> szOID_KP_KERNEL_MODE_CODE_SIGNING =>
        "1.3.6.1.4.1.311.61.1.1"u8;

    [NativeTypeName("#define szOID_KP_KERNEL_MODE_TRUSTED_BOOT_SIGNING \"1.3.6.1.4.1.311.61.4.1\"")]
    public static ReadOnlySpan<byte> szOID_KP_KERNEL_MODE_TRUSTED_BOOT_SIGNING =>
        "1.3.6.1.4.1.311.61.4.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PROTECTED_PROCESS_LIGHT_SIGNER =>
        "1.3.6.1.4.1.311.10.3.22"u8;
    ...
    public static ReadOnlySpan<byte> szOID_WINDOWS_THIRD_PARTY_COMPONENT_SIGNER =>
        "1.3.6.1.4.1.311.10.3.25"u8;

    [NativeTypeName("#define szOID_WINDOWS_SOFTWARE_EXTENSION_SIGNER \"1.3.6.1.4.1.311.10.3.26\"")]
    public static ReadOnlySpan<byte> szOID_WINDOWS_SOFTWARE_EXTENSION_SIGNER =>
        "1.3.6.1.4.1.311.10.3.26"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PIN_RULES_LOG_END_DATE_EXT =>
        "1.3.6.1.4.1.311.10.3.35"u8;
    ...
    public static ReadOnlySpan<byte> szOID_KP_KERNEL_MODE_HAL_EXTENSION_SIGNING =>
        "1.3.6.1.4.1.311.61.5.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PKIX_POLICY_QUALIFIER_USERNOTICE =>
        "1.3.6.1.5.5.7.2.2"u8;
    ...
    public static ReadOnlySpan<byte> szOID_CERT_POLICIES_95_QUALIFIER1 =>
        "2.16.840.1.113733.1.7.1.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_ENROLL_ATTESTATION_STATEMENT =>
        "1.3.6.1.4.1.311.21.24"u8;
    ...
    public static ReadOnlySpan<byte> szOID_ENROLL_ATTESTATION_CHALLENGE =>
        "1.3.6.1.4.1.311.21.28"u8;
    ...
    public static ReadOnlySpan<byte> szOID_ENROLL_SCEP_CHALLENGE_ANSWER =>
        "1.3.6.1.4.1.311.21.35"u8;
    ...
    public static ReadOnlySpan<byte> szOID_VERISIGN_ONSITE_JURISDICTION_HASH =>
        "2.16.840.1.113733.1.6.11"u8;
    ...
    public static ReadOnlySpan<byte> szOID_VERISIGN_ISS_STRONG_CRYPTO =>
        "2.16.840.1.113733.1.8.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PKIX_OCSP_BASIC_SIGNED_RESPONSE =>
        "1.3.6.1.5.5.7.48.1.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_CERT_STRONG_SIGN_OS_CURRENT =>
        "1.3.6.1.4.1.311.72.1.1"u8;
    ...
    public static ReadOnlySpan<byte> szOID_CERT_KEY_IDENTIFIER_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.20"u8;

    [NativeTypeName(
        "#define szOID_CERT_ISSUER_SERIAL_NUMBER_MD5_HASH_PROP_ID \"1.3.6.1.4.1.311.10.11.28\""
    )]
    public static ReadOnlySpan<byte> szOID_CERT_ISSUER_SERIAL_NUMBER_MD5_HASH_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.28"u8;

    [NativeTypeName(
        "#define szOID_CERT_SUBJECT_NAME_MD5_HASH_PROP_ID \"1.3.6.1.4.1.311.10.11.29\""
    )]
    public static ReadOnlySpan<byte> szOID_CERT_SUBJECT_NAME_MD5_HASH_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.29"u8;
    ...
    public static ReadOnlySpan<byte> szOID_CERT_SHA256_HASH_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.107"u8;

    [NativeTypeName("#define szOID_CERT_SIGNATURE_HASH_PROP_ID \"1.3.6.1.4.1.311.10.11.15\"")]
    public static ReadOnlySpan<byte> szOID_CERT_SIGNATURE_HASH_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.15"u8;
    ...
    public static ReadOnlySpan<byte> szOID_CERT_DISALLOWED_FILETIME_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.104"u8;

    [NativeTypeName(
        "#define szOID_CERT_DISALLOWED_CA_FILETIME_PROP_ID \"1.3.6.1.4.1.311.10.11.128\""
    )]
    public static ReadOnlySpan<byte> szOID_CERT_DISALLOWED_CA_FILETIME_PROP_ID =>
        "1.3.6.1.4.1.311.10.11.128"u8;

    [NativeTypeName(
        "#define szOID_ROOT_PROGRAM_AUTO_UPDATE_CA_REVOCATION \"1.3.6.1.4.1.311.60.3.1\""
    )]
    public static ReadOnlySpan<byte> szOID_ROOT_PROGRAM_AUTO_UPDATE_CA_REVOCATION =>
        "1.3.6.1.4.1.311.60.3.1"u8;

    [NativeTypeName(
        "#define szOID_ROOT_PROGRAM_AUTO_UPDATE_END_REVOCATION \"1.3.6.1.4.1.311.60.3.2\""
    )]
    public static ReadOnlySpan<byte> szOID_ROOT_PROGRAM_AUTO_UPDATE_END_REVOCATION =>
        "1.3.6.1.4.1.311.60.3.2"u8;

    [NativeTypeName(
        "#define szOID_ROOT_PROGRAM_NO_OCSP_FAILOVER_TO_CRL \"1.3.6.1.4.1.311.60.3.3\""
    )]
    public static ReadOnlySpan<byte> szOID_ROOT_PROGRAM_NO_OCSP_FAILOVER_TO_CRL =>
        "1.3.6.1.4.1.311.60.3.3"u8;
    ...
    public static ReadOnlySpan<byte> szOID_PKCS_12_pbeWithSHA1And128BitRC4 =>
        "1.2.840.113549.1.12.1.1"u8;

    [NativeTypeName("#define szOID_PKCS_12_pbeWithSHA1And40BitRC4 \"1.2.840.113549.1.12.1.2\"")]
    public static ReadOnlySpan<byte> szOID_PKCS_12_pbeWithSHA1And40BitRC4 =>
        "1.2.840.113549.1.12.1.2"u8;

    [NativeTypeName(
        "#define szOID_PKCS_12_pbeWithSHA1And3KeyTripleDES \"1.2.840.113549.1.12.1.3\""
    )]
    public static ReadOnlySpan<byte> szOID_PKCS_12_pbeWithSHA1And3KeyTripleDES =>
        "1.2.840.113549.1.12.1.3"u8;

    [NativeTypeName(
        "#define szOID_PKCS_12_pbeWithSHA1And2KeyTripleDES \"1.2.840.113549.1.12.1.4\""
    )]
    public static ReadOnlySpan<byte> szOID_PKCS_12_pbeWithSHA1And2KeyTripleDES =>
        "1.2.840.113549.1.12.1.4"u8;

    [NativeTypeName("#define szOID_PKCS_12_pbeWithSHA1And128BitRC2 \"1.2.840.113549.1.12.1.5\"")]
    public static ReadOnlySpan<byte> szOID_PKCS_12_pbeWithSHA1And128BitRC2 =>
        "1.2.840.113549.1.12.1.5"u8;

    [NativeTypeName("#define szOID_PKCS_12_pbeWithSHA1And40BitRC2 \"1.2.840.113549.1.12.1.6\"")]
    public static ReadOnlySpan<byte> szOID_PKCS_12_pbeWithSHA1And40BitRC2 =>
        "1.2.840.113549.1.12.1.6"u8;
