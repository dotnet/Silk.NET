...
public static unsafe partial class CRYPT
{
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_CREATE_COM_OBJECT_FUNC =>
        "CryptDllCreateCOMObject"u8;

    [NativeTypeName("#define CRYPT_OID_VERIFY_REVOCATION_FUNC \"CertDllVerifyRevocation\"")]
    public static ReadOnlySpan<byte> CRYPT_OID_VERIFY_REVOCATION_FUNC =>
        "CertDllVerifyRevocation"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_FIND_LOCALIZED_NAME_FUNC =>
        "CryptDllFindLocalizedName"u8;

    [NativeTypeName("#define CRYPT_OID_REGPATH \"Software\\Microsoft\\Cryptography\\OID\"")]
    public static ReadOnlySpan<byte> CRYPT_OID_REGPATH =>
        "Software\\Microsoft\\Cryptography\\OID"u8;
    ...
    public const string CRYPT_OID_INFO_ECC_WRAP_PARAMETERS_ALGORITHM =
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_OPEN_SYSTEM_STORE_PROV_FUNC =>
        "CertDllOpenSystemStoreProv"u8;

    [NativeTypeName("#define CRYPT_OID_REGISTER_SYSTEM_STORE_FUNC \"CertDllRegisterSystemStore\"")]
    public static ReadOnlySpan<byte> CRYPT_OID_REGISTER_SYSTEM_STORE_FUNC =>
        "CertDllRegisterSystemStore"u8;

    [NativeTypeName(
        "#define CRYPT_OID_UNREGISTER_SYSTEM_STORE_FUNC \"CertDllUnregisterSystemStore\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_UNREGISTER_SYSTEM_STORE_FUNC =>
        "CertDllUnregisterSystemStore"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_REGISTER_PHYSICAL_STORE_FUNC =>
        "CertDllRegisterPhysicalStore"u8;

    [NativeTypeName(
        "#define CRYPT_OID_UNREGISTER_PHYSICAL_STORE_FUNC \"CertDllUnregisterPhysicalStore\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_UNREGISTER_PHYSICAL_STORE_FUNC =>
        "CertDllUnregisterPhysicalStore"u8;

    [NativeTypeName("#define CRYPT_OID_ENUM_PHYSICAL_STORE_FUNC \"CertDllEnumPhysicalStore\"")]
    public static ReadOnlySpan<byte> CRYPT_OID_ENUM_PHYSICAL_STORE_FUNC =>
        "CertDllEnumPhysicalStore"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_EXTRACT_ENCODED_SIGNATURE_PARAMETERS_FUNC =>
        "CryptDllExtractEncodedSignatureParameters"u8;

    [NativeTypeName("#define CRYPT_OID_SIGN_AND_ENCODE_HASH_FUNC \"CryptDllSignAndEncodeHash\"")]
    public static ReadOnlySpan<byte> CRYPT_OID_SIGN_AND_ENCODE_HASH_FUNC =>
        "CryptDllSignAndEncodeHash"u8;

    [NativeTypeName(
        "#define CRYPT_OID_VERIFY_ENCODED_SIGNATURE_FUNC \"CryptDllVerifyEncodedSignature\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_VERIFY_ENCODED_SIGNATURE_FUNC =>
        "CryptDllVerifyEncodedSignature"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_FUNC =>
        "CryptDllExportPublicKeyInfoEx"u8;

    [NativeTypeName(
        "#define CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_EX2_FUNC \"CryptDllExportPublicKeyInfoEx2\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_EX2_FUNC =>
        "CryptDllExportPublicKeyInfoEx2"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_EXPORT_PUBLIC_KEY_INFO_FROM_BCRYPT_HANDLE_FUNC =>
        "CryptDllExportPublicKeyInfoFromBCryptKeyHandle"u8;

    [NativeTypeName(
        "#define CRYPT_OID_IMPORT_PUBLIC_KEY_INFO_FUNC \"CryptDllImportPublicKeyInfoEx\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_IMPORT_PUBLIC_KEY_INFO_FUNC =>
        "CryptDllImportPublicKeyInfoEx"u8;

    [NativeTypeName(
        "#define CRYPT_OID_IMPORT_PUBLIC_KEY_INFO_EX2_FUNC \"CryptDllImportPublicKeyInfoEx2\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_IMPORT_PUBLIC_KEY_INFO_EX2_FUNC =>
        "CryptDllImportPublicKeyInfoEx2"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_IMPORT_PRIVATE_KEY_INFO_FUNC =>
        "CryptDllImportPrivateKeyInfoEx"u8;

    [NativeTypeName(
        "#define CRYPT_OID_EXPORT_PRIVATE_KEY_INFO_FUNC \"CryptDllExportPrivateKeyInfoEx\""
    )]
    public static ReadOnlySpan<byte> CRYPT_OID_EXPORT_PRIVATE_KEY_INFO_FUNC =>
        "CryptDllExportPrivateKeyInfoEx"u8;
    ...
    public static ReadOnlySpan<byte> CRYPT_OID_VERIFY_CERTIFICATE_CHAIN_POLICY_FUNC =>
        "CertDllVerifyCertificateChainPolicy"u8;
