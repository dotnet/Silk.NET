        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IGlobalThreadCleanupProvider));
    public void*** lpVtbl;
    ...
    {
        ((delegate* unmanaged<IGlobalThreadCleanupProvider*, HRESULT, void>)((*lpVtbl)[0]))(
            (IGlobalThreadCleanupProvider*)Unsafe.AsPointer(ref this),
            hrError
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IGlobalThreadCleanupProvider*, IHttpApplication*>)((*lpVtbl)[1])
        )((IGlobalThreadCleanupProvider*)Unsafe.AsPointer(ref this));
    }
