...
public unsafe partial struct IHttpStoredContext : IHttpStoredContext.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHttpStoredContext));
    public void*** lpVtbl;
    ...
    {
        ((delegate* unmanaged<IHttpStoredContext*, void>)((*lpVtbl)[0]))(
            (IHttpStoredContext*)Unsafe.AsPointer(ref this)
        );
    }
