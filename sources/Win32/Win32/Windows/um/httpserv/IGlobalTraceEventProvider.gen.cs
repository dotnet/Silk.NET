        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IGlobalTraceEventProvider));
    public void*** lpVtbl;
    ...
    {
        ((delegate* unmanaged<IGlobalTraceEventProvider*, HRESULT, void>)((*lpVtbl)[0]))(
            (IGlobalTraceEventProvider*)Unsafe.AsPointer(ref this),
            hrError
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IGlobalTraceEventProvider*, HTTP_TRACE_EVENT**, int>)((*lpVtbl)[1])
        )((IGlobalTraceEventProvider*)Unsafe.AsPointer(ref this), ppTraceEvent);
    }
    ...
    {
        return ((delegate* unmanaged<IGlobalTraceEventProvider*, void*, int>)((*lpVtbl)[2]))(
            (IGlobalTraceEventProvider*)Unsafe.AsPointer(ref this),
            ModuleId
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IGlobalTraceEventProvider*, IHttpContext**, int>)((*lpVtbl)[3])
        )((IGlobalTraceEventProvider*)Unsafe.AsPointer(ref this), ppHttpContext);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, HTTP_TRACE_EVENT**, int> GetTraceEvent;

        [NativeTypeName("BOOL (HTTP_MODULE_ID)")]
        public delegate* unmanaged<TSelf*, void*, int> CheckSubscription;

        [NativeTypeName("HRESULT (IHttpContext **)")]
        public delegate* unmanaged<TSelf*, IHttpContext**, int> GetCurrentHttpRequestContext;
    }
}
