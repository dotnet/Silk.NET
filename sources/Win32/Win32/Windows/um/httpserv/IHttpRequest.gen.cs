...
public unsafe partial struct IHttpRequest : IHttpRequest.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IHttpRequest));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, HTTP_REQUEST_V2*>)((*lpVtbl)[0]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, HTTP_REQUEST_V2*>)((*lpVtbl)[1]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IHttpRequest*, HTTP_HEADER_ID, ushort*, sbyte*>)((*lpVtbl)[2])
        )((IHttpRequest*)Unsafe.AsPointer(ref this), ulHeaderIndex, pcchHeaderValue);
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, sbyte*, ushort*, sbyte*>)((*lpVtbl)[3]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pszHeaderName,
            pcchHeaderValue
        );
    ...
    {
        return (
            (delegate* unmanaged<IHttpRequest*, HTTP_HEADER_ID, sbyte*, ushort, BOOL, int>)(
                (*lpVtbl)[4]
            )
        )(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
    ...
    {
        return (
            (delegate* unmanaged<IHttpRequest*, sbyte*, sbyte*, ushort, BOOL, int>)((*lpVtbl)[5])
        )(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pszHeaderName,
            pszHeaderValue,
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, HTTP_HEADER_ID, int>)((*lpVtbl)[6]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            ulHeaderIndex
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, sbyte*, int>)((*lpVtbl)[7]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pszHeaderName
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, sbyte*>)((*lpVtbl)[8]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, sbyte*, int>)((*lpVtbl)[9]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pszHttpMethod
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, sbyte*, uint, BOOL, int>)((*lpVtbl)[10]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pszUrl,
            cchUrl,
            fResetQueryString
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, ushort*, uint, BOOL, int>)((*lpVtbl)[11]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pszUrl,
            cchUrl,
            fResetQueryString
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, int>)((*lpVtbl)[12]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, ushort*>)((*lpVtbl)[13]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, SOCKADDR*>)((*lpVtbl)[14]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, SOCKADDR*>)((*lpVtbl)[15]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IHttpRequest*, void*, uint, BOOL, uint*, BOOL*, int>)(
                (*lpVtbl)[16]
            )
        )(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, void*, uint, int>)((*lpVtbl)[17]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pvBuffer,
            cbBuffer
        );
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, uint>)((*lpVtbl)[18]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<IHttpRequest*, ushort*, ushort*, void>)((*lpVtbl)[19]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            pMajorVersion,
            pMinorVersion
        );
    ...
    {
        return (
            (delegate* unmanaged<IHttpRequest*, HTTP_SSL_CLIENT_CERT_INFO**, BOOL*, int>)(
                (*lpVtbl)[20]
            )
        )((IHttpRequest*)Unsafe.AsPointer(ref this), ppClientCertInfo, pfClientCertNegotiated);
    }
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, BOOL, BOOL*, int>)((*lpVtbl)[21]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this),
            fAsync,
            pfCompletionPending
        );
    ...
    {
        return ((delegate* unmanaged<IHttpRequest*, uint>)((*lpVtbl)[22]))(
            (IHttpRequest*)Unsafe.AsPointer(ref this)
        );
    }
