...
public unsafe partial struct IFilterGraph3 : IFilterGraph3.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IFilterGraph3));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IFilterGraph3, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IFilterGraph3, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IBaseFilter, ushort*, int>)((*lpVtbl)[3]))(
            this,
            pFilter,
            pName
        );
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IBaseFilter, int>)((*lpVtbl)[4]))(
            this,
            pFilter
        );
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IEnumFilters*, int>)((*lpVtbl)[5]))(
            this,
            ppEnum
        );
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, ushort*, IBaseFilter*, int>)((*lpVtbl)[6]))(
            this,
            pName,
            ppFilter
        );
    ...
    {
        return (
            (delegate* unmanaged<IFilterGraph3, IPin, IPin, AM_MEDIA_TYPE*, int>)((*lpVtbl)[7])
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IPin, int>)((*lpVtbl)[8]))(this, ppin);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IPin, int>)((*lpVtbl)[9]))(this, ppin);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, int>)((*lpVtbl)[10]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IPin, IPin, int>)((*lpVtbl)[11]))(
            this,
            ppinOut,
            ppinIn
        );
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IPin, int>)((*lpVtbl)[12]))(this, ppinOut);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, ushort*, ushort*, int>)((*lpVtbl)[13]))(
            this,
            lpcwstrFile,
            lpcwstrPlayList
        );
    ...
    {
        return (
            (delegate* unmanaged<IFilterGraph3, ushort*, ushort*, IBaseFilter*, int>)((*lpVtbl)[14])
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, nuint, int>)((*lpVtbl)[15]))(this, hFile);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, int>)((*lpVtbl)[16]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, int>)((*lpVtbl)[17]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IFilterGraph3, IMoniker, IBindCtx, ushort*, IBaseFilter*, int>)(
                (*lpVtbl)[18]
            )
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IPin, AM_MEDIA_TYPE*, int>)((*lpVtbl)[19]))(
            this,
            ppin,
            pmt
        );
    ...
    {
        return ((delegate* unmanaged<IFilterGraph3, IPin, uint, uint*, int>)((*lpVtbl)[20]))(
            this,
            pPinOut,
            dwFlags,
            pvContext
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(21)]
    public HRESULT SetSyncSourceEx(
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                IBaseFilter,
                int>)((*lpVtbl)[21])
        )(this, pClockForMostOfFilterGraph, pClockForFilter, pFilter);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (IReferenceClock *, IReferenceClock *, IBaseFilter *) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            IReferenceClock,
    ...
    /// <summary>Initializes a new instance of the <see cref = "IFilterGraph3"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IFilterGraph3(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IFilterGraph2"/> to <see cref = "IFilterGraph3"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IFilterGraph2"/> instance to be converted </param>
    public static explicit operator IFilterGraph3(Silk.NET.Windows.IFilterGraph2 value)
    {
        return new IFilterGraph3(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFilterGraph3"/> to <see cref = "Silk.NET.Windows.IFilterGraph2"/>.</summary>
    /// <param name = "value">The <see cref = "IFilterGraph3"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IFilterGraph2(IFilterGraph3 value)
    {
        return new Silk.NET.Windows.IFilterGraph2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IGraphBuilder"/> to <see cref = "IFilterGraph3"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IGraphBuilder"/> instance to be converted </param>
    public static explicit operator IFilterGraph3(Silk.NET.Windows.IGraphBuilder value)
    {
        return new IFilterGraph3(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFilterGraph3"/> to <see cref = "Silk.NET.Windows.IGraphBuilder"/>.</summary>
    /// <param name = "value">The <see cref = "IFilterGraph3"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IGraphBuilder(IFilterGraph3 value)
    {
        return new Silk.NET.Windows.IGraphBuilder(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IFilterGraph"/> to <see cref = "IFilterGraph3"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IFilterGraph"/> instance to be converted </param>
    public static explicit operator IFilterGraph3(Silk.NET.Windows.IFilterGraph value)
    {
        return new IFilterGraph3(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFilterGraph3"/> to <see cref = "Silk.NET.Windows.IFilterGraph"/>.</summary>
    /// <param name = "value">The <see cref = "IFilterGraph3"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IFilterGraph(IFilterGraph3 value)
    {
        return new Silk.NET.Windows.IFilterGraph(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IFilterGraph3"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IFilterGraph3(Silk.NET.Windows.IUnknown value)
    {
        return new IFilterGraph3(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFilterGraph3"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IFilterGraph3"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IFilterGraph3 value)
    {
