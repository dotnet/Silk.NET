...
public unsafe partial struct IFilterMapper3 : IFilterMapper3.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IFilterMapper3));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IFilterMapper3, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IFilterMapper3, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IFilterMapper3, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IFilterMapper3, Guid*, uint, ushort*, int>)((*lpVtbl)[3]))(
            this,
            clsidCategory,
            dwCategoryMerit,
            Description
    ...
    {
        return ((delegate* unmanaged<IFilterMapper3, Guid*, ushort*, Guid*, int>)((*lpVtbl)[4]))(
            this,
            pclsidCategory,
            szInstance,
            Filter
    ...
    {
        return ((delegate* unmanaged<IFilterMapper3, ICreateDevEnum*, int>)((*lpVtbl)[7]))(
            this,
            ppEnum
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IFilterMapper3"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IFilterMapper3(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IFilterMapper2"/> to <see cref = "IFilterMapper3"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IFilterMapper2"/> instance to be converted </param>
    public static explicit operator IFilterMapper3(Silk.NET.Windows.IFilterMapper2 value)
    {
        return new IFilterMapper3(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFilterMapper3"/> to <see cref = "Silk.NET.Windows.IFilterMapper2"/>.</summary>
    /// <param name = "value">The <see cref = "IFilterMapper3"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IFilterMapper2(IFilterMapper3 value)
    {
        return new Silk.NET.Windows.IFilterMapper2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IFilterMapper3"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IFilterMapper3(Silk.NET.Windows.IUnknown value)
    {
        return new IFilterMapper3(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IFilterMapper3"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IFilterMapper3"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IFilterMapper3 value)
    {
