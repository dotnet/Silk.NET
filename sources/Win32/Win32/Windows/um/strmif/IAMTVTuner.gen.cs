...
public unsafe partial struct IAMTVTuner : IAMTVTuner.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IAMTVTuner));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IAMTVTuner, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IAMTVTuner, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int, int, int, int>)((*lpVtbl)[3]))(
            this,
            lChannel,
            lVideoSubChannel,
            lAudioSubChannel
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int*, int*, int>)((*lpVtbl)[4]))(
            this,
            plChannel,
            plVideoSubChannel,
            plAudioSubChannel
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int*, int>)((*lpVtbl)[5]))(
            this,
            lChannelMin,
            lChannelMax
        );
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int, int>)((*lpVtbl)[6]))(this, lCountryCode);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[7]))(this, plCountryCode);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int, int>)((*lpVtbl)[8]))(this, lTuningSpace);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[9]))(this, plTuningSpace);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, HANDLE, int>)((*lpVtbl)[10]))(this, hCurrentUser);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int>)((*lpVtbl)[11]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[12]))(
            this,
            plSignalStrength
        );
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, AMTunerModeType, int>)((*lpVtbl)[13]))(
            this,
            lMode
        );
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, AMTunerModeType*, int>)((*lpVtbl)[14]))(
            this,
            plMode
        );
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[15]))(this, plModes);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, IAMTunerNotification, int, int>)((*lpVtbl)[16]))(
            this,
            pNotify,
            lEvents
        );
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, IAMTunerNotification, int>)((*lpVtbl)[17]))(
            this,
            pNotify
        );
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[18]))(
            this,
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[19]))(
            this,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(20)]
    public HRESULT AutoTune(
        [NativeTypeName("long")] int lChannel,
        [NativeTypeName("long *")] int* plFoundSignal
    )
    {
        return ((delegate* unmanaged<IAMTVTuner, int, int*, int>)((*lpVtbl)[20]))(
            this,
            lChannel,
            plFoundSignal
        );
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int>)((*lpVtbl)[21]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[22]))(
            this,
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int, TunerInputType, int>)((*lpVtbl)[23]))(
            this,
            lIndex,
            InputType
        );
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int, TunerInputType*, int>)((*lpVtbl)[24]))(
            this,
            lIndex,
            pInputType
        );
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int, int>)((*lpVtbl)[25]))(this, lIndex);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[26]))(this, plIndex);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[27]))(this, lFreq);
    }
    ...
    {
        return ((delegate* unmanaged<IAMTVTuner, int*, int>)((*lpVtbl)[28]))(this, lFreq);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IAMTVTuner"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IAMTVTuner(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IAMTuner"/> to <see cref = "IAMTVTuner"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IAMTuner"/> instance to be converted </param>
    public static explicit operator IAMTVTuner(Silk.NET.Windows.IAMTuner value)
    {
        return new IAMTVTuner(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IAMTVTuner"/> to <see cref = "Silk.NET.Windows.IAMTuner"/>.</summary>
    /// <param name = "value">The <see cref = "IAMTVTuner"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IAMTuner(IAMTVTuner value)
    {
        return new Silk.NET.Windows.IAMTuner(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IAMTVTuner"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IAMTVTuner(Silk.NET.Windows.IUnknown value)
    {
        return new IAMTVTuner(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IAMTVTuner"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IAMTVTuner"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IAMTVTuner value)
    {
