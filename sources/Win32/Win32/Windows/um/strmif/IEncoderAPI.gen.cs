...
public unsafe partial struct IEncoderAPI : IEncoderAPI.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IEncoderAPI));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IEncoderAPI, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IEncoderAPI, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, int>)((*lpVtbl)[3]))(this, Api);
    }
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, int>)((*lpVtbl)[4]))(this, Api);
    }
    ...
    {
        return (
            (delegate* unmanaged<IEncoderAPI, Guid*, VARIANT*, VARIANT*, VARIANT*, int>)(
                (*lpVtbl)[5]
            )
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, VARIANT**, uint*, int>)((*lpVtbl)[6]))(
            this,
            Api,
            Values,
            ValuesCount
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, VARIANT*, int>)((*lpVtbl)[7]))(
            this,
            Api,
            Value
        );
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, VARIANT*, int>)((*lpVtbl)[8]))(
            this,
            Api,
            Value
        );
    ...
    {
        return ((delegate* unmanaged<IEncoderAPI, Guid*, VARIANT*, int>)((*lpVtbl)[9]))(
            this,
            Api,
            Value
        );
    ...
    /// <summary>Initializes a new instance of the <see cref = "IEncoderAPI"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IEncoderAPI(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IEncoderAPI"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IEncoderAPI(Silk.NET.Windows.IUnknown value)
    {
        return new IEncoderAPI(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IEncoderAPI"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IEncoderAPI"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IEncoderAPI value)
    {
