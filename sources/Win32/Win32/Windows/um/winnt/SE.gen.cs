...
public static partial class SE
{
    ...
    public const uint SE_GROUP_VALID_ATTRIBUTES = (
        (0x00000001)
        | (0x00000002)
        | (0x00000004)
        | (0x00000008)
    ...
    public const uint SE_PRIVILEGE_VALID_ATTRIBUTES = (
    ...
    public const string SE_APP_SILO_ACCESS_TO_PUBLISHER_DIRECTORY_CAPABILITY =
