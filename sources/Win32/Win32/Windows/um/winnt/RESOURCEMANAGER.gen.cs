...
public static partial class RESOURCEMANAGER
{
    ...
    public const int RESOURCEMANAGER_GENERIC_WRITE = (
        ((0x00020000))
        | (0x0002)
        | (0x0004)
        | (0x0008)
    ...
    public const int RESOURCEMANAGER_GENERIC_EXECUTE = (
        ((0x00020000)) | (0x0004) | (0x0008) | (0x0010) | (0x0040) | (0x00100000)
    );

    [NativeTypeName(
        "#define RESOURCEMANAGER_ALL_ACCESS (STANDARD_RIGHTS_REQUIRED             |\\\r\n                                             RESOURCEMANAGER_GENERIC_READ         |\\\r\n                                             RESOURCEMANAGER_GENERIC_WRITE        |\\\r\n                                             RESOURCEMANAGER_GENERIC_EXECUTE)"
    )]
    public const int RESOURCEMANAGER_ALL_ACCESS = (
        (0x000F0000)
