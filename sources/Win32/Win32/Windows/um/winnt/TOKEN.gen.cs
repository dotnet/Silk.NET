...
public static unsafe partial class TOKEN
{
    ...
    public const int TOKEN_TRUST_ALLOWED_MASK = (
        (((0x00020000)) | (0x0008) | (0x0010)) | (0x0002) | (0x0004)
    );
    ...
    public static uint TOKEN_USER_MAX_SIZE =>
        unchecked((uint)(sizeof(TOKEN_USER)) + (12 - 4 + ((15) * 4)));

    [NativeTypeName("#define TOKEN_OWNER_MAX_SIZE (sizeof(TOKEN_OWNER) + SECURITY_MAX_SID_SIZE)")]
    public static uint TOKEN_OWNER_MAX_SIZE =>
        unchecked((uint)(sizeof(TOKEN_OWNER)) + (12 - 4 + ((15) * 4)));
    ...
    public static uint TOKEN_INTEGRITY_LEVEL_MAX_SIZE =>
        unchecked(
            (
                ((uint)((uint)(sizeof(TOKEN_MANDATORY_LABEL))) + (uint)(sizeof(void*)) - 1)
                & ~((uint)(sizeof(void*)) - 1)
            ) + (12 - 4 + ((15) * 4))
        );
    ...
    public static uint TOKEN_APPCONTAINER_SID_MAX_SIZE =>
        unchecked((uint)(sizeof(TOKEN_APPCONTAINER_INFORMATION)) + (12 - 4 + ((15) * 4)));
}
