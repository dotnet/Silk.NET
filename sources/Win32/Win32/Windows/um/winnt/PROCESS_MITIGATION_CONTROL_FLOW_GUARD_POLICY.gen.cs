...
{
    [NativeTypeName("__AnonymousRecord_winnt_L13119_C5")]
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableControlFlowGuard; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableControlFlowGuard = value; }
    }
    public uint EnableExportSuppression
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableExportSuppression; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableExportSuppression = value; }
    }
    public uint StrictMode
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.StrictMode; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.StrictMode = value; }
    }
    public uint EnableXfg
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableXfg; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableXfg = value; }
    }
    public uint EnableXfgAuditMode
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableXfgAuditMode; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableXfgAuditMode = value; }
    }
    ...
    public partial struct _Anonymous_e__Union
    {
        ...
        [FieldOffset(0)]
        [NativeTypeName("__AnonymousRecord_winnt_L13121_C9")]
