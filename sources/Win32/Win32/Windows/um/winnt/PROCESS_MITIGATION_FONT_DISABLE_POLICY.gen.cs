...
public partial struct PROCESS_MITIGATION_FONT_DISABLE_POLICY
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.DisableNonSystemFonts; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.DisableNonSystemFonts = value; }
    }
    public uint AuditNonSystemFontLoading
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.AuditNonSystemFontLoading; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.AuditNonSystemFontLoading = value; }
    }
