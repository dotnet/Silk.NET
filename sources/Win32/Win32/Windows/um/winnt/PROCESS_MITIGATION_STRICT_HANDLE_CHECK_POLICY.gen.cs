...
public partial struct PROCESS_MITIGATION_STRICT_HANDLE_CHECK_POLICY
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.RaiseExceptionOnInvalidHandleReference; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.RaiseExceptionOnInvalidHandleReference = value; }
    }
    public uint HandleExceptionsPermanentlyEnabled
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.HandleExceptionsPermanentlyEnabled; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.HandleExceptionsPermanentlyEnabled = value; }
    }
