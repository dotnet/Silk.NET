...
public static partial class JOB
{
    ...
    [NativeTypeName(
        "#define JOB_OBJECT_VALID_COMPLETION_FILTER (((1UL << (JOB_OBJECT_MSG_MAXIMUM + 1)) - 1) - \\\r\n     ((1UL << JOB_OBJECT_MSG_MINIMUM) - 1))"
    )]
    public const uint JOB_OBJECT_VALID_COMPLETION_FILTER = (
        ((1U << (13 + 1)) - 1) - ((1U << 1) - 1)
    );
