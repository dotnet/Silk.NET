...
public partial struct PROCESS_MITIGATION_CHILD_PROCESS_POLICY
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.NoChildProcessCreation; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.NoChildProcessCreation = value; }
    }
    public uint AuditNoChildProcessCreation
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.AuditNoChildProcessCreation; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.AuditNoChildProcessCreation = value; }
    }
    public uint AllowSecureProcessCreation
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.AllowSecureProcessCreation; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.AllowSecureProcessCreation = value; }
    }
