...
public partial struct PROCESS_MITIGATION_ASLR_POLICY
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableBottomUpRandomization; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableBottomUpRandomization = value; }
    }
    public uint EnableForceRelocateImages
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableForceRelocateImages; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableForceRelocateImages = value; }
    }
    public uint EnableHighEntropy
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.EnableHighEntropy; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.EnableHighEntropy = value; }
    }
    public uint DisallowStrippedImages
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.DisallowStrippedImages; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.DisallowStrippedImages = value; }
    }
