...
public partial struct PROCESS_MITIGATION_DYNAMIC_CODE_POLICY
{
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.ProhibitDynamicCode; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.ProhibitDynamicCode = value; }
    }
    public uint AllowThreadOptOut
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.AllowThreadOptOut; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.AllowThreadOptOut = value; }
    }
    public uint AllowRemoteDowngrade
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.AllowRemoteDowngrade; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.AllowRemoteDowngrade = value; }
    }
    public uint AuditProhibitDynamicCode
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        readonly get { return Anonymous.Anonymous.AuditProhibitDynamicCode; }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        set { Anonymous.Anonymous.AuditProhibitDynamicCode = value; }
    }
