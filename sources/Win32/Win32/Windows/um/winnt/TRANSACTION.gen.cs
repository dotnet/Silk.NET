...
public static partial class TRANSACTION
{
    ...
    public const int TRANSACTION_GENERIC_WRITE = (
        ((0x00020000)) | (0x0002) | (0x0008) | (0x0004) | (0x0010) | (0x0020) | (0x00100000)
    );

    [NativeTypeName(
        "#define TRANSACTION_GENERIC_EXECUTE (STANDARD_RIGHTS_EXECUTE         |\\\r\n                                             TRANSACTION_COMMIT              |\\\r\n                                             TRANSACTION_ROLLBACK            |\\\r\n                                             SYNCHRONIZE)"
    )]
    public const int TRANSACTION_GENERIC_EXECUTE = (
        ((0x00020000)) | (0x0008) | (0x0010) | (0x00100000)
    );

    [NativeTypeName(
        "#define TRANSACTION_ALL_ACCESS (STANDARD_RIGHTS_REQUIRED        |\\\r\n                                             TRANSACTION_GENERIC_READ        |\\\r\n                                             TRANSACTION_GENERIC_WRITE       |\\\r\n                                             TRANSACTION_GENERIC_EXECUTE)"
    )]
    public const int TRANSACTION_ALL_ACCESS = (
        (0x000F0000)
        | (((0x00020000)) | (0x0001) | (0x00100000))
        | (((0x00020000)) | (0x0002) | (0x0008) | (0x0004) | (0x0010) | (0x0020) | (0x00100000))
        | (((0x00020000)) | (0x0008) | (0x0010) | (0x00100000))
    );
    ...
    public const int TRANSACTION_RESOURCE_MANAGER_RIGHTS = (
        (((0x00020000)) | (0x0001) | (0x00100000))
        | ((0x00020000))
        | (0x0002)
        | (0x0004)
