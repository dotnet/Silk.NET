...
public static partial class LOCALE
{
    ...
    public const uint LOCALE_SYSTEM_DEFAULT = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked(((((ushort)(0x02)) << 10) | (ushort)(0x00))))))
            )
        )
    );

    [NativeTypeName("#define LOCALE_USER_DEFAULT (MAKELCID(LANG_USER_DEFAULT, SORT_DEFAULT))")]
    public const uint LOCALE_USER_DEFAULT = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked(((((ushort)(0x01)) << 10) | (ushort)(0x00))))))
            )
        )
    );
    ...
    public const uint LOCALE_CUSTOM_DEFAULT = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked((((ushort)(0x03)) << 10) | (ushort)(0x00)))))
            )
        )
    );
    ...
    public const uint LOCALE_CUSTOM_UNSPECIFIED = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked((((ushort)(0x04)) << 10) | (ushort)(0x00)))))
            )
        )
    );
    ...
    public const uint LOCALE_CUSTOM_UI_DEFAULT = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked((((ushort)(0x05)) << 10) | (ushort)(0x00)))))
            )
        )
    );
    ...
    public const uint LOCALE_NEUTRAL = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked((((ushort)(0x00)) << 10) | (ushort)(0x00)))))
            )
        )
    );
    ...
    public const uint LOCALE_INVARIANT = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked((((ushort)(0x00)) << 10) | (ushort)(0x7f)))))
            )
        )
    );
    ...
    public const uint LOCALE_UNASSIGNED_LCID = (
        (
            (uint)(
                (((uint)((ushort)(0x0))) << 16)
                | ((uint)((ushort)(unchecked((((ushort)(0x04)) << 10) | (ushort)(0x00)))))
