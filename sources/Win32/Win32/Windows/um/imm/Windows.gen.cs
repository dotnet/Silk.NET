...
public static unsafe partial class Windows
{
    ...
    public static extern HKL ImmInstallIMEA(
        [NativeTypeName("LPCSTR")] sbyte* lpszIMEFileName,
        [NativeTypeName("LPCSTR")] sbyte* lpszLayoutText
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern HKL ImmInstallIMEW(
        [NativeTypeName("LPCWSTR")] ushort* lpszIMEFileName,
        [NativeTypeName("LPCWSTR")] ushort* lpszLayoutText
    );
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmGetDescriptionA(
        HKL param0,
        [NativeTypeName("LPSTR")] sbyte* lpszDescription,
        uint uBufLen
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmGetDescriptionW(
        HKL param0,
        [NativeTypeName("LPWSTR")] ushort* lpszDescription,
        uint uBufLen
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmGetIMEFileNameA(
        HKL param0,
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmGetIMEFileNameW(
        HKL param0,
    ...
    public static extern int ImmGetCompositionStringA(
        HIMC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("LPVOID")] void* lpBuf,
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmSetCompositionStringA(
        HIMC param0,
        [NativeTypeName("DWORD")] uint dwIndex,
        [NativeTypeName("LPVOID")] void* lpComp,
        [NativeTypeName("DWORD")] uint dwCompLen,
        [NativeTypeName("LPVOID")] void* lpRead,
        [NativeTypeName("DWORD")] uint dwReadLen
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmSetCompositionStringW(
        HIMC param0,
        [NativeTypeName("DWORD")] uint dwIndex,
        [NativeTypeName("LPVOID")] void* lpComp,
        [NativeTypeName("DWORD")] uint dwCompLen,
    ...
    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetCandidateListCountA(
        HIMC param0,
        [NativeTypeName("LPDWORD")] uint* lpdwListCount
    );

    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetCandidateListCountW(
        HIMC param0,
        [NativeTypeName("LPDWORD")] uint* lpdwListCount
    );
    ...
    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetCandidateListA(
        HIMC param0,
        [NativeTypeName("DWORD")] uint deIndex,
        [NativeTypeName("LPCANDIDATELIST")] CANDIDATELIST* lpCandList,
        [NativeTypeName("DWORD")] uint dwBufLen
    );

    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetCandidateListW(
        HIMC param0,
        [NativeTypeName("DWORD")] uint deIndex,
        [NativeTypeName("LPCANDIDATELIST")] CANDIDATELIST* lpCandList,
        [NativeTypeName("DWORD")] uint dwBufLen
    ...
    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetGuideLineA(
        HIMC param0,
        [NativeTypeName("DWORD")] uint dwIndex,
        [NativeTypeName("LPSTR")] sbyte* lpBuf,
        [NativeTypeName("DWORD")] uint dwBufLen
    );

    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetGuideLineW(
        HIMC param0,
        [NativeTypeName("DWORD")] uint dwIndex,
        [NativeTypeName("LPWSTR")] ushort* lpBuf,
        [NativeTypeName("DWORD")] uint dwBufLen
    );
    ...
    public static extern BOOL ImmGetConversionStatus(
        HIMC param0,
        [NativeTypeName("LPDWORD")] uint* lpfdwConversion,
        [NativeTypeName("LPDWORD")] uint* lpfdwSentence
    );
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmGetCompositionFontA(
        HIMC param0,
        [NativeTypeName("LPLOGFONTA")] LOGFONTA* lplf
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmGetCompositionFontW(
        HIMC param0,
        [NativeTypeName("LPLOGFONTW")] LOGFONTW* lplf
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmSetCompositionFontA(
        HIMC param0,
        [NativeTypeName("LPLOGFONTA")] LOGFONTA* lplf
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmSetCompositionFontW(
        HIMC param0,
        [NativeTypeName("LPLOGFONTW")] LOGFONTW* lplf
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmConfigureIMEA(
        HKL param0,
        HWND param1,
        [NativeTypeName("DWORD")] uint param2,
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmConfigureIMEW(
        HKL param0,
        HWND param1,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPVOID")] void* param3
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern LRESULT ImmEscapeA(
        HKL param0,
        HIMC param1,
        uint param2,
        [NativeTypeName("LPVOID")] void* param3
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern LRESULT ImmEscapeW(
        HKL param0,
        HIMC param1,
        uint param2,
        [NativeTypeName("LPVOID")] void* param3
    ...
    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetConversionListA(
        HKL param0,
        HIMC param1,
        [NativeTypeName("LPCSTR")] sbyte* lpSrc,
        [NativeTypeName("LPCANDIDATELIST")] CANDIDATELIST* lpDst,
        [NativeTypeName("DWORD")] uint dwBufLen,
        uint uFlag
    );
    ...
    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetConversionListW(
        HKL param0,
        HIMC param1,
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmGetStatusWindowPos(
        HIMC param0,
        [NativeTypeName("LPPOINT")] POINT* lpptPos
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmSetStatusWindowPos(
        HIMC param0,
        [NativeTypeName("LPPOINT")] POINT* lpptPos
    );
    ...
    public static extern BOOL ImmGetCompositionWindow(
        HIMC param0,
        [NativeTypeName("LPCOMPOSITIONFORM")] COMPOSITIONFORM* lpCompForm
    );
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmGetCandidateWindow(
        HIMC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("LPCANDIDATEFORM")] CANDIDATEFORM* lpCandidate
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmSetCandidateWindow(
        HIMC param0,
        [NativeTypeName("LPCANDIDATEFORM")] CANDIDATEFORM* lpCandidate
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmIsUIMessageA(
        HWND param0,
        uint param1,
        WPARAM param2,
        LPARAM param3
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmIsUIMessageW(
        HWND param0,
        uint param1,
        WPARAM param2,
        LPARAM param3
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmRegisterWordA(
        HKL param0,
        [NativeTypeName("LPCSTR")] sbyte* lpszReading,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPCSTR")] sbyte* lpszRegister
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmRegisterWordW(
        HKL param0,
        [NativeTypeName("LPCWSTR")] ushort* lpszReading,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPCWSTR")] ushort* lpszRegister
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmUnregisterWordA(
        HKL param0,
        [NativeTypeName("LPCSTR")] sbyte* lpszReading,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPCSTR")] sbyte* lpszUnregister
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern BOOL ImmUnregisterWordW(
        HKL param0,
        [NativeTypeName("LPCWSTR")] ushort* lpszReading,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPCWSTR")] ushort* lpszUnregister
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmGetRegisterWordStyleA(
        HKL param0,
        uint nItem,
        [NativeTypeName("LPSTYLEBUFA")] STYLEBUFA* lpStyleBuf
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmGetRegisterWordStyleW(
        HKL param0,
        uint nItem,
        [NativeTypeName("LPSTYLEBUFW")] STYLEBUFW* lpStyleBuf
    );

    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmEnumRegisterWordA(
        HKL param0,
        [NativeTypeName("REGISTERWORDENUMPROCA")]
            delegate* unmanaged<sbyte*, uint, sbyte*, void*, int> param1,
        [NativeTypeName("LPCSTR")] sbyte* lpszReading,
    ...
    [DllImport("imm32", ExactSpelling = true)]
    public static extern uint ImmEnumRegisterWordW(
        HKL param0,
        [NativeTypeName("REGISTERWORDENUMPROCW")]
            delegate* unmanaged<ushort*, uint, ushort*, void*, int> param1,
        [NativeTypeName("LPCWSTR")] ushort* lpszReading,
        [NativeTypeName("DWORD")] uint param3,
        [NativeTypeName("LPCWSTR")] ushort* lpszRegister,
        [NativeTypeName("LPVOID")] void* param5
    ...
    public static extern BOOL ImmEnumInputContext(
        ...
        [NativeTypeName("IMCENUMPROC")] delegate* unmanaged<HIMC, LPARAM, BOOL> lpfn,
        LPARAM lParam
    );

    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetImeMenuItemsA(
        HIMC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPIMEMENUITEMINFOA")] IMEMENUITEMINFOA* lpImeParentMenu,
        [NativeTypeName("LPIMEMENUITEMINFOA")] IMEMENUITEMINFOA* lpImeMenu,
        [NativeTypeName("DWORD")] uint dwSize
    );

    [DllImport("imm32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint ImmGetImeMenuItemsW(
        HIMC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("LPIMEMENUITEMINFOW")] IMEMENUITEMINFOW* lpImeParentMenu,
        [NativeTypeName("LPIMEMENUITEMINFOW")] IMEMENUITEMINFOW* lpImeMenu,
        [NativeTypeName("DWORD")] uint dwSize
    );
    ...
    public static delegate* <HIMC, uint, void*, uint, int> ImmGetCompositionString =>
        &ImmGetCompositionStringW;

    [NativeTypeName("#define ImmSetCompositionString ImmSetCompositionStringW")]
    public static delegate* <HIMC, uint, void*, uint, void*, uint, BOOL> ImmSetCompositionString =>
        &ImmSetCompositionStringW;

    [NativeTypeName("#define ImmGetCandidateListCount ImmGetCandidateListCountW")]
    public static delegate* <HIMC, uint*, uint> ImmGetCandidateListCount =>
        &ImmGetCandidateListCountW;

    [NativeTypeName("#define ImmGetCandidateList ImmGetCandidateListW")]
    public static delegate* <HIMC, uint, CANDIDATELIST*, uint, uint> ImmGetCandidateList =>
    ...
    public static delegate* <HIMC, LOGFONTW*, BOOL> ImmGetCompositionFont =>
        &ImmGetCompositionFontW;

    [NativeTypeName("#define ImmSetCompositionFont ImmSetCompositionFontW")]
    public static delegate* <HIMC, LOGFONTW*, BOOL> ImmSetCompositionFont =>
    ...
    public static delegate* <
        ...
        uint,
        uint,
        uint> ImmGetConversionList => &ImmGetConversionListW;
    ...
    public static delegate* <HKL, ushort*, uint, ushort*, BOOL> ImmRegisterWord =>
        &ImmRegisterWordW;

    [NativeTypeName("#define ImmUnregisterWord ImmUnregisterWordW")]
    public static delegate* <HKL, ushort*, uint, ushort*, BOOL> ImmUnregisterWord =>
        &ImmUnregisterWordW;

    [NativeTypeName("#define ImmGetRegisterWordStyle ImmGetRegisterWordStyleW")]
    public static delegate* <HKL, uint, STYLEBUFW*, uint> ImmGetRegisterWordStyle =>
        &ImmGetRegisterWordStyleW;

    [NativeTypeName("#define ImmEnumRegisterWord ImmEnumRegisterWordW")]
    public static delegate* <
        HKL,
        delegate* unmanaged<ushort*, uint, ushort*, void*, int>,
        ushort*,
        uint,
        ushort*,
        void*,
        uint> ImmEnumRegisterWord => &ImmEnumRegisterWordW;
    ...
    public static delegate* <
        ...
        IMEMENUITEMINFOW*,
        uint,
        uint> ImmGetImeMenuItems => &ImmGetImeMenuItemsW;
