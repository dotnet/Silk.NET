...
public static unsafe partial class SPC
{
    ...
    public static ReadOnlySpan<byte> SPC_STRUCTURED_STORAGE_DATA_OBJID =>
        "1.3.6.1.4.1.311.2.1.19"u8;
    ...
    public static ReadOnlySpan<byte> SPC_INDIVIDUAL_SP_KEY_PURPOSE_OBJID =>
        "1.3.6.1.4.1.311.2.1.21"u8;

    [NativeTypeName("#define SPC_COMMERCIAL_SP_KEY_PURPOSE_OBJID \"1.3.6.1.4.1.311.2.1.22\"")]
    public static ReadOnlySpan<byte> SPC_COMMERCIAL_SP_KEY_PURPOSE_OBJID =>
        "1.3.6.1.4.1.311.2.1.22"u8;
    ...
    public static ReadOnlySpan<byte> SPC_ENCRYPTED_DIGEST_RETRY_COUNT_OBJID =>
        "1.3.6.1.4.1.311.2.6.2"u8;

    [NativeTypeName("#define SPC_WINDOWS_HELLO_COMPATIBILITY_OBJID \"1.3.6.1.4.1.311.10.41.1\"")]
    public static ReadOnlySpan<byte> SPC_WINDOWS_HELLO_COMPATIBILITY_OBJID =>
        "1.3.6.1.4.1.311.10.41.1"u8;
