...
public static partial class MF
{
    ...
    public const int MF_E_TRANSFORM_PROPERTY_ARRAY_VALUE_WRONG_NUM_DIM = unchecked(
        (int)(0xC00D6D69)
    );
    ...
    public const int MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_OUTPUT_MEDIATYPE = unchecked(
        (int)(0xC00D6D6D)
    );
    ...
    public const int MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_INPUT_MEDIATYPE = unchecked(
        (int)(0xC00D6D6E)
    );
    ...
    public const int MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_MEDIATYPE_COMBINATION = unchecked(
        (int)(0xC00D6D6F)
    );
    ...
    public const int MF_E_TRANSFORM_CONFLICTS_WITH_OTHER_CURRENTLY_ENABLED_FEATURES = unchecked(
        (int)(0xC00D6D70)
    );
    ...
    public const int MF_E_TRANSFORM_NOT_POSSIBLE_FOR_CURRENT_SPKR_CONFIG = unchecked(
        (int)(0xC00D6D73)
    );
    ...
    public const int MF_E_TRANSFORM_CANNOT_CHANGE_MEDIATYPE_WHILE_PROCESSING = unchecked(
        (int)(0xC00D6D74)
    );
    ...
    public const int MF_E_WMDRMOTA_DRM_ENCRYPTION_SCHEME_NOT_SUPPORTED = unchecked(
        (int)(0xC00D7156)
    );
    ...
    public const int MF_E_ITA_UNRECOGNIZED_ANALOG_VIDEO_PROTECTION_GUID = unchecked(
        (int)(0xC00D717E)
    );
    ...
    public const int MF_E_CAPTURE_SOURCE_NO_INDEPENDENT_PHOTO_STREAM_PRESENT = unchecked(
        (int)(0xC00DABE6)
    );
    ...
    public const int MF_E_CAPTURE_SOURCE_DEVICE_EXTENDEDPROP_OP_IN_PROGRESS = unchecked(
        (int)(0xC00DABE9)
    );
    ...
    public const int MF_E_MEDIA_EXTENSION_APPSERVICE_CONNECTION_FAILED = unchecked(
        (int)(0xC00DB3B0)
    );
    ...
    public const int MF_E_MEDIA_EXTENSION_PACKAGE_INTEGRITY_CHECK_FAILED = unchecked(
        (int)(0xC00DB3B2)
    );
