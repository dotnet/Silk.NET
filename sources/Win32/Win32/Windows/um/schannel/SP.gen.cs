...
public static partial class SP
{
    ...
    public const uint SP_PROT_CLIENTS = (
        0x00000002 | 0x00000008 | 0x00000020 | 0x80000000 | 0x00000080
    );
    ...
    public const int SP_PROT_SERVERS = (
        0x00000001 | 0x00000004 | 0x00000010 | 0x40000000 | 0x00000040
    );
    ...
    public const int SP_PROT_TLS1_1PLUS = (
        (0x00000100 | 0x00000400 | 0x00001000) | (0x00000200 | 0x00000800 | 0x00002000)
    );
    ...
    public const int SP_PROT_TLS1_X = (
        (0x00000040 | 0x00000100 | 0x00000400 | 0x00001000)
        | (0x00000080 | 0x00000200 | 0x00000800 | 0x00002000)
    );

    [NativeTypeName(
        "#define SP_PROT_SSL3TLS1_X_CLIENTS (SP_PROT_TLS1_X_CLIENT | \\\r\n                                         SP_PROT_SSL3_CLIENT)"
    )]
    public const int SP_PROT_SSL3TLS1_X_CLIENTS = (
        (0x00000080 | 0x00000200 | 0x00000800 | 0x00002000) | 0x00000020
    );

    [NativeTypeName(
        "#define SP_PROT_SSL3TLS1_X_SERVERS (SP_PROT_TLS1_X_SERVER | \\\r\n                                         SP_PROT_SSL3_SERVER)"
    )]
    public const int SP_PROT_SSL3TLS1_X_SERVERS = (
        (0x00000040 | 0x00000100 | 0x00000400 | 0x00001000) | 0x00000010
    );

    [NativeTypeName("#define SP_PROT_SSL3TLS1_X (SP_PROT_SSL3 | SP_PROT_TLS1_X)")]
    public const int SP_PROT_SSL3TLS1_X = (
    ...
    public const uint SP_PROT_X_CLIENTS = (
        (0x00000002 | 0x00000008 | 0x00000020 | 0x80000000 | 0x00000080)
        | (0x00000080 | 0x00000200 | 0x00000800 | 0x00002000)
    ...
    public const int SP_PROT_X_SERVERS = (
        (0x00000001 | 0x00000004 | 0x00000010 | 0x40000000 | 0x00000040)
        | (0x00000040 | 0x00000100 | 0x00000400 | 0x00001000)
