...
public static unsafe partial class Windows
{
    ...
    public static extern int LsaRegisterLogonProcess(
        [NativeTypeName("PLSA_STRING")] LSA_STRING* LogonProcessName,
        [NativeTypeName("PHANDLE")] HANDLE* LsaHandle,
        [NativeTypeName("PLSA_OPERATIONAL_MODE")] uint* SecurityMode
    );
    ...
    public static extern int LsaLogonUser(
        HANDLE LsaHandle,
        [NativeTypeName("PLSA_STRING")] LSA_STRING* OriginName,
        SECURITY_LOGON_TYPE LogonType,
        [NativeTypeName("ULONG")] uint AuthenticationPackage,
        [NativeTypeName("PVOID")] void* AuthenticationInformation,
        [NativeTypeName("ULONG")] uint AuthenticationInformationLength,
        [NativeTypeName("PTOKEN_GROUPS")] TOKEN_GROUPS* LocalGroups,
        [NativeTypeName("PTOKEN_SOURCE")] TOKEN_SOURCE* SourceContext,
        [NativeTypeName("PVOID *")] void** ProfileBuffer,
        [NativeTypeName("PULONG")] uint* ProfileBufferLength,
        [NativeTypeName("PLUID")] LUID* LogonId,
        [NativeTypeName("PHANDLE")] HANDLE* Token,
        [NativeTypeName("PQUOTA_LIMITS")] QUOTA_LIMITS* Quotas,
        [NativeTypeName("PNTSTATUS")] int* SubStatus
    );
    ...
    public static extern int LsaLookupAuthenticationPackage(
        HANDLE LsaHandle,
        [NativeTypeName("PLSA_STRING")] LSA_STRING* PackageName,
        [NativeTypeName("PULONG")] uint* AuthenticationPackage
    );
    ...
    public static extern int LsaCallAuthenticationPackage(
        HANDLE LsaHandle,
        [NativeTypeName("ULONG")] uint AuthenticationPackage,
        [NativeTypeName("PVOID")] void* ProtocolSubmitBuffer,
        [NativeTypeName("ULONG")] uint SubmitBufferLength,
        [NativeTypeName("PVOID *")] void** ProtocolReturnBuffer,
        [NativeTypeName("PULONG")] uint* ReturnBufferLength,
        [NativeTypeName("PNTSTATUS")] int* ProtocolStatus
    );
    ...
    public static extern int LsaEnumerateLogonSessions(
        [NativeTypeName("PULONG")] uint* LogonSessionCount,
        [NativeTypeName("PLUID *")] LUID** LogonSessionList
    );
    ...
    public static extern int LsaGetLogonSessionData(
        [NativeTypeName("PLUID")] LUID* LogonId,
        [NativeTypeName("PSECURITY_LOGON_SESSION_DATA *")]
    ...
    public static extern int LsaOpenPolicy(
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* SystemName,
        ...
        [NativeTypeName("PLSA_HANDLE")] void** PolicyHandle
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaSetCAPs(
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* CAPDNs,
        [NativeTypeName("ULONG")] uint CAPDNCount,
    ...
    public static extern int LsaGetAppliedCAPIDs(
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* SystemName,
        [NativeTypeName("PSID **")] void*** CAPIDs,
        [NativeTypeName("PULONG")] uint* CAPIDCount
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaQueryCAPs(
        [NativeTypeName("PSID *")] void** CAPIDs,
        [NativeTypeName("ULONG")] uint CAPIDCount,
        [NativeTypeName("PCENTRAL_ACCESS_POLICY *")] CENTRAL_ACCESS_POLICY** CAPs,
        [NativeTypeName("PULONG")] uint* CAPCount
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaQueryInformationPolicy(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaSetInformationPolicy(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        POLICY_INFORMATION_CLASS InformationClass,
        [NativeTypeName("PVOID")] void* Buffer
    );
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaQueryDomainInformationPolicy(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaSetDomainInformationPolicy(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        POLICY_DOMAIN_INFORMATION_CLASS InformationClass,
        [NativeTypeName("PVOID")] void* Buffer
    );
    ...
    [DllImport("secur32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaRegisterPolicyChangeNotification(
    ...
    [DllImport("secur32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaUnregisterPolicyChangeNotification(
        POLICY_NOTIFICATION_INFORMATION_CLASS InformationClass,
        HANDLE NotificationEventHandle
    );
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaEnumerateTrustedDomains(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_ENUMERATION_HANDLE")] uint* EnumerationContext,
        [NativeTypeName("PVOID *")] void** Buffer,
        [NativeTypeName("ULONG")] uint PreferedMaximumLength,
        [NativeTypeName("PULONG")] uint* CountReturned
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaLookupNames(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        ...
        [NativeTypeName("PLSA_TRANSLATED_SID *")] LSA_TRANSLATED_SID** Sids
    );
    ...
    [return: NativeTypeName("NTSTATUS")]
    [SupportedOSPlatform("windows6.2")]
    public static extern int LsaLookupSids2(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("ULONG")] uint LookupOptions,
        [NativeTypeName("ULONG")] uint Count,
        [NativeTypeName("PSID *")] void** Sids,
        [NativeTypeName("PLSA_REFERENCED_DOMAIN_LIST *")]
            LSA_REFERENCED_DOMAIN_LIST** ReferencedDomains,
    ...
    public static extern int LsaEnumerateAccountsWithUserRight(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* UserRight,
        [NativeTypeName("PVOID *")] void** Buffer,
        [NativeTypeName("PULONG")] uint* CountReturned
    );
    ...
    public static extern int LsaEnumerateAccountRights(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PSID")] void* AccountSid,
        [NativeTypeName("PLSA_UNICODE_STRING *")] LSA_UNICODE_STRING** UserRights,
        [NativeTypeName("PULONG")] uint* CountOfRights
    );
    ...
    public static extern int LsaAddAccountRights(
        ...
        [NativeTypeName("PSID")] void* AccountSid,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* UserRights,
        [NativeTypeName("ULONG")] uint CountOfRights
    );
    ...
    public static extern int LsaRemoveAccountRights(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PSID")] void* AccountSid,
        [NativeTypeName("BOOLEAN")] byte AllRights,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* UserRights,
        [NativeTypeName("ULONG")] uint CountOfRights
    );
    ...
    public static extern int LsaOpenTrustedDomainByName(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* TrustedDomainName,
        [NativeTypeName("ACCESS_MASK")] uint DesiredAccess,
        [NativeTypeName("PLSA_HANDLE")] void** TrustedDomainHandle
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaQueryTrustedDomainInfo(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PSID")] void* TrustedDomainSid,
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaSetTrustedDomainInformation(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PSID")] void* TrustedDomainSid,
        TRUSTED_INFORMATION_CLASS InformationClass,
        [NativeTypeName("PVOID")] void* Buffer
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaDeleteTrustedDomain(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PSID")] void* TrustedDomainSid
    );
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaEnumerateTrustedDomainsEx(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_ENUMERATION_HANDLE")] uint* EnumerationContext,
        [NativeTypeName("PVOID *")] void** Buffer,
        [NativeTypeName("ULONG")] uint PreferedMaximumLength,
    ...
    public static extern int LsaCreateTrustedDomainEx(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PTRUSTED_DOMAIN_INFORMATION_EX")]
            TRUSTED_DOMAIN_INFORMATION_EX* TrustedDomainInformation,
        [NativeTypeName("PTRUSTED_DOMAIN_AUTH_INFORMATION")]
    ...
    public static extern int LsaQueryForestTrustInformation(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* TrustedDomainName,
        [NativeTypeName("PLSA_FOREST_TRUST_INFORMATION *")]
    ...
    public static extern int LsaSetForestTrustInformation(
        ...
        [NativeTypeName("PLSA_FOREST_TRUST_INFORMATION")]
            LSA_FOREST_TRUST_INFORMATION* ForestTrustInfo,
        [NativeTypeName("BOOLEAN")] byte CheckOnly,
        [NativeTypeName("PLSA_FOREST_TRUST_COLLISION_INFORMATION *")]
    ...
    public static extern int LsaStorePrivateData(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* KeyName,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* PrivateData
    );
    ...
    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int LsaSetForestTrustInformation2(
        [NativeTypeName("LSA_HANDLE")] void* PolicyHandle,
        [NativeTypeName("PLSA_UNICODE_STRING")] LSA_UNICODE_STRING* TrustedDomainName,
        LSA_FOREST_TRUST_RECORD_TYPE HighestRecordType,
        [NativeTypeName("PLSA_FOREST_TRUST_INFORMATION2")]
    ...
    public static extern byte SystemFunction036(
        [NativeTypeName("PVOID")] void* RandomBuffer,
        [NativeTypeName("ULONG")] uint RandomBufferLength
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int SystemFunction040(
        [NativeTypeName("PVOID")] void* Memory,
        [NativeTypeName("ULONG")] uint MemorySize,
        [NativeTypeName("ULONG")] uint OptionFlags
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [return: NativeTypeName("NTSTATUS")]
    public static extern int SystemFunction041(
        [NativeTypeName("PVOID")] void* Memory,
        [NativeTypeName("ULONG")] uint MemorySize,
        [NativeTypeName("ULONG")] uint OptionFlags
    );
    ...
    public static extern byte AuditSetSystemPolicy(
        [NativeTypeName("PCAUDIT_POLICY_INFORMATION")] AUDIT_POLICY_INFORMATION* pAuditPolicy,
        [NativeTypeName("ULONG")] uint dwPolicyCount
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditSetPerUserPolicy(
        [NativeTypeName("const PSID")] void* pSid,
        [NativeTypeName("PCAUDIT_POLICY_INFORMATION")] AUDIT_POLICY_INFORMATION* pAuditPolicy,
        [NativeTypeName("ULONG")] uint dwPolicyCount
    );
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditQuerySystemPolicy(
        [NativeTypeName("const GUID *")] Guid* pSubCategoryGuids,
        [NativeTypeName("ULONG")] uint dwPolicyCount,
        [NativeTypeName("PAUDIT_POLICY_INFORMATION *")] AUDIT_POLICY_INFORMATION** ppAuditPolicy
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditQueryPerUserPolicy(
        [NativeTypeName("const PSID")] void* pSid,
        [NativeTypeName("const GUID *")] Guid* pSubCategoryGuids,
        [NativeTypeName("ULONG")] uint dwPolicyCount,
        [NativeTypeName("PAUDIT_POLICY_INFORMATION *")] AUDIT_POLICY_INFORMATION** ppAuditPolicy
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditEnumeratePerUserPolicy(
        [NativeTypeName("PPOLICY_AUDIT_SID_ARRAY *")] POLICY_AUDIT_SID_ARRAY** ppAuditSidArray
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditComputeEffectivePolicyBySid(
        [NativeTypeName("const PSID")] void* pSid,
        [NativeTypeName("const GUID *")] Guid* pSubCategoryGuids,
        [NativeTypeName("ULONG")] uint dwPolicyCount,
        [NativeTypeName("PAUDIT_POLICY_INFORMATION *")] AUDIT_POLICY_INFORMATION** ppAuditPolicy
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditComputeEffectivePolicyByToken(
        HANDLE hTokenHandle,
        [NativeTypeName("const GUID *")] Guid* pSubCategoryGuids,
        [NativeTypeName("ULONG")] uint dwPolicyCount,
        [NativeTypeName("PAUDIT_POLICY_INFORMATION *")] AUDIT_POLICY_INFORMATION** ppAuditPolicy
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditEnumerateCategories(
        Guid** ppAuditCategoriesArray,
        [NativeTypeName("PULONG")] uint* pdwCountReturned
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditEnumerateSubCategories(
        [NativeTypeName("const GUID *")] Guid* pAuditCategoryGuid,
        [NativeTypeName("BOOLEAN")] byte bRetrieveAllSubCategories,
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditLookupCategoryNameW(
        [NativeTypeName("const GUID *")] Guid* pAuditCategoryGuid,
        [NativeTypeName("PWSTR *")] ushort** ppszCategoryName
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditLookupCategoryNameA(
        [NativeTypeName("const GUID *")] Guid* pAuditCategoryGuid,
        [NativeTypeName("PSTR *")] sbyte** ppszCategoryName
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditLookupSubCategoryNameW(
        [NativeTypeName("const GUID *")] Guid* pAuditSubCategoryGuid,
        [NativeTypeName("PWSTR *")] ushort** ppszSubCategoryName
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditLookupSubCategoryNameA(
        [NativeTypeName("const GUID *")] Guid* pAuditSubCategoryGuid,
        [NativeTypeName("PSTR *")] sbyte** ppszSubCategoryName
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditLookupCategoryIdFromCategoryGuid(
        [NativeTypeName("const GUID *")] Guid* pAuditCategoryGuid,
        [NativeTypeName("PPOLICY_AUDIT_EVENT_TYPE")] POLICY_AUDIT_EVENT_TYPE* pAuditCategoryId
    );

    [DllImport("advapi32", ExactSpelling = true)]
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditLookupCategoryGuidFromCategoryId(
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditSetSecurity(
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditQuerySecurity(
        [NativeTypeName("SECURITY_INFORMATION")] uint SecurityInformation,
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditSetGlobalSaclW(
        [NativeTypeName("PCWSTR")] ushort* ObjectTypeName,
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditSetGlobalSaclA(
        [NativeTypeName("PCSTR")] sbyte* ObjectTypeName,
        [NativeTypeName("PACL")] ACL* Acl
    );
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditQueryGlobalSaclW(
        [NativeTypeName("PCWSTR")] ushort* ObjectTypeName,
        [NativeTypeName("PACL *")] ACL** Acl
    );
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("BOOLEAN")]
    public static extern byte AuditQueryGlobalSaclA(
        [NativeTypeName("PCSTR")] sbyte* ObjectTypeName,
        [NativeTypeName("PACL *")] ACL** Acl
    );
    ...
    public const int VALID_PER_USER_AUDIT_POLICY_FLAG = (
    ...
    public const int AUDIT_GENERIC_ALL = (
        (0x000F0000) | (0x0001) | (0x0002) | (0x0004) | (0x0008) | (0x0010) | (0x0020) | (0x0040)
    );

    [NativeTypeName(
        "#define AUDIT_GENERIC_READ (STANDARD_RIGHTS_READ      |\\\r\n                                      AUDIT_QUERY_SYSTEM_POLICY |\\\r\n                                      AUDIT_QUERY_USER_POLICY   |\\\r\n                                      AUDIT_ENUMERATE_USERS     |\\\r\n                                      AUDIT_QUERY_MISC_POLICY)"
    )]
    public const int AUDIT_GENERIC_READ = (
        ((0x00020000)) | (0x0002) | (0x0008) | (0x0010) | (0x0040)
    );
    ...
    public static delegate* <Guid*, ushort**, byte> AuditLookupCategoryName =>
        &AuditLookupCategoryNameW;

    [NativeTypeName("#define AuditLookupSubCategoryName AuditLookupSubCategoryNameW")]
    public static delegate* <Guid*, ushort**, byte> AuditLookupSubCategoryName =>
