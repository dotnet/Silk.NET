...
public unsafe partial struct ISpRecoResult : ISpRecoResult.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ISpRecoResult));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ISpRecoResult, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ISpRecoResult, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, SPPHRASE**, int>)((*lpVtbl)[3]))(
            this,
            ppCoMemPhrase
        );
    }
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, SPSERIALIZEDPHRASE**, int>)((*lpVtbl)[4]))(
            this,
            ppCoMemPhrase
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ISpRecoResult, uint, uint, BOOL, ushort**, byte*, int>)(
                (*lpVtbl)[5]
            )
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, uint, int>)((*lpVtbl)[6]))(this, dwValueTypes);
    }
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, SPRECORESULTTIMES*, int>)((*lpVtbl)[7]))(
            this,
            pTimes
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ISpRecoResult, uint, uint, uint, ISpPhraseAlt*, uint*, int>)(
                (*lpVtbl)[8]
            )
    ...
    {
        return (
            (delegate* unmanaged<ISpRecoResult, uint, uint, ISpStreamFormat*, int>)((*lpVtbl)[9])
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, uint, uint, uint, uint*, int>)((*lpVtbl)[10]))(
            this,
            ulStartElement,
            cElements,
            dwFlags,
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, SPSERIALIZEDRESULT**, int>)((*lpVtbl)[11]))(
            this,
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, Guid*, WAVEFORMATEX*, int>)((*lpVtbl)[12]))(
            this,
            pAudioFormatId,
            pWaveFormatEx
        );
    ...
    {
        return ((delegate* unmanaged<ISpRecoResult, ISpRecoContext*, int>)((*lpVtbl)[13]))(
            this,
            ppRecoContext
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ISpRecoResult"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ISpRecoResult(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.ISpPhrase"/> to <see cref = "ISpRecoResult"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.ISpPhrase"/> instance to be converted </param>
    public static explicit operator ISpRecoResult(Silk.NET.Windows.ISpPhrase value)
    {
        return new ISpRecoResult(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ISpRecoResult"/> to <see cref = "Silk.NET.Windows.ISpPhrase"/>.</summary>
    /// <param name = "value">The <see cref = "ISpRecoResult"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.ISpPhrase(ISpRecoResult value)
    {
        return new Silk.NET.Windows.ISpPhrase(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ISpRecoResult"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ISpRecoResult(Silk.NET.Windows.IUnknown value)
    {
        return new ISpRecoResult(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ISpRecoResult"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ISpRecoResult"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ISpRecoResult value)
    {
