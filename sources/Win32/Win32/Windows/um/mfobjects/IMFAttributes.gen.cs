...
public unsafe partial struct IMFAttributes : IMFAttributes.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IMFAttributes));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IMFAttributes, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IMFAttributes, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, PROPVARIANT*, int>)((*lpVtbl)[3]))(
            this,
            guidKey,
            pValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, MF_ATTRIBUTE_TYPE*, int>)((*lpVtbl)[4]))(
            this,
            guidKey,
            pType
        );
    ...
    {
        return (
            (delegate* unmanaged<IMFAttributes, Guid*, PROPVARIANT*, BOOL*, int>)((*lpVtbl)[5])
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, uint*, int>)((*lpVtbl)[7]))(
            this,
            guidKey,
            punValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, ulong*, int>)((*lpVtbl)[8]))(
            this,
            guidKey,
            punValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, double*, int>)((*lpVtbl)[9]))(
            this,
            guidKey,
            pfValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, Guid*, int>)((*lpVtbl)[10]))(
            this,
            guidKey,
            pguidValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, uint*, int>)((*lpVtbl)[11]))(
            this,
            guidKey,
            pcchLength
        );
    ...
    {
        return (
            (delegate* unmanaged<IMFAttributes, Guid*, ushort*, uint, uint*, int>)((*lpVtbl)[12])
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, ushort**, uint*, int>)((*lpVtbl)[13]))(
            this,
            guidKey,
            ppwszValue,
            pcchLength
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, uint*, int>)((*lpVtbl)[14]))(
            this,
            guidKey,
            pcbBlobSize
        );
    ...
    {
        return (
            (delegate* unmanaged<IMFAttributes, Guid*, byte*, uint, uint*, int>)((*lpVtbl)[15])
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, byte**, uint*, int>)((*lpVtbl)[16]))(
            this,
            guidKey,
            ppBuf,
            pcbSize
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, Guid*, void**, int>)((*lpVtbl)[17]))(
            this,
            guidKey,
            riid,
            ppv
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, PROPVARIANT*, int>)((*lpVtbl)[18]))(
            this,
            guidKey,
            Value
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, int>)((*lpVtbl)[19]))(this, guidKey);
    }
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, int>)((*lpVtbl)[20]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, uint, int>)((*lpVtbl)[21]))(
            this,
            guidKey,
            unValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, ulong, int>)((*lpVtbl)[22]))(
            this,
            guidKey,
            unValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, double, int>)((*lpVtbl)[23]))(
            this,
            guidKey,
            fValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, Guid*, int>)((*lpVtbl)[24]))(
            this,
            guidKey,
            guidValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, ushort*, int>)((*lpVtbl)[25]))(
            this,
            guidKey,
            wszValue
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, byte*, uint, int>)((*lpVtbl)[26]))(
            this,
            guidKey,
            pBuf,
            cbBufSize
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, Guid*, IUnknown, int>)((*lpVtbl)[27]))(
            this,
            guidKey,
            pUnknown
        );
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, int>)((*lpVtbl)[28]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, int>)((*lpVtbl)[29]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, uint*, int>)((*lpVtbl)[30]))(this, pcItems);
    }
    ...
    {
        return (
            (delegate* unmanaged<IMFAttributes, uint, Guid*, PROPVARIANT*, int>)((*lpVtbl)[31])
    ...
    {
        return ((delegate* unmanaged<IMFAttributes, IMFAttributes, int>)((*lpVtbl)[32]))(
            this,
            pDest
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IMFAttributes"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IMFAttributes(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IMFAttributes"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IMFAttributes(Silk.NET.Windows.IUnknown value)
    {
        return new IMFAttributes(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IMFAttributes"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IMFAttributes"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IMFAttributes value)
    {
