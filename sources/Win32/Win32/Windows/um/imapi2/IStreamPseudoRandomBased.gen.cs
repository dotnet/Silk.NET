        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IStreamPseudoRandomBased));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IStreamPseudoRandomBased, void*, uint, uint*, int>)((*lpVtbl)[3])
        )(this, pv, cb, pcbRead);
    }
    ...
    {
        return (
            (delegate* unmanaged<IStreamPseudoRandomBased, void*, uint, uint*, int>)((*lpVtbl)[4])
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, ULARGE_INTEGER, int>)((*lpVtbl)[6]))(
            this,
            libNewSize
        );
    }
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint, int>)((*lpVtbl)[8]))(
            this,
            grfCommitFlags
        );
    }
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, int>)((*lpVtbl)[9]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IStreamPseudoRandomBased, STATSTG*, uint, int>)((*lpVtbl)[12])
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, IStream*, int>)((*lpVtbl)[13]))(
            this,
            ppstm
        );
    }
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint, int>)((*lpVtbl)[14]))(
            this,
            value
        );
    }
    ...
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint*, int>)((*lpVtbl)[15]))(
            this,
            value
        );
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(16)]
    public HRESULT put_ExtendedSeed(
        [NativeTypeName("ULONG *")] uint* values,
        [NativeTypeName("ULONG")] uint eCount
    )
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint*, uint, int>)((*lpVtbl)[16]))(
            this,
            values,
            eCount
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(17)]
    public HRESULT get_ExtendedSeed(
        [NativeTypeName("ULONG **")] uint** values,
        [NativeTypeName("ULONG *")] uint* eCount
    )
    {
        return ((delegate* unmanaged<IStreamPseudoRandomBased, uint**, uint*, int>)((*lpVtbl)[17]))(
            this,
            values,
            eCount
        );
    ...
    /// <summary>Initializes a new instance of the <see cref = "IStreamPseudoRandomBased"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IStreamPseudoRandomBased(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IStream"/> to <see cref = "IStreamPseudoRandomBased"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IStream"/> instance to be converted </param>
    public static explicit operator IStreamPseudoRandomBased(Silk.NET.Windows.IStream value)
    {
        return new IStreamPseudoRandomBased(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IStreamPseudoRandomBased"/> to <see cref = "Silk.NET.Windows.IStream"/>.</summary>
    /// <param name = "value">The <see cref = "IStreamPseudoRandomBased"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IStream(IStreamPseudoRandomBased value)
    {
        return new Silk.NET.Windows.IStream(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.ISequentialStream"/> to <see cref = "IStreamPseudoRandomBased"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.ISequentialStream"/> instance to be converted </param>
    public static explicit operator IStreamPseudoRandomBased(
    ...
    /// <summary>Upcasts <see cref = "IStreamPseudoRandomBased"/> to <see cref = "Silk.NET.Windows.ISequentialStream"/>.</summary>
    /// <param name = "value">The <see cref = "IStreamPseudoRandomBased"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.ISequentialStream(
        IStreamPseudoRandomBased value
    )
    {
        return new Silk.NET.Windows.ISequentialStream(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IStreamPseudoRandomBased"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IStreamPseudoRandomBased(Silk.NET.Windows.IUnknown value)
    {
        return new IStreamPseudoRandomBased(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IStreamPseudoRandomBased"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IStreamPseudoRandomBased"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IStreamPseudoRandomBased value)
    {
