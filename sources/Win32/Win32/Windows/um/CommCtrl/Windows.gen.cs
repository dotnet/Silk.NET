...
public static unsafe partial class Windows
{
    ...
    public static extern BOOL InitCommonControlsEx(
        [NativeTypeName("const INITCOMMONCONTROLSEX *")] INITCOMMONCONTROLSEX* picce
    );

    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HIMAGELIST ImageList_Create(
        int cx,
        int cy,
        uint flags,
        int cInitial,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HIMAGELIST ImageList_LoadImageA(
        HINSTANCE hi,
        [NativeTypeName("LPCSTR")] sbyte* lpbmp,
        int cx,
        int cGrow,
        COLORREF crMask,
        uint uType,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HIMAGELIST ImageList_LoadImageW(
        HINSTANCE hi,
        [NativeTypeName("LPCWSTR")] ushort* lpbmp,
        int cx,
        int cGrow,
        COLORREF crMask,
        uint uType,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL ImageList_SetDragCursorImage(
        HIMAGELIST himlDrag,
        int iDrag,
        int dxHotspot,
        int dyHotspot
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HIMAGELIST ImageList_Read(
        [NativeTypeName("struct IStream *")] IStream pstm
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HRESULT ImageList_ReadEx(
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HRESULT ImageList_WriteEx(
        HIMAGELIST himl,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("struct IStream *")] IStream pstm
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HIMAGELIST ImageList_Merge(
        HIMAGELIST himl1,
        int i1,
        HIMAGELIST himl2,
        int i2,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HRESULT HIMAGELIST_QueryInterface(
        HIMAGELIST himl,
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    );

    public static HIMAGELIST IImageListToHIMAGELIST(
        [NativeTypeName("struct IImageList *")] IImageList himl
    )
    {
    ...
    public static extern HWND CreateToolbarEx(
        HWND hwnd,
        [NativeTypeName("DWORD")] uint ws,
        uint wID,
        int nBitmaps,
        HINSTANCE hBMInst,
        [NativeTypeName("UINT_PTR")] nuint wBMID,
        [NativeTypeName("LPCTBBUTTON")] TBBUTTON* lpButtons,
        int iNumButtons,
        int dxButton,
        int dyButton,
        int dxBitmap,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern HBITMAP CreateMappedBitmap(
        HINSTANCE hInstance,
        [NativeTypeName("INT_PTR")] nint idBitmap,
        uint wFlags,
        [NativeTypeName("LPCOLORMAP")] COLORMAP* lpColorMap,
        int iNumMaps
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern HWND CreateStatusWindowA(
        [NativeTypeName("LONG")] int style,
        [NativeTypeName("LPCSTR")] sbyte* lpszText,
        HWND hwndParent,
        uint wID
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern HWND CreateStatusWindowW(
        [NativeTypeName("LONG")] int style,
        [NativeTypeName("LPCWSTR")] ushort* lpszText,
        HWND hwndParent,
        uint wID
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL ShowHideMenuCtl(
        HWND hWnd,
        [NativeTypeName("UINT_PTR")] nuint uFlags,
        [NativeTypeName("LPINT")] int* lpInfo
    );

    [DllImport("comctl32", ExactSpelling = true)]
    public static extern void GetEffectiveClientRect(
        HWND hWnd,
        [NativeTypeName("LPRECT")] RECT* lprc,
        [NativeTypeName("const INT *")] int* lpInfo
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HWND CreateUpDownControl(
    ...
    public static extern HRESULT TaskDialogIndirect(
        [NativeTypeName("const TASKDIALOGCONFIG *")] TASKDIALOGCONFIG* pTaskConfig,
        int* pnButton,
        int* pnRadioButton,
    ...
    public static extern HRESULT TaskDialog(
        HWND hwndOwner,
        HINSTANCE hInstance,
        [NativeTypeName("PCWSTR")] ushort* pszWindowTitle,
        [NativeTypeName("PCWSTR")] ushort* pszMainInstruction,
        [NativeTypeName("PCWSTR")] ushort* pszContent,
        [NativeTypeName("TASKDIALOG_COMMON_BUTTON_FLAGS")] int dwCommonButtons,
        [NativeTypeName("PCWSTR")] ushort* pszIcon,
        int* pnButton
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL _TrackMouseEvent(
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL FlatSB_GetScrollRange(
        HWND param0,
        int code,
        [NativeTypeName("LPINT")] int* param2,
        [NativeTypeName("LPINT")] int* param3
    );

    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL FlatSB_GetScrollInfo(
        HWND param0,
        int code,
        [NativeTypeName("LPSCROLLINFO")] SCROLLINFO* param2
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL FlatSB_GetScrollProp(
        HWND param0,
        int propIndex,
        [NativeTypeName("LPINT")] int* param2
    );
    ...
    public static extern int FlatSB_SetScrollInfo(
        HWND param0,
        int code,
        [NativeTypeName("LPSCROLLINFO")] SCROLLINFO* psi,
        BOOL fRedraw
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL FlatSB_SetScrollProp(
        HWND param0,
        uint index,
        [NativeTypeName("INT_PTR")] nint newValue,
        BOOL param3
    );
    ...
    public static extern BOOL SetWindowSubclass(
        HWND hWnd,
        [NativeTypeName("SUBCLASSPROC")]
            delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nuint, nuint, LRESULT> pfnSubclass,
        [NativeTypeName("UINT_PTR")] nuint uIdSubclass,
        [NativeTypeName("DWORD_PTR")] nuint dwRefData
    );

    [DllImport("comctl32", ExactSpelling = true)]
    public static extern BOOL GetWindowSubclass(
        HWND hWnd,
        [NativeTypeName("SUBCLASSPROC")]
            delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nuint, nuint, LRESULT> pfnSubclass,
        [NativeTypeName("UINT_PTR")] nuint uIdSubclass,
        [NativeTypeName("DWORD_PTR *")] nuint* pdwRefData
    );
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern LRESULT DefSubclassProc(
        HWND hWnd,
        uint uMsg,
        WPARAM wParam,
        LPARAM lParam
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HRESULT LoadIconMetric(
        HINSTANCE hinst,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern HRESULT LoadIconWithScaleDown(
        HINSTANCE hinst,
        [NativeTypeName("PCWSTR")] ushort* pszName,
        int cx,
        int cy,
    ...
    [DllImport("comctl32", ExactSpelling = true)]
    public static extern int DrawShadowText(
        HDC hdc,
        [NativeTypeName("LPCWSTR")] ushort* pszText,
        uint cch,
        RECT* prc,
    ...
    public static delegate* <
        ...
        uint,
        uint,
        HIMAGELIST> ImageList_LoadImage => &ImageList_LoadImageW;
    ...
    public static delegate* <int, ushort*, HWND, uint, HWND> CreateStatusWindow =>
        &CreateStatusWindowW;
    ...
    public static delegate* <HWND, uint, nint, BOOL, BOOL> FlatSB_SetScrollPropPtr =>
