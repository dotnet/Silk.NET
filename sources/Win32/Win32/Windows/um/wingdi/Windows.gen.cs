...
public static unsafe partial class Windows
{
    ...
    public static extern BOOL AnimatePalette(
        ...
        uint iStartIndex,
        uint cEntries,
        [NativeTypeName("const PALETTEENTRY *")] PALETTEENTRY* ppe
    );
    ...
    public static extern int ChoosePixelFormat(
        HDC hdc,
        [NativeTypeName("const PIXELFORMATDESCRIPTOR *")] PIXELFORMATDESCRIPTOR* ppfd
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HMETAFILE CopyMetaFileA(
        HMETAFILE param0,
        [NativeTypeName("LPCSTR")] sbyte* param1
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HMETAFILE CopyMetaFileW(
        HMETAFILE param0,
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HBITMAP CreateBitmapIndirect(
        [NativeTypeName("const BITMAP *")] BITMAP* pbm
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HBRUSH CreateBrushIndirect(
        [NativeTypeName("const LOGBRUSH *")] LOGBRUSH* plbrush
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HDC CreateDCA(
        [NativeTypeName("LPCSTR")] sbyte* pwszDriver,
        [NativeTypeName("LPCSTR")] sbyte* pwszDevice,
        [NativeTypeName("LPCSTR")] sbyte* pszPort,
        [NativeTypeName("const DEVMODEA *")] DEVMODEA* pdm
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HDC CreateDCW(
        [NativeTypeName("LPCWSTR")] ushort* pwszDriver,
        [NativeTypeName("LPCWSTR")] ushort* pwszDevice,
        [NativeTypeName("LPCWSTR")] ushort* pszPort,
        [NativeTypeName("const DEVMODEW *")] DEVMODEW* pdm
    );
    ...
    public static extern HBITMAP CreateDIBitmap(
        ...
        [NativeTypeName("DWORD")] uint flInit,
        [NativeTypeName("const void *")] void* pjBits,
        [NativeTypeName("const BITMAPINFO *")] BITMAPINFO* pbmi,
        uint iUsage
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HBRUSH CreateDIBPatternBrushPt(
        [NativeTypeName("const void *")] void* lpPackedDIB,
        uint iUsage
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HFONT CreateFontIndirectA(
        [NativeTypeName("const LOGFONTA *")] LOGFONTA* lplf
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HFONT CreateFontIndirectW(
        [NativeTypeName("const LOGFONTW *")] LOGFONTW* lplf
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HFONT CreateFontA(
        int cHeight,
        int cWidth,
        int cEscapement,
        int cOrientation,
        int cWeight,
        [NativeTypeName("DWORD")] uint bItalic,
        [NativeTypeName("DWORD")] uint bUnderline,
        [NativeTypeName("DWORD")] uint bStrikeOut,
        [NativeTypeName("DWORD")] uint iCharSet,
        [NativeTypeName("DWORD")] uint iOutPrecision,
        [NativeTypeName("DWORD")] uint iClipPrecision,
        [NativeTypeName("DWORD")] uint iQuality,
        [NativeTypeName("DWORD")] uint iPitchAndFamily,
        [NativeTypeName("LPCSTR")] sbyte* pszFaceName
    );
    ...
    public static extern HFONT CreateFontW(
        ...
        [NativeTypeName("DWORD")] uint iQuality,
        [NativeTypeName("DWORD")] uint iPitchAndFamily,
        [NativeTypeName("LPCWSTR")] ushort* pszFaceName
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HDC CreateICA(
        [NativeTypeName("LPCSTR")] sbyte* pszDriver,
        [NativeTypeName("LPCSTR")] sbyte* pszDevice,
        [NativeTypeName("LPCSTR")] sbyte* pszPort,
        [NativeTypeName("const DEVMODEA *")] DEVMODEA* pdm
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HDC CreateICW(
        [NativeTypeName("LPCWSTR")] ushort* pszDriver,
        [NativeTypeName("LPCWSTR")] ushort* pszDevice,
        [NativeTypeName("LPCWSTR")] ushort* pszPort,
        [NativeTypeName("const DEVMODEW *")] DEVMODEW* pdm
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HPALETTE CreatePalette(
        [NativeTypeName("const LOGPALETTE *")] LOGPALETTE* plpal
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HRGN CreatePolyPolygonRgn(
        [NativeTypeName("const POINT *")] POINT* pptl,
        [NativeTypeName("const INT *")] int* pc,
        int cPoly,
        int iMode
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL CreateScalableFontResourceA(
        [NativeTypeName("DWORD")] uint fdwHidden,
        [NativeTypeName("LPCSTR")] sbyte* lpszFont,
        [NativeTypeName("LPCSTR")] sbyte* lpszFile,
        [NativeTypeName("LPCSTR")] sbyte* lpszPath
    );

    [DllImport("gdi32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL CreateScalableFontResourceW(
        [NativeTypeName("DWORD")] uint fdwHidden,
        [NativeTypeName("LPCWSTR")] ushort* lpszFont,
        [NativeTypeName("LPCWSTR")] ushort* lpszFile,
        [NativeTypeName("LPCWSTR")] ushort* lpszPath
    );
    ...
    public static extern int DescribePixelFormat(
        ...
        int iPixelFormat,
        uint nBytes,
        [NativeTypeName("LPPIXELFORMATDESCRIPTOR")] PIXELFORMATDESCRIPTOR* ppfd
    );
    ...
    public static extern int DrawEscape(
        ...
        int iEscape,
        int cjIn,
        [NativeTypeName("LPCSTR")] sbyte* lpIn
    );
    ...
    public static extern int EnumFontFamiliesExA(
        HDC hdc,
        [NativeTypeName("LPLOGFONTA")] LOGFONTA* lpLogfont,
        [NativeTypeName("FONTENUMPROCA")]
            delegate* unmanaged<LOGFONTA*, TEXTMETRICA*, uint, LPARAM, int> lpProc,
        LPARAM lParam,
    ...
    public static extern int EnumFontFamiliesExW(
        HDC hdc,
        [NativeTypeName("LPLOGFONTW")] LOGFONTW* lpLogfont,
        [NativeTypeName("FONTENUMPROCW")]
            delegate* unmanaged<LOGFONTW*, TEXTMETRICW*, uint, LPARAM, int> lpProc,
        LPARAM lParam,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern int EnumFontFamiliesA(
        HDC hdc,
        [NativeTypeName("LPCSTR")] sbyte* lpLogfont,
        [NativeTypeName("FONTENUMPROCA")]
            delegate* unmanaged<LOGFONTA*, TEXTMETRICA*, uint, LPARAM, int> lpProc,
        LPARAM lParam
    );
    ...
    public static extern int EnumFontFamiliesW(
        HDC hdc,
        [NativeTypeName("LPCWSTR")] ushort* lpLogfont,
        [NativeTypeName("FONTENUMPROCW")]
            delegate* unmanaged<LOGFONTW*, TEXTMETRICW*, uint, LPARAM, int> lpProc,
        LPARAM lParam
    );
    ...
    public static extern int EnumObjects(
        HDC hdc,
        int nType,
        [NativeTypeName("GOBJENUMPROC")] delegate* unmanaged<void*, LPARAM, int> lpFunc,
        LPARAM lParam
    );
    ...
    public static extern int Escape(
        ...
        int iEscape,
        int cjIn,
        [NativeTypeName("LPCSTR")] sbyte* pvIn,
        [NativeTypeName("LPVOID")] void* pvOut
    );
    ...
    public static extern int ExtEscape(
        ...
        int iEscape,
        int cjInput,
        [NativeTypeName("LPCSTR")] sbyte* lpInData,
        int cjOutput,
        [NativeTypeName("LPSTR")] sbyte* lpOutData
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HRGN ExtCreateRegion(
        [NativeTypeName("const XFORM *")] XFORM* lpx,
        [NativeTypeName("DWORD")] uint nCount,
        [NativeTypeName("const RGNDATA *")] RGNDATA* lpData
    );
    ...
    public static extern BOOL GetAspectRatioFilterEx(
        HDC hdc,
        [NativeTypeName("LPSIZE")] SIZE* lpsize
    );
    ...
    public static extern int GetBitmapBits(
        HBITMAP hbit,
        [NativeTypeName("LONG")] int cb,
        [NativeTypeName("LPVOID")] void* lpvBits
    );
    ...
    public static extern BOOL GetCharWidthA(
        ...
        uint iFirst,
        uint iLast,
        [NativeTypeName("LPINT")] int* lpBuffer
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetCharWidthW(
        HDC hdc,
        uint iFirst,
        uint iLast,
        [NativeTypeName("LPINT")] int* lpBuffer
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetCharWidth32W(
        HDC hdc,
        uint iFirst,
        uint iLast,
        [NativeTypeName("LPINT")] int* lpBuffer
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetCharWidthFloatA(
        HDC hdc,
        uint iFirst,
        uint iLast,
        [NativeTypeName("PFLOAT")] float* lpBuffer
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetCharWidthFloatW(
        HDC hdc,
        uint iFirst,
        uint iLast,
        [NativeTypeName("PFLOAT")] float* lpBuffer
    ...
    public static extern BOOL GetCharABCWidthsA(
        ...
        uint wFirst,
        uint wLast,
        [NativeTypeName("LPABC")] ABC* lpABC
    );
    ...
    public static extern BOOL GetCharABCWidthsFloatA(
        ...
        uint iFirst,
        uint iLast,
        [NativeTypeName("LPABCFLOAT")] ABCFLOAT* lpABC
    );
    ...
    public static extern BOOL GetCurrentPositionEx(
        HDC hdc,
        [NativeTypeName("LPPOINT")] POINT* lppt
    );
    ...
    public static extern int GetDIBits(
        ...
        uint cLines,
        [NativeTypeName("LPVOID")] void* lpvBits,
        [NativeTypeName("LPBITMAPINFO")] BITMAPINFO* lpbmi,
        uint usage
    );
    ...
    public static extern uint GetGlyphOutlineA(
        ...
        uint uChar,
        uint fuFormat,
        [NativeTypeName("LPGLYPHMETRICS")] GLYPHMETRICS* lpgm,
        [NativeTypeName("DWORD")] uint cjBuffer,
        [NativeTypeName("LPVOID")] void* pvBuffer,
        [NativeTypeName("const MAT2 *")] MAT2* lpmat2
    );
    ...
    public static extern uint GetOutlineTextMetricsA(
        HDC hdc,
        uint cjCopy,
        [NativeTypeName("LPOUTLINETEXTMETRICA")] OUTLINETEXTMETRICA* potm
    );
    ...
    public static extern uint GetOutlineTextMetricsW(
        HDC hdc,
        uint cjCopy,
        [NativeTypeName("LPOUTLINETEXTMETRICW")] OUTLINETEXTMETRICW* potm
    );
    ...
    public static extern uint GetPaletteEntries(
        ...
        uint iStart,
        uint cEntries,
        [NativeTypeName("LPPALETTEENTRY")] PALETTEENTRY* pPalEntries
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetRasterizerCaps(
        [NativeTypeName("LPRASTERIZER_STATUS")] RASTERIZER_STATUS* lpraststat,
        uint cjBytes
    );
    ...
    public static extern uint GetRegionData(
        HRGN hrgn,
        [NativeTypeName("DWORD")] uint nCount,
        [NativeTypeName("LPRGNDATA")] RGNDATA* lpRgnData
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextExtentPointA(
        HDC hdc,
        [NativeTypeName("LPCSTR")] sbyte* lpString,
        int c,
        [NativeTypeName("LPSIZE")] SIZE* lpsz
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextExtentPointW(
        HDC hdc,
    ...
    public static extern BOOL GetTextExtentPoint32A(
        ...
        [NativeTypeName("LPCSTR")] sbyte* lpString,
        int c,
        [NativeTypeName("LPSIZE")] SIZE* psizl
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextExtentExPointA(
        HDC hdc,
        [NativeTypeName("LPCSTR")] sbyte* lpszString,
        int cchString,
        int nMaxExtent,
        [NativeTypeName("LPINT")] int* lpnFit,
        [NativeTypeName("LPINT")] int* lpnDx,
        [NativeTypeName("LPSIZE")] SIZE* lpSize
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextExtentExPointW(
        HDC hdc,
        [NativeTypeName("LPCWSTR")] ushort* lpszString,
        int cchString,
        int nMaxExtent,
        [NativeTypeName("LPINT")] int* lpnFit,
        [NativeTypeName("LPINT")] int* lpnDx,
    ...
    public static extern int GetTextCharsetInfo(
        HDC hdc,
        [NativeTypeName("LPFONTSIGNATURE")] FONTSIGNATURE* lpSig,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern BOOL TranslateCharsetInfo(
        [NativeTypeName("DWORD *")] uint* lpSrc,
        [NativeTypeName("LPCHARSETINFO")] CHARSETINFO* lpCs,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern uint GetCharacterPlacementA(
        ...
        int nCount,
        int nMexExtent,
        [NativeTypeName("LPGCP_RESULTSA")] GCP_RESULTSA* lpResults,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern uint GetCharacterPlacementW(
        ...
        int nCount,
        int nMexExtent,
        [NativeTypeName("LPGCP_RESULTSW")] GCP_RESULTSW* lpResults,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern uint GetFontUnicodeRanges(
        HDC hdc,
        [NativeTypeName("LPGLYPHSET")] GLYPHSET* lpgs
    );

    [DllImport("gdi32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint GetGlyphIndicesA(
        HDC hdc,
        [NativeTypeName("LPCSTR")] sbyte* lpstr,
        int c,
        [NativeTypeName("LPWORD")] ushort* pgi,
        [NativeTypeName("DWORD")] uint fl
    );
    ...
    public static extern BOOL GetTextExtentPointI(
        HDC hdc,
        [NativeTypeName("LPWORD")] ushort* pgiIn,
        int cgi,
        [NativeTypeName("LPSIZE")] SIZE* psize
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextExtentExPointI(
        HDC hdc,
        [NativeTypeName("LPWORD")] ushort* lpwszString,
        int cwchString,
        int nMaxExtent,
        [NativeTypeName("LPINT")] int* lpnFit,
        [NativeTypeName("LPINT")] int* lpnDx,
    ...
    public static extern BOOL GetCharWidthI(
        ...
        uint cgi,
        [NativeTypeName("LPWORD")] ushort* pgi,
        [NativeTypeName("LPINT")] int* piWidths
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL RemoveFontResourceExA(
        [NativeTypeName("LPCSTR")] sbyte* name,
        [NativeTypeName("DWORD")] uint fl,
        [NativeTypeName("PVOID")] void* pdv
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HANDLE AddFontMemResourceEx(
        [NativeTypeName("PVOID")] void* pFileView,
        [NativeTypeName("DWORD")] uint cjSize,
        [NativeTypeName("PVOID")] void* pvResrved,
        [NativeTypeName("DWORD *")] uint* pNumFonts
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HFONT CreateFontIndirectExA(
        [NativeTypeName("const ENUMLOGFONTEXDVA *")] ENUMLOGFONTEXDVA* param0
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HFONT CreateFontIndirectExW(
        [NativeTypeName("const ENUMLOGFONTEXDVW *")] ENUMLOGFONTEXDVW* param0
    );
    ...
    public static extern BOOL LineDDA(
        ...
        int xEnd,
        int yEnd,
        [NativeTypeName("LINEDDAPROC")] delegate* unmanaged<int, int, LPARAM, void> lpProc,
        LPARAM data
    );
    ...
    public static extern BOOL PlgBlt(
        HDC hdcDest,
        [NativeTypeName("const POINT *")] POINT* lpPoint,
        HDC hdcSrc,
        int xSrc,
        int ySrc,
        int width,
    ...
    public static extern BOOL PolyPolygon(
        HDC hdc,
        [NativeTypeName("const POINT *")] POINT* apt,
        [NativeTypeName("const INT *")] int* asz,
        int csz
    );
    ...
    public static extern int SetBitmapBits(
        ...
        [NativeTypeName("const void *")] void* pvBits
    );
    ...
    public static extern int SetDIBits(
        ...
        uint cLines,
        [NativeTypeName("const void *")] void* lpBits,
        [NativeTypeName("const BITMAPINFO *")] BITMAPINFO* lpbmi,
        uint ColorUse
    );
    ...
    public static extern int SetDIBitsToDevice(
        ...
        int xDest,
        int yDest,
        [NativeTypeName("DWORD")] uint w,
        [NativeTypeName("DWORD")] uint h,
        int xSrc,
        int ySrc,
        uint StartScan,
        uint cLines,
        [NativeTypeName("const void *")] void* lpvBits,
        [NativeTypeName("const BITMAPINFO *")] BITMAPINFO* lpbmi,
        uint ColorUse
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HMETAFILE SetMetaFileBitsEx(
        uint cbBuffer,
    ...
    public static extern uint SetPaletteEntries(
        ...
        uint iStart,
        uint cEntries,
        [NativeTypeName("const PALETTEENTRY *")] PALETTEENTRY* pPalEntries
    );
    ...
    public static extern BOOL GradientFill(
        HDC hdc,
        [NativeTypeName("PTRIVERTEX")] TRIVERTEX* pVertex,
        [NativeTypeName("ULONG")] uint nVertex,
        [NativeTypeName("PVOID")] void* pMesh,
        [NativeTypeName("ULONG")] uint nMesh,
        [NativeTypeName("ULONG")] uint ulMode
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GdiTransparentBlt(
        HDC hdcDest,
        int xoriginDest,
        int yoriginDest,
        int wDest,
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GdiGradientFill(
        HDC hdc,
        [NativeTypeName("PTRIVERTEX")] TRIVERTEX* pVertex,
        [NativeTypeName("ULONG")] uint nVertex,
        [NativeTypeName("PVOID")] void* pMesh,
    ...
    public static extern BOOL PlayMetaFileRecord(
        HDC hdc,
        [NativeTypeName("LPHANDLETABLE")] HANDLETABLE* lpHandleTable,
        [NativeTypeName("LPMETARECORD")] METARECORD* lpMR,
        uint noObjs
    );
    ...
    public static extern BOOL EnumMetaFile(
        HDC hdc,
        HMETAFILE hmf,
        [NativeTypeName("MFENUMPROC")]
            delegate* unmanaged<HDC, HANDLETABLE*, METARECORD*, int, LPARAM, int> proc,
        LPARAM param3
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HENHMETAFILE CopyEnhMetaFileA(
        HENHMETAFILE hEnh,
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HDC CreateEnhMetaFileA(
        HDC hdc,
        [NativeTypeName("LPCSTR")] sbyte* lpFilename,
        [NativeTypeName("const RECT *")] RECT* lprc,
        [NativeTypeName("LPCSTR")] sbyte* lpDesc
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HDC CreateEnhMetaFileW(
        HDC hdc,
        [NativeTypeName("LPCWSTR")] ushort* lpFilename,
        [NativeTypeName("const RECT *")] RECT* lprc,
        [NativeTypeName("LPCWSTR")] ushort* lpDesc
    );
    ...
    public static extern BOOL EnumEnhMetaFile(
        HDC hdc,
        HENHMETAFILE hmf,
        [NativeTypeName("ENHMFENUMPROC")]
            delegate* unmanaged<HDC, HANDLETABLE*, ENHMETARECORD*, int, LPARAM, int> proc,
    ...
    public static extern uint GetEnhMetaFileDescriptionA(
        HENHMETAFILE hemf,
        uint cchBuffer,
        [NativeTypeName("LPSTR")] sbyte* lpDescription
    );
    ...
    public static extern uint GetEnhMetaFileDescriptionW(
        HENHMETAFILE hemf,
        uint cchBuffer,
        [NativeTypeName("LPWSTR")] ushort* lpDescription
    );
    ...
    public static extern uint GetEnhMetaFileHeader(
        HENHMETAFILE hemf,
        uint nSize,
        [NativeTypeName("LPENHMETAHEADER")] ENHMETAHEADER* lpEnhMetaHeader
    );
    ...
    public static extern uint GetEnhMetaFilePaletteEntries(
        HENHMETAFILE hemf,
        uint nNumEntries,
        [NativeTypeName("LPPALETTEENTRY")] PALETTEENTRY* lpPaletteEntries
    );
    ...
    public static extern BOOL PlayEnhMetaFileRecord(
        HDC hdc,
        [NativeTypeName("LPHANDLETABLE")] HANDLETABLE* pht,
        [NativeTypeName("const ENHMETARECORD *")] ENHMETARECORD* pmr,
        uint cht
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HENHMETAFILE SetEnhMetaFileBits(
        uint nSize,
        [NativeTypeName("const BYTE *")] byte* pb
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HENHMETAFILE SetWinMetaFileBits(
        uint nSize,
        [NativeTypeName("const BYTE *")] byte* lpMeta16Data,
        HDC hdcRef,
        [NativeTypeName("const METAFILEPICT *")] METAFILEPICT* lpMFP
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextMetricsA(
        HDC hdc,
        [NativeTypeName("LPTEXTMETRICA")] TEXTMETRICA* lptm
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetTextMetricsW(
        HDC hdc,
        [NativeTypeName("LPTEXTMETRICW")] TEXTMETRICW* lptm
    );
    ...
    public static extern BOOL PolyPolyline(
        HDC hdc,
        [NativeTypeName("const POINT *")] POINT* apt,
        [NativeTypeName("const DWORD *")] uint* asz,
    ...
    public static extern BOOL SetWorldTransform(
        HDC hdc,
        [NativeTypeName("const XFORM *")] XFORM* lpxf
    );
    ...
    public static extern BOOL ModifyWorldTransform(
        HDC hdc,
        [NativeTypeName("const XFORM *")] XFORM* lpxf,
        [NativeTypeName("DWORD")] uint mode
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL CombineTransform(
        [NativeTypeName("LPXFORM")] XFORM* lpxfOut,
        [NativeTypeName("const XFORM *")] XFORM* lpxf1,
        [NativeTypeName("const XFORM *")] XFORM* lpxf2
    );
    ...
    public static extern uint SetDIBColorTable(
        ...
        uint iStart,
        uint cEntries,
        [NativeTypeName("const RGBQUAD *")] RGBQUAD* prgbq
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL SetColorAdjustment(
        HDC hdc,
        [NativeTypeName("const COLORADJUSTMENT *")] COLORADJUSTMENT* lpca
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetColorAdjustment(
        HDC hdc,
        [NativeTypeName("LPCOLORADJUSTMENT")] COLORADJUSTMENT* lpca
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern int StartDocA(
        HDC hdc,
        [NativeTypeName("const DOCINFOA *")] DOCINFOA* lpdi
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern int StartDocW(
        HDC hdc,
        [NativeTypeName("const DOCINFOW *")] DOCINFOW* lpdi
    );
    ...
    public static extern int SetAbortProc(
        HDC hdc,
        [NativeTypeName("ABORTPROC")] delegate* unmanaged<HDC, int, BOOL> proc
    );
    ...
    public static extern int GetPath(
        HDC hdc,
        [NativeTypeName("LPPOINT")] POINT* apt,
        [NativeTypeName("LPBYTE")] byte* aj,
        int cpt
    );
    ...
    public static extern BOOL PolyDraw(
        HDC hdc,
        [NativeTypeName("const POINT *")] POINT* apt,
        [NativeTypeName("const BYTE *")] byte* aj,
        int cpt
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL SetMiterLimit(
        HDC hdc,
        float limit,
        [NativeTypeName("PFLOAT")] float* old
    );
    ...
    public static extern HPEN ExtCreatePen(
        [NativeTypeName("DWORD")] uint iPenStyle,
        [NativeTypeName("DWORD")] uint cWidth,
        [NativeTypeName("const LOGBRUSH *")] LOGBRUSH* plbrush,
        [NativeTypeName("DWORD")] uint cStyle,
        [NativeTypeName("const DWORD *")] uint* pstyle
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL TextOutA(
        HDC hdc,
        int x,
        int y,
        [NativeTypeName("LPCSTR")] sbyte* lpString,
    ...
    public static extern BOOL ExtTextOutA(
        ...
        [NativeTypeName("LPCSTR")] sbyte* lpString,
        uint c,
        [NativeTypeName("const INT *")] int* lpDx
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL PolyTextOutA(
        HDC hdc,
        [NativeTypeName("const POLYTEXTA *")] POLYTEXTA* ppt,
        int nstrings
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL PolyTextOutW(
        HDC hdc,
        [NativeTypeName("const POLYTEXTW *")] POLYTEXTW* ppt,
        int nstrings
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HRGN CreatePolygonRgn(
        [NativeTypeName("const POINT *")] POINT* pptl,
        int cPoint,
        int iMode
    );
    ...
    public static extern uint GetKerningPairsA(
        HDC hdc,
        [NativeTypeName("DWORD")] uint nPairs,
        [NativeTypeName("LPKERNINGPAIR")] KERNINGPAIR* lpKernPair
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL FixBrushOrgEx(
        HDC hdc,
        int x,
        int y,
        [NativeTypeName("LPPOINT")] POINT* ptl
    );
    ...
    public static extern BOOL CheckColorsInGamut(
        HDC hdc,
        [NativeTypeName("LPRGBTRIPLE")] RGBTRIPLE* lpRGBTriple,
        [NativeTypeName("LPVOID")] void* dlpBuffer,
        [NativeTypeName("DWORD")] uint nCount
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetLogColorSpaceA(
        HCOLORSPACE hColorSpace,
        [NativeTypeName("LPLOGCOLORSPACEA")] LOGCOLORSPACEA* lpBuffer,
        [NativeTypeName("DWORD")] uint nSize
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetLogColorSpaceW(
        HCOLORSPACE hColorSpace,
        [NativeTypeName("LPLOGCOLORSPACEW")] LOGCOLORSPACEW* lpBuffer,
        [NativeTypeName("DWORD")] uint nSize
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HCOLORSPACE CreateColorSpaceA(
        [NativeTypeName("LPLOGCOLORSPACEA")] LOGCOLORSPACEA* lplcs
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern HCOLORSPACE CreateColorSpaceW(
        [NativeTypeName("LPLOGCOLORSPACEW")] LOGCOLORSPACEW* lplcs
    );
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL GetICMProfileA(
        HDC hdc,
        [NativeTypeName("LPDWORD")] uint* pBufSize,
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL SetICMProfileW(
        HDC hdc,
    ...
    [DllImport("gdi32", ExactSpelling = true)]
    public static extern int EnumICMProfilesA(
        HDC hdc,
        [NativeTypeName("ICMENUMPROCA")] delegate* unmanaged<sbyte*, LPARAM, int> proc,
        LPARAM param2
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern int EnumICMProfilesW(
        HDC hdc,
        [NativeTypeName("ICMENUMPROCW")] delegate* unmanaged<ushort*, LPARAM, int> proc,
        LPARAM param2
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL UpdateICMRegKeyA(
        [NativeTypeName("DWORD")] uint reserved,
        [NativeTypeName("LPSTR")] sbyte* lpszCMID,
        [NativeTypeName("LPSTR")] sbyte* lpszFileName,
        uint command
    );

    [DllImport("gdi32", ExactSpelling = true)]
    public static extern BOOL UpdateICMRegKeyW(
        [NativeTypeName("DWORD")] uint reserved,
        [NativeTypeName("LPWSTR")] ushort* lpszCMID,
        [NativeTypeName("LPWSTR")] ushort* lpszFileName,
        uint command
    );
    ...
    public static extern BOOL ColorCorrectPalette(
        HDC hdc,
        HPALETTE hPal,
        [NativeTypeName("DWORD")] uint deFirst,
        [NativeTypeName("DWORD")] uint num
    );
    ...
    [DllImport("opengl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL wglUseFontBitmapsA(
        HDC param0,
    ...
    [DllImport("opengl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL wglUseFontBitmapsW(
        HDC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("DWORD")] uint param3
    ...
    [DllImport("opengl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL wglUseFontOutlinesA(
        HDC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("DWORD")] uint param3,
        ...
        float param5,
        int param6,
        [NativeTypeName("LPGLYPHMETRICSFLOAT")] GLYPHMETRICSFLOAT* param7
    );

    [DllImport("opengl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL wglUseFontOutlinesW(
        HDC param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("DWORD")] uint param2,
        [NativeTypeName("DWORD")] uint param3,
    ...
    [DllImport("opengl32", ExactSpelling = true)]
    public static extern BOOL wglDescribeLayerPlane(
        HDC param0,
        int param1,
        int param2,
        uint param3,
        [NativeTypeName("LPLAYERPLANEDESCRIPTOR")] LAYERPLANEDESCRIPTOR* param4
    );

    [DllImport("opengl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern int wglSetLayerPaletteEntries(
        HDC param0,
        int param1,
        int param2,
        int param3,
        [NativeTypeName("const COLORREF *")] COLORREF* param4
    );

    [DllImport("opengl32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern int wglGetLayerPaletteEntries(
        HDC param0,
        int param1,
        int param2,
        int param3,
    ...
    [DllImport("opengl32", ExactSpelling = true)]
    [return: NativeTypeName("DWORD")]
    public static extern uint wglSwapMultipleBuffers(
        uint param0,
        [NativeTypeName("const WGLSWAP *")] WGLSWAP* param1
    );
    ...
    public static delegate* <uint, ushort*, ushort*, ushort*, BOOL> CreateScalableFontResource =>
    ...
    public static delegate* <
        HDC,
        LOGFONTW*,
        delegate* unmanaged<LOGFONTW*, TEXTMETRICW*, uint, LPARAM, int>,
        LPARAM,
        uint,
        int> EnumFontFamiliesEx => &EnumFontFamiliesExW;
    ...
    public static delegate* <
        ...
        delegate* unmanaged<LOGFONTW*, TEXTMETRICW*, uint, LPARAM, int>,
        LPARAM,
        int> EnumFontFamilies => &EnumFontFamiliesW;
    ...
    public static delegate* <HDC, uint, uint, float*, BOOL> GetCharWidthFloat =>
        &GetCharWidthFloatW;
    ...
    public static delegate* <HDC, uint, uint, ABCFLOAT*, BOOL> GetCharABCWidthsFloat =>
    ...
    public static delegate* <
        ...
        void*,
        MAT2*,
        uint> GetGlyphOutline => &GetGlyphOutlineW;
    ...
    public static delegate* <HDC, uint, OUTLINETEXTMETRICW*, uint> GetOutlineTextMetrics =>
        &GetOutlineTextMetricsW;

    [NativeTypeName("#define GetTextExtentPoint GetTextExtentPointW")]
    public static delegate* <HDC, ushort*, int, SIZE*, BOOL> GetTextExtentPoint =>
        &GetTextExtentPointW;

    [NativeTypeName("#define GetTextExtentPoint32 GetTextExtentPoint32W")]
    public static delegate* <HDC, ushort*, int, SIZE*, BOOL> GetTextExtentPoint32 =>
    ...
    public static delegate* <
        ...
        int*,
        SIZE*,
        BOOL> GetTextExtentExPoint => &GetTextExtentExPointW;
    ...
    public static delegate* <
        ...
        GCP_RESULTSW*,
        uint,
        uint> GetCharacterPlacement => &GetCharacterPlacementW;
    ...
    public static delegate* <HDC, ushort*, int, ushort*, uint, uint> GetGlyphIndices =>
        &GetGlyphIndicesW;
    ...
    public static delegate* <ushort*, uint, void*, BOOL> RemoveFontResourceEx =>
        &RemoveFontResourceExW;

    [NativeTypeName("#define CreateFontIndirectEx CreateFontIndirectExW")]
    public static delegate* <ENUMLOGFONTEXDVW*, HFONT> CreateFontIndirectEx =>
    ...
    public static delegate* <HENHMETAFILE, ushort*, HENHMETAFILE> CopyEnhMetaFile =>
        &CopyEnhMetaFileW;

    [NativeTypeName("#define CreateEnhMetaFile CreateEnhMetaFileW")]
    public static delegate* <HDC, ushort*, RECT*, ushort*, HDC> CreateEnhMetaFile =>
        &CreateEnhMetaFileW;
    ...
    public static delegate* <HENHMETAFILE, uint, ushort*, uint> GetEnhMetaFileDescription =>
    ...
    public static delegate* <HDC, int, int, uint, RECT*, ushort*, uint, int*, BOOL> ExtTextOut =>
        &ExtTextOutW;
    ...
    public static delegate* <HCOLORSPACE, LOGCOLORSPACEW*, uint, BOOL> GetLogColorSpace =>
        &GetLogColorSpaceW;
    ...
    public static delegate* <
        HDC,
        delegate* unmanaged<ushort*, LPARAM, int>,
        LPARAM,
        int> EnumICMProfiles => &EnumICMProfilesW;

    [NativeTypeName("#define UpdateICMRegKey UpdateICMRegKeyW")]
    public static delegate* <uint, ushort*, ushort*, uint, BOOL> UpdateICMRegKey =>
        &UpdateICMRegKeyW;
    ...
    public static delegate* <
        ...
        int,
        GLYPHMETRICSFLOAT*,
        BOOL> wglUseFontOutlines => &wglUseFontOutlinesW;
}
