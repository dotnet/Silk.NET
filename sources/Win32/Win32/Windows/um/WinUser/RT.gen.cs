...
public static unsafe partial class RT
{
    ...
    public static ushort* RT_GROUP_CURSOR =>
        ((ushort*)((nuint)((ushort)((nuint)(((ushort*)((nuint)((ushort)(1))))) + 11))));

    [NativeTypeName("#define RT_GROUP_ICON MAKEINTRESOURCE((ULONG_PTR)(RT_ICON) + DIFFERENCE)")]
    public static ushort* RT_GROUP_ICON =>
        ((ushort*)((nuint)((ushort)((nuint)(((ushort*)((nuint)((ushort)(3))))) + 11))));
