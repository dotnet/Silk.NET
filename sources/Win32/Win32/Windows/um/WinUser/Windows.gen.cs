...
public static unsafe partial class Windows
{
    ...
    public static extern int wvsprintfA(
        [NativeTypeName("LPSTR")] sbyte* param0,
    ...
    public static extern int wvsprintfW(
        [NativeTypeName("LPWSTR")] char* param0,
        [NativeTypeName("LPCWSTR")] char* param1,
        [NativeTypeName("va_list")] sbyte* arglist
    );
    ...
    public static extern HKL LoadKeyboardLayoutA(
        [NativeTypeName("LPCSTR")] sbyte* pwszKLID,
        uint Flags
    );
    ...
    public static extern HKL LoadKeyboardLayoutW(
        [NativeTypeName("LPCWSTR")] char* pwszKLID,
        uint Flags
    );
    ...
    public static extern int ToUnicodeEx(
        uint wVirtKey,
        uint wScanCode,
        [NativeTypeName("const BYTE *")] byte* lpKeyState,
        [NativeTypeName("LPWSTR")] char* pwszBuff,
        int cchBuff,
        uint wFlags,
        HKL dwhkl
    );
    ...
    public static extern int GetMouseMovePointsEx(
        uint cbSize,
        [NativeTypeName("LPMOUSEMOVEPOINT")] MOUSEMOVEPOINT* lppt,
        [NativeTypeName("LPMOUSEMOVEPOINT")] MOUSEMOVEPOINT* lpptBuf,
        int nBufPoints,
        [NativeTypeName("DWORD")] uint resolution
    );
    ...
    public static extern HDESK CreateDesktopA(
        [NativeTypeName("LPCSTR")] sbyte* lpszDesktop,
        [NativeTypeName("LPCSTR")] sbyte* lpszDevice,
        DEVMODEA* pDevmode,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess,
        [NativeTypeName("LPSECURITY_ATTRIBUTES")] SECURITY_ATTRIBUTES* lpsa
    );
    ...
    public static extern HDESK CreateDesktopW(
        [NativeTypeName("LPCWSTR")] char* lpszDesktop,
        [NativeTypeName("LPCWSTR")] char* lpszDevice,
        DEVMODEW* pDevmode,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess,
        [NativeTypeName("LPSECURITY_ATTRIBUTES")] SECURITY_ATTRIBUTES* lpsa
    ...
    public static extern HDESK CreateDesktopExA(
        ...
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess,
        [NativeTypeName("LPSECURITY_ATTRIBUTES")] SECURITY_ATTRIBUTES* lpsa,
        [NativeTypeName("ULONG")] uint ulHeapSize,
        [NativeTypeName("PVOID")] void* pvoid
    );
    ...
    public static extern BOOL EnumDesktopsA(
        HWINSTA hwinsta,
        [NativeTypeName("DESKTOPENUMPROCA")] delegate* unmanaged<sbyte*, LPARAM, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern BOOL EnumDesktopsW(
        HWINSTA hwinsta,
        [NativeTypeName("DESKTOPENUMPROCW")] delegate* unmanaged<char*, LPARAM, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern HWINSTA CreateWindowStationA(
        [NativeTypeName("LPCSTR")] sbyte* lpwinsta,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess,
        [NativeTypeName("LPSECURITY_ATTRIBUTES")] SECURITY_ATTRIBUTES* lpsa
    );
    ...
    public static extern HWINSTA CreateWindowStationW(
        [NativeTypeName("LPCWSTR")] char* lpwinsta,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess,
        [NativeTypeName("LPSECURITY_ATTRIBUTES")] SECURITY_ATTRIBUTES* lpsa
    );
    ...
    public static extern HWINSTA OpenWindowStationA(
        [NativeTypeName("LPCSTR")] sbyte* lpszWinSta,
        BOOL fInherit,
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess
    );
    ...
    public static extern HWINSTA OpenWindowStationW(
        [NativeTypeName("LPCWSTR")] char* lpszWinSta,
        BOOL fInherit,
        [NativeTypeName("ACCESS_MASK")] uint dwDesiredAccess
    );
    ...
    public static extern BOOL EnumWindowStationsA(
        [NativeTypeName("WINSTAENUMPROCA")] delegate* unmanaged<sbyte*, LPARAM, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern BOOL EnumWindowStationsW(
        [NativeTypeName("WINSTAENUMPROCW")] delegate* unmanaged<char*, LPARAM, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern BOOL SetUserObjectSecurity(
        HANDLE hObj,
        [NativeTypeName("PSECURITY_INFORMATION")] uint* pSIRequested,
        [NativeTypeName("PSECURITY_DESCRIPTOR")] void* pSID
    );
    ...
    public static extern BOOL GetUserObjectInformationA(
        HANDLE hObj,
        int nIndex,
        [NativeTypeName("PVOID")] void* pvInfo,
        [NativeTypeName("DWORD")] uint nLength,
        [NativeTypeName("LPDWORD")] uint* lpnLengthNeeded
    );
    ...
    public static extern BOOL TrackMouseEvent(
        [NativeTypeName("LPTRACKMOUSEEVENT")] TRACKMOUSEEVENT* lpEventTrack
    );
    ...
    public static extern BOOL DrawEdge(
        HDC hdc,
        [NativeTypeName("LPRECT")] RECT* qrc,
        uint edge,
        uint grfFlags
    );
    ...
    public static extern BOOL DrawFrameControl(
        HDC hdc,
        [NativeTypeName("LPRECT")] RECT* lprc,
        uint uType,
        uint uState
    );
    ...
    public static extern BOOL DrawCaption(
        HWND hwnd,
        HDC hdc,
        [NativeTypeName("const RECT *")] RECT* lprect,
        uint flags
    );
    ...
    public static extern BOOL DrawAnimatedRects(
        HWND hwnd,
        int idAni,
        [NativeTypeName("const RECT *")] RECT* lprcFrom,
        [NativeTypeName("const RECT *")] RECT* lprcTo
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern LRESULT SendMessageTimeoutA(
        HWND hWnd,
        uint Msg,
        WPARAM wParam,
        LPARAM lParam,
        uint fuFlags,
        uint uTimeout,
        [NativeTypeName("PDWORD_PTR")] nuint* lpdwResult
    );
    ...
    public static extern BOOL SendMessageCallbackA(
        ...
        WPARAM wParam,
        LPARAM lParam,
        [NativeTypeName("SENDASYNCPROC")]
            delegate* unmanaged<HWND, uint, nuint, LRESULT, void> lpResultCallBack,
    ...
    public static extern int BroadcastSystemMessageExA(
        ...
        [NativeTypeName("LPDWORD")] uint* lpInfo,
        uint Msg,
        WPARAM wParam,
        LPARAM lParam,
        [NativeTypeName("PBSMINFO")] BSMINFO* pbsmInfo
    );
    ...
    public static extern HDEVNOTIFY RegisterDeviceNotificationA(
        HANDLE hRecipient,
        [NativeTypeName("LPVOID")] void* NotificationFilter,
        [NativeTypeName("DWORD")] uint Flags
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern HPOWERNOTIFY RegisterPowerSettingNotification(
        HANDLE hRecipient,
        [NativeTypeName("LPCGUID")] Guid* PowerSettingGuid,
        [NativeTypeName("DWORD")] uint Flags
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern HPOWERNOTIFY RegisterSuspendResumeNotification(
        HANDLE hRecipient,
        [NativeTypeName("DWORD")] uint Flags
    );
    ...
    public static extern BOOL AttachThreadInput(
        [NativeTypeName("DWORD")] uint idAttach,
        [NativeTypeName("DWORD")] uint idAttachTo,
        BOOL fAttach
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern LRESULT CallWindowProcA(
        [NativeTypeName("WNDPROC")]
            delegate* unmanaged<HWND, uint, WPARAM, LPARAM, LRESULT> lpPrevWndFunc,
        HWND hWnd,
        uint Msg,
        WPARAM wParam,
        LPARAM lParam
    ...
    public static extern ushort RegisterClassA(
        [NativeTypeName("const WNDCLASSA *")] WNDCLASSA* lpWndClass
    );
    ...
    public static extern ushort RegisterClassW(
        [NativeTypeName("const WNDCLASSW *")] WNDCLASSW* lpWndClass
    );
    ...
    public static extern BOOL GetClassInfoA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpClassName,
        [NativeTypeName("LPWNDCLASSA")] WNDCLASSA* lpWndClass
    );
    ...
    public static extern BOOL GetClassInfoW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpClassName,
        [NativeTypeName("LPWNDCLASSW")] WNDCLASSW* lpWndClass
    );
    ...
    public static extern ushort RegisterClassExA(
        [NativeTypeName("const WNDCLASSEXA *")] WNDCLASSEXA* param0
    );
    ...
    public static extern ushort RegisterClassExW(
        [NativeTypeName("const WNDCLASSEXW *")] WNDCLASSEXW* param0
    );
    ...
    public static extern BOOL GetClassInfoExA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpszClass,
        [NativeTypeName("LPWNDCLASSEXA")] WNDCLASSEXA* lpwcx
    );
    ...
    public static extern BOOL GetClassInfoExW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpszClass,
        [NativeTypeName("LPWNDCLASSEXW")] WNDCLASSEXW* lpwcx
    );
    ...
    public static extern HWND CreateWindowExA(
        [NativeTypeName("DWORD")] uint dwExStyle,
        [NativeTypeName("LPCSTR")] sbyte* lpClassName,
    ...
    public static extern BOOL AnimateWindow(
        HWND hWnd,
        [NativeTypeName("DWORD")] uint dwTime,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern BOOL UpdateLayeredWindowIndirect(
        HWND hWnd,
        [NativeTypeName("const UPDATELAYEREDWINDOWINFO *")] UPDATELAYEREDWINDOWINFO* pULWInfo
    );
    ...
    public static extern BOOL SetWindowPlacement(
        HWND hWnd,
        [NativeTypeName("const WINDOWPLACEMENT *")] WINDOWPLACEMENT* lpwndpl
    );
    ...
    public static extern BOOL GetWindowDisplayAffinity(
        HWND hWnd,
        [NativeTypeName("DWORD *")] uint* pdwAffinity
    );
    ...
    public static extern BOOL SetWindowDisplayAffinity(
        HWND hWnd,
        [NativeTypeName("DWORD")] uint dwAffinity
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern HDWP DeferWindowPos(
        HDWP hWinPosInfo,
        HWND hWnd,
        HWND hWndInsertAfter,
        int x,
    ...
    public static extern HWND CreateDialogParamA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpTemplateName,
        HWND hWndParent,
    ...
    public static extern HWND CreateDialogParamW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpTemplateName,
        HWND hWndParent,
        [NativeTypeName("DLGPROC")]
            delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint> lpDialogFunc,
        LPARAM dwInitParam
    ...
    public static extern nint DialogBoxParamA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpTemplateName,
        HWND hWndParent,
        [NativeTypeName("DLGPROC")]
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("INT_PTR")]
    public static extern nint DialogBoxParamW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpTemplateName,
        HWND hWndParent,
        [NativeTypeName("DLGPROC")]
    ...
    [SetsLastSystemError]
    [return: NativeTypeName("INT_PTR")]
    public static extern nint DialogBoxIndirectParamA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCDLGTEMPLATEA")] DLGTEMPLATE* hDialogTemplate,
        HWND hWndParent,
        [NativeTypeName("DLGPROC")]
            delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint> lpDialogFunc,
        LPARAM dwInitParam
    ...
    public static extern nint DialogBoxIndirectParamW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCDLGTEMPLATEW")] DLGTEMPLATE* hDialogTemplate,
        HWND hWndParent,
        [NativeTypeName("DLGPROC")]
            delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint> lpDialogFunc,
        LPARAM dwInitParam
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL SetDlgItemTextA(
        HWND hDlg,
        int nIDDlgItem,
    ...
    public static extern BOOL SetDlgItemTextW(
        HWND hDlg,
        int nIDDlgItem,
        [NativeTypeName("LPCWSTR")] char* lpString
    );
    ...
    public static extern uint GetDlgItemTextA(
        HWND hDlg,
        int nIDDlgItem,
        [NativeTypeName("LPSTR")] sbyte* lpString,
        int cchMax
    );
    ...
    public static extern uint GetDlgItemTextW(
        HWND hDlg,
        int nIDDlgItem,
        [NativeTypeName("LPWSTR")] char* lpString,
        int cchMax
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern LRESULT SendDlgItemMessageA(
        HWND hDlg,
        int nIDDlgItem,
        uint Msg,
        WPARAM wParam,
    ...
    public static extern BOOL GetClipboardMetadata(
        uint format,
        [NativeTypeName("PGETCLIPBMETADATA")] GETCLIPBMETADATA* metadata
    );
    ...
    public static extern uint RegisterClipboardFormatA(
        [NativeTypeName("LPCSTR")] sbyte* lpszFormat
    );
    ...
    public static extern uint RegisterClipboardFormatW(
        [NativeTypeName("LPCWSTR")] char* lpszFormat
    );
    ...
    public static extern int GetClipboardFormatNameA(
        uint format,
        [NativeTypeName("LPSTR")] sbyte* lpszFormatName,
        int cchMaxCount
    );
    ...
    public static extern int GetClipboardFormatNameW(
        uint format,
        [NativeTypeName("LPWSTR")] char* lpszFormatName,
        int cchMaxCount
    );
    ...
    public static extern BOOL GetUpdatedClipboardFormats(
        [NativeTypeName("PUINT")] uint* lpuiFormats,
        uint cFormats,
        [NativeTypeName("PUINT")] uint* pcFormatsOut
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL CharToOemA(
        [NativeTypeName("LPCSTR")] sbyte* pSrc,
        [NativeTypeName("LPSTR")] sbyte* pDst
    );
    ...
    public static extern BOOL CharToOemW(
        [NativeTypeName("LPCWSTR")] char* pSrc,
        [NativeTypeName("LPSTR")] sbyte* pDst
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL OemToCharA(
        [NativeTypeName("LPCSTR")] sbyte* pSrc,
        [NativeTypeName("LPSTR")] sbyte* pDst
    );
    ...
    public static extern BOOL OemToCharW(
        [NativeTypeName("LPCSTR")] sbyte* pSrc,
        [NativeTypeName("LPWSTR")] char* pDst
    );
    ...
    public static extern BOOL CharToOemBuffA(
        [NativeTypeName("LPCSTR")] sbyte* lpszSrc,
        [NativeTypeName("LPSTR")] sbyte* lpszDst,
        [NativeTypeName("DWORD")] uint cchDstLength
    );
    ...
    public static extern BOOL CharToOemBuffW(
        [NativeTypeName("LPCWSTR")] char* lpszSrc,
        [NativeTypeName("LPSTR")] sbyte* lpszDst,
        [NativeTypeName("DWORD")] uint cchDstLength
    );
    ...
    public static extern BOOL OemToCharBuffW(
        [NativeTypeName("LPCSTR")] sbyte* lpszSrc,
        [NativeTypeName("LPWSTR")] char* lpszDst,
        [NativeTypeName("DWORD")] uint cchDstLength
    );
    ...
    public static extern uint CharUpperBuffA(
        [NativeTypeName("LPSTR")] sbyte* lpsz,
        [NativeTypeName("DWORD")] uint cchLength
    );
    ...
    public static extern uint CharUpperBuffW(
        [NativeTypeName("LPWSTR")] char* lpsz,
        [NativeTypeName("DWORD")] uint cchLength
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [return: NativeTypeName("LPSTR")]
    public static extern sbyte* CharPrevA(
        [NativeTypeName("LPCSTR")] sbyte* lpszStart,
        [NativeTypeName("LPCSTR")] sbyte* lpszCurrent
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [return: NativeTypeName("LPWSTR")]
    public static extern char* CharPrevW(
        [NativeTypeName("LPCWSTR")] char* lpszStart,
        [NativeTypeName("LPCWSTR")] char* lpszCurrent
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [return: NativeTypeName("LPSTR")]
    public static extern sbyte* CharNextExA(
        [NativeTypeName("WORD")] ushort CodePage,
        [NativeTypeName("LPCSTR")] sbyte* lpCurrentChar,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [return: NativeTypeName("LPSTR")]
    public static extern sbyte* CharPrevExA(
        [NativeTypeName("WORD")] ushort CodePage,
        [NativeTypeName("LPCSTR")] sbyte* lpStart,
        [NativeTypeName("LPCSTR")] sbyte* lpCurrentChar,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern int GetKeyNameTextA(
        [NativeTypeName("LONG")] int lParam,
        [NativeTypeName("LPSTR")] sbyte* lpString,
        int cchSize
    );
    ...
    public static extern int ToAscii(
        ...
        uint uScanCode,
        [NativeTypeName("const BYTE *")] byte* lpKeyState,
        [NativeTypeName("LPWORD")] ushort* lpChar,
        uint uFlags
    );
    ...
    public static extern void keybd_event(
        ...
        byte bScan,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("ULONG_PTR")] nuint dwExtraInfo
    );
    ...
    public static extern void mouse_event(
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("DWORD")] uint dx,
        [NativeTypeName("DWORD")] uint dy,
        [NativeTypeName("DWORD")] uint dwData,
        [NativeTypeName("ULONG_PTR")] nuint dwExtraInfo
    );
    ...
    public static extern uint SendInput(
        uint cInputs,
        [NativeTypeName("LPINPUT")] INPUT* pInputs,
        int cbSize
    );
    ...
    public static extern BOOL GetTouchInputInfo(
        ...
        uint cInputs,
        [NativeTypeName("PTOUCHINPUT")] TOUCHINPUT* pInputs,
        int cbSize
    );
    ...
    public static extern BOOL InitializeTouchInjection(
        [NativeTypeName("UINT32")] uint maxCount,
    ...
    public static extern BOOL InjectTouchInput(
        ...
        [NativeTypeName("const POINTER_TOUCH_INFO *")] POINTER_TOUCH_INFO* contacts
    );
    ...
    public static extern BOOL GetPointerType(
        ...
        [NativeTypeName("POINTER_INPUT_TYPE *")] uint* pointerType
    );
    ...
    public static extern BOOL GetPointerCursorId(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32 *")] uint* cursorId
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerInfoHistory(
        [NativeTypeName("UINT32")] uint pointerId,
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerFrameInfoHistory(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32 *")] uint* entriesCount,
        [NativeTypeName("UINT32 *")] uint* pointerCount,
        POINTER_INFO* pointerInfo
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerTouchInfoHistory(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32 *")] uint* entriesCount,
        POINTER_TOUCH_INFO* touchInfo
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerFrameTouchInfoHistory(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32 *")] uint* entriesCount,
        [NativeTypeName("UINT32 *")] uint* pointerCount,
        POINTER_TOUCH_INFO* touchInfo
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerFramePenInfo(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32 *")] uint* pointerCount,
        POINTER_PEN_INFO* penInfo
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerFramePenInfoHistory(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32 *")] uint* entriesCount,
        [NativeTypeName("UINT32 *")] uint* pointerCount,
        POINTER_PEN_INFO* penInfo
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL UnregisterPointerInputTarget(
        HWND hwnd,
        [NativeTypeName("POINTER_INPUT_TYPE")] uint pointerType
    );
    ...
    public static extern BOOL RegisterPointerInputTargetEx(
        HWND hwnd,
        [NativeTypeName("POINTER_INPUT_TYPE")] uint pointerType,
        BOOL fObserve
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SupportedOSPlatform("windows10.0")]
    public static extern BOOL UnregisterPointerInputTargetEx(
        HWND hwnd,
        [NativeTypeName("POINTER_INPUT_TYPE")] uint pointerType
    );
    ...
    public static extern HSYNTHETICPOINTERDEVICE CreateSyntheticPointerDevice(
        [NativeTypeName("POINTER_INPUT_TYPE")] uint pointerType,
        [NativeTypeName("ULONG")] uint maxCount,
    ...
    public static extern BOOL InjectSyntheticPointerInput(
        ...
        [NativeTypeName("const POINTER_TYPE_INFO *")] POINTER_TYPE_INFO* pointerInfo,
        [NativeTypeName("UINT32")] uint count
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL RegisterTouchHitTestingWindow(
        HWND hwnd,
        [NativeTypeName("ULONG")] uint value
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL EvaluateProximityToRect(
        [NativeTypeName("const RECT *")] RECT* controlBoundingBox,
        [NativeTypeName("const TOUCH_HIT_TESTING_INPUT *")]
            TOUCH_HIT_TESTING_INPUT* pHitTestingInput,
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL EvaluateProximityToPolygon(
        [NativeTypeName("UINT32")] uint numVertices,
        [NativeTypeName("const POINT *")] POINT* controlPolygon,
        [NativeTypeName("const TOUCH_HIT_TESTING_INPUT *")]
            TOUCH_HIT_TESTING_INPUT* pHitTestingInput,
        TOUCH_HIT_TESTING_PROXIMITY_EVALUATION* pProximityEval
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern LRESULT PackTouchHitTestingProximityEvaluation(
        [NativeTypeName("const TOUCH_HIT_TESTING_INPUT *")]
            TOUCH_HIT_TESTING_INPUT* pHitTestingInput,
        [NativeTypeName("const TOUCH_HIT_TESTING_PROXIMITY_EVALUATION *")]
            TOUCH_HIT_TESTING_PROXIMITY_EVALUATION* pProximityEval
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetWindowFeedbackSetting(
        HWND hwnd,
        FEEDBACK_TYPE feedback,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("UINT32 *")] uint* pSize,
        void* config
    );
    ...
    public static extern BOOL SetWindowFeedbackSetting(
        ...
        [NativeTypeName("const void *")] void* configuration
    );
    ...
    public static extern BOOL GetPointerInputTransform(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32")] uint historyCount,
    ...
    public static extern BOOL GetLastInputInfo(
        [NativeTypeName("PLASTINPUTINFO")] LASTINPUTINFO* plii
    );
    ...
    public static extern uint MsgWaitForMultipleObjects(
        ...
        BOOL fWaitAll,
        [NativeTypeName("DWORD")] uint dwMilliseconds,
        [NativeTypeName("DWORD")] uint dwWakeMask
    );
    ...
    public static extern nuint SetTimer(
        HWND hWnd,
        [NativeTypeName("UINT_PTR")] nuint nIDEvent,
        uint uElapse,
        [NativeTypeName("TIMERPROC")] delegate* unmanaged<HWND, uint, nuint, uint, void> lpTimerFunc
    );
    ...
    [return: NativeTypeName("UINT_PTR")]
    [SupportedOSPlatform("windows6.2")]
    public static extern nuint SetCoalescableTimer(
        HWND hWnd,
        [NativeTypeName("UINT_PTR")] nuint nIDEvent,
        uint uElapse,
        [NativeTypeName("TIMERPROC")]
            delegate* unmanaged<HWND, uint, nuint, uint, void> lpTimerFunc,
        [NativeTypeName("ULONG")] uint uToleranceDelay
    );
    ...
    public static extern HACCEL LoadAcceleratorsA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpTableName
    );
    ...
    public static extern HACCEL LoadAcceleratorsW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpTableName
    );
    ...
    public static extern HACCEL CreateAcceleratorTableA(
        [NativeTypeName("LPACCEL")] ACCEL* paccel,
        int cAccel
    );
    ...
    public static extern int CopyAcceleratorTableA(
        HACCEL hAccelSrc,
        [NativeTypeName("LPACCEL")] ACCEL* lpAccelDst,
        int cAccelEntries
    );
    ...
    public static extern HMENU LoadMenuA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpMenuName
    );
    ...
    public static extern HMENU LoadMenuW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpMenuName
    );
    ...
    public static extern HMENU LoadMenuIndirectA(
        [NativeTypeName("const MENUTEMPLATEA *")] void* lpMenuTemplate
    );
    ...
    public static extern HMENU LoadMenuIndirectW(
        [NativeTypeName("const MENUTEMPLATEW *")] void* lpMenuTemplate
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern BOOL ChangeMenuA(
        HMENU hMenu,
        uint cmd,
        [NativeTypeName("LPCSTR")] sbyte* lpszNewItem,
        uint cmdInsert,
        uint flags
    );
    ...
    public static extern BOOL ChangeMenuW(
        HMENU hMenu,
        uint cmd,
        [NativeTypeName("LPCWSTR")] char* lpszNewItem,
        uint cmdInsert,
        uint flags
    );
    ...
    public static extern BOOL InsertMenuA(
        ...
        uint uPosition,
        uint uFlags,
        [NativeTypeName("UINT_PTR")] nuint uIDNewItem,
        [NativeTypeName("LPCSTR")] sbyte* lpNewItem
    );
    ...
    public static extern BOOL InsertMenuW(
        ...
        uint uFlags,
        [NativeTypeName("UINT_PTR")] nuint uIDNewItem,
        [NativeTypeName("LPCWSTR")] char* lpNewItem
    );
    ...
    public static extern BOOL TrackPopupMenu(
        ...
        int nReserved,
        HWND hWnd,
        [NativeTypeName("const RECT *")] RECT* prcRect
    );
    ...
    public static extern BOOL TrackPopupMenuEx(
        ...
        int y,
        HWND hwnd,
        [NativeTypeName("LPTPMPARAMS")] TPMPARAMS* lptpm
    );
    ...
    public static extern BOOL CalculatePopupWindowPosition(
        [NativeTypeName("const POINT *")] POINT* anchorPoint,
        [NativeTypeName("const SIZE *")] SIZE* windowSize,
        uint flags,
        RECT* excludeRect,
    ...
    public static extern BOOL InsertMenuItemA(
        ...
        uint item,
        BOOL fByPosition,
        [NativeTypeName("LPCMENUITEMINFOA")] MENUITEMINFOA* lpmi
    );
    ...
    public static extern BOOL InsertMenuItemW(
        ...
        uint item,
        BOOL fByPosition,
        [NativeTypeName("LPCMENUITEMINFOW")] MENUITEMINFOW* lpmi
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL GetMenuItemInfoA(
        HMENU hmenu,
        uint item,
        BOOL fByPosition,
        [NativeTypeName("LPMENUITEMINFOA")] MENUITEMINFOA* lpmii
    );
    ...
    public static extern BOOL GetMenuItemInfoW(
        ...
        uint item,
        BOOL fByPosition,
        [NativeTypeName("LPMENUITEMINFOW")] MENUITEMINFOW* lpmii
    );
    ...
    public static extern BOOL SetMenuItemInfoA(
        ...
        uint item,
        BOOL fByPositon,
        [NativeTypeName("LPCMENUITEMINFOA")] MENUITEMINFOA* lpmii
    );
    ...
    public static extern BOOL SetMenuItemInfoW(
        ...
        uint item,
        BOOL fByPositon,
        [NativeTypeName("LPCMENUITEMINFOW")] MENUITEMINFOW* lpmii
    );
    ...
    public static extern BOOL GetMenuItemRect(
        ...
        HMENU hMenu,
        uint uItem,
        [NativeTypeName("LPRECT")] RECT* lprcItem
    );
    ...
    public static extern int DrawTextA(
        HDC hdc,
        [NativeTypeName("LPCSTR")] sbyte* lpchText,
        int cchText,
        [NativeTypeName("LPRECT")] RECT* lprc,
        uint format
    );
    ...
    public static extern int DrawTextW(
        HDC hdc,
        [NativeTypeName("LPCWSTR")] char* lpchText,
        int cchText,
        [NativeTypeName("LPRECT")] RECT* lprc,
        uint format
    );
    ...
    public static extern int DrawTextExA(
        HDC hdc,
        [NativeTypeName("LPSTR")] sbyte* lpchText,
        int cchText,
        [NativeTypeName("LPRECT")] RECT* lprc,
        uint format,
        [NativeTypeName("LPDRAWTEXTPARAMS")] DRAWTEXTPARAMS* lpdtp
    );
    ...
    public static extern int DrawTextExW(
        HDC hdc,
        [NativeTypeName("LPWSTR")] char* lpchText,
        int cchText,
        [NativeTypeName("LPRECT")] RECT* lprc,
        uint format,
        [NativeTypeName("LPDRAWTEXTPARAMS")] DRAWTEXTPARAMS* lpdtp
    ...
    public static extern BOOL GrayStringA(
        HDC hDC,
        HBRUSH hBrush,
        [NativeTypeName("GRAYSTRINGPROC")] delegate* unmanaged<HDC, LPARAM, int, BOOL> lpOutputFunc,
        LPARAM lpData,
        int nCount,
        int X,
        int Y,
    ...
    public static extern BOOL DrawStateA(
        HDC hdc,
        HBRUSH hbrFore,
        [NativeTypeName("DRAWSTATEPROC")]
            delegate* unmanaged<HDC, LPARAM, WPARAM, int, int, BOOL> qfnCallBack,
        LPARAM lData,
        WPARAM wData,
        int x,
        int y,
    ...
    public static extern int TabbedTextOutA(
        ...
        int chCount,
        int nTabPositions,
        [NativeTypeName("const INT *")] int* lpnTabStopPositions,
        int nTabOrigin
    );
    ...
    public static extern HDC BeginPaint(
        HWND hWnd,
        [NativeTypeName("LPPAINTSTRUCT")] PAINTSTRUCT* lpPaint
    );
    ...
    public static extern BOOL EndPaint(
        HWND hWnd,
        [NativeTypeName("const PAINTSTRUCT *")] PAINTSTRUCT* lpPaint
    );
    ...
    public static extern BOOL GetUpdateRect(
        HWND hWnd,
        [NativeTypeName("LPRECT")] RECT* lpRect,
        BOOL bErase
    );
    ...
    public static extern BOOL RedrawWindow(
        HWND hWnd,
        [NativeTypeName("const RECT *")] RECT* lprcUpdate,
        HRGN hrgnUpdate,
        uint flags
    );
    ...
    public static extern BOOL ScrollWindow(
        ...
        int YAmount,
        [NativeTypeName("const RECT *")] RECT* lpRect,
        [NativeTypeName("const RECT *")] RECT* lpClipRect
    );
    ...
    public static extern BOOL ScrollDC(
        ...
        int dx,
        int dy,
        [NativeTypeName("const RECT *")] RECT* lprcScroll,
        [NativeTypeName("const RECT *")] RECT* lprcClip,
        HRGN hrgnUpdate,
        [NativeTypeName("LPRECT")] RECT* lprcUpdate
    );
    ...
    public static extern int ScrollWindowEx(
        ...
        int dx,
        int dy,
        [NativeTypeName("const RECT *")] RECT* prcScroll,
        [NativeTypeName("const RECT *")] RECT* prcClip,
        HRGN hrgnUpdate,
        [NativeTypeName("LPRECT")] RECT* prcUpdate,
        uint flags
    );
    ...
    public static extern BOOL GetScrollRange(
        HWND hWnd,
        int nBar,
        [NativeTypeName("LPINT")] int* lpMinPos,
        [NativeTypeName("LPINT")] int* lpMaxPos
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL SetPropA(
        HWND hWnd,
        [NativeTypeName("LPCSTR")] sbyte* lpString,
        HANDLE hData
    );
    ...
    public static extern int EnumPropsExA(
        HWND hWnd,
        [NativeTypeName("PROPENUMPROCEXA")]
            delegate* unmanaged<HWND, sbyte*, HANDLE, nuint, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern int EnumPropsExW(
        HWND hWnd,
        [NativeTypeName("PROPENUMPROCEXW")]
            delegate* unmanaged<HWND, char*, HANDLE, nuint, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern int EnumPropsA(
        HWND hWnd,
        [NativeTypeName("PROPENUMPROCA")] delegate* unmanaged<HWND, sbyte*, HANDLE, BOOL> lpEnumFunc
    );
    ...
    public static extern int EnumPropsW(
        HWND hWnd,
        [NativeTypeName("PROPENUMPROCW")] delegate* unmanaged<HWND, char*, HANDLE, BOOL> lpEnumFunc
    );
    ...
    public static extern int MessageBoxA(
        HWND hWnd,
        [NativeTypeName("LPCSTR")] sbyte* lpText,
        [NativeTypeName("LPCSTR")] sbyte* lpCaption,
        uint uType
    );
    ...
    public static extern int MessageBoxW(
        HWND hWnd,
        [NativeTypeName("LPCWSTR")] char* lpText,
        [NativeTypeName("LPCWSTR")] char* lpCaption,
        uint uType
    );
    ...
    public static extern int MessageBoxExA(
        ...
        [NativeTypeName("LPCSTR")] sbyte* lpCaption,
        uint uType,
        [NativeTypeName("WORD")] ushort wLanguageId
    );
    ...
    public static extern int MessageBoxIndirectA(
        [NativeTypeName("const MSGBOXPARAMSA *")] MSGBOXPARAMSA* lpmbp
    );
    ...
    public static extern int MessageBoxIndirectW(
        [NativeTypeName("const MSGBOXPARAMSW *")] MSGBOXPARAMSW* lpmbp
    );
    ...
    public static extern BOOL LogicalToPhysicalPoint(
        HWND hWnd,
        [NativeTypeName("LPPOINT")] POINT* lpPoint
    );
    ...
    public static extern int MapWindowPoints(
        HWND hWndFrom,
        HWND hWndTo,
        [NativeTypeName("LPPOINT")] POINT* lpPoints,
        uint cPoints
    );
    ...
    public static extern BOOL SetSysColors(
        int cElements,
        [NativeTypeName("const INT *")] int* lpaElements,
        [NativeTypeName("const COLORREF *")] COLORREF* lpaRgbValues
    );
    ...
    public static extern int FillRect(
        HDC hDC,
        [NativeTypeName("const RECT *")] RECT* lprc,
        HBRUSH hbr
    );
    ...
    public static extern BOOL CopyRect(
        ...
        [NativeTypeName("const RECT *")] RECT* lprcSrc
    );
    ...
    public static extern BOOL IntersectRect(
        [NativeTypeName("LPRECT")] RECT* lprcDst,
        [NativeTypeName("const RECT *")] RECT* lprcSrc1,
        [NativeTypeName("const RECT *")] RECT* lprcSrc2
    );
    ...
    public static extern BOOL EqualRect(
        [NativeTypeName("const RECT *")] RECT* lprc1,
        [NativeTypeName("const RECT *")] RECT* lprc2
    );
    ...
    public static extern ushort SetWindowWord(
        HWND hWnd,
        int nIndex,
        [NativeTypeName("WORD")] ushort wNewWord
    );
    ...
    public static extern int SetWindowLongA(
        HWND hWnd,
        int nIndex,
        [NativeTypeName("LONG")] int dwNewLong
    );
    ...
    public static extern BOOL GetProcessDefaultLayout(
        [NativeTypeName("DWORD *")] uint* pdwDefaultLayout
    );
    ...
    public static extern BOOL SetProcessDefaultLayout(
        [NativeTypeName("DWORD")] uint dwDefaultLayout
    );
    ...
    public static extern BOOL EnumChildWindows(
        HWND hWndParent,
        [NativeTypeName("WNDENUMPROC")] delegate* unmanaged<HWND, LPARAM, BOOL> lpEnumFunc,
        LPARAM lParam
    );
    ...
    public static extern HWND FindWindowExA(
        ...
        HWND hWndChildAfter,
        [NativeTypeName("LPCSTR")] sbyte* lpszClass,
        [NativeTypeName("LPCSTR")] sbyte* lpszWindow
    );
    ...
    public static extern HWND FindWindowExW(
        ...
        HWND hWndChildAfter,
        [NativeTypeName("LPCWSTR")] char* lpszClass,
        [NativeTypeName("LPCWSTR")] char* lpszWindow
    );
    ...
    public static extern int GetClassNameA(
        HWND hWnd,
        [NativeTypeName("LPSTR")] sbyte* lpClassName,
        int nMaxCount
    );
    ...
    public static extern int GetClassNameW(
        HWND hWnd,
        [NativeTypeName("LPWSTR")] char* lpClassName,
        int nMaxCount
    );
    ...
    public static extern uint GetWindowThreadProcessId(
        HWND hWnd,
        [NativeTypeName("LPDWORD")] uint* lpdwProcessId
    );
    ...
    public static extern HHOOK SetWindowsHookA(
        int nFilterType,
        [NativeTypeName("HOOKPROC")] delegate* unmanaged<int, WPARAM, LPARAM, LRESULT> pfnFilterProc
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern BOOL UnhookWindowsHook(
        int nCode,
        [NativeTypeName("HOOKPROC")] delegate* unmanaged<int, WPARAM, LPARAM, LRESULT> pfnFilterProc
    );
    ...
    public static extern HHOOK SetWindowsHookExA(
        int idHook,
        [NativeTypeName("HOOKPROC")] delegate* unmanaged<int, WPARAM, LPARAM, LRESULT> lpfn,
        HINSTANCE hmod,
        [NativeTypeName("DWORD")] uint dwThreadId
    );
    ...
    public static extern HBITMAP LoadBitmapA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpBitmapName
    );
    ...
    public static extern HBITMAP LoadBitmapW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpBitmapName
    );
    ...
    public static extern HCURSOR LoadCursorA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpCursorName
    );
    ...
    public static extern HCURSOR LoadCursorW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpCursorName
    );
    ...
    public static extern HCURSOR CreateCursor(
        ...
        int nWidth,
        int nHeight,
        [NativeTypeName("const void *")] void* pvANDPlane,
        [NativeTypeName("const void *")] void* pvXORPlane
    );
    ...
    public static extern HICON LoadIconA(
        HINSTANCE hInstance,
        [NativeTypeName("LPCSTR")] sbyte* lpIconName
    );
    ...
    public static extern HICON LoadIconW(
        HINSTANCE hInstance,
        [NativeTypeName("LPCWSTR")] char* lpIconName
    );
    ...
    public static extern uint PrivateExtractIconsW(
        [NativeTypeName("LPCWSTR")] char* szFileName,
        int nIconIndex,
        int cxIcon,
        int cyIcon,
        HICON* phicon,
    ...
    public static extern HICON CreateIcon(
        ...
        byte cPlanes,
        byte cBitsPixel,
        [NativeTypeName("const BYTE *")] byte* lpbANDbits,
        [NativeTypeName("const BYTE *")] byte* lpbXORbits
    );
    ...
    public static extern int LookupIconIdFromDirectory(
        [NativeTypeName("PBYTE")] byte* presbits,
        BOOL fIcon
    );
    ...
    public static extern HICON CreateIconFromResource(
        [NativeTypeName("PBYTE")] byte* presbits,
        [NativeTypeName("DWORD")] uint dwResSize,
        BOOL fIcon,
        [NativeTypeName("DWORD")] uint dwVer
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern HANDLE LoadImageA(
        HINSTANCE hInst,
    ...
    public static extern HANDLE LoadImageW(
        HINSTANCE hInst,
        [NativeTypeName("LPCWSTR")] char* name,
        uint type,
        int cx,
        int cy,
        uint fuLoad
    ...
    public static extern HICON CreateIconIndirect(
        [NativeTypeName("PICONINFO")] ICONINFO* piconinfo
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern BOOL GetIconInfoExA(
        HICON hicon,
        [NativeTypeName("PICONINFOEXA")] ICONINFOEXA* piconinfo
    );

    /// <include file='Windows.xml' path='doc/member[@name="Windows.GetIconInfoExW"]/*'/>

    [DllImport("user32", ExactSpelling = true)]
    public static extern BOOL GetIconInfoExW(
        HICON hicon,
        [NativeTypeName("PICONINFOEXW")] ICONINFOEXW* piconinfo
    );
    ...
    public static extern int DlgDirListA(
        HWND hDlg,
        [NativeTypeName("LPSTR")] sbyte* lpPathSpec,
        int nIDListBox,
        int nIDStaticPath,
        uint uFileType
    );
    ...
    public static extern int DlgDirListW(
        HWND hDlg,
        [NativeTypeName("LPWSTR")] char* lpPathSpec,
        int nIDListBox,
        int nIDStaticPath,
        uint uFileType
    );
    ...
    public static extern int SetScrollInfo(
        HWND hwnd,
        int nBar,
        [NativeTypeName("LPCSCROLLINFO")] SCROLLINFO* lpsi,
        BOOL redraw
    );
    ...
    public static extern BOOL GetScrollInfo(
        HWND hwnd,
        int nBar,
        [NativeTypeName("LPSCROLLINFO")] SCROLLINFO* lpsi
    );

    /// <include file='Windows.xml' path='doc/member[@name="Windows.DefFrameProcA"]/*'/>

    [DllImport("user32", ExactSpelling = true)]
    public static extern LRESULT DefFrameProcA(
        HWND hWnd,
        HWND hWndMDIClient,
        uint uMsg,
        WPARAM wParam,
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern LRESULT DefFrameProcW(
        HWND hWnd,
        HWND hWndMDIClient,
        uint uMsg,
        WPARAM wParam,
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern LRESULT DefMDIChildProcA(
        HWND hWnd,
        uint uMsg,
        WPARAM wParam,
        LPARAM lParam
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern LRESULT DefMDIChildProcW(
        HWND hWnd,
        uint uMsg,
        WPARAM wParam,
        LPARAM lParam
    ...
    public static extern ushort TileWindows(
        ...
        [NativeTypeName("const RECT *")] RECT* lpRect,
        uint cKids,
        [NativeTypeName("const HWND *")] HWND* lpKids
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL WinHelpA(
        HWND hWndMain,
        [NativeTypeName("LPCSTR")] sbyte* lpszHelp,
        uint uCommand,
        [NativeTypeName("ULONG_PTR")] nuint dwData
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    [SetsLastSystemError]
    public static extern BOOL WinHelpW(
        HWND hWndMain,
        [NativeTypeName("LPCWSTR")] char* lpszHelp,
        uint uCommand,
        [NativeTypeName("ULONG_PTR")] nuint dwData
    );
    ...
    public static extern uint GetGuiResources(
        HANDLE hProcess,
        [NativeTypeName("DWORD")] uint uiFlags
    );
    ...
    public static extern int ChangeDisplaySettingsExA(
        [NativeTypeName("LPCSTR")] sbyte* lpszDeviceName,
        DEVMODEA* lpDevMode,
        HWND hwnd,
        [NativeTypeName("DWORD")] uint dwflags,
        [NativeTypeName("LPVOID")] void* lParam
    );
    ...
    public static extern int ChangeDisplaySettingsExW(
        [NativeTypeName("LPCWSTR")] char* lpszDeviceName,
        DEVMODEW* lpDevMode,
        HWND hwnd,
        [NativeTypeName("DWORD")] uint dwflags,
        [NativeTypeName("LPVOID")] void* lParam
    ...
    public static extern BOOL EnumDisplaySettingsA(
        [NativeTypeName("LPCSTR")] sbyte* lpszDeviceName,
        [NativeTypeName("DWORD")] uint iModeNum,
        DEVMODEA* lpDevMode
    );
    ...
    public static extern BOOL EnumDisplayDevicesA(
        [NativeTypeName("LPCSTR")] sbyte* lpDevice,
        [NativeTypeName("DWORD")] uint iDevNum,
        [NativeTypeName("PDISPLAY_DEVICEA")] DISPLAY_DEVICEA* lpDisplayDevice,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern BOOL EnumDisplayDevicesW(
        [NativeTypeName("LPCWSTR")] char* lpDevice,
        [NativeTypeName("DWORD")] uint iDevNum,
        [NativeTypeName("PDISPLAY_DEVICEW")] DISPLAY_DEVICEW* lpDisplayDevice,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern int GetDisplayConfigBufferSizes(
        ...
        [NativeTypeName("UINT32 *")] uint* numPathArrayElements,
        [NativeTypeName("UINT32 *")] uint* numModeInfoArrayElements
    );
    ...
    public static extern BOOL SystemParametersInfoA(
        uint uiAction,
        uint uiParam,
        [NativeTypeName("PVOID")] void* pvParam,
        uint fWinIni
    );
    ...
    public static extern void SetLastErrorEx(
        [NativeTypeName("DWORD")] uint dwErrCode,
    ...
    public static extern int InternalGetWindowText(
        HWND hWnd,
        [NativeTypeName("LPWSTR")] char* pString,
        int cchMaxCount
    );
    ...
    public static extern HMONITOR MonitorFromRect(
        [NativeTypeName("LPCRECT")] RECT* lprc,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    [DllImport("user32", ExactSpelling = true)]
    public static extern BOOL GetMonitorInfoA(
        HMONITOR hMonitor,
        [NativeTypeName("LPMONITORINFO")] MONITORINFO* lpmi
    );
    ...
    public static extern BOOL EnumDisplayMonitors(
        HDC hdc,
        [NativeTypeName("LPCRECT")] RECT* lprcClip,
        [NativeTypeName("MONITORENUMPROC")]
            delegate* unmanaged<HMONITOR, HDC, RECT*, LPARAM, BOOL> lpfnEnum,
        LPARAM dwData
    );
    ...
    public static extern void NotifyWinEvent(
        ...
        HWND hwnd,
        [NativeTypeName("LONG")] int idObject,
        [NativeTypeName("LONG")] int idChild
    );
    ...
    public static extern HWINEVENTHOOK SetWinEventHook(
        [NativeTypeName("DWORD")] uint eventMin,
        [NativeTypeName("DWORD")] uint eventMax,
        HMODULE hmodWinEventProc,
        [NativeTypeName("WINEVENTPROC")]
            delegate* unmanaged<
            HWINEVENTHOOK,
            uint,
            HWND,
        ...
        [NativeTypeName("DWORD")] uint idProcess,
        [NativeTypeName("DWORD")] uint idThread,
        [NativeTypeName("DWORD")] uint dwFlags
    );
    ...
    public static extern BOOL GetGUIThreadInfo(
        [NativeTypeName("DWORD")] uint idThread,
        [NativeTypeName("PGUITHREADINFO")] GUITHREADINFO* pgui
    );
    ...
    public static extern uint GetWindowModuleFileNameA(
        HWND hwnd,
        [NativeTypeName("LPSTR")] sbyte* pszFileName,
        uint cchFileNameMax
    );
    ...
    public static extern uint GetWindowModuleFileNameW(
        HWND hwnd,
        [NativeTypeName("LPWSTR")] char* pszFileName,
        uint cchFileNameMax
    );
    ...
    public static extern BOOL GetWindowInfo(
        HWND hwnd,
        [NativeTypeName("PWINDOWINFO")] WINDOWINFO* pwi
    );
    ...
    public static extern BOOL GetTitleBarInfo(
        HWND hwnd,
        [NativeTypeName("PTITLEBARINFO")] TITLEBARINFO* pti
    );
    ...
    public static extern BOOL GetMenuBarInfo(
        HWND hwnd,
        [NativeTypeName("LONG")] int idObject,
        [NativeTypeName("LONG")] int idItem,
        [NativeTypeName("PMENUBARINFO")] MENUBARINFO* pmbi
    );
    ...
    public static extern BOOL GetScrollBarInfo(
        HWND hwnd,
        [NativeTypeName("LONG")] int idObject,
        [NativeTypeName("PSCROLLBARINFO")] SCROLLBARINFO* psbi
    );
    ...
    public static extern BOOL GetComboBoxInfo(
        HWND hwndCombo,
        [NativeTypeName("PCOMBOBOXINFO")] COMBOBOXINFO* pcbi
    );
    ...
    public static extern uint RealGetWindowClassA(
        HWND hwnd,
        [NativeTypeName("LPSTR")] sbyte* ptszClassName,
    ...
    public static extern uint RealGetWindowClassW(
        HWND hwnd,
        [NativeTypeName("LPWSTR")] char* ptszClassName,
        uint cchClassNameMax
    );
    ...
    public static extern BOOL GetAltTabInfoA(
        HWND hwnd,
        int iItem,
        [NativeTypeName("PALTTABINFO")] ALTTABINFO* pati,
        [NativeTypeName("LPSTR")] sbyte* pszItemText,
        uint cchItemText
    );
    ...
    public static extern BOOL GetAltTabInfoW(
        ...
        int iItem,
        [NativeTypeName("PALTTABINFO")] ALTTABINFO* pati,
        [NativeTypeName("LPWSTR")] char* pszItemText,
        uint cchItemText
    );
    ...
    public static extern uint GetRawInputData(
        ...
        [NativeTypeName("PUINT")] uint* pcbSize,
        uint cbSizeHeader
    );
    ...
    public static extern uint GetRawInputBuffer(
        [NativeTypeName("PRAWINPUT")] RAWINPUT* pData,
        [NativeTypeName("PUINT")] uint* pcbSize,
        uint cbSizeHeader
    );
    ...
    public static extern BOOL RegisterRawInputDevices(
        [NativeTypeName("PCRAWINPUTDEVICE")] RAWINPUTDEVICE* pRawInputDevices,
        uint uiNumDevices,
        uint cbSize
    );
    ...
    public static extern uint GetRegisteredRawInputDevices(
        [NativeTypeName("PRAWINPUTDEVICE")] RAWINPUTDEVICE* pRawInputDevices,
        [NativeTypeName("PUINT")] uint* puiNumDevices,
        uint cbSize
    );
    ...
    public static extern uint GetRawInputDeviceList(
        [NativeTypeName("PRAWINPUTDEVICELIST")] RAWINPUTDEVICELIST* pRawInputDeviceList,
        [NativeTypeName("PUINT")] uint* puiNumDevices,
        uint cbSize
    );
    ...
    public static extern LRESULT DefRawInputProc(
        [NativeTypeName("PRAWINPUT *")] RAWINPUT** paRawInput,
        int nInput,
        uint cbSizeHeader
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerDevices(
        [NativeTypeName("UINT32 *")] uint* deviceCount,
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerDeviceProperties(
        HANDLE device,
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetPointerDeviceCursors(
        HANDLE device,
        [NativeTypeName("UINT32 *")] uint* cursorCount,
    ...
    public static extern BOOL GetRawPointerDeviceData(
        [NativeTypeName("UINT32")] uint pointerId,
        [NativeTypeName("UINT32")] uint historyCount,
        [NativeTypeName("UINT32")] uint propertiesCount,
        POINTER_DEVICE_PROPERTY* pProperties,
        [NativeTypeName("LONG *")] int* pValues
    );
    ...
    public static extern BOOL ChangeWindowMessageFilterEx(
        HWND hwnd,
        uint message,
        [NativeTypeName("DWORD")] uint action,
        [NativeTypeName("PCHANGEFILTERSTRUCT")] CHANGEFILTERSTRUCT* pChangeFilterStruct
    );
    ...
    public static extern BOOL GetGestureInfo(
        ...
        [NativeTypeName("PGESTUREINFO")] GESTUREINFO* pGestureInfo
    );
    ...
    public static extern BOOL GetGestureExtraArgs(
        HGESTUREINFO hGestureInfo,
        uint cbExtraArgs,
        [NativeTypeName("PBYTE")] byte* pExtraArgs
    );
    ...
    public static extern BOOL SetGestureConfig(
        ...
        uint cIDs,
        [NativeTypeName("PGESTURECONFIG")] GESTURECONFIG* pGestureConfig,
        uint cbSize
    );
    ...
    public static extern BOOL GetGestureConfig(
        ...
        [NativeTypeName("DWORD")] uint dwReserved,
        [NativeTypeName("DWORD")] uint dwFlags,
        [NativeTypeName("PUINT")] uint* pcIDs,
        [NativeTypeName("PGESTURECONFIG")] GESTURECONFIG* pGestureConfig,
        uint cbSize
    );
    ...
    public static extern BOOL ShutdownBlockReasonCreate(
        HWND hWnd,
        [NativeTypeName("LPCWSTR")] char* pwszReason
    );
    ...
    public static extern BOOL ShutdownBlockReasonQuery(
        HWND hWnd,
        [NativeTypeName("LPWSTR")] char* pwszBuff,
        [NativeTypeName("DWORD *")] uint* pcchBuff
    );
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows6.2")]
    public static extern BOOL GetCurrentInputMessageSource(
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows10.0.22621.0")]
    public static extern BOOL SetAdditionalForegroundBoostProcesses(
        HWND topLevelWindow,
        [NativeTypeName("DWORD")] uint processHandleCount,
    ...
    [SetsLastSystemError]
    [SupportedOSPlatform("windows10.0.22621.0")]
    public static extern BOOL RegisterForTooltipDismissNotification(
        HWND hWnd,
    ...
    public static char* ISOLATIONAWARE_NOSTATICIMPORT_MANIFEST_RESOURCE_ID =>
        ((char*)((nuint)((ushort)(3))));
    ...
    public static char* ISOLATIONPOLICY_BROWSER_MANIFEST_RESOURCE_ID =>
        ((char*)((nuint)((ushort)(5))));
    ...
    public static delegate* <
        ...
        uint,
        SECURITY_ATTRIBUTES*,
        HDESK> CreateDesktop => &CreateDesktopW;
    ...
    public static delegate* <
        ...
        uint,
        void*,
        HDESK> CreateDesktopEx => &CreateDesktopExW;
    ...
    public static delegate* <
        HWINSTA,
        delegate* unmanaged<char*, LPARAM, BOOL>,
        LPARAM,
        BOOL> EnumDesktops => &EnumDesktopsW;
    ...
    public static delegate* <
        ...
        uint,
        SECURITY_ATTRIBUTES*,
        HWINSTA> CreateWindowStation => &CreateWindowStationW;
    ...
    public static delegate* <
        delegate* unmanaged<char*, LPARAM, BOOL>,
        LPARAM,
        BOOL> EnumWindowStations => &EnumWindowStationsW;
    ...
    public static delegate* <HANDLE, int, void*, uint, uint*, BOOL> GetUserObjectInformation =>
        &GetUserObjectInformationW;

    [NativeTypeName("#define SetUserObjectInformation SetUserObjectInformationW")]
    public static delegate* <HANDLE, int, void*, uint, BOOL> SetUserObjectInformation =>
    ...
    public static delegate* <
        ...
        uint,
        nuint*,
        LRESULT> SendMessageTimeout => &SendMessageTimeoutW;

    [NativeTypeName("#define SendNotifyMessage SendNotifyMessageW")]
    public static delegate* <HWND, uint, WPARAM, LPARAM, BOOL> SendNotifyMessage =>
        &SendNotifyMessageW;
    ...
    public static delegate* <
        ...
        WPARAM,
        LPARAM,
        delegate* unmanaged<HWND, uint, nuint, LRESULT, void>,
        nuint,
        BOOL> SendMessageCallback => &SendMessageCallbackW;
    ...
    public static delegate* <
        ...
        LPARAM,
        BSMINFO*,
        int> BroadcastSystemMessageEx => &BroadcastSystemMessageExW;

    [NativeTypeName("#define BroadcastSystemMessage BroadcastSystemMessageW")]
    public static delegate* <uint, uint*, uint, WPARAM, LPARAM, int> BroadcastSystemMessage =>
    ...
    public static delegate* <HANDLE, void*, uint, HDEVNOTIFY> RegisterDeviceNotification =>
    ...
    public static delegate* <uint, uint, WPARAM, LPARAM, BOOL> PostThreadMessage =>
        &PostThreadMessageW;
    ...
    public static delegate* <
        delegate* unmanaged<HWND, uint, WPARAM, LPARAM, LRESULT>,
        HWND,
        uint,
        WPARAM,
        LPARAM,
        LRESULT> CallWindowProc => &CallWindowProcW;
    ...
    public static delegate* <HINSTANCE, char*, WNDCLASSEXW*, BOOL> GetClassInfoEx =>
        &GetClassInfoExW;
    ...
    public static delegate* <
        ...
        HINSTANCE,
        void*,
        HWND> CreateWindowEx => &CreateWindowExW;
    ...
    public static delegate* <
        ...
        char*,
        HWND,
        delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint>,
        LPARAM,
        HWND> CreateDialogParam => &CreateDialogParamW;
    ...
    public static delegate* <
        ...
        delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint>,
        LPARAM,
        HWND> CreateDialogIndirectParam => &CreateDialogIndirectParamW;
    ...
    public static delegate* <
        ...
        delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint>,
        LPARAM,
        nint> DialogBoxParam => &DialogBoxParamW;
    ...
    public static delegate* <
        ...
        delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint>,
        LPARAM,
        nint> DialogBoxIndirectParam => &DialogBoxIndirectParamW;
    ...
    public static delegate* <HWND, int, uint, WPARAM, LPARAM, LRESULT> SendDlgItemMessage =>
        &SendDlgItemMessageW;
    ...
    public static delegate* <uint, char*, int, int> GetClipboardFormatName =>
    ...
    public static delegate* <ACCEL*, int, HACCEL> CreateAcceleratorTable =>
        &CreateAcceleratorTableW;

    [NativeTypeName("#define CopyAcceleratorTable CopyAcceleratorTableW")]
    public static delegate* <HACCEL, ACCEL*, int, int> CopyAcceleratorTable =>
        &CopyAcceleratorTableW;

    [NativeTypeName("#define TranslateAccelerator TranslateAcceleratorW")]
    public static delegate* <HWND, HACCEL, MSG*, int> TranslateAccelerator =>
    ...
    public const int MENU_WRITE_ACCESS = (
        ((0x00020000))
        | (0x0008)
        | (0x0010)
        | (0x0020)
    ...
    public const int MENU_ALL_ACCESS = (
        (0x001F0000)
        | (((0x00020000)) | (0x0001) | (0x0002) | (0x0004))
        | (
            ((0x00020000))
            | (0x0008)
            | (0x0010)
    ...
    public static delegate* <HMENU, uint, BOOL, MENUITEMINFOW*, BOOL> InsertMenuItem =>
        &InsertMenuItemW;

    [NativeTypeName("#define GetMenuItemInfo GetMenuItemInfoW")]
    public static delegate* <HMENU, uint, BOOL, MENUITEMINFOW*, BOOL> GetMenuItemInfo =>
        &GetMenuItemInfoW;

    [NativeTypeName("#define SetMenuItemInfo SetMenuItemInfoW")]
    public static delegate* <HMENU, uint, BOOL, MENUITEMINFOW*, BOOL> SetMenuItemInfo =>
        &SetMenuItemInfoW;
    ...
    public static delegate* <HDC, char*, int, RECT*, uint, DRAWTEXTPARAMS*, int> DrawTextEx =>
        &DrawTextExW;
    ...
    public static delegate* <
        HDC,
        HBRUSH,
        delegate* unmanaged<HDC, LPARAM, int, BOOL>,
        LPARAM,
        int,
        int,
        int,
    ...
    public static delegate* <
        HDC,
        HBRUSH,
        delegate* unmanaged<HDC, LPARAM, WPARAM, int, int, BOOL>,
        LPARAM,
        WPARAM,
        int,
        int,
        ...
        int,
        uint,
        BOOL> DrawState => &DrawStateW;

    [NativeTypeName("#define TabbedTextOut TabbedTextOutW")]
    public static delegate* <HDC, int, int, char*, int, int, int*, int, int> TabbedTextOut =>
        &TabbedTextOutW;

    [NativeTypeName("#define GetTabbedTextExtent GetTabbedTextExtentW")]
    public static delegate* <HDC, char*, int, int, int*, uint> GetTabbedTextExtent =>
    ...
    public static delegate* <
        HWND,
        delegate* unmanaged<HWND, char*, HANDLE, nuint, BOOL>,
        LPARAM,
        int> EnumPropsEx => &EnumPropsExW;

    [NativeTypeName("#define EnumProps EnumPropsW")]
    public static delegate* <HWND, delegate* unmanaged<HWND, char*, HANDLE, BOOL>, int> EnumProps =>
        &EnumPropsW;
    ...
    public static delegate* <
        int,
        delegate* unmanaged<int, WPARAM, LPARAM, LRESULT>,
        HHOOK> SetWindowsHook => &SetWindowsHookW;
    ...
    public static delegate* <
        ...
        HINSTANCE,
        uint,
        HHOOK> SetWindowsHookEx => &SetWindowsHookExW;
    ...
    public static delegate* <
        ...
        uint,
        uint,
        uint> PrivateExtractIcons => &PrivateExtractIconsW;
    ...
    public static delegate* <HINSTANCE, char*, uint, int, int, uint, HANDLE> LoadImage =>
        &LoadImageW;
    ...
    public static uint DWLP_USER =>
        unchecked(
            0
            + (uint)(sizeof(LRESULT))
            + (uint)(sizeof(delegate* unmanaged<HWND, uint, WPARAM, LPARAM, nint>))
        );
    ...
    public static delegate* <HWND, char*, int, int, uint, int> DlgDirListComboBox =>
        &DlgDirListComboBoxW;

    [NativeTypeName("#define DlgDirSelectComboBoxEx DlgDirSelectComboBoxExW")]
    public static delegate* <HWND, char*, int, int, BOOL> DlgDirSelectComboBoxEx =>
    ...
    public static delegate* <HWND, HWND, uint, WPARAM, LPARAM, LRESULT> DefFrameProc =>
        &DefFrameProcW;

    [NativeTypeName("#define DefMDIChildProc DefMDIChildProcW")]
    public static delegate* <HWND, uint, WPARAM, LPARAM, LRESULT> DefMDIChildProc =>
        &DefMDIChildProcW;
    ...
    public static delegate* <
        ...
        HINSTANCE,
        LPARAM,
        HWND> CreateMDIWindow => &CreateMDIWindowW;
    ...
    public static delegate* <char*, DEVMODEW*, HWND, uint, void*, int> ChangeDisplaySettingsEx =>
        &ChangeDisplaySettingsExW;

    [NativeTypeName("#define EnumDisplaySettings EnumDisplaySettingsW")]
    public static delegate* <char*, uint, DEVMODEW*, BOOL> EnumDisplaySettings =>
        &EnumDisplaySettingsW;

    [NativeTypeName("#define EnumDisplaySettingsEx EnumDisplaySettingsExW")]
    public static delegate* <char*, uint, DEVMODEW*, uint, BOOL> EnumDisplaySettingsEx =>
    ...
    public static delegate* <char*, uint, DISPLAY_DEVICEW*, uint, BOOL> EnumDisplayDevices =>
        &EnumDisplayDevicesW;
    ...
    public static delegate* <uint, uint, void*, uint, BOOL> SystemParametersInfo =>
    ...
    public static delegate* <HWND, char*, uint, uint> GetWindowModuleFileName =>
    ...
    public static delegate* <HWND, int, ALTTABINFO*, char*, uint, BOOL> GetAltTabInfo =>
        &GetAltTabInfoW;
    ...
    public static delegate* <HANDLE, uint, void*, uint*, uint> GetRawInputDeviceInfo =>
