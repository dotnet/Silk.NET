...
public unsafe partial struct IXmlAttribute : IXmlAttribute.Interface, INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, uint*, Guid**, int>)((*lpVtbl)[3]))(
            this,
            iidCount,
            iids
        );
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, HSTRING*, int>)((*lpVtbl)[4]))(this, className);
    }
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, TrustLevel*, int>)((*lpVtbl)[5]))(
            this,
            trustLevel
        );
    }
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, HSTRING*, int>)((*lpVtbl)[6]))(this, value);
    }
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, byte*, int>)((*lpVtbl)[7]))(this, value);
    }
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, HSTRING*, int>)((*lpVtbl)[8]))(this, value);
    }
    ...
    {
        return ((delegate* unmanaged<IXmlAttribute, HSTRING, int>)((*lpVtbl)[9]))(this, value);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        public delegate* unmanaged<TSelf*, byte*, int> get_Specified;
    ...
    /// <summary>Downcasts <see cref = "Silk.NET.WinRT.IInspectable"/> to <see cref = "IXmlAttribute"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.WinRT.IInspectable"/> instance to be converted </param>
    public static explicit operator IXmlAttribute(Silk.NET.WinRT.IInspectable value)
    {
        return new IXmlAttribute(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IXmlAttribute"/> to <see cref = "Silk.NET.WinRT.IInspectable"/>.</summary>
    /// <param name = "value">The <see cref = "IXmlAttribute"/> instance to be converted </param>
    public static implicit operator Silk.NET.WinRT.IInspectable(IXmlAttribute value)
    {
