...
public unsafe partial struct IAppointmentManagerStatics2
    : IAppointmentManagerStatics2.Interface,
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IAppointmentManagerStatics2));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<IAppointmentManagerStatics2, Guid*, void**, int>)((*lpVtbl)[0])
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IAppointmentManagerStatics2, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IAppointmentManagerStatics2, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IAppointmentManagerStatics2, uint*, Guid**, int>)((*lpVtbl)[3])
        )(this, iidCount, iids);
    }
    ...
    {
        return ((delegate* unmanaged<IAppointmentManagerStatics2, HSTRING*, int>)((*lpVtbl)[4]))(
            this,
            className
        );
    }
    ...
    {
        return ((delegate* unmanaged<IAppointmentManagerStatics2, TrustLevel*, int>)((*lpVtbl)[5]))(
            this,
            trustLevel
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IAppointmentManagerStatics2, HSTRING, IAsyncAction*, int>)(
                (*lpVtbl)[6]
            )
        )(this, appointmentId, asyncAction);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                IAsyncAction*,
                int>)((*lpVtbl)[7])
        )(this, appointmentId, instanceStartDate, asyncAction);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IAppointmentManagerStatics2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IAppointmentManagerStatics2(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.WinRT.IInspectable"/> to <see cref = "IAppointmentManagerStatics2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.WinRT.IInspectable"/> instance to be converted </param>
    public static explicit operator IAppointmentManagerStatics2(Silk.NET.WinRT.IInspectable value)
    {
        return new IAppointmentManagerStatics2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IAppointmentManagerStatics2"/> to <see cref = "Silk.NET.WinRT.IInspectable"/>.</summary>
    /// <param name = "value">The <see cref = "IAppointmentManagerStatics2"/> instance to be converted </param>
    public static implicit operator Silk.NET.WinRT.IInspectable(IAppointmentManagerStatics2 value)
    {
        return new Silk.NET.WinRT.IInspectable(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IAppointmentManagerStatics2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IAppointmentManagerStatics2(Silk.NET.Windows.IUnknown value)
    {
        return new IAppointmentManagerStatics2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IAppointmentManagerStatics2"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IAppointmentManagerStatics2"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IAppointmentManagerStatics2 value)
    {
