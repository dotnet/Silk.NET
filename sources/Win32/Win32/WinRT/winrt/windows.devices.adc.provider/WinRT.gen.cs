...
public static partial class WinRT
{
    ...
    public const string InterfaceName_Windows_Devices_Adc_Provider_IAdcControllerProvider =
        "Windows.Devices.Adc.Provider.IAdcControllerProvider";

    [NativeTypeName("const WCHAR[42]")]
    public const string InterfaceName_Windows_Devices_Adc_Provider_IAdcProvider =
