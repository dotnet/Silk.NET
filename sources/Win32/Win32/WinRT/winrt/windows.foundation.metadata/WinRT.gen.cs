...
public static partial class WinRT
{
    ...
    public const string InterfaceName_Windows_Foundation_Metadata_IApiInformationStatics =
        "Windows.Foundation.Metadata.IApiInformationStatics";

    [NativeTypeName("const WCHAR[43]")]
    public const string RuntimeClass_Windows_Foundation_Metadata_ApiInformation =
