...
public static partial class WinRT
{
    ...
    public const string InterfaceName_Windows_Security_Cryptography_ICryptographicBufferStatics =
        "Windows.Security.Cryptography.ICryptographicBufferStatics";

    [NativeTypeName("const WCHAR[50]")]
    public const string RuntimeClass_Windows_Security_Cryptography_CryptographicBuffer =
