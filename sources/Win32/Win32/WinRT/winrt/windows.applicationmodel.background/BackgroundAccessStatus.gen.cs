...
public enum BackgroundAccessStatus
{
    ...
    [Obsolete(
        "Use AlwaysAllowed or AllowedSubjectToSystemPolicy instead of AllowedWithAlwaysOnRealTimeConnectivity. For more info, see MSDN."
    )]
    BackgroundAccessStatus_AllowedWithAlwaysOnRealTimeConnectivity = 1,

    [Obsolete(
        "Use AlwaysAllowed or AllowedSubjectToSystemPolicy instead of AllowedMayUseActiveRealTimeConnectivity. For more info, see MSDN."
    )]
    BackgroundAccessStatus_AllowedMayUseActiveRealTimeConnectivity = 2,

    [Obsolete(
        "Use DeniedByUser or DeniedBySystemPolicy instead of Denied. For more info, see MSDN."
    )]
