...
public unsafe partial struct IDisplayServices : IDisplayServices.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_WinRT_IDisplayServices));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDisplayServices, uint*, Guid**, int>)((*lpVtbl)[3]))(
            this,
            iidCount,
            iids
        );
    ...
    {
        return ((delegate* unmanaged<IDisplayServices, HSTRING*, int>)((*lpVtbl)[4]))(
            this,
            className
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDisplayServices, TrustLevel*, int>)((*lpVtbl)[5]))(
            this,
            trustLevel
        );
    }
