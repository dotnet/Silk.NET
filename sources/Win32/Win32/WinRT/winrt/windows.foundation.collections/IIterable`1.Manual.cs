    ...
    where T : unmanaged
{
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IIterable<T>*, uint>)(lpVtbl[1]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<IIterable<T>*, IIterator<T>**, int>)(lpVtbl[6]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this),
            first
        );
    }
    ...
    public HRESULT First([NativeTypeName("IIterator<T_logical> **")] Ref2D<IIterator<T>> first)
    {
        fixed (IIterator<T>** __dsl_first = first)
        {
            return (HRESULT)First(__dsl_first);
        }
    }
    ...
    {
        return ((delegate* unmanaged<IIterable<T>*, uint*, Guid**, int>)(lpVtbl[3]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this),
            iidCount,
            iids
        );
    ...
    {
        return ((delegate* unmanaged<IIterable<T>*, HSTRING*, int>)(lpVtbl[4]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this),
            className
        );
    }
    ...
    {
        return ((delegate* unmanaged<IIterable<T>*, TrustLevel*, int>)(lpVtbl[5]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this),
            trustLevel
        );
    }
    ...
    {
        return ((delegate* unmanaged<IIterable<T>*, Guid*, void**, int>)(lpVtbl[0]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IIterable<T>*, uint>)(lpVtbl[2]))(
            (IIterable<T>*)Unsafe.AsPointer(ref this)
        );
    }
}
