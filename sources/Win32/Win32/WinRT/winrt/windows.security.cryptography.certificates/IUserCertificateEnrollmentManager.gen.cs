...
public unsafe partial struct IUserCertificateEnrollmentManager
    : IUserCertificateEnrollmentManager.Interface,
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IUserCertificateEnrollmentManager));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<IUserCertificateEnrollmentManager, Guid*, void**, int>)(
                (*lpVtbl)[0]
            )
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IUserCertificateEnrollmentManager, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IUserCertificateEnrollmentManager, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IUserCertificateEnrollmentManager, uint*, Guid**, int>)(
                (*lpVtbl)[3]
            )
        )(this, iidCount, iids);
    }
    ...
    {
        return (
            (delegate* unmanaged<IUserCertificateEnrollmentManager, HSTRING*, int>)((*lpVtbl)[4])
        )(this, className);
    }
    ...
    {
        return (
            (delegate* unmanaged<IUserCertificateEnrollmentManager, TrustLevel*, int>)((*lpVtbl)[5])
        )(this, trustLevel);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IUserCertificateEnrollmentManager"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IUserCertificateEnrollmentManager(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.WinRT.IInspectable"/> to <see cref = "IUserCertificateEnrollmentManager"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.WinRT.IInspectable"/> instance to be converted </param>
    public static explicit operator IUserCertificateEnrollmentManager(
        Silk.NET.WinRT.IInspectable value
    )
    {
        return new IUserCertificateEnrollmentManager(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IUserCertificateEnrollmentManager"/> to <see cref = "Silk.NET.WinRT.IInspectable"/>.</summary>
    /// <param name = "value">The <see cref = "IUserCertificateEnrollmentManager"/> instance to be converted </param>
    ...
    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IUserCertificateEnrollmentManager"/>.</summary>
    ...
    /// <summary>Upcasts <see cref = "IUserCertificateEnrollmentManager"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IUserCertificateEnrollmentManager"/> instance to be converted </param>
