...
public unsafe partial struct IAdaptiveMediaSourceDownloadCompletedEventArgs
    : IAdaptiveMediaSourceDownloadCompletedEventArgs.Interface,
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)
            Unsafe.AsPointer(
                ref Unsafe.AsRef(in IID_IAdaptiveMediaSourceDownloadCompletedEventArgs)
            );
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<IAdaptiveMediaSourceDownloadCompletedEventArgs, uint>)(
                (*lpVtbl)[1]
            )
        )(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IAdaptiveMediaSourceDownloadCompletedEventArgs, HSTRING*, int>)(
                (*lpVtbl)[4]
            )
        )(this, className);
    }
    ...
    {
        return (
            (delegate* unmanaged<IAdaptiveMediaSourceDownloadCompletedEventArgs, TrustLevel*, int>)(
                (*lpVtbl)[5]
            )
        )(this, trustLevel);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IAdaptiveMediaSourceDownloadCompletedEventArgs(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.WinRT.IInspectable"/> to <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.WinRT.IInspectable"/> instance to be converted </param>
    public static explicit operator IAdaptiveMediaSourceDownloadCompletedEventArgs(
        Silk.NET.WinRT.IInspectable value
    )
    {
        return new IAdaptiveMediaSourceDownloadCompletedEventArgs(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/> to <see cref = "Silk.NET.WinRT.IInspectable"/>.</summary>
    /// <param name = "value">The <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/> instance to be converted </param>
    public static implicit operator Silk.NET.WinRT.IInspectable(
        IAdaptiveMediaSourceDownloadCompletedEventArgs value
    )
    {
        return new Silk.NET.WinRT.IInspectable(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/>.</summary>
    ...
    /// <summary>Upcasts <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IAdaptiveMediaSourceDownloadCompletedEventArgs"/> instance to be converted </param>
