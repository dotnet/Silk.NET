...
public static unsafe partial class Gdiplus
{
    ...
    public static extern GpStatus GdipCreateEffect(
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::Status")]
    public static extern GpStatus GdipDeleteEffect(
        [NativeTypeName("Gdiplus::CGpEffect *")] CGpEffect* effect
    );

    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::Status")]
    public static extern GpStatus GdipGetEffectParameterSize(
        [NativeTypeName("Gdiplus::CGpEffect *")] CGpEffect* effect,
        uint* size
    );
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::Status")]
    public static extern GpStatus GdipSetEffectParameters(
        [NativeTypeName("Gdiplus::CGpEffect *")] CGpEffect* effect,
    ...
    [DllImport("gdiplus", ExactSpelling = true)]
    [return: NativeTypeName("Gdiplus::Status")]
    public static extern GpStatus GdipGetEffectParameters(
        [NativeTypeName("Gdiplus::CGpEffect *")] CGpEffect* effect,
        uint* size,
        void* @params
    );
