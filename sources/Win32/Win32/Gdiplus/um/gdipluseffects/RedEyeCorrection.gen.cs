...
public unsafe partial struct RedEyeCorrection
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public GpStatus SetParameters(
        [NativeTypeName("const RedEyeCorrectionParams *")] RedEyeCorrectionParams* parameters
    )
    {
        ...
        if ((parameters) != null)
        {
            ...
            uint size = unchecked(
                (uint)(sizeof(RedEyeCorrectionParams)) + inputParam->numberOfAreas * 16
            );
    ...
    public GpStatus GetParameters(
        uint* size,
        [NativeTypeName("Gdiplus::RedEyeCorrectionParams *")] RedEyeCorrectionParams* parameters
    )
    {
