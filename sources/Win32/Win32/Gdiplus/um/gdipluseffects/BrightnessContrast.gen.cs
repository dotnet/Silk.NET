...
public unsafe partial struct BrightnessContrast
{
    ...
    [return: NativeTypeName("Gdiplus::Status")]
    public GpStatus SetParameters(
        [NativeTypeName("const BrightnessContrastParams *")] BrightnessContrastParams* parameters
    )
    {
        uint size = 8;
    ...
    public GpStatus GetParameters(
        uint* size,
        [NativeTypeName("Gdiplus::BrightnessContrastParams *")] BrightnessContrastParams* parameters
    )
    {
