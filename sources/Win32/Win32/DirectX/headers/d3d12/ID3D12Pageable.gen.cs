...
public unsafe partial struct ID3D12Pageable : ID3D12Pageable.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12Pageable*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Pageable*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Pageable*, uint>)(lpVtbl[1]))(
            (ID3D12Pageable*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Pageable*, uint>)(lpVtbl[2]))(
            (ID3D12Pageable*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Pageable*, ushort*, int>)(lpVtbl[6]))(
            (ID3D12Pageable*)Unsafe.AsPointer(ref this),
            Name
        );
    }
