        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DeviceConfiguration*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DeviceConfiguration*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DeviceConfiguration*, uint>)(lpVtbl[1]))(
            (ID3D12DeviceConfiguration*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DeviceConfiguration*, uint>)(lpVtbl[2]))(
            (ID3D12DeviceConfiguration*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public D3D12_DEVICE_CONFIGURATION_DESC GetDesc()
    {
        ...
        )((ID3D12DeviceConfiguration*)Unsafe.AsPointer(ref this), &result);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                ID3DBlob**,
                int>)(lpVtbl[5])
        )((ID3D12DeviceConfiguration*)Unsafe.AsPointer(ref this), pDesc, ppResult, ppError);
    }
