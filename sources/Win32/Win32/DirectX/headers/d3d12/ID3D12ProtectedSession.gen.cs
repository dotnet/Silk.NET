...
public unsafe partial struct ID3D12ProtectedSession : ID3D12ProtectedSession.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12ProtectedSession*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12ProtectedSession*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12ProtectedSession*, uint>)(lpVtbl[1]))(
            (ID3D12ProtectedSession*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12ProtectedSession*, uint>)(lpVtbl[2]))(
            (ID3D12ProtectedSession*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        ...
        )((ID3D12ProtectedSession*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12ProtectedSession*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12ProtectedSession*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
