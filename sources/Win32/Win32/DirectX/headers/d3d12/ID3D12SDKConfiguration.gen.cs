...
public unsafe partial struct ID3D12SDKConfiguration : ID3D12SDKConfiguration.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12SDKConfiguration*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12SDKConfiguration*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12SDKConfiguration*, uint>)(lpVtbl[1]))(
            (ID3D12SDKConfiguration*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12SDKConfiguration*, uint>)(lpVtbl[2]))(
            (ID3D12SDKConfiguration*)Unsafe.AsPointer(ref this)
        );
    }
