...
public unsafe partial struct ID3D12LifetimeTracker : ID3D12LifetimeTracker.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12LifetimeTracker*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12LifetimeTracker*, uint>)(lpVtbl[1]))(
            (ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12LifetimeTracker*, uint>)(lpVtbl[2]))(
            (ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12LifetimeTracker*, Guid*, uint*, void*, int>)(lpVtbl[3]))(
            (ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this),
            guid,
            pDataSize,
            pData
    ...
    {
        return ((delegate* unmanaged<ID3D12LifetimeTracker*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12LifetimeTracker*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
