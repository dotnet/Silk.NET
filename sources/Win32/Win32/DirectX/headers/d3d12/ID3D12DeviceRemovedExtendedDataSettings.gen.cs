        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        ...
        )((ID3D12DeviceRemovedExtendedDataSettings*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DeviceRemovedExtendedDataSettings*, uint>)(lpVtbl[1]))(
            (ID3D12DeviceRemovedExtendedDataSettings*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public void SetAutoBreadcrumbsEnablement(D3D12_DRED_ENABLEMENT Enablement)
    {
        (
            (delegate* unmanaged<
                ...
                void>)(lpVtbl[3])
        )((ID3D12DeviceRemovedExtendedDataSettings*)Unsafe.AsPointer(ref this), Enablement);
    }
