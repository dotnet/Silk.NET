        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<DirectMLPyTorchCreatorID*, Guid*, void**, int>)(lpVtbl[0]))(
            (DirectMLPyTorchCreatorID*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<DirectMLPyTorchCreatorID*, uint>)(lpVtbl[1]))(
            (DirectMLPyTorchCreatorID*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<DirectMLPyTorchCreatorID*, uint>)(lpVtbl[2]))(
            (DirectMLPyTorchCreatorID*)Unsafe.AsPointer(ref this)
        );
    }
