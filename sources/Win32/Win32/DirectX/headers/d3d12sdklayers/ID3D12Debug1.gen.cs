...
public unsafe partial struct ID3D12Debug1 : ID3D12Debug1.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12Debug1));
    public void** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID3D12Debug1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Debug1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Debug1*, uint>)(lpVtbl[1]))(
            (ID3D12Debug1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Debug1*, uint>)(lpVtbl[2]))(
            (ID3D12Debug1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug1*, void>)(lpVtbl[3]))(
            (ID3D12Debug1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug1*, BOOL, void>)(lpVtbl[4]))(
            (ID3D12Debug1*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug1*, BOOL, void>)(lpVtbl[5]))(
            (ID3D12Debug1*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
