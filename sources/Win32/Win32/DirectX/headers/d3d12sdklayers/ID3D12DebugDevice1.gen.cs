...
public unsafe partial struct ID3D12DebugDevice1 : ID3D12DebugDevice1.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DebugDevice1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DebugDevice1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice1*, uint>)(lpVtbl[1]))(
            (ID3D12DebugDevice1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice1*, uint>)(lpVtbl[2]))(
            (ID3D12DebugDevice1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                uint,
                int>)(lpVtbl[3])
        )((ID3D12DebugDevice1*)Unsafe.AsPointer(ref this), Type, pData, DataSize);
    }
