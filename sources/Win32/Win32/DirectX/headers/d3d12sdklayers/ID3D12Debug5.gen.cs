...
public unsafe partial struct ID3D12Debug5 : ID3D12Debug5.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12Debug5));
    public void** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID3D12Debug5*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Debug5*, uint>)(lpVtbl[1]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Debug5*, uint>)(lpVtbl[2]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug5*, void>)(lpVtbl[3]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug5*, BOOL, void>)(lpVtbl[4]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug5*, BOOL, void>)(lpVtbl[5]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug5*, D3D12_GPU_BASED_VALIDATION_FLAGS, void>)(lpVtbl[6]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this),
            Flags
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug5*, void>)(lpVtbl[7]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug5*, BOOL, void>)(lpVtbl[8]))(
            (ID3D12Debug5*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
