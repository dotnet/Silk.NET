...
public unsafe partial struct ID3D12VideoDevice3 : ID3D12VideoDevice3.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12VideoDevice3*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12VideoDevice3*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoDevice3*, uint>)(lpVtbl[1]))(
            (ID3D12VideoDevice3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoDevice3*, uint>)(lpVtbl[2]))(
            (ID3D12VideoDevice3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[4])
        )((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoDecoder);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[14])
        )((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoEncoder);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[15])
        )((ID3D12VideoDevice3*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoEncoderHeap);
    }
