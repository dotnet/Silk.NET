...
public unsafe partial struct ID3D12VideoProcessor1 : ID3D12VideoProcessor1.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, uint>)(lpVtbl[1]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, uint>)(lpVtbl[2]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, Guid*, uint*, void*, int>)(lpVtbl[3]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this),
            guid,
            pDataSize,
            pData
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, uint>)(lpVtbl[8]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoProcessor1*, uint>)(lpVtbl[9]))(
            (ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public D3D12_VIDEO_PROCESS_OUTPUT_STREAM_DESC GetOutputStreamDesc()
    {
        ...
        )((ID3D12VideoProcessor1*)Unsafe.AsPointer(ref this), &result);
    }
