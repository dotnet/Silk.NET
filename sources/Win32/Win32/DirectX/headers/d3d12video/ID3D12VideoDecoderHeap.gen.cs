...
public unsafe partial struct ID3D12VideoDecoderHeap : ID3D12VideoDecoderHeap.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12VideoDecoderHeap*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12VideoDecoderHeap*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoDecoderHeap*, uint>)(lpVtbl[1]))(
            (ID3D12VideoDecoderHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoDecoderHeap*, uint>)(lpVtbl[2]))(
            (ID3D12VideoDecoderHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        ...
        )((ID3D12VideoDecoderHeap*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoDecoderHeap*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12VideoDecoderHeap*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
    ...
    public D3D12_VIDEO_DECODER_HEAP_DESC GetDesc()
    {
        ...
        )((ID3D12VideoDecoderHeap*)Unsafe.AsPointer(ref this), &result);
    }
