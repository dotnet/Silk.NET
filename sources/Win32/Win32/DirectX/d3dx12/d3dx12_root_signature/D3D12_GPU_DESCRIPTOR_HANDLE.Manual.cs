...
public unsafe partial struct D3D12_GPU_DESCRIPTOR_HANDLE : IEquatable<D3D12_GPU_DESCRIPTOR_HANDLE>
{
    ...
    public D3D12_GPU_DESCRIPTOR_HANDLE(
        [NativeTypeName("const D3D12_GPU_DESCRIPTOR_HANDLE &")]
            in D3D12_GPU_DESCRIPTOR_HANDLE other,
    ...
    public static bool operator ==(
        D3D12_GPU_DESCRIPTOR_HANDLE left,
        D3D12_GPU_DESCRIPTOR_HANDLE right
    ) => left.ptr == right.ptr;
    ...
    public override readonly bool Equals([NotNullWhen(true)] object? obj) =>
        (obj is D3D12_GPU_DESCRIPTOR_HANDLE other) && Equals(other);
    ...
    public void InitOffsetted(
        [NativeTypeName("const D3D12_GPU_DESCRIPTOR_HANDLE &")]
            in D3D12_GPU_DESCRIPTOR_HANDLE @base,
        int offsetScaledByIncrementSize
    )
    {
    ...
    public static void InitOffsetted(
        [NativeTypeName("D3D12_GPU_DESCRIPTOR_HANDLE &")] ref D3D12_GPU_DESCRIPTOR_HANDLE handle,
        [NativeTypeName("const D3D12_GPU_DESCRIPTOR_HANDLE &")]
            in D3D12_GPU_DESCRIPTOR_HANDLE @base,
        int offsetScaledByIncrementSize
    )
    ...
    public ref D3D12_GPU_DESCRIPTOR_HANDLE Offset(
        int offsetInDescriptors,
        uint descriptorIncrementSize
    )
    {
