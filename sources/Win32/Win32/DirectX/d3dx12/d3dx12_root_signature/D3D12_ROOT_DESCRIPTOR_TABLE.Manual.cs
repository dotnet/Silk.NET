...
public unsafe partial struct D3D12_ROOT_DESCRIPTOR_TABLE
{
    ...
    public void Init(
        uint numDescriptorRanges,
        [NativeTypeName("const D3D12_DESCRIPTOR_RANGE *")]
            Ref<D3D12_DESCRIPTOR_RANGE> _pDescriptorRanges
    )
    {
        fixed (D3D12_DESCRIPTOR_RANGE* __dsl__pDescriptorRanges = _pDescriptorRanges)
        {
    ...
    public static void Init(
        [NativeTypeName("D3D12_ROOT_DESCRIPTOR_TABLE &")]
            ref D3D12_ROOT_DESCRIPTOR_TABLE rootDescriptorTable,
        uint numDescriptorRanges,
        [NativeTypeName("const D3D12_DESCRIPTOR_RANGE *")]
            D3D12_DESCRIPTOR_RANGE* _pDescriptorRanges
    )
