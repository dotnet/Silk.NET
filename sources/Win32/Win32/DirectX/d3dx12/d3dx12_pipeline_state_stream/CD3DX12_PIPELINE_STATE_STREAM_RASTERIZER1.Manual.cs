...
public struct CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER1
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER1(
        [NativeTypeName("D3D12_RASTERIZER_DESC1 const &")] in D3D12_RASTERIZER_DESC1 i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER1;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER1(
        in D3D12_RASTERIZER_DESC1 value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER1(value);

    public static implicit operator D3D12_RASTERIZER_DESC1(
        in CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER1 value
    ) => value.pssInner;
