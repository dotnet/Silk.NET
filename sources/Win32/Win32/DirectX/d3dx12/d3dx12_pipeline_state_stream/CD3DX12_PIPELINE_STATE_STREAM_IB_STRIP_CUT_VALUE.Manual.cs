...
public struct CD3DX12_PIPELINE_STATE_STREAM_IB_STRIP_CUT_VALUE
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_IB_STRIP_CUT_VALUE(
        [NativeTypeName("D3D12_INDEX_BUFFER_STRIP_CUT_VALUE const &")]
            in D3D12_INDEX_BUFFER_STRIP_CUT_VALUE i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_IB_STRIP_CUT_VALUE;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_IB_STRIP_CUT_VALUE(
        in D3D12_INDEX_BUFFER_STRIP_CUT_VALUE value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_IB_STRIP_CUT_VALUE(value);

    public static implicit operator D3D12_INDEX_BUFFER_STRIP_CUT_VALUE(
        in CD3DX12_PIPELINE_STATE_STREAM_IB_STRIP_CUT_VALUE value
    ) => value.pssInner;
