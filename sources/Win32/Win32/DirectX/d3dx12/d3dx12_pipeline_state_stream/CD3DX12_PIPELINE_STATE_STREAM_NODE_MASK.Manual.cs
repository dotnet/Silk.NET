...
public struct CD3DX12_PIPELINE_STATE_STREAM_NODE_MASK
{
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_NODE_MASK(in uint value) =>
        new CD3DX12_PIPELINE_STATE_STREAM_NODE_MASK(value);

    public static implicit operator uint(in CD3DX12_PIPELINE_STATE_STREAM_NODE_MASK value) =>
        value.pssInner;
