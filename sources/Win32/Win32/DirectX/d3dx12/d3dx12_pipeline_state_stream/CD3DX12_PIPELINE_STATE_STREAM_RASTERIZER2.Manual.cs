...
public struct CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER2
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER2(
        [NativeTypeName("D3D12_RASTERIZER_DESC2 const &")] in D3D12_RASTERIZER_DESC2 i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER2;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER2(
        in D3D12_RASTERIZER_DESC2 value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER2(value);

    public static implicit operator D3D12_RASTERIZER_DESC2(
        in CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER2 value
    ) => value.pssInner;
