...
public struct CD3DX12_PIPELINE_STATE_STREAM_SAMPLE_MASK
{
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_SAMPLE_MASK(in uint value) =>
        new CD3DX12_PIPELINE_STATE_STREAM_SAMPLE_MASK(value);

    public static implicit operator uint(in CD3DX12_PIPELINE_STATE_STREAM_SAMPLE_MASK value) =>
        value.pssInner;
