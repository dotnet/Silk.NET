...
public struct CD3DX12_PIPELINE_STATE_STREAM_VIEW_INSTANCING
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_VIEW_INSTANCING(
        [NativeTypeName("D3D12_VIEW_INSTANCING_DESC const &")] in D3D12_VIEW_INSTANCING_DESC i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_VIEW_INSTANCING;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_VIEW_INSTANCING(
        in D3D12_VIEW_INSTANCING_DESC value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_VIEW_INSTANCING(value);

    public static implicit operator D3D12_VIEW_INSTANCING_DESC(
        in CD3DX12_PIPELINE_STATE_STREAM_VIEW_INSTANCING value
    ) => value.pssInner;
