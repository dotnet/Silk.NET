...
public struct CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL2
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL2(
        [NativeTypeName("D3D12_DEPTH_STENCIL_DESC2 const &")] in D3D12_DEPTH_STENCIL_DESC2 i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL2;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL2(
        in D3D12_DEPTH_STENCIL_DESC2 value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL2(value);

    public static implicit operator D3D12_DEPTH_STENCIL_DESC2(
        in CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL2 value
    ) => value.pssInner;
