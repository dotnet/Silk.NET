...
public struct CD3DX12_PIPELINE_STATE_STREAM_BLEND_DESC
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_BLEND_DESC(
        [NativeTypeName("D3D12_BLEND_DESC const &")] in D3D12_BLEND_DESC i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_BLEND;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_BLEND_DESC(
        in D3D12_BLEND_DESC value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_BLEND_DESC(value);

    public static implicit operator D3D12_BLEND_DESC(
        in CD3DX12_PIPELINE_STATE_STREAM_BLEND_DESC value
    ) => value.pssInner;
