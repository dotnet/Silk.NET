...
public struct CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL1
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL1(
        [NativeTypeName("D3D12_DEPTH_STENCIL_DESC1 const &")] in D3D12_DEPTH_STENCIL_DESC1 i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_DEPTH_STENCIL1;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL1(
        in D3D12_DEPTH_STENCIL_DESC1 value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL1(value);

    public static implicit operator D3D12_DEPTH_STENCIL_DESC1(
        in CD3DX12_PIPELINE_STATE_STREAM_DEPTH_STENCIL1 value
    ) => value.pssInner;
