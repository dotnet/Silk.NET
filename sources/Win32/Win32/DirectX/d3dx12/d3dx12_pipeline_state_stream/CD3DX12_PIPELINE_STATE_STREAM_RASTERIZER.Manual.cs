...
public struct CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER
{
    ...
    public CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER(
        [NativeTypeName("D3D12_RASTERIZER_DESC const &")] in D3D12_RASTERIZER_DESC i
    )
    {
        pssType = D3D12_PIPELINE_STATE_SUBOBJECT_TYPE_RASTERIZER;
        pssInner = i;
    ...
    public static implicit operator CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER(
        in D3D12_RASTERIZER_DESC value
    ) => new CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER(value);

    public static implicit operator D3D12_RASTERIZER_DESC(
        in CD3DX12_PIPELINE_STATE_STREAM_RASTERIZER value
    ) => value.pssInner;
