...
public unsafe partial struct IDirect3DCubeTexture9 : IDirect3DCubeTexture9.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDirect3DCubeTexture9));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, IDirect3DDevice9*, int>)((*lpVtbl)[3]))(
            this,
            ppDevice
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirect3DCubeTexture9, Guid*, void*, uint, uint, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDirect3DCubeTexture9, Guid*, void*, uint*, int>)((*lpVtbl)[5])
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, Guid*, int>)((*lpVtbl)[6]))(
            this,
            refguid
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint, uint>)((*lpVtbl)[7]))(
            this,
            PriorityNew
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint>)((*lpVtbl)[8]))(this);
    }
    ...
    public void PreLoad()
    {
        ((delegate* unmanaged<IDirect3DCubeTexture9, void>)((*lpVtbl)[9]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, D3DRESOURCETYPE>)((*lpVtbl)[10]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint, uint>)((*lpVtbl)[11]))(
            this,
            LODNew
        );
    }
    ...
    public uint GetLOD()
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint>)((*lpVtbl)[12]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, uint>)((*lpVtbl)[13]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirect3DCubeTexture9, D3DTEXTUREFILTERTYPE, int>)((*lpVtbl)[14])
        )(this, FilterType);
    }
    ...
    {
        return ((delegate* unmanaged<IDirect3DCubeTexture9, D3DTEXTUREFILTERTYPE>)((*lpVtbl)[15]))(
            this
        );
    }
    ...
    {
        ((delegate* unmanaged<IDirect3DCubeTexture9, void>)((*lpVtbl)[16]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirect3DCubeTexture9, uint, D3DSURFACE_DESC*, int>)((*lpVtbl)[17])
        )(this, Level, pDesc);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(18)]
    public HRESULT GetCubeMapSurface(
    ...
    {
        return (
            (delegate* unmanaged<IDirect3DCubeTexture9, D3DCUBEMAP_FACES, uint, int>)((*lpVtbl)[20])
        )(this, FaceType, Level);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(21)]
    public HRESULT AddDirtyRect(
        D3DCUBEMAP_FACES FaceType,
        [NativeTypeName("const RECT *")] RECT* pDirtyRect
    )
    {
        return (
            (delegate* unmanaged<IDirect3DCubeTexture9, D3DCUBEMAP_FACES, RECT*, int>)(
                (*lpVtbl)[21]
            )
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (D3DCUBEMAP_FACES, UINT, IDirect3DSurface9 **) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (D3DCUBEMAP_FACES, UINT, D3DLOCKED_RECT *, const RECT *, DWORD) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            D3DCUBEMAP_FACES,
        ...
        [NativeTypeName(
            "HRESULT (D3DCUBEMAP_FACES, UINT) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, D3DCUBEMAP_FACES, uint, int> UnlockRect;

        [NativeTypeName(
            "HRESULT (D3DCUBEMAP_FACES, const RECT *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, D3DCUBEMAP_FACES, RECT*, int> AddDirtyRect;
    }
    ...
    public IDirect3DCubeTexture9(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDirect3DBaseTexture9"/> to <see cref = "IDirect3DCubeTexture9"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDirect3DBaseTexture9"/> instance to be converted </param>
    public static explicit operator IDirect3DCubeTexture9(
        Silk.NET.DirectX.IDirect3DBaseTexture9 value
    )
    {
        return new IDirect3DCubeTexture9(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirect3DCubeTexture9"/> to <see cref = "Silk.NET.DirectX.IDirect3DBaseTexture9"/>.</summary>
    ...
    public static implicit operator Silk.NET.DirectX.IDirect3DBaseTexture9(
        IDirect3DCubeTexture9 value
    )
    {
        return new Silk.NET.DirectX.IDirect3DBaseTexture9(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDirect3DResource9"/> to <see cref = "IDirect3DCubeTexture9"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDirect3DResource9"/> instance to be converted </param>
    public static explicit operator IDirect3DCubeTexture9(Silk.NET.DirectX.IDirect3DResource9 value)
    {
        return new IDirect3DCubeTexture9(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirect3DCubeTexture9"/> to <see cref = "Silk.NET.DirectX.IDirect3DResource9"/>.</summary>
    /// <param name = "value">The <see cref = "IDirect3DCubeTexture9"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDirect3DResource9(IDirect3DCubeTexture9 value)
    {
        return new Silk.NET.DirectX.IDirect3DResource9(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDirect3DCubeTexture9"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDirect3DCubeTexture9(Silk.NET.Windows.IUnknown value)
    {
        return new IDirect3DCubeTexture9(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirect3DCubeTexture9"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDirect3DCubeTexture9"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDirect3DCubeTexture9 value)
    {
