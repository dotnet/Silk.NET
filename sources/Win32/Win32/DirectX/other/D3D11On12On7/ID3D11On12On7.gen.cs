...
public unsafe partial struct ID3D11On12On7 : ID3D11On12On7.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D11On12On7*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D11On12On7*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D11On12On7*, uint>)(lpVtbl[1]))(
            (ID3D11On12On7*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D11On12On7*, uint>)(lpVtbl[2]))(
            (ID3D11On12On7*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        ...
        )((ID3D11On12On7*)Unsafe.AsPointer(ref this), pDevice, pGraphicsQueue);
    }
    ...
    {
        ((delegate* unmanaged<ID3D11On12On7*, ID3D12Resource*, void>)(lpVtbl[4]))(
            (ID3D11On12On7*)Unsafe.AsPointer(ref this),
            pResource
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D11On12On7*, ID3D11On12On7Device*>)(lpVtbl[5]))(
            (ID3D11On12On7*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D11On12On7*, void*>)(lpVtbl[6]))(
            (ID3D11On12On7*)Unsafe.AsPointer(ref this)
        );
    }
