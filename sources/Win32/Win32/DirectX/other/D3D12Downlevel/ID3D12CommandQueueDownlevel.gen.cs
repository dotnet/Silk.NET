        ...
        INativeGuid
{
    ...
    {
        return ((delegate* unmanaged<ID3D12CommandQueueDownlevel*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12CommandQueueDownlevel*, uint>)(lpVtbl[1]))(
            (ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12CommandQueueDownlevel*, uint>)(lpVtbl[2]))(
            (ID3D12CommandQueueDownlevel*)Unsafe.AsPointer(ref this)
        );
    }
