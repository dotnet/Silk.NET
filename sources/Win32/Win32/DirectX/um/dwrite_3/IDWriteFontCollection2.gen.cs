...
public unsafe partial struct IDWriteFontCollection2 : IDWriteFontCollection2.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDWriteFontCollection2));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDWriteFontCollection2, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDWriteFontCollection2, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDWriteFontCollection2, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFontCollection2, uint>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, uint, IDWriteFontFamily*, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, ushort*, uint*, BOOL*, int>)((*lpVtbl)[5])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, IDWriteFontFace, IDWriteFont*, int>)(
                (*lpVtbl)[6]
            )
        )(this, fontFace, font);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFontCollection2, IDWriteFontSet*, int>)((*lpVtbl)[7]))(
            this,
            fontSet
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, uint, IDWriteFontFamily1*, int>)(
                (*lpVtbl)[8]
            )
        )(this, index, fontFamily);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, uint, IDWriteFontFamily2*, int>)(
                (*lpVtbl)[9]
            )
        )(this, index, fontFamily);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, DWRITE_FONT_FAMILY_MODEL>)((*lpVtbl)[11])
        )(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontCollection2, IDWriteFontSet1*, int>)((*lpVtbl)[12])
        )(this, fontSet);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDWriteFontCollection2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDWriteFontCollection2(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFontCollection1"/> to <see cref = "IDWriteFontCollection2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFontCollection1"/> instance to be converted </param>
    public static explicit operator IDWriteFontCollection2(
        Silk.NET.DirectX.IDWriteFontCollection1 value
    )
    {
        return new IDWriteFontCollection2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontCollection2"/> to <see cref = "Silk.NET.DirectX.IDWriteFontCollection1"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontCollection2"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFontCollection1(
        IDWriteFontCollection2 value
    )
    {
        return new Silk.NET.DirectX.IDWriteFontCollection1(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFontCollection"/> to <see cref = "IDWriteFontCollection2"/>.</summary>
    ...
    /// <summary>Upcasts <see cref = "IDWriteFontCollection2"/> to <see cref = "Silk.NET.DirectX.IDWriteFontCollection"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontCollection2"/> instance to be converted </param>
    ...
    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDWriteFontCollection2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDWriteFontCollection2(Silk.NET.Windows.IUnknown value)
    {
        return new IDWriteFontCollection2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontCollection2"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontCollection2"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDWriteFontCollection2 value)
    {
