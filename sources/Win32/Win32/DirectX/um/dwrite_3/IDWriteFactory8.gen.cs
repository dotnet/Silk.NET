...
public unsafe partial struct IDWriteFactory8 : IDWriteFactory8.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDWriteFactory8));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDWriteFactory8, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDWriteFactory8, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontCollection*, BOOL, int>)((*lpVtbl)[3])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontCollectionLoader, int>)((*lpVtbl)[5])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontCollectionLoader, int>)((*lpVtbl)[6])
        )(this, fontCollectionLoader);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, ushort*, FILETIME*, IDWriteFontFile*, int>)(
                (*lpVtbl)[7]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteRenderingParams*, int>)((*lpVtbl)[10])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, HMONITOR, IDWriteRenderingParams*, int>)(
                (*lpVtbl)[11]
            )
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteFontFileLoader, int>)((*lpVtbl)[13]))(
            this,
            fontFileLoader
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteFontFileLoader, int>)((*lpVtbl)[14]))(
            this,
            fontFileLoader
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteTypography*, int>)((*lpVtbl)[16]))(
            this,
            typography
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteGdiInterop*, int>)((*lpVtbl)[17]))(
            this,
            gdiInterop
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteTextFormat, IDWriteInlineObject*, int>)(
                (*lpVtbl)[20]
            )
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteTextAnalyzer*, int>)((*lpVtbl)[21]))(
            this,
            textAnalyzer
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontCollection*, BOOL, int>)((*lpVtbl)[24])
        )(this, fontCollection, checkForUpdates);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteFontFallback*, int>)((*lpVtbl)[26]))(
            this,
            fontFallback
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontFallbackBuilder*, int>)((*lpVtbl)[27])
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteFontSet*, int>)((*lpVtbl)[35]))(
            this,
            fontSet
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, IDWriteFontSetBuilder*, int>)((*lpVtbl)[36]))(
            this,
            fontSetBuilder
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontSet, IDWriteFontCollection1*, int>)(
                (*lpVtbl)[37]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, BOOL, IDWriteFontCollection1*, BOOL, int>)(
                (*lpVtbl)[38]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontDownloadQueue*, int>)((*lpVtbl)[39])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontSetBuilder1*, int>)((*lpVtbl)[43])
        )(this, fontSetBuilder);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteInMemoryFontFileLoader*, int>)(
                (*lpVtbl)[44]
            )
        )(this, newLoader);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, void*, uint, DWRITE_CONTAINER_TYPE>)(
                (*lpVtbl)[46]
            )
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, BOOL, IDWriteFontSet1*, int>)((*lpVtbl)[50]))(
            this,
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFactory8, IDWriteFontSetBuilder2*, int>)((*lpVtbl)[53])
        )(this, fontSetBuilder);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFactory8, BOOL, IDWriteFontSet2*, int>)((*lpVtbl)[55]))(
            this,
            includeDownloadableFonts,
            fontSet
        );
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (D2D1_POINT_2F, const DWRITE_GLYPH_RUN *, const DWRITE_GLYPH_RUN_DESCRIPTION *, DWRITE_GLYPH_IMAGE_FORMATS, DWRITE_PAINT_FEATURE_LEVEL, DWRITE_MEASURING_MODE, const DWRITE_MATRIX *, UINT32, IDWriteColorGlyphRunEnumerator1 **) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            D2D_POINT_2F,
            ...
            uint,
            IDWriteColorGlyphRunEnumerator1*,
            int> TranslateColorGlyphRun2;
    }

    /// <summary>Initializes a new instance of the <see cref = "IDWriteFactory8"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDWriteFactory8(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory7"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory7"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory7 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory7"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory7(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory7(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory6"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory6"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory6 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory6"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory6(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory6(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory5"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory5"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory5 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory5"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory5(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory5(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory4"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory4"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory4 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory4"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory4(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory4(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory3"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory3"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory3 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory3"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory3(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory3(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory2"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory2"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory2 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory2"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory2(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory1"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory1"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory1 value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory1"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory1(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory1(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFactory"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFactory"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.DirectX.IDWriteFactory value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.DirectX.IDWriteFactory"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFactory(IDWriteFactory8 value)
    {
        return new Silk.NET.DirectX.IDWriteFactory(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDWriteFactory8"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDWriteFactory8(Silk.NET.Windows.IUnknown value)
    {
        return new IDWriteFactory8(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFactory8"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFactory8"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDWriteFactory8 value)
    {
