...
public unsafe partial struct IDWriteFontSet4 : IDWriteFontSet4.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDWriteFontSet4));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet4, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDWriteFontSet4, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDWriteFontSet4, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet4, uint>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint, IDWriteFontFaceReference*, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, IDWriteFontFaceReference, uint*, BOOL*, int>)(
                (*lpVtbl)[5]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, IDWriteFontFace, uint*, BOOL*, int>)((*lpVtbl)[6])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, DWRITE_FONT_PROPERTY*, uint*, int>)((*lpVtbl)[10])
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet4, IDWriteFontSet1*, int>)((*lpVtbl)[14]))(
            this,
            filteredFontSet
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint*, uint, IDWriteFontSet1*, int>)(
                (*lpVtbl)[15]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint, DWRITE_FONT_AXIS_RANGE*, uint, uint*, int>)(
                (*lpVtbl)[20]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, DWRITE_FONT_AXIS_RANGE*, uint, uint*, int>)(
                (*lpVtbl)[21]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint, IDWriteFontFaceReference1*, int>)(
                (*lpVtbl)[22]
            )
        )(this, listIndex, fontFaceReference);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint, IDWriteFontResource*, int>)((*lpVtbl)[23])
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint, IDWriteFontFace5*, int>)((*lpVtbl)[24])
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet4, uint, DWRITE_LOCALITY>)((*lpVtbl)[25]))(
            this,
            listIndex
        );
    }
    ...
    {
        return ((HANDLE)(((delegate* unmanaged<IDWriteFontSet4, void*>)((*lpVtbl)[26]))(this)));
    }
    ...
    {
        return (
            (delegate* unmanaged<IDWriteFontSet4, uint, DWRITE_FONT_SOURCE_TYPE>)((*lpVtbl)[27])
        )(this, fontIndex);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet4, uint, uint>)((*lpVtbl)[28]))(this, listIndex);
    }
    ...
    {
        return ((delegate* unmanaged<IDWriteFontSet4, uint, ushort*, uint, int>)((*lpVtbl)[29]))(
            this,
            listIndex,
            stringBuffer,
            stringBufferSize
    ...
    public uint ConvertWeightStretchStyleToFontAxisValues(
        [NativeTypeName("const DWRITE_FONT_AXIS_VALUE *")] DWRITE_FONT_AXIS_VALUE* inputAxisValues,
        [NativeTypeName("UINT32")] uint inputAxisCount,
        DWRITE_FONT_WEIGHT fontWeight,
        DWRITE_FONT_STRETCH fontStretch,
        DWRITE_FONT_STYLE fontStyle,
        float fontSize,
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                IDWriteFontSet4*,
                int>)((*lpVtbl)[31])
        )(this, familyName, fontAxisValues, fontAxisValueCount, allowedSimulations, matchingFonts);
    }
    ...
    public interface Interface : IDWriteFontSet3.Interface
    {
        ...
        uint ConvertWeightStretchStyleToFontAxisValues(
            [NativeTypeName("const DWRITE_FONT_AXIS_VALUE *")]
                DWRITE_FONT_AXIS_VALUE* inputAxisValues,
            [NativeTypeName("UINT32")] uint inputAxisCount,
            DWRITE_FONT_WEIGHT fontWeight,
            DWRITE_FONT_STRETCH fontStretch,
            DWRITE_FONT_STYLE fontStyle,
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "UINT32 (const DWRITE_FONT_AXIS_VALUE *, UINT32, DWRITE_FONT_WEIGHT, DWRITE_FONT_STRETCH, DWRITE_FONT_STYLE, float, DWRITE_FONT_AXIS_VALUE *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            DWRITE_FONT_AXIS_VALUE*,
        ...
        [NativeTypeName(
            "HRESULT (const WCHAR *, const DWRITE_FONT_AXIS_VALUE *, UINT32, DWRITE_FONT_SIMULATIONS, IDWriteFontSet4 **) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            ushort*,
            ...
            DWRITE_FONT_SIMULATIONS,
            IDWriteFontSet4*,
            int> GetMatchingFonts3;
    }

    /// <summary>Initializes a new instance of the <see cref = "IDWriteFontSet4"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDWriteFontSet4(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFontSet3"/> to <see cref = "IDWriteFontSet4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFontSet3"/> instance to be converted </param>
    public static explicit operator IDWriteFontSet4(Silk.NET.DirectX.IDWriteFontSet3 value)
    {
        return new IDWriteFontSet4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontSet4"/> to <see cref = "Silk.NET.DirectX.IDWriteFontSet3"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontSet4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFontSet3(IDWriteFontSet4 value)
    {
        return new Silk.NET.DirectX.IDWriteFontSet3(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFontSet2"/> to <see cref = "IDWriteFontSet4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFontSet2"/> instance to be converted </param>
    public static explicit operator IDWriteFontSet4(Silk.NET.DirectX.IDWriteFontSet2 value)
    {
        return new IDWriteFontSet4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontSet4"/> to <see cref = "Silk.NET.DirectX.IDWriteFontSet2"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontSet4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFontSet2(IDWriteFontSet4 value)
    {
        return new Silk.NET.DirectX.IDWriteFontSet2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFontSet1"/> to <see cref = "IDWriteFontSet4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFontSet1"/> instance to be converted </param>
    public static explicit operator IDWriteFontSet4(Silk.NET.DirectX.IDWriteFontSet1 value)
    {
        return new IDWriteFontSet4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontSet4"/> to <see cref = "Silk.NET.DirectX.IDWriteFontSet1"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontSet4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFontSet1(IDWriteFontSet4 value)
    {
        return new Silk.NET.DirectX.IDWriteFontSet1(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDWriteFontSet"/> to <see cref = "IDWriteFontSet4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDWriteFontSet"/> instance to be converted </param>
    public static explicit operator IDWriteFontSet4(Silk.NET.DirectX.IDWriteFontSet value)
    {
        return new IDWriteFontSet4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontSet4"/> to <see cref = "Silk.NET.DirectX.IDWriteFontSet"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontSet4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDWriteFontSet(IDWriteFontSet4 value)
    {
        return new Silk.NET.DirectX.IDWriteFontSet(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDWriteFontSet4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDWriteFontSet4(Silk.NET.Windows.IUnknown value)
    {
        return new IDWriteFontSet4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDWriteFontSet4"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDWriteFontSet4"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDWriteFontSet4 value)
    {
