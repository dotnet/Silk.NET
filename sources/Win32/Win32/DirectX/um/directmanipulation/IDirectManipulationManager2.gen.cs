        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDirectManipulationManager2));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<IDirectManipulationManager2, Guid*, void**, int>)((*lpVtbl)[0])
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDirectManipulationManager2, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDirectManipulationManager2, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectManipulationManager2, HWND, int>)((*lpVtbl)[3]))(
            this,
            window
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectManipulationManager2, HWND, int>)((*lpVtbl)[4]))(
            this,
            window
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectManipulationManager2, MSG*, BOOL*, int>)((*lpVtbl)[6]))(
            this,
            message,
            handled
        );
    ...
    {
        return (
            (delegate* unmanaged<IDirectManipulationManager2, Guid*, void**, int>)((*lpVtbl)[7])
        )(this, riid, @object);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectManipulationManager2, Guid*, Guid*, void**, int>)(
                (*lpVtbl)[10]
            )
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDirectManipulationManager2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDirectManipulationManager2(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDirectManipulationManager"/> to <see cref = "IDirectManipulationManager2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDirectManipulationManager"/> instance to be converted </param>
    public static explicit operator IDirectManipulationManager2(
        Silk.NET.DirectX.IDirectManipulationManager value
    )
    {
        return new IDirectManipulationManager2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirectManipulationManager2"/> to <see cref = "Silk.NET.DirectX.IDirectManipulationManager"/>.</summary>
    /// <param name = "value">The <see cref = "IDirectManipulationManager2"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDirectManipulationManager(
        IDirectManipulationManager2 value
    )
    {
        return new Silk.NET.DirectX.IDirectManipulationManager(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDirectManipulationManager2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDirectManipulationManager2(Silk.NET.Windows.IUnknown value)
    {
        return new IDirectManipulationManager2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirectManipulationManager2"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDirectManipulationManager2"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDirectManipulationManager2 value)
    {
