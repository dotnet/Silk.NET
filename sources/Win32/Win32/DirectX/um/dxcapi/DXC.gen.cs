...
public static partial class DXC
{
    ...
    public const uint DXC_PART_PDB = (
        (uint)((byte)('I'))
        | (uint)((byte)('L')) << 8
        | (uint)((byte)('D')) << 16
        | (uint)((byte)('B')) << 24
    ...
    public const uint DXC_PART_PDB_NAME = (
        (uint)((byte)('I'))
        | (uint)((byte)('L')) << 8
        | (uint)((byte)('D')) << 16
        | (uint)((byte)('N')) << 24
    ...
    public const uint DXC_PART_PRIVATE_DATA = (
        (uint)((byte)('P'))
        | (uint)((byte)('R')) << 8
        | (uint)((byte)('I')) << 16
        | (uint)((byte)('V')) << 24
    ...
    public const uint DXC_PART_ROOT_SIGNATURE = (
        (uint)((byte)('R'))
        | (uint)((byte)('T')) << 8
        | (uint)((byte)('S')) << 16
        | (uint)((byte)('0')) << 24
    ...
    public const uint DXC_PART_DXIL = (
        (uint)((byte)('D'))
        | (uint)((byte)('X')) << 8
        | (uint)((byte)('I')) << 16
        | (uint)((byte)('L')) << 24
    ...
    public const uint DXC_PART_REFLECTION_DATA = (
        (uint)((byte)('S'))
        | (uint)((byte)('T')) << 8
        | (uint)((byte)('A')) << 16
        | (uint)((byte)('T')) << 24
    ...
    public const uint DXC_PART_SHADER_HASH = (
        (uint)((byte)('H'))
        | (uint)((byte)('A')) << 8
        | (uint)((byte)('S')) << 16
        | (uint)((byte)('H')) << 24
    ...
    public const uint DXC_PART_INPUT_SIGNATURE = (
        (uint)((byte)('I'))
        | (uint)((byte)('S')) << 8
        | (uint)((byte)('G')) << 16
        | (uint)((byte)('1')) << 24
    ...
    public const uint DXC_PART_OUTPUT_SIGNATURE = (
        (uint)((byte)('O'))
        | (uint)((byte)('S')) << 8
        | (uint)((byte)('G')) << 16
        | (uint)((byte)('1')) << 24
    ...
    public const uint DXC_PART_PATCH_CONSTANT_SIGNATURE = (
        (uint)((byte)('P'))
        | (uint)((byte)('S')) << 8
        | (uint)((byte)('G')) << 16
        | (uint)((byte)('1')) << 24
