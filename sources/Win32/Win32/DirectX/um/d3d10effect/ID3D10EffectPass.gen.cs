...
public unsafe partial struct ID3D10EffectPass : ID3D10EffectPass.Interface
{
    ...
    public BOOL IsValid()
    {
        return ((delegate* unmanaged<ID3D10EffectPass*, int>)((*lpVtbl)[0]))(
            (ID3D10EffectPass*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D10EffectPass*, D3D10_PASS_DESC*, int>)((*lpVtbl)[1]))(
            (ID3D10EffectPass*)Unsafe.AsPointer(ref this),
            pDesc
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectPass*, D3D10_PASS_SHADER_DESC*, int>)((*lpVtbl)[2])
        )((ID3D10EffectPass*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectPass*, D3D10_PASS_SHADER_DESC*, int>)((*lpVtbl)[3])
        )((ID3D10EffectPass*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectPass*, D3D10_PASS_SHADER_DESC*, int>)((*lpVtbl)[4])
        )((ID3D10EffectPass*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectPass*, uint, ID3D10EffectVariable*>)((*lpVtbl)[5])
        )((ID3D10EffectPass*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectPass*, sbyte*, ID3D10EffectVariable*>)((*lpVtbl)[6])
        )((ID3D10EffectPass*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D10EffectPass*, uint, int>)((*lpVtbl)[7]))(
            (ID3D10EffectPass*)Unsafe.AsPointer(ref this),
            Flags
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectPass*, D3D10_STATE_BLOCK_MASK*, int>)((*lpVtbl)[8])
        )((ID3D10EffectPass*)Unsafe.AsPointer(ref this), pStateBlockMask);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (D3D10_PASS_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, D3D10_PASS_DESC*, int> GetDesc;

        [NativeTypeName(
            "HRESULT (D3D10_PASS_SHADER_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (D3D10_STATE_BLOCK_MASK *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
