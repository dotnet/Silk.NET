...
public unsafe partial struct ID3D10EffectTechnique : ID3D10EffectTechnique.Interface
{
    ...
    public BOOL IsValid()
    {
        return ((delegate* unmanaged<ID3D10EffectTechnique*, int>)((*lpVtbl)[0]))(
            (ID3D10EffectTechnique*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectTechnique*, D3D10_TECHNIQUE_DESC*, int>)((*lpVtbl)[1])
        )((ID3D10EffectTechnique*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectTechnique*, uint, ID3D10EffectVariable*>)((*lpVtbl)[2])
        )((ID3D10EffectTechnique*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectTechnique*, sbyte*, ID3D10EffectVariable*>)(
                (*lpVtbl)[3]
            )
        )((ID3D10EffectTechnique*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectTechnique*, uint, ID3D10EffectPass*>)((*lpVtbl)[4])
        )((ID3D10EffectTechnique*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectTechnique*, sbyte*, ID3D10EffectPass*>)((*lpVtbl)[5])
        )((ID3D10EffectTechnique*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectTechnique*, D3D10_STATE_BLOCK_MASK*, int>)(
                (*lpVtbl)[6]
            )
        )((ID3D10EffectTechnique*)Unsafe.AsPointer(ref this), pStateBlockMask);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (D3D10_TECHNIQUE_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "ID3D10EffectPass *(UINT) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, uint, ID3D10EffectPass*> GetPassByIndex;

        [NativeTypeName(
            "ID3D10EffectPass *(LPCSTR) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
