    ...
    : ID3D10EffectRenderTargetViewVariable.Interface
{
    ...
    public BOOL IsValid()
    {
        return ((delegate* unmanaged<ID3D10EffectRenderTargetViewVariable*, int>)((*lpVtbl)[0]))(
            (ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectRenderTargetViewVariable*, ID3D10EffectType*>)(
                (*lpVtbl)[1]
            )
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this));
    }
    ...
    public HRESULT GetDesc(D3D10_EFFECT_VARIABLE_DESC* pDesc)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)((*lpVtbl)[2])
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    public ID3D10EffectVariable* GetAnnotationByIndex(uint Index)
    {
        ...
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    public ID3D10EffectVariable* GetAnnotationByName([NativeTypeName("LPCSTR")] sbyte* Name)
    {
        ...
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    public ID3D10EffectVariable* GetMemberBySemantic([NativeTypeName("LPCSTR")] sbyte* Semantic)
    {
        ...
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this), Semantic);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D10EffectRenderTargetViewVariable*, void*, uint, uint, int>)(
                (*lpVtbl)[23]
            )
        )(
            (ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this),
    ...
    public HRESULT SetRenderTarget(ID3D10RenderTargetView pResource)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)((*lpVtbl)[25])
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this), pResource);
    }
    ...
    public HRESULT GetRenderTarget(ID3D10RenderTargetView* ppResource)
    {
        return (
            (delegate* unmanaged<
                ...
                ID3D10RenderTargetView*,
                int>)((*lpVtbl)[26])
        )((ID3D10EffectRenderTargetViewVariable*)Unsafe.AsPointer(ref this), ppResource);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (ID3D10RenderTargetView *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (ID3D10RenderTargetView **, UINT, UINT) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            ID3D10RenderTargetView*,
