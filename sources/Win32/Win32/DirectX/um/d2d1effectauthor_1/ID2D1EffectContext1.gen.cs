...
public unsafe partial struct ID2D1EffectContext1 : ID2D1EffectContext1.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1EffectContext1));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1EffectContext1, float*, float*, void>)((*lpVtbl)[3]))(
            this,
            dpiX,
            dpiY
        );
    ...
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, Guid*, ID2D1Effect*, int>)((*lpVtbl)[4]))(
            this,
            effectId,
            effect
        );
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, ID2D1Effect, ID2D1TransformNode*, int>)(
                (*lpVtbl)[6]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, POINT, ID2D1OffsetTransform*, int>)(
                (*lpVtbl)[9]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, RECT*, ID2D1BoundsAdjustmentTransform*, int>)(
                (*lpVtbl)[10]
            )
    ...
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, Guid*, byte*, uint, int>)((*lpVtbl)[11]))(
            this,
            shaderId,
            shaderBuffer,
            shaderBufferCount
    ...
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, Guid*, byte*, uint, int>)((*lpVtbl)[12]))(
            this,
            resourceId,
            shaderBuffer,
            shaderBufferCount
    ...
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, Guid*, byte*, uint, int>)((*lpVtbl)[13]))(
            this,
            resourceId,
            shaderBuffer,
            shaderBufferCount
    ...
    {
        return ((delegate* unmanaged<ID2D1EffectContext1, Guid*, int>)((*lpVtbl)[14]))(
            this,
            shaderId
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, Guid*, ID2D1ResourceTexture*, int>)(
                (*lpVtbl)[16]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, Guid*, ID2D1VertexBuffer*, int>)(
                (*lpVtbl)[18]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, ushort*, ID2D1ColorContext*, int>)(
                (*lpVtbl)[20]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, IWICColorContext, ID2D1ColorContext*, int>)(
                (*lpVtbl)[21]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, D2D1_FEATURE, void*, uint, int>)(
                (*lpVtbl)[22]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1EffectContext1, D2D1_BUFFER_PRECISION, int>)((*lpVtbl)[23])
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1EffectContext1"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1EffectContext1(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1EffectContext"/> to <see cref = "ID2D1EffectContext1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1EffectContext"/> instance to be converted </param>
    public static explicit operator ID2D1EffectContext1(Silk.NET.DirectX.ID2D1EffectContext value)
    {
        return new ID2D1EffectContext1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1EffectContext1"/> to <see cref = "Silk.NET.DirectX.ID2D1EffectContext"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1EffectContext1"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1EffectContext(ID2D1EffectContext1 value)
    {
        return new Silk.NET.DirectX.ID2D1EffectContext(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1EffectContext1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1EffectContext1(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1EffectContext1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1EffectContext1"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1EffectContext1"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1EffectContext1 value)
    {
