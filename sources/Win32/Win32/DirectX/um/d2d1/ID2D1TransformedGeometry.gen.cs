        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1TransformedGeometry));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1TransformedGeometry, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1TransformedGeometry, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1TransformedGeometry, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1TransformedGeometry, ID2D1Factory*, void>)((*lpVtbl)[3]))(
            this,
            factory
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1TransformedGeometry, D2D_MATRIX_3X2_F*, D2D_RECT_F*, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1TransformedGeometry, D2D_MATRIX_3X2_F*, float, float*, int>)(
                (*lpVtbl)[13]
            )
    ...
    {
        ((delegate* unmanaged<ID2D1TransformedGeometry, ID2D1Geometry*, void>)((*lpVtbl)[17]))(
            this,
            sourceGeometry
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1TransformedGeometry, D2D_MATRIX_3X2_F*, void>)((*lpVtbl)[18]))(
            this,
            transform
        );
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "void (ID2D1Geometry **) const __attribute__((nothrow)) __attribute__((stdcall))"
        )]
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1TransformedGeometry"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1TransformedGeometry(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Geometry"/> to <see cref = "ID2D1TransformedGeometry"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Geometry"/> instance to be converted </param>
    public static explicit operator ID2D1TransformedGeometry(Silk.NET.DirectX.ID2D1Geometry value)
    {
        return new ID2D1TransformedGeometry(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1TransformedGeometry"/> to <see cref = "Silk.NET.DirectX.ID2D1Geometry"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1TransformedGeometry"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Geometry(ID2D1TransformedGeometry value)
    {
        return new Silk.NET.DirectX.ID2D1Geometry(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Resource"/> to <see cref = "ID2D1TransformedGeometry"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Resource"/> instance to be converted </param>
    public static explicit operator ID2D1TransformedGeometry(Silk.NET.DirectX.ID2D1Resource value)
    {
        return new ID2D1TransformedGeometry(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1TransformedGeometry"/> to <see cref = "Silk.NET.DirectX.ID2D1Resource"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1TransformedGeometry"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Resource(ID2D1TransformedGeometry value)
    {
        return new Silk.NET.DirectX.ID2D1Resource(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1TransformedGeometry"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1TransformedGeometry(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1TransformedGeometry(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1TransformedGeometry"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1TransformedGeometry"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1TransformedGeometry value)
    {
