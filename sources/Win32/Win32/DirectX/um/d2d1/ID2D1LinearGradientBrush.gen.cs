        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1LinearGradientBrush));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1LinearGradientBrush, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1LinearGradientBrush, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1LinearGradientBrush, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1LinearGradientBrush, ID2D1Factory*, void>)((*lpVtbl)[3]))(
            this,
            factory
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1LinearGradientBrush, float, void>)((*lpVtbl)[4]))(this, opacity);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1LinearGradientBrush, D2D_MATRIX_3X2_F*, void>)((*lpVtbl)[5]))(
            this,
            transform
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1LinearGradientBrush, float>)((*lpVtbl)[6]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1LinearGradientBrush, D2D_MATRIX_3X2_F*, void>)((*lpVtbl)[7]))(
            this,
            transform
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1LinearGradientBrush, D2D_POINT_2F, void>)((*lpVtbl)[8]))(
            this,
            startPoint
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1LinearGradientBrush, D2D_POINT_2F, void>)((*lpVtbl)[9]))(
            this,
            endPoint
        );
    }
    ...
    public D2D_POINT_2F GetStartPoint()
    {
        D2D_POINT_2F result;
        return *(
            (delegate* unmanaged<ID2D1LinearGradientBrush, D2D_POINT_2F*, D2D_POINT_2F*>)(
                (*lpVtbl)[10]
            )
        )(this, &result);
    }
    ...
    {
        (
            (delegate* unmanaged<ID2D1LinearGradientBrush, ID2D1GradientStopCollection*, void>)(
                (*lpVtbl)[12]
            )
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1LinearGradientBrush"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1LinearGradientBrush(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Brush"/> to <see cref = "ID2D1LinearGradientBrush"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Brush"/> instance to be converted </param>
    public static explicit operator ID2D1LinearGradientBrush(Silk.NET.DirectX.ID2D1Brush value)
    {
        return new ID2D1LinearGradientBrush(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1LinearGradientBrush"/> to <see cref = "Silk.NET.DirectX.ID2D1Brush"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1LinearGradientBrush"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Brush(ID2D1LinearGradientBrush value)
    {
        return new Silk.NET.DirectX.ID2D1Brush(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Resource"/> to <see cref = "ID2D1LinearGradientBrush"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Resource"/> instance to be converted </param>
    public static explicit operator ID2D1LinearGradientBrush(Silk.NET.DirectX.ID2D1Resource value)
    {
        return new ID2D1LinearGradientBrush(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1LinearGradientBrush"/> to <see cref = "Silk.NET.DirectX.ID2D1Resource"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1LinearGradientBrush"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Resource(ID2D1LinearGradientBrush value)
    {
        return new Silk.NET.DirectX.ID2D1Resource(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1LinearGradientBrush"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1LinearGradientBrush(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1LinearGradientBrush(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1LinearGradientBrush"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1LinearGradientBrush"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1LinearGradientBrush value)
    {
