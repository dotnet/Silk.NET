        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1SimplifiedGeometrySink));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<ID2D1SimplifiedGeometrySink, Guid*, void**, int>)((*lpVtbl)[0])
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1SimplifiedGeometrySink, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1SimplifiedGeometrySink, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1SimplifiedGeometrySink, D2D1_FILL_MODE, void>)((*lpVtbl)[3]))(
            this,
            fillMode
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1SimplifiedGeometrySink, D2D1_PATH_SEGMENT, void>)((*lpVtbl)[4]))(
            this,
            vertexFlags
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1SimplifiedGeometrySink, D2D1_FIGURE_END, void>)((*lpVtbl)[8]))(
            this,
            figureEnd
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1SimplifiedGeometrySink, int>)((*lpVtbl)[9]))(this);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1SimplifiedGeometrySink"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1SimplifiedGeometrySink(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1SimplifiedGeometrySink"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1SimplifiedGeometrySink(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1SimplifiedGeometrySink(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1SimplifiedGeometrySink"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1SimplifiedGeometrySink"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1SimplifiedGeometrySink value)
    {
