...
public unsafe partial struct IDirectDraw7 : IDirectDraw7.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDirectDraw7));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDirectDraw7, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDirectDraw7, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, int>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDraw7, uint, IDirectDrawClipper*, IUnknown, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return (
            (delegate* unmanaged<IDirectDraw7, IDirectDrawSurface7, IDirectDrawSurface7*, int>)(
                (*lpVtbl)[7]
            )
        )(this, param0, param1);
    }
    ...
    public HRESULT EnumSurfaces(
        ...
        [NativeTypeName("LPDDENUMSURFACESCALLBACK7")]
            delegate* unmanaged<IDirectDrawSurface7, DDSURFACEDESC2*, void*, HRESULT> param3
    )
    {
        return (
            (delegate* unmanaged<
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, int>)((*lpVtbl)[10]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, DDCAPS_DX7*, DDCAPS_DX7*, int>)((*lpVtbl)[11]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, DDSURFACEDESC2*, int>)((*lpVtbl)[12]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, uint*, uint*, int>)((*lpVtbl)[13]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, IDirectDrawSurface7*, int>)((*lpVtbl)[14]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, uint*, int>)((*lpVtbl)[15]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, uint*, int>)((*lpVtbl)[16]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, BOOL*, int>)((*lpVtbl)[17]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, Guid*, int>)((*lpVtbl)[18]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, int>)((*lpVtbl)[19]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, HWND, uint, int>)((*lpVtbl)[20]))(
            this,
            param0,
            param1
        );
    ...
    {
        return (
            (delegate* unmanaged<IDirectDraw7, uint, uint, uint, uint, uint, int>)((*lpVtbl)[21])
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, uint, HANDLE, int>)((*lpVtbl)[22]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, DDSCAPS2*, uint*, uint*, int>)((*lpVtbl)[23]))(
            this,
            param0,
            param1,
            param2
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, HDC, IDirectDrawSurface7*, int>)((*lpVtbl)[24]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, int>)((*lpVtbl)[25]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDraw7, int>)((*lpVtbl)[26]))(this);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(27)]
    public HRESULT GetDeviceIdentifier(
        [NativeTypeName("LPDDDEVICEIDENTIFIER2")] DDDEVICEIDENTIFIER2* param0,
        [NativeTypeName("DWORD")] uint param1
    )
    {
        return (
            (delegate* unmanaged<IDirectDraw7, DDDEVICEIDENTIFIER2*, uint, int>)((*lpVtbl)[27])
        )(this, param0, param1);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(28)]
    public HRESULT StartModeTest(
        [NativeTypeName("LPSIZE")] SIZE* param0,
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("DWORD")] uint param2
    )
    {
        return ((delegate* unmanaged<IDirectDraw7, SIZE*, uint, uint, int>)((*lpVtbl)[28]))(
            this,
            param0,
            param1,
            param2
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(29)]
    public HRESULT EvaluateMode(
        [NativeTypeName("DWORD")] uint param0,
        [NativeTypeName("DWORD *")] uint* param1
    )
    {
        return ((delegate* unmanaged<IDirectDraw7, uint, uint*, int>)((*lpVtbl)[29]))(
            this,
            param0,
            param1
        );
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (LPDDSURFACEDESC2, LPDIRECTDRAWSURFACE7 *, IUnknown *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            DDSURFACEDESC2*,
        ...
        [NativeTypeName(
            "HRESULT (LPDIRECTDRAWSURFACE7, LPDIRECTDRAWSURFACE7 *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            IDirectDrawSurface7,
        ...
        [NativeTypeName(
            "HRESULT (DWORD, LPDDSURFACEDESC2, LPVOID, LPDDENUMSURFACESCALLBACK7) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            uint,
        ...
        [NativeTypeName(
            "HRESULT (HDC, LPDIRECTDRAWSURFACE7 *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (LPDDDEVICEIDENTIFIER2, DWORD) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, DDDEVICEIDENTIFIER2*, uint, int> GetDeviceIdentifier;

        [NativeTypeName(
            "HRESULT (LPSIZE, DWORD, DWORD) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDirectDraw7"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDirectDraw7(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDirectDraw7"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDirectDraw7(Silk.NET.Windows.IUnknown value)
    {
        return new IDirectDraw7(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirectDraw7"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDirectDraw7"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDirectDraw7 value)
    {
