...
public unsafe partial struct IDirectDrawSurface2 : IDirectDrawSurface2.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDirectDrawSurface2));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint>)((*lpVtbl)[2]))(this);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(3)]
    public HRESULT AddAttachedSurface(
        [NativeTypeName("LPDIRECTDRAWSURFACE2")] IDirectDrawSurface2 param0
    )
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, IDirectDrawSurface2, int>)((*lpVtbl)[3]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, RECT*, int>)((*lpVtbl)[4]))(this, param0);
    }
    ...
    public HRESULT Blt(
        ...
        [NativeTypeName("LPDIRECTDRAWSURFACE2")] IDirectDrawSurface2 param1,
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, DDBLTBATCH*, uint, uint, int>)((*lpVtbl)[6])
    ...
    public HRESULT BltFast(
        ...
        [NativeTypeName("DWORD")] uint param1,
        [NativeTypeName("LPDIRECTDRAWSURFACE2")] IDirectDrawSurface2 param2,
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, uint, IDirectDrawSurface2, int>)((*lpVtbl)[8])
        )(this, param0, param1);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, IDirectDrawSurface2, uint, int>)(
                (*lpVtbl)[11]
            )
        )(this, param0, param1);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, DDSCAPS*, IDirectDrawSurface2*, int>)(
                (*lpVtbl)[12]
            )
        )(this, param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, int>)((*lpVtbl)[13]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, DDSCAPS*, int>)((*lpVtbl)[14]))(
            this,
            param0
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, IDirectDrawClipper*, int>)((*lpVtbl)[15])
        )(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, DDCOLORKEY*, int>)((*lpVtbl)[16]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, HDC*, int>)((*lpVtbl)[17]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, int>)((*lpVtbl)[18]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, int*, int*, int>)((*lpVtbl)[19]))(
            this,
            param0,
            param1
        );
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, IDirectDrawPalette*, int>)((*lpVtbl)[20])
        )(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, DDPIXELFORMAT*, int>)((*lpVtbl)[21]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, DDSURFACEDESC*, int>)((*lpVtbl)[22]))(
            this,
            param0
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, IDirectDraw, DDSURFACEDESC*, int>)(
                (*lpVtbl)[23]
            )
        )(this, param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, int>)((*lpVtbl)[24]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, RECT*, DDSURFACEDESC*, uint, HANDLE, int>)(
                (*lpVtbl)[25]
            )
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, HDC, int>)((*lpVtbl)[26]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, int>)((*lpVtbl)[27]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, IDirectDrawClipper, int>)((*lpVtbl)[28]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, DDCOLORKEY*, int>)((*lpVtbl)[29]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, int, int, int>)((*lpVtbl)[30]))(
            this,
            param0,
            param1
        );
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, IDirectDrawPalette, int>)((*lpVtbl)[31]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, void*, int>)((*lpVtbl)[32]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, int>)((*lpVtbl)[34]))(this, param0);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDirectDrawSurface2, uint, IDirectDrawSurface2, int>)(
                (*lpVtbl)[35]
            )
        )(this, param0, param1);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, void**, int>)((*lpVtbl)[36]))(
            this,
            param0
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, int>)((*lpVtbl)[37]))(this, param0);
    }
    ...
    {
        return ((delegate* unmanaged<IDirectDrawSurface2, uint, int>)((*lpVtbl)[38]))(this, param0);
    }
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (LPDIRECTDRAWSURFACE2) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (LPRECT, LPDIRECTDRAWSURFACE2, LPRECT, DWORD, LPDDBLTFX) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (DWORD, DWORD, LPDIRECTDRAWSURFACE2, LPRECT, DWORD) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            uint,
        ...
        [NativeTypeName(
            "HRESULT (DWORD, LPDIRECTDRAWSURFACE2) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (LPDIRECTDRAWSURFACE2, DWORD) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, IDirectDrawSurface2, uint, int> Flip;

        [NativeTypeName(
            "HRESULT (LPDDSCAPS, LPDIRECTDRAWSURFACE2 *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "HRESULT (LPRECT, LPDIRECTDRAWSURFACE2, LPRECT, DWORD, LPDDOVERLAYFX) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            RECT*,
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDirectDrawSurface2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDirectDrawSurface2(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDirectDrawSurface2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDirectDrawSurface2(Silk.NET.Windows.IUnknown value)
    {
        return new IDirectDrawSurface2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDirectDrawSurface2"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDirectDrawSurface2"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDirectDrawSurface2 value)
    {
