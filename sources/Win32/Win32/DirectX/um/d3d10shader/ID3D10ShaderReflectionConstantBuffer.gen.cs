        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D10ShaderReflectionConstantBuffer));
    public void*** lpVtbl;
    ...
    public HRESULT GetDesc(D3D10_SHADER_BUFFER_DESC* pDesc)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)((*lpVtbl)[0])
        )((ID3D10ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    public ID3D10ShaderReflectionVariable* GetVariableByIndex(uint Index)
    {
        return (
            (delegate* unmanaged<
                ID3D10ShaderReflectionConstantBuffer*,
                uint,
                ID3D10ShaderReflectionVariable*>)((*lpVtbl)[1])
        )((ID3D10ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    public ID3D10ShaderReflectionVariable* GetVariableByName([NativeTypeName("LPCSTR")] sbyte* Name)
    {
        return (
            (delegate* unmanaged<
                ID3D10ShaderReflectionConstantBuffer*,
                sbyte*,
                ID3D10ShaderReflectionVariable*>)((*lpVtbl)[2])
        )((ID3D10ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        [NativeTypeName(
            "HRESULT (D3D10_SHADER_BUFFER_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, D3D10_SHADER_BUFFER_DESC*, int> GetDesc;

        [NativeTypeName(
            "ID3D10ShaderReflectionVariable *(UINT) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
