...
public unsafe partial struct ID2D1Device5 : ID2D1Device5.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1Device5));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1Device5, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1Device5, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1Device5, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Device5, ID2D1Factory*, void>)((*lpVtbl)[3]))(this, factory);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Device5, ulong, void>)((*lpVtbl)[6]))(this, maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Device5, ulong>)((*lpVtbl)[7]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Device5, uint, void>)((*lpVtbl)[8]))(this, millisecondsSinceUse);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Device5, D2D1_RENDERING_PRIORITY>)((*lpVtbl)[9]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Device5, D2D1_RENDERING_PRIORITY, void>)((*lpVtbl)[10]))(
            this,
            renderingPriority
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Device5, ID2D1Bitmap, void>)((*lpVtbl)[13]))(this, bitmap);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Device5, IDXGIDevice*, int>)((*lpVtbl)[14]))(
            this,
            dxgiDevice
        );
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Device5, ulong, void>)((*lpVtbl)[17]))(this, maximumInBytes);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Device5, ulong>)((*lpVtbl)[18]))(this);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1Device5"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1Device5(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Device4"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Device4"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.DirectX.ID2D1Device4 value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.DirectX.ID2D1Device4"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Device4(ID2D1Device5 value)
    {
        return new Silk.NET.DirectX.ID2D1Device4(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Device3"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Device3"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.DirectX.ID2D1Device3 value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.DirectX.ID2D1Device3"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Device3(ID2D1Device5 value)
    {
        return new Silk.NET.DirectX.ID2D1Device3(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Device2"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Device2"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.DirectX.ID2D1Device2 value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.DirectX.ID2D1Device2"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Device2(ID2D1Device5 value)
    {
        return new Silk.NET.DirectX.ID2D1Device2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Device1"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Device1"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.DirectX.ID2D1Device1 value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.DirectX.ID2D1Device1"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Device1(ID2D1Device5 value)
    {
        return new Silk.NET.DirectX.ID2D1Device1(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Device"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Device"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.DirectX.ID2D1Device value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.DirectX.ID2D1Device"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Device(ID2D1Device5 value)
    {
        return new Silk.NET.DirectX.ID2D1Device(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Resource"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Resource"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.DirectX.ID2D1Resource value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.DirectX.ID2D1Resource"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Resource(ID2D1Device5 value)
    {
        return new Silk.NET.DirectX.ID2D1Resource(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1Device5"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1Device5(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1Device5(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Device5"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Device5"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1Device5 value)
    {
