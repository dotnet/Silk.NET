...
public unsafe partial struct ID2D1Factory4 : ID2D1Factory4.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1Factory4));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory4, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1Factory4, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1Factory4, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory4, int>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID2D1Factory4, float*, float*, void>)((*lpVtbl)[4]))(
            this,
            dpiX,
            dpiY
        );
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, D2D_RECT_F*, ID2D1RectangleGeometry*, int>)(
                (*lpVtbl)[5]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, D2D1_ELLIPSE*, ID2D1EllipseGeometry*, int>)(
                (*lpVtbl)[7]
            )
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory4, ID2D1PathGeometry*, int>)((*lpVtbl)[10]))(
            this,
            pathGeometry
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, IDXGIDevice, ID2D1Device*, int>)((*lpVtbl)[17])
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory4, ID2D1PathGeometry1*, int>)((*lpVtbl)[19]))(
            this,
            pathGeometry
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, IStream, ID2D1GdiMetafile*, int>)((*lpVtbl)[21])
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory4, Guid*, int>)((*lpVtbl)[24]))(this, classId);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, Guid*, uint, uint*, uint*, int>)((*lpVtbl)[25])
    ...
    {
        return ((delegate* unmanaged<ID2D1Factory4, Guid*, ID2D1Properties*, int>)((*lpVtbl)[26]))(
            this,
            effectId,
            properties
        );
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, IDXGIDevice, ID2D1Device1*, int>)((*lpVtbl)[27])
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, IDXGIDevice, ID2D1Device2*, int>)((*lpVtbl)[28])
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Factory4, IDXGIDevice, ID2D1Device3*, int>)((*lpVtbl)[29])
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1Factory4"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1Factory4(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Factory3"/> to <see cref = "ID2D1Factory4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Factory3"/> instance to be converted </param>
    public static explicit operator ID2D1Factory4(Silk.NET.DirectX.ID2D1Factory3 value)
    {
        return new ID2D1Factory4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Factory4"/> to <see cref = "Silk.NET.DirectX.ID2D1Factory3"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Factory4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Factory3(ID2D1Factory4 value)
    {
        return new Silk.NET.DirectX.ID2D1Factory3(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Factory2"/> to <see cref = "ID2D1Factory4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Factory2"/> instance to be converted </param>
    public static explicit operator ID2D1Factory4(Silk.NET.DirectX.ID2D1Factory2 value)
    {
        return new ID2D1Factory4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Factory4"/> to <see cref = "Silk.NET.DirectX.ID2D1Factory2"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Factory4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Factory2(ID2D1Factory4 value)
    {
        return new Silk.NET.DirectX.ID2D1Factory2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Factory1"/> to <see cref = "ID2D1Factory4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Factory1"/> instance to be converted </param>
    public static explicit operator ID2D1Factory4(Silk.NET.DirectX.ID2D1Factory1 value)
    {
        return new ID2D1Factory4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Factory4"/> to <see cref = "Silk.NET.DirectX.ID2D1Factory1"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Factory4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Factory1(ID2D1Factory4 value)
    {
        return new Silk.NET.DirectX.ID2D1Factory1(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1Factory"/> to <see cref = "ID2D1Factory4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1Factory"/> instance to be converted </param>
    public static explicit operator ID2D1Factory4(Silk.NET.DirectX.ID2D1Factory value)
    {
        return new ID2D1Factory4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Factory4"/> to <see cref = "Silk.NET.DirectX.ID2D1Factory"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Factory4"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1Factory(ID2D1Factory4 value)
    {
        return new Silk.NET.DirectX.ID2D1Factory(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1Factory4"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1Factory4(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1Factory4(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Factory4"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Factory4"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1Factory4 value)
    {
