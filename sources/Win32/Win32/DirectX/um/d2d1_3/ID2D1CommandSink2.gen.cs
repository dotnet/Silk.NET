...
public unsafe partial struct ID2D1CommandSink2 : ID2D1CommandSink2.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1CommandSink2));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, int>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, int>)((*lpVtbl)[4]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, D2D1_ANTIALIAS_MODE, int>)((*lpVtbl)[5]))(
            this,
            antialiasMode
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, ulong, ulong, int>)((*lpVtbl)[6]))(
            this,
            tag1,
            tag2
        );
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, D2D1_TEXT_ANTIALIAS_MODE, int>)((*lpVtbl)[7])
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, IDWriteRenderingParams, int>)((*lpVtbl)[8])
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, D2D_MATRIX_3X2_F*, int>)((*lpVtbl)[9]))(
            this,
            transform
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, D2D1_PRIMITIVE_BLEND, int>)((*lpVtbl)[10]))(
            this,
            primitiveBlend
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, D2D1_UNIT_MODE, int>)((*lpVtbl)[11]))(
            this,
            unitMode
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, DXGI_RGBA*, int>)((*lpVtbl)[12]))(
            this,
            color
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, ID2D1GdiMetafile, D2D_POINT_2F*, int>)(
                (*lpVtbl)[19]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, ID2D1Mesh, ID2D1Brush, int>)((*lpVtbl)[20])
        )(this, mesh, brush);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, ID2D1Geometry, ID2D1Brush, ID2D1Brush, int>)(
                (*lpVtbl)[22]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, D2D_RECT_F*, ID2D1Brush, int>)((*lpVtbl)[23])
        )(this, rect, brush);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, D2D_RECT_F*, D2D1_ANTIALIAS_MODE, int>)(
                (*lpVtbl)[24]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, D2D1_LAYER_PARAMETERS1*, ID2D1Layer, int>)(
                (*lpVtbl)[25]
            )
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, int>)((*lpVtbl)[26]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, int>)((*lpVtbl)[27]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, D2D1_PRIMITIVE_BLEND, int>)((*lpVtbl)[28]))(
            this,
            primitiveBlend
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID2D1CommandSink2, ID2D1Ink, ID2D1Brush, ID2D1InkStyle, int>)(
                (*lpVtbl)[29]
            )
    ...
    {
        return ((delegate* unmanaged<ID2D1CommandSink2, ID2D1GradientMesh, int>)((*lpVtbl)[30]))(
            this,
            gradientMesh
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1CommandSink2"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1CommandSink2(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1CommandSink1"/> to <see cref = "ID2D1CommandSink2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1CommandSink1"/> instance to be converted </param>
    public static explicit operator ID2D1CommandSink2(Silk.NET.DirectX.ID2D1CommandSink1 value)
    {
        return new ID2D1CommandSink2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1CommandSink2"/> to <see cref = "Silk.NET.DirectX.ID2D1CommandSink1"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1CommandSink2"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1CommandSink1(ID2D1CommandSink2 value)
    {
        return new Silk.NET.DirectX.ID2D1CommandSink1(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1CommandSink"/> to <see cref = "ID2D1CommandSink2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1CommandSink"/> instance to be converted </param>
    public static explicit operator ID2D1CommandSink2(Silk.NET.DirectX.ID2D1CommandSink value)
    {
        return new ID2D1CommandSink2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1CommandSink2"/> to <see cref = "Silk.NET.DirectX.ID2D1CommandSink"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1CommandSink2"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1CommandSink(ID2D1CommandSink2 value)
    {
        return new Silk.NET.DirectX.ID2D1CommandSink(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1CommandSink2"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1CommandSink2(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1CommandSink2(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1CommandSink2"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1CommandSink2"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1CommandSink2 value)
    {
