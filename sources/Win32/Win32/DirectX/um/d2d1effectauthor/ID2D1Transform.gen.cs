...
public unsafe partial struct ID2D1Transform : ID2D1Transform.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID2D1Transform));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID2D1Transform, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID2D1Transform, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID2D1Transform, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Transform, uint>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID2D1Transform, RECT*, RECT*, uint, int>)((*lpVtbl)[4]))(
            this,
            outputRect,
            inputRects,
            inputRectsCount
    ...
    {
        return (
            (delegate* unmanaged<ID2D1Transform, RECT*, RECT*, uint, RECT*, RECT*, int>)(
                (*lpVtbl)[5]
            )
    ...
    {
        return ((delegate* unmanaged<ID2D1Transform, uint, RECT, RECT*, int>)((*lpVtbl)[6]))(
            this,
            inputIndex,
            invalidInputRect,
            invalidOutputRect
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID2D1Transform"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID2D1Transform(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID2D1TransformNode"/> to <see cref = "ID2D1Transform"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID2D1TransformNode"/> instance to be converted </param>
    public static explicit operator ID2D1Transform(Silk.NET.DirectX.ID2D1TransformNode value)
    {
        return new ID2D1Transform(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Transform"/> to <see cref = "Silk.NET.DirectX.ID2D1TransformNode"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Transform"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID2D1TransformNode(ID2D1Transform value)
    {
        return new Silk.NET.DirectX.ID2D1TransformNode(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID2D1Transform"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID2D1Transform(Silk.NET.Windows.IUnknown value)
    {
        return new ID2D1Transform(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID2D1Transform"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID2D1Transform"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID2D1Transform value)
    {
