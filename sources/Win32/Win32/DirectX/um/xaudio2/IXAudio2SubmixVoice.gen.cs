...
public unsafe partial struct IXAudio2SubmixVoice : IXAudio2SubmixVoice.Interface
{
    ...
    {
        ((delegate* unmanaged<IXAudio2SubmixVoice*, XAUDIO2_VOICE_DETAILS*, void>)((*lpVtbl)[0]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            pVoiceDetails
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2SubmixVoice*, XAUDIO2_VOICE_SENDS*, int>)((*lpVtbl)[1])
        )((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), pSendList);
    }
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2SubmixVoice*, XAUDIO2_EFFECT_CHAIN*, int>)((*lpVtbl)[2])
        )((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), pEffectChain);
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2SubmixVoice*, uint, uint, int>)((*lpVtbl)[3]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            OperationSet
        );
    ...
    {
        return ((delegate* unmanaged<IXAudio2SubmixVoice*, uint, uint, int>)((*lpVtbl)[4]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            OperationSet
        );
    ...
    {
        ((delegate* unmanaged<IXAudio2SubmixVoice*, uint, BOOL*, void>)((*lpVtbl)[5]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            pEnabled
        );
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2SubmixVoice*, uint, void*, uint, uint, int>)((*lpVtbl)[6])
        )(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            pParameters,
    ...
    {
        return ((delegate* unmanaged<IXAudio2SubmixVoice*, uint, void*, uint, int>)((*lpVtbl)[7]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            pParameters,
            ParametersByteSize
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2SubmixVoice*, XAUDIO2_FILTER_PARAMETERS*, uint, int>)(
                (*lpVtbl)[8]
            )
        )((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), pParameters, OperationSet);
    }
    ...
    {
        (
            (delegate* unmanaged<IXAudio2SubmixVoice*, XAUDIO2_FILTER_PARAMETERS*, void>)(
                (*lpVtbl)[9]
            )
        )((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), pParameters);
    }
    ...
    )
    {
        (
            (delegate* unmanaged<
                ...
                XAUDIO2_FILTER_PARAMETERS*,
                void>)((*lpVtbl)[11])
        )((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), pDestinationVoice, pParameters);
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2SubmixVoice*, float, uint, int>)((*lpVtbl)[12]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            Volume,
            OperationSet
        );
    ...
    {
        ((delegate* unmanaged<IXAudio2SubmixVoice*, float*, void>)((*lpVtbl)[13]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            pVolume
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2SubmixVoice*, uint, float*, uint, int>)((*lpVtbl)[14])
        )((IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this), Channels, pVolumes, OperationSet);
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2SubmixVoice*, uint, float*, void>)((*lpVtbl)[15]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
            Channels,
            pVolumes
        );
    ...
    {
        (
            (delegate* unmanaged<IXAudio2SubmixVoice*, IXAudio2Voice*, uint, uint, float*, void>)(
                (*lpVtbl)[17]
            )
        )(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this),
    ...
    {
        ((delegate* unmanaged<IXAudio2SubmixVoice*, void>)((*lpVtbl)[18]))(
            (IXAudio2SubmixVoice*)Unsafe.AsPointer(ref this)
        );
    }
