...
public unsafe partial struct IXAudio2EngineCallback : IXAudio2EngineCallback.Interface
{
    ...
    {
        ((delegate* unmanaged<IXAudio2EngineCallback*, void>)((*lpVtbl)[0]))(
            (IXAudio2EngineCallback*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2EngineCallback*, void>)((*lpVtbl)[1]))(
            (IXAudio2EngineCallback*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2EngineCallback*, HRESULT, void>)((*lpVtbl)[2]))(
            (IXAudio2EngineCallback*)Unsafe.AsPointer(ref this),
            Error
        );
    }
