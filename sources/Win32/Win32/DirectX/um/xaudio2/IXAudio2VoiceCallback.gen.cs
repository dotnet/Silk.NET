...
public unsafe partial struct IXAudio2VoiceCallback : IXAudio2VoiceCallback.Interface
{
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, uint, void>)((*lpVtbl)[0]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this),
            BytesRequired
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, void>)((*lpVtbl)[1]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, void>)((*lpVtbl)[2]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, void*, void>)((*lpVtbl)[3]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this),
            pBufferContext
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, void*, void>)((*lpVtbl)[4]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this),
            pBufferContext
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, void*, void>)((*lpVtbl)[5]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this),
            pBufferContext
        );
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2VoiceCallback*, void*, HRESULT, void>)((*lpVtbl)[6]))(
            (IXAudio2VoiceCallback*)Unsafe.AsPointer(ref this),
            pBufferContext,
            Error
        );
