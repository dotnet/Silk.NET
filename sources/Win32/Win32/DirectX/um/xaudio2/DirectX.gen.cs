...
public static unsafe partial class DirectX
{
    ...
    public static extern HRESULT XAudio2CreateWithVersionInfo(
        IXAudio2* ppXAudio2,
        [NativeTypeName("UINT32")] uint Flags = 0,
        [NativeTypeName("XAUDIO2_PROCESSOR")] uint XAudio2Processor = 0x00000001,
        [NativeTypeName("DWORD")] uint ntddiVersion = 0x0A000010
    );
