...
public unsafe partial struct IXAudio2Voice : IXAudio2Voice.Interface
{
    ...
    {
        ((delegate* unmanaged<IXAudio2Voice*, XAUDIO2_VOICE_DETAILS*, void>)((*lpVtbl)[0]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            pVoiceDetails
        );
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, XAUDIO2_VOICE_SENDS*, int>)((*lpVtbl)[1]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            pSendList
        );
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, XAUDIO2_EFFECT_CHAIN*, int>)((*lpVtbl)[2]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            pEffectChain
        );
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, uint, uint, int>)((*lpVtbl)[3]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            OperationSet
        );
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, uint, uint, int>)((*lpVtbl)[4]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            OperationSet
        );
    ...
    {
        ((delegate* unmanaged<IXAudio2Voice*, uint, BOOL*, void>)((*lpVtbl)[5]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            pEnabled
        );
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, uint, void*, uint, uint, int>)((*lpVtbl)[6]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            pParameters,
            ParametersByteSize,
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, uint, void*, uint, int>)((*lpVtbl)[7]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            EffectIndex,
            pParameters,
            ParametersByteSize
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2Voice*, XAUDIO2_FILTER_PARAMETERS*, uint, int>)(
                (*lpVtbl)[8]
            )
        )((IXAudio2Voice*)Unsafe.AsPointer(ref this), pParameters, OperationSet);
    }
    ...
    {
        ((delegate* unmanaged<IXAudio2Voice*, XAUDIO2_FILTER_PARAMETERS*, void>)((*lpVtbl)[9]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            pParameters
        );
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                uint,
                int>)((*lpVtbl)[10])
        )((IXAudio2Voice*)Unsafe.AsPointer(ref this), pDestinationVoice, pParameters, OperationSet);
    }
    ...
    {
        (
            (delegate* unmanaged<IXAudio2Voice*, IXAudio2Voice*, XAUDIO2_FILTER_PARAMETERS*, void>)(
                (*lpVtbl)[11]
            )
        )((IXAudio2Voice*)Unsafe.AsPointer(ref this), pDestinationVoice, pParameters);
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, float, uint, int>)((*lpVtbl)[12]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            Volume,
            OperationSet
        );
    ...
    {
        ((delegate* unmanaged<IXAudio2Voice*, float*, void>)((*lpVtbl)[13]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            pVolume
        );
    }
    ...
    {
        return ((delegate* unmanaged<IXAudio2Voice*, uint, float*, uint, int>)((*lpVtbl)[14]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            Channels,
            pVolumes,
            OperationSet
    ...
    {
        ((delegate* unmanaged<IXAudio2Voice*, uint, float*, void>)((*lpVtbl)[15]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
            Channels,
            pVolumes
        );
    ...
    {
        return (
            (delegate* unmanaged<IXAudio2Voice*, IXAudio2Voice*, uint, uint, float*, uint, int>)(
                (*lpVtbl)[16]
            )
        )(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
    ...
    {
        (
            (delegate* unmanaged<IXAudio2Voice*, IXAudio2Voice*, uint, uint, float*, void>)(
                (*lpVtbl)[17]
            )
        )(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this),
    ...
    {
        ((delegate* unmanaged<IXAudio2Voice*, void>)((*lpVtbl)[18]))(
            (IXAudio2Voice*)Unsafe.AsPointer(ref this)
        );
    }
