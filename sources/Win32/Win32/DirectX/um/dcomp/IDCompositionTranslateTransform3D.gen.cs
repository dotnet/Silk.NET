        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDCompositionTranslateTransform3D));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionTranslateTransform3D, Guid*, void**, int>)(
                (*lpVtbl)[0]
            )
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDCompositionTranslateTransform3D, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDCompositionTranslateTransform3D, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionTranslateTransform3D, IDCompositionAnimation, int>)(
                (*lpVtbl)[3]
            )
        )(this, animation);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionTranslateTransform3D, float, int>)((*lpVtbl)[4]))(
            this,
            offsetX
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionTranslateTransform3D, float, int>)((*lpVtbl)[6]))(
            this,
            offsetY
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionTranslateTransform3D, float, int>)((*lpVtbl)[8]))(
            this,
            offsetZ
        );
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDCompositionTranslateTransform3D"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDCompositionTranslateTransform3D(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDCompositionTransform3D"/> to <see cref = "IDCompositionTranslateTransform3D"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDCompositionTransform3D"/> instance to be converted </param>
    public static explicit operator IDCompositionTranslateTransform3D(
        Silk.NET.DirectX.IDCompositionTransform3D value
    )
    {
        return new IDCompositionTranslateTransform3D(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDCompositionTranslateTransform3D"/> to <see cref = "Silk.NET.DirectX.IDCompositionTransform3D"/>.</summary>
    /// <param name = "value">The <see cref = "IDCompositionTranslateTransform3D"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDCompositionTransform3D(
        IDCompositionTranslateTransform3D value
    )
    {
        return new Silk.NET.DirectX.IDCompositionTransform3D(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDCompositionEffect"/> to <see cref = "IDCompositionTranslateTransform3D"/>.</summary>
    ...
    /// <summary>Upcasts <see cref = "IDCompositionTranslateTransform3D"/> to <see cref = "Silk.NET.DirectX.IDCompositionEffect"/>.</summary>
    /// <param name = "value">The <see cref = "IDCompositionTranslateTransform3D"/> instance to be converted </param>
    ...
    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDCompositionTranslateTransform3D"/>.</summary>
    ...
    /// <summary>Upcasts <see cref = "IDCompositionTranslateTransform3D"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDCompositionTranslateTransform3D"/> instance to be converted </param>
