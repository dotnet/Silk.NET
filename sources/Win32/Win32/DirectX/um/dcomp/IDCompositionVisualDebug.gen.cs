        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDCompositionVisualDebug));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, IDCompositionAnimation, int>)(
                (*lpVtbl)[3]
            )
        )(this, animation);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, float, int>)((*lpVtbl)[4]))(
            this,
            offsetX
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, float, int>)((*lpVtbl)[6]))(
            this,
            offsetY
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, IDCompositionTransform, int>)(
                (*lpVtbl)[7]
            )
        )(this, transform);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, D2D_MATRIX_3X2_F*, int>)((*lpVtbl)[8])
        )(this, matrix);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, IDCompositionVisual, int>)((*lpVtbl)[9])
        )(this, visual);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, IDCompositionEffect, int>)((*lpVtbl)[10])
        )(this, effect);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, DCOMPOSITION_BORDER_MODE, int>)(
                (*lpVtbl)[12]
            )
        )(this, borderMode);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, IDCompositionClip, int>)((*lpVtbl)[13])
        )(this, clip);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, D2D_RECT_F*, int>)((*lpVtbl)[14]))(
            this,
            rect
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, IUnknown, int>)((*lpVtbl)[15]))(
            this,
            content
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, IDCompositionVisual, int>)((*lpVtbl)[17])
        )(this, visual);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, int>)((*lpVtbl)[18]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, DCOMPOSITION_COMPOSITE_MODE, int>)(
                (*lpVtbl)[19]
            )
        )(this, compositeMode);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, DCOMPOSITION_OPACITY_MODE, int>)(
                (*lpVtbl)[20]
            )
        )(this, mode);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDCompositionVisualDebug, DCOMPOSITION_BACKFACE_VISIBILITY, int>)(
                (*lpVtbl)[21]
            )
        )(this, visibility);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, DXGI_RGBA*, int>)((*lpVtbl)[22]))(
            this,
            color
        );
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, int>)((*lpVtbl)[23]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, int>)((*lpVtbl)[24]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDCompositionVisualDebug, int>)((*lpVtbl)[25]))(this);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "IDCompositionVisualDebug"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public IDCompositionVisualDebug(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDCompositionVisual2"/> to <see cref = "IDCompositionVisualDebug"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDCompositionVisual2"/> instance to be converted </param>
    public static explicit operator IDCompositionVisualDebug(
        Silk.NET.DirectX.IDCompositionVisual2 value
    )
    {
        return new IDCompositionVisualDebug(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDCompositionVisualDebug"/> to <see cref = "Silk.NET.DirectX.IDCompositionVisual2"/>.</summary>
    /// <param name = "value">The <see cref = "IDCompositionVisualDebug"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDCompositionVisual2(
        IDCompositionVisualDebug value
    )
    {
        return new Silk.NET.DirectX.IDCompositionVisual2(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDCompositionVisual"/> to <see cref = "IDCompositionVisualDebug"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDCompositionVisual"/> instance to be converted </param>
    public static explicit operator IDCompositionVisualDebug(
        Silk.NET.DirectX.IDCompositionVisual value
    )
    {
        return new IDCompositionVisualDebug(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDCompositionVisualDebug"/> to <see cref = "Silk.NET.DirectX.IDCompositionVisual"/>.</summary>
    /// <param name = "value">The <see cref = "IDCompositionVisualDebug"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDCompositionVisual(
        IDCompositionVisualDebug value
    )
    {
    ...
    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDCompositionVisualDebug"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDCompositionVisualDebug(Silk.NET.Windows.IUnknown value)
    {
        return new IDCompositionVisualDebug(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDCompositionVisualDebug"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDCompositionVisualDebug"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDCompositionVisualDebug value)
    {
