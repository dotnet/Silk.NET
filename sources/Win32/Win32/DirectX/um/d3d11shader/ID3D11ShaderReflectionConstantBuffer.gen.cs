        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D11ShaderReflectionConstantBuffer));
    public void*** lpVtbl;
    ...
    public HRESULT GetDesc(D3D11_SHADER_BUFFER_DESC* pDesc)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)((*lpVtbl)[0])
        )((ID3D11ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    public ID3D11ShaderReflectionVariable* GetVariableByIndex(uint Index)
    {
        return (
            (delegate* unmanaged<
                ID3D11ShaderReflectionConstantBuffer*,
                uint,
                ID3D11ShaderReflectionVariable*>)((*lpVtbl)[1])
        )((ID3D11ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    public ID3D11ShaderReflectionVariable* GetVariableByName([NativeTypeName("LPCSTR")] sbyte* Name)
    {
        return (
            (delegate* unmanaged<
                ID3D11ShaderReflectionConstantBuffer*,
                sbyte*,
                ID3D11ShaderReflectionVariable*>)((*lpVtbl)[2])
        )((ID3D11ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        [NativeTypeName(
            "HRESULT (D3D11_SHADER_BUFFER_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, D3D11_SHADER_BUFFER_DESC*, int> GetDesc;

        [NativeTypeName(
            "ID3D11ShaderReflectionVariable *(UINT) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
