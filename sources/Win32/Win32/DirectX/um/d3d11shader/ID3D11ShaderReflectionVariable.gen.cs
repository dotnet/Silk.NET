        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D11ShaderReflectionVariable));
    public void*** lpVtbl;
    ...
    public HRESULT GetDesc(D3D11_SHADER_VARIABLE_DESC* pDesc)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)((*lpVtbl)[0])
        )((ID3D11ShaderReflectionVariable*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D11ShaderReflectionVariable*, ID3D11ShaderReflectionType*>)(
                (*lpVtbl)[1]
            )
        )((ID3D11ShaderReflectionVariable*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<ID3D11ShaderReflectionVariable*, uint, uint>)((*lpVtbl)[3]))(
            (ID3D11ShaderReflectionVariable*)Unsafe.AsPointer(ref this),
            uArrayIndex
        );
    }
    ...
    {
        [NativeTypeName(
            "HRESULT (D3D11_SHADER_VARIABLE_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "ID3D11ShaderReflectionConstantBuffer *() __attribute__((nothrow)) __attribute__((stdcall))"
        )]
