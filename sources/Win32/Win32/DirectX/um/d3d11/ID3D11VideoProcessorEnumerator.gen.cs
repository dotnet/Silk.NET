        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D11VideoProcessorEnumerator));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<ID3D11VideoProcessorEnumerator, Guid*, void**, int>)((*lpVtbl)[0])
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D11VideoProcessorEnumerator, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D11VideoProcessorEnumerator, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID3D11VideoProcessorEnumerator, ID3D11Device*, void>)((*lpVtbl)[3]))(
            this,
            ppDevice
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D11VideoProcessorEnumerator, Guid*, uint*, void*, int>)(
                (*lpVtbl)[4]
            )
    ...
    {
        return (
            (delegate* unmanaged<ID3D11VideoProcessorEnumerator, Guid*, IUnknown, int>)(
                (*lpVtbl)[6]
            )
        )(this, guid, pData);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D11VideoProcessorEnumerator, DXGI_FORMAT, uint*, int>)(
                (*lpVtbl)[8]
            )
        )(this, Format, pFlags);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D11VideoProcessorEnumerator, D3D11_VIDEO_PROCESSOR_CAPS*, int>)(
                (*lpVtbl)[9]
            )
        )(this, pCaps);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID3D11VideoProcessorEnumerator"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D11VideoProcessorEnumerator(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID3D11DeviceChild"/> to <see cref = "ID3D11VideoProcessorEnumerator"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID3D11DeviceChild"/> instance to be converted </param>
    public static explicit operator ID3D11VideoProcessorEnumerator(
        Silk.NET.DirectX.ID3D11DeviceChild value
    )
    {
        return new ID3D11VideoProcessorEnumerator(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D11VideoProcessorEnumerator"/> to <see cref = "Silk.NET.DirectX.ID3D11DeviceChild"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D11VideoProcessorEnumerator"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID3D11DeviceChild(
        ID3D11VideoProcessorEnumerator value
    )
    {
        return new Silk.NET.DirectX.ID3D11DeviceChild(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D11VideoProcessorEnumerator"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D11VideoProcessorEnumerator(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D11VideoProcessorEnumerator(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D11VideoProcessorEnumerator"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D11VideoProcessorEnumerator"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D11VideoProcessorEnumerator value)
    {
