...
public unsafe partial struct ID3D12Debug1 : ID3D12Debug1.Interface, INativeGuid
{
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Debug1, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Debug1, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug1, void>)((*lpVtbl)[3]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug1, BOOL, void>)((*lpVtbl)[4]))(this, Enable);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug1, BOOL, void>)((*lpVtbl)[5]))(this, Enable);
    }
    ...
    public ID3D12Debug1(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12Debug1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12Debug1(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12Debug1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12Debug1"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Debug1"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12Debug1 value)
    {
