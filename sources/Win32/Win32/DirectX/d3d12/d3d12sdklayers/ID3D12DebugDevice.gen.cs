...
public unsafe partial struct ID3D12DebugDevice : ID3D12DebugDevice.Interface, INativeGuid
{
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugDevice, D3D12_DEBUG_FEATURE>)((*lpVtbl)[4]))(this);
    }
    ...
    public ID3D12DebugDevice(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12DebugDevice"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12DebugDevice(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12DebugDevice(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12DebugDevice"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12DebugDevice"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12DebugDevice value)
    {
