...
public unsafe partial struct ID3D12DebugCommandList : ID3D12DebugCommandList.Interface, INativeGuid
{
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    public ID3D12DebugCommandList(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12DebugCommandList"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12DebugCommandList(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12DebugCommandList(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12DebugCommandList"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12DebugCommandList"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12DebugCommandList value)
    {
