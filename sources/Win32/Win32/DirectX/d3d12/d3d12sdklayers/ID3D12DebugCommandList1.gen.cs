        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12DebugCommandList1));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList1, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList1, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList1, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D12DebugCommandList1, ID3D12Resource, uint, uint, int>)(
                (*lpVtbl)[3]
            )
    ...
    public ID3D12DebugCommandList1(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12DebugCommandList1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12DebugCommandList1(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12DebugCommandList1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12DebugCommandList1"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12DebugCommandList1"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12DebugCommandList1 value)
    {
