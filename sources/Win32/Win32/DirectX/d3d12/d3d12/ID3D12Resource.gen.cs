...
public unsafe partial struct ID3D12Resource : ID3D12Resource.Interface, INativeGuid
{
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Resource, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Resource, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Resource, ushort*, int>)((*lpVtbl)[6]))(this, Name);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D12Resource, uint, D3D12_RANGE*, void**, int>)((*lpVtbl)[8])
    ...
    {
        return ((delegate* unmanaged<ID3D12Resource, ulong>)((*lpVtbl)[11]))(this);
    }
    ...
    /// <summary>Initializes a new instance of the <see cref = "ID3D12Resource"/> struct with the specified virtual table pointer.</summary>
    /// <param name = "vtbl">The pointer to virtual table.</param>
    public ID3D12Resource(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID3D12Pageable"/> to <see cref = "ID3D12Resource"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID3D12Pageable"/> instance to be converted </param>
    public static explicit operator ID3D12Resource(Silk.NET.DirectX.ID3D12Pageable value)
    {
        return new ID3D12Resource(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12Resource"/> to <see cref = "Silk.NET.DirectX.ID3D12Pageable"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID3D12Pageable(ID3D12Resource value)
    {
        return new Silk.NET.DirectX.ID3D12Pageable(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID3D12DeviceChild"/> to <see cref = "ID3D12Resource"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID3D12DeviceChild"/> instance to be converted </param>
    public static explicit operator ID3D12Resource(Silk.NET.DirectX.ID3D12DeviceChild value)
    {
        return new ID3D12Resource(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12Resource"/> to <see cref = "Silk.NET.DirectX.ID3D12DeviceChild"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID3D12DeviceChild(ID3D12Resource value)
    {
        return new Silk.NET.DirectX.ID3D12DeviceChild(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.ID3D12Object"/> to <see cref = "ID3D12Resource"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.ID3D12Object"/> instance to be converted </param>
    public static explicit operator ID3D12Resource(Silk.NET.DirectX.ID3D12Object value)
    {
        return new ID3D12Resource(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12Resource"/> to <see cref = "Silk.NET.DirectX.ID3D12Object"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.ID3D12Object(ID3D12Resource value)
    {
        return new Silk.NET.DirectX.ID3D12Object(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12Resource"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12Resource(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12Resource(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12Resource"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Resource"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12Resource value)
    {
