...
public enum D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE
{
    ...
    D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE =
        (D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_DISCARD + 1),
    D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_CLEAR =
        (D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE + 1),
    D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_NO_ACCESS =
        (D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_CLEAR + 1),
    D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_RENDER =
        (D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_NO_ACCESS + 1),
    D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_SRV =
        (D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_RENDER + 1),
    D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_UAV =
        (D3D12_RENDER_PASS_BEGINNING_ACCESS_TYPE_PRESERVE_LOCAL_SRV + 1),
}
