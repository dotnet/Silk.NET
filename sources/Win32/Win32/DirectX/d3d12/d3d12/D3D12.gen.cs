...
public static partial class D3D12
{
    ...
    public const int D3D12_COMMONSHADER_CONSTANT_BUFFER_PARTIAL_UPDATE_EXTENTS_BYTE_ALIGNMENT = (
        16
    );
    ...
    public const int D3D12_RAYTRACING_MAX_GEOMETRIES_PER_BOTTOM_LEVEL_ACCELERATION_STRUCTURE = (
        16777216
    );
    ...
    public const int D3D12_RAYTRACING_MAX_INSTANCES_PER_TOP_LEVEL_ACCELERATION_STRUCTURE = (
        16777216
    );
    ...
    public const int D3D12_RAYTRACING_MAX_PRIMITIVES_PER_BOTTOM_LEVEL_ACCELERATION_STRUCTURE = (
        536870912
    );
    ...
    public const int D3D12_SHADER_COMPONENT_MAPPING_ALWAYS_SET_BIT_AVOIDING_ZEROMEM_MISTAKES = (
        1 << (3 * 4)
    );
    ...
    public const int D3D12_DEFAULT_SHADER_4_COMPONENT_MAPPING = (
        (
            ((0) & 0x7)
            | (((1) & 0x7) << 3)
            | (((2) & 0x7) << (3 * 2))
