        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12DeviceRemovedExtendedData));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<ID3D12DeviceRemovedExtendedData, Guid*, void**, int>)((*lpVtbl)[0])
        )(this, riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DeviceRemovedExtendedData, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DeviceRemovedExtendedData, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    public ID3D12DeviceRemovedExtendedData(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12DeviceRemovedExtendedData"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12DeviceRemovedExtendedData(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12DeviceRemovedExtendedData(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12DeviceRemovedExtendedData"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12DeviceRemovedExtendedData"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12DeviceRemovedExtendedData value)
    {
