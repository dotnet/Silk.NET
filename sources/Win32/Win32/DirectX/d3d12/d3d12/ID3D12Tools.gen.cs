...
public unsafe partial struct ID3D12Tools : ID3D12Tools.Interface, INativeGuid
{
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Tools, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Tools, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Tools, BOOL, void>)((*lpVtbl)[3]))(this, bEnable);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Tools, int>)((*lpVtbl)[4]))(this);
    }
    ...
    public ID3D12Tools(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "ID3D12Tools"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator ID3D12Tools(Silk.NET.Windows.IUnknown value)
    {
        return new ID3D12Tools(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "ID3D12Tools"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "ID3D12Tools"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(ID3D12Tools value)
    {
