...
public unsafe partial struct IDMLDevice1 : IDMLDevice1.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_IDMLDevice1));
    public void*** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, Guid*, void**, int>)((*lpVtbl)[0]))(
            this,
            riid,
            ppvObject
        );
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<IDMLDevice1, uint>)((*lpVtbl)[1]))(this);
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<IDMLDevice1, uint>)((*lpVtbl)[2]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, Guid*, uint*, void*, int>)((*lpVtbl)[3]))(
            this,
            guid,
            dataSize,
            data
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, Guid*, uint, void*, int>)((*lpVtbl)[4]))(
            this,
            guid,
            dataSize,
            data
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, Guid*, IUnknown, int>)((*lpVtbl)[5]))(
            this,
            guid,
            data
        );
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, ushort*, int>)((*lpVtbl)[6]))(this, name);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDMLDevice1, DML_FEATURE, uint, void*, uint, void*, int>)(
                (*lpVtbl)[7]
            )
        )(
            this,
    ...
    {
        return (
            (delegate* unmanaged<IDMLDevice1, DML_OPERATOR_DESC*, Guid*, void**, int>)((*lpVtbl)[8])
        )(this, desc, riid, ppv);
    }
    ...
    {
        return (
            (delegate* unmanaged<IDMLDevice1, uint, IDMLCompiledOperator*, Guid*, void**, int>)(
                (*lpVtbl)[10]
            )
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, Guid*, void**, int>)((*lpVtbl)[11]))(
            this,
            riid,
            ppv
        );
    ...
    {
        return (
            (delegate* unmanaged<IDMLDevice1, DML_BINDING_TABLE_DESC*, Guid*, void**, int>)(
                (*lpVtbl)[12]
            )
        )(this, desc, riid, ppv);
    }
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, uint, IDMLPageable*, int>)((*lpVtbl)[13]))(
            this,
            count,
            ppObjects
        );
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, uint, IDMLPageable*, int>)((*lpVtbl)[14]))(
            this,
            count,
            ppObjects
        );
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, int>)((*lpVtbl)[15]))(this);
    }
    ...
    {
        return ((delegate* unmanaged<IDMLDevice1, Guid*, void**, int>)((*lpVtbl)[16]))(
            this,
            riid,
            ppv
        );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(17)]
    public HRESULT CompileGraph(
        [NativeTypeName("const DML_GRAPH_DESC *")] DML_GRAPH_DESC* desc,
        DML_EXECUTION_FLAGS flags,
        [NativeTypeName("const IID &")] Guid* riid,
        void** ppv
    )
        ...
        where TSelf : unmanaged, Interface
    {
        ...
        [NativeTypeName(
            "HRESULT (const DML_GRAPH_DESC *, DML_EXECUTION_FLAGS, const IID &, void **) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<
            TSelf*,
            DML_GRAPH_DESC*,
    ...
    public IDMLDevice1(void*** vtbl)
    {
        lpVtbl = vtbl;
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDMLDevice"/> to <see cref = "IDMLDevice1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDMLDevice"/> instance to be converted </param>
    public static explicit operator IDMLDevice1(Silk.NET.DirectX.IDMLDevice value)
    {
        return new IDMLDevice1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDMLDevice1"/> to <see cref = "Silk.NET.DirectX.IDMLDevice"/>.</summary>
    /// <param name = "value">The <see cref = "IDMLDevice1"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDMLDevice(IDMLDevice1 value)
    {
        return new Silk.NET.DirectX.IDMLDevice(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.DirectX.IDMLObject"/> to <see cref = "IDMLDevice1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.DirectX.IDMLObject"/> instance to be converted </param>
    public static explicit operator IDMLDevice1(Silk.NET.DirectX.IDMLObject value)
    {
        return new IDMLDevice1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDMLDevice1"/> to <see cref = "Silk.NET.DirectX.IDMLObject"/>.</summary>
    /// <param name = "value">The <see cref = "IDMLDevice1"/> instance to be converted </param>
    public static implicit operator Silk.NET.DirectX.IDMLObject(IDMLDevice1 value)
    {
        return new Silk.NET.DirectX.IDMLObject(value.lpVtbl);
    }

    /// <summary>Downcasts <see cref = "Silk.NET.Windows.IUnknown"/> to <see cref = "IDMLDevice1"/>.</summary>
    /// <param name = "value">The <see cref = "Silk.NET.Windows.IUnknown"/> instance to be converted </param>
    public static explicit operator IDMLDevice1(Silk.NET.Windows.IUnknown value)
    {
        return new IDMLDevice1(value.lpVtbl);
    }

    /// <summary>Upcasts <see cref = "IDMLDevice1"/> to <see cref = "Silk.NET.Windows.IUnknown"/>.</summary>
    /// <param name = "value">The <see cref = "IDMLDevice1"/> instance to be converted </param>
    public static implicit operator Silk.NET.Windows.IUnknown(IDMLDevice1 value)
    {
