...
public unsafe partial struct ID3DInclude : ID3DInclude.Interface
{
    ...
    public unsafe partial struct Native : Interface
    {
        ...
        {
            return ((delegate* unmanaged<ID3DInclude.Native*, void*, int>)(lpVtbl[1]))(
                (ID3DInclude.Native*)Unsafe.AsPointer(ref this),
                pData
            );
        }
    ...
    public static implicit operator ID3DInclude(ID3DInclude.Native* value) =>
        new ID3DInclude((Ptr<Native>)value);
    ...
    public static explicit operator ID3DInclude(Ptr<ID3DInclude.Native> value) =>
        new ID3DInclude(value);

    /// <summary>casts <see cref = "ID3DInclude"/> to <see cref = "Ptr{T}"/> .</summary>
    /// <param name = "value">The <see cref = "ID3DInclude"/> instance to be converted </param>
    public static implicit operator Ptr<ID3DInclude.Native>(ID3DInclude value) =>
        (Ptr<ID3DInclude.Native>)value.lpVtbl;

    /// <summary>casts void*** to <see cref = "ID3DInclude"/>.</summary>
    /// <param name = "value">The void*** instance to be converted </param>
    public static explicit operator ID3DInclude(void*** value) =>
        new ID3DInclude((Ptr<Native>)value);
    ...
    public static explicit operator ID3DInclude(nuint value) =>
        new ID3DInclude((Ptr<Native>)value.ToPointer());
    ...
    public HRESULT Open(
        ...
        [NativeTypeName("LPCVOID *")] void** ppData,
        uint* pBytes
    ) => lpVtbl->Open(IncludeType, pFileName, pParentData, ppData, pBytes);
