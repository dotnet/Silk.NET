        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12ShaderReflectionConstantBuffer));
    public void*** lpVtbl;
    ...
    public HRESULT GetDesc(D3D12_SHADER_BUFFER_DESC* pDesc)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)((*lpVtbl)[0])
        )((ID3D12ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    public ID3D12ShaderReflectionVariable* GetVariableByIndex(uint Index)
    {
        return (
            (delegate* unmanaged<
                ID3D12ShaderReflectionConstantBuffer*,
                uint,
                ID3D12ShaderReflectionVariable*>)((*lpVtbl)[1])
        )((ID3D12ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Index);
    }
    ...
    public ID3D12ShaderReflectionVariable* GetVariableByName([NativeTypeName("LPCSTR")] sbyte* Name)
    {
        return (
            (delegate* unmanaged<
                ID3D12ShaderReflectionConstantBuffer*,
                sbyte*,
                ID3D12ShaderReflectionVariable*>)((*lpVtbl)[2])
        )((ID3D12ShaderReflectionConstantBuffer*)Unsafe.AsPointer(ref this), Name);
    }
    ...
    {
        [NativeTypeName(
            "HRESULT (D3D12_SHADER_BUFFER_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        public delegate* unmanaged<TSelf*, D3D12_SHADER_BUFFER_DESC*, int> GetDesc;

        [NativeTypeName(
            "ID3D12ShaderReflectionVariable *(UINT) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
