        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12FunctionParameterReflection));
    public void*** lpVtbl;
    ...
    {
        return (
            (delegate* unmanaged<ID3D12FunctionParameterReflection*, D3D12_PARAMETER_DESC*, int>)(
                (*lpVtbl)[0]
            )
        )((ID3D12FunctionParameterReflection*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        [NativeTypeName(
            "HRESULT (D3D12_PARAMETER_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
