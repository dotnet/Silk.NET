...
public unsafe partial struct ID3D12Debug3 : ID3D12Debug3.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12Debug3*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Debug3*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Debug3*, uint>)(lpVtbl[1]))(
            (ID3D12Debug3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Debug3*, uint>)(lpVtbl[2]))(
            (ID3D12Debug3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug3*, void>)(lpVtbl[3]))(
            (ID3D12Debug3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug3*, BOOL, void>)(lpVtbl[4]))(
            (ID3D12Debug3*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug3*, BOOL, void>)(lpVtbl[5]))(
            (ID3D12Debug3*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
