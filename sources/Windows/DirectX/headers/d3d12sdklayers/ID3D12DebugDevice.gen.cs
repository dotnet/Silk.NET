...
public unsafe partial struct ID3D12DebugDevice : ID3D12DebugDevice.Interface, INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12DebugDevice));
    public void** lpVtbl;
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugDevice*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DebugDevice*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice*, uint>)(lpVtbl[1]))(
            (ID3D12DebugDevice*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice*, uint>)(lpVtbl[2]))(
            (ID3D12DebugDevice*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugDevice*, D3D12_DEBUG_FEATURE, int>)(lpVtbl[3]))(
            (ID3D12DebugDevice*)Unsafe.AsPointer(ref this),
            Mask
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugDevice*, D3D12_DEBUG_FEATURE>)(lpVtbl[4]))(
            (ID3D12DebugDevice*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugDevice*, D3D12_RLDO_FLAGS, int>)(lpVtbl[5]))(
            (ID3D12DebugDevice*)Unsafe.AsPointer(ref this),
            Flags
        );
    }
