...
public unsafe partial struct ID3D12DebugDevice2 : ID3D12DebugDevice2.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DebugDevice2*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DebugDevice2*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice2*, uint>)(lpVtbl[1]))(
            (ID3D12DebugDevice2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugDevice2*, uint>)(lpVtbl[2]))(
            (ID3D12DebugDevice2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DebugDevice2*, D3D12_DEBUG_FEATURE>)(lpVtbl[4]))(
            (ID3D12DebugDevice2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                uint,
                int>)(lpVtbl[6])
        )((ID3D12DebugDevice2*)Unsafe.AsPointer(ref this), Type, pData, DataSize);
    }
