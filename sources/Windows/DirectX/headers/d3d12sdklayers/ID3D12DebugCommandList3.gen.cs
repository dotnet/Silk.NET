        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList3*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList3*, uint>)(lpVtbl[1]))(
            (ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandList3*, uint>)(lpVtbl[2]))(
            (ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public BOOL AssertResourceState(ID3D12Resource* pResource, uint Subresource, uint State)
    {
        ...
        )((ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this), pResource, Subresource, State);
    }
    ...
    public HRESULT SetFeatureMask(D3D12_DEBUG_FEATURE Mask)
    {
        ...
        )((ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this), Mask);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                uint,
                int>)(lpVtbl[6])
        )((ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this), Type, pData, DataSize);
    }
    ...
    )
    {
        (
            (delegate* unmanaged<
                ...
                void>)(lpVtbl[8])
        )((ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this), pResource, Subresource, Access);
    }
    ...
    )
    {
        (
            (delegate* unmanaged<
                ...
                void>)(lpVtbl[9])
        )((ID3D12DebugCommandList3*)Unsafe.AsPointer(ref this), pResource, Subresource, Layout);
    }
