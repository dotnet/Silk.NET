...
public unsafe partial struct ID3D12Debug6 : ID3D12Debug6.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12Debug6*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Debug6*, uint>)(lpVtbl[1]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Debug6*, uint>)(lpVtbl[2]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug6*, void>)(lpVtbl[3]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug6*, BOOL, void>)(lpVtbl[4]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug6*, BOOL, void>)(lpVtbl[5]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug6*, void>)(lpVtbl[7]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug6*, BOOL, void>)(lpVtbl[8]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12Debug6*, BOOL, void>)(lpVtbl[9]))(
            (ID3D12Debug6*)Unsafe.AsPointer(ref this),
            Enable
        );
    }
