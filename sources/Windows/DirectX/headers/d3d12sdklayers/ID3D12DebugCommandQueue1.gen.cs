        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DebugCommandQueue1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DebugCommandQueue1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandQueue1*, uint>)(lpVtbl[1]))(
            (ID3D12DebugCommandQueue1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DebugCommandQueue1*, uint>)(lpVtbl[2]))(
            (ID3D12DebugCommandQueue1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public BOOL AssertResourceState(ID3D12Resource* pResource, uint Subresource, uint State)
    {
        ...
        )((ID3D12DebugCommandQueue1*)Unsafe.AsPointer(ref this), pResource, Subresource, State);
    }
    ...
    )
    {
        (
            (delegate* unmanaged<
                ...
                void>)(lpVtbl[4])
        )((ID3D12DebugCommandQueue1*)Unsafe.AsPointer(ref this), pResource, Subresource, Access);
    }
    ...
    )
    {
        (
            (delegate* unmanaged<
                ...
                void>)(lpVtbl[5])
        )((ID3D12DebugCommandQueue1*)Unsafe.AsPointer(ref this), pResource, Subresource, Layout);
    }
