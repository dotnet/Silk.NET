        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12SDKConfiguration1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12SDKConfiguration1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12SDKConfiguration1*, uint>)(lpVtbl[1]))(
            (ID3D12SDKConfiguration1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12SDKConfiguration1*, uint>)(lpVtbl[2]))(
            (ID3D12SDKConfiguration1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12SDKConfiguration1*, void>)(lpVtbl[5]))(
            (ID3D12SDKConfiguration1*)Unsafe.AsPointer(ref this)
        );
    }
