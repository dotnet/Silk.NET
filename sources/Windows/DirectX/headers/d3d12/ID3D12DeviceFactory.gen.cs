...
public unsafe partial struct ID3D12DeviceFactory : ID3D12DeviceFactory.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, uint>)(lpVtbl[1]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, uint>)(lpVtbl[2]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, int>)(lpVtbl[3]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, int>)(lpVtbl[4]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D12DeviceFactory*, D3D12_DEVICE_FACTORY_FLAGS, int>)(lpVtbl[5])
        )((ID3D12DeviceFactory*)Unsafe.AsPointer(ref this), flags);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, D3D12_DEVICE_FACTORY_FLAGS>)(lpVtbl[6]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DeviceFactory*, Guid*, Guid*, void**, int>)(lpVtbl[7]))(
            (ID3D12DeviceFactory*)Unsafe.AsPointer(ref this),
            clsid,
            iid,
            ppv
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[9])
        )((ID3D12DeviceFactory*)Unsafe.AsPointer(ref this), adapter, FeatureLevel, riid, ppvDevice);
    }
