...
public unsafe partial struct ID3D12Heap1 : ID3D12Heap1.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12Heap1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Heap1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Heap1*, uint>)(lpVtbl[1]))(
            (ID3D12Heap1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Heap1*, uint>)(lpVtbl[2]))(
            (ID3D12Heap1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Heap1*, ushort*, int>)(lpVtbl[6]))(
            (ID3D12Heap1*)Unsafe.AsPointer(ref this),
            Name
        );
    }
    ...
    public D3D12_HEAP_DESC GetDesc()
    {
        ...
        )((ID3D12Heap1*)Unsafe.AsPointer(ref this), &result);
    }
