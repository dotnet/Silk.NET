...
public unsafe partial struct ID3D12DescriptorHeap : ID3D12DescriptorHeap.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12DescriptorHeap*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12DescriptorHeap*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DescriptorHeap*, uint>)(lpVtbl[1]))(
            (ID3D12DescriptorHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DescriptorHeap*, uint>)(lpVtbl[2]))(
            (ID3D12DescriptorHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12DescriptorHeap*, Guid*, uint*, void*, int>)(lpVtbl[3]))(
            (ID3D12DescriptorHeap*)Unsafe.AsPointer(ref this),
            guid,
            pDataSize,
            pData
    ...
    public D3D12_DESCRIPTOR_HEAP_DESC GetDesc()
    {
        ...
        )((ID3D12DescriptorHeap*)Unsafe.AsPointer(ref this), &result);
    }
