        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        ...
        )((ID3D12DeviceRemovedExtendedData*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12DeviceRemovedExtendedData*, uint>)(lpVtbl[1]))(
            (ID3D12DeviceRemovedExtendedData*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12DeviceRemovedExtendedData*, uint>)(lpVtbl[2]))(
            (ID3D12DeviceRemovedExtendedData*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public HRESULT GetAutoBreadcrumbsOutput(D3D12_DRED_AUTO_BREADCRUMBS_OUTPUT* pOutput)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)(lpVtbl[3])
        )((ID3D12DeviceRemovedExtendedData*)Unsafe.AsPointer(ref this), pOutput);
    }
