...
public unsafe partial struct ID3D12PipelineLibrary : ID3D12PipelineLibrary.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary*, uint>)(lpVtbl[1]))(
            (ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary*, uint>)(lpVtbl[2]))(
            (ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary*, Guid*, uint*, void*, int>)(lpVtbl[3]))(
            (ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this),
            guid,
            pDataSize,
            pData
    ...
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
    ...
    )
    {
        ...
        )((ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this), pName, pPipeline);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[9])
        )((ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this), pName, pDesc, riid, ppPipelineState);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary*, nuint>)(lpVtbl[11]))(
            (ID3D12PipelineLibrary*)Unsafe.AsPointer(ref this)
        );
    }
