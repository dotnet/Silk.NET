        ...
        INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        ...
        )((ID3D12VirtualizationGuestDevice*)Unsafe.AsPointer(ref this), riid, ppvObject);
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VirtualizationGuestDevice*, uint>)(lpVtbl[1]))(
            (ID3D12VirtualizationGuestDevice*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VirtualizationGuestDevice*, uint>)(lpVtbl[2]))(
            (ID3D12VirtualizationGuestDevice*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public HRESULT ShareWithHost(ID3D12DeviceChild* pObject, HANDLE* pHandle)
    {
        return (
            (delegate* unmanaged<
                ...
                HANDLE*,
                int>)(lpVtbl[3])
        )((ID3D12VirtualizationGuestDevice*)Unsafe.AsPointer(ref this), pObject, pHandle);
    }
