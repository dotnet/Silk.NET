...
public unsafe partial struct ID3D12Resource2 : ID3D12Resource2.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12Resource2*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12Resource2*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12Resource2*, uint>)(lpVtbl[1]))(
            (ID3D12Resource2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12Resource2*, uint>)(lpVtbl[2]))(
            (ID3D12Resource2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Resource2*, ushort*, int>)(lpVtbl[6]))(
            (ID3D12Resource2*)Unsafe.AsPointer(ref this),
            Name
        );
    }
    ...
    )
    {
        ...
        )((ID3D12Resource2*)Unsafe.AsPointer(ref this), Subresource, pReadRange, ppData);
    }
    ...
    public D3D12_RESOURCE_DESC GetDesc()
    {
        ...
        )((ID3D12Resource2*)Unsafe.AsPointer(ref this), &result);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12Resource2*, ulong>)(lpVtbl[11]))(
            (ID3D12Resource2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        ...
        )((ID3D12Resource2*)Unsafe.AsPointer(ref this), pHeapProperties, pHeapFlags);
    }
