...
public unsafe partial struct ID3D12PipelineLibrary1 : ID3D12PipelineLibrary1.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary1*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary1*, uint>)(lpVtbl[1]))(
            (ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary1*, uint>)(lpVtbl[2]))(
            (ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        ...
        )((ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary1*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
    ...
    )
    {
        ...
        )((ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this), pName, pPipeline);
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[9])
        )((ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this), pName, pDesc, riid, ppPipelineState);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12PipelineLibrary1*, nuint>)(lpVtbl[11]))(
            (ID3D12PipelineLibrary1*)Unsafe.AsPointer(ref this)
        );
    }
