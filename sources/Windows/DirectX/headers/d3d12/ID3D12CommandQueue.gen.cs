...
public unsafe partial struct ID3D12CommandQueue : ID3D12CommandQueue.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12CommandQueue*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12CommandQueue*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12CommandQueue*, uint>)(lpVtbl[1]))(
            (ID3D12CommandQueue*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12CommandQueue*, uint>)(lpVtbl[2]))(
            (ID3D12CommandQueue*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12CommandQueue*, ushort*, int>)(lpVtbl[6]))(
            (ID3D12CommandQueue*)Unsafe.AsPointer(ref this),
            Name
        );
    }
    ...
    {
        ((delegate* unmanaged<ID3D12CommandQueue*, void>)(lpVtbl[13]))(
            (ID3D12CommandQueue*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public D3D12_COMMAND_QUEUE_DESC GetDesc()
    {
        ...
        )((ID3D12CommandQueue*)Unsafe.AsPointer(ref this), &result);
    }
