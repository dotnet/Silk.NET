...
public static partial class D3D
{
    ...
    public static ref readonly Guid D3D_TEXTURE_LAYOUT_ROW_MAJOR
    {
        ...
        get
        {
            ReadOnlySpan<byte> data = [0x4F, 0x23, 0xDC, 0xB5, 0xBB, 0x72, 0xEC, 0x4B, 0x97, 0x05, 0x8C, 0xF2, 0x58, 0xDF, 0x6B, 0x6C];
    ...
    public static ref readonly Guid D3D_TEXTURE_LAYOUT_64KB_STANDARD_SWIZZLE
    {
        ...
        get
        {
            ReadOnlySpan<byte> data = [0xE3, 0x29, 0x0F, 0x4C, 0x5F, 0x3F, 0x35, 0x4D, 0x84, 0xC9, 0xBC, 0x09, 0x83, 0xB6, 0x2C, 0x28];
            Debug.Assert(data.Length == Unsafe.SizeOf<Guid>());
            return ref Unsafe.As<byte, Guid>(ref MemoryMarshal.GetReference(data));
        }
    }
