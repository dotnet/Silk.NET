...
public unsafe partial struct ID3D12VideoDevice2 : ID3D12VideoDevice2.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12VideoDevice2*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12VideoDevice2*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoDevice2*, uint>)(lpVtbl[1]))(
            (ID3D12VideoDevice2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoDevice2*, uint>)(lpVtbl[2]))(
            (ID3D12VideoDevice2*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        return (
            (delegate* unmanaged<
                ...
                void**,
                int>)(lpVtbl[4])
        )((ID3D12VideoDevice2*)Unsafe.AsPointer(ref this), pDesc, riid, ppVideoDecoder);
    }
