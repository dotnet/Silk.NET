...
public unsafe partial struct ID3D12VideoEncoderHeap : ID3D12VideoEncoderHeap.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12VideoEncoderHeap*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoEncoderHeap*, uint>)(lpVtbl[1]))(
            (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoEncoderHeap*, uint>)(lpVtbl[2]))(
            (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    )
    {
        ...
        )((ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this), guid, pDataSize, pData);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoderHeap*, Guid*, uint, void*, int>)(lpVtbl[4]))(
            (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this),
            guid,
            DataSize,
            pData
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoderHeap*, uint>)(lpVtbl[8]))(
            (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public HRESULT GetCodecProfile(D3D12_VIDEO_ENCODER_PROFILE_DESC dstProfile)
    {
        ...
        )((ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this), dstProfile);
    }
    ...
    public HRESULT GetCodecLevel(D3D12_VIDEO_ENCODER_LEVEL_SETTING dstLevel)
    {
        ...
        )((ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this), dstLevel);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoderHeap*, uint>)(lpVtbl[13]))(
            (ID3D12VideoEncoderHeap*)Unsafe.AsPointer(ref this)
        );
    }
