...
public unsafe partial struct ID3D12VideoEncoder : ID3D12VideoEncoder.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, Guid*, void**, int>)(lpVtbl[0]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, uint>)(lpVtbl[1]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, uint>)(lpVtbl[2]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, ushort*, int>)(lpVtbl[6]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this),
            Name
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, uint>)(lpVtbl[8]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, D3D12_VIDEO_ENCODER_CODEC>)(lpVtbl[10]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public HRESULT GetCodecProfile(D3D12_VIDEO_ENCODER_PROFILE_DESC dstProfile)
    {
        ...
        )((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), dstProfile);
    }
    ...
    public HRESULT GetCodecConfiguration(D3D12_VIDEO_ENCODER_CODEC_CONFIGURATION dstCodecConfig)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)(lpVtbl[12])
        )((ID3D12VideoEncoder*)Unsafe.AsPointer(ref this), dstCodecConfig);
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12VideoEncoder*, DXGI_FORMAT>)(lpVtbl[13]))(
            (ID3D12VideoEncoder*)Unsafe.AsPointer(ref this)
        );
    }
