        ...
        INativeGuid
{
    static Guid* INativeGuid.NativeGuid =>
        (Guid*)Unsafe.AsPointer(ref Unsafe.AsRef(in IID_ID3D12ShaderReflectionVariable));
    public void** lpVtbl;
    ...
    public HRESULT GetDesc(D3D12_SHADER_VARIABLE_DESC* pDesc)
    {
        return (
            (delegate* unmanaged<
                ...
                int>)(lpVtbl[0])
        )((ID3D12ShaderReflectionVariable*)Unsafe.AsPointer(ref this), pDesc);
    }
    ...
    {
        return (
            (delegate* unmanaged<ID3D12ShaderReflectionVariable*, ID3D12ShaderReflectionType*>)(
                lpVtbl[1]
            )
        )((ID3D12ShaderReflectionVariable*)Unsafe.AsPointer(ref this));
    }
    ...
    {
        return ((delegate* unmanaged<ID3D12ShaderReflectionVariable*, uint, uint>)(lpVtbl[3]))(
            (ID3D12ShaderReflectionVariable*)Unsafe.AsPointer(ref this),
            uArrayIndex
        );
    }
    ...
    {
        [NativeTypeName(
            "HRESULT (D3D12_SHADER_VARIABLE_DESC *) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
        ...
        [NativeTypeName(
            "ID3D12ShaderReflectionConstantBuffer *() __attribute__((nothrow)) __attribute__((stdcall))"
        )]
