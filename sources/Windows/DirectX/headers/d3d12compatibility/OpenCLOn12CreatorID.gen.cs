...
public unsafe partial struct OpenCLOn12CreatorID : OpenCLOn12CreatorID.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<OpenCLOn12CreatorID*, Guid*, void**, int>)(lpVtbl[0]))(
            (OpenCLOn12CreatorID*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<OpenCLOn12CreatorID*, uint>)(lpVtbl[1]))(
            (OpenCLOn12CreatorID*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<OpenCLOn12CreatorID*, uint>)(lpVtbl[2]))(
            (OpenCLOn12CreatorID*)Unsafe.AsPointer(ref this)
        );
    }
