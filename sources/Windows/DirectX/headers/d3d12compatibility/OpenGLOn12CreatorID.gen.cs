...
public unsafe partial struct OpenGLOn12CreatorID : OpenGLOn12CreatorID.Interface, INativeGuid
{
    ...
    public HRESULT QueryInterface([NativeTypeName("const IID &")] Guid* riid, void** ppvObject)
    {
        return ((delegate* unmanaged<OpenGLOn12CreatorID*, Guid*, void**, int>)(lpVtbl[0]))(
            (OpenGLOn12CreatorID*)Unsafe.AsPointer(ref this),
            riid,
            ppvObject
        );
    }
    ...
    public uint AddRef()
    {
        return ((delegate* unmanaged<OpenGLOn12CreatorID*, uint>)(lpVtbl[1]))(
            (OpenGLOn12CreatorID*)Unsafe.AsPointer(ref this)
        );
    }
    ...
    public uint Release()
    {
        return ((delegate* unmanaged<OpenGLOn12CreatorID*, uint>)(lpVtbl[2]))(
            (OpenGLOn12CreatorID*)Unsafe.AsPointer(ref this)
        );
    }
