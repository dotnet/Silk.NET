...
public unsafe partial struct ID3D11On12On7Device : ID3D11On12On7Device.Interface
{
    ...
    [VtblIndex(0)]
    public HRESULT AcquireResource(
        [NativeTypeName("ID3D11On12On7Resource*")] void* pResource,
        D3D12_RESOURCE_STATES state
    )
    {
        return (
            (delegate* unmanaged<ID3D11On12On7Device*, void*, D3D12_RESOURCE_STATES, int>)(
                lpVtbl[0]
            )
        )((ID3D11On12On7Device*)Unsafe.AsPointer(ref this), pResource, state);
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [VtblIndex(1)]
    public HRESULT ReleaseResource(
        [NativeTypeName("ID3D11On12On7Resource*")] void* pResource,
        D3D12_RESOURCE_STATES state
    )
    {
    ...
    {
        [NativeTypeName(
            "HRESULT (ID3D11On12On7Resource *, D3D12_RESOURCE_STATES) __attribute__((nothrow)) __attribute__((stdcall))"
        )]
