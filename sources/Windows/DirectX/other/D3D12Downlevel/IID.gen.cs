...
public static partial class IID
{
    ...
    public static ref readonly Guid IID_ID3D12CommandQueueDownlevel
    {
        ...
        get
        {
            ReadOnlySpan<byte> data = [0xEF, 0xC5, 0xA8, 0x38, 0xCB, 0x7C, 0x81, 0x4E, 0x91, 0x4F, 0xA6, 0xE9, 0xD0, 0x72, 0xC4, 0x94];
    ...
    public static ref readonly Guid IID_ID3D12DeviceDownlevel
    {
        ...
        get
        {
            ReadOnlySpan<byte> data = [0x3F, 0xEE, 0xEA, 0x74, 0x4B, 0x2F, 0x6D, 0x47, 0x82, 0xBA, 0x2B, 0x85, 0xCB, 0x49, 0xE3, 0x10];
            Debug.Assert(data.Length == Unsafe.SizeOf<Guid>());
            return ref Unsafe.As<byte, Guid>(ref MemoryMarshal.GetReference(data));
        }
    }
