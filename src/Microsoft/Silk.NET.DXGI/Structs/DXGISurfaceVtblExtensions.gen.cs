...
public unsafe static class DXGISurfaceVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int QueryInterface<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppvObject) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISurface>
    {
        var @this = (IDXGISurface*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppvObject = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetParent<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppParent) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISurface>
    {
        var @this = (IDXGISurface*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppParent = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetDevice<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISurface>
    {
        var @this = (IDXGISurface*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppDevice = default;
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISurface>
    {
        var @this = (IDXGISurface*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetParent<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISurface>
    {
        var @this = (IDXGISurface*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetDevice<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISurface>
    {
        var @this = (IDXGISurface*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
