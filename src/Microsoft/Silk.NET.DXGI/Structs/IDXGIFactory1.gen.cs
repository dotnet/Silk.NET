...
namespace Silk.NET.DXGI
{
    ...
    public unsafe partial struct IDXGIFactory1
    {
        ...
        public readonly int MakeWindowAssociation(IntPtr WindowHandle, uint Flags)
        {
            var @this = (IDXGIFactory1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                int ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGIFactory1*, IntPtr, uint, int>)LpVtbl[8])(@this, WindowHandle, Flags);
            return ret;
        }
        ...
        public readonly unsafe int GetWindowAssociation(IntPtr* pWindowHandle)
        {
            var @this = (IDXGIFactory1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                int ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGIFactory1*, IntPtr*, int>)LpVtbl[9])(@this, pWindowHandle);
            return ret;
        }
        ...
        public readonly int GetWindowAssociation(ref IntPtr pWindowHandle)
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<IDXGIFactory1*, IntPtr*, int>)LpVtbl[9])(@this, pWindowHandlePtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int CreateSoftwareAdapter(IntPtr Module, Silk.NET.DXGI.IDXGIAdapter** ppAdapter)
        {
            var @this = (IDXGIFactory1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                int ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGIFactory1*, IntPtr, Silk.NET.DXGI.IDXGIAdapter**, int>)LpVtbl[11])(@this, Module, ppAdapter);
            return ret;
        }
        ...
        public readonly unsafe int CreateSoftwareAdapter(IntPtr Module, ref Silk.NET.DXGI.IDXGIAdapter* ppAdapter)
        {
            ...
            fixed (Silk.NET.DXGI.IDXGIAdapter** ppAdapterPtr = &ppAdapter)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDXGIFactory1*, IntPtr, Silk.NET.DXGI.IDXGIAdapter**, int>)LpVtbl[11])(@this, Module, ppAdapterPtr);
            }
            return ret;
        }
