...
public unsafe static class DXGISwapChain2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int SetPrivateData<T0>(this ComPtr<IDXGISwapChain2> thisVtbl, Span<Guid> Name, uint DataSize, [Flow(FlowDirection.In)] Span<T0> pData) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetPrivateDataInterface<TI0>(this ComPtr<IDXGISwapChain2> thisVtbl, Guid* Name, [Flow(FlowDirection.In)] ComPtr<TI0> pUnknown) where TI0 : unmanaged, IComVtbl<Silk.NET.Core.Native.IUnknown>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int SetPrivateDataInterface<TI0>(this ComPtr<IDXGISwapChain2> thisVtbl, ref Guid Name, [Flow(FlowDirection.In)] ComPtr<TI0> pUnknown) where TI0 : unmanaged, IComVtbl<Silk.NET.Core.Native.IUnknown>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
