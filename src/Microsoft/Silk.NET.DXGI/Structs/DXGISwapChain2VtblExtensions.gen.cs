...
public unsafe static class DXGISwapChain2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetFullscreenState(this ComPtr<IDXGISwapChain2> thisVtbl, bool Fullscreen, IDXGIOutput* pTarget)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetFullscreenState(this ComPtr<IDXGISwapChain2> thisVtbl, bool Fullscreen, ref IDXGIOutput pTarget)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static bool IsTemporaryMonoSupported(this ComPtr<IDXGISwapChain2> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        bool ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe nint* GetFrameLatencyWaitableObject(this ComPtr<IDXGISwapChain2> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        nint* ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetFullscreenState<TI0>(this ComPtr<IDXGISwapChain2> thisVtbl, bool Fullscreen, ComPtr<TI0> pTarget) where TI0 : unmanaged, IComVtbl<IDXGIOutput>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int SetFullscreenState(this ComPtr<IDXGISwapChain2> thisVtbl, bool Fullscreen, Span<IDXGIOutput> pTarget)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
