...
public unsafe static class DXGISwapChainMediaVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int QueryInterface<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppvObject) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISwapChainMedia>
    {
        var @this = (IDXGISwapChainMedia*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppvObject = default;
