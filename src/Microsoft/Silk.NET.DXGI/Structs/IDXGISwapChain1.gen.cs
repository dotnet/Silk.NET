...
namespace Silk.NET.DXGI
{
    ...
    public unsafe partial struct IDXGISwapChain1
    {
        ...
        public readonly uint AddRef()
        {
            var @this = (IDXGISwapChain1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGISwapChain1*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (IDXGISwapChain1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGISwapChain1*, uint>)LpVtbl[2])(@this);
            return ret;
        }
        ...
        public readonly unsafe int GetHwnd(IntPtr* pHwnd)
        {
            var @this = (IDXGISwapChain1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                int ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGISwapChain1*, IntPtr*, int>)LpVtbl[20])(@this, pHwnd);
            return ret;
        }
        ...
        public readonly int GetHwnd(ref IntPtr pHwnd)
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<IDXGISwapChain1*, IntPtr*, int>)LpVtbl[20])(@this, pHwndPtr);
            }
            return ret;
        }
        ...
        public readonly int IsTemporaryMonoSupported()
        {
            var @this = (IDXGISwapChain1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                int ret = default;
            ret = ((delegate* unmanaged[Cdecl]<IDXGISwapChain1*, int>)LpVtbl[23])(@this);
            return ret;
        }
