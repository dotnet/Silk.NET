...
namespace Silk.NET.DXGI
{
    ...
    public unsafe partial struct IDXGIOutput1 : IComVtbl<IDXGIOutput1>, IComVtbl<IDXGIOutput>, IComVtbl<Silk.NET.DXGI.IDXGIObject>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
