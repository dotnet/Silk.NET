...
namespace Silk.NET.DXGI
{
    ...
    public unsafe partial struct IDXGIAdapter1 : IComVtbl<IDXGIAdapter1>, IComVtbl<Silk.NET.DXGI.IDXGIAdapter>, IComVtbl<IDXGIObject>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
