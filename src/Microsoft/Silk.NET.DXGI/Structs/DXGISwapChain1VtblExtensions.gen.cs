...
public unsafe static class DXGISwapChain1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISwapChain1>
    {
        var @this = (IDXGISwapChain1*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetParent<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISwapChain1>
    {
        var @this = (IDXGISwapChain1*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetDevice<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISwapChain1>
    {
        var @this = (IDXGISwapChain1*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetBuffer<TI0, TThis>(this TThis thisVtbl, uint Buffer) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISwapChain1>
    {
        var @this = (IDXGISwapChain1*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetCoreWindow<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGISwapChain1>
    {
        var @this = (IDXGISwapChain1*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
