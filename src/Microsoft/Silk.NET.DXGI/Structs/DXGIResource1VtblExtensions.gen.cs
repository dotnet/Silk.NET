...
public unsafe static class DXGIResource1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGIResource1>
    {
        var @this = (IDXGIResource1*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetParent<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGIResource1>
    {
        var @this = (IDXGIResource1*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetDevice<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGIResource1>
    {
        var @this = (IDXGIResource1*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
