...
namespace Silk.NET.DXGI
{
    ...
    public unsafe partial struct IDXGIDevice4 : IComVtbl<IDXGIDevice4>, IComVtbl<IDXGIDevice3>, IComVtbl<IDXGIDevice2>, IComVtbl<IDXGIDevice1>, IComVtbl<Silk.NET.DXGI.IDXGIDevice>, IComVtbl<Silk.NET.DXGI.IDXGIObject>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int OfferResources1(uint NumResources, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in IDXGIResource* ppResources, OfferResourcePriority Priority, uint Flags)
        {
            var @this = (IDXGIDevice4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (IDXGIResource** ppResourcesPtr = &ppResources)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int ReclaimResources1(uint NumResources, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in IDXGIResource* ppResources, ReclaimResourceResults* pResults)
        {
            var @this = (IDXGIDevice4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (IDXGIResource** ppResourcesPtr = &ppResources)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int ReclaimResources1(uint NumResources, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in IDXGIResource* ppResources, ref ReclaimResourceResults pResults)
        {
            var @this = (IDXGIDevice4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (IDXGIResource** ppResourcesPtr = &ppResources)
