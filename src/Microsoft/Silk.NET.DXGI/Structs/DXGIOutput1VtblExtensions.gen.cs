...
public unsafe static class DXGIOutput1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int SetDisplaySurface<TI0>(this ComPtr<IDXGIOutput1> thisVtbl, ComPtr<TI0> pScanoutSurface) where TI0 : unmanaged, IComVtbl<IDXGISurface>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int GetDisplaySurfaceData<TI0>(this ComPtr<IDXGIOutput1> thisVtbl, ComPtr<TI0> pDestination) where TI0 : unmanaged, IComVtbl<IDXGISurface>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
