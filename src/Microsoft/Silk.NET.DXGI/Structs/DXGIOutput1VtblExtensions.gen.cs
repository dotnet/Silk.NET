...
public unsafe static class DXGIOutput1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int TakeOwnership<TI0>(this ComPtr<IDXGIOutput1> thisVtbl, ComPtr<TI0> pDevice, int Exclusive) where TI0 : unmanaged, IComVtbl<Silk.NET.Core.Native.IUnknown>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
