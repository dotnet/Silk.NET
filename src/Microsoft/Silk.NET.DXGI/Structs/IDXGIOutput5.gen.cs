...
namespace Silk.NET.DXGI
{
    ...
    public unsafe partial struct IDXGIOutput5 : IComVtbl<IDXGIOutput5>, IComVtbl<IDXGIOutput4>, IComVtbl<IDXGIOutput3>, IComVtbl<IDXGIOutput2>, IComVtbl<IDXGIOutput1>, IComVtbl<IDXGIOutput>, IComVtbl<Silk.NET.DXGI.IDXGIObject>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public readonly unsafe int TakeOwnership(Silk.NET.Core.Native.IUnknown* pDevice, bool Exclusive)
        {
            var @this = (IDXGIOutput5*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDXGIOutput5*, Silk.NET.Core.Native.IUnknown*, bool, int>)@this->LpVtbl[11])(@this, pDevice, Exclusive);
            return ret;
        }
        ...
        public readonly int TakeOwnership(ref Silk.NET.Core.Native.IUnknown pDevice, bool Exclusive)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDXGIOutput5*, Silk.NET.Core.Native.IUnknown*, bool, int>)@this->LpVtbl[11])(@this, pDevicePtr, Exclusive);
            }
            return ret;
        }
        ...
        public readonly bool SupportsOverlays()
        {
            var @this = (IDXGIOutput5*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            bool ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDXGIOutput5*, bool>)@this->LpVtbl[23])(@this);
            return ret;
        }
