...
public unsafe static class DXGIOutputDuplicationVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGIOutputDuplication>
    {
        var @this = (IDXGIOutputDuplication*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetParent<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDXGIOutputDuplication>
    {
        var @this = (IDXGIOutputDuplication*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
