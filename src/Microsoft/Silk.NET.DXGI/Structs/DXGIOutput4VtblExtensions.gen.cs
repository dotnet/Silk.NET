...
public unsafe static class DXGIOutput4VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int DuplicateOutput<TI0>(this ComPtr<IDXGIOutput4> thisVtbl, Silk.NET.Core.Native.IUnknown* pDevice, ref ComPtr<TI0> ppOutputDuplication) where TI0 : unmanaged, IComVtbl<IDXGIOutputDuplication>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
