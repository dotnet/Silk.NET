...
public unsafe static class DXGIOutput4VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int TakeOwnership(this ComPtr<IDXGIOutput4> thisVtbl, Silk.NET.Core.Native.IUnknown* pDevice, bool Exclusive)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDXGIOutput4*, Silk.NET.Core.Native.IUnknown*, bool, int>)@this->LpVtbl[11])(@this, pDevice, Exclusive);
        return ret;
    }

    /// <summary>To be documented.</summary>
    public static int TakeOwnership(this ComPtr<IDXGIOutput4> thisVtbl, ref Silk.NET.Core.Native.IUnknown pDevice, bool Exclusive)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Silk.NET.Core.Native.IUnknown* pDevicePtr = &pDevice)
        {
            ret = ((delegate* unmanaged[Stdcall]<IDXGIOutput4*, Silk.NET.Core.Native.IUnknown*, bool, int>)@this->LpVtbl[11])(@this, pDevicePtr, Exclusive);
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public static bool SupportsOverlays(this ComPtr<IDXGIOutput4> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        bool ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDXGIOutput4*, bool>)@this->LpVtbl[23])(@this);
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public static int TakeOwnership<TI0>(this ComPtr<IDXGIOutput4> thisVtbl, ComPtr<TI0> pDevice, bool Exclusive) where TI0 : unmanaged, IComVtbl<Silk.NET.Core.Native.IUnknown>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int TakeOwnership(this ComPtr<IDXGIOutput4> thisVtbl, Span<Silk.NET.Core.Native.IUnknown> pDevice, bool Exclusive)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
