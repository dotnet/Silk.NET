...
namespace Silk.NET.DXVA
{
    public static class DXVAOverloads
    {
        ...
        public static unsafe int HDCreateDevice(this DXVA thisApi, Silk.NET.Direct3D9.IDirect3DDevice9Ex* pD3DDevice, Span<HDContentDesc> pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, IDXVAHDDevice** ppDevice)
        {
            // SpanOverloader
            return thisApi.HDCreateDevice(pD3DDevice, ref pContentDesc.GetPinnableReference(), Usage, pPlugin, ppDevice);
        }
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in D:/Windows Kits/10/Include/10.0.22621.0/um\\dxvahd.h")]
        public static unsafe int HDCreateDevice(this DXVA thisApi, Span<Silk.NET.Direct3D9.IDirect3DDevice9Ex> pD3DDevice, HDContentDesc* pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, IDXVAHDDevice** ppDevice)
        {
            // SpanOverloader
