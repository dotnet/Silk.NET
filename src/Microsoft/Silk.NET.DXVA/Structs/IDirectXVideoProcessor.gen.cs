...
public unsafe partial struct IDirectXVideoProcessor
{
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParams, pSamples, NumSamples, pHandleComplete);
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (void** pHandleCompletePtr = &pHandleComplete)
        {
            ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParams, pSamples, NumSamples, pHandleCompletePtr);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
        {
            ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParams, pSamplesPtr, NumSamples, pHandleComplete);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
        {
            fixed (void** pHandleCompletePtr = &pHandleComplete)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParams, pSamplesPtr, NumSamples, pHandleCompletePtr);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
        {
            ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParamsPtr, pSamples, NumSamples, pHandleComplete);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
        {
            fixed (void** pHandleCompletePtr = &pHandleComplete)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParamsPtr, pSamples, NumSamples, pHandleCompletePtr);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
        {
            fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParamsPtr, pSamplesPtr, NumSamples, pHandleComplete);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(IDirect3DSurface9* pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
        {
            fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
            {
                fixed (void** pHandleCompletePtr = &pHandleComplete)
                {
                    ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTarget, pBltParamsPtr, pSamplesPtr, NumSamples, pHandleCompletePtr);
                }
            }
        }
        return ret;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParams, pSamples, NumSamples, pHandleComplete);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (void** pHandleCompletePtr = &pHandleComplete)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParams, pSamples, NumSamples, pHandleCompletePtr);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParams, pSamplesPtr, NumSamples, pHandleComplete);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, DXVA2VideoProcessBltParams* pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
            {
                fixed (void** pHandleCompletePtr = &pHandleComplete)
                {
                    ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParams, pSamplesPtr, NumSamples, pHandleCompletePtr);
                }
            }
        }
        return ret;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParamsPtr, pSamples, NumSamples, pHandleComplete);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, DXVA2VideoSample* pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
            {
                fixed (void** pHandleCompletePtr = &pHandleComplete)
                {
                    ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParamsPtr, pSamples, NumSamples, pHandleCompletePtr);
                }
            }
        }
        return ret;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, void** pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
            {
                fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
                {
                    ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParamsPtr, pSamplesPtr, NumSamples, pHandleComplete);
                }
            }
        }
        return ret;
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBlt(ref IDirect3DSurface9 pRenderTarget, ref DXVA2VideoProcessBltParams pBltParams, ref DXVA2VideoSample pSamples, uint NumSamples, ref void* pHandleComplete)
    {
        var @this = (IDirectXVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pRenderTargetPtr = &pRenderTarget)
        {
            fixed (DXVA2VideoProcessBltParams* pBltParamsPtr = &pBltParams)
            {
                fixed (DXVA2VideoSample* pSamplesPtr = &pSamples)
                {
                    fixed (void** pHandleCompletePtr = &pHandleComplete)
                    {
                        ret = ((delegate* unmanaged[Cdecl]<IDirectXVideoProcessor*, IDirect3DSurface9*, DXVA2VideoProcessBltParams*, DXVA2VideoSample*, uint, void**, int>)LpVtbl[8])(@this, pRenderTargetPtr, pBltParamsPtr, pSamplesPtr, NumSamples, pHandleCompletePtr);
                    }
                }
            }
        }
