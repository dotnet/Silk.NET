...
public unsafe partial struct IDXVAHDVideoProcessor
{
    ...
    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBltHD(IDirect3DSurface9* pOutputSurface, uint OutputFrame, uint StreamCount, HDStreamData* pStreams)
    {
        var @this = (IDXVAHDVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        ret = ((delegate* unmanaged[Cdecl]<IDXVAHDVideoProcessor*, IDirect3DSurface9*, uint, uint, HDStreamData*, int>)LpVtbl[7])(@this, pOutputSurface, OutputFrame, StreamCount, pStreams);
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBltHD(IDirect3DSurface9* pOutputSurface, uint OutputFrame, uint StreamCount, ref HDStreamData pStreams)
    {
        var @this = (IDXVAHDVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (HDStreamData* pStreamsPtr = &pStreams)
        {
            ret = ((delegate* unmanaged[Cdecl]<IDXVAHDVideoProcessor*, IDirect3DSurface9*, uint, uint, HDStreamData*, int>)LpVtbl[7])(@this, pOutputSurface, OutputFrame, StreamCount, pStreamsPtr);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly unsafe int VideoProcessBltHD(ref IDirect3DSurface9 pOutputSurface, uint OutputFrame, uint StreamCount, HDStreamData* pStreams)
    {
        var @this = (IDXVAHDVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pOutputSurfacePtr = &pOutputSurface)
        {
            ret = ((delegate* unmanaged[Cdecl]<IDXVAHDVideoProcessor*, IDirect3DSurface9*, uint, uint, HDStreamData*, int>)LpVtbl[7])(@this, pOutputSurfacePtr, OutputFrame, StreamCount, pStreams);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public readonly int VideoProcessBltHD(ref IDirect3DSurface9 pOutputSurface, uint OutputFrame, uint StreamCount, ref HDStreamData pStreams)
    {
        var @this = (IDXVAHDVideoProcessor*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        int ret = default;
        fixed (IDirect3DSurface9* pOutputSurfacePtr = &pOutputSurface)
        {
            fixed (HDStreamData* pStreamsPtr = &pStreams)
            {
                ret = ((delegate* unmanaged[Cdecl]<IDXVAHDVideoProcessor*, IDirect3DSurface9*, uint, uint, HDStreamData*, int>)LpVtbl[7])(@this, pOutputSurfacePtr, OutputFrame, StreamCount, pStreamsPtr);
            }
        }
        return ret;
    }
