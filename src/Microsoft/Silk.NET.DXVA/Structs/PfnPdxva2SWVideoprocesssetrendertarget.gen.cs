...
public unsafe readonly struct PfnPdxva2SWVideoprocesssetrendertarget : IDisposable
{
    ...
    public delegate* unmanaged[Cdecl]<void*, IDirect3DSurface9*, int> Handle => (delegate* unmanaged[Cdecl]<void*, IDirect3DSurface9*, int>) _handle;
    public PfnPdxva2SWVideoprocesssetrendertarget
    (
        delegate* unmanaged[Cdecl]<void*, IDirect3DSurface9*, int> ptr
    ) => _handle = ptr;
    ...
    public static explicit operator PfnPdxva2SWVideoprocesssetrendertarget(nint pfn)
        => new PfnPdxva2SWVideoprocesssetrendertarget((delegate* unmanaged[Cdecl]<void*, IDirect3DSurface9*, int>) pfn);
    ...
    public static implicit operator delegate* unmanaged[Cdecl]<void*, IDirect3DSurface9*, int>(PfnPdxva2SWVideoprocesssetrendertarget pfn) => pfn.Handle;
    public static implicit operator PfnPdxva2SWVideoprocesssetrendertarget(delegate* unmanaged[Cdecl]<void*, IDirect3DSurface9*, int> ptr) => new PfnPdxva2SWVideoprocesssetrendertarget(ptr);
}

[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
public unsafe delegate int Pdxva2SWVideoprocesssetrendertarget(void* arg0, IDirect3DSurface9* arg1);
