...
namespace Silk.NET.DXVA
{
    ...
    public unsafe partial struct IDXVAHDDevice : IComVtbl<IDXVAHDDevice>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetVideoProcessorCustomRates([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pVPGuid, uint Count, HDCustomRateData* pRates)
        {
            var @this = (IDXVAHDDevice*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int GetVideoProcessorCustomRates([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pVPGuid, uint Count, ref HDCustomRateData pRates)
        {
            var @this = (IDXVAHDDevice*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* pVPGuidPtr = &pVPGuid)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateVideoProcessor([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pVPGuid, IDXVAHDVideoProcessor** ppVideoProcessor)
        {
            var @this = (IDXVAHDDevice*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* pVPGuidPtr = &pVPGuid)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateVideoProcessor([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pVPGuid, ref IDXVAHDVideoProcessor* ppVideoProcessor)
        {
            var @this = (IDXVAHDDevice*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* pVPGuidPtr = &pVPGuid)
        ...
        /// <summary>To be documented.</summary>
        public readonly int CreateVideoProcessor<TI0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pVPGuid, ref ComPtr<TI0> ppVideoProcessor) where TI0 : unmanaged, IComVtbl<IDXVAHDVideoProcessor>, IComVtbl<TI0>
        {
            var @this = (IDXVAHDDevice*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
