...
namespace Silk.NET.DXVA
{
    public unsafe partial class DXVA : NativeAPI
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in D:/Windows Kits/10/Include/10.0.22621.0/um\\dxvahd.h")]
        public unsafe int HDCreateDevice<TI0>(Silk.NET.Direct3D9.IDirect3DDevice9Ex* pD3DDevice, HDContentDesc* pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<IDXVAHDDevice>, IComVtbl<TI0>
        {
            // ComPtrOverloader
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in D:/Windows Kits/10/Include/10.0.22621.0/um\\dxvahd.h")]
        public unsafe int HDCreateDevice<TI0>(Silk.NET.Direct3D9.IDirect3DDevice9Ex* pD3DDevice, ref HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<IDXVAHDDevice>, IComVtbl<TI0>
        {
            // ComPtrOverloader
            return HDCreateDevice(pD3DDevice, ref pContentDesc, Usage, pPlugin, (IDXVAHDDevice**) ppDevice.GetAddressOf());
        }

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in D:/Windows Kits/10/Include/10.0.22621.0/um\\dxvahd.h")]
        public unsafe int HDCreateDevice<TI0>(ref Silk.NET.Direct3D9.IDirect3DDevice9Ex pD3DDevice, HDContentDesc* pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<IDXVAHDDevice>, IComVtbl<TI0>
        {
            // ComPtrOverloader
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in D:/Windows Kits/10/Include/10.0.22621.0/um\\dxvahd.h")]
        public unsafe int HDCreateDevice<TI0>(ref Silk.NET.Direct3D9.IDirect3DDevice9Ex pD3DDevice, ref HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<IDXVAHDDevice>, IComVtbl<TI0>
        {
            // ComPtrOverloader
            return HDCreateDevice(ref pD3DDevice, ref pContentDesc, Usage, pPlugin, (IDXVAHDDevice**) ppDevice.GetAddressOf());
        }
