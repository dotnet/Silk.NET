...
namespace Silk.NET.DXVA
{
    public unsafe partial class DXVA : NativeAPI
    {
        ...
        [NativeName("Src", "Line 1134, Column 1 in dxvahd.h")]
        [NativeApi(EntryPoint = "DXVAHD_CreateDevice", Convention = CallingConvention.StdCall)]
        public unsafe partial int HDCreateDevice(Silk.NET.Direct3D9.IDirect3DDevice9Ex* pD3DDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, IDXVAHDDevice** ppDevice);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in dxvahd.h")]
        [NativeApi(EntryPoint = "DXVAHD_CreateDevice", Convention = CallingConvention.StdCall)]
        public unsafe partial int HDCreateDevice(Silk.NET.Direct3D9.IDirect3DDevice9Ex* pD3DDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref IDXVAHDDevice* ppDevice);
        ...
        [NativeName("Src", "Line 1134, Column 1 in dxvahd.h")]
        [NativeApi(EntryPoint = "DXVAHD_CreateDevice", Convention = CallingConvention.StdCall)]
        public unsafe partial int HDCreateDevice(ref Silk.NET.Direct3D9.IDirect3DDevice9Ex pD3DDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, IDXVAHDDevice** ppDevice);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in dxvahd.h")]
        [NativeApi(EntryPoint = "DXVAHD_CreateDevice", Convention = CallingConvention.StdCall)]
        public unsafe partial int HDCreateDevice(ref Silk.NET.Direct3D9.IDirect3DDevice9Ex pD3DDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref IDXVAHDDevice* ppDevice);
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in dxvahd.h")]
        public unsafe int HDCreateDevice<TI0>(Silk.NET.Direct3D9.IDirect3DDevice9Ex* pD3DDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<IDXVAHDDevice>, IComVtbl<TI0>
        {
            // ComPtrOverloader
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1134, Column 1 in dxvahd.h")]
        public unsafe int HDCreateDevice<TI0>(ref Silk.NET.Direct3D9.IDirect3DDevice9Ex pD3DDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in HDContentDesc pContentDesc, HDDeviceUsage Usage, PfnPDXVAHDSWPlugin pPlugin, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<IDXVAHDDevice>, IComVtbl<TI0>
        {
            // ComPtrOverloader
