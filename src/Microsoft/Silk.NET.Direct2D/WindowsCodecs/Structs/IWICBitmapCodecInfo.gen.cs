...
namespace Silk.NET.WindowsCodecs
{
    ...
    public unsafe partial struct IWICBitmapCodecInfo : IComVtbl<IWICBitmapCodecInfo>, IComVtbl<IWICComponentInfo>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int MatchesMimeType([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char wzMimeType, int* pfMatches)
        {
            var @this = (IWICBitmapCodecInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int MatchesMimeType([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char wzMimeType, ref int pfMatches)
        {
            var @this = (IWICBitmapCodecInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (char* wzMimeTypePtr = &wzMimeType)
