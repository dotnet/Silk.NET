...
public unsafe static class WICStreamVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Write<T0>(this ComPtr<IWICStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 pv, uint cb, uint* pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
    ...
    /// <summary>To be documented.</summary>
    public static int Write<T0>(this ComPtr<IWICStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 pv, uint cb, ref uint pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
    ...
    /// <summary>To be documented.</summary>
    public static int InitializeFromFilename(this ComPtr<IWICStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char wzFileName, uint dwDesiredAccess)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
