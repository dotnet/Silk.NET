...
namespace Silk.NET.WindowsCodecs
{
    ...
    [NativeName("Name", "IWICMetadataHandlerInfo")]
    public unsafe partial struct IWICMetadataHandlerInfo : IComVtbl<IWICMetadataHandlerInfo>, IComVtbl<IWICComponentInfo>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("aba958bf-c672-44d1-8d61-ce6df2e682c2");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IWICComponentInfo(IWICMetadataHandlerInfo val)
            => Unsafe.As<IWICMetadataHandlerInfo, IWICComponentInfo>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IWICMetadataHandlerInfo val)
            => Unsafe.As<IWICMetadataHandlerInfo, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (IWICMetadataHandlerInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        public readonly unsafe int GetComponentType(ComponentType* pType)
        {
            var @this = (IWICMetadataHandlerInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IWICMetadataHandlerInfo*, ComponentType*, int>)@this->LpVtbl[3])(@this, pType);
            return ret;
        }
        ...
        public readonly int GetComponentType(ref ComponentType pType)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IWICMetadataHandlerInfo*, ComponentType*, int>)@this->LpVtbl[3])(@this, pTypePtr);
            }
            return ret;
        }
