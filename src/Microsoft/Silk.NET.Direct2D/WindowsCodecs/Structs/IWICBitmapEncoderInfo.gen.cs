...
namespace Silk.NET.WindowsCodecs
{
    ...
    [NativeName("Name", "IWICBitmapEncoderInfo")]
    public unsafe partial struct IWICBitmapEncoderInfo : IComVtbl<IWICBitmapEncoderInfo>, IComVtbl<IWICBitmapCodecInfo>, IComVtbl<IWICComponentInfo>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("94c9b4ee-a09f-4f92-8a1e-4a9bce7e76fb");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IWICBitmapCodecInfo(IWICBitmapEncoderInfo val)
            => Unsafe.As<IWICBitmapEncoderInfo, IWICBitmapCodecInfo>(ref val);

        public static implicit operator IWICComponentInfo(IWICBitmapEncoderInfo val)
            => Unsafe.As<IWICBitmapEncoderInfo, IWICComponentInfo>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IWICBitmapEncoderInfo val)
            => Unsafe.As<IWICBitmapEncoderInfo, Silk.NET.Core.Native.IUnknown>(ref val);

        public IWICBitmapEncoderInfo
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        {
            var @this = (IWICBitmapEncoderInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateInstance(IWICBitmapEncoder** ppIBitmapEncoder)
        {
            var @this = (IWICBitmapEncoderInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateInstance(ref IWICBitmapEncoder* ppIBitmapEncoder)
        {
            var @this = (IWICBitmapEncoderInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int CreateInstance<TI0>(ref ComPtr<TI0> ppIBitmapEncoder) where TI0 : unmanaged, IComVtbl<IWICBitmapEncoder>, IComVtbl<TI0>
        {
            var @this = (IWICBitmapEncoderInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
