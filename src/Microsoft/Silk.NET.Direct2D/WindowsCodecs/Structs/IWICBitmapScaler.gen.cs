...
namespace Silk.NET.WindowsCodecs
{
    ...
    public unsafe partial struct IWICBitmapScaler : IComVtbl<IWICBitmapScaler>, IComVtbl<IWICBitmapSource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int Initialize(IWICBitmapSource* pISource, uint uiWidth, uint uiHeight, BitmapInterpolationMode mode)
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int Initialize(ref IWICBitmapSource pISource, uint uiWidth, uint uiHeight, BitmapInterpolationMode mode)
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int Initialize<TI0>(ComPtr<TI0> pISource, uint uiWidth, uint uiHeight, BitmapInterpolationMode mode) where TI0 : unmanaged, IComVtbl<IWICBitmapSource>, IComVtbl<TI0>
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
