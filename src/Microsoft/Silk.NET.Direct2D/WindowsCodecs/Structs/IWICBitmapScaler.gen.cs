...
namespace Silk.NET.WindowsCodecs
{
    ...
    [NativeName("Name", "IWICBitmapScaler")]
    public unsafe partial struct IWICBitmapScaler : IComVtbl<IWICBitmapScaler>, IComVtbl<IWICBitmapSource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("00000302-a8f2-4877-ba0a-fd2b6645fb94");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IWICBitmapSource(IWICBitmapScaler val)
            => Unsafe.As<IWICBitmapScaler, IWICBitmapSource>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IWICBitmapScaler val)
            => Unsafe.As<IWICBitmapScaler, Silk.NET.Core.Native.IUnknown>(ref val);

        public IWICBitmapScaler
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int Initialize(IWICBitmapSource* pISource, uint uiWidth, uint uiHeight, WICBitmapInterpolationMode mode)
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int Initialize(ref IWICBitmapSource pISource, uint uiWidth, uint uiHeight, WICBitmapInterpolationMode mode)
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int Initialize<TI0>(ComPtr<TI0> pISource, uint uiWidth, uint uiHeight, WICBitmapInterpolationMode mode) where TI0 : unmanaged, IComVtbl<IWICBitmapSource>, IComVtbl<TI0>
        {
            var @this = (IWICBitmapScaler*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
