...
namespace Silk.NET.WindowsCodecs
{
    ...
    [NativeName("Name", "IWICPixelFormatInfo")]
    public unsafe partial struct IWICPixelFormatInfo : IComVtbl<IWICPixelFormatInfo>, IComVtbl<IWICComponentInfo>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("e8eda601-3d48-431a-ab44-69059be88bbe");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IWICComponentInfo(IWICPixelFormatInfo val)
            => Unsafe.As<IWICPixelFormatInfo, IWICComponentInfo>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IWICPixelFormatInfo val)
            => Unsafe.As<IWICPixelFormatInfo, Silk.NET.Core.Native.IUnknown>(ref val);

        public IWICPixelFormatInfo
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        {
            var @this = (IWICPixelFormatInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        public readonly unsafe int GetComponentType(WICComponentType* pType)
        {
            var @this = (IWICPixelFormatInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IWICPixelFormatInfo*, WICComponentType*, int>)@this->LpVtbl[3])(@this, pType);
            return ret;
        }
        ...
        public readonly int GetComponentType(ref WICComponentType pType)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IWICPixelFormatInfo*, WICComponentType*, int>)@this->LpVtbl[3])(@this, pTypePtr);
            }
            return ret;
        }
