...
namespace Silk.NET.WindowsCodecs
{
    ...
    public unsafe partial struct IWICPersistStream : IComVtbl<IWICPersistStream>, IComVtbl<Silk.NET.Core.Win32Extras.IPersistStream>, IComVtbl<Silk.NET.Core.Win32Extras.IPersist>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int LoadEx(Silk.NET.Core.Win32Extras.IStream* pIStream, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pguidPreferredVendor, uint dwPersistOptions)
        {
            var @this = (IWICPersistStream*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int LoadEx(ref Silk.NET.Core.Win32Extras.IStream pIStream, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pguidPreferredVendor, uint dwPersistOptions)
        {
            var @this = (IWICPersistStream*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Silk.NET.Core.Win32Extras.IStream* pIStreamPtr = &pIStream)
        ...
        /// <summary>To be documented.</summary>
        public readonly int LoadEx<TI0>(ComPtr<TI0> pIStream, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid pguidPreferredVendor, uint dwPersistOptions) where TI0 : unmanaged, IComVtbl<Silk.NET.Core.Win32Extras.IStream>, IComVtbl<TI0>
        {
            var @this = (IWICPersistStream*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
