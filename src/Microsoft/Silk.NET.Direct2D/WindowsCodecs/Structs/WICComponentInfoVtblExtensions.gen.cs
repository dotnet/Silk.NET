...
public unsafe static class WICComponentInfoVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetComponentType(this ComPtr<IWICComponentInfo> thisVtbl, WICComponentType* pType)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetComponentType(this ComPtr<IWICComponentInfo> thisVtbl, ref WICComponentType pType)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetComponentType(this ComPtr<IWICComponentInfo> thisVtbl, Span<WICComponentType> pType)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
