...
namespace Silk.NET.WindowsCodecs
{
    ...
    public unsafe partial struct IWICPlanarFormatConverter : IComVtbl<IWICPlanarFormatConverter>, IComVtbl<IWICBitmapSource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CanConvert([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Guid pSrcPixelFormats, uint cSrcPlanes, Guid* dstPixelFormat, int* pfCanConvert)
        {
            var @this = (IWICPlanarFormatConverter*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CanConvert([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Guid pSrcPixelFormats, uint cSrcPlanes, Guid* dstPixelFormat, ref int pfCanConvert)
        {
            var @this = (IWICPlanarFormatConverter*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* pSrcPixelFormatsPtr = &pSrcPixelFormats)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CanConvert([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Guid pSrcPixelFormats, uint cSrcPlanes, ref Guid dstPixelFormat, int* pfCanConvert)
        {
            var @this = (IWICPlanarFormatConverter*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* pSrcPixelFormatsPtr = &pSrcPixelFormats)
        ...
        /// <summary>To be documented.</summary>
        public readonly int CanConvert([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Guid pSrcPixelFormats, uint cSrcPlanes, ref Guid dstPixelFormat, ref int pfCanConvert)
        {
            var @this = (IWICPlanarFormatConverter*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* pSrcPixelFormatsPtr = &pSrcPixelFormats)
