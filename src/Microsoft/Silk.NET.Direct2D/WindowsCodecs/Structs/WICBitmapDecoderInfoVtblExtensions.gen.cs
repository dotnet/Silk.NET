...
public unsafe static class WICBitmapDecoderInfoVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int MatchesMimeType(this ComPtr<IWICBitmapDecoderInfo> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char wzMimeType, int* pfMatches)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int MatchesMimeType(this ComPtr<IWICBitmapDecoderInfo> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char wzMimeType, ref int pfMatches)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* wzMimeTypePtr = &wzMimeType)
