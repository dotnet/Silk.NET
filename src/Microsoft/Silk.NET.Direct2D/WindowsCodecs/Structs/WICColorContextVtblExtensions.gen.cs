...
public unsafe static class WICColorContextVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int InitializeFromFilename(this ComPtr<IWICColorContext> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char wzFilename)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int InitializeFromMemory(this ComPtr<IWICColorContext> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte pbBuffer, uint cbBufferSize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
