...
public unsafe static class D2D1EffectContext2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe Silk.NET.Core.Bool32 IsShaderLoaded(this ComPtr<ID2D1EffectContext2> thisVtbl, Guid* shaderId)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static Silk.NET.Core.Bool32 IsShaderLoaded(this ComPtr<ID2D1EffectContext2> thisVtbl, ref Guid shaderId)
    {
        var @this = thisVtbl.Handle;
        Silk.NET.Core.Bool32 ret = default;
        fixed (Guid* shaderIdPtr = &shaderId)
    ...
    /// <summary>To be documented.</summary>
    public static Silk.NET.Core.Bool32 IsShaderLoaded(this ComPtr<ID2D1EffectContext2> thisVtbl, Span<Guid> shaderId)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
