...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1SvgAttribute : IComVtbl<ID2D1SvgAttribute>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1SvgAttribute*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riid, ppvObjectPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1SvgAttribute*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObject);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                fixed (void** ppvObjectPtr = &ppvObject)
                {
                    ret = ((delegate* unmanaged[Stdcall]<ID2D1SvgAttribute*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe void GetFactory(ref ID2D1Factory* factory)
        {
            ...
            {
                ((delegate* unmanaged[Stdcall]<ID2D1SvgAttribute*, ID2D1Factory**, void>)@this->LpVtbl[3])(@this, factoryPtr);
            }
        }
        ...
        public readonly unsafe void GetElement(ref ID2D1SvgElement* element)
        {
            ...
            {
                ((delegate* unmanaged[Stdcall]<ID2D1SvgAttribute*, ID2D1SvgElement**, void>)@this->LpVtbl[4])(@this, elementPtr);
            }
        }
        ...
        public readonly unsafe int Clone(ref ID2D1SvgAttribute* attribute)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1SvgAttribute*, ID2D1SvgAttribute**, int>)@this->LpVtbl[5])(@this, attributePtr);
            }
            return ret;
        }
