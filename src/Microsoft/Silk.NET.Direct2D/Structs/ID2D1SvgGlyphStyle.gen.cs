...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1SvgGlyphStyle : IComVtbl<ID2D1SvgGlyphStyle>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int SetStroke(ID2D1Brush* brush, float strokeWidth, float* dashes, uint dashesCount, float dashOffset)
        {
            var @this = (ID2D1SvgGlyphStyle*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int SetStroke(ID2D1Brush* brush, float strokeWidth, ref float dashes, uint dashesCount, float dashOffset)
        {
            var @this = (ID2D1SvgGlyphStyle*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int SetStroke(ref ID2D1Brush brush, float strokeWidth, float* dashes, uint dashesCount, float dashOffset)
        {
            var @this = (ID2D1SvgGlyphStyle*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (ID2D1Brush* brushPtr = &brush)
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetStroke(ref ID2D1Brush brush, float strokeWidth, ref float dashes, uint dashesCount, float dashOffset)
        {
            var @this = (ID2D1SvgGlyphStyle*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (ID2D1Brush* brushPtr = &brush)
