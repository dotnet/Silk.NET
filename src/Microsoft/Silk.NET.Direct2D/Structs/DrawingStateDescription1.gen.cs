...
{
    [NativeName("Name", "D2D1_DRAWING_STATE_DESCRIPTION1")]
    public unsafe partial struct DrawingStateDescription1
    {
        public DrawingStateDescription1
        (
            ...
            PrimitiveBlend? primitiveBlend = null,
        ...
        ) : this()
        {
            ...
            if (primitiveBlend is not null)
            {
                PrimitiveBlend = primitiveBlend.Value;
            }

            if (unitMode is not null)
            {
        ...
        [NativeName("Type", "D2D1_PRIMITIVE_BLEND")]
        [NativeName("Type.Name", "D2D1_PRIMITIVE_BLEND")]
        [NativeName("Name", "primitiveBlend")]
        public PrimitiveBlend PrimitiveBlend;

        [NativeName("Type", "D2D1_UNIT_MODE")]
        [NativeName("Type.Name", "D2D1_UNIT_MODE")]
        [NativeName("Name", "unitMode")]
