...
public unsafe static class D2D1DrawingStateBlockVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe void SetDescription(this ComPtr<ID2D1DrawingStateBlock> thisVtbl, DrawingStateDescription* stateDescription)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void SetDescription(this ComPtr<ID2D1DrawingStateBlock> thisVtbl, ref DrawingStateDescription stateDescription)
    {
        var @this = thisVtbl.Handle;
        fixed (DrawingStateDescription* stateDescriptionPtr = &stateDescription)
        {
    ...
    /// <summary>To be documented.</summary>
    public static void SetDescription(this ComPtr<ID2D1DrawingStateBlock> thisVtbl, Span<DrawingStateDescription> stateDescription)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
