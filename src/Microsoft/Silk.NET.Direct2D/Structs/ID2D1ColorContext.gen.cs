...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1ColorContext
    {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, void** ppvObject)
        {
            ...
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObject);
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObjectPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObject);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                fixed (void** ppvObjectPtr = &ppvObject)
                {
                    ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                }
            }
            return ret;
        }
        ...
        public readonly uint AddRef()
        {
            var @this = (ID2D1ColorContext*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (ID2D1ColorContext*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, uint>)LpVtbl[2])(@this);
            return ret;
        }
        ...
        {
            var @this = (ID2D1ColorContext*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, ID2D1Factory**, void>)LpVtbl[3])(@this, factory);
        }
        ...
        public readonly unsafe void GetFactory(ref ID2D1Factory* factory)
        {
            ...
            {
                ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, ID2D1Factory**, void>)LpVtbl[3])(@this, factoryPtr);
            }
        }
        ...
        public readonly ColorSpace GetColorSpace()
        {
            ...
            ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, ColorSpace>)LpVtbl[4])(@this);
            return ret;
        }
        ...
        public readonly uint GetProfileSize()
        {
            var @this = (ID2D1ColorContext*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, uint>)LpVtbl[5])(@this);
            return ret;
        }
        ...
        public readonly unsafe int GetProfile(byte* profile, uint profileSize)
        {
            var @this = (ID2D1ColorContext*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, byte*, uint, int>)LpVtbl[6])(@this, profile, profileSize);
            return ret;
        }
        ...
        public readonly int GetProfile(ref byte profile, uint profileSize)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1ColorContext*, byte*, uint, int>)LpVtbl[6])(@this, profilePtr, profileSize);
            }
            return ret;
        }
