...
public unsafe static class D2D1GdiMetafileSinkVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int ProcessRecord(this ComPtr<ID2D1GdiMetafileSink> thisVtbl, int recordType, [Flow(FlowDirection.In)] void* recordData, int recordDataSize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int ProcessRecord<T0>(this ComPtr<ID2D1GdiMetafileSink> thisVtbl, int recordType, [Flow(FlowDirection.In)] in T0 recordData, int recordDataSize) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int ProcessRecord<T0>(this ComPtr<ID2D1GdiMetafileSink> thisVtbl, int recordType, [Flow(FlowDirection.In)] ReadOnlySpan<T0> recordData, int recordDataSize) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
