...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1Factory6 : IComVtbl<ID2D1Factory6>, IComVtbl<ID2D1Factory5>, IComVtbl<ID2D1Factory4>, IComVtbl<ID2D1Factory3>, IComVtbl<ID2D1Factory2>, IComVtbl<ID2D1Factory1>, IComVtbl<ID2D1Factory>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public static implicit operator ID2D1Factory4(ID2D1Factory6 val)
            => Unsafe.As<ID2D1Factory6, ID2D1Factory4>(ref val);

        public static implicit operator ID2D1Factory3(ID2D1Factory6 val)
            => Unsafe.As<ID2D1Factory6, ID2D1Factory3>(ref val);

        public static implicit operator ID2D1Factory2(ID2D1Factory6 val)
            => Unsafe.As<ID2D1Factory6, ID2D1Factory2>(ref val);

        public static implicit operator ID2D1Factory1(ID2D1Factory6 val)
            => Unsafe.As<ID2D1Factory6, ID2D1Factory1>(ref val);

        public static implicit operator ID2D1Factory(ID2D1Factory6 val)
            => Unsafe.As<ID2D1Factory6, ID2D1Factory>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(ID2D1Factory6 val)
            => Unsafe.As<ID2D1Factory6, Silk.NET.Core.Native.IUnknown>(ref val);
