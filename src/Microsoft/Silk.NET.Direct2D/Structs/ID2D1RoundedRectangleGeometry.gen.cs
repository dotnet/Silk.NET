...
namespace Silk.NET.Direct2D
{
    ...
    [NativeName("Name", "ID2D1RoundedRectangleGeometry")]
    public unsafe partial struct ID2D1RoundedRectangleGeometry : IComVtbl<ID2D1RoundedRectangleGeometry>, IComVtbl<ID2D1Geometry>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("2cd906a3-12e2-11dc-9fed-001143a055f9");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator ID2D1Geometry(ID2D1RoundedRectangleGeometry val)
            => Unsafe.As<ID2D1RoundedRectangleGeometry, ID2D1Geometry>(ref val);

        public static implicit operator ID2D1Resource(ID2D1RoundedRectangleGeometry val)
            => Unsafe.As<ID2D1RoundedRectangleGeometry, ID2D1Resource>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(ID2D1RoundedRectangleGeometry val)
            => Unsafe.As<ID2D1RoundedRectangleGeometry, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (ID2D1RoundedRectangleGeometry*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void GetRoundedRect(RoundedRect* roundedRect)
        {
            var @this = (ID2D1RoundedRectangleGeometry*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        ...
        /// <summary>To be documented.</summary>
        public readonly void GetRoundedRect(ref RoundedRect roundedRect)
        {
            var @this = (ID2D1RoundedRectangleGeometry*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
