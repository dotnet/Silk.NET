...
public unsafe static class D2D1GdiMetafileSink1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int ProcessRecord<T0>(this ComPtr<ID2D1GdiMetafileSink1> thisVtbl, uint recordType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 recordData, uint recordDataSize) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int ProcessRecord<T0>(this ComPtr<ID2D1GdiMetafileSink1> thisVtbl, uint recordType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<T0> recordData, uint recordDataSize) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
