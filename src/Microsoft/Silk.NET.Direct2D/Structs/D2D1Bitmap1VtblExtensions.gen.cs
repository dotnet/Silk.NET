...
public unsafe static class D2D1Bitmap1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int CopyFromMemory<T0>(this ComPtr<ID2D1Bitmap1> thisVtbl, [Flow(FlowDirection.In)] ReadOnlySpan<Silk.NET.Maths.Box2D<uint>> dstRect, [Flow(FlowDirection.In)] Span<T0> srcData, uint pitch) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
