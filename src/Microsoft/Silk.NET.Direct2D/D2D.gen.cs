...
namespace Silk.NET.Direct2D
{
    public unsafe partial class D2D : NativeAPI
    {
        ...
        public unsafe partial Silk.NET.Core.Bool32 D2D1IsMatrixInvertible([Flow(FlowDirection.In)] Silk.NET.Maths.Matrix3X2<float>* matrix);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 3691, Column 5 in d2d1.h")]
        [NativeApi(EntryPoint = "D2D1IsMatrixInvertible", Convention = CallingConvention.StdCall)]
        public partial Silk.NET.Core.Bool32 D2D1IsMatrixInvertible([Flow(FlowDirection.In)] in Silk.NET.Maths.Matrix3X2<float> matrix);
