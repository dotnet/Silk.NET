...
public unsafe static class DWriteColorGlyphRunEnumeratorVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetCurrentRun(this ComPtr<IDWriteColorGlyphRunEnumerator> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly ColorGlyphRun* colorGlyphRun)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
