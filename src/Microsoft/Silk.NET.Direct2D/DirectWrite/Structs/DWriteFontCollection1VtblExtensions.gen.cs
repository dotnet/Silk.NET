...
public unsafe static class DWriteFontCollection1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int FindFamilyName(this ComPtr<IDWriteFontCollection1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly char familyName, uint* index, int* exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int FindFamilyName(this ComPtr<IDWriteFontCollection1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly char familyName, uint* index, ref int exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* familyNamePtr = &familyName)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int FindFamilyName(this ComPtr<IDWriteFontCollection1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly char familyName, ref uint index, int* exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* familyNamePtr = &familyName)
    ...
    /// <summary>To be documented.</summary>
    public static int FindFamilyName(this ComPtr<IDWriteFontCollection1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly char familyName, ref uint index, ref int exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* familyNamePtr = &familyName)
