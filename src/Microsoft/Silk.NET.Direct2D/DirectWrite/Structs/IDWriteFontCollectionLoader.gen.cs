...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteFontCollectionLoader : IComVtbl<IDWriteFontCollectionLoader>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateEnumeratorFromKey<T0>(IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, IDWriteFontFileEnumerator** fontFileEnumerator) where T0 : unmanaged
        {
            var @this = (IDWriteFontCollectionLoader*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateEnumeratorFromKey<T0>(IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref IDWriteFontFileEnumerator* fontFileEnumerator) where T0 : unmanaged
        {
            var @this = (IDWriteFontCollectionLoader*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* collectionKeyPtr = &collectionKey)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateEnumeratorFromKey<T0>(ref IDWriteFactory factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, IDWriteFontFileEnumerator** fontFileEnumerator) where T0 : unmanaged
        {
            var @this = (IDWriteFontCollectionLoader*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (IDWriteFactory* factoryPtr = &factory)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateEnumeratorFromKey<T0>(ref IDWriteFactory factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref IDWriteFontFileEnumerator* fontFileEnumerator) where T0 : unmanaged
        {
            var @this = (IDWriteFontCollectionLoader*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (IDWriteFactory* factoryPtr = &factory)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateEnumeratorFromKey<T0, TI0>(ComPtr<TI0> factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref IDWriteFontFileEnumerator* fontFileEnumerator) where T0 : unmanaged where TI0 : unmanaged, IComVtbl<IDWriteFactory>, IComVtbl<TI0>
        {
            var @this = (IDWriteFontCollectionLoader*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
        ...
        /// <summary>To be documented.</summary>
        public readonly int CreateEnumeratorFromKey<T0, TI0>(ref IDWriteFactory factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref ComPtr<TI0> fontFileEnumerator) where T0 : unmanaged where TI0 : unmanaged, IComVtbl<IDWriteFontFileEnumerator>, IComVtbl<TI0>
        {
            var @this = (IDWriteFontCollectionLoader*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
