...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteTextLayout4 : IComVtbl<IDWriteTextLayout4>, IComVtbl<IDWriteTextLayout3>, IComVtbl<IDWriteTextLayout2>, IComVtbl<IDWriteTextLayout1>, IComVtbl<IDWriteTextLayout>, IComVtbl<IDWriteTextFormat>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetFontAxisValues([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly FontAxisValue fontAxisValues, uint fontAxisValueCount, TextRange textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
