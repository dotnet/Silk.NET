...
public unsafe static class DWriteTextFormat1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetTrimming(this ComPtr<IDWriteTextFormat1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Trimming trimmingOptions, IDWriteInlineObject* trimmingSign)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetTrimming(this ComPtr<IDWriteTextFormat1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Trimming trimmingOptions, ref IDWriteInlineObject trimmingSign)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Trimming* trimmingOptionsPtr = &trimmingOptions)
    ...
    /// <summary>To be documented.</summary>
    public static int SetTrimming<TI0>(this ComPtr<IDWriteTextFormat1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Trimming trimmingOptions, ComPtr<TI0> trimmingSign) where TI0 : unmanaged, IComVtbl<IDWriteInlineObject>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
