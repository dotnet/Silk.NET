...
public unsafe static class DWriteTextLayout3VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetTrimming(this ComPtr<IDWriteTextLayout3> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Trimming trimmingOptions, IDWriteInlineObject* trimmingSign)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetTrimming(this ComPtr<IDWriteTextLayout3> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Trimming trimmingOptions, ref IDWriteInlineObject trimmingSign)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Trimming* trimmingOptionsPtr = &trimmingOptions)
    ...
    /// <summary>To be documented.</summary>
    public static int SetFontFamilyName(this ComPtr<IDWriteTextLayout3> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly char fontFamilyName, TextRange textRange)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* fontFamilyNamePtr = &fontFamilyName)
    ...
    /// <summary>To be documented.</summary>
    public static int SetLocaleName(this ComPtr<IDWriteTextLayout3> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly char localeName, TextRange textRange)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* localeNamePtr = &localeName)
    ...
    /// <summary>To be documented.</summary>
    public static int SetTrimming<TI0>(this ComPtr<IDWriteTextLayout3> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Trimming trimmingOptions, ComPtr<TI0> trimmingSign) where TI0 : unmanaged, IComVtbl<IDWriteInlineObject>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
