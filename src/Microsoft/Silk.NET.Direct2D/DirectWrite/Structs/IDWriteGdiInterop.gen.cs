...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteGdiInterop : IComVtbl<IDWriteGdiInterop>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateFontFromLOGFONT<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 logFont, IDWriteFont** font) where T0 : unmanaged
        {
            var @this = (IDWriteGdiInterop*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateFontFromLOGFONT<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 logFont, ref IDWriteFont* font) where T0 : unmanaged
        {
            var @this = (IDWriteGdiInterop*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* logFontPtr = &logFont)
        ...
        /// <summary>To be documented.</summary>
        public readonly int CreateFontFromLOGFONT<T0, TI0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 logFont, ref ComPtr<TI0> font) where T0 : unmanaged where TI0 : unmanaged, IComVtbl<IDWriteFont>, IComVtbl<TI0>
        {
            var @this = (IDWriteGdiInterop*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
