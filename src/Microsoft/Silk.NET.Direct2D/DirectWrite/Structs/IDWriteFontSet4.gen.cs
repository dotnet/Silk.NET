...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteFontSet4 : IComVtbl<IDWriteFontSet4>, IComVtbl<IDWriteFontSet3>, IComVtbl<IDWriteFontSet2>, IComVtbl<IDWriteFontSet1>, IComVtbl<IDWriteFontSet>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe uint ConvertWeightStretchStyleToFontAxisValues([Flow(Silk.NET.Core.Native.FlowDirection.In)] FontAxisValue* inputAxisValues, uint inputAxisCount, FontWeight fontWeight, FontStretch fontStretch, FontStyle fontStyle, float fontSize, ref FontAxisValue outputAxisValues)
        {
            var @this = (IDWriteFontSet4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe uint ConvertWeightStretchStyleToFontAxisValues([Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue inputAxisValues, uint inputAxisCount, FontWeight fontWeight, FontStretch fontStretch, FontStyle fontStyle, float fontSize, FontAxisValue* outputAxisValues)
        {
            var @this = (IDWriteFontSet4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly uint ConvertWeightStretchStyleToFontAxisValues([Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue inputAxisValues, uint inputAxisCount, FontWeight fontWeight, FontStretch fontStretch, FontStyle fontStyle, float fontSize, ref FontAxisValue outputAxisValues)
        {
            var @this = (IDWriteFontSet4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            fixed (FontAxisValue* inputAxisValuesPtr = &inputAxisValues)
