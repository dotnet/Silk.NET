...
public unsafe static class DWriteBitmapRenderTarget1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int SetCurrentTransform(this ComPtr<IDWriteBitmapRenderTarget1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Matrix transform)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Matrix* transformPtr = &transform)
