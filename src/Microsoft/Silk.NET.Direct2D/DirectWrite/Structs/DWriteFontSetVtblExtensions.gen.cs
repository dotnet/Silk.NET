...
public unsafe static class DWriteFontSetVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetPropertyOccurrenceCount(this ComPtr<IDWriteFontSet> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontProperty property, uint* propertyOccurrenceCount)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetPropertyOccurrenceCount(this ComPtr<IDWriteFontSet> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontProperty property, ref uint propertyOccurrenceCount)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (FontProperty* propertyPtr = &property)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetMatchingFonts(this ComPtr<IDWriteFontSet> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontProperty properties, uint propertyCount, IDWriteFontSet** filteredSet)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetMatchingFonts(this ComPtr<IDWriteFontSet> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontProperty properties, uint propertyCount, ref IDWriteFontSet* filteredSet)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (FontProperty* propertiesPtr = &properties)
    ...
    /// <summary>To be documented.</summary>
    public static int GetMatchingFonts<TI0>(this ComPtr<IDWriteFontSet> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontProperty properties, uint propertyCount, ref ComPtr<TI0> filteredSet) where TI0 : unmanaged, IComVtbl<IDWriteFontSet>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
