...
namespace Silk.NET.DirectWrite
{
    ...
    [NativeName("Name", "IDWriteFont1")]
    public unsafe partial struct IDWriteFont1 : IComVtbl<IDWriteFont1>, IComVtbl<IDWriteFont>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("acd16696-8c14-4f5d-877e-fe3fc1d32738");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IDWriteFont(IDWriteFont1 val)
            => Unsafe.As<IDWriteFont1, IDWriteFont>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IDWriteFont1 val)
            => Unsafe.As<IDWriteFont1, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (IDWriteFont1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
