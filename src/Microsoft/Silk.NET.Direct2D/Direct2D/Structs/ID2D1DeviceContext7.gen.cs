...
namespace Silk.NET.Direct2D
{
    ...
    [NativeName("Name", "ID2D1DeviceContext7")]
    public unsafe partial struct ID2D1DeviceContext7 : IComVtbl<ID2D1DeviceContext7>, IComVtbl<ID2D1DeviceContext6>, IComVtbl<ID2D1DeviceContext5>, IComVtbl<ID2D1DeviceContext4>, IComVtbl<ID2D1DeviceContext3>, IComVtbl<ID2D1DeviceContext2>, IComVtbl<ID2D1DeviceContext1>, IComVtbl<ID2D1DeviceContext>, IComVtbl<ID2D1RenderTarget>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("ec891cf7-9b69-4851-9def-4e0915771e62");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator ID2D1DeviceContext6(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext6>(ref val);

        public static implicit operator ID2D1DeviceContext5(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext5>(ref val);

        public static implicit operator ID2D1DeviceContext4(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext4>(ref val);

        public static implicit operator ID2D1DeviceContext3(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext3>(ref val);

        public static implicit operator ID2D1DeviceContext2(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext2>(ref val);

        public static implicit operator ID2D1DeviceContext1(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext1>(ref val);

        public static implicit operator ID2D1DeviceContext(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1DeviceContext>(ref val);

        public static implicit operator ID2D1RenderTarget(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1RenderTarget>(ref val);

        public static implicit operator ID2D1Resource(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, ID2D1Resource>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(ID2D1DeviceContext7 val)
            => Unsafe.As<ID2D1DeviceContext7, Silk.NET.Core.Native.IUnknown>(ref val);

        public ID2D1DeviceContext7
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        {
            var @this = (ID2D1DeviceContext7*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly DwritePaintFeatureLevel GetPaintFeatureLevel()
        {
            var @this = (ID2D1DeviceContext7*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void DrawPaintGlyphRun(Silk.NET.Maths.Vector2D<float> baselineOrigin, [Flow(Silk.NET.Core.Native.FlowDirection.In)] DwriteGlyphRun* glyphRun, ID2D1Brush* defaultFillBrush, uint colorPaletteIndex, DwriteMeasuringMode measuringMode)
        {
            var @this = (ID2D1DeviceContext7*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void DrawPaintGlyphRun(Silk.NET.Maths.Vector2D<float> baselineOrigin, [Flow(Silk.NET.Core.Native.FlowDirection.In)] DwriteGlyphRun* glyphRun, ref ID2D1Brush defaultFillBrush, uint colorPaletteIndex, DwriteMeasuringMode measuringMode)
        {
            var @this = (ID2D1DeviceContext7*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            fixed (ID2D1Brush* defaultFillBrushPtr = &defaultFillBrush)
            {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void DrawPaintGlyphRun<TI0>(Silk.NET.Maths.Vector2D<float> baselineOrigin, [Flow(Silk.NET.Core.Native.FlowDirection.In)] DwriteGlyphRun* glyphRun, ComPtr<TI0> defaultFillBrush, uint colorPaletteIndex, DwriteMeasuringMode measuringMode) where TI0 : unmanaged, IComVtbl<ID2D1Brush>, IComVtbl<TI0>
        {
            var @this = (ID2D1DeviceContext7*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
