...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1RectangleGeometry : IComVtbl<ID2D1RectangleGeometry>, IComVtbl<ID2D1Geometry>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
