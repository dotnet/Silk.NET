...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1AnalysisTransform : IComVtbl<ID2D1AnalysisTransform>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int ProcessAnalysisResults([Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte analysisData, uint analysisDataCount)
        {
            var @this = (ID2D1AnalysisTransform*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int ProcessAnalysisResults([Flow(Silk.NET.Core.Native.FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string analysisData, uint analysisDataCount)
        {
            var @this = (ID2D1AnalysisTransform*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
