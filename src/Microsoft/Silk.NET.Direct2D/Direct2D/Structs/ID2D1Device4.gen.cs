...
namespace Silk.NET.Direct2D
{
    ...
    [NativeName("Name", "ID2D1Device4")]
    public unsafe partial struct ID2D1Device4 : IComVtbl<ID2D1Device4>, IComVtbl<ID2D1Device3>, IComVtbl<ID2D1Device2>, IComVtbl<ID2D1Device1>, IComVtbl<ID2D1Device>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("d7bdb159-5683-4a46-bc9c-72dc720b858b");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator ID2D1Device3(ID2D1Device4 val)
            => Unsafe.As<ID2D1Device4, ID2D1Device3>(ref val);

        public static implicit operator ID2D1Device2(ID2D1Device4 val)
            => Unsafe.As<ID2D1Device4, ID2D1Device2>(ref val);

        public static implicit operator ID2D1Device1(ID2D1Device4 val)
            => Unsafe.As<ID2D1Device4, ID2D1Device1>(ref val);

        public static implicit operator ID2D1Device(ID2D1Device4 val)
            => Unsafe.As<ID2D1Device4, ID2D1Device>(ref val);

        public static implicit operator ID2D1Resource(ID2D1Device4 val)
            => Unsafe.As<ID2D1Device4, ID2D1Resource>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(ID2D1Device4 val)
            => Unsafe.As<ID2D1Device4, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreatePrintControl(IWICImagingFactory* wicFactory, IPrintDocumentPackageTarget* documentTarget, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly PrintControlProperties printControlProperties, ID2D1PrintControl** printControl)
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreatePrintControl(IWICImagingFactory* wicFactory, IPrintDocumentPackageTarget* documentTarget, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly PrintControlProperties printControlProperties, ref ID2D1PrintControl* printControl)
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (PrintControlProperties* printControlPropertiesPtr = &printControlProperties)
        ...
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Stdcall]<ID2D1Device4*, ID2D1Bitmap*, void>)@this->LpVtbl[13])(@this, bitmap);
        }
        ...
        public readonly void FlushDeviceContexts(ref ID2D1Bitmap bitmap)
        {
            ...
            {
                ((delegate* unmanaged[Stdcall]<ID2D1Device4*, ID2D1Bitmap*, void>)@this->LpVtbl[13])(@this, bitmapPtr);
            }
        }
        ...
        public readonly unsafe int GetDxgiDevice(Silk.NET.DXGI.IDXGIDevice** dxgiDevice)
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1Device4*, Silk.NET.DXGI.IDXGIDevice**, int>)@this->LpVtbl[14])(@this, dxgiDevice);
            return ret;
        }
        ...
        public readonly unsafe int GetDxgiDevice(ref Silk.NET.DXGI.IDXGIDevice* dxgiDevice)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID2D1Device4*, Silk.NET.DXGI.IDXGIDevice**, int>)@this->LpVtbl[14])(@this, dxgiDevicePtr);
            }
            return ret;
        }
        ...
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Stdcall]<ID2D1Device4*, ulong, void>)@this->LpVtbl[17])(@this, maximumInBytes);
        }
        ...
        public readonly ulong GetMaximumColorGlyphCacheMemory()
        {
            var @this = (ID2D1Device4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ulong ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID2D1Device4*, ulong>)@this->LpVtbl[18])(@this);
            return ret;
        }
