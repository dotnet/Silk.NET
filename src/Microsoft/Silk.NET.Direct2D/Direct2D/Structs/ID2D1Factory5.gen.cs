...
namespace Silk.NET.Direct2D
{
    ...
    [NativeName("Name", "ID2D1Factory5")]
    public unsafe partial struct ID2D1Factory5 : IComVtbl<ID2D1Factory5>, IComVtbl<ID2D1Factory4>, IComVtbl<ID2D1Factory3>, IComVtbl<ID2D1Factory2>, IComVtbl<ID2D1Factory1>, IComVtbl<ID2D1Factory>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("c4349994-838e-4b0f-8cab-44997d9eeacc");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator ID2D1Factory4(ID2D1Factory5 val)
            => Unsafe.As<ID2D1Factory5, ID2D1Factory4>(ref val);

        public static implicit operator ID2D1Factory3(ID2D1Factory5 val)
            => Unsafe.As<ID2D1Factory5, ID2D1Factory3>(ref val);

        public static implicit operator ID2D1Factory2(ID2D1Factory5 val)
            => Unsafe.As<ID2D1Factory5, ID2D1Factory2>(ref val);

        public static implicit operator ID2D1Factory1(ID2D1Factory5 val)
            => Unsafe.As<ID2D1Factory5, ID2D1Factory1>(ref val);

        public static implicit operator ID2D1Factory(ID2D1Factory5 val)
            => Unsafe.As<ID2D1Factory5, ID2D1Factory>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(ID2D1Factory5 val)
            => Unsafe.As<ID2D1Factory5, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (ID2D1Factory5*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
