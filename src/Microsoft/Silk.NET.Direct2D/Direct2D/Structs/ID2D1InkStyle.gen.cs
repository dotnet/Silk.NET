...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1InkStyle : IComVtbl<ID2D1InkStyle>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe void SetNibTransform([Flow(Silk.NET.Core.Native.FlowDirection.In)] Silk.NET.Maths.Matrix3X2<float>* transform)
        {
            var @this = (ID2D1InkStyle*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        ...
        /// <summary>To be documented.</summary>
        public readonly void SetNibTransform([Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in Silk.NET.Maths.Matrix3X2<float> transform)
        {
            var @this = (ID2D1InkStyle*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
