...
{
    [NativeName("Name", "D2D1_LAYER_PARAMETERS1")]
    public unsafe partial struct LayerParameters1
    {
        ...
        (
            ...
            LayerOptions1? layerOptions = null
        ) : this()
        {
        ...
        [NativeName("Type", "D2D1_LAYER_OPTIONS1")]
        [NativeName("Type.Name", "D2D1_LAYER_OPTIONS1")]
