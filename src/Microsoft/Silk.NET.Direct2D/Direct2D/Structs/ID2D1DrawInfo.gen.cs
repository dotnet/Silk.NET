...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1DrawInfo : IComVtbl<ID2D1DrawInfo>, IComVtbl<ID2D1RenderInfo>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetPixelShaderConstantBuffer([Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte buffer, uint bufferCount)
        {
            var @this = (ID2D1DrawInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetVertexShaderConstantBuffer([Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte buffer, uint bufferCount)
        {
            var @this = (ID2D1DrawInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (byte* bufferPtr = &buffer)
