...
namespace Silk.NET.Direct2D
{
    ...
    public unsafe partial struct ID2D1PathGeometry1 : IComVtbl<ID2D1PathGeometry1>, IComVtbl<ID2D1PathGeometry>, IComVtbl<ID2D1Geometry>, IComVtbl<ID2D1Resource>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int ComputePointAndSegmentAtLength(float length, uint startSegment, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Matrix3X2<float> worldTransform, float flatteningTolerance, PointDescription* pointDescription)
        {
            var @this = (ID2D1PathGeometry1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Silk.NET.Maths.Matrix3X2<float>* worldTransformPtr = &worldTransform)
        ...
        /// <summary>To be documented.</summary>
        public readonly int ComputePointAndSegmentAtLength(float length, uint startSegment, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Matrix3X2<float> worldTransform, float flatteningTolerance, ref PointDescription pointDescription)
        {
            var @this = (ID2D1PathGeometry1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Silk.NET.Maths.Matrix3X2<float>* worldTransformPtr = &worldTransform)
