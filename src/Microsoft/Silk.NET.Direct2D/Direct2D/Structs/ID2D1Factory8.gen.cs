...
namespace Silk.NET.Direct2D
{
    ...
    [NativeName("Name", "ID2D1Factory8")]
    public unsafe partial struct ID2D1Factory8 : IComVtbl<ID2D1Factory8>, IComVtbl<ID2D1Factory7>, IComVtbl<ID2D1Factory6>, IComVtbl<ID2D1Factory5>, IComVtbl<ID2D1Factory4>, IComVtbl<ID2D1Factory3>, IComVtbl<ID2D1Factory2>, IComVtbl<ID2D1Factory1>, IComVtbl<ID2D1Factory>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("677c9311-f36d-4b1f-ae86-86d1223ffd3a");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator ID2D1Factory7(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory7>(ref val);

        public static implicit operator ID2D1Factory6(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory6>(ref val);

        public static implicit operator ID2D1Factory5(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory5>(ref val);

        public static implicit operator ID2D1Factory4(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory4>(ref val);

        public static implicit operator ID2D1Factory3(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory3>(ref val);

        public static implicit operator ID2D1Factory2(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory2>(ref val);

        public static implicit operator ID2D1Factory1(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory1>(ref val);

        public static implicit operator ID2D1Factory(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, ID2D1Factory>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(ID2D1Factory8 val)
            => Unsafe.As<ID2D1Factory8, Silk.NET.Core.Native.IUnknown>(ref val);

        public ID2D1Factory8
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        {
            var @this = (ID2D1Factory8*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
