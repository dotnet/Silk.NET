...
{
    [NativeName("Name", "DWRITE_LINE_METRICS1")]
    public unsafe partial struct LineMetrics1
    {
        public LineMetrics1
        (
            uint? length = null,
        ...
        ) : this()
        {
            ...
            if (leadingAfter is not null)
            {
                LeadingAfter = leadingAfter.Value;
            }
        }
