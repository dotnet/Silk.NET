...
namespace Silk.NET.DirectWrite
{
    ...
    [NativeName("Name", "IDWriteTextLayout4")]
    public unsafe partial struct IDWriteTextLayout4 : IComVtbl<IDWriteTextLayout4>, IComVtbl<IDWriteTextLayout3>, IComVtbl<IDWriteTextLayout2>, IComVtbl<IDWriteTextLayout1>, IComVtbl<IDWriteTextLayout>, IComVtbl<IDWriteTextFormat>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("05a9bf42-223f-4441-b5fb-8263685f55e9");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IDWriteTextLayout3(IDWriteTextLayout4 val)
            => Unsafe.As<IDWriteTextLayout4, IDWriteTextLayout3>(ref val);

        public static implicit operator IDWriteTextLayout2(IDWriteTextLayout4 val)
            => Unsafe.As<IDWriteTextLayout4, IDWriteTextLayout2>(ref val);

        public static implicit operator IDWriteTextLayout1(IDWriteTextLayout4 val)
            => Unsafe.As<IDWriteTextLayout4, IDWriteTextLayout1>(ref val);

        public static implicit operator IDWriteTextLayout(IDWriteTextLayout4 val)
            => Unsafe.As<IDWriteTextLayout4, IDWriteTextLayout>(ref val);

        public static implicit operator IDWriteTextFormat(IDWriteTextLayout4 val)
            => Unsafe.As<IDWriteTextLayout4, IDWriteTextFormat>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IDWriteTextLayout4 val)
            => Unsafe.As<IDWriteTextLayout4, Silk.NET.Core.Native.IUnknown>(ref val);

        public IDWriteTextLayout4
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riid, ppvObjectPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObject);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                fixed (void** ppvObjectPtr = &ppvObject)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe int SetTrimming([Flow(Silk.NET.Core.Native.FlowDirection.In)] Trimming* trimmingOptions, ref IDWriteInlineObject trimmingSign)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Trimming*, IDWriteInlineObject*, int>)@this->LpVtbl[9])(@this, trimmingOptions, trimmingSignPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int SetTrimming([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Trimming trimmingOptions, IDWriteInlineObject* trimmingSign)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Trimming*, IDWriteInlineObject*, int>)@this->LpVtbl[9])(@this, trimmingOptionsPtr, trimmingSign);
            }
            return ret;
        }
        ...
        public readonly int SetTrimming([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Trimming trimmingOptions, ref IDWriteInlineObject trimmingSign)
        {
            ...
            fixed (Trimming* trimmingOptionsPtr = &trimmingOptions)
            {
                fixed (IDWriteInlineObject* trimmingSignPtr = &trimmingSign)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Trimming*, IDWriteInlineObject*, int>)@this->LpVtbl[9])(@this, trimmingOptionsPtr, trimmingSignPtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe int GetTrimming(Trimming* trimmingOptions, ref IDWriteInlineObject* trimmingSign)
        {
            ...
            fixed (IDWriteInlineObject** trimmingSignPtr = &trimmingSign)
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Trimming*, IDWriteInlineObject**, int>)@this->LpVtbl[17])(@this, trimmingOptions, trimmingSignPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetTrimming(ref Trimming trimmingOptions, IDWriteInlineObject** trimmingSign)
        {
            ...
            fixed (Trimming* trimmingOptionsPtr = &trimmingOptions)
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Trimming*, IDWriteInlineObject**, int>)@this->LpVtbl[17])(@this, trimmingOptionsPtr, trimmingSign);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetTrimming(ref Trimming trimmingOptions, ref IDWriteInlineObject* trimmingSign)
        {
            ...
            fixed (Trimming* trimmingOptionsPtr = &trimmingOptions)
            {
                fixed (IDWriteInlineObject** trimmingSignPtr = &trimmingSign)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Trimming*, IDWriteInlineObject**, int>)@this->LpVtbl[17])(@this, trimmingOptionsPtr, trimmingSignPtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe int GetLineSpacing(LineSpacingMethod* lineSpacingMethod, float* lineSpacing, ref float baseline)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethod, lineSpacing, baselinePtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetLineSpacing(LineSpacingMethod* lineSpacingMethod, ref float lineSpacing, float* baseline)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethod, lineSpacingPtr, baseline);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetLineSpacing(LineSpacingMethod* lineSpacingMethod, ref float lineSpacing, ref float baseline)
        {
            ...
            fixed (float* lineSpacingPtr = &lineSpacing)
            {
                fixed (float* baselinePtr = &baseline)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethod, lineSpacingPtr, baselinePtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe int GetLineSpacing(ref LineSpacingMethod lineSpacingMethod, float* lineSpacing, float* baseline)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethodPtr, lineSpacing, baseline);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetLineSpacing(ref LineSpacingMethod lineSpacingMethod, float* lineSpacing, ref float baseline)
        {
            ...
            fixed (LineSpacingMethod* lineSpacingMethodPtr = &lineSpacingMethod)
            {
                fixed (float* baselinePtr = &baseline)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethodPtr, lineSpacing, baselinePtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe int GetLineSpacing(ref LineSpacingMethod lineSpacingMethod, ref float lineSpacing, float* baseline)
        {
            ...
            fixed (LineSpacingMethod* lineSpacingMethodPtr = &lineSpacingMethod)
            {
                fixed (float* lineSpacingPtr = &lineSpacing)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethodPtr, lineSpacingPtr, baseline);
                }
            }
            return ret;
        }
        ...
        public readonly int GetLineSpacing(ref LineSpacingMethod lineSpacingMethod, ref float lineSpacing, ref float baseline)
        {
            ...
            fixed (LineSpacingMethod* lineSpacingMethodPtr = &lineSpacingMethod)
            {
                fixed (float* lineSpacingPtr = &lineSpacing)
                {
                    fixed (float* baselinePtr = &baseline)
                    {
                        ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, LineSpacingMethod*, float*, float*, int>)@this->LpVtbl[18])(@this, lineSpacingMethodPtr, lineSpacingPtr, baselinePtr);
                    }
                }
            }
            return ret;
        ...
        public readonly unsafe int GetFontCollection(ref IDWriteFontCollection* fontCollection)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, IDWriteFontCollection**, int>)@this->LpVtbl[19])(@this, fontCollectionPtr);
            }
            return ret;
        }
        ...
        public readonly int GetFontFamilyName(ref char fontFamilyName, uint nameSize)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, char*, uint, int>)@this->LpVtbl[21])(@this, fontFamilyNamePtr, nameSize);
            }
            return ret;
        }
        ...
        public readonly int GetFontFamilyName([UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string fontFamilyName, uint nameSize)
        {
            ...
            ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, byte*, uint, int>)@this->LpVtbl[21])(@this, fontFamilyNamePtr, nameSize);
        ...
        public readonly int GetLocaleName(ref char localeName, uint nameSize)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, char*, uint, int>)@this->LpVtbl[27])(@this, localeNamePtr, nameSize);
            }
            return ret;
        }
        ...
        public readonly int GetLocaleName([UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string localeName, uint nameSize)
        {
            ...
            ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, byte*, uint, int>)@this->LpVtbl[27])(@this, localeNamePtr, nameSize);
        ...
        public readonly int SetFontCollection(ref IDWriteFontCollection fontCollection, TextRange textRange)
        {
            ...
            fixed (IDWriteFontCollection* fontCollectionPtr = &fontCollection)
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, IDWriteFontCollection*, TextRange, int>)@this->LpVtbl[30])(@this, fontCollectionPtr, textRange);
            }
            return ret;
        }
        ...
        public readonly int SetFontFamilyName([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char fontFamilyName, TextRange textRange)
        {
            ...
            fixed (char* fontFamilyNamePtr = &fontFamilyName)
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, char*, TextRange, int>)@this->LpVtbl[31])(@this, fontFamilyNamePtr, textRange);
            }
            return ret;
        }
        ...
        public readonly int SetFontFamilyName([Flow(Silk.NET.Core.Native.FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string fontFamilyName, TextRange textRange)
        {
            ...
            int ret = default;
            var fontFamilyNamePtr = (byte*) SilkMarshal.StringToPtr(fontFamilyName, NativeStringEncoding.UTF8);
            ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, byte*, TextRange, int>)@this->LpVtbl[31])(@this, fontFamilyNamePtr, textRange);
            SilkMarshal.Free((nint)fontFamilyNamePtr);
            return ret;
        }
        ...
        public readonly int SetDrawingEffect(ref Silk.NET.Core.Native.IUnknown drawingEffect, TextRange textRange)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, Silk.NET.Core.Native.IUnknown*, TextRange, int>)@this->LpVtbl[38])(@this, drawingEffectPtr, textRange);
            }
            return ret;
        }
        ...
        public readonly int SetInlineObject(ref IDWriteInlineObject inlineObject, TextRange textRange)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, IDWriteInlineObject*, TextRange, int>)@this->LpVtbl[39])(@this, inlineObjectPtr, textRange);
            }
            return ret;
        }
        ...
        public readonly int SetTypography(ref IDWriteTypography typography, TextRange textRange)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, IDWriteTypography*, TextRange, int>)@this->LpVtbl[40])(@this, typographyPtr, textRange);
            }
            return ret;
        }
        ...
        public readonly int SetLocaleName([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, TextRange textRange)
        {
            ...
            fixed (char* localeNamePtr = &localeName)
            {
                ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, char*, TextRange, int>)@this->LpVtbl[41])(@this, localeNamePtr, textRange);
            }
            return ret;
        }
        ...
        public readonly int SetLocaleName([Flow(Silk.NET.Core.Native.FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string localeName, TextRange textRange)
        {
            ...
            int ret = default;
            var localeNamePtr = (byte*) SilkMarshal.StringToPtr(localeName, NativeStringEncoding.UTF8);
            ret = ((delegate* unmanaged[Stdcall]<IDWriteTextLayout4*, byte*, TextRange, int>)@this->LpVtbl[41])(@this, localeNamePtr, textRange);
            SilkMarshal.Free((nint)localeNamePtr);
            return ret;
        }
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int SetFontAxisValues([Flow(Silk.NET.Core.Native.FlowDirection.In)] FontAxisValue* fontAxisValues, uint fontAxisValueCount, TextRange textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetFontAxisValues([Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue fontAxisValues, uint fontAxisValueCount, TextRange textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly uint GetFontAxisValueCount(uint currentPosition)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetFontAxisValues(uint currentPosition, FontAxisValue* fontAxisValues, uint fontAxisValueCount, TextRange* textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetFontAxisValues(uint currentPosition, FontAxisValue* fontAxisValues, uint fontAxisValueCount, ref TextRange textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (TextRange* textRangePtr = &textRange)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetFontAxisValues(uint currentPosition, ref FontAxisValue fontAxisValues, uint fontAxisValueCount, TextRange* textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (FontAxisValue* fontAxisValuesPtr = &fontAxisValues)
        ...
        /// <summary>To be documented.</summary>
        public readonly int GetFontAxisValues(uint currentPosition, ref FontAxisValue fontAxisValues, uint fontAxisValueCount, ref TextRange textRange)
        {
            var @this = (IDWriteTextLayout4*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (FontAxisValue* fontAxisValuesPtr = &fontAxisValues)
