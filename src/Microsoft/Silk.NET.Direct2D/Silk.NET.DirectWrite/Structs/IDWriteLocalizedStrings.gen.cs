...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteLocalizedStrings : IComVtbl<IDWriteLocalizedStrings>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindLocaleName([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, uint* index, int* exists)
        {
            var @this = (IDWriteLocalizedStrings*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindLocaleName([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, uint* index, ref int exists)
        {
            var @this = (IDWriteLocalizedStrings*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (char* localeNamePtr = &localeName)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindLocaleName([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, ref uint index, int* exists)
        {
            var @this = (IDWriteLocalizedStrings*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (char* localeNamePtr = &localeName)
        ...
        /// <summary>To be documented.</summary>
        public readonly int FindLocaleName([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, ref uint index, ref int exists)
        {
            var @this = (IDWriteLocalizedStrings*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (char* localeNamePtr = &localeName)
