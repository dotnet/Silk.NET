...
public unsafe static class DWriteLocalizedStringsVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int FindLocaleName(this ComPtr<IDWriteLocalizedStrings> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, uint* index, int* exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int FindLocaleName(this ComPtr<IDWriteLocalizedStrings> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, uint* index, ref int exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* localeNamePtr = &localeName)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int FindLocaleName(this ComPtr<IDWriteLocalizedStrings> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, ref uint index, int* exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* localeNamePtr = &localeName)
    ...
    /// <summary>To be documented.</summary>
    public static int FindLocaleName(this ComPtr<IDWriteLocalizedStrings> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char localeName, ref uint index, ref int exists)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* localeNamePtr = &localeName)
