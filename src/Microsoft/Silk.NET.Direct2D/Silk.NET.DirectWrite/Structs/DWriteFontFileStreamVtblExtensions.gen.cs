...
public unsafe static class DWriteFontFileStreamVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int ReadFileFragment(this ComPtr<IDWriteFontFileStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fragmentStart, ulong fileOffset, ulong fragmentSize, void** fragmentContext)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int ReadFileFragment(this ComPtr<IDWriteFontFileStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fragmentStart, ulong fileOffset, ulong fragmentSize, ref void* fragmentContext)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void** fragmentStartPtr = &fragmentStart)
