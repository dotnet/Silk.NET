...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteBitmapRenderTarget1 : IComVtbl<IDWriteBitmapRenderTarget1>, IComVtbl<IDWriteBitmapRenderTarget>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DrawGlyphRun(float baselineOriginX, float baselineOriginY, MeasuringMode measuringMode, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in GlyphRun glyphRun, IDWriteRenderingParams* renderingParams, uint textColor, Silk.NET.Maths.Box2D<int>* blackBoxRect)
        {
            var @this = (IDWriteBitmapRenderTarget1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DrawGlyphRun(float baselineOriginX, float baselineOriginY, MeasuringMode measuringMode, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in GlyphRun glyphRun, IDWriteRenderingParams* renderingParams, uint textColor, ref Silk.NET.Maths.Box2D<int> blackBoxRect)
        {
            var @this = (IDWriteBitmapRenderTarget1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (GlyphRun* glyphRunPtr = &glyphRun)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DrawGlyphRun(float baselineOriginX, float baselineOriginY, MeasuringMode measuringMode, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in GlyphRun glyphRun, ref IDWriteRenderingParams renderingParams, uint textColor, Silk.NET.Maths.Box2D<int>* blackBoxRect)
        {
            var @this = (IDWriteBitmapRenderTarget1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (GlyphRun* glyphRunPtr = &glyphRun)
        ...
        /// <summary>To be documented.</summary>
        public readonly int DrawGlyphRun(float baselineOriginX, float baselineOriginY, MeasuringMode measuringMode, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in GlyphRun glyphRun, ref IDWriteRenderingParams renderingParams, uint textColor, ref Silk.NET.Maths.Box2D<int> blackBoxRect)
        {
            var @this = (IDWriteBitmapRenderTarget1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (GlyphRun* glyphRunPtr = &glyphRun)
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetCurrentTransform([Flow(Silk.NET.Core.Native.FlowDirection.In)] in Matrix transform)
        {
            var @this = (IDWriteBitmapRenderTarget1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Matrix* transformPtr = &transform)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DrawGlyphRun<TI0>(float baselineOriginX, float baselineOriginY, MeasuringMode measuringMode, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in GlyphRun glyphRun, ComPtr<TI0> renderingParams, uint textColor, Silk.NET.Maths.Box2D<int>* blackBoxRect) where TI0 : unmanaged, IComVtbl<IDWriteRenderingParams>, IComVtbl<TI0>
        {
            var @this = (IDWriteBitmapRenderTarget1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
