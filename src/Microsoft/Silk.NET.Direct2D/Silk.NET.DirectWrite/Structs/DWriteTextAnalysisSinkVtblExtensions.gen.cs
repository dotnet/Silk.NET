...
public unsafe static class DWriteTextAnalysisSinkVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int SetScriptAnalysis(this ComPtr<IDWriteTextAnalysisSink> thisVtbl, uint textPosition, uint textLength, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ScriptAnalysis scriptAnalysis)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetLineBreakpoints(this ComPtr<IDWriteTextAnalysisSink> thisVtbl, uint textPosition, uint textLength, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in LineBreakpoint lineBreakpoints)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
