...
public unsafe static class DWriteFontFileVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetReferenceKey(this ComPtr<IDWriteFontFile> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fontFileReferenceKey, uint* fontFileReferenceKeySize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetReferenceKey(this ComPtr<IDWriteFontFile> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fontFileReferenceKey, ref uint fontFileReferenceKeySize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void** fontFileReferenceKeyPtr = &fontFileReferenceKey)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetReferenceKey(this ComPtr<IDWriteFontFile> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fontFileReferenceKey, Span<uint> fontFileReferenceKeySize)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
