...
namespace Silk.NET.DirectComposition
{
    public unsafe partial class DComp : NativeAPI
    {
        ...
        [NativeName("Src", "Line 205, Column 8 in dcomp.h")]
        [NativeApi(EntryPoint = "DCompositionGetTargetStatistics", Convention = CallingConvention.StdCall)]
        public unsafe partial int GetTargetStatistics(ulong frameId, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in CompositionTargetId targetId, CompositionTargetStats* targetStats);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 205, Column 8 in dcomp.h")]
        [NativeApi(EntryPoint = "DCompositionGetTargetStatistics", Convention = CallingConvention.StdCall)]
        public partial int GetTargetStatistics(ulong frameId, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in CompositionTargetId targetId, ref CompositionTargetStats targetStats);
