...
public unsafe static class DCompositionDeviceVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateTargetForHwnd(this ComPtr<IDCompositionDevice> thisVtbl, nint hwnd, int topmost, IDCompositionTarget** target)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateTargetForHwnd(this ComPtr<IDCompositionDevice> thisVtbl, nint hwnd, int topmost, ref IDCompositionTarget* target)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int CreateTargetForHwnd<TI0>(this ComPtr<IDCompositionDevice> thisVtbl, nint hwnd, int topmost, ref ComPtr<TI0> target) where TI0 : unmanaged, IComVtbl<IDCompositionTarget>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
