...
public unsafe static class DCompositionDelegatedInkTrailVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int AddTrailPoints(this ComPtr<IDCompositionDelegatedInkTrail> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in InkTrailPoint inkPoints, uint inkPointsCount, uint* generationId)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int AddTrailPoints(this ComPtr<IDCompositionDelegatedInkTrail> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in InkTrailPoint inkPoints, uint inkPointsCount, ref uint generationId)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (InkTrailPoint* inkPointsPtr = &inkPoints)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int AddTrailPointsWithPrediction(this ComPtr<IDCompositionDelegatedInkTrail> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] InkTrailPoint* inkPoints, uint inkPointsCount, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in InkTrailPoint predictedInkPoints, uint predictedInkPointsCount, uint* generationId)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int AddTrailPointsWithPrediction(this ComPtr<IDCompositionDelegatedInkTrail> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in InkTrailPoint inkPoints, uint inkPointsCount, [Flow(Silk.NET.Core.Native.FlowDirection.In)] InkTrailPoint* predictedInkPoints, uint predictedInkPointsCount, uint* generationId)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (InkTrailPoint* inkPointsPtr = &inkPoints)
