...
namespace Silk.NET.DirectComposition
{
    ...
    public unsafe partial struct IDCompositionScaleTransform
    {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, void** ppvObject)
        {
            ...
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionScaleTransform*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObject);
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDCompositionScaleTransform*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObjectPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDCompositionScaleTransform*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObject);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                fixed (void** ppvObjectPtr = &ppvObject)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDCompositionScaleTransform*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                }
            }
            return ret;
        }
        ...
        public readonly uint AddRef()
        {
            var @this = (IDCompositionScaleTransform*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionScaleTransform*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (IDCompositionScaleTransform*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionScaleTransform*, uint>)LpVtbl[2])(@this);
            return ret;
        }
