...
public unsafe static class DCompositionVisualVtblExtensions
{
    ...
    public static int SetOffsetX(this ComPtr<IDCompositionVisual> thisVtbl, float offsetX)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, float, int>)@this->LpVtbl[3])(@this, offsetX);
        return ret;
    }
    ...
    public static int SetOffsetY(this ComPtr<IDCompositionVisual> thisVtbl, float offsetY)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, float, int>)@this->LpVtbl[4])(@this, offsetY);
        return ret;
    }
    ...
    public static unsafe int SetTransform(this ComPtr<IDCompositionVisual> thisVtbl, Silk.NET.Maths.Matrix3X2<float>* matrix)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, Silk.NET.Maths.Matrix3X2<float>*, int>)@this->LpVtbl[5])(@this, matrix);
        return ret;
    }
    ...
    public static int SetTransform(this ComPtr<IDCompositionVisual> thisVtbl, ref Silk.NET.Maths.Matrix3X2<float> matrix)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, Silk.NET.Maths.Matrix3X2<float>*, int>)@this->LpVtbl[5])(@this, matrixPtr);
        }
        return ret;
    }
    ...
    public static unsafe int SetTransformParent(this ComPtr<IDCompositionVisual> thisVtbl, IDCompositionVisual* visual)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int>)@this->LpVtbl[6])(@this, visual);
        return ret;
    }
    ...
    public static int SetTransformParent(this ComPtr<IDCompositionVisual> thisVtbl, ref IDCompositionVisual visual)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int>)@this->LpVtbl[6])(@this, visualPtr);
        }
        return ret;
    }
    ...
    public static unsafe int SetEffect(this ComPtr<IDCompositionVisual> thisVtbl, IDCompositionEffect* effect)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionEffect*, int>)@this->LpVtbl[7])(@this, effect);
        return ret;
    }
    ...
    public static int SetEffect(this ComPtr<IDCompositionVisual> thisVtbl, ref IDCompositionEffect effect)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionEffect*, int>)@this->LpVtbl[7])(@this, effectPtr);
        }
        return ret;
    }
    ...
    public static int SetBitmapInterpolationMode(this ComPtr<IDCompositionVisual> thisVtbl, BitmapInterpolationMode interpolationMode)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, BitmapInterpolationMode, int>)@this->LpVtbl[8])(@this, interpolationMode);
        return ret;
    }
    ...
    public static int SetBorderMode(this ComPtr<IDCompositionVisual> thisVtbl, BorderMode borderMode)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, BorderMode, int>)@this->LpVtbl[9])(@this, borderMode);
        return ret;
    }
    ...
    public static unsafe int SetClip(this ComPtr<IDCompositionVisual> thisVtbl, Silk.NET.Maths.Rectangle<float>* rect)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, Silk.NET.Maths.Rectangle<float>*, int>)@this->LpVtbl[10])(@this, rect);
        return ret;
    }
    ...
    public static int SetClip(this ComPtr<IDCompositionVisual> thisVtbl, ref Silk.NET.Maths.Rectangle<float> rect)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, Silk.NET.Maths.Rectangle<float>*, int>)@this->LpVtbl[10])(@this, rectPtr);
        }
        return ret;
    }
    ...
    public static unsafe int SetContent(this ComPtr<IDCompositionVisual> thisVtbl, Silk.NET.Core.Native.IUnknown* content)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, Silk.NET.Core.Native.IUnknown*, int>)@this->LpVtbl[11])(@this, content);
        return ret;
    }
    ...
    public static int SetContent(this ComPtr<IDCompositionVisual> thisVtbl, ref Silk.NET.Core.Native.IUnknown content)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, Silk.NET.Core.Native.IUnknown*, int>)@this->LpVtbl[11])(@this, contentPtr);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public static unsafe int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, IDCompositionVisual* visual, int insertAbove, IDCompositionVisual* referenceVisual)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int, IDCompositionVisual*, int>)@this->LpVtbl[12])(@this, visual, insertAbove, referenceVisual);
        return ret;
    }

    /// <summary>To be documented.</summary>
    public static unsafe int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, IDCompositionVisual* visual, int insertAbove, ref IDCompositionVisual referenceVisual)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (IDCompositionVisual* referenceVisualPtr = &referenceVisual)
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int, IDCompositionVisual*, int>)@this->LpVtbl[12])(@this, visual, insertAbove, referenceVisualPtr);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public static unsafe int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, ref IDCompositionVisual visual, int insertAbove, IDCompositionVisual* referenceVisual)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (IDCompositionVisual* visualPtr = &visual)
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int, IDCompositionVisual*, int>)@this->LpVtbl[12])(@this, visualPtr, insertAbove, referenceVisual);
        }
        return ret;
    }

    /// <summary>To be documented.</summary>
    public static int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, ref IDCompositionVisual visual, int insertAbove, ref IDCompositionVisual referenceVisual)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (IDCompositionVisual* visualPtr = &visual)
        {
            fixed (IDCompositionVisual* referenceVisualPtr = &referenceVisual)
            {
                ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int, IDCompositionVisual*, int>)@this->LpVtbl[12])(@this, visualPtr, insertAbove, referenceVisualPtr);
            }
        }
        return ret;
    }
    ...
    public static unsafe int RemoveVisual(this ComPtr<IDCompositionVisual> thisVtbl, IDCompositionVisual* visual)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int>)@this->LpVtbl[13])(@this, visual);
        return ret;
    }
    ...
    public static int RemoveVisual(this ComPtr<IDCompositionVisual> thisVtbl, ref IDCompositionVisual visual)
    {
        ...
        fixed (IDCompositionVisual* visualPtr = &visual)
        {
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, IDCompositionVisual*, int>)@this->LpVtbl[13])(@this, visualPtr);
        }
        return ret;
    }
    ...
    public static int RemoveAllVisuals(this ComPtr<IDCompositionVisual> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, int>)@this->LpVtbl[14])(@this);
        return ret;
    }
    ...
    public static int SetCompositeMode(this ComPtr<IDCompositionVisual> thisVtbl, CompositeMode compositeMode)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDCompositionVisual*, CompositeMode, int>)@this->LpVtbl[15])(@this, compositeMode);
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public static int AddVisual<TI0, TI1>(this ComPtr<IDCompositionVisual> thisVtbl, ComPtr<TI0> visual, int insertAbove, ComPtr<TI1> referenceVisual) where TI0 : unmanaged, IComVtbl<IDCompositionVisual>, IComVtbl<TI0> where TI1 : unmanaged, IComVtbl<IDCompositionVisual>, IComVtbl<TI1>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, IDCompositionVisual* visual, int insertAbove, Span<IDCompositionVisual> referenceVisual)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int AddVisual<TI0>(this ComPtr<IDCompositionVisual> thisVtbl, ComPtr<TI0> visual, int insertAbove, ref IDCompositionVisual referenceVisual) where TI0 : unmanaged, IComVtbl<IDCompositionVisual>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, Span<IDCompositionVisual> visual, int insertAbove, IDCompositionVisual* referenceVisual)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int AddVisual<TI0>(this ComPtr<IDCompositionVisual> thisVtbl, ref IDCompositionVisual visual, int insertAbove, ComPtr<TI0> referenceVisual) where TI0 : unmanaged, IComVtbl<IDCompositionVisual>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int AddVisual(this ComPtr<IDCompositionVisual> thisVtbl, Span<IDCompositionVisual> visual, int insertAbove, Span<IDCompositionVisual> referenceVisual)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
