...
namespace Silk.NET.DirectComposition
{
    ...
    public unsafe partial struct IDCompositionMatrixTransform3D
    {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, void** ppvObject)
        {
            ...
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObject);
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObjectPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObject);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                fixed (void** ppvObjectPtr = &ppvObject)
                {
                    ret = ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                }
            }
            return ret;
        }
        ...
        public readonly uint AddRef()
        {
            var @this = (IDCompositionMatrixTransform3D*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (IDCompositionMatrixTransform3D*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            uint ret = default;
            ret = ((delegate* unmanaged[Stdcall]<IDCompositionMatrixTransform3D*, uint>)LpVtbl[2])(@this);
            return ret;
        }
