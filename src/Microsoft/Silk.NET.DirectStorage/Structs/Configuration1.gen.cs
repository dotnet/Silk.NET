...
{
    [NativeName("Name", "DSTORAGE_CONFIGURATION1")]
    public unsafe partial struct Configuration1
    {
        ...
        (
            ...
            Silk.NET.Core.Bool32? forceFileBuffering = null
        ) : this()
        {
            ...
            if (forceFileBuffering is not null)
            {
                ForceFileBuffering = forceFileBuffering.Value;
            }
        }
        ...
        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "ForceFileBuffering")]
        public Silk.NET.Core.Bool32 ForceFileBuffering;
    }
}
