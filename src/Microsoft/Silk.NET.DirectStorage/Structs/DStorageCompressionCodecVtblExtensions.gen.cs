...
public unsafe static class DStorageCompressionCodecVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int CompressBuffer<T0, T1>(this ComPtr<IDStorageCompressionCodec> thisVtbl, [Flow(FlowDirection.In)] Span<T0> uncompressedData, nuint uncompressedDataSize, Compression compressionSetting, Span<T1> compressedBuffer, nuint compressedBufferSize, Span<nuint> compressedDataSize) where T0 : struct where T1 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int DecompressBuffer<T0, T1>(this ComPtr<IDStorageCompressionCodec> thisVtbl, [Flow(FlowDirection.In)] Span<T0> compressedData, nuint compressedDataSize, Span<T1> uncompressedBuffer, nuint uncompressedBufferSize, Span<nuint> uncompressedDataSize) where T0 : struct where T1 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        fixed (void* compressedDataSpp = compressedData)
        fixed (void* uncompressedBufferSpp = uncompressedBuffer)
            return @this->DecompressBuffer(compressedDataSpp, compressedDataSize, uncompressedBufferSpp, uncompressedBufferSize, ref uncompressedDataSize.GetPinnableReference());
    }
