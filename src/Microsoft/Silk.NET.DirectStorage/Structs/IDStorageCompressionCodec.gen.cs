...
namespace Silk.NET.DirectStorage
{
    ...
    public unsafe partial struct IDStorageCompressionCodec : IComVtbl<IDStorageCompressionCodec>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CompressBuffer<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 uncompressedData, nuint uncompressedDataSize, Compression compressionSetting, void* compressedBuffer, nuint compressedBufferSize, nuint* compressedDataSize) where T0 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CompressBuffer<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 uncompressedData, nuint uncompressedDataSize, Compression compressionSetting, void* compressedBuffer, nuint compressedBufferSize, ref nuint compressedDataSize) where T0 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* uncompressedDataPtr = &uncompressedData)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CompressBuffer<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 uncompressedData, nuint uncompressedDataSize, Compression compressionSetting, ref T1 compressedBuffer, nuint compressedBufferSize, nuint* compressedDataSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* uncompressedDataPtr = &uncompressedData)
        ...
        /// <summary>To be documented.</summary>
        public readonly int CompressBuffer<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 uncompressedData, nuint uncompressedDataSize, Compression compressionSetting, ref T1 compressedBuffer, nuint compressedBufferSize, ref nuint compressedDataSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* uncompressedDataPtr = &uncompressedData)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DecompressBuffer<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 compressedData, nuint compressedDataSize, void* uncompressedBuffer, nuint uncompressedBufferSize, nuint* uncompressedDataSize) where T0 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DecompressBuffer<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 compressedData, nuint compressedDataSize, void* uncompressedBuffer, nuint uncompressedBufferSize, ref nuint uncompressedDataSize) where T0 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* compressedDataPtr = &compressedData)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int DecompressBuffer<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 compressedData, nuint compressedDataSize, ref T1 uncompressedBuffer, nuint uncompressedBufferSize, nuint* uncompressedDataSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* compressedDataPtr = &compressedData)
        ...
        /// <summary>To be documented.</summary>
        public readonly int DecompressBuffer<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 compressedData, nuint compressedDataSize, ref T1 uncompressedBuffer, nuint uncompressedBufferSize, ref nuint uncompressedDataSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (IDStorageCompressionCodec*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* compressedDataPtr = &compressedData)
