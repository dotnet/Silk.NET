...
public unsafe static class DStorageQueue1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IDStorageQueue1> thisVtbl, Guid* riid, ref void* ppvObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IDStorageQueue1> thisVtbl, ref Guid riid, void** ppvObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IDStorageQueue1> thisVtbl, ref Guid riid, ref void* ppvObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Guid* riidPtr = &riid)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe void EnqueueRequest(this ComPtr<IDStorageQueue1> thisVtbl, [Flow(FlowDirection.In)] Request* request)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueRequest(this ComPtr<IDStorageQueue1> thisVtbl, [Flow(FlowDirection.In)] in Request request)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueStatus(this ComPtr<IDStorageQueue1> thisVtbl, ref IDStorageStatusArray statusArray, uint index)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueSignal(this ComPtr<IDStorageQueue1> thisVtbl, ref Silk.NET.Direct3D12.ID3D12Fence fence, ulong value)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void RetrieveErrorRecord(this ComPtr<IDStorageQueue1> thisVtbl, ref ErrorRecord record)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void Query(this ComPtr<IDStorageQueue1> thisVtbl, ref QueueInfo info)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IDStorageQueue1> thisVtbl, Span<Guid> riid, void** ppvObject)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IDStorageQueue1> thisVtbl, Span<Guid> riid, ref void* ppvObject)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueRequest(this ComPtr<IDStorageQueue1> thisVtbl, [Flow(FlowDirection.In)] ReadOnlySpan<Request> request)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueStatus<TI0>(this ComPtr<IDStorageQueue1> thisVtbl, ComPtr<TI0> statusArray, uint index) where TI0 : unmanaged, IComVtbl<IDStorageStatusArray>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueStatus(this ComPtr<IDStorageQueue1> thisVtbl, Span<IDStorageStatusArray> statusArray, uint index)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueSignal(this ComPtr<IDStorageQueue1> thisVtbl, Span<Silk.NET.Direct3D12.ID3D12Fence> fence, ulong value)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void RetrieveErrorRecord(this ComPtr<IDStorageQueue1> thisVtbl, Span<ErrorRecord> record)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void Query(this ComPtr<IDStorageQueue1> thisVtbl, Span<QueueInfo> info)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0>(this ComPtr<IDStorageQueue1> thisVtbl) where TI0 : unmanaged, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
