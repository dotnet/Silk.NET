...
public unsafe static class DStorageQueue1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueRequest(this ComPtr<IDStorageQueue1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in Request request)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static void EnqueueRequest(this ComPtr<IDStorageQueue1> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<Request> request)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
