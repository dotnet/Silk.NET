...
namespace Silk.NET.DirectStorage
{
    public unsafe partial class DStorage : NativeAPI
    {
        ...
        [NativeName("Src", "Line 1386, Column 16 in dstorage.h")]
        [NativeApi(EntryPoint = "DStorageSetConfiguration", Convention = CallingConvention.StdCall)]
        public partial int SetConfiguration([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Configuration configuration);
        ...
        [NativeName("Src", "Line 1396, Column 16 in dstorage.h")]
        [NativeApi(EntryPoint = "DStorageSetConfiguration1", Convention = CallingConvention.StdCall)]
        public partial int SetConfiguration1([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Configuration1 configuration);
