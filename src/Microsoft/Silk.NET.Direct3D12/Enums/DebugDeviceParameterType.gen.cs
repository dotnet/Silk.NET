...
namespace Silk.NET.Direct3D12
{
    ...
    public enum DebugDeviceParameterType : int
    {
        ...
        [Obsolete("Deprecated in favour of \"BytecodeValidationMode\"")]
        [NativeName("Name", "D3D12_DEBUG_DEVICE_PARAMETER_BYTECODE_VALIDATION_MODE")]
        DebugDeviceParameterBytecodeValidationMode = 0x3,
        [NativeName("Name", "D3D12_DEBUG_DEVICE_PARAMETER_FEATURE_FLAGS")]
        FeatureFlags = 0x0,
        [NativeName("Name", "D3D12_DEBUG_DEVICE_PARAMETER_GPU_BASED_VALIDATION_SETTINGS")]
