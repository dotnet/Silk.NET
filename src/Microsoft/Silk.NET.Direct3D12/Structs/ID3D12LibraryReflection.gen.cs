...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12LibraryReflection
    {
        ...
        public unsafe int QueryInterface(Guid* iid, void** ppv)
        {
            ...
            {
                int ret = default;
                ret = ((delegate* cdecl<ID3D12LibraryReflection*, Guid*, void**, int>)LpVtbl[3])(@this, iid, ppv);
                return ret;
            }
        }
        ...
        public unsafe int QueryInterface(Guid* iid, ref void* ppv)
        {
            fixed (ID3D12LibraryReflection* @this = &this)
            {
                ...
                {
                    ret = ((delegate* cdecl<ID3D12LibraryReflection*, Guid*, void**, int>)LpVtbl[3])(@this, iid, ppvPtr);
                }
                return ret;
            }
        }
        ...
        public unsafe int QueryInterface(ref Guid iid, void** ppv)
        {
            fixed (ID3D12LibraryReflection* @this = &this)
            {
                ...
                {
                    ret = ((delegate* cdecl<ID3D12LibraryReflection*, Guid*, void**, int>)LpVtbl[3])(@this, iidPtr, ppv);
                }
                return ret;
            }
        }
        ...
        public unsafe int QueryInterface(ref Guid iid, ref void* ppv)
        {
            fixed (ID3D12LibraryReflection* @this = &this)
            {
                ...
                fixed (Guid* iidPtr = &iid)
                {
                    fixed (void** ppvPtr = &ppv)
                    {
                        ret = ((delegate* cdecl<ID3D12LibraryReflection*, Guid*, void**, int>)LpVtbl[3])(@this, iidPtr, ppvPtr);
                    }
                }
                return ret;
            }
        ...
        public uint AddRef()
        {
            ...
            {
                uint ret = default;
                ret = ((delegate* cdecl<ID3D12LibraryReflection*, uint>)LpVtbl[4])(@this);
                return ret;
            }
        }
        ...
        public uint Release()
        {
            ...
            {
                uint ret = default;
                ret = ((delegate* cdecl<ID3D12LibraryReflection*, uint>)LpVtbl[5])(@this);
                return ret;
            }
        }
        ...
        public unsafe int GetDesc(LibraryDesc* pDesc)
        {
            ...
            {
                int ret = default;
                ret = ((delegate* cdecl<ID3D12LibraryReflection*, LibraryDesc*, int>)LpVtbl[6])(@this, pDesc);
                return ret;
            }
        }
        ...
        public int GetDesc(ref LibraryDesc pDesc)
        {
            fixed (ID3D12LibraryReflection* @this = &this)
            {
                ...
                {
                    ret = ((delegate* cdecl<ID3D12LibraryReflection*, LibraryDesc*, int>)LpVtbl[6])(@this, pDescPtr);
                }
                return ret;
            }
        }
        ...
        public unsafe ID3D12FunctionReflection* GetFunctionByIndex(int FunctionIndex)
        {
            fixed (ID3D12LibraryReflection* @this = &this)
            {
                ...
                ret = ((delegate* cdecl<ID3D12LibraryReflection*, int, ID3D12FunctionReflection*>)LpVtbl[7])(@this, FunctionIndex);
                return ret;
            }
        }
