...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12Debug5 : IComVtbl<ID3D12Debug5>, IComVtbl<ID3D12Debug4>, IComVtbl<ID3D12Debug3>, IComVtbl<ID3D12Debug>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        {
            var @this = (ID3D12Debug5*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Stdcall]<ID3D12Debug5*, Silk.NET.Core.Bool32, void>)@this->LpVtbl[4])(@this, Enable);
        }
        ...
        {
            var @this = (ID3D12Debug5*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Stdcall]<ID3D12Debug5*, Silk.NET.Core.Bool32, void>)@this->LpVtbl[5])(@this, Enable);
        }
        ...
        {
            var @this = (ID3D12Debug5*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Stdcall]<ID3D12Debug5*, Silk.NET.Core.Bool32, void>)@this->LpVtbl[8])(@this, Enable);
        }
