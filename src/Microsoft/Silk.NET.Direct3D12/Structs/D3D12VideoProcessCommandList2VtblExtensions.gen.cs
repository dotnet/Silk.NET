...
public unsafe static class D3D12VideoProcessCommandList2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D12VideoProcessCommandList2>
    {
        var @this = (ID3D12VideoProcessCommandList2*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetDevice<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D12VideoProcessCommandList2>
    {
        var @this = (ID3D12VideoProcessCommandList2*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
