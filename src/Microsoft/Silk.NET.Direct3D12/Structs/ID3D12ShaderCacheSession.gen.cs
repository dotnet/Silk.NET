...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12ShaderCacheSession : IComVtbl<ID3D12ShaderCacheSession>, IComVtbl<ID3D12DeviceChild>, IComVtbl<ID3D12Object>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindValue<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pKey, uint KeySize, void* pValue, uint* pValueSize) where T0 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindValue<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pKey, uint KeySize, void* pValue, ref uint pValueSize) where T0 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* pKeyPtr = &pKey)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindValue<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pKey, uint KeySize, ref T1 pValue, uint* pValueSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* pKeyPtr = &pKey)
        ...
        /// <summary>To be documented.</summary>
        public readonly int FindValue<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pKey, uint KeySize, ref T1 pValue, ref uint pValueSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* pKeyPtr = &pKey)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int StoreValue<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] void* pKey, uint KeySize, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pValue, uint ValueSize) where T0 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* pValuePtr = &pValue)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int StoreValue<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pKey, uint KeySize, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void* pValue, uint ValueSize) where T0 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* pKeyPtr = &pKey)
        ...
        /// <summary>To be documented.</summary>
        public readonly int StoreValue<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pKey, uint KeySize, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T1 pValue, uint ValueSize) where T0 : unmanaged where T1 : unmanaged
        {
            var @this = (ID3D12ShaderCacheSession*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void* pKeyPtr = &pKey)
