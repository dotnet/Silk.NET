...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12DebugCommandQueue : IComVtbl<ID3D12DebugCommandQueue>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public readonly unsafe bool AssertResourceState(ID3D12Resource* pResource, uint Subresource, uint State)
        {
            var @this = (ID3D12DebugCommandQueue*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            bool ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID3D12DebugCommandQueue*, ID3D12Resource*, uint, uint, bool>)@this->LpVtbl[3])(@this, pResource, Subresource, State);
            return ret;
        }
        ...
        public readonly bool AssertResourceState(ref ID3D12Resource pResource, uint Subresource, uint State)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID3D12DebugCommandQueue*, ID3D12Resource*, uint, uint, bool>)@this->LpVtbl[3])(@this, pResourcePtr, Subresource, State);
            }
            return ret;
        }
