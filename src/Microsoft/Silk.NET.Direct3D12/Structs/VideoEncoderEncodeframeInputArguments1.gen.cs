...
{
    [NativeName("Name", "D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS1")]
    public unsafe partial struct VideoEncoderEncodeframeInputArguments1
    {
        ...
        (
            ...
            VideoEncoderPictureControlDesc1? pictureControlDesc = null,
        ...
        [NativeName("Type", "D3D12_VIDEO_ENCODER_PICTURE_CONTROL_DESC1")]
        [NativeName("Type.Name", "D3D12_VIDEO_ENCODER_PICTURE_CONTROL_DESC1")]
        [NativeName("Name", "PictureControlDesc")]
        public VideoEncoderPictureControlDesc1 PictureControlDesc;
