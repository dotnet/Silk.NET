...
{
    [NativeName("Name", "D3D12_FEATURE_DATA_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_CONFIG")]
    public unsafe partial struct FeatureDataVideoEncoderFrameSubregionLayoutConfig
    {
        public FeatureDataVideoEncoderFrameSubregionLayoutConfig
        (
            uint? nodeIndex = null,
            ...
            VideoEncoderPictureResolutionDesc? frameResolution = null,
            VideoEncoderFrameSubregionLayoutConfigSupport? codecSupport = null,
        ...
        ) : this()
        {
            ...
            if (frameResolution is not null)
            {
                FrameResolution = frameResolution.Value;
            }

            if (codecSupport is not null)
            {
                CodecSupport = codecSupport.Value;
            }
        ...
        [NativeName("Name", "FrameResolution")]
        public VideoEncoderPictureResolutionDesc FrameResolution;

        [NativeName("Type", "D3D12_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_CONFIG_SUPPORT")]
        [NativeName("Type.Name", "D3D12_VIDEO_ENCODER_FRAME_SUBREGION_LAYOUT_CONFIG_SUPPORT")]
        [NativeName("Name", "CodecSupport")]
        public VideoEncoderFrameSubregionLayoutConfigSupport CodecSupport;
