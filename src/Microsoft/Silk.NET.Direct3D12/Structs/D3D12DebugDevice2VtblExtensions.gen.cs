...
public unsafe static class D3D12DebugDevice2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetDebugParameter(this ComPtr<ID3D12DebugDevice2> thisVtbl, DebugDeviceParameterType Type, void* pData, uint DataSize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetDebugParameter<T0>(this ComPtr<ID3D12DebugDevice2> thisVtbl, DebugDeviceParameterType Type, ref T0 pData, uint DataSize) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetDebugParameter<T0>(this ComPtr<ID3D12DebugDevice2> thisVtbl, DebugDeviceParameterType Type, Span<T0> pData, uint DataSize) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
