...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12InfoQueue
    {
        ...
        public readonly unsafe int GetMessageA(ulong MessageIndex, Message* pMessage, ref uint pMessageByteLength)
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, ulong, Message*, uint*, int>)LpVtbl[5])(@this, MessageIndex, pMessage, pMessageByteLengthPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetMessageA(ulong MessageIndex, ref Message pMessage, uint* pMessageByteLength)
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, ulong, Message*, uint*, int>)LpVtbl[5])(@this, MessageIndex, pMessagePtr, pMessageByteLength);
            }
            return ret;
        }
        ...
        public readonly int GetMessageA(ulong MessageIndex, ref Message pMessage, ref uint pMessageByteLength)
        {
            ...
            fixed (Message* pMessagePtr = &pMessage)
            {
                fixed (uint* pMessageByteLengthPtr = &pMessageByteLength)
                {
                    ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, ulong, Message*, uint*, int>)LpVtbl[5])(@this, MessageIndex, pMessagePtr, pMessageByteLengthPtr);
                }
            }
            return ret;
        }
        ...
        public readonly unsafe int GetStorageFilter(InfoQueueFilter* pFilter, ref uint pFilterByteLength)
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, InfoQueueFilter*, uint*, int>)LpVtbl[13])(@this, pFilter, pFilterByteLengthPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetStorageFilter(ref InfoQueueFilter pFilter, uint* pFilterByteLength)
        {
            ...
            fixed (InfoQueueFilter* pFilterPtr = &pFilter)
            {
                ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, InfoQueueFilter*, uint*, int>)LpVtbl[13])(@this, pFilterPtr, pFilterByteLength);
            }
            return ret;
        }
        ...
        public readonly unsafe int GetRetrievalFilter(InfoQueueFilter* pFilter, uint* pFilterByteLength)
        {
            var @this = (ID3D12InfoQueue*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                int ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, InfoQueueFilter*, uint*, int>)LpVtbl[21])(@this, pFilter, pFilterByteLength);
            return ret;
        }
        ...
        public readonly int GetRetrievalFilter(ref InfoQueueFilter pFilter, ref uint pFilterByteLength)
        {
            ...
            fixed (InfoQueueFilter* pFilterPtr = &pFilter)
            {
                fixed (uint* pFilterByteLengthPtr = &pFilterByteLength)
                {
                    ret = ((delegate* unmanaged[Cdecl]<ID3D12InfoQueue*, InfoQueueFilter*, uint*, int>)LpVtbl[21])(@this, pFilterPtr, pFilterByteLengthPtr);
                }
            }
            return ret;
        }
