...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12Debug2
    {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, void** ppvObject)
        {
            ...
            ret = ((delegate* unmanaged<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObject);
            #else
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObject);
            }
            #endif
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
            #if NET5_0_OR_GREATER
                ret = ((delegate* unmanaged<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObjectPtr);
            #else
                if (SilkMarshal.IsWinapiStdcall)
                {
                ...
                {
                    ret = ((delegate* unmanaged[Cdecl]<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riid, ppvObjectPtr);
                }
            #endif
            }
            return ret;
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
            #if NET5_0_OR_GREATER
                ret = ((delegate* unmanaged<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObject);
            #else
                if (SilkMarshal.IsWinapiStdcall)
                {
                ...
                {
                    ret = ((delegate* unmanaged[Cdecl]<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObject);
                }
            #endif
            }
            return ret;
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                ...
                {
            #if NET5_0_OR_GREATER
                    ret = ((delegate* unmanaged<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
            #else
                    if (SilkMarshal.IsWinapiStdcall)
                    {
                    ...
                    {
                        ret = ((delegate* unmanaged[Cdecl]<ID3D12Debug2*, Guid*, void**, int>)LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                    }
            #endif
                }
            }
        ...
        public readonly void SetGPUBasedValidationFlags(GpuBasedValidationFlags Flags)
        {
            var @this = (ID3D12Debug2*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            #if NET5_0_OR_GREATER
            ((delegate* unmanaged<ID3D12Debug2*, GpuBasedValidationFlags, void>)LpVtbl[3])(@this, Flags);
            #else
            if (SilkMarshal.IsWinapiStdcall)
            {
            ...
            {
                ((delegate* unmanaged[Cdecl]<ID3D12Debug2*, GpuBasedValidationFlags, void>)LpVtbl[3])(@this, Flags);
            }
            #endif
        }
