...
{
    [NativeName("Name", "D3D12_VIDEO_ENCODER_PICTURE_CONTROL_CODEC_DATA_HEVC1")]
    public unsafe partial struct VideoEncoderPictureControlCodecDataHevc1
    {
        public VideoEncoderPictureControlCodecDataHevc1
        (
        ...
        [NativeName("Type", "CHAR[6]")]
        [NativeName("Type.Name", "CHAR[6]")]
