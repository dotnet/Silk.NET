...
public unsafe static class D3D12ShaderReflectionTypeVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe ID3D12ShaderReflectionType* GetMemberTypeByName(this ComPtr<ID3D12ShaderReflectionType> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly byte Name)
    {
        var @this = thisVtbl.Handle;
        ID3D12ShaderReflectionType* ret = default;
