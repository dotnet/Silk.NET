...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12Debug
    {
        ...
        public readonly uint AddRef()
        {
            var @this = (ID3D12Debug*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D12Debug*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (ID3D12Debug*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D12Debug*, uint>)LpVtbl[2])(@this);
            return ret;
        }
        ...
        {
            var @this = (ID3D12Debug*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Cdecl]<ID3D12Debug*, void>)LpVtbl[3])(@this);
        }
