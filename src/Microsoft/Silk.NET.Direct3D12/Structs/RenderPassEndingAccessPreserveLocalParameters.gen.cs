...
{
    [NativeName("Name", "D3D12_RENDER_PASS_ENDING_ACCESS_PRESERVE_LOCAL_PARAMETERS")]
    public unsafe partial struct RenderPassEndingAccessPreserveLocalParameters
    {
        public RenderPassEndingAccessPreserveLocalParameters
        (
