...
public unsafe static class D3D12Resource1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int WriteToSubresource<T0>(this ComPtr<ID3D12Resource1> thisVtbl, uint DstSubresource, [Flow(FlowDirection.In)] ReadOnlySpan<Box> pDstBox, [Flow(FlowDirection.In)] Span<T0> pSrcData, uint SrcRowPitch, uint SrcDepthPitch) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static int ReadFromSubresource<T0>(this ComPtr<ID3D12Resource1> thisVtbl, Span<T0> pDstData, uint DstRowPitch, uint DstDepthPitch, uint SrcSubresource, [Flow(FlowDirection.In)] ReadOnlySpan<Box> pSrcBox) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
