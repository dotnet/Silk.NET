...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12DescriptorHeap : IComVtbl<ID3D12DescriptorHeap>, IComVtbl<ID3D12Pageable>, IComVtbl<ID3D12DeviceChild>, IComVtbl<ID3D12Object>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public readonly unsafe int SetName([Flow(FlowDirection.In)] nint* Name)
        {
            var @this = (ID3D12DescriptorHeap*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID3D12DescriptorHeap*, nint*, int>)@this->LpVtbl[6])(@this, Name);
            return ret;
        }
        ...
        public readonly int SetName([Flow(FlowDirection.In)] in nint Name)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID3D12DescriptorHeap*, nint*, int>)@this->LpVtbl[6])(@this, NamePtr);
            }
            return ret;
        }
