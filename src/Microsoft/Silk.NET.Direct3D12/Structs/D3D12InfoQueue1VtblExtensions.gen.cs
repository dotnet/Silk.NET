...
public unsafe static class D3D12InfoQueue1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int AddMessage(this ComPtr<ID3D12InfoQueue1> thisVtbl, MessageCategory Category, MessageSeverity Severity, MessageID ID, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte pDescription)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int AddApplicationMessage(this ComPtr<ID3D12InfoQueue1> thisVtbl, MessageSeverity Severity, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte pDescription)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (byte* pDescriptionPtr = &pDescription)
