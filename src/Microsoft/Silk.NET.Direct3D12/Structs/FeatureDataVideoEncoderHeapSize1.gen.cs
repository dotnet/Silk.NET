...
{
    [NativeName("Name", "D3D12_FEATURE_DATA_VIDEO_ENCODER_HEAP_SIZE1")]
    public unsafe partial struct FeatureDataVideoEncoderHeapSize1
    {
        public FeatureDataVideoEncoderHeapSize1
        (
            VideoEncoderHeapDesc1? heapDesc = null,
        ...
        [NativeName("Type", "D3D12_VIDEO_ENCODER_HEAP_DESC1")]
        [NativeName("Type.Name", "D3D12_VIDEO_ENCODER_HEAP_DESC1")]
        [NativeName("Name", "HeapDesc")]
        public VideoEncoderHeapDesc1 HeapDesc;
