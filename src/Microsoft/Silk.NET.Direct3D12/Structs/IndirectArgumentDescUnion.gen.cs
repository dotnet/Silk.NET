...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct IndirectArgumentDescUnion
    {
        ...
        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at d3d12.h:3953:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at d3d12.h:3953:9)")]
        [NativeName("Name", "VertexBuffer")]
        public IndirectArgumentDescUnionVertexBuffer VertexBuffer;

        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at d3d12.h:3957:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at d3d12.h:3957:9)")]
        [NativeName("Name", "Constant")]
        public IndirectArgumentDescUnionConstant Constant;

        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at d3d12.h:3963:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at d3d12.h:3963:9)")]
        [NativeName("Name", "ConstantBufferView")]
        public IndirectArgumentDescUnionConstantBufferView ConstantBufferView;

        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at d3d12.h:3967:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at d3d12.h:3967:9)")]
        [NativeName("Name", "ShaderResourceView")]
        public IndirectArgumentDescUnionShaderResourceView ShaderResourceView;

        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at d3d12.h:3971:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at d3d12.h:3971:9)")]
