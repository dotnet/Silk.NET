...
public unsafe static class D3D12VideoEncodeCommandList3VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetName(this ComPtr<ID3D12VideoEncodeCommandList3> thisVtbl, [Flow(FlowDirection.In)] nint* Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12VideoEncodeCommandList3> thisVtbl, [Flow(FlowDirection.In)] in nint Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12VideoEncodeCommandList3> thisVtbl, [Flow(FlowDirection.In)] ReadOnlySpan<nint> Name)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
