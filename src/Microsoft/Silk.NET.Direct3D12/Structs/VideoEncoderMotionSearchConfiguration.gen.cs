...
{
    [NativeName("Name", "D3D12_VIDEO_ENCODER_MOTION_SEARCH_CONFIGURATION")]
    public unsafe partial struct VideoEncoderMotionSearchConfiguration
    {
        public VideoEncoderMotionSearchConfiguration
        (
