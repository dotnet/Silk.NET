...
public unsafe static class D3D12VideoEncodeCommandList2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetName(this ComPtr<ID3D12VideoEncodeCommandList2> thisVtbl, [Flow(FlowDirection.In)] char* Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12VideoEncodeCommandList2> thisVtbl, [Flow(FlowDirection.In)] in char Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12VideoEncodeCommandList2> thisVtbl, [Flow(FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPWStr)] string Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12VideoEncodeCommandList2> thisVtbl, [Flow(FlowDirection.In)] ReadOnlySpan<char> Name)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void InitializeExtensionCommand<T0>(this ComPtr<ID3D12VideoEncodeCommandList2> thisVtbl, Span<ID3D12VideoExtensionCommand> pExtensionCommand, [Flow(FlowDirection.In)] Span<T0> pInitializationParameters, nuint InitializationParametersSizeInBytes) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static void ExecuteExtensionCommand<T0>(this ComPtr<ID3D12VideoEncodeCommandList2> thisVtbl, Span<ID3D12VideoExtensionCommand> pExtensionCommand, [Flow(FlowDirection.In)] Span<T0> pExecutionParameters, nuint ExecutionParametersSizeInBytes) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
