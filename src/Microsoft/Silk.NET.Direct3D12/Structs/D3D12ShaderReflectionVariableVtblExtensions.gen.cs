...
public unsafe static class D3D12ShaderReflectionVariableVtblExtensions
{
    ...
    public static unsafe int GetDesc<TThis>(this TThis thisVtbl, ShaderVariableDesc* pDesc) where TThis : IComVtbl<ID3D12ShaderReflectionVariable>
    {
    ...
    /// <summary>To be documented.</summary>
    public static int GetDesc<TThis>(this TThis thisVtbl, ref ShaderVariableDesc pDesc) where TThis : IComVtbl<ID3D12ShaderReflectionVariable>
    {
        var @this = (ID3D12ShaderReflectionVariable*) thisVtbl.AsVtblPtr();
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe ID3D12ShaderReflectionType* GetType<TThis>(this TThis thisVtbl) where TThis : IComVtbl<ID3D12ShaderReflectionVariable>
    {
        var @this = (ID3D12ShaderReflectionVariable*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static unsafe ID3D12ShaderReflectionConstantBuffer* GetBuffer<TThis>(this TThis thisVtbl) where TThis : IComVtbl<ID3D12ShaderReflectionVariable>
    {
        var @this = (ID3D12ShaderReflectionVariable*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static uint GetInterfaceSlot<TThis>(this TThis thisVtbl, uint uArrayIndex) where TThis : IComVtbl<ID3D12ShaderReflectionVariable>
    {
        var @this = (ID3D12ShaderReflectionVariable*) thisVtbl.AsVtblPtr();
        uint ret = default;
