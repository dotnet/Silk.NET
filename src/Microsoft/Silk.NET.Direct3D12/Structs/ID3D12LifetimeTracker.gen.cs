...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12LifetimeTracker : IComVtbl<ID3D12LifetimeTracker>, IComVtbl<ID3D12DeviceChild>, IComVtbl<ID3D12Object>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int DestroyOwnedObject<TI0>(ComPtr<TI0> pObject) where TI0 : unmanaged, IComVtbl<ID3D12DeviceChild>, IComVtbl<TI0>
        {
            var @this = (ID3D12LifetimeTracker*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
