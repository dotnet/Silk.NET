...
{
    [NativeName("Name", "D3D12_DRED_PAGE_FAULT_OUTPUT2")]
    public unsafe partial struct DredPageFaultOutput2
    {
        ...
        [NativeName("Type", "D3D12_DRED_PAGE_FAULT_FLAGS")]
        [NativeName("Type.Name", "D3D12_DRED_PAGE_FAULT_FLAGS")]
        [NativeName("Name", "PageFaultFlags")]
