...
public unsafe static class D3D12ShaderCacheSessionVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetName(this ComPtr<ID3D12ShaderCacheSession> thisVtbl, [Flow(FlowDirection.In)] nint* Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<ID3D12ShaderCacheSession*, nint*, int>)@this->LpVtbl[6])(@this, Name);
        return ret;
    }

    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12ShaderCacheSession> thisVtbl, [Flow(FlowDirection.In)] in nint Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (nint* NamePtr = &Name)
        {
            ret = ((delegate* unmanaged[Stdcall]<ID3D12ShaderCacheSession*, nint*, int>)@this->LpVtbl[6])(@this, NamePtr);
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12ShaderCacheSession> thisVtbl, [Flow(FlowDirection.In)] ReadOnlySpan<nint> Name)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
