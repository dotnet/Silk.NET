...
{
    [NativeName("Name", "D3D12_FEATURE_DATA_VIDEO_ENCODER_SUPPORT2")]
    public unsafe partial struct FeatureDataVideoEncoderSupport2
    {
        public FeatureDataVideoEncoderSupport2
        (
            uint? nodeIndex = null,
            ...
            FeatureDataVideoEncoderResolutionSupportLimits1* pResolutionDependentSupport = null,
            ...
            VideoEncoderFrameAnalysisConfiguration? frameAnalysis = null
        ) : this()
        {
        ...
        [NativeName("Type", "D3D12_FEATURE_DATA_VIDEO_ENCODER_RESOLUTION_SUPPORT_LIMITS1 *")]
        [NativeName("Type.Name", "D3D12_FEATURE_DATA_VIDEO_ENCODER_RESOLUTION_SUPPORT_LIMITS1 *")]
        [NativeName("Name", "pResolutionDependentSupport")]
        public FeatureDataVideoEncoderResolutionSupportLimits1* PResolutionDependentSupport;
        ...
        [NativeName("Type", "D3D12_VIDEO_ENCODER_FRAME_ANALYSIS_CONFIGURATION")]
        [NativeName("Type.Name", "D3D12_VIDEO_ENCODER_FRAME_ANALYSIS_CONFIGURATION")]
        [NativeName("Name", "FrameAnalysis")]
        public VideoEncoderFrameAnalysisConfiguration FrameAnalysis;
    }
}
