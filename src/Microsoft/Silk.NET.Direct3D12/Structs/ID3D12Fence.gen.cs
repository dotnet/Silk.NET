...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12Fence : IComVtbl<ID3D12Fence>, IComVtbl<ID3D12Pageable>, IComVtbl<ID3D12DeviceChild>, IComVtbl<ID3D12Object>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int SetEventOnCompletion(ulong Value, ref nint hEvent)
        {
            var @this = (ID3D12Fence*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
