...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12GraphicsCommandList10 : IComVtbl<ID3D12GraphicsCommandList10>, IComVtbl<ID3D12GraphicsCommandList9>, IComVtbl<ID3D12GraphicsCommandList8>, IComVtbl<ID3D12GraphicsCommandList7>, IComVtbl<ID3D12GraphicsCommandList6>, IComVtbl<ID3D12GraphicsCommandList5>, IComVtbl<ID3D12GraphicsCommandList4>, IComVtbl<ID3D12GraphicsCommandList3>, IComVtbl<ID3D12GraphicsCommandList2>, IComVtbl<ID3D12GraphicsCommandList1>, IComVtbl<ID3D12GraphicsCommandList>, IComVtbl<ID3D12CommandList>, IComVtbl<ID3D12DeviceChild>, IComVtbl<ID3D12Object>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly void SetProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SetProgramDesc pDesc)
        {
            var @this = (ID3D12GraphicsCommandList10*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
        ...
        /// <summary>To be documented.</summary>
        public readonly void DispatchGraph([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly DispatchGraphDesc pDesc)
        {
            var @this = (ID3D12GraphicsCommandList10*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
