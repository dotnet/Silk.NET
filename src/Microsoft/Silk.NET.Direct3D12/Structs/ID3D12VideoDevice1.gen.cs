...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12VideoDevice1
    {
        ...
        public readonly uint AddRef()
        {
            var @this = (ID3D12VideoDevice1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D12VideoDevice1*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (ID3D12VideoDevice1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D12VideoDevice1*, uint>)LpVtbl[2])(@this);
            return ret;
        }
        ...
        public readonly int CheckFeatureSupport<T0>(FeatureVideo FeatureVideo, ref T0 pFeatureSupportData, uint FeatureSupportDataSize) where T0 : unmanaged
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<ID3D12VideoDevice1*, FeatureVideo, T0*, uint, int>)LpVtbl[3])(@this, FeatureVideo, pFeatureSupportDataPtr, FeatureSupportDataSize);
            }
            return ret;
        }
