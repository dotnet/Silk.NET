...
public unsafe static class D3D12DebugVtblExtensions
{
    ...
    public static unsafe int QueryInterface(this ComPtr<ID3D12Debug> thisVtbl, Guid* riid, void** ppvObject)
    {
    ...
    /// <summary>To be documented.</summary>
    public static uint AddRef(this ComPtr<ID3D12Debug> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        uint ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static uint Release(this ComPtr<ID3D12Debug> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        uint ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static void EnableDebugLayer(this ComPtr<ID3D12Debug> thisVtbl)
    {
        var @this = thisVtbl.Handle;
