...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12VideoEncodeCommandList : IComVtbl<ID3D12VideoEncodeCommandList>, IComVtbl<ID3D12CommandList>, IComVtbl<ID3D12DeviceChild>, IComVtbl<ID3D12Object>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public readonly unsafe int SetName([Flow(FlowDirection.In)] nint* Name)
        {
            var @this = (ID3D12VideoEncodeCommandList*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoEncodeCommandList*, nint*, int>)@this->LpVtbl[6])(@this, Name);
            return ret;
        }
        ...
        public readonly int SetName([Flow(FlowDirection.In)] in nint Name)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID3D12VideoEncodeCommandList*, nint*, int>)@this->LpVtbl[6])(@this, NamePtr);
            }
            return ret;
        }
