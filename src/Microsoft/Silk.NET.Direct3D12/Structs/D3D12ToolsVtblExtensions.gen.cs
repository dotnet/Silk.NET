...
public unsafe static class D3D12ToolsVtblExtensions
{
    ...
    public static unsafe int QueryInterface(this ComPtr<ID3D12Tools> thisVtbl, Guid* riid, ref void* ppvObject)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<ID3D12Tools*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riid, ppvObjectPtr);
        }
        return ret;
    }
    ...
    public static unsafe int QueryInterface(this ComPtr<ID3D12Tools> thisVtbl, ref Guid riid, void** ppvObject)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<ID3D12Tools*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObject);
        }
        return ret;
    }
    ...
    public static unsafe int QueryInterface(this ComPtr<ID3D12Tools> thisVtbl, ref Guid riid, ref void* ppvObject)
    {
        ...
        fixed (Guid* riidPtr = &riid)
        {
            fixed (void** ppvObjectPtr = &ppvObject)
            {
                ret = ((delegate* unmanaged[Stdcall]<ID3D12Tools*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
            }
        }
        return ret;
    }
    ...
    /// <summary>To be documented.</summary>
    public static void EnableShaderInstrumentation(this ComPtr<ID3D12Tools> thisVtbl, Silk.NET.Core.Bool32 bEnable)
    {
        var @this = thisVtbl.Handle;
        ((delegate* unmanaged[Stdcall]<ID3D12Tools*, Silk.NET.Core.Bool32, void>)@this->LpVtbl[3])(@this, bEnable);
    }

    /// <summary>To be documented.</summary>
    public static Silk.NET.Core.Bool32 ShaderInstrumentationEnabled(this ComPtr<ID3D12Tools> thisVtbl)
    {
        var @this = thisVtbl.Handle;
        Silk.NET.Core.Bool32 ret = default;
        ret = ((delegate* unmanaged[Stdcall]<ID3D12Tools*, Silk.NET.Core.Bool32>)@this->LpVtbl[4])(@this);
        return ret;
    }
