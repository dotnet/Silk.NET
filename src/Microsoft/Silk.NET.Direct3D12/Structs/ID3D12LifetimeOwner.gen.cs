...
namespace Silk.NET.Direct3D12
{
    ...
    public unsafe partial struct ID3D12LifetimeOwner : IComVtbl<ID3D12LifetimeOwner>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public readonly unsafe int QueryInterface(Guid* riid, ref void* ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID3D12LifetimeOwner*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riid, ppvObjectPtr);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, void** ppvObject)
        {
            ...
            {
                ret = ((delegate* unmanaged[Stdcall]<ID3D12LifetimeOwner*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObject);
            }
            return ret;
        }
        ...
        public readonly unsafe int QueryInterface(ref Guid riid, ref void* ppvObject)
        {
            ...
            fixed (Guid* riidPtr = &riid)
            {
                fixed (void** ppvObjectPtr = &ppvObject)
                {
                    ret = ((delegate* unmanaged[Stdcall]<ID3D12LifetimeOwner*, Guid*, void**, int>)@this->LpVtbl[0])(@this, riidPtr, ppvObjectPtr);
                }
            }
            return ret;
        }
