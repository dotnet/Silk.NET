...
public unsafe static class D3D12VideoDecodeCommandListVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int QueryInterface<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppvObject) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D12VideoDecodeCommandList>
    {
        var @this = (ID3D12VideoDecodeCommandList*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppvObject = default;
    ...
    /// <summary>To be documented.</summary>
    public static int GetDevice<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppvDevice) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D12VideoDecodeCommandList>
    {
        var @this = (ID3D12VideoDecodeCommandList*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppvDevice = default;
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D12VideoDecodeCommandList>
    {
        var @this = (ID3D12VideoDecodeCommandList*) thisVtbl.AsVtblPtr();
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> GetDevice<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D12VideoDecodeCommandList>
    {
        var @this = (ID3D12VideoDecodeCommandList*) thisVtbl.AsVtblPtr();
        // NonKhrReturnTypeOverloader
