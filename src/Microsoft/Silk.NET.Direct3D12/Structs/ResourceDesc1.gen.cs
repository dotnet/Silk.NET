...
{
    [NativeName("Name", "D3D12_RESOURCE_DESC1")]
    public unsafe partial struct ResourceDesc1
    {
        public ResourceDesc1
        (
            ...
            MipRegion? samplerFeedbackMipRegion = null
        ) : this()
        {
            ...
            if (samplerFeedbackMipRegion is not null)
            {
                SamplerFeedbackMipRegion = samplerFeedbackMipRegion.Value;
            }
        }
        ...
        [NativeName("Type", "D3D12_MIP_REGION")]
        [NativeName("Type.Name", "D3D12_MIP_REGION")]
        [NativeName("Name", "SamplerFeedbackMipRegion")]
