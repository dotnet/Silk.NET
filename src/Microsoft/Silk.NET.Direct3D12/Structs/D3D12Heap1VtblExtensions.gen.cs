...
public unsafe static class D3D12Heap1VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetName(this ComPtr<ID3D12Heap1> thisVtbl, [Flow(FlowDirection.In)] char* Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12Heap1> thisVtbl, [Flow(FlowDirection.In)] in char Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12Heap1> thisVtbl, [Flow(FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPWStr)] string Name)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetName(this ComPtr<ID3D12Heap1> thisVtbl, [Flow(FlowDirection.In)] ReadOnlySpan<char> Name)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
