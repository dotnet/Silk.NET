...
namespace Silk.NET.XAudio
{
    public unsafe partial class XAudioFX : NativeAPI
    {
        ...
        [NativeName("Src", "Line 68, Column 18 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um\\xaudio2fx.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 69, Column 18 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um\\xaudio2fx.h")]
