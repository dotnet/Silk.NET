...
namespace Silk.NET.XAudio
{
    public unsafe partial class XAudio : NativeAPI
    {
        ...
        public unsafe partial int CreateWithVersionInfo(IXAudio2** ppXAudio2, uint Flags, uint XAudio2Processor, int ntddiVersion);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1273, Column 16 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um\\xaudio2.h")]
        [NativeApi(EntryPoint = "XAudio2CreateWithVersionInfo", Convention = CallingConvention.StdCall)]
        public unsafe partial int CreateWithVersionInfo(ref IXAudio2* ppXAudio2, uint Flags, uint XAudio2Processor, int ntddiVersion);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 1273, Column 16 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.22621.0/um\\xaudio2.h")]
        public unsafe int CreateWithVersionInfo<TI0>(ref ComPtr<TI0> ppXAudio2, uint Flags, uint XAudio2Processor, int ntddiVersion) where TI0 : unmanaged, IComVtbl<IXAudio2>, IComVtbl<TI0>
        {
            // ComPtrOverloader
