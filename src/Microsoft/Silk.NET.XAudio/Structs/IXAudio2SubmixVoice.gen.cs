...
namespace Silk.NET.XAudio
{
    ...
    public unsafe partial struct IXAudio2SubmixVoice
    {
        ...
        {
            fixed (IXAudio2SubmixVoice* @this = &this)
            {
        ...
        public readonly int SetEffectParameters<T0>(uint EffectIndex, ref T0 pParameters, uint ParametersByteSize, uint OperationSet) where T0 : unmanaged
        {
            ...
            {
                ret = ((delegate* unmanaged[Cdecl]<IXAudio2SubmixVoice*, uint, T0*, uint, uint, int>)LpVtbl[6])(@this, EffectIndex, pParametersPtr, ParametersByteSize, OperationSet);
            }
            return ret;
        }
        ...
        public readonly int GetEffectParameters<T0>(uint EffectIndex, ref T0 pParameters, uint ParametersByteSize) where T0 : unmanaged
        {
            ...
            fixed (T0* pParametersPtr = &pParameters)
            {
                ret = ((delegate* unmanaged[Cdecl]<IXAudio2SubmixVoice*, uint, T0*, uint, int>)LpVtbl[7])(@this, EffectIndex, pParametersPtr, ParametersByteSize);
            }
            return ret;
        }
        ...
        {
            var @this = (IXAudio2SubmixVoice*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            ((delegate* unmanaged[Cdecl]<IXAudio2SubmixVoice*, void>)LpVtbl[18])(@this);
        }
