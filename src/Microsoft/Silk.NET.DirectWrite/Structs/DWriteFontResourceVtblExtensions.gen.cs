...
public unsafe static class DWriteFontResourceVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateFontFace(this ComPtr<IDWriteFontResource> thisVtbl, FontSimulations fontSimulations, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue fontAxisValues, uint fontAxisValueCount, IDWriteFontFace5** fontFace)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (FontAxisValue* fontAxisValuesPtr = &fontAxisValues)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateFontFace(this ComPtr<IDWriteFontResource> thisVtbl, FontSimulations fontSimulations, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue fontAxisValues, uint fontAxisValueCount, ref IDWriteFontFace5* fontFace)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (FontAxisValue* fontAxisValuesPtr = &fontAxisValues)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateFontFaceReference(this ComPtr<IDWriteFontResource> thisVtbl, FontSimulations fontSimulations, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue fontAxisValues, uint fontAxisValueCount, IDWriteFontFaceReference1** fontFaceReference)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (FontAxisValue* fontAxisValuesPtr = &fontAxisValues)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateFontFaceReference(this ComPtr<IDWriteFontResource> thisVtbl, FontSimulations fontSimulations, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue fontAxisValues, uint fontAxisValueCount, ref IDWriteFontFaceReference1* fontFaceReference)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (FontAxisValue* fontAxisValuesPtr = &fontAxisValues)
    ...
    /// <summary>To be documented.</summary>
    public static int CreateFontFace<TI0>(this ComPtr<IDWriteFontResource> thisVtbl, FontSimulations fontSimulations, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in FontAxisValue fontAxisValues, uint fontAxisValueCount, ref ComPtr<TI0> fontFace) where TI0 : unmanaged, IComVtbl<IDWriteFontFace5>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
