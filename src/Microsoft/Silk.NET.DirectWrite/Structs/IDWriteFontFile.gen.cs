...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteFontFile : IComVtbl<IDWriteFontFile>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetReferenceKey([Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fontFileReferenceKey, uint* fontFileReferenceKeySize)
        {
            var @this = (IDWriteFontFile*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetReferenceKey([Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* fontFileReferenceKey, ref uint fontFileReferenceKeySize)
        {
            var @this = (IDWriteFontFile*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (void** fontFileReferenceKeyPtr = &fontFileReferenceKey)
