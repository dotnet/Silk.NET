...
public unsafe static class DWriteFontCollectionLoaderVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateEnumeratorFromKey<T0>(this ComPtr<IDWriteFontCollectionLoader> thisVtbl, IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, IDWriteFontFileEnumerator** fontFileEnumerator) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateEnumeratorFromKey<T0>(this ComPtr<IDWriteFontCollectionLoader> thisVtbl, IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref IDWriteFontFileEnumerator* fontFileEnumerator) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* collectionKeyPtr = &collectionKey)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateEnumeratorFromKey<T0>(this ComPtr<IDWriteFontCollectionLoader> thisVtbl, ref IDWriteFactory factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, IDWriteFontFileEnumerator** fontFileEnumerator) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (IDWriteFactory* factoryPtr = &factory)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateEnumeratorFromKey<T0>(this ComPtr<IDWriteFontCollectionLoader> thisVtbl, ref IDWriteFactory factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref IDWriteFontFileEnumerator* fontFileEnumerator) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (IDWriteFactory* factoryPtr = &factory)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateEnumeratorFromKey<T0, TI0>(this ComPtr<IDWriteFontCollectionLoader> thisVtbl, ComPtr<TI0> factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 collectionKey, uint collectionKeySize, ref IDWriteFontFileEnumerator* fontFileEnumerator) where T0 : unmanaged where TI0 : unmanaged, IComVtbl<IDWriteFactory>, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
