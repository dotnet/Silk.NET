...
public unsafe static class DWriteFontSetBuilderVtblExtensions
{
    ...
    public static unsafe int AddFontFaceReference(this ComPtr<IDWriteFontSetBuilder> thisVtbl, IDWriteFontFaceReference* fontFaceReference)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDWriteFontSetBuilder*, IDWriteFontFaceReference*, int>)@this->LpVtbl[3])(@this, fontFaceReference);
        return ret;
    }
    ...
    public static int AddFontFaceReference(this ComPtr<IDWriteFontSetBuilder> thisVtbl, ref IDWriteFontFaceReference fontFaceReference)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDWriteFontSetBuilder*, IDWriteFontFaceReference*, int>)@this->LpVtbl[3])(@this, fontFaceReferencePtr);
        }
        return ret;
    }
    ...
    public static unsafe int AddFontSet(this ComPtr<IDWriteFontSetBuilder> thisVtbl, IDWriteFontSet* fontSet)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        ret = ((delegate* unmanaged[Stdcall]<IDWriteFontSetBuilder*, IDWriteFontSet*, int>)@this->LpVtbl[4])(@this, fontSet);
        return ret;
    }
    ...
    public static int AddFontSet(this ComPtr<IDWriteFontSetBuilder> thisVtbl, ref IDWriteFontSet fontSet)
    {
        ...
        {
            ret = ((delegate* unmanaged[Stdcall]<IDWriteFontSetBuilder*, IDWriteFontSet*, int>)@this->LpVtbl[4])(@this, fontSetPtr);
        }
        return ret;
    }
