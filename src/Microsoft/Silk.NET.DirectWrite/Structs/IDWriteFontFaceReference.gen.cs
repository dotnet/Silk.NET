...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteFontFaceReference : IComVtbl<IDWriteFontFaceReference>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int EnqueueCharacterDownloadRequest([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char characters, uint characterCount)
        {
            var @this = (IDWriteFontFaceReference*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int EnqueueGlyphDownloadRequest([Flow(Silk.NET.Core.Native.FlowDirection.In)] in ushort glyphIndices, uint glyphCount)
        {
            var @this = (IDWriteFontFaceReference*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
