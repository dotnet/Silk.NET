...
namespace Silk.NET.DirectWrite
{
    ...
    [NativeName("Name", "IDWriteTextFormat1")]
    public unsafe partial struct IDWriteTextFormat1 : IComVtbl<IDWriteTextFormat1>, IComVtbl<IDWriteTextFormat>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("5f174b49-0d8b-4cfb-8bca-f1cce9d06c67");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IDWriteTextFormat(IDWriteTextFormat1 val)
            => Unsafe.As<IDWriteTextFormat1, IDWriteTextFormat>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IDWriteTextFormat1 val)
            => Unsafe.As<IDWriteTextFormat1, Silk.NET.Core.Native.IUnknown>(ref val);
