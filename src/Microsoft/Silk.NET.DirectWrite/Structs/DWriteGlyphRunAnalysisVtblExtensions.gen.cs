...
public unsafe static class DWriteGlyphRunAnalysisVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateAlphaTexture(this ComPtr<IDWriteGlyphRunAnalysis> thisVtbl, TextureType textureType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Box2D<int> textureBounds, byte* alphaValues, uint bufferSize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Silk.NET.Maths.Box2D<int>* textureBoundsPtr = &textureBounds)
    ...
    /// <summary>To be documented.</summary>
    public static int CreateAlphaTexture(this ComPtr<IDWriteGlyphRunAnalysis> thisVtbl, TextureType textureType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Box2D<int> textureBounds, ref byte alphaValues, uint bufferSize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Silk.NET.Maths.Box2D<int>* textureBoundsPtr = &textureBounds)
    ...
    /// <summary>To be documented.</summary>
    public static int CreateAlphaTexture(this ComPtr<IDWriteGlyphRunAnalysis> thisVtbl, TextureType textureType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Box2D<int> textureBounds, [UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string alphaValues, uint bufferSize)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Silk.NET.Maths.Box2D<int>* textureBoundsPtr = &textureBounds)
