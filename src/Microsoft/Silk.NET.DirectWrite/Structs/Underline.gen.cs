...
namespace Silk.NET.DirectWrite
{
    ...
    [NativeName("Name", "DWRITE_UNDERLINE")]
    public unsafe partial struct Underline
    {
        public Underline
        (
            float? width = null,
        ...
        ) : this()
        {
            ...
            if (runHeight is not null)
            {
                RunHeight = runHeight.Value;
            }
