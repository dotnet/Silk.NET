...
public unsafe static class DWriteInMemoryFontFileLoaderVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateStreamFromKey<T0>(this ComPtr<IDWriteInMemoryFontFileLoader> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 fontFileReferenceKey, uint fontFileReferenceKeySize, IDWriteFontFileStream** fontFileStream) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateStreamFromKey<T0>(this ComPtr<IDWriteInMemoryFontFileLoader> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 fontFileReferenceKey, uint fontFileReferenceKeySize, ref IDWriteFontFileStream* fontFileStream) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* fontFileReferenceKeyPtr = &fontFileReferenceKey)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateInMemoryFontFileReference<T0>(this ComPtr<IDWriteInMemoryFontFileLoader> thisVtbl, IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 fontData, uint fontDataSize, Silk.NET.Core.Native.IUnknown* ownerObject, IDWriteFontFile** fontFile) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateInMemoryFontFileReference<T0>(this ComPtr<IDWriteInMemoryFontFileLoader> thisVtbl, IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 fontData, uint fontDataSize, Silk.NET.Core.Native.IUnknown* ownerObject, ref IDWriteFontFile* fontFile) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* fontDataPtr = &fontData)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateInMemoryFontFileReference<T0>(this ComPtr<IDWriteInMemoryFontFileLoader> thisVtbl, IDWriteFactory* factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 fontData, uint fontDataSize, ref Silk.NET.Core.Native.IUnknown ownerObject, IDWriteFontFile** fontFile) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* fontDataPtr = &fontData)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int CreateInMemoryFontFileReference<T0>(this ComPtr<IDWriteInMemoryFontFileLoader> thisVtbl, ref IDWriteFactory factory, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 fontData, uint fontDataSize, Silk.NET.Core.Native.IUnknown* ownerObject, IDWriteFontFile** fontFile) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (IDWriteFactory* factoryPtr = &factory)
