...
namespace Silk.NET.DirectWrite
{
    ...
    public unsafe partial struct IDWriteGlyphRunAnalysis : IComVtbl<IDWriteGlyphRunAnalysis>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int CreateAlphaTexture(TextureType textureType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Box2D<int> textureBounds, byte* alphaValues, uint bufferSize)
        {
            var @this = (IDWriteGlyphRunAnalysis*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Silk.NET.Maths.Box2D<int>* textureBoundsPtr = &textureBounds)
        ...
        /// <summary>To be documented.</summary>
        public readonly int CreateAlphaTexture(TextureType textureType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Box2D<int> textureBounds, ref byte alphaValues, uint bufferSize)
        {
            var @this = (IDWriteGlyphRunAnalysis*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Silk.NET.Maths.Box2D<int>* textureBoundsPtr = &textureBounds)
        ...
        /// <summary>To be documented.</summary>
        public readonly int CreateAlphaTexture(TextureType textureType, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in Silk.NET.Maths.Box2D<int> textureBounds, [UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string alphaValues, uint bufferSize)
        {
            var @this = (IDWriteGlyphRunAnalysis*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Silk.NET.Maths.Box2D<int>* textureBoundsPtr = &textureBounds)
