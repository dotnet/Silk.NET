...
public unsafe static class DWriteFontFaceReferenceVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int EnqueueCharacterDownloadRequest(this ComPtr<IDWriteFontFaceReference> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char characters, uint characterCount)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int EnqueueGlyphDownloadRequest(this ComPtr<IDWriteFontFaceReference> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ushort glyphIndices, uint glyphCount)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
