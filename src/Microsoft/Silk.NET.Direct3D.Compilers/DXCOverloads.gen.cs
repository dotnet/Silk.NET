...
namespace Silk.NET.Direct3D.Compilers
{
    public static class DXCOverloads
    {
        ...
        [NativeName("Src", "Line 76, Column 34 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um\\dxcapi.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 83, Column 34 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/um\\dxcapi.h")]
