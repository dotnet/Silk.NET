...
public unsafe static class DxcVersionInfo2VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int QueryInterface<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppvObject) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<IDxcVersionInfo2>
    {
        var @this = (IDxcVersionInfo2*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppvObject = default;
