...
namespace Silk.NET.Direct3D11
{
    public unsafe partial class D3D11 : NativeAPI
    {
        ...
        [NativeName("Src", "Line 571, Column 1 in d3d11shadertracing.h")]
        [NativeApi(EntryPoint = "D3DDisassemble11Trace", Convention = CallingConvention.StdCall)]
        public unsafe partial int D3DDisassemble11Trace<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pSrcData, nuint SrcDataSize, ID3D11ShaderTrace* pTrace, uint StartStep, uint NumSteps, uint Flags, Silk.NET.Core.Native.ID3D10Blob** ppDisassembly) where T0 : unmanaged;

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 571, Column 1 in d3d11shadertracing.h")]
        [NativeApi(EntryPoint = "D3DDisassemble11Trace", Convention = CallingConvention.StdCall)]
        public unsafe partial int D3DDisassemble11Trace<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pSrcData, nuint SrcDataSize, ID3D11ShaderTrace* pTrace, uint StartStep, uint NumSteps, uint Flags, ref Silk.NET.Core.Native.ID3D10Blob* ppDisassembly) where T0 : unmanaged;

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 571, Column 1 in d3d11shadertracing.h")]
        [NativeApi(EntryPoint = "D3DDisassemble11Trace", Convention = CallingConvention.StdCall)]
        public unsafe partial int D3DDisassemble11Trace<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pSrcData, nuint SrcDataSize, ref ID3D11ShaderTrace pTrace, uint StartStep, uint NumSteps, uint Flags, Silk.NET.Core.Native.ID3D10Blob** ppDisassembly) where T0 : unmanaged;

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 571, Column 1 in d3d11shadertracing.h")]
        [NativeApi(EntryPoint = "D3DDisassemble11Trace", Convention = CallingConvention.StdCall)]
        public unsafe partial int D3DDisassemble11Trace<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pSrcData, nuint SrcDataSize, ref ID3D11ShaderTrace pTrace, uint StartStep, uint NumSteps, uint Flags, ref Silk.NET.Core.Native.ID3D10Blob* ppDisassembly) where T0 : unmanaged;
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 571, Column 1 in d3d11shadertracing.h")]
        public unsafe int D3DDisassemble11Trace<T0, TI0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pSrcData, nuint SrcDataSize, ref ID3D11ShaderTrace pTrace, uint StartStep, uint NumSteps, uint Flags, ref ComPtr<TI0> ppDisassembly) where T0 : unmanaged where TI0 : unmanaged, IComVtbl<Silk.NET.Core.Native.ID3D10Blob>, IComVtbl<TI0>
        {
            // ComPtrOverloader
