...
namespace Silk.NET.Direct3D11
{
    public static class D3D11Overloads
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 146, Column 16 in d3d11on12.h")]
        public static unsafe int On12CreateDevice(this D3D11 thisApi, Span<Silk.NET.Core.Native.IUnknown> pDevice, uint Flags, [Flow(FlowDirection.In)] Silk.NET.Core.Native.D3DFeatureLevel* pFeatureLevels, uint FeatureLevels, [Flow(FlowDirection.In)] Silk.NET.Core.Native.IUnknown** ppCommandQueues, uint NumQueues, uint NodeMask, ID3D11Device** ppDevice, ID3D11DeviceContext** ppImmediateContext, Silk.NET.Core.Native.D3DFeatureLevel* pChosenFeatureLevel)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 15115, Column 16 in d3d11.h")]
        public static unsafe int CreateDeviceAndSwapChain(this D3D11 thisApi, Silk.NET.DXGI.IDXGIAdapter* pAdapter, Silk.NET.Core.Native.D3DDriverType DriverType, nint Software, uint Flags, [Flow(FlowDirection.In)] Silk.NET.Core.Native.D3DFeatureLevel* pFeatureLevels, uint FeatureLevels, uint SDKVersion, [Flow(FlowDirection.In)] ReadOnlySpan<Silk.NET.DXGI.SwapChainDesc> pSwapChainDesc, Silk.NET.DXGI.IDXGISwapChain** ppSwapChain, ID3D11Device** ppDevice, Silk.NET.Core.Native.D3DFeatureLevel* pFeatureLevel, ID3D11DeviceContext** ppImmediateContext)
        {
            // SpanOverloader
