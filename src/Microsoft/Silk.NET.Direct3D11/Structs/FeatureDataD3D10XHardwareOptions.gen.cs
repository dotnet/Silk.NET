...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct FeatureDataD3D10XHardwareOptions
    {
        ...
        (
            Silk.NET.Core.Miscellaneous.Bool32? computeShadersPlusRawAndStructuredBuffersViaShader4X = null
        ) : this()
        {
        ...
        public Silk.NET.Core.Miscellaneous.Bool32 ComputeShadersPlusRawAndStructuredBuffersViaShader4X;
    }
}
