...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct ID3D11Counter : IComVtbl<ID3D11Counter>, IComVtbl<ID3D11Asynchronous>, IComVtbl<ID3D11DeviceChild>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
