...
public unsafe static class D3D11VideoProcessorEnumeratorVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetPrivateData<T0>(this ComPtr<ID3D11VideoProcessorEnumerator> thisVtbl, Guid* guid, Span<uint> pDataSize, Span<T0> pData) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int GetPrivateData<T0>(this ComPtr<ID3D11VideoProcessorEnumerator> thisVtbl, Span<Guid> guid, uint* pDataSize, Span<T0> pData) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        fixed (void* pDataSpp = pData)
    ...
    /// <summary>To be documented.</summary>
    public static int GetPrivateData<T0>(this ComPtr<ID3D11VideoProcessorEnumerator> thisVtbl, Span<Guid> guid, Span<uint> pDataSize, Span<T0> pData) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        fixed (void* pDataSpp = pData)
    ...
    /// <summary>To be documented.</summary>
    public static int SetPrivateData<T0>(this ComPtr<ID3D11VideoProcessorEnumerator> thisVtbl, Span<Guid> guid, uint DataSize, [Flow(FlowDirection.In)] Span<T0> pData) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
