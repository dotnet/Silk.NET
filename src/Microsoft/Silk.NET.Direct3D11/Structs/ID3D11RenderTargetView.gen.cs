...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct ID3D11RenderTargetView : IComVtbl<ID3D11RenderTargetView>, IComVtbl<ID3D11View>, IComVtbl<ID3D11DeviceChild>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
