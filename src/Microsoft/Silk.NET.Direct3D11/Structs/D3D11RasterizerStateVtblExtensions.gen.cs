...
public unsafe static class D3D11RasterizerStateVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int QueryInterface<TI0, TThis>(this TThis thisVtbl, out ComPtr<TI0> ppvObject) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D11RasterizerState>
    {
        var @this = (ID3D11RasterizerState*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
        ppvObject = default;
    ...
    /// <summary>To be documented.</summary>
    public static void GetDevice<TI0, TThis>(this TThis thisVtbl, ref ComPtr<TI0> ppDevice) where TI0 : unmanaged, IComVtbl<ID3D11Device>, IComVtbl<TI0> where TThis : IComVtbl<ID3D11RasterizerState>
    {
        var @this = (ID3D11RasterizerState*) thisVtbl.AsVtblPtr();
        // ComPtrOverloader
    ...
    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0, TThis>(this TThis thisVtbl) where TI0 : unmanaged, IComVtbl<TI0> where TThis : IComVtbl<ID3D11RasterizerState>
    {
        var @this = (ID3D11RasterizerState*) thisVtbl.AsVtblPtr();
