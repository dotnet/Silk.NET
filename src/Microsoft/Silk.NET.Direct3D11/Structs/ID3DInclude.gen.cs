...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct ID3DInclude
    {
        ...
        /// <summary>To be added.</summary>
        public unsafe int Close(void* pData)
        {
            fixed (ID3DInclude* @this = &this)
            {
                int ret = default;
                ret = ((delegate* cdecl<ID3DInclude*, void*, int>)LpVtbl[1])(@this, pData);
                return ret;
            }
        }

        /// <summary>To be added.</summary>
        public int Close<T0>(ref T0 pData) where T0 : unmanaged
        {
            fixed (ID3DInclude* @this = &this)
            {
                int ret = default;
                ...
                {
                    ret = ((delegate* cdecl<ID3DInclude*, T0*, int>)LpVtbl[1])(@this, pDataPtr);
                }
                return ret;
            }
        }
