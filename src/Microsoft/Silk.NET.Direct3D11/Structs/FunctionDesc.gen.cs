...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct FunctionDesc
    {
        ...
        (
            ...
            Silk.NET.Core.Miscellaneous.Bool32? hasReturn = null,
            Silk.NET.Core.Miscellaneous.Bool32? has10Level9VertexShader = null,
            Silk.NET.Core.Miscellaneous.Bool32? has10Level9PixelShader = null
        ) : this()
        {
        ...
        public Silk.NET.Core.Miscellaneous.Bool32 HasReturn;

        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "Has10Level9VertexShader")]
        public Silk.NET.Core.Miscellaneous.Bool32 Has10Level9VertexShader;

        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "Has10Level9PixelShader")]
        public Silk.NET.Core.Miscellaneous.Bool32 Has10Level9PixelShader;
    }
}
