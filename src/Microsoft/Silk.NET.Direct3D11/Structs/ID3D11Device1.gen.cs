...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct ID3D11Device1 : IComVtbl<ID3D11Device1>, IComVtbl<ID3D11Device>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public static implicit operator Silk.NET.Core.Native.IUnknown(ID3D11Device1 val)
            => Unsafe.As<ID3D11Device1, Silk.NET.Core.Native.IUnknown>(ref val);
