...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct AnonymousRecordD3d113L886C5
    {
        public AnonymousRecordD3d113L886C5
        (
            BufferSrv buffer = default,
            Tex1DSrv texture1D = default,
            Tex1DArraySrv texture1DArray = default,
            Tex2DSrv1 texture2D = default,
            Tex2DArraySrv1 texture2DArray = default,
        ...
        [FieldOffset(0)]
        [NativeName("Type", "D3D11_TEX2D_SRV1")]
        [NativeName("Type.Name", "D3D11_TEX2D_SRV1")]
        [NativeName("Name", "Texture2D")]
        public Tex2DSrv1 Texture2D;

        [FieldOffset(0)]
        [NativeName("Type", "D3D11_TEX2D_ARRAY_SRV1")]
        [NativeName("Type.Name", "D3D11_TEX2D_ARRAY_SRV1")]
