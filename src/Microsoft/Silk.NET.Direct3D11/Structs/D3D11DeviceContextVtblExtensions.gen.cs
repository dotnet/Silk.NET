...
public unsafe static class D3D11DeviceContextVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe void UpdateSubresource<T0>(this ComPtr<ID3D11DeviceContext> thisVtbl, ID3D11Resource* pDstResource, uint DstSubresource, [Flow(FlowDirection.In)] ReadOnlySpan<Box> pDstBox, [Flow(FlowDirection.In)] Span<T0> pSrcData, uint SrcRowPitch, uint SrcDepthPitch) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe void UpdateSubresource<T0>(this ComPtr<ID3D11DeviceContext> thisVtbl, Span<ID3D11Resource> pDstResource, uint DstSubresource, [Flow(FlowDirection.In)] Box* pDstBox, [Flow(FlowDirection.In)] Span<T0> pSrcData, uint SrcRowPitch, uint SrcDepthPitch) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        fixed (void* pSrcDataSpp = pSrcData)
    ...
    /// <summary>To be documented.</summary>
    public static void UpdateSubresource<T0>(this ComPtr<ID3D11DeviceContext> thisVtbl, Span<ID3D11Resource> pDstResource, uint DstSubresource, [Flow(FlowDirection.In)] ReadOnlySpan<Box> pDstBox, [Flow(FlowDirection.In)] Span<T0> pSrcData, uint SrcRowPitch, uint SrcDepthPitch) where T0 : struct
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        fixed (void* pSrcDataSpp = pSrcData)
