...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct ID3D11Texture2D1
    {
        ...
        public readonly uint AddRef()
        {
            var @this = (ID3D11Texture2D1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D11Texture2D1*, uint>)LpVtbl[1])(@this);
            return ret;
        }
        ...
        public readonly uint Release()
        {
            var @this = (ID3D11Texture2D1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D11Texture2D1*, uint>)LpVtbl[2])(@this);
            return ret;
        }
        ...
        public readonly uint GetEvictionPriority()
        {
            var @this = (ID3D11Texture2D1*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
                uint ret = default;
            ret = ((delegate* unmanaged[Cdecl]<ID3D11Texture2D1*, uint>)LpVtbl[9])(@this);
            return ret;
        }
