...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct ShaderDesc
    {
        ...
        (
            ...
            D3DPrimitiveTopology gSOutputTopology = default,
            uint gSMaxOutputVertexCount = default,
            D3DPrimitive inputPrimitive = default,
            uint patchConstantParameters = default,
            uint cGSInstanceCount = default,
            uint cControlPoints = default,
            D3DTessellatorOutputPrimitive hSOutputPrimitive = default,
            D3DTessellatorPartitioning hSPartitioning = default,
            D3DTessellatorDomain tessellatorDomain = default,
