...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct RasterizerDesc2
    {
        ...
        (
            ...
            Silk.NET.Core.Miscellaneous.Bool32? frontCounterClockwise = null,
            int? depthBias = null,
            float? depthBiasClamp = null,
            float? slopeScaledDepthBias = null,
            Silk.NET.Core.Miscellaneous.Bool32? depthClipEnable = null,
            Silk.NET.Core.Miscellaneous.Bool32? scissorEnable = null,
            Silk.NET.Core.Miscellaneous.Bool32? multisampleEnable = null,
            Silk.NET.Core.Miscellaneous.Bool32? antialiasedLineEnable = null,
        ...
        public Silk.NET.Core.Miscellaneous.Bool32 FrontCounterClockwise;
        ...
        public Silk.NET.Core.Miscellaneous.Bool32 DepthClipEnable;

        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "ScissorEnable")]
        public Silk.NET.Core.Miscellaneous.Bool32 ScissorEnable;

        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "MultisampleEnable")]
        public Silk.NET.Core.Miscellaneous.Bool32 MultisampleEnable;

        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "AntialiasedLineEnable")]
        public Silk.NET.Core.Miscellaneous.Bool32 AntialiasedLineEnable;
