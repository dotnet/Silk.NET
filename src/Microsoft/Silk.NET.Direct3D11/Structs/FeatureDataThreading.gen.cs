...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct FeatureDataThreading
    {
        ...
        (
            Silk.NET.Core.Miscellaneous.Bool32? driverConcurrentCreates = null,
            Silk.NET.Core.Miscellaneous.Bool32? driverCommandLists = null
        ) : this()
        {
        ...
        public Silk.NET.Core.Miscellaneous.Bool32 DriverConcurrentCreates;

        [NativeName("Type", "BOOL")]
        [NativeName("Type.Name", "BOOL")]
        [NativeName("Name", "DriverCommandLists")]
        public Silk.NET.Core.Miscellaneous.Bool32 DriverCommandLists;
    }
}
