...
namespace Silk.NET.Direct3D11
{
    ...
    public unsafe partial struct FeatureDataD3D11Options3
    {
        ...
        (
            Silk.NET.Core.Miscellaneous.Bool32? vPAndRTArrayIndexFromAnyShaderFeedingRasterizer = null
        ) : this()
        {
        ...
        public Silk.NET.Core.Miscellaneous.Bool32 VPAndRTArrayIndexFromAnyShaderFeedingRasterizer;
    }
}
