        ...
        public static D3D11 GetApi(DXSwapchainProvider swapchainProvider = DXSwapchainProvider.Win32, bool forceDxvk = false)
        {
            switch (swapchainProvider)
            {
                case DXSwapchainProvider.Win32:
                    ...
                    return new D3D11(CreateDefaultContext(forceDxvk ? "dxvk-" : string.Empty + new D3D11LibraryNameContainer().GetLibraryName()));
                case DXSwapchainProvider.Glfw:
                    ...
                    return new D3D11(CreateDefaultContext(new D3D11GLFWLibraryNameContainer().GetLibraryName()));
                case DXSwapchainProvider.Sdl2:
                    ...
                    return new D3D11(CreateDefaultContext(new D3D11Sdl2LibraryNameContainer().GetLibraryName()));
                default:
