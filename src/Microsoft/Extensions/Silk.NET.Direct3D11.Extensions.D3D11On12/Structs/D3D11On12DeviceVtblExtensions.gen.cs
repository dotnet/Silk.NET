...
public unsafe static class D3D11On12DeviceVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe void ReleaseWrappedResources(this ComPtr<ID3D11On12Device> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ID3D11Resource* ppResources, uint NumResources)
    {
        var @this = thisVtbl.Handle;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe void AcquireWrappedResources(this ComPtr<ID3D11On12Device> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ID3D11Resource* ppResources, uint NumResources)
    {
        var @this = thisVtbl.Handle;
        fixed (ID3D11Resource** ppResourcesPtr = &ppResources)
        {
