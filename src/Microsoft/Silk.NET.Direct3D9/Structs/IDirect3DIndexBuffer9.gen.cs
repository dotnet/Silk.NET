...
namespace Silk.NET.Direct3D9
{
    ...
    public unsafe partial struct IDirect3DIndexBuffer9 : IComVtbl<IDirect3DIndexBuffer9>, IComVtbl<IDirect3DResource9>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int Lock(uint OffsetToLock, uint SizeToLock, void** ppbData, int Flags)
        {
            var @this = (IDirect3DIndexBuffer9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int Lock(uint OffsetToLock, uint SizeToLock, ref void* ppbData, int Flags)
        {
            var @this = (IDirect3DIndexBuffer9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
