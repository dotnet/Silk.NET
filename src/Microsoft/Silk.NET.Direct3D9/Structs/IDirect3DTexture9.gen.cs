...
namespace Silk.NET.Direct3D9
{
    ...
    public unsafe partial struct IDirect3DTexture9 : IComVtbl<IDirect3DTexture9>, IComVtbl<IDirect3DBaseTexture9>, IComVtbl<IDirect3DResource9>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int LockRect(uint Level, LockedRect* pLockedRect, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Silk.NET.Maths.Box2D<int> pRect, uint Flags)
        {
            var @this = (IDirect3DTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int LockRect(uint Level, ref LockedRect pLockedRect, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Silk.NET.Maths.Box2D<int> pRect, uint Flags)
        {
            var @this = (IDirect3DTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (LockedRect* pLockedRectPtr = &pLockedRect)
        ...
        /// <summary>To be documented.</summary>
        public readonly int AddDirtyRect([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Silk.NET.Maths.Box2D<int> pDirtyRect)
        {
            var @this = (IDirect3DTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
