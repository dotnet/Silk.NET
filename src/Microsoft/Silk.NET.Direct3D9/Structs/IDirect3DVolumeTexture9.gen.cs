...
namespace Silk.NET.Direct3D9
{
    ...
    public unsafe partial struct IDirect3DVolumeTexture9 : IComVtbl<IDirect3DVolumeTexture9>, IComVtbl<IDirect3DBaseTexture9>, IComVtbl<IDirect3DResource9>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int LockBox(uint Level, LockedBox* pLockedVolume, [Flow(FlowDirection.In)] Box* pBox, int Flags)
        {
            var @this = (IDirect3DVolumeTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int LockBox(uint Level, LockedBox* pLockedVolume, [Flow(FlowDirection.In)] in Box pBox, int Flags)
        {
            var @this = (IDirect3DVolumeTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int LockBox(uint Level, ref LockedBox pLockedVolume, [Flow(FlowDirection.In)] Box* pBox, int Flags)
        {
            var @this = (IDirect3DVolumeTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int LockBox(uint Level, ref LockedBox pLockedVolume, [Flow(FlowDirection.In)] in Box pBox, int Flags)
        {
            var @this = (IDirect3DVolumeTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (LockedBox* pLockedVolumePtr = &pLockedVolume)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int AddDirtyBox([Flow(FlowDirection.In)] Box* pDirtyBox)
        {
            var @this = (IDirect3DVolumeTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int AddDirtyBox([Flow(FlowDirection.In)] in Box pDirtyBox)
        {
            var @this = (IDirect3DVolumeTexture9*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
