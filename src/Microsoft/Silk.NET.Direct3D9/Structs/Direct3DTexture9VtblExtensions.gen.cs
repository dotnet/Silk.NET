...
public unsafe static class Direct3DTexture9VtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int SetPrivateData<T0>(this ComPtr<IDirect3DTexture9> thisVtbl, Guid* refguid, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pData, uint SizeOfData, uint Flags) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int SetPrivateData<T0>(this ComPtr<IDirect3DTexture9> thisVtbl, ref Guid refguid, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pData, uint SizeOfData, uint Flags) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Guid* refguidPtr = &refguid)
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int LockRect(this ComPtr<IDirect3DTexture9> thisVtbl, uint Level, LockedRect* pLockedRect, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Silk.NET.Maths.Box2D<int> pRect, uint Flags)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int LockRect(this ComPtr<IDirect3DTexture9> thisVtbl, uint Level, ref LockedRect pLockedRect, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Silk.NET.Maths.Box2D<int> pRect, uint Flags)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (LockedRect* pLockedRectPtr = &pLockedRect)
    ...
    /// <summary>To be documented.</summary>
    public static int AddDirtyRect(this ComPtr<IDirect3DTexture9> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly Silk.NET.Maths.Box2D<int> pDirtyRect)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
