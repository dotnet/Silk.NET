        ...
        public static D3D9 GetApi(DXSwapchainProvider swapchainProvider = DXSwapchainProvider.Win32, bool forceDxvk = false)
        {
            switch (swapchainProvider)
            {
                case DXSwapchainProvider.Win32:
                    ...
                    return new D3D9(CreateDefaultContext(forceDxvk ? "dxvk-" : string.Empty + new D3D9LibraryNameContainer().GetLibraryName()));
                case DXSwapchainProvider.Glfw:
                    ...
                    return new D3D9(CreateDefaultContext(new D3D9GLFWLibraryNameContainer().GetLibraryName()));
                case DXSwapchainProvider.Sdl2:
                    ...
                    return new D3D9(CreateDefaultContext(new D3D9Sdl2LibraryNameContainer().GetLibraryName()));
                default:
