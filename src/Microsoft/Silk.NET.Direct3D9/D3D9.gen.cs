...
namespace Silk.NET.Direct3D9
{
    public unsafe partial class D3D9 : NativeAPI
    {
        ...
        [NativeName("Src", "Line 309, Column 21 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        [NativeApi(EntryPoint = "Direct3DCreate9")]
        public unsafe partial IDirect3D9* Direct3DCreate9(uint SDKVersion);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 315, Column 12 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 316, Column 12 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        [NativeApi(EntryPoint = "D3DPERF_EndEvent")]
        public partial int PERFEndEvent();

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 317, Column 13 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 318, Column 13 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 319, Column 13 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        [NativeApi(EntryPoint = "D3DPERF_QueryRepeatFrame")]
        public partial int PERFQueryRepeatFrame();

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 321, Column 13 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        [NativeApi(EntryPoint = "D3DPERF_SetOptions")]
        public partial void PERFSetOptions(uint dwOptions);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 322, Column 14 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
        [NativeApi(EntryPoint = "D3DPERF_GetStatus")]
        public partial uint PERFGetStatus();

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 2030, Column 16 in C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\d3d9.h")]
