...
namespace Silk.NET.OpenCL.Extensions.EXT
{
    ...
    {
        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] DevicePartitionProperty* properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* out_devices, [Flow(FlowDirection.Out)] Span<uint> num_devices)
        {
            // SpanOverloader
            return thisApi.CreateSubDevices(in_device, properties, num_entries, out_devices, out num_devices.GetPinnableReference());
        }

        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] DevicePartitionProperty* properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] Span<nint> out_devices, [Flow(FlowDirection.Out)] uint* num_devices)
        {
            // SpanOverloader
            return thisApi.CreateSubDevices(in_device, properties, num_entries, out out_devices.GetPinnableReference(), num_devices);
        }

        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] DevicePartitionProperty* properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] Span<nint> out_devices, [Flow(FlowDirection.Out)] Span<uint> num_devices)
        {
            // SpanOverloader
        ...
        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] ReadOnlySpan<DevicePartitionProperty> properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* out_devices, [Flow(FlowDirection.Out)] uint* num_devices)
        {
            // SpanOverloader
            return thisApi.CreateSubDevices(in_device, in properties.GetPinnableReference(), num_entries, out_devices, num_devices);
        }

        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] ReadOnlySpan<DevicePartitionProperty> properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* out_devices, [Flow(FlowDirection.Out)] Span<uint> num_devices)
        {
            // SpanOverloader
        ...
        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] ReadOnlySpan<DevicePartitionProperty> properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] Span<nint> out_devices, [Flow(FlowDirection.Out)] uint* num_devices)
        {
            // SpanOverloader
        ...
        public static unsafe int CreateSubDevices(this ExtDeviceFission thisApi, [Flow(FlowDirection.In)] nint in_device, [Flow(FlowDirection.In)] ReadOnlySpan<DevicePartitionProperty> properties, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] Span<nint> out_devices, [Flow(FlowDirection.Out)] Span<uint> num_devices)
        {
            // SpanOverloader
