...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    ...
    public unsafe partial class KhrEglEvent : NativeExtension<CL>
    {
        ...
        public unsafe IntPtr CreateEventFromEglsync([Flow(FlowDirection.In)] IntPtr context, [Flow(FlowDirection.In)] IntPtr sync, [Flow(FlowDirection.In)] IntPtr display, [Flow(FlowDirection.Out)] int* errcode_ret)
            => ImplCreateEventFromEglsync(context, sync, display, errcode_ret);

        [NativeApi(EntryPoint = "clCreateEventFromEGLSyncKHR")]
        [System.Runtime.CompilerServices.MethodImpl((System.Runtime.CompilerServices.MethodImplOptions)(512 | 256))]
        public IntPtr CreateEventFromEglsync([Flow(FlowDirection.In)] IntPtr context, [Flow(FlowDirection.In)] IntPtr sync, [Flow(FlowDirection.In)] IntPtr display, [Flow(FlowDirection.Out)] Span<int> errcode_ret)
            => ImplCreateEventFromEglsync(context, sync, display, errcode_ret);
