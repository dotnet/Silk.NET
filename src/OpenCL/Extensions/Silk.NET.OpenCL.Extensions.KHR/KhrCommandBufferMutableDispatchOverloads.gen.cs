...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    ...
    {
        public static unsafe int GetMutableCommandInfo<T0>(this KhrCommandBufferMutableDispatch thisApi, [Flow(FlowDirection.In)] nint command, [Flow(FlowDirection.In)] MutableCommandInfo param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] Span<T0> param_value, [Flow(FlowDirection.Out)] Span<nuint> param_value_size_ret) where T0 : struct
        {
            // SpanOverloader
            fixed (void* param_valueSpp = param_value)
                return thisApi.GetMutableCommandInfo(command, param_name, param_value_size, param_valueSpp, out param_value_size_ret.GetPinnableReference());
        }
        ...
        public static unsafe int GetMutableCommandInfo<T0>(this KhrCommandBufferMutableDispatch thisApi, [Flow(FlowDirection.In)] nint command, [Flow(FlowDirection.In)] KHR param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] Span<T0> param_value, [Flow(FlowDirection.Out)] nuint* param_value_size_ret) where T0 : struct
        {
            // SpanOverloader
            fixed (void* param_valueSpp = param_value)
                return thisApi.GetMutableCommandInfo(command, param_name, param_value_size, param_valueSpp, param_value_size_ret);
        }
