...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    ...
    public unsafe partial class KhrCommandBufferMutableDispatch : NativeExtension<CL>
    {
        ...
        [NativeApi(EntryPoint = "clUpdateMutableCommandsKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int UpdateMutableCommands([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_buffer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_configs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] CommandBufferUpdateType* config_types, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly void* configs);

        [NativeApi(EntryPoint = "clUpdateMutableCommandsKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int UpdateMutableCommands([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_buffer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_configs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly CommandBufferUpdateType config_types, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void** configs);
        ...
        [Obsolete("The \"ungrouped\" enums (KHR) are deprecated in favour of the \"grouped\" enums (CommandBufferUpdateType). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", false)]
        [NativeApi(EntryPoint = "clUpdateMutableCommandsKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int UpdateMutableCommands([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_buffer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_configs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] KHR* config_types, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly void* configs);

        [Obsolete("The \"ungrouped\" enums (KHR) are deprecated in favour of the \"grouped\" enums (CommandBufferUpdateType). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", false)]
        [NativeApi(EntryPoint = "clUpdateMutableCommandsKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int UpdateMutableCommands([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_buffer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_configs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly KHR config_types, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void** configs);

        [Obsolete("The \"ungrouped\" enums (KHR) are deprecated in favour of the \"grouped\" enums (CommandBufferUpdateType). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", false)]
        [NativeApi(EntryPoint = "clUpdateMutableCommandsKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int UpdateMutableCommands([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_buffer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_configs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly KHR config_types, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly void* configs);
