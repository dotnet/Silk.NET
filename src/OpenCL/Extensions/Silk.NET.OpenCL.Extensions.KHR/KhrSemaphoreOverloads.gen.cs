...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    public static class KhrSemaphoreOverloads
    {
        ...
        public static unsafe int GetSemaphoreInfo<T0>(this KhrSemaphore thisApi, [Flow(FlowDirection.In)] nint sema_object, [Flow(FlowDirection.In)] SemaphoreInfo param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] Span<T0> param_value, [Flow(FlowDirection.Out)] Span<nuint> param_value_size_ret) where T0 : struct
        {
            // SpanOverloader
            fixed (void* param_valueSpp = param_value)
                return thisApi.GetSemaphoreInfo(sema_object, param_name, param_value_size, param_valueSpp, out param_value_size_ret.GetPinnableReference());
        }
        ...
        public static unsafe int GetSemaphoreInfo<T0>(this KhrSemaphore thisApi, [Flow(FlowDirection.In)] nint sema_object, [Flow(FlowDirection.In)] KHR param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] Span<T0> param_value, [Flow(FlowDirection.Out)] nuint* param_value_size_ret) where T0 : struct
        {
            // SpanOverloader
            fixed (void* param_valueSpp = param_value)
                return thisApi.GetSemaphoreInfo(sema_object, param_name, param_value_size, param_valueSpp, param_value_size_ret);
        }
