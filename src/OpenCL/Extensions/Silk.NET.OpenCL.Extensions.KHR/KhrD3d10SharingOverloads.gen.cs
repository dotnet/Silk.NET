...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    public static class KhrD3d10SharingOverloads
    {
        ...
        public static unsafe nint CreateFromD3D10Texture3D(this KhrD3d10Sharing thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemFlags flags, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] void* resource, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint subresource, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<int> errcode_ret)
        {
            // SpanOverloader
            return thisApi.CreateFromD3D10Texture3D(context, flags, resource, subresource, out errcode_ret.GetPinnableReference());
        }

        public static unsafe nint CreateFromD3D10Texture3D<T0>(this KhrD3d10Sharing thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemFlags flags, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<T0> resource, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint subresource, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] int* errcode_ret) where T0 : unmanaged
        {
            // SpanOverloader
