...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    ...
    public unsafe partial class KhrSemaphore : NativeExtension<CL>
    {
        ...
        public unsafe partial nint CreateSemaphoreWithProperties([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] SemaphoreProperties* sema_props, [Flow(FlowDirection.Out)] int* errcode_ret);

        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial nint CreateSemaphoreWithProperties([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] SemaphoreProperties* sema_props, [Flow(FlowDirection.Out)] out int errcode_ret);

        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial nint CreateSemaphoreWithProperties([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] in SemaphoreProperties sema_props, [Flow(FlowDirection.Out)] int* errcode_ret);

        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public partial nint CreateSemaphoreWithProperties([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] in SemaphoreProperties sema_props, [Flow(FlowDirection.Out)] out int errcode_ret);
        ...
        public unsafe partial int GetSemaphoreInfo([Flow(FlowDirection.In)] nint sema_object, [Flow(FlowDirection.In)] SemaphoreInfo param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] void* param_value, [Flow(FlowDirection.Out)] nuint* param_value_size_ret);
