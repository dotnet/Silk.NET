...
namespace Silk.NET.OpenCL.Extensions.KHR
{
    ...
    public unsafe partial class KhrSemaphore : NativeExtension<CL>
    {
        ...
        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial nint CreateSemaphoreWithProperties([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SemaphoreProperties sema_props, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] int* errcode_ret);

        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public partial nint CreateSemaphoreWithProperties([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SemaphoreProperties sema_props, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] out int errcode_ret);
        ...
        [Obsolete("The \"ungrouped\" enums (KHR) are deprecated in favour of the \"grouped\" enums (SemaphoreProperties). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", true)]
        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial nint CreateSemaphoreWithProperties([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly ulong sema_props, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] int* errcode_ret);

        [Obsolete("The \"ungrouped\" enums (KHR) are deprecated in favour of the \"grouped\" enums (SemaphoreProperties). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", true)]
        [NativeApi(EntryPoint = "clCreateSemaphoreWithPropertiesKHR", Convention = CallingConvention.Winapi)]
        public partial nint CreateSemaphoreWithProperties([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly ulong sema_props, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] out int errcode_ret);
        ...
        [NativeApi(EntryPoint = "clEnqueueSignalSemaphoresKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int EnqueueSignalSemaphores([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_queue, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_sema_objects, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint* sema_objects, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly ulong sema_payload_list, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_events_in_wait_list, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint* event_wait_list, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] nint* @event);
        ...
        [NativeApi(EntryPoint = "clEnqueueSignalSemaphoresKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial int EnqueueSignalSemaphores([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint command_queue, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_sema_objects, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint sema_objects, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ulong* sema_payload_list, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_events_in_wait_list, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint* event_wait_list, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] nint* @event);
