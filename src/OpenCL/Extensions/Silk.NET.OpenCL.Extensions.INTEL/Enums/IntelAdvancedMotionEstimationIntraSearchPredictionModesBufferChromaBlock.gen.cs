...
{
    [NativeName("Name", "cl_intel_advanced_motion_estimation_intra_search_prediction_modes_buffer_chroma_block")]
    public enum IntelAdvancedMotionEstimationIntraSearchPredictionModesBufferChromaBlock : int
    {
