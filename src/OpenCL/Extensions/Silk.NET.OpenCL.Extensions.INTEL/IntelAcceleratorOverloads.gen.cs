...
namespace Silk.NET.OpenCL.Extensions.INTEL
{
    ...
    {
        public static unsafe nint CreateAccelerator(this IntelAccelerator thisApi, [Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] AcceleratorType accelerator_type, [Flow(FlowDirection.In)] nuint descriptor_size, [Flow(FlowDirection.In)] void* descriptor, [Flow(FlowDirection.Out)] Span<int> errcode_ret)
        {
            // SpanOverloader
        ...
        public static unsafe nint CreateAccelerator<T0>(this IntelAccelerator thisApi, [Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] AcceleratorType accelerator_type, [Flow(FlowDirection.In)] nuint descriptor_size, [Flow(FlowDirection.In)] ReadOnlySpan<T0> descriptor, [Flow(FlowDirection.Out)] int* errcode_ret) where T0 : unmanaged
        {
            // SpanOverloader
            return thisApi.CreateAccelerator(context, accelerator_type, descriptor_size, in descriptor.GetPinnableReference(), errcode_ret);
        }

        public static unsafe nint CreateAccelerator<T0>(this IntelAccelerator thisApi, [Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] AcceleratorType accelerator_type, [Flow(FlowDirection.In)] nuint descriptor_size, [Flow(FlowDirection.In)] ReadOnlySpan<T0> descriptor, [Flow(FlowDirection.Out)] Span<int> errcode_ret) where T0 : unmanaged
        {
            // SpanOverloader
