...
namespace Silk.NET.OpenCL.Extensions.INTEL
{
    public static class IntelSharingFormatQueryVaApiOverloads
    {
        ...
        public static unsafe int GetSupportedVAApimediaSurfaceFormats<T0>(this IntelSharingFormatQueryVaApi thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemFlags flags, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemObjectType image_type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint plane, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_entries, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<T0> va_api_formats, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] uint* num_surface_formats) where T0 : unmanaged
        {
            // SpanOverloader
        ...
        public static unsafe int GetSupportedVAApimediaSurfaceFormats<T0>(this IntelSharingFormatQueryVaApi thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint context, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemFlags flags, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemObjectType image_type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint plane, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_entries, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<T0> va_api_formats, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<uint> num_surface_formats) where T0 : unmanaged
        {
            // SpanOverloader
