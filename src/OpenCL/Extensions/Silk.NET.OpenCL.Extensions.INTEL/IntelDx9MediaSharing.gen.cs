...
namespace Silk.NET.OpenCL.Extensions.INTEL
{
    ...
    public unsafe partial class IntelDx9MediaSharing : NativeExtension<CL>
    {
        ...
        [NativeApi(EntryPoint = "clCreateFromDX9MediaSurfaceINTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial nint CreateFromDX9MediaSurface<T0>([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] MemFlags flags, [Flow(FlowDirection.Out)] out T0 resource, [Flow(FlowDirection.In)] nint sharedHandle, [Flow(FlowDirection.In)] uint plane, [Flow(FlowDirection.Out)] int* errcode_ret) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clCreateFromDX9MediaSurfaceINTEL", Convention = CallingConvention.Winapi)]
        public partial nint CreateFromDX9MediaSurface<T0>([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] MemFlags flags, [Flow(FlowDirection.Out)] out T0 resource, [Flow(FlowDirection.In)] nint sharedHandle, [Flow(FlowDirection.In)] uint plane, [Flow(FlowDirection.Out)] out int errcode_ret) where T0 : unmanaged;
        ...
        [Obsolete("The \"ungrouped\" enums (CLEnum) are deprecated in favour of the \"grouped\" enums (MemFlags). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", true)]
        [NativeApi(EntryPoint = "clCreateFromDX9MediaSurfaceINTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial nint CreateFromDX9MediaSurface<T0>([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] CLEnum flags, [Flow(FlowDirection.Out)] out T0 resource, [Flow(FlowDirection.In)] nint sharedHandle, [Flow(FlowDirection.In)] uint plane, [Flow(FlowDirection.Out)] int* errcode_ret) where T0 : unmanaged;

        [Obsolete("The \"ungrouped\" enums (CLEnum) are deprecated in favour of the \"grouped\" enums (MemFlags). Not only is this akin to how the original specification represents enums, it also ensures that the size of the enum is correct which is a guarantee the \"ungrouped\" enums do not provide. As such, we have made every attempt to prevent functions known to use these ungrouped enums problematically from compiling; but regardless of whether usage of these deprecated enums compiles please use the other enums to ensure that all functions will work as intended. ", true)]
        [NativeApi(EntryPoint = "clCreateFromDX9MediaSurfaceINTEL", Convention = CallingConvention.Winapi)]
        public partial nint CreateFromDX9MediaSurface<T0>([Flow(FlowDirection.In)] nint context, [Flow(FlowDirection.In)] CLEnum flags, [Flow(FlowDirection.Out)] out T0 resource, [Flow(FlowDirection.In)] nint sharedHandle, [Flow(FlowDirection.In)] uint plane, [Flow(FlowDirection.Out)] out int errcode_ret) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "clGetDeviceIDsFromDX9INTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetDeviceIDsFromDX9<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] Dx9DeviceSource dx9_device_source, [Flow(FlowDirection.Out)] out T0 dx9_object, [Flow(FlowDirection.In)] Dx9DeviceSet dx9_device_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* devices, [Flow(FlowDirection.Out)] uint* num_devices) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetDeviceIDsFromDX9INTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetDeviceIDsFromDX9<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] Dx9DeviceSource dx9_device_source, [Flow(FlowDirection.Out)] out T0 dx9_object, [Flow(FlowDirection.In)] Dx9DeviceSet dx9_device_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* devices, [Flow(FlowDirection.Out)] out uint num_devices) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetDeviceIDsFromDX9INTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetDeviceIDsFromDX9<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] Dx9DeviceSource dx9_device_source, [Flow(FlowDirection.Out)] out T0 dx9_object, [Flow(FlowDirection.In)] Dx9DeviceSet dx9_device_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] out nint devices, [Flow(FlowDirection.Out)] uint* num_devices) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetDeviceIDsFromDX9INTEL", Convention = CallingConvention.Winapi)]
        public partial int GetDeviceIDsFromDX9<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] Dx9DeviceSource dx9_device_source, [Flow(FlowDirection.Out)] out T0 dx9_object, [Flow(FlowDirection.In)] Dx9DeviceSet dx9_device_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] out nint devices, [Flow(FlowDirection.Out)] out uint num_devices) where T0 : unmanaged;
