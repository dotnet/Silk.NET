...
namespace Silk.NET.OpenCL.Extensions.INTEL
{
    ...
    public unsafe partial class IntelVaApiMediaSharing : NativeExtension<CL>
    {
        ...
        public partial unsafe IntPtr CreateFromVAApimediaSurface([Flow(FlowDirection.In)] IntPtr context, [Flow(FlowDirection.In)] INTEL flags, [Flow(FlowDirection.Out)] IntPtr surface, [Flow(FlowDirection.In)] uint plane, [Flow(FlowDirection.Out)] int* errcode_ret);
