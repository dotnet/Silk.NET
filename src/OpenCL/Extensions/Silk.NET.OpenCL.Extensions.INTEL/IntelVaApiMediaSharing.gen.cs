...
namespace Silk.NET.OpenCL.Extensions.INTEL
{
    ...
    public unsafe partial class IntelVaApiMediaSharing : NativeExtension<CL>
    {
        ...
        [NativeApi(EntryPoint = "clGetDeviceIDsFromVA_APIMediaAdapterINTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetDeviceIDsFromVAApimediaAdapter<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] VaApiDeviceSource media_adapter_type, [Flow(FlowDirection.Out)] out T0 media_adapter, [Flow(FlowDirection.In)] VaApiDeviceSet media_adapter_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* devices, [Flow(FlowDirection.Out)] uint* num_devices) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetDeviceIDsFromVA_APIMediaAdapterINTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetDeviceIDsFromVAApimediaAdapter<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] VaApiDeviceSource media_adapter_type, [Flow(FlowDirection.Out)] out T0 media_adapter, [Flow(FlowDirection.In)] VaApiDeviceSet media_adapter_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] nint* devices, [Flow(FlowDirection.Out)] out uint num_devices) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetDeviceIDsFromVA_APIMediaAdapterINTEL", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetDeviceIDsFromVAApimediaAdapter<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] VaApiDeviceSource media_adapter_type, [Flow(FlowDirection.Out)] out T0 media_adapter, [Flow(FlowDirection.In)] VaApiDeviceSet media_adapter_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] out nint devices, [Flow(FlowDirection.Out)] uint* num_devices) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetDeviceIDsFromVA_APIMediaAdapterINTEL", Convention = CallingConvention.Winapi)]
        public partial int GetDeviceIDsFromVAApimediaAdapter<T0>([Flow(FlowDirection.In)] nint platform, [Flow(FlowDirection.In)] VaApiDeviceSource media_adapter_type, [Flow(FlowDirection.Out)] out T0 media_adapter, [Flow(FlowDirection.In)] VaApiDeviceSet media_adapter_set, [Flow(FlowDirection.In)] uint num_entries, [Flow(FlowDirection.Out)] out nint devices, [Flow(FlowDirection.Out)] out uint num_devices) where T0 : unmanaged;
