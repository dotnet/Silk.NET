...
namespace Silk.NET.OpenCL.Extensions.APPLE
{
    ...
    public unsafe partial class AppleContextLoggingFunctions : NativeExtension<CL>
    {
        ...
        [NativeApi(EntryPoint = "clLogMessagesToStderrAPPLE")]
        public unsafe partial void LogMessagesToStderr([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] void* private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] void* user_data);

        [NativeApi(EntryPoint = "clLogMessagesToStderrAPPLE")]
        public unsafe partial void LogMessagesToStderr<T0>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] void* private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] out T0 user_data) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clLogMessagesToStderrAPPLE")]
        public unsafe partial void LogMessagesToStderr<T0>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] in T0 private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] void* user_data) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clLogMessagesToStderrAPPLE")]
        public partial void LogMessagesToStderr<T0, T1>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] in T0 private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] out T1 user_data) where T0 : unmanaged where T1 : unmanaged;
        ...
        [NativeApi(EntryPoint = "clLogMessagesToStdoutAPPLE")]
        public unsafe partial void LogMessagesToStdout([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] void* private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] void* user_data);

        [NativeApi(EntryPoint = "clLogMessagesToStdoutAPPLE")]
        public unsafe partial void LogMessagesToStdout<T0>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] void* private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] out T0 user_data) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clLogMessagesToStdoutAPPLE")]
        public unsafe partial void LogMessagesToStdout<T0>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] in T0 private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] void* user_data) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clLogMessagesToStdoutAPPLE")]
        public partial void LogMessagesToStdout<T0, T1>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] in T0 private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] out T1 user_data) where T0 : unmanaged where T1 : unmanaged;
        ...
        [NativeApi(EntryPoint = "clLogMessagesToSystemLogAPPLE")]
        public unsafe partial void LogMessagesToSystemLog([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] void* private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] void* user_data);

        [NativeApi(EntryPoint = "clLogMessagesToSystemLogAPPLE")]
        public unsafe partial void LogMessagesToSystemLog<T0>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] void* private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] out T0 user_data) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clLogMessagesToSystemLogAPPLE")]
        public unsafe partial void LogMessagesToSystemLog<T0>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] in T0 private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] void* user_data) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clLogMessagesToSystemLogAPPLE")]
        public partial void LogMessagesToSystemLog<T0, T1>([Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string errstr, [Flow(FlowDirection.In)] in T0 private_info, [Flow(FlowDirection.In)] nuint cb, [Flow(FlowDirection.Out)] out T1 user_data) where T0 : unmanaged where T1 : unmanaged;
