...
namespace Silk.NET.OpenCL.Extensions.LOADER
{
    public static class LoaderInfoOverloads
    {
        ...
        public static unsafe int GetIcdloaderInfoOclicd<T0>(this LoaderInfo thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] IcdlInfo param_name, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nuint param_value_size, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<T0> param_value, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] nuint* param_value_size_ret) where T0 : unmanaged
        {
            // SpanOverloader
