...
namespace Silk.NET.OpenCL.Extensions.LOADER
{
    ...
    public unsafe partial class LoaderLayers : NativeExtension<CL>
    {
        ...
        [NativeApi(EntryPoint = "clGetLayerInfo", Convention = CallingConvention.Winapi)]
        public unsafe partial int GetLayerInfo<T0>([Flow(FlowDirection.In)] LayerInfo param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] out T0 param_value, [Flow(FlowDirection.Out)] nuint* param_value_size_ret) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clGetLayerInfo", Convention = CallingConvention.Winapi)]
        public partial int GetLayerInfo<T0>([Flow(FlowDirection.In)] LayerInfo param_name, [Flow(FlowDirection.In)] nuint param_value_size, [Flow(FlowDirection.Out)] out T0 param_value, [Flow(FlowDirection.Out)] out nuint param_value_size_ret) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "clInitLayer", Convention = CallingConvention.Winapi)]
        public unsafe partial int InitLayer([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_entries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void* target_dispatch, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] uint* num_entries_ret, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* layer_dispatch_ret);
        ...
        [NativeApi(EntryPoint = "clInitLayer", Convention = CallingConvention.Winapi)]
        public unsafe partial int InitLayer([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_entries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void* target_dispatch, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] out uint num_entries_ret, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* layer_dispatch_ret);

        [NativeApi(EntryPoint = "clInitLayer", Convention = CallingConvention.Winapi)]
        public unsafe partial int InitLayer<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_entries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 target_dispatch, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] uint* num_entries_ret, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void** layer_dispatch_ret) where T0 : unmanaged;

        [NativeApi(EntryPoint = "clInitLayer", Convention = CallingConvention.Winapi)]
        public unsafe partial int InitLayer<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint num_entries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 target_dispatch, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] uint* num_entries_ret, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in void* layer_dispatch_ret) where T0 : unmanaged;
