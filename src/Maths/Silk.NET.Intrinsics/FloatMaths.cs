...
{
    internal static unsafe class FloatMaths
    {
        public static readonly int VectorSize =
#if INTRINSICS
            sizeof(Vector128<float>);
#else
            sizeof(float) * 4;
#endif
        ...
        /// </remarks>
        public static void Ld1(byte* outputMemory, float* input) => throw new NotImplementedException();

        /// <summary>loads a value and stores it into a vector</summary>
        /// <remarks>
        /// This pops 0 value(s) from the input memory and pushes 1 value(s) to the output memory.
        /// </remarks>
        public static void Ld2(byte* outputMemory, float* input) => throw new NotImplementedException();

        /// <summary>loads a value and stores it into a vector</summary>
        /// <remarks>
        /// This pops 0 value(s) from the input memory and pushes 1 value(s) to the output memory.
        /// </remarks>
        public static void Ld3(byte* outputMemory, float* input) => throw new NotImplementedException();

        /// <summary>loads a value and stores it into a vector</summary>
        /// <remarks>
        /// This pops 0 value(s) from the input memory and pushes 1 value(s) to the output memory.
        /// </remarks>
        public static void Ld4(byte* outputMemory, float* input) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St1(byte* inputMemory, float* output) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St2(byte* inputMemory, float* output) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St3(byte* inputMemory, float* output) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St4(byte* inputMemory, float* output) => throw new NotImplementedException();
