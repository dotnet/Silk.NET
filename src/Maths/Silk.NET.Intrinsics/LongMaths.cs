...
{
    internal static unsafe class LongMaths
    {
        public static readonly int VectorSize =
#if INTRINSICS
            sizeof(Vector256<long>);
#else
            sizeof(long) * 4;
#endif
        ...
        /// </remarks>
        public static void Ld1(byte* outputMemory, long* input) => throw new NotImplementedException();

        /// <summary>loads a value and stores it into a vector</summary>
        /// <remarks>
        /// This pops 0 value(s) from the input memory and pushes 1 value(s) to the output memory.
        /// </remarks>
        public static void Ld2(byte* outputMemory, long* input) => throw new NotImplementedException();

        /// <summary>loads a value and stores it into a vector</summary>
        /// <remarks>
        /// This pops 0 value(s) from the input memory and pushes 1 value(s) to the output memory.
        /// </remarks>
        public static void Ld3(byte* outputMemory, long* input) => throw new NotImplementedException();

        /// <summary>loads a value and stores it into a vector</summary>
        /// <remarks>
        /// This pops 0 value(s) from the input memory and pushes 1 value(s) to the output memory.
        /// </remarks>
        public static void Ld4(byte* outputMemory, long* input) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St1(byte* inputMemory, long* output) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St2(byte* inputMemory, long* output) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St3(byte* inputMemory, long* output) => throw new NotImplementedException();

        /// <summary>stores the vector.</summary>
        /// <remarks>
        /// This pops 1 value(s) from the input memory and pushes 0 value(s) to the output memory.
        /// </remarks>
        public static void St4(byte* inputMemory, long* output) => throw new NotImplementedException();
