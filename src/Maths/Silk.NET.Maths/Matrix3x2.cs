...
{
    public struct Matrix3x2<T> : IEquatable<Matrix3x2<T>> where T:unmanaged
    {
        ...
        public static void CreateRotation(T angle, out Matrix3x2<T> result)
        {
            throw new NotImplementedException();
        }

        public static Matrix3x2<T> CreateRotation(T angle)
        {
            throw new NotImplementedException();
        }

        public static void CreateScale(T scale, out Matrix3x2<T> result)
        {
            throw new NotImplementedException();
        }
        ...
        public static void CreateScale(Vector2<T> scale, out Matrix3x2<T> result)
        {
            throw new NotImplementedException();
        }
        ...
        public static void CreateScale(T x, T y, out Matrix3x2<T> result)
        {
            throw new NotImplementedException();
        }

        public static Matrix3x2<T> CreateScale(T x, T y)
        {
            throw new NotImplementedException();
        }
