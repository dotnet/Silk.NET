...
namespace Silk.NET.Maths
{
    public struct Matrix2X3<T> : IEquatable<Matrix2X3<T>>, IFormattable where T : unmanaged, IFormattable
    {
        ...
        public static void CreateScale
            (Vector2<T> scale, out Matrix2X3<T> result) => throw new NotImplementedException();
        ...
        public static void Multiply
            (ref Matrix2X3<T> left, T right, out Matrix2X3<T> result) => throw new NotImplementedException();

        public static Matrix2X3<T> Multiply(Matrix2X3<T> left, T right) => throw new NotImplementedException();

        public static void Multiply
            (ref Matrix2X3<T> left, ref Matrix3x2<T> right, out Matrix2X2<T> result) =>
            throw new NotImplementedException();

        public static Matrix2X2<T> Multiply
            (Matrix2X3<T> left, Matrix3x2<T> right) => throw new NotImplementedException();

        public static void Multiply
            (ref Matrix2X3<T> left, ref Matrix3X3<T> right, out Matrix2X3<T> result) =>
            throw new NotImplementedException();

        public static Matrix2X3<T> Multiply
            (Matrix2X3<T> left, Matrix3X3<T> right) => throw new NotImplementedException();

        public static void Multiply
            (ref Matrix2X3<T> left, ref Matrix3X4<T> right, out Matrix2X4<T> result) =>
            throw new NotImplementedException();

        public static Matrix2X4<T> Multiply
            (Matrix2X3<T> left, Matrix3X4<T> right) => throw new NotImplementedException();

        public static void Add
            (ref Matrix2X3<T> left, ref Matrix2X3<T> right, out Matrix2X3<T> result) =>
            throw new NotImplementedException();
        ...
        public static Matrix2X3<T> Subtract
            (Matrix2X3<T> left, Matrix2X3<T> right) => throw new NotImplementedException();

        public static void Transpose
            (ref Matrix2X3<T> mat, out Matrix3x2<T> result) => throw new NotImplementedException();
