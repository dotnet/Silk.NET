...
namespace Silk.NET.Maths
{
    ...
    public readonly struct Matrix4X3<T> : IEquatable<Matrix4X3<T>>, IFormattable where T : unmanaged, IFormattable
    {
        /*
         * TODO:
         * - check all the api surfaces
         * - provide static methods were missing
         * - provide non-static methods were missing (and appropriate)
         * - provide ref/out methods to ALL static methods
         */

        public static Matrix4X3<T> Zero => default;
        public readonly Vector3<T> Row0;
        public readonly Vector3<T> Row1;
        public readonly Vector3<T> Row2;
        public readonly Vector3<T> Row3;
