...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated And on 128-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector128<T> And<T>(Vector128<T> left, Vector128<T> right) where T : unmanaged
        {
            ...
            static Vector128<T> SByte(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(sbyte))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.And(left.AsSByte(), right.AsSByte()).As<sbyte, T>();
                    }
#endif
#if SSE
                    if (Sse2.IsSupported)
                    {
                        return Sse2.And(left.AsSByte(), right.AsSByte()).As<sbyte, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Int16(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(short))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.And(left.AsInt16(), right.AsInt16()).As<short, T>();
                    }
#endif
#if SSE
                    if (Sse2.IsSupported)
                    {
                        return Sse2.And(left.AsInt16(), right.AsInt16()).As<short, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Int32(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(int))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.And(left.AsInt32(), right.AsInt32()).As<int, T>();
                    }
#endif
#if SSE
                    if (Sse2.IsSupported)
                    {
                        return Sse2.And(left.AsInt32(), right.AsInt32()).As<int, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Int64(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(long))
                {
                    ...
                    if (Sse2.IsSupported)
                    {
                        return Sse2.And(left.AsInt64(), right.AsInt64()).As<long, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Single(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(float))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.And(left.AsSingle(), right.AsSingle()).As<float, T>();
                    }
#endif
#if SSE
                    if (Sse2.IsSupported)
                    {
                        return Sse2.And(left.AsSingle(), right.AsSingle()).As<float, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Other(Vector128<T> left, Vector128<T> right)
            {
                ...
                {
                    WithElement(vec, i, Scalar.And(GetElement(left, i), GetElement(right, i)));
                }
                return vec;
            }
        }
