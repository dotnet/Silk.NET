...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated IsNegativeInfinity on 64-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector64<T> IsNegativeInfinity<T>(Vector64<T> vector) where T : unmanaged
        {
            ...
            static Vector64<T> SingleOrDouble(Vector64<T> vector)
            {
                ...
                {
                    return Equal(vector, Simd64<T>.NegativeInfinity);
                }
