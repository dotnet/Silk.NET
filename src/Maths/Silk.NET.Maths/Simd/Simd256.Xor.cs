...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated Xor on 256-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector256<T> Xor<T>(Vector256<T> left, Vector256<T> right) where T : unmanaged
        {
            ...
            static Vector256<T> SByte(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(sbyte))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Xor(left.AsSByte(), right.AsSByte()).As<sbyte, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Int16(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(short))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Xor(left.AsInt16(), right.AsInt16()).As<short, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Int32(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(int))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Xor(left.AsInt32(), right.AsInt32()).As<int, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Int64(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(long))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Xor(left.AsInt64(), right.AsInt64()).As<long, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Single(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(float))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Xor(left.AsSingle(), right.AsSingle()).As<float, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Double(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(double))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Xor(left.AsDouble(), right.AsDouble()).As<double, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Other(Vector256<T> left, Vector256<T> right)
            {
                ...
                {
                    vec.WithElement(i, Scalar.Xor(left.GetElement(i), right.GetElement(i)));
                }
                return vec;
            }
        }
