...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated Or on 256-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector256<T> Or<T>(Vector256<T> left, Vector256<T> right) where T : unmanaged
        {
            ...
            static Vector256<T> SByte(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(sbyte))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Or(left.AsSByte(), right.AsSByte()).As<sbyte, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Int16(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(short))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Or(left.AsInt16(), right.AsInt16()).As<short, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Int32(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(int))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Or(left.AsInt32(), right.AsInt32()).As<int, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Int64(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(long))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Or(left.AsInt64(), right.AsInt64()).As<long, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Single(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(float))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Or(left.AsSingle(), right.AsSingle()).As<float, T>();
                    }
#endif
                }
            ...
            static Vector256<T> Double(Vector256<T> left, Vector256<T> right)
            {
                if (typeof(T) == typeof(double))
                {
                    ...
                    if (Avx2.IsSupported)
                    {
                        return Avx2.Or(left.AsDouble(), right.AsDouble()).As<double, T>();
                    }
#endif
                }
