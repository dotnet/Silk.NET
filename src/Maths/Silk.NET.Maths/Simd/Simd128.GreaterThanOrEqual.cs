...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated GreaterThanOrEqual on 128-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector128<T> GreaterThanOrEqual<T>(Vector128<T> left, Vector128<T> right) where T : unmanaged
        {
            ...
            static Vector128<T> SByte(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(sbyte))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareGreaterThanOrEqual(left.AsSByte(), right.AsSByte()).As<sbyte, T>();
                    }
#endif
                }
            ...
            static Vector128<T> UInt16(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(ushort))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareGreaterThanOrEqual(left.AsUInt16(), right.AsUInt16()).As<ushort, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Int16(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(short))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareGreaterThanOrEqual(left.AsInt16(), right.AsInt16()).As<short, T>();
                    }
#endif
                }
            ...
            static Vector128<T> UInt32(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(uint))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareGreaterThanOrEqual(left.AsUInt32(), right.AsUInt32()).As<uint, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Int32(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(int))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareGreaterThanOrEqual(left.AsInt32(), right.AsInt32()).As<int, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Single(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(float))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareGreaterThanOrEqual(left.AsSingle(), right.AsSingle()).As<float, T>();
                    }
#endif
#if SSE
                    if (Sse2.IsSupported)
                    {
                        return Sse2.CompareGreaterThanOrEqual(left.AsSingle(), right.AsSingle()).As<float, T>();
                    }
#endif
                }
            ...
            static Vector128<T> Double(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(double))
                {
                    ...
                    if (Sse2.IsSupported)
                    {
                        return Sse2.CompareGreaterThanOrEqual(left.AsDouble(), right.AsDouble()).As<double, T>();
                    }
#endif
                }
