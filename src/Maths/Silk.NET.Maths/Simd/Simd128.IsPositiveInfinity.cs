...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated IsPositiveInfinity on 128-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector128<T> IsPositiveInfinity<T>(Vector128<T> vector) where T : unmanaged
        {
            ...
            static Vector128<T> SingleOrDouble(Vector128<T> vector)
            {
                ...
                {
                    return Equal(vector, Simd128<T>.PositiveInfinity);
                }
