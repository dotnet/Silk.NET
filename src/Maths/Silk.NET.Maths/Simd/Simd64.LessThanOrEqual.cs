...
namespace Silk.NET.Maths
{
    ...
    {
        /// <summary>
        /// Performs hardware-accelerated LessThanOrEqual on 64-bit vectors.
        /// </summary>
        [MethodImpl(Scalar.MaxOpt)]
        public static Vector64<T> LessThanOrEqual<T>(Vector64<T> left, Vector64<T> right) where T : unmanaged
        {
            ...
            static Vector64<T> UInt64(Vector64<T> left, Vector64<T> right)
            {
                if (typeof(T) == typeof(ulong))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareLessThanOrEqual(left.AsUInt64(), right.AsUInt64()).As<ulong, T>();
                    }
#endif
                }
            ...
            static Vector64<T> Int64(Vector64<T> left, Vector64<T> right)
            {
                if (typeof(T) == typeof(long))
                {
                    ...
                    if (AdvSimd.IsSupported)
                    {
                        return AdvSimd.CompareLessThanOrEqual(left.AsInt64(), right.AsInt64()).As<long, T>();
                    }
#endif
                }
