            ...
            static Vector128<T> Byte(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(byte))
                {
                    ...
                    if (Sse2.IsSupported)
                    {
                        ...
                        return Sse2.CompareLessThan(leftShifted.AsSByte(), rightShifted.AsSByte()).As<SByte, T>();
                    }
#endif
                }
            ...
            static Vector128<T> UInt16(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(ushort))
                {
                    ...
                    if (Sse2.IsSupported)
                    {
                        ...
                        return Sse2.CompareLessThan(leftShifted.AsInt16(), rightShifted.AsInt16()).As<Int16, T>();
                    }
#endif
                }
            ...
            static Vector128<T> UInt32(Vector128<T> left, Vector128<T> right)
            {
                if (typeof(T) == typeof(uint))
                {
                    ...
                    if (Sse2.IsSupported)
                    {
                        ...
                        return Sse2.CompareLessThan(leftShifted.AsInt32(), rightShifted.AsInt32()).As<Int32, T>();
                    }
#endif
                }
