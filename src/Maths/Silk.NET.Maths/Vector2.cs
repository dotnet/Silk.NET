...
namespace Silk.NET.Maths
{
    ...
    */
    ...
    public readonly partial struct Vector2<T> : IVector2<T, Vector2<T>> where T : unmanaged, IFormattable
    {
        ...
        public static void Divide(T value, ref Vector2<T> scale, out Vector2<T> result) => result = Divide(value, scale);
        ...
        public static void Clamp(ref Vector2<T> vec, ref Vector2<T> min, ref Vector2<T> max, out Vector2<T> result)
        ...
        public static void BaryCentric
            (ref Vector2<T> a, ref Vector2<T> b, ref Vector2<T> c, T u, T v, out Vector2<T> result)
        ...
        public static void Cos(ref Vector2<T> vector, out Vector2<T> result) => result = Cos(vector);

        public static Vector2<T> Sin(Vector2<T> vector) => new Vector2<T>(Scalar.Sin(vector.X), Scalar.Sin(vector.Y));

        public static void Sin(ref Vector2<T> vector, out Vector2<T> result) => result = Sin(vector);
