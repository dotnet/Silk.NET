...
namespace Silk.NET.Maths
{
    ...
    public static class Vector3
    {
        ...
        public static Vector3<T> Abs<T>(Vector3<T> value)
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Add<T>(Vector3<T> left, Vector3<T> right)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left + right;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Clamp<T>(Vector3<T> value1, Vector3<T> min, Vector3<T> max)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Cross<T>(Vector3<T> vector1, Vector3<T> vector2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => new(
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static T Distance<T>(Vector3<T> value1, Vector3<T> value2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static T DistanceSquared<T>(Vector3<T> value1, Vector3<T> value2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        {
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Divide<T>(Vector3<T> left, Vector3<T> right)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left / right;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Divide<T>(Vector3<T> left, T divisor)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left / divisor;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static T Dot<T>(Vector3<T> vector1, Vector3<T> vector2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => Scalar.Add(
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Lerp<T>(Vector3<T> value1, Vector3<T> value2, T amount)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        {
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Max<T>(Vector3<T> value1, Vector3<T> value2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        ...
        public static Vector3<T> Min<T>(Vector3<T> value1, Vector3<T> value2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Multiply<T>(Vector3<T> left, Vector3<T> right)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left * right;
        ...
        /// <returns>The result of the multiplication.</returns>
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Multiply<T>(Vector3<T> value1, Matrix3x3<T> value2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => value1 * value2;
        ...
        /// <returns>The result of the multiplication.</returns>
        [MethodImpl((MethodImplOptions)768)]
        public static Vector2<T> Multiply<T>(Vector3<T> value1, Matrix3x2<T> value2)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => value1 * value2;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Multiply<T>(Vector3<T> left, T right) 
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left * right;
        ...
        /// <returns>The scaled vector.</returns>
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Multiply<T>(T left, Vector3<T> right)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left * right;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Negate<T>(Vector3<T> value)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => -value;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Normalize<T>(Vector3<T> value) 
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => value / value.Length;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Reflect<T>(Vector3<T> vector, Vector3<T> normal) 
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> SquareRoot<T>(Vector3<T> value)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Subtract<T>(Vector3<T> left, Vector3<T> right) 
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
            => left - right;
        ...
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Transform<T>(Vector3<T> position, Matrix4x4<T> matrix) // TODO: Matrix4x3
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        {
            return new(
        ...
        /// <returns>The transformed vector.</returns>
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> Transform<T>(Vector3<T> value, Quaternion<T> rotation)
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        {
        ...
        /// <returns>The transformed vector.</returns>
        [MethodImpl((MethodImplOptions)768)]
        public static Vector3<T> TransformNormal<T>(Vector3<T> normal, Matrix4x4<T> matrix) // TODO: Matrix3x3
            where T : unmanaged, IFormattable, IEquatable<T>, IComparable<T>
        {
            return new(
