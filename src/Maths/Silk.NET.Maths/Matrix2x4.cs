...
namespace Silk.NET.Maths
{
    public struct Matrix2X4<T> : IEquatable<Matrix2X4<T>>, IFormattable where T : unmanaged, IFormattable
    {
        ...
        public static void CreateScale
            (Vector2<T> scale, out Matrix2X4<T> result) => throw new NotImplementedException();
        ...
        public static void Multiply
            (ref Matrix2X4<T> left, T right, out Matrix2X4<T> result) => throw new NotImplementedException();

        public static Matrix2X4<T> Multiply(Matrix2X4<T> left, T right) => throw new NotImplementedException();

        public static void Multiply
            (ref Matrix2X4<T> left, ref Matrix4X2<T> right, out Matrix2X2<T> result) =>
            throw new NotImplementedException();

        public static Matrix2X2<T> Multiply
            (Matrix2X4<T> left, Matrix4X2<T> right) => throw new NotImplementedException();

        public static void Multiply
            (ref Matrix2X4<T> left, ref Matrix4X3<T> right, out Matrix2X3<T> result) =>
            throw new NotImplementedException();

        public static Matrix2X3<T> Multiply
            (Matrix2X4<T> left, Matrix4X3<T> right) => throw new NotImplementedException();

        public static void Multiply
            (ref Matrix2X4<T> left, ref Matrix4X4<T> right, out Matrix2X4<T> result) =>
            throw new NotImplementedException();

        public static Matrix2X4<T> Multiply
            (Matrix2X4<T> left, Matrix4X4<T> right) => throw new NotImplementedException();

        public static void Add
            (ref Matrix2X4<T> left, ref Matrix2X4<T> right, out Matrix2X4<T> result) =>
            throw new NotImplementedException();
        ...
        public static Matrix2X4<T> Subtract
            (Matrix2X4<T> left, Matrix2X4<T> right) => throw new NotImplementedException();

        public static void Transpose
            (ref Matrix2X4<T> mat, out Matrix4X2<T> result) => throw new NotImplementedException();
        ...
        public static Matrix2X2<T> operator *
            (Matrix2X4<T> left, Matrix4X2<T> right) => throw new NotImplementedException();

        public static Matrix2X3<T> operator *
            (Matrix2X4<T> left, Matrix4X3<T> right) => throw new NotImplementedException();

        public static Matrix2X4<T> operator *
            (Matrix2X4<T> left, Matrix4X4<T> right) => throw new NotImplementedException();
