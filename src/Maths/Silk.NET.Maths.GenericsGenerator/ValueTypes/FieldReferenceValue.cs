...
{
    public sealed class FieldReferenceValue : IValue, IEquatable<FieldReferenceValue>
    {
        public FieldReferenceValue(string name, Type type)
        {
            Name = name;
            Type = type;
        }
        ...
        public void DebugWrite(TextWriter writer, int indentation = 0)
        {
            ...
            writer.WriteLine($"PARAM REF {Name}");
        }
    }
}
