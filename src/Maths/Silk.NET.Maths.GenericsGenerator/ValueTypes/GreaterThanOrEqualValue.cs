...
{
    public sealed class GreaterThanOrEqualValue : BinaryOperatorValue
    {
        ...
        protected override SyntaxKind OpSyntaxKind => SyntaxKind.GreaterThanOrEqualExpression;
        public override void DebugWrite(TextWriter writer, int indentation = 0)
        {
            Helpers.Indent(writer, indentation);
            writer.WriteLine("BEGIN GREATER THAN OR EQUAL");
