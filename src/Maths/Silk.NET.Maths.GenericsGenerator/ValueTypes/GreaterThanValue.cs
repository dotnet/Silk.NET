...
{
    public sealed class GreaterThanValue : BinaryOperatorValue
    {
        ...
        protected override SyntaxKind OpSyntaxKind => SyntaxKind.GreaterThanExpression;
        public override void DebugWrite(TextWriter writer, int indentation = 0)
        {
            Helpers.Indent(writer, indentation);
            writer.WriteLine("BEGIN GREATER THAN");
