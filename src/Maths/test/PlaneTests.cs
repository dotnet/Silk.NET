...
namespace Silk.NET.Numerics.Tests
{
    public class PlaneTests
    {
        ...
        public void PlaneEqualsTest1()
        {
            ...
            b.Normal = new Vector3<float>(10.0f, b.Normal.Y, b.Normal.Z);
            expected = false;
            actual = a.Equals(b);
            Assert.Equal(expected, actual);
        }
...
*/
        ...
        {
            Vector3<float> point1 = new Vector3<float>(0.0f, 1.0f, 1.0f);
        ...
        // A test for Plane<float> (Vector3<float>f, float)
        [Fact]
        public void PlaneConstructorTest3()
        {
            Vector3<float> normal = new Vector3<float>(1, 2, 3);
            float d = 4;
        ...
        // A test for Plane<float> (Vector4<float>f)
        [Fact]
        public void PlaneConstructorTest()
        {
            Vector4<float> value = new Vector4<float>(1.0f, 2.0f, 3.0f, 4.0f);
        ...
        public void PlaneNormalizeTest()
        {
            ...
            float invF = 1.0f / (float)Operations.Sqrt(f);
            Plane<float> expected = new Plane<float>(target.Normal * invF, target.D * invF);
