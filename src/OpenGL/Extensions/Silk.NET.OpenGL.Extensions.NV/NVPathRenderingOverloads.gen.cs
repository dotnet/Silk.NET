...
namespace Silk.NET.OpenGL.Extensions.NV
{
    ...
    {
        public static unsafe void CoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] ReadOnlySpan<float> transformValues) where T0 : struct
        {
            // SpanOverloader
        ...
        public static unsafe void CoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void CoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.CoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, coverMode, transformType, transformValues);
        ...
        public static unsafe void CoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.CoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, coverMode, transformType, transformValues);
        ...
        public static unsafe void GetPathMetric<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint metricQueryMask, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] uint stride, [Count(Computed = "metricQueryMask, numPaths, stride"), Flow(FlowDirection.Out)] Span<float> metrics) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void GetPathMetric<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint metricQueryMask, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] PathElementType pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] uint stride, [Count(Computed = "metricQueryMask, numPaths, stride"), Flow(FlowDirection.Out)] float* metrics) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void GetPathSpacing<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV pathListMode, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] float advanceScale, [Flow(FlowDirection.In)] float kerningScale, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "pathListMode, numPaths"), Flow(FlowDirection.Out)] Span<float> returnedSpacing) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void GetPathSpacing<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV pathListMode, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] float advanceScale, [Flow(FlowDirection.In)] float kerningScale, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "pathListMode, numPaths"), Flow(FlowDirection.Out)] float* returnedSpacing) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] ReadOnlySpan<byte> commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] NV coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Flow(FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] NV coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] byte* commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, commands, numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] ReadOnlySpan<byte> commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, in commands.GetPinnableReference(), numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Flow(FlowDirection.In), UnmanagedType(Silk.NET.Core.Native.UnmanagedType.LPUTF8Str)] string commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, commands, numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] PathCoordType* commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] NV coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, commands, numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] ReadOnlySpan<PathCoordType> commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] NV coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, in commands.GetPinnableReference(), numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] PathCoordType* commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, commands, numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Count(Parameter = "numCommands"), Flow(FlowDirection.In)] ReadOnlySpan<PathCoordType> commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCommands(path, numCommands, in commands.GetPinnableReference(), numCoords, coordType, coordsSpp);
        ...
        public static unsafe void PathCoords<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathCoords(path, numCoords, coordType, coordsSpp);
        }
        ...
        public static unsafe void PathGlyph<T0, T1>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] NV fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV type, [Count(Computed = "numGlyphs, type, charcodes"), Flow(FlowDirection.In)] Span<T1> charcodes, [Flow(FlowDirection.In)] PathHandleMissingGlyphs handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct where T1 : struct
        {
            // SpanOverloader
        ...
        public static unsafe void PathGlyph<T0, T1>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] NV fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] PathElementType type, [Count(Computed = "numGlyphs, type, charcodes"), Flow(FlowDirection.In)] Span<T1> charcodes, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct where T1 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
            fixed (void* charcodesSpp = charcodes)
        ...
        public static unsafe void PathGlyph<T0, T1>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] NV fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] PathFontStyle fontStyle, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV type, [Count(Computed = "numGlyphs, type, charcodes"), Flow(FlowDirection.In)] Span<T1> charcodes, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct where T1 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
            fixed (void* charcodesSpp = charcodes)
        ...
        public static unsafe void PathGlyph<T0, T1>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] PathFontTarget fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV type, [Count(Computed = "numGlyphs, type, charcodes"), Flow(FlowDirection.In)] Span<T1> charcodes, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct where T1 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
            fixed (void* charcodesSpp = charcodes)
        ...
        public static unsafe void PathGlyph<T0, T1>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] PathFontTarget fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] PathElementType type, [Count(Computed = "numGlyphs, type, charcodes"), Flow(FlowDirection.In)] Span<T1> charcodes, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct where T1 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
            fixed (void* charcodesSpp = charcodes)
        ...
        public static unsafe void PathGlyph<T0, T1>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] PathFontTarget fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] PathFontStyle fontStyle, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV type, [Count(Computed = "numGlyphs, type, charcodes"), Flow(FlowDirection.In)] Span<T1> charcodes, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct where T1 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
            fixed (void* charcodesSpp = charcodes)
        ...
        public static unsafe NV PathGlyphIndexArray<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] NV fontTarget, [Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] PathFontStyle fontStyle, [Flow(FlowDirection.In)] uint firstGlyphIndex, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
        ...
        public static unsafe NV PathGlyphIndexRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV fontTarget, [Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale, [Count(Count = 2), Flow(FlowDirection.Out)] Span<uint> baseAndCount) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
        ...
        public static unsafe NV PathGlyphIndexRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV fontTarget, [Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] PathFontStyle fontStyle, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale, [Count(Count = 2), Flow(FlowDirection.Out)] uint* baseAndCount) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
        ...
        public static unsafe void PathGlyphRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] NV fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint firstGlyph, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] PathHandleMissingGlyphs handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
        ...
        public static unsafe void PathGlyphRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] NV fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] PathFontStyle fontStyle, [Flow(FlowDirection.In)] uint firstGlyph, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
                thisApi.PathGlyphRange(firstPathName, fontTarget, fontNameSpp, fontStyle, firstGlyph, numGlyphs, handleMissingGlyphs, pathParameterTemplate, emScale);
        ...
        public static unsafe void PathGlyphRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] PathFontTarget fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint firstGlyph, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
                thisApi.PathGlyphRange(firstPathName, fontTarget, fontNameSpp, fontStyle, firstGlyph, numGlyphs, handleMissingGlyphs, pathParameterTemplate, emScale);
        ...
        public static unsafe void PathGlyphRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] PathFontTarget fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] uint fontStyle, [Flow(FlowDirection.In)] uint firstGlyph, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] PathHandleMissingGlyphs handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
                thisApi.PathGlyphRange(firstPathName, fontTarget, fontNameSpp, fontStyle, firstGlyph, numGlyphs, handleMissingGlyphs, pathParameterTemplate, emScale);
        ...
        public static unsafe void PathGlyphRange<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint firstPathName, [Flow(FlowDirection.In)] PathFontTarget fontTarget, [Count(Computed = "fontTarget, fontName"), Flow(FlowDirection.In)] Span<T0> fontName, [Flow(FlowDirection.In)] PathFontStyle fontStyle, [Flow(FlowDirection.In)] uint firstGlyph, [Flow(FlowDirection.In)] uint numGlyphs, [Flow(FlowDirection.In)] NV handleMissingGlyphs, [Flow(FlowDirection.In)] uint pathParameterTemplate, [Flow(FlowDirection.In)] float emScale) where T0 : struct
        {
            // SpanOverloader
            fixed (void* fontNameSpp = fontName)
                thisApi.PathGlyphRange(firstPathName, fontTarget, fontNameSpp, fontStyle, firstGlyph, numGlyphs, handleMissingGlyphs, pathParameterTemplate, emScale);
        ...
        public static unsafe void PathString<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] PathStringFormat format, [Flow(FlowDirection.In)] uint length, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> pathString) where T0 : struct
        {
            // SpanOverloader
        ...
        public static unsafe void PathSubCoords<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint coordStart, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] Span<T0> coords) where T0 : struct
        {
            // SpanOverloader
            fixed (void* coordsSpp = coords)
                thisApi.PathSubCoords(path, coordStart, numCoords, coordType, coordsSpp);
        }
        ...
        public static unsafe void StencilFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] ReadOnlySpan<float> transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] PathFillMode fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, transformType, transformValues);
        ...
        public static unsafe void StencilFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] PathFillMode fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, transformType, transformValues);
        ...
        public static unsafe void StencilStrokePathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] int reference, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] ReadOnlySpan<float> transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilStrokePathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] int reference, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] ReadOnlySpan<float> transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] NV fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] PathFillMode fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] PathFillMode fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] PathFillMode fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverFillPathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] PathFillMode fillMode, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverFillPathInstanced(numPaths, pathNameType, pathsSpp, pathBase, fillMode, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverStrokePathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] int reference, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] ReadOnlySpan<float> transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilThenCoverStrokePathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] int reference, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] NV coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
        ...
        public static unsafe void StencilThenCoverStrokePathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] int reference, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] NV transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverStrokePathInstanced(numPaths, pathNameType, pathsSpp, pathBase, reference, mask, coverMode, transformType, transformValues);
        ...
        public static unsafe void StencilThenCoverStrokePathInstanced<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint numPaths, [Flow(FlowDirection.In)] NV pathNameType, [Count(Computed = "numPaths, pathNameType, paths"), Flow(FlowDirection.In)] Span<T0> paths, [Flow(FlowDirection.In)] uint pathBase, [Flow(FlowDirection.In)] int reference, [Flow(FlowDirection.In)] uint mask, [Flow(FlowDirection.In)] InstancedPathCoverMode coverMode, [Flow(FlowDirection.In)] PathTransformType transformType, [Count(Computed = "numPaths, transformType"), Flow(FlowDirection.In)] float* transformValues) where T0 : struct
        {
            // SpanOverloader
            fixed (void* pathsSpp = paths)
                thisApi.StencilThenCoverStrokePathInstanced(numPaths, pathNameType, pathsSpp, pathBase, reference, mask, coverMode, transformType, transformValues);
