...
namespace Silk.NET.OpenGL.Extensions.NV
{
    public static class NVPathRenderingOverloads
    {
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] NV coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] ReadOnlySpan<T0> coords) where T0 : unmanaged
        {
            // SpanOverloader
            thisApi.PathCommands(path, numCommands, commands, numCoords, coordType, in coords.GetPinnableReference());
        }
        ...
        public static unsafe void PathCommands<T0>(this NVPathRendering thisApi, [Flow(FlowDirection.In)] uint path, [Flow(FlowDirection.In)] uint numCommands, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string commands, [Flow(FlowDirection.In)] uint numCoords, [Flow(FlowDirection.In)] PathCoordType coordType, [Count(Computed = "numCoords, coordType"), Flow(FlowDirection.In)] ReadOnlySpan<T0> coords) where T0 : unmanaged
        {
            // SpanOverloader
            thisApi.PathCommands(path, numCommands, commands, numCoords, coordType, in coords.GetPinnableReference());
        }
