...
namespace Silk.NET.OpenGL.Extensions.NV
{
    ...
    public unsafe partial class NVShadingRateImage : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glShadingRateImagePaletteNV", Convention = CallingConvention.Winapi)]
        public partial void ShadingRateImagePalette([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint viewport, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint first, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in NV rates);
        ...
        [NativeApi(EntryPoint = "glShadingRateSampleOrderCustomNV", Convention = CallingConvention.Winapi)]
        public partial void ShadingRateSampleOrderCustom([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV rate, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint samples, [Count(Computed = "rate, samples"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int locations);
