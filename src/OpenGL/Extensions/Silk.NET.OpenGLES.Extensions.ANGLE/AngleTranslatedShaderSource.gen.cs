...
namespace Silk.NET.OpenGLES.Extensions.ANGLE
{
    ...
    public unsafe partial class AngleTranslatedShaderSource : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetTranslatedShaderSourceANGLE")]
        public unsafe partial void GetTranslatedShaderSource([Flow(FlowDirection.In)] uint shader, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] uint* length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string source);
        ...
        [NativeApi(EntryPoint = "glGetTranslatedShaderSourceANGLE")]
        public partial void GetTranslatedShaderSource([Flow(FlowDirection.In)] uint shader, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] out uint length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string source);
