...
namespace Silk.NET.OpenGL.Legacy.Extensions.AMD
{
    ...
    public unsafe partial class AmdPerformanceMonitor : NativeExtension<GL>
    {
        ...
        public unsafe int GetPerfMonitorCounterData([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint monitor, [Flow(Silk.NET.Core.Native.FlowDirection.In)] AMD pname, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint dataSize, [Count(Parameter = "dataSize"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] uint* data)
        {
            // NonKhrReturnTypeOverloader
        ...
        public unsafe int GetPerfMonitorCounterData([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint monitor, [Flow(Silk.NET.Core.Native.FlowDirection.In)] AMD pname, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint dataSize, [Count(Parameter = "dataSize"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out uint data)
        {
            // NonKhrReturnTypeOverloader
        ...
        public unsafe int GetPerfMonitorCounterData([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint monitor, [Flow(Silk.NET.Core.Native.FlowDirection.In)] AMD pname, [Count(Parameter = "dataSize"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<uint> data)
        {
            // NonKhrReturnTypeOverloader
