...
namespace Silk.NET.OpenGL.Legacy.Extensions.ATI
{
    ...
    public unsafe partial class AtiDrawBuffers : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glDrawBuffersATI", Convention = CallingConvention.Winapi)]
        public partial void DrawBuffers([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ATI bufs);
