...
namespace Silk.NET.OpenGL.Legacy.Extensions.ATI
{
    ...
    public unsafe partial class AtiVertexAttribArrayObject : NativeExtension<GL>
    {
        ...
        public partial unsafe void GetVertexAttribArrayObject([Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] ATI pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] float* @params);
        ...
        public partial unsafe void GetVertexAttribArrayObject([Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] ATI pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] int* @params);
        ...
        [NativeApi(EntryPoint = "glGetVertexAttribArrayObjectfvATI")]
        public partial unsafe void GetVertexAttribArrayObject([Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] ArrayObjectPNameATI pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] float* @params);
        ...
        [NativeApi(EntryPoint = "glGetVertexAttribArrayObjectivATI")]
        public partial unsafe void GetVertexAttribArrayObject([Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] ArrayObjectPNameATI pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] int* @params);
