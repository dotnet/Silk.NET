...
namespace Silk.NET.WGL.Extensions.EXT
{
    public static class ExtPixelFormatOverloads
    {
        ...
        public static unsafe Silk.NET.Core.Bool32 GetPixelFormatAttrib(this ExtPixelFormat thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hdc, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int iPixelFormat, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int iLayerPlane, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint nAttributes, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<int> piAttributes, [Flow(Silk.NET.Core.Native.FlowDirection.Out)] int* piValues)
        {
            // SpanOverloader
