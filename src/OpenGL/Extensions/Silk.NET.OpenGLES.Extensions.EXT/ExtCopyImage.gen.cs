...
namespace Silk.NET.OpenGLES.Extensions.EXT
{
    ...
    public abstract unsafe partial class ExtCopyImage : NativeExtension<GL>
    {
        public const string ExtensionName = "EXT_copy_image";
        [NativeApi(EntryPoint = "glCopyImageSubDataEXT")]
        public abstract void CopyImageSubData([Flow(FlowDirection.In)] uint srcName, [Flow(FlowDirection.In)] EXT srcTarget, [Flow(FlowDirection.In)] int srcLevel, [Flow(FlowDirection.In)] int srcX, [Flow(FlowDirection.In)] int srcY, [Flow(FlowDirection.In)] int srcZ, [Flow(FlowDirection.In)] uint dstName, [Flow(FlowDirection.In)] EXT dstTarget, [Flow(FlowDirection.In)] int dstLevel, [Flow(FlowDirection.In)] int dstX, [Flow(FlowDirection.In)] int dstY, [Flow(FlowDirection.In)] int dstZ, [Flow(FlowDirection.In)] uint srcWidth, [Flow(FlowDirection.In)] uint srcHeight, [Flow(FlowDirection.In)] uint srcDepth);
        ...
        public ExtCopyImage(ref NativeApiContext ctx)
            : base(ref ctx)
        {
        }
    }
