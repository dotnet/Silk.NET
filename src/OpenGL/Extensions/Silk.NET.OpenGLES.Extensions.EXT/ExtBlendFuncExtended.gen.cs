...
namespace Silk.NET.OpenGLES.Extensions.EXT
{
    ...
    public unsafe partial class ExtBlendFuncExtended : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glBindFragDataLocationEXT")]
        public partial void BindFragDataLocation([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] uint color, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glBindFragDataLocationIndexedEXT")]
        public partial void BindFragDataLocationIndexed([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] uint colorNumber, [Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetFragDataIndexEXT")]
        public partial int GetFragDataIndex([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetProgramResourceLocationIndexEXT")]
        public partial int GetProgramResourceLocationIndex([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] EXT programInterface, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
