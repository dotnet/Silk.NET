...
namespace Silk.NET.OpenGLES.Extensions.EXT
{
    ...
    public unsafe partial class ExtTextureBorderClamp : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glSamplerParameterIivEXT", Convention = CallingConvention.Winapi)]
        public partial void SamplerParameterI([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint sampler, [Flow(Silk.NET.Core.Native.FlowDirection.In)] EXT pname, [Count(Computed = "pname"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int param);
        ...
        [NativeApi(EntryPoint = "glSamplerParameterIuivEXT", Convention = CallingConvention.Winapi)]
        public partial void SamplerParameterI([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint sampler, [Flow(Silk.NET.Core.Native.FlowDirection.In)] EXT pname, [Count(Computed = "pname"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in uint param);
