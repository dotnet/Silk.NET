...
namespace Silk.NET.OpenGLES.Extensions.EXT
{
    ...
    public unsafe partial class ExtDrawElementsBaseVertex : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glMultiDrawElementsBaseVertexEXT")]
        public unsafe partial void MultiDrawElementsBaseVertex<T0>([Flow(FlowDirection.In)] EXT mode, [Count(Computed = "drawcount"), Flow(FlowDirection.In)] ref uint count, [Flow(FlowDirection.In)] EXT type, [Count(Computed = "drawcount"), Flow(FlowDirection.In)] ref T0* indices, [Flow(FlowDirection.In)] uint drawcount, [Count(Computed = "drawcount"), Flow(FlowDirection.In)] ref int basevertex) where T0 : unmanaged;
