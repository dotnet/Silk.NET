...
namespace Silk.NET.OpenGLES.Extensions.EXT
{
    ...
    public unsafe partial class ExtSemaphore : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetUnsignedBytevEXT")]
        public partial void GetUnsignedByte([Flow(FlowDirection.In)] EXT pname, [Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] string data);
        ...
        [NativeApi(EntryPoint = "glGetUnsignedBytevEXT")]
        public partial void GetUnsignedByte([Flow(FlowDirection.In)] GetPName pname, [Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] string data);
        ...
        [NativeApi(EntryPoint = "glGetUnsignedBytei_vEXT")]
        public partial void GetUnsignedByte([Flow(FlowDirection.In)] EXT target, [Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] string data);
