...
namespace Silk.NET.OpenGL.Extensions.INTEL
{
    public static class IntelPerformanceQueryOverloads
    {
        ...
        public static unsafe void GetPerfQueryIdByName(this IntelPerformanceQuery thisApi, [Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] string queryName, [Flow(FlowDirection.Out)] Span<uint> queryId)
        {
            // SpanOverloader
            thisApi.GetPerfQueryIdByName(queryName, out queryId.GetPinnableReference());
        }
