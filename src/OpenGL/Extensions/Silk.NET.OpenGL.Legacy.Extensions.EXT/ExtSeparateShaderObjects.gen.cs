...
namespace Silk.NET.OpenGL.Legacy.Extensions.EXT
{
    ...
    public unsafe partial class ExtSeparateShaderObjects : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glCreateShaderProgramEXT")]
        public partial uint CreateShaderProgram([Flow(FlowDirection.In)] EXT type, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string @string);
        ...
        [NativeApi(EntryPoint = "glCreateShaderProgramEXT")]
        public partial uint CreateShaderProgram([Flow(FlowDirection.In)] ShaderType type, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string @string);
