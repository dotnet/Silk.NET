...
namespace Silk.NET.OpenGL.Legacy.Extensions.EXT
{
    ...
    public unsafe partial class ExtMemoryObject : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glDeleteMemoryObjectsEXT", Convention = CallingConvention.Winapi)]
        public partial void DeleteMemoryObjects([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in uint memoryObjects);
        ...
        [NativeApi(EntryPoint = "glMemoryObjectParameterivEXT", Convention = CallingConvention.Winapi)]
        public partial void MemoryObjectParameter([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint memoryObject, [Flow(Silk.NET.Core.Native.FlowDirection.In)] EXT pname, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in int @params);
        ...
        [NativeApi(EntryPoint = "glMemoryObjectParameterivEXT", Convention = CallingConvention.Winapi)]
        public partial void MemoryObjectParameter([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint memoryObject, [Flow(Silk.NET.Core.Native.FlowDirection.In)] MemoryObjectParameterName pname, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in int @params);
