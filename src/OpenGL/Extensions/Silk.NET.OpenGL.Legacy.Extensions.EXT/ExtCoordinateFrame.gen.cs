...
namespace Silk.NET.OpenGL.Legacy.Extensions.EXT
{
    ...
    public unsafe partial class ExtCoordinateFrame : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glBinormal3bvEXT", Convention = CallingConvention.Winapi)]
        public partial void Binormal3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in sbyte v);
        ...
        [NativeApi(EntryPoint = "glBinormal3dvEXT", Convention = CallingConvention.Winapi)]
        public partial void Binormal3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);
        ...
        [NativeApi(EntryPoint = "glBinormal3fvEXT", Convention = CallingConvention.Winapi)]
        public partial void Binormal3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);
        ...
        [NativeApi(EntryPoint = "glBinormal3ivEXT", Convention = CallingConvention.Winapi)]
        public partial void Binormal3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int v);
        ...
        [NativeApi(EntryPoint = "glBinormal3svEXT", Convention = CallingConvention.Winapi)]
        public partial void Binormal3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in short v);
        ...
        [NativeApi(EntryPoint = "glTangent3bvEXT", Convention = CallingConvention.Winapi)]
        public partial void Tangent3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in sbyte v);
        ...
        [NativeApi(EntryPoint = "glTangent3dvEXT", Convention = CallingConvention.Winapi)]
        public partial void Tangent3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);
        ...
        [NativeApi(EntryPoint = "glTangent3fvEXT", Convention = CallingConvention.Winapi)]
        public partial void Tangent3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);
        ...
        [NativeApi(EntryPoint = "glTangent3ivEXT", Convention = CallingConvention.Winapi)]
        public partial void Tangent3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int v);
        ...
        [NativeApi(EntryPoint = "glTangent3svEXT", Convention = CallingConvention.Winapi)]
        public partial void Tangent3([Count(Count = 3), Flow(Silk.NET.Core.Native.FlowDirection.In)] in short v);
