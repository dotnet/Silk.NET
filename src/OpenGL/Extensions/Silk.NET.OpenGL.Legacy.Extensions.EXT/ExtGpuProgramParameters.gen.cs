...
namespace Silk.NET.OpenGL.Legacy.Extensions.EXT
{
    ...
    public unsafe partial class ExtGpuProgramParameters : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glProgramEnvParameters4fvEXT", Convention = CallingConvention.Winapi)]
        public partial void ProgramEnvParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] EXT target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count", Expression = "*4"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float @params);
        ...
        [NativeApi(EntryPoint = "glProgramLocalParameters4fvEXT", Convention = CallingConvention.Winapi)]
        public partial void ProgramLocalParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] EXT target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count", Expression = "*4"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float @params);
