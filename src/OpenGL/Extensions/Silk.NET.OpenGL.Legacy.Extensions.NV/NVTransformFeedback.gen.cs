...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    ...
    public unsafe partial class NVTransformFeedback : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glActiveVaryingNV", Convention = CallingConvention.Winapi)]
        public partial void ActiveVarying([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint program, [Count(Computed = "name"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name);
        ...
        [NativeApi(EntryPoint = "glGetVaryingLocationNV", Convention = CallingConvention.Winapi)]
        public partial int GetVaryingLocation([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint program, [Count(Computed = "name"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name);
        ...
        [NativeApi(EntryPoint = "glTransformFeedbackAttribsNV", Convention = CallingConvention.Winapi)]
        public partial void TransformFeedbackAttrib([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Computed = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int attribs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] NV bufferMode);
        ...
        [NativeApi(EntryPoint = "glTransformFeedbackStreamAttribsNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void TransformFeedbackStreamAttrib([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] int* attribs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint nbuffers, [Count(Parameter = "nbuffers"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int bufstreams, [Flow(Silk.NET.Core.Native.FlowDirection.In)] NV bufferMode);

        [NativeApi(EntryPoint = "glTransformFeedbackStreamAttribsNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void TransformFeedbackStreamAttrib([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int attribs, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint nbuffers, [Count(Parameter = "nbuffers"), Flow(Silk.NET.Core.Native.FlowDirection.In)] int* bufstreams, [Flow(Silk.NET.Core.Native.FlowDirection.In)] NV bufferMode);
        ...
        [NativeApi(EntryPoint = "glTransformFeedbackVaryingsNV", Convention = CallingConvention.Winapi)]
        public partial void TransformFeedbackVaryings([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint program, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in int locations, [Flow(Silk.NET.Core.Native.FlowDirection.In)] NV bufferMode);
