...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    ...
    public unsafe partial class NVTransformFeedback : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glActiveVaryingNV")]
        public partial void ActiveVarying([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetActiveVaryingNV")]
        public unsafe partial void GetActiveVarying([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] uint* length, [Count(Count = 1), Flow(FlowDirection.Out)] uint* size, [Count(Count = 1), Flow(FlowDirection.Out)] NV* type, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string name);
        ...
        [NativeApi(EntryPoint = "glGetActiveVaryingNV")]
        public unsafe partial void GetActiveVarying([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] uint* length, [Count(Count = 1), Flow(FlowDirection.Out)] uint* size, [Count(Count = 1), Flow(FlowDirection.Out)] out NV type, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string name);
        ...
        [NativeApi(EntryPoint = "glGetVaryingLocationNV")]
        public partial int GetVaryingLocation([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
