...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    ...
    public unsafe partial class NVVdpauInterop : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glVDPAUInitNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void Vdpauinit<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] void* vdpDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 getProcAddress) where T0 : unmanaged;

        [NativeApi(EntryPoint = "glVDPAUInitNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void Vdpauinit<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 vdpDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] void* getProcAddress) where T0 : unmanaged;

        [NativeApi(EntryPoint = "glVDPAUInitNV", Convention = CallingConvention.Winapi)]
        public partial void Vdpauinit<T0, T1>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 vdpDevice, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T1 getProcAddress) where T0 : unmanaged where T1 : unmanaged;
        ...
        [NativeApi(EntryPoint = "glVDPAUMapSurfacesNV", Convention = CallingConvention.Winapi)]
        public partial void VdpaumapSurfaces([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint numSurfaces, [Count(Parameter = "numSurfaces"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint surfaces);
        ...
        [NativeApi(EntryPoint = "glVDPAUUnmapSurfacesNV", Convention = CallingConvention.Winapi)]
        public partial void VdpauunmapSurfaces([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint numSurface, [Count(Parameter = "numSurface"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint surfaces);
        ...
        public unsafe nint VdpauregisterOutputSurface<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 vdpSurface, [Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Count(Parameter = "numTextureNames"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<uint> textureNames) where T0 : unmanaged
        {
            // ImplicitCountSpanOverloader
        ...
        public unsafe nint VdpauregisterVideoSurface<T0>([Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 vdpSurface, [Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Count(Parameter = "numTextureNames"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<uint> textureNames) where T0 : unmanaged
        {
            // ImplicitCountSpanOverloader
