...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    ...
    public unsafe partial class NVSampleLocations : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glFramebufferSampleLocationsfvNV", Convention = CallingConvention.Winapi)]
        public partial void FramebufferSampleLocations([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint start, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly float v);
