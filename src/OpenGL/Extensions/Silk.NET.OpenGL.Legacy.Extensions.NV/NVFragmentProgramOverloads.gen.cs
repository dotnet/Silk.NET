...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    public static class NVFragmentProgramOverloads
    {
        ...
        public static unsafe void GetProgramNamedParameter(this NVFragmentProgram thisApi, [Flow(FlowDirection.In)] uint id, [Flow(FlowDirection.In)] uint len, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name, [Count(Count = 4), Flow(FlowDirection.Out)] Span<float> @params)
        {
            // SpanOverloader
            thisApi.GetProgramNamedParameter(id, len, name, out @params.GetPinnableReference());
        }
        ...
        public static unsafe void GetProgramNamedParameter(this NVFragmentProgram thisApi, [Flow(FlowDirection.In)] uint id, [Flow(FlowDirection.In)] uint len, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name, [Count(Count = 4), Flow(FlowDirection.Out)] Span<double> @params)
        {
            // SpanOverloader
            thisApi.GetProgramNamedParameter(id, len, name, out @params.GetPinnableReference());
        }
        ...
        public static unsafe void ProgramNamedParameter4(this NVFragmentProgram thisApi, [Flow(FlowDirection.In)] uint id, [Flow(FlowDirection.In)] uint len, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name, [Count(Count = 4), Flow(FlowDirection.In)] ReadOnlySpan<float> v)
        {
            // SpanOverloader
            thisApi.ProgramNamedParameter4(id, len, name, in v.GetPinnableReference());
        }
        ...
        public static unsafe void ProgramNamedParameter4(this NVFragmentProgram thisApi, [Flow(FlowDirection.In)] uint id, [Flow(FlowDirection.In)] uint len, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name, [Count(Count = 4), Flow(FlowDirection.In)] ReadOnlySpan<double> v)
        {
            // SpanOverloader
            thisApi.ProgramNamedParameter4(id, len, name, in v.GetPinnableReference());
        }
