...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    ...
    public unsafe partial class NVVertexProgram : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glAreProgramsResidentNV", Convention = CallingConvention.Winapi)]
        public unsafe partial bool AreProgramsResident([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in uint programs, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] bool* residences);

        [NativeApi(EntryPoint = "glAreProgramsResidentNV", Convention = CallingConvention.Winapi)]
        public partial bool AreProgramsResident([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in uint programs, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out bool residences);
        ...
        [NativeApi(EntryPoint = "glAreProgramsResidentNV", Convention = CallingConvention.Winapi)]
        public unsafe partial bool AreProgramsResident([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Program programs, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] bool* residences);

        [NativeApi(EntryPoint = "glAreProgramsResidentNV", Convention = CallingConvention.Winapi)]
        public partial bool AreProgramsResident([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Program programs, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out bool residences);
        ...
        [NativeApi(EntryPoint = "glDeleteProgramsNV", Convention = CallingConvention.Winapi)]
        public partial void DeleteProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in uint programs);
        ...
        [NativeApi(EntryPoint = "glDeleteProgramsNV", Convention = CallingConvention.Winapi)]
        public partial void DeleteProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Program programs);
        ...
        [NativeApi(EntryPoint = "glExecuteProgramNV", Convention = CallingConvention.Winapi)]
        public partial void ExecuteProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint id, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float @params);
        ...
        [NativeApi(EntryPoint = "glExecuteProgramNV", Convention = CallingConvention.Winapi)]
        public partial void ExecuteProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint id, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float @params);
        ...
        [NativeApi(EntryPoint = "glLoadProgramNV", Convention = CallingConvention.Winapi)]
        public partial void LoadProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint id, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint len, [Count(Parameter = "len"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte program);
        ...
        [NativeApi(EntryPoint = "glLoadProgramNV", Convention = CallingConvention.Winapi)]
        public partial void LoadProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint id, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint len, [Count(Parameter = "len"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte program);
        ...
        [NativeApi(EntryPoint = "glProgramParameter4dvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameter4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);
        ...
        [NativeApi(EntryPoint = "glProgramParameter4dvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameter4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);
        ...
        [NativeApi(EntryPoint = "glProgramParameter4fvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameter4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);
        ...
        [NativeApi(EntryPoint = "glProgramParameter4fvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameter4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);

        [NativeApi(EntryPoint = "glProgramParameters4dvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] double* v);

        [NativeApi(EntryPoint = "glProgramParameters4dvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);

        [NativeApi(EntryPoint = "glProgramParameters4dvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] double* v);

        [NativeApi(EntryPoint = "glProgramParameters4dvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);

        [NativeApi(EntryPoint = "glProgramParameters4fvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] float* v);

        [NativeApi(EntryPoint = "glProgramParameters4fvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);

        [NativeApi(EntryPoint = "glProgramParameters4fvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] float* v);

        [NativeApi(EntryPoint = "glProgramParameters4fvNV", Convention = CallingConvention.Winapi)]
        public partial void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);
        ...
        [NativeApi(EntryPoint = "glRequestResidentProgramsNV", Convention = CallingConvention.Winapi)]
        public partial void RequestResidentProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in uint programs);
        ...
        [NativeApi(EntryPoint = "glRequestResidentProgramsNV", Convention = CallingConvention.Winapi)]
        public partial void RequestResidentProgram([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Program programs);
        ...
        [NativeApi(EntryPoint = "glVertexAttribs1dvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs1([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);
        ...
        [NativeApi(EntryPoint = "glVertexAttribs1fvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs1([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);
        ...
        [NativeApi(EntryPoint = "glVertexAttribs1svNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs1([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in short v);

        [NativeApi(EntryPoint = "glVertexAttribs2dvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] double* v);

        [NativeApi(EntryPoint = "glVertexAttribs2dvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);

        [NativeApi(EntryPoint = "glVertexAttribs2fvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] float* v);

        [NativeApi(EntryPoint = "glVertexAttribs2fvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);

        [NativeApi(EntryPoint = "glVertexAttribs2svNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] short* v);

        [NativeApi(EntryPoint = "glVertexAttribs2svNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in short v);

        [NativeApi(EntryPoint = "glVertexAttribs3dvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] double* v);

        [NativeApi(EntryPoint = "glVertexAttribs3dvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);

        [NativeApi(EntryPoint = "glVertexAttribs3fvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] float* v);

        [NativeApi(EntryPoint = "glVertexAttribs3fvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);

        [NativeApi(EntryPoint = "glVertexAttribs3svNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] short* v);

        [NativeApi(EntryPoint = "glVertexAttribs3svNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in short v);

        [NativeApi(EntryPoint = "glVertexAttribs4dvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] double* v);

        [NativeApi(EntryPoint = "glVertexAttribs4dvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in double v);

        [NativeApi(EntryPoint = "glVertexAttribs4fvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] float* v);

        [NativeApi(EntryPoint = "glVertexAttribs4fvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float v);

        [NativeApi(EntryPoint = "glVertexAttribs4svNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] short* v);

        [NativeApi(EntryPoint = "glVertexAttribs4svNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in short v);

        [NativeApi(EntryPoint = "glVertexAttribs4ubvNV", Convention = CallingConvention.Winapi)]
        public unsafe partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] byte* v);

        [NativeApi(EntryPoint = "glVertexAttribs4ubvNV", Convention = CallingConvention.Winapi)]
        public partial void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte v);
        ...
        public unsafe void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<double> v)
        {
            // ImplicitCountSpanOverloader
            ProgramParameters4(target, index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<double> v)
        {
            // ImplicitCountSpanOverloader
            ProgramParameters4(target, index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] NV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> v)
        {
            // ImplicitCountSpanOverloader
            ProgramParameters4(target, index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void ProgramParameters4([Flow(Silk.NET.Core.Native.FlowDirection.In)] VertexAttribEnumNV target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> v)
        {
            // ImplicitCountSpanOverloader
            ProgramParameters4(target, index, (uint) v.Length, in v.GetPinnableReference());
        }
        ...
        public unsafe void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<double> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs2(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs2(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs2([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<short> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs2(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<double> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs3(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs3(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs3([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<short> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs3(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<double> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs4(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs4(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<short> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs4(index, (uint) v.Length, in v.GetPinnableReference());
        }

        public unsafe void VertexAttribs4([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint index, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<byte> v)
        {
            // ImplicitCountSpanOverloader
            VertexAttribs4(index, (uint) v.Length, in v.GetPinnableReference());
        }
