...
namespace Silk.NET.OpenGL.Legacy.Extensions.NV
{
    public static class NVPathRenderingOverloads
    {
        ...
        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathColorGen(color, pname, out value.GetPinnableReference());
        }
        ...
        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV texCoordSet, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV texCoordSet, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] TextureUnit texCoordSet, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] TextureUnit texCoordSet, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV texCoordSet, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV texCoordSet, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] TextureUnit texCoordSet, [Flow(FlowDirection.In)] NV pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }

        public static unsafe void GetPathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] TextureUnit texCoordSet, [Flow(FlowDirection.In)] PathGenMode pname, [Count(Computed = "pname"), Flow(FlowDirection.Out)] Span<float> value)
        {
            // SpanOverloader
            thisApi.GetPathTexGen(texCoordSet, pname, out value.GetPinnableReference());
        }
        ...
        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] NV genMode, [Flow(FlowDirection.In)] NV colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] NV genMode, [Flow(FlowDirection.In)] PathColorFormat colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] PathGenMode genMode, [Flow(FlowDirection.In)] NV colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV color, [Flow(FlowDirection.In)] PathGenMode genMode, [Flow(FlowDirection.In)] PathColorFormat colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] NV genMode, [Flow(FlowDirection.In)] NV colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] NV genMode, [Flow(FlowDirection.In)] PathColorFormat colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] PathGenMode genMode, [Flow(FlowDirection.In)] NV colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathColorGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor color, [Flow(FlowDirection.In)] PathGenMode genMode, [Flow(FlowDirection.In)] PathColorFormat colorFormat, [Count(Computed = "genMode, colorFormat"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathColorGen(color, genMode, colorFormat, in coeffs.GetPinnableReference());
        }
        ...
        public static unsafe void PathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV texCoordSet, [Flow(FlowDirection.In)] NV genMode, [Flow(FlowDirection.In)] int components, [Count(Computed = "genMode, components"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathTexGen(texCoordSet, genMode, components, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] NV texCoordSet, [Flow(FlowDirection.In)] PathGenMode genMode, [Flow(FlowDirection.In)] int components, [Count(Computed = "genMode, components"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathTexGen(texCoordSet, genMode, components, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor texCoordSet, [Flow(FlowDirection.In)] NV genMode, [Flow(FlowDirection.In)] int components, [Count(Computed = "genMode, components"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathTexGen(texCoordSet, genMode, components, in coeffs.GetPinnableReference());
        }

        public static unsafe void PathTexGen(this NVPathRendering thisApi, [Flow(FlowDirection.In)] PathColor texCoordSet, [Flow(FlowDirection.In)] PathGenMode genMode, [Flow(FlowDirection.In)] int components, [Count(Computed = "genMode, components"), Flow(FlowDirection.In)] ReadOnlySpan<float> coeffs)
        {
            // SpanOverloader
            thisApi.PathTexGen(texCoordSet, genMode, components, in coeffs.GetPinnableReference());
        }
