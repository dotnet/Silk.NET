...
namespace Silk.NET.OpenGL.Legacy.Extensions.ARB
{
    ...
    public unsafe partial class ArbVertexShader : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glBindAttribLocationARB")]
        public partial void BindAttribLocation([Flow(FlowDirection.In)] uint programObj, [Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetActiveAttribARB")]
        public unsafe partial void GetActiveAttrib([Flow(FlowDirection.In)] uint programObj, [Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In)] uint maxLength, [Count(Count = 1), Flow(FlowDirection.Out)] uint* length, [Count(Count = 1), Flow(FlowDirection.Out)] int* size, [Count(Count = 1), Flow(FlowDirection.Out)] AttributeType* type, [Count(Parameter = "maxLength"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string name);
        ...
        [NativeApi(EntryPoint = "glGetAttribLocationARB")]
        public partial int GetAttribLocation([Flow(FlowDirection.In)] uint programObj, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glVertexAttrib4ubvARB")]
        public partial void VertexAttrib4([Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string v);
        ...
        [NativeApi(EntryPoint = "glVertexAttrib4NubvARB")]
        public partial void VertexAttrib4N([Flow(FlowDirection.In)] uint index, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string v);
