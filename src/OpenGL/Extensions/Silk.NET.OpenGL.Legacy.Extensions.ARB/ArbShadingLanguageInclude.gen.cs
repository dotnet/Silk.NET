...
namespace Silk.NET.OpenGL.Legacy.Extensions.ARB
{
    ...
    public unsafe partial class ArbShadingLanguageInclude : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glCompileShaderIncludeARB", Convention = CallingConvention.Winapi)]
        public unsafe partial void CompileShaderInclude([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint shader, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte* path, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] int* length);
        ...
        [NativeApi(EntryPoint = "glDeleteNamedStringARB", Convention = CallingConvention.Winapi)]
        public partial void DeleteNamedString([Flow(Silk.NET.Core.Native.FlowDirection.In)] int namelen, [Count(Parameter = "namelen"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name);
        ...
        [NativeApi(EntryPoint = "glIsNamedStringARB", Convention = CallingConvention.Winapi)]
        public partial bool IsNamedString([Flow(Silk.NET.Core.Native.FlowDirection.In)] int namelen, [Count(Parameter = "namelen"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name);
        ...
        public unsafe void CompileShaderInclude([Flow(Silk.NET.Core.Native.FlowDirection.In)] uint shader, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte* path, [Count(Parameter = "count"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<int> length)
        {
            // ImplicitCountSpanOverloader
        ...
        public unsafe byte GetNamedString([Flow(Silk.NET.Core.Native.FlowDirection.In)] int namelen, [Count(Parameter = "namelen"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(Silk.NET.Core.Native.FlowDirection.Out)] int* stringlen)
        {
            // NonKhrReturnTypeOverloader
        ...
        public unsafe byte GetNamedString([Flow(Silk.NET.Core.Native.FlowDirection.In)] int namelen, [Count(Parameter = "namelen"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out int stringlen)
        {
            // NonKhrReturnTypeOverloader
        ...
        public unsafe int GetNamedString([Flow(Silk.NET.Core.Native.FlowDirection.In)] int namelen, [Count(Parameter = "namelen"), Flow(Silk.NET.Core.Native.FlowDirection.In)] in byte name, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ARB pname)
        {
            // NonKhrReturnTypeOverloader
