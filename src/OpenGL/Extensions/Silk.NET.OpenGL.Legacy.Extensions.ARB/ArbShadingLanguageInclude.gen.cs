...
namespace Silk.NET.OpenGL.Legacy.Extensions.ARB
{
    ...
    public unsafe partial class ArbShadingLanguageInclude : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetNamedStringARB")]
        public unsafe partial void GetNamedString([Flow(FlowDirection.In)] int namelen, [Flow(FlowDirection.In)] string name, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] int* stringlen, [Flow(FlowDirection.Out)] out string @string);
