...
namespace Silk.NET.OpenGL.Legacy.Extensions.ARB
{
    ...
    public unsafe partial class ArbRobustness : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetnPolygonStippleARB")]
        public partial void GetnPolygonStipple([Flow(FlowDirection.In)] uint bufSize, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string pattern);
