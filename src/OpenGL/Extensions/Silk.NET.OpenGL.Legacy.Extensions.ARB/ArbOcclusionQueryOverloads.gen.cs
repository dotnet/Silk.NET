...
namespace Silk.NET.OpenGL.Legacy.Extensions.ARB
{
    public static class ArbOcclusionQueryOverloads
    {
        ...
        public static unsafe void DeleteQueries(this ArbOcclusionQuery thisApi, [Flow(FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(FlowDirection.In)] ReadOnlySpan<Query> ids)
        {
            // SpanOverloader
            thisApi.DeleteQueries(n, in ids.GetPinnableReference());
        }
        ...
        public static unsafe void GenQueries(this ArbOcclusionQuery thisApi, [Flow(FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(FlowDirection.Out)] Span<Query> ids)
        {
            // SpanOverloader
            thisApi.GenQueries(n, out ids.GetPinnableReference());
        }
