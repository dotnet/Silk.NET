...
namespace Silk.NET.OpenGL.Legacy.Extensions.ARB
{
    public static class ArbES2CompatibilityOverloads
    {
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] ReadOnlySpan<uint> shaders, [Flow(FlowDirection.In)] ARB binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] uint* shaders, [Flow(FlowDirection.In)] ShaderBinaryFormat binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
            fixed (void* binarySpp = binary)
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] ReadOnlySpan<uint> shaders, [Flow(FlowDirection.In)] ShaderBinaryFormat binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
            fixed (void* binarySpp = binary)
                thisApi.ShaderBinary(count, in shaders.GetPinnableReference(), binaryFormat, binarySpp, length);
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] Shader* shaders, [Flow(FlowDirection.In)] ARB binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
            fixed (void* binarySpp = binary)
                thisApi.ShaderBinary(count, shaders, binaryFormat, binarySpp, length);
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] ReadOnlySpan<Shader> shaders, [Flow(FlowDirection.In)] ARB binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
            fixed (void* binarySpp = binary)
                thisApi.ShaderBinary(count, in shaders.GetPinnableReference(), binaryFormat, binarySpp, length);
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] Shader* shaders, [Flow(FlowDirection.In)] ShaderBinaryFormat binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
            fixed (void* binarySpp = binary)
                thisApi.ShaderBinary(count, shaders, binaryFormat, binarySpp, length);
        ...
        public static unsafe void ShaderBinary<T0>(this ArbES2Compatibility thisApi, [Flow(FlowDirection.In)] uint count, [Count(Parameter = "count"), Flow(FlowDirection.In)] ReadOnlySpan<Shader> shaders, [Flow(FlowDirection.In)] ShaderBinaryFormat binaryFormat, [Count(Parameter = "length"), Flow(FlowDirection.In)] Span<T0> binary, [Flow(FlowDirection.In)] uint length) where T0 : struct
        {
            // SpanOverloader
            fixed (void* binarySpp = binary)
                thisApi.ShaderBinary(count, in shaders.GetPinnableReference(), binaryFormat, binarySpp, length);
