...
namespace Silk.NET.OpenGL.Legacy.Extensions.NVX
{
    ...
    public unsafe partial class NvxLinkedGpuMulticast : NativeExtension<GL>
    {
        ...
        [System.Runtime.CompilerServices.MethodImpl((System.Runtime.CompilerServices.MethodImplOptions)(512 | 256))]
        public unsafe void LgpunamedBufferSubData([Flow(FlowDirection.In)] uint gpuMask, [Flow(FlowDirection.In)] uint buffer, [Flow(FlowDirection.In)] IntPtr offset, [Flow(FlowDirection.In)] UIntPtr size, [Flow(FlowDirection.In)] void* data)
            => ImplLgpunamedBufferSubData(gpuMask, buffer, offset, size, data);
        ...
        [NativeApi(EntryPoint = "glLGPUNamedBufferSubDataNVX")]
        [System.Runtime.CompilerServices.MethodImpl((System.Runtime.CompilerServices.MethodImplOptions)(512 | 256))]
        public void LgpunamedBufferSubData<T0>([Flow(FlowDirection.In)] uint gpuMask, [Flow(FlowDirection.In)] uint buffer, [Flow(FlowDirection.In)] IntPtr offset, [Flow(FlowDirection.In)] UIntPtr size, [Flow(FlowDirection.In)] Span<T0> data) where T0 : unmanaged
            => ImplLgpunamedBufferSubData<T0>(gpuMask, buffer, offset, size, data);
