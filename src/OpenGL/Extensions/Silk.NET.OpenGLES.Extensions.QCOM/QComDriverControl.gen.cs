...
namespace Silk.NET.OpenGLES.Extensions.QCOM
{
    ...
    public unsafe partial class QComDriverControl : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetDriverControlStringQCOM")]
        public unsafe partial void GetDriverControlString([Flow(FlowDirection.In)] uint driverControl, [Flow(FlowDirection.In)] uint bufSize, [Flow(FlowDirection.Out)] uint* length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string driverControlString);
        ...
        [NativeApi(EntryPoint = "glGetDriverControlStringQCOM")]
        public partial void GetDriverControlString([Flow(FlowDirection.In)] uint driverControl, [Flow(FlowDirection.In)] uint bufSize, [Flow(FlowDirection.Out)] out uint length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string driverControlString);
