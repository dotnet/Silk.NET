...
namespace Silk.NET.OpenGLES.Extensions.QCOM
{
    ...
    public unsafe partial class QComExtendedGet2 : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glExtGetProgramBinarySourceQCOM")]
        public unsafe partial void ExtGetProgramBinarySource([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] QCOM shadertype, [Count(Parameter = "length"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string source, [Flow(FlowDirection.Out)] int* length);

        [NativeApi(EntryPoint = "glExtGetProgramBinarySourceQCOM")]
        public partial void ExtGetProgramBinarySource([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] QCOM shadertype, [Count(Parameter = "length"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string source, [Flow(FlowDirection.Out)] out int length);
        ...
        [NativeApi(EntryPoint = "glExtGetProgramBinarySourceQCOM")]
        public unsafe partial void ExtGetProgramBinarySource([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] ShaderType shadertype, [Count(Parameter = "length"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string source, [Flow(FlowDirection.Out)] int* length);

        [NativeApi(EntryPoint = "glExtGetProgramBinarySourceQCOM")]
        public partial void ExtGetProgramBinarySource([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] ShaderType shadertype, [Count(Parameter = "length"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string source, [Flow(FlowDirection.Out)] out int length);
