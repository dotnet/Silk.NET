...
namespace Silk.NET.OpenGLES.Extensions.OES
{
    ...
    public abstract unsafe partial class OesCopyImage : NativeExtension<GL>
    {
        ...
        public OesCopyImage(ref NativeApiContext ctx)
            : base(ref ctx)
        {
        }
    }
