...
namespace Silk.NET.OpenGL.Extensions.ARB
{
    ...
    public unsafe partial class ArbSeparateShaderObjects : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetProgramPipelineInfoLog")]
        public unsafe partial void GetProgramPipelineInfoLog([Flow(FlowDirection.In)] uint pipeline, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] uint* length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string infoLog);
        ...
        [NativeApi(EntryPoint = "glGetProgramPipelineInfoLog")]
        public partial void GetProgramPipelineInfoLog([Flow(FlowDirection.In)] uint pipeline, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] out uint length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string infoLog);
