...
namespace Silk.NET.OpenGL.Extensions.ARB
{
    ...
    public unsafe partial class ArbShaderSubroutine : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetSubroutineIndex")]
        public partial uint GetSubroutineIndex([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] ARB shadertype, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetSubroutineIndex")]
        public partial uint GetSubroutineIndex([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] ShaderType shadertype, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetSubroutineUniformLocation")]
        public partial int GetSubroutineUniformLocation([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] ARB shadertype, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
        ...
        [NativeApi(EntryPoint = "glGetSubroutineUniformLocation")]
        public partial int GetSubroutineUniformLocation([Flow(FlowDirection.In)] uint program, [Flow(FlowDirection.In)] ShaderType shadertype, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name);
