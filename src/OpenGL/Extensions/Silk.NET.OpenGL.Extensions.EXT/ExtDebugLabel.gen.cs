...
namespace Silk.NET.OpenGL.Extensions.EXT
{
    ...
    public unsafe partial class ExtDebugLabel : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetObjectLabelEXT")]
        public unsafe partial void GetObjectLabel([Flow(FlowDirection.In)] EXT type, [Flow(FlowDirection.In)] uint @object, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] uint* length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string label);
        ...
        [NativeApi(EntryPoint = "glGetObjectLabelEXT")]
        public partial void GetObjectLabel([Flow(FlowDirection.In)] EXT type, [Flow(FlowDirection.In)] uint @object, [Flow(FlowDirection.In)] uint bufSize, [Count(Count = 1), Flow(FlowDirection.Out)] out uint length, [Count(Parameter = "bufSize"), Flow(FlowDirection.Out), UnmanagedType(UnmanagedType.LPUTF8Str)] out string label);
        ...
        [NativeApi(EntryPoint = "glLabelObjectEXT")]
        public partial void LabelObject([Flow(FlowDirection.In)] EXT type, [Flow(FlowDirection.In)] uint @object, [Flow(FlowDirection.In)] uint length, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string label);
