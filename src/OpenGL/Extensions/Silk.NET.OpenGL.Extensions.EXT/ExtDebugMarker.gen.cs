...
namespace Silk.NET.OpenGL.Extensions.EXT
{
    ...
    public unsafe partial class ExtDebugMarker : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glInsertEventMarkerEXT")]
        public partial void InsertEventMarker([Flow(FlowDirection.In)] uint length, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string marker);
        ...
        [NativeApi(EntryPoint = "glPushGroupMarkerEXT")]
        public partial void PushGroupMarker([Flow(FlowDirection.In)] uint length, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string marker);
