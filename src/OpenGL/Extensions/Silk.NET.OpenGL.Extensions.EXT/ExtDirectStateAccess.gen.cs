...
namespace Silk.NET.OpenGL.Extensions.EXT
{
    ...
    public unsafe partial class ExtDirectStateAccess : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glGetNamedBufferPointervEXT")]
        public unsafe partial void GetNamedBufferPointer<T0>([Flow(FlowDirection.In)] uint buffer, [Flow(FlowDirection.In)] EXT pname, [Count(Count = 1), Flow(FlowDirection.Out)] out T0* @params) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "glGetPointeri_vEXT")]
        public unsafe partial void GetPointer<T0>([Flow(FlowDirection.In)] EXT pname, [Flow(FlowDirection.In)] uint index, [Count(Count = 1), Flow(FlowDirection.Out)] out T0* @params) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "glGetPointerIndexedvEXT")]
        public unsafe partial void GetPointerIndexed<T0>([Flow(FlowDirection.In)] EXT target, [Flow(FlowDirection.In)] uint index, [Count(Count = 1), Flow(FlowDirection.Out)] out T0* data) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "glGetVertexArrayPointervEXT")]
        public unsafe partial void GetVertexArrayPointer<T0>([Flow(FlowDirection.In)] uint vaobj, [Flow(FlowDirection.In)] EXT pname, [Count(Count = 1), Flow(FlowDirection.Out)] out T0* param) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "glGetNamedBufferPointervEXT")]
        public unsafe partial void GetNamedBufferPointer<T0>([Flow(FlowDirection.In)] uint buffer, [Flow(FlowDirection.In)] BufferPointerNameARB pname, [Count(Count = 1), Flow(FlowDirection.Out)] out T0* @params) where T0 : unmanaged;
        ...
        [NativeApi(EntryPoint = "glGetVertexArrayPointervEXT")]
        public unsafe partial void GetVertexArrayPointer<T0>([Flow(FlowDirection.In)] uint vaobj, [Flow(FlowDirection.In)] VertexArrayPName pname, [Count(Count = 1), Flow(FlowDirection.Out)] out T0* param) where T0 : unmanaged;
