...
namespace Silk.NET.OpenGL.Legacy.Extensions.OES
{
    ...
    public unsafe partial class OesFixedPoint : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glBitmapxOES")]
        public partial void Bitmapx([Flow(FlowDirection.In)] uint width, [Flow(FlowDirection.In)] uint height, [Flow(FlowDirection.In)] int xorig, [Flow(FlowDirection.In)] int yorig, [Flow(FlowDirection.In)] int xmove, [Flow(FlowDirection.In)] int ymove, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string bitmap);
