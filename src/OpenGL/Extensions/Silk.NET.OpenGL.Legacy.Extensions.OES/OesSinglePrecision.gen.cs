...
namespace Silk.NET.OpenGL.Legacy.Extensions.OES
{
    ...
    public unsafe partial class OesSinglePrecision : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glClipPlanefOES", Convention = CallingConvention.Winapi)]
        public partial void ClipPlane([Flow(Silk.NET.Core.Native.FlowDirection.In)] OES plane, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float equation);
        ...
        [NativeApi(EntryPoint = "glClipPlanefOES", Convention = CallingConvention.Winapi)]
        public partial void ClipPlane([Flow(Silk.NET.Core.Native.FlowDirection.In)] ClipPlaneName plane, [Count(Count = 4), Flow(Silk.NET.Core.Native.FlowDirection.In)] in float equation);
