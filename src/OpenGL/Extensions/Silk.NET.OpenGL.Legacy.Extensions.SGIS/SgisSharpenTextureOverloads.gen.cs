...
namespace Silk.NET.OpenGL.Legacy.Extensions.SGIS
{
    public static class SgisSharpenTextureOverloads
    {
        ...
        public static unsafe void SharpenTexFunc(this SgisSharpenTexture thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] SGIS target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> points)
        {
            // SpanOverloader
            thisApi.SharpenTexFunc(target, n, in points.GetPinnableReference());
        }

        public static unsafe void SharpenTexFunc(this SgisSharpenTexture thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] TextureTarget target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> points)
        {
            // SpanOverloader
            thisApi.SharpenTexFunc(target, n, in points.GetPinnableReference());
        }
