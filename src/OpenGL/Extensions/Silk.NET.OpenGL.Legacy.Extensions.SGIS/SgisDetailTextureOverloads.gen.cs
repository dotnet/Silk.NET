...
namespace Silk.NET.OpenGL.Legacy.Extensions.SGIS
{
    ...
    {
        public static unsafe void DetailTexFunc(this SgisDetailTexture thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] SGIS target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> points)
        {
            // SpanOverloader
            thisApi.DetailTexFunc(target, n, in points.GetPinnableReference());
        }

        public static unsafe void DetailTexFunc(this SgisDetailTexture thisApi, [Flow(Silk.NET.Core.Native.FlowDirection.In)] TextureTarget target, [Flow(Silk.NET.Core.Native.FlowDirection.In)] uint n, [Count(Parameter = "n"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<float> points)
        {
            // SpanOverloader
            thisApi.DetailTexFunc(target, n, in points.GetPinnableReference());
        }
