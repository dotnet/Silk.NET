...
namespace Silk.NET.OpenGL.Legacy.Extensions.SGIS
{
    ...
    public unsafe partial class SgisDetailTexture : NativeExtension<GL>
    {
        ...
        public unsafe partial void DetailTexFunc([Flow(FlowDirection.In)] SGIS target, [Flow(FlowDirection.In)] uint n, [Count(Parameter = "n", Expression = "*2"), Flow(FlowDirection.In)] float* points);

        [NativeApi(EntryPoint = "glDetailTexFuncSGIS", Convention = CallingConvention.Winapi)]
        public partial void DetailTexFunc([Flow(FlowDirection.In)] SGIS target, [Flow(FlowDirection.In)] uint n, [Count(Parameter = "n", Expression = "*2"), Flow(FlowDirection.In)] in float points);

        [NativeApi(EntryPoint = "glDetailTexFuncSGIS", Convention = CallingConvention.Winapi)]
        public unsafe partial void DetailTexFunc([Flow(FlowDirection.In)] TextureTarget target, [Flow(FlowDirection.In)] uint n, [Count(Parameter = "n", Expression = "*2"), Flow(FlowDirection.In)] float* points);

        [NativeApi(EntryPoint = "glDetailTexFuncSGIS", Convention = CallingConvention.Winapi)]
        public partial void DetailTexFunc([Flow(FlowDirection.In)] TextureTarget target, [Flow(FlowDirection.In)] uint n, [Count(Parameter = "n", Expression = "*2"), Flow(FlowDirection.In)] in float points);
