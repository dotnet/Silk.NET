...
namespace Silk.NET.OpenGL.Legacy.Extensions.IBM
{
    ...
    public unsafe partial class IbmVertexArrayLists : NativeExtension<GL>
    {
        ...
        [NativeApi(EntryPoint = "glColorPointerListIBM", Convention = CallingConvention.Winapi)]
        public unsafe partial void ColorPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] int size, [Flow(Silk.NET.Core.Native.FlowDirection.In)] IBM type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "size, type, stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly void* pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);

        [NativeApi(EntryPoint = "glColorPointerListIBM", Convention = CallingConvention.Winapi)]
        public unsafe partial void ColorPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] int size, [Flow(Silk.NET.Core.Native.FlowDirection.In)] IBM type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "size, type, stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] nint* pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);

        [NativeApi(EntryPoint = "glColorPointerListIBM", Convention = CallingConvention.Winapi)]
        public partial void ColorPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] int size, [Flow(Silk.NET.Core.Native.FlowDirection.In)] IBM type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "size, type, stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);
        ...
        [Obsolete("This overload exposes native-sized integer parameters (which are expressed as pointers in the original C function) as C# references due to a historical error, please consider using overloads that expose the following parameters as raw pointers or native integers instead: pointer")]
        [NativeApi(EntryPoint = "glEdgeFlagPointerListIBM", Convention = CallingConvention.Winapi)]
        public unsafe partial void EdgeFlagPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly bool* pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);
        ...
        [NativeApi(EntryPoint = "glEdgeFlagPointerListIBM", Convention = CallingConvention.Winapi)]
        public partial void EdgeFlagPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);
        ...
        [NativeApi(EntryPoint = "glFogCoordPointerListIBM", Convention = CallingConvention.Winapi)]
        public partial void FogCoordPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] IBM type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "type, stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);
        ...
        [NativeApi(EntryPoint = "glIndexPointerListIBM", Convention = CallingConvention.Winapi)]
        public partial void IndexPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] IBM type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "type, stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);
        ...
        [NativeApi(EntryPoint = "glNormalPointerListIBM", Convention = CallingConvention.Winapi)]
        public partial void NormalPointerList([Flow(Silk.NET.Core.Native.FlowDirection.In)] IBM type, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int stride, [Count(Computed = "type, stride"), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly nint pointer, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ptrstride);
