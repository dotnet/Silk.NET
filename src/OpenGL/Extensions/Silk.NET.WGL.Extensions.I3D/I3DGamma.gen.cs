...
namespace Silk.NET.WGL.Extensions.I3D
{
    ...
    public unsafe partial class I3DGamma : NativeExtension<WGL>
    {
        ...
        [NativeApi(EntryPoint = "wglSetGammaTableI3D", Convention = CallingConvention.Winapi)]
        public unsafe partial Silk.NET.Core.Bool32 SetGammaTableI3D([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hDC, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int iEntries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ushort* puRed, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ushort puGreen, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ushort* puBlue);

        [NativeApi(EntryPoint = "wglSetGammaTableI3D", Convention = CallingConvention.Winapi)]
        public unsafe partial Silk.NET.Core.Bool32 SetGammaTableI3D([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hDC, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int iEntries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ushort* puRed, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ushort puGreen, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ushort puBlue);

        [NativeApi(EntryPoint = "wglSetGammaTableI3D", Convention = CallingConvention.Winapi)]
        public unsafe partial Silk.NET.Core.Bool32 SetGammaTableI3D([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hDC, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int iEntries, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in ushort puRed, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ushort* puGreen, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ushort* puBlue);
        ...
        [NativeApi(EntryPoint = "wglSetGammaTableParametersI3D", Convention = CallingConvention.Winapi)]
        public partial Silk.NET.Core.Bool32 SetGammaTableParametersI3D([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hDC, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int iAttribute, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in int piValue);
