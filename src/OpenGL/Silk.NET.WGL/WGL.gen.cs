...
namespace Silk.NET.WGL
{
    public unsafe partial class WGL : NativeAPI
    {
        ...
        [NativeApi(EntryPoint = "ChoosePixelFormat", Convention = CallingConvention.Winapi)]
        public partial int ChoosePixelFormat([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hDc, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in PixelFormatDescriptor pPfd);
        ...
        [NativeApi(EntryPoint = "SetPixelFormat", Convention = CallingConvention.Winapi)]
        public partial Silk.NET.Core.Bool32 SetPixelFormat([Flow(Silk.NET.Core.Native.FlowDirection.In)] nint hdc, [Flow(Silk.NET.Core.Native.FlowDirection.In)] int ipfd, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in PixelFormatDescriptor ppfd);
