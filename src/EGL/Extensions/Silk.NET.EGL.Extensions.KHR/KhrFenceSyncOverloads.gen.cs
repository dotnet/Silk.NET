...
namespace Silk.NET.EGL.Extensions.KHR
{
    public static class KhrFenceSyncOverloads
    {
        ...
        public static unsafe bool GetSyncAttrib(this KhrFenceSync thisApi, [Flow(FlowDirection.In)] nint dpy, [Flow(FlowDirection.In)] nint sync, [Flow(FlowDirection.In)] int attribute, [Flow(FlowDirection.Out)] Span<int> value)
        {
            // SpanOverloader
