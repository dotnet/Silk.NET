...
{
    public static class KhrReusableSyncOverloads
    {
        public static unsafe nint CreateSync(this KhrReusableSync thisApi, [Flow(FlowDirection.In)] nint dpy, [Flow(FlowDirection.In)] KHR type, [Flow(FlowDirection.In)] ReadOnlySpan<int> attrib_list)
        {
            // SpanOverloader
