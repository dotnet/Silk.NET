...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "__AnonymousRecord_propidlbase_L303_C3")]
    public unsafe partial struct PropVariantUnion
    {
        public PropVariantUnion
        (
            PropVariantUnionUnion? anonymous = null,
        ...
        [FieldOffset(0)]
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_propidlbase_L305_C1")]
        [NativeName("Name", "anonymous1")]
        public PropVariantUnionUnion Anonymous;

        [FieldOffset(0)]
        [NativeName("Type", "DECIMAL")]
        [NativeName("Type.Name", "DECIMAL")]
        [NativeName("Name", "decVal")]
