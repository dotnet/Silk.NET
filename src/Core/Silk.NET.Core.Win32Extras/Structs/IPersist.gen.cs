...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "IPersist")]
    public unsafe partial struct IPersist : IComVtbl<IPersist>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        public static implicit operator Silk.NET.Core.Native.IUnknown(IPersist val)
            => Unsafe.As<IPersist, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (IPersist*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
