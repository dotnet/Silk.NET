...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "ISupportErrorInfo")]
    public unsafe partial struct ISupportErrorInfo : IComVtbl<ISupportErrorInfo>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("df0b3d60-548f-101b-8e65-08002b2bd119");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator Silk.NET.Core.Native.IUnknown(ISupportErrorInfo val)
            => Unsafe.As<ISupportErrorInfo, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (ISupportErrorInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int InterfaceSupportsErrorInfo(Guid* riid)
        {
            var @this = (ISupportErrorInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int InterfaceSupportsErrorInfo(ref Guid riid)
        {
            var @this = (ISupportErrorInfo*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (Guid* riidPtr = &riid)
