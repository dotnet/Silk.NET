...
namespace Silk.NET.Core.Win32Extras
{
    ...
    public unsafe partial struct EventInstanceHeader
    {
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L586_C5")]
        [NativeName("Name", "anonymous1")]
        public EventInstanceHeaderUnion1 Anonymous1;

        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L593_C5")]
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L607_C5")]
