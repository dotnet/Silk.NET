...
public unsafe static class MarshalingStreamVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Write<T0>(this ComPtr<IMarshalingStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pv, uint cb, uint* pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
    ...
    /// <summary>To be documented.</summary>
    public static int Write<T0>(this ComPtr<IMarshalingStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly T0 pv, uint cb, ref uint pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
