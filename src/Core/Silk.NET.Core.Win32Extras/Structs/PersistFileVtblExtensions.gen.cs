...
public unsafe static class PersistFileVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static int Load(this ComPtr<IPersistFile> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char pszFileName, uint dwMode)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static int Save(this ComPtr<IPersistFile> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char pszFileName, Silk.NET.Core.Bool32 fRemember)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* pszFileNamePtr = &pszFileName)
    ...
    /// <summary>To be documented.</summary>
    public static int SaveCompleted(this ComPtr<IPersistFile> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in char pszFileName)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (char* pszFileNamePtr = &pszFileName)
