...
namespace Silk.NET.Core.Win32Extras
{
    ...
    public unsafe partial struct EventInstanceHeaderUnion2
    {
        ...
        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/shared\\evntrace.h:928:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.22000.0/shared\\evntrace.h:928:9)")]
