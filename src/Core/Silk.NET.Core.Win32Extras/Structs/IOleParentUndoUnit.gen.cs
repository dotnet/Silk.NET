...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "IOleParentUndoUnit")]
    public unsafe partial struct IOleParentUndoUnit : IComVtbl<IOleParentUndoUnit>, IComVtbl<IOleUndoUnit>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("a1faf330-ef97-11ce-9bc9-00aa00608e01");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator IOleUndoUnit(IOleParentUndoUnit val)
            => Unsafe.As<IOleParentUndoUnit, IOleUndoUnit>(ref val);

        public static implicit operator Silk.NET.Core.Native.IUnknown(IOleParentUndoUnit val)
            => Unsafe.As<IOleParentUndoUnit, Silk.NET.Core.Native.IUnknown>(ref val);
        ...
        {
            var @this = (IOleParentUndoUnit*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int FindUnit(IOleUndoUnit* pUU)
        {
            var @this = (IOleParentUndoUnit*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int FindUnit(ref IOleUndoUnit pUU)
        {
            var @this = (IOleParentUndoUnit*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (IOleUndoUnit* pUUPtr = &pUU)
        ...
        /// <summary>To be documented.</summary>
        public readonly unsafe int GetParentState(uint* pdwState)
        {
            var @this = (IOleParentUndoUnit*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int GetParentState(ref uint pdwState)
        {
            var @this = (IOleParentUndoUnit*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int FindUnit<TI0>(ComPtr<TI0> pUU) where TI0 : unmanaged, IComVtbl<IOleUndoUnit>, IComVtbl<TI0>
        {
            var @this = (IOleParentUndoUnit*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            // ComPtrOverloader
