...
namespace Silk.NET.Core.Win32Extras
{
    ...
    public unsafe partial struct ReasonContextReason
    {
        ...
        [FieldOffset(0)]
        [NativeName("Type", "struct (unnamed struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/um\\minwinbase.h:269:9)")]
        [NativeName("Type.Name", "struct (unnamed struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/um\\minwinbase.h:269:9)")]
