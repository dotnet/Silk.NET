...
public unsafe static class MultiQIVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IMultiQI> thisVtbl, Guid* riid, ref void* ppvObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IMultiQI> thisVtbl, ref Guid riid, void** ppvObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IMultiQI> thisVtbl, ref Guid riid, ref void* ppvObject)
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (Guid* riidPtr = &riid)
    ...
    /// <summary>To be documented.</summary>
    public static int QueryInterface<TI0>(this ComPtr<IMultiQI> thisVtbl, out ComPtr<TI0> ppvObject) where TI0 : unmanaged, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
        // ComPtrOverloader
        ppvObject = default;
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IMultiQI> thisVtbl, Span<Guid> riid, void** ppvObject)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int QueryInterface(this ComPtr<IMultiQI> thisVtbl, Span<Guid> riid, ref void* ppvObject)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
    ...
    public static int QueryMultipleInterfaces(this ComPtr<IMultiQI> thisVtbl, uint cMQIs, Span<MultiQi> pMQIs)
    {
        var @this = thisVtbl.Handle;
        // SpanOverloader
        return @this->QueryMultipleInterfaces(cMQIs, ref pMQIs.GetPinnableReference());
    }

    /// <summary>To be documented.</summary>
    public static ComPtr<TI0> QueryInterface<TI0>(this ComPtr<IMultiQI> thisVtbl) where TI0 : unmanaged, IComVtbl<TI0>
    {
        var @this = thisVtbl.Handle;
