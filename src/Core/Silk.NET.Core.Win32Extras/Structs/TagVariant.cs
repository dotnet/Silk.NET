...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "TagVariant")]
    public unsafe partial struct TagVariant
    {
        public TagVariant
        (
            TagVariantUnion? anonymous = null,
            TagDecimal? decVal = null,
            ushort? vt = null,
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_oaidl_L478_C5")]
        [NativeName("Name", "anonymous1")]
        public TagVariantUnion Anonymous;
#if NETSTANDARD2_1 || NETCOREAPP3_1 || NET5_0 || NET5_0_OR_GREATER
        public ref TagDecimal DecVal
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref MemoryMarshal.CreateSpan(ref Anonymous, 1)[0].DecVal;
        }
#else
        public TagDecimal DecVal
        {
            get => Anonymous.DecVal;
            set => Anonymous.DecVal = value;
        }
#endif
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref MemoryMarshal.CreateSpan(ref Anonymous, 1)[0].Vt;
        }
#else
        public ushort Vt
        {
            get => Anonymous.Vt;
            set => Anonymous.Vt = value;
        }
#endif
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref MemoryMarshal.CreateSpan(ref Anonymous, 1)[0].WReserved1;
        }
#else
        public ushort WReserved1
        {
            get => Anonymous.WReserved1;
            set => Anonymous.WReserved1 = value;
        }
#endif
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref MemoryMarshal.CreateSpan(ref Anonymous, 1)[0].WReserved2;
        }
#else
        public ushort WReserved2
        {
            get => Anonymous.WReserved2;
            set => Anonymous.WReserved2 = value;
        }
#endif
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref MemoryMarshal.CreateSpan(ref Anonymous, 1)[0].WReserved3;
        }
#else
        public ushort WReserved3
        {
            get => Anonymous.WReserved3;
            set => Anonymous.WReserved3 = value;
        }
#endif
