...
public unsafe static class LockBytesVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int WriteAt<T0>(this ComPtr<ILockBytes> thisVtbl, ulong ulOffset, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 pv, uint cb, uint* pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
    ...
    /// <summary>To be documented.</summary>
    public static int WriteAt<T0>(this ComPtr<ILockBytes> thisVtbl, ulong ulOffset, [Flow(Silk.NET.Core.Native.FlowDirection.In)] in T0 pv, uint cb, ref uint pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
