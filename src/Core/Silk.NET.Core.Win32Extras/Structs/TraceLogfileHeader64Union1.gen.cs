...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "__AnonymousRecord_evntrace_L785_C5")]
    public unsafe partial struct TraceLogfileHeader64Union1
    {
        ...
        [FieldOffset(0)]
        [NativeName("Type", "struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\evntrace.h:787:9)")]
        [NativeName("Type.Name", "struct (anonymous struct at C:/Program Files (x86)/Windows Kits/10/Include/10.0.19041.0/shared\\evntrace.h:787:9)")]
