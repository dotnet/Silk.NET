...
namespace Silk.NET.Core.Win32Extras
{
    ...
    public unsafe partial struct IPersistFile : IComVtbl<IPersistFile>, IComVtbl<IPersist>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        ...
        /// <summary>To be documented.</summary>
        public readonly int Load([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char pszFileName, uint dwMode)
        {
            var @this = (IPersistFile*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
        ...
        /// <summary>To be documented.</summary>
        public readonly int Save([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char pszFileName, Silk.NET.Core.Bool32 fRemember)
        {
            var @this = (IPersistFile*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (char* pszFileNamePtr = &pszFileName)
        ...
        /// <summary>To be documented.</summary>
        public readonly int SaveCompleted([Flow(Silk.NET.Core.Native.FlowDirection.In)] in char pszFileName)
        {
            var @this = (IPersistFile*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
            fixed (char* pszFileNamePtr = &pszFileName)
