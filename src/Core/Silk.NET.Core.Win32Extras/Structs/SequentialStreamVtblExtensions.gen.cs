...
public unsafe static class SequentialStreamVtblExtensions
{
    ...
    /// <summary>To be documented.</summary>
    public static unsafe int Write<T0>(this ComPtr<ISequentialStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in T0 pv, uint cb, uint* pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
    ...
    /// <summary>To be documented.</summary>
    public static int Write<T0>(this ComPtr<ISequentialStream> thisVtbl, [Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in T0 pv, uint cb, ref uint pcbWritten) where T0 : unmanaged
    {
        var @this = thisVtbl.Handle;
        int ret = default;
        fixed (void* pvPtr = &pv)
