...
namespace Silk.NET.Core.Win32Extras
{
    ...
    [NativeName("Name", "AsyncIAdviseSink")]
    public unsafe partial struct AsyncIAdviseSink : IComVtbl<AsyncIAdviseSink>, IComVtbl<Silk.NET.Core.Native.IUnknown>
    {
        public static readonly Guid Guid = new("00000150-0000-0000-c000-000000000046");

        void*** IComVtbl.AsVtblPtr()
            => (void***) Unsafe.AsPointer(ref Unsafe.AsRef(in this));

        public static implicit operator Silk.NET.Core.Native.IUnknown(AsyncIAdviseSink val)
            => Unsafe.As<AsyncIAdviseSink, Silk.NET.Core.Native.IUnknown>(ref val);

        public AsyncIAdviseSink
        (
            void** lpVtbl = null
        ) : this()
        {
        ...
        {
            var @this = (AsyncIAdviseSink*) Unsafe.AsPointer(ref Unsafe.AsRef(in this));
            int ret = default;
