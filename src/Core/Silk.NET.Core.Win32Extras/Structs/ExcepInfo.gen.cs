...
namespace Silk.NET.Core.Win32Extras
{
    ...
    public unsafe partial struct ExcepInfo
    {
        ...
        [NativeName("Type", "HRESULT (*)(struct tagEXCEPINFO *) __attribute__((stdcall))")]
        [NativeName("Type.Name", "HRESULT (*)(struct tagEXCEPINFO *) __attribute__((stdcall))")]
