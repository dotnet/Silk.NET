...
{
    [NativeName("Name", "__AnonymousRecord_evntrace_L787_C9")]
    public unsafe partial struct TraceLogfileHeader64Union1VersionDetail
    {
        public TraceLogfileHeader64Union1VersionDetail
        (
