...
namespace Silk.NET.Core.Native
{
    ...
    public unsafe partial struct EventTraceHeader
    {
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L546_C5")]
        [NativeName("Name", "anonymous1")]
        public EventTraceHeaderUnion1 Anonymous1;

        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L553_C5")]
        ...
        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L564_C5")]
        [NativeName("Name", "anonymous3")]
        public EventTraceHeaderUnion3 Anonymous3;

        [NativeName("Type", "")]
        [NativeName("Type.Name", "__AnonymousRecord_evntrace_L568_C5")]
        ...
        public ref ushort FieldTypeFlags
        {
            ...
            get => ref Anonymous1.FieldTypeFlags;
        }
#else
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref Anonymous1.MarkerFlags;
        }
#else
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref Anonymous4.ProcessorTime;
        }
#else
        ...
        {
            [MethodImpl((MethodImplOptions) 768)]
            get => ref Anonymous4.ClientContext;
        }
#else
