...
{
    public static void NoGenericPointersMiddleware(ref IMarshalContext ctx, Action next)
    {
        ...
        IPointerTypeSymbol? returnType = null;
        if (ctx.ReturnLoadType is IPointerTypeSymbol p)
        {
