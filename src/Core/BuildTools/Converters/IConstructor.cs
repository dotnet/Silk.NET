...
namespace Silk.NET.BuildTools.Converters
{
    ...
    public interface IConstructor
    {
        ...
        void WriteFunctions(Profile profile, IEnumerable<Function> functions, ProfileConverterOptions opts, BindTask task);
        ...
        /// <param name="opts">The options for profile conversion.</param>
        void WriteEnums(Profile profile, IEnumerable<Enum> enums, ProfileConverterOptions opts, BindTask task);
        ...
        /// <param name="opts">The options for profile conversion.</param>
        void WriteStructs(Profile profile, IEnumerable<Struct> structs, ProfileConverterOptions opts, BindTask task);
        ...
        /// <param name="opts">The options for profile conversion.</param>
        void WriteConstants(Profile profile, IEnumerable<Constant> constants, ProfileConverterOptions opts, BindTask task);
    }
}
