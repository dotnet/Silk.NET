...
namespace Silk.NET.BuildTools.GLXmlConvert.Construction
{
    ...
    public static class ProfileConstructorExtensions
    {
        ...
        public static void WriteEnums(this Profile profile, IEnumerable<Enum> enums)
        {
            ...
            var gl = profile.ClassName.ToUpper().CheckMemberName(GLXmlConverter.CliOptions.Prefix);
            ...
            foreach (var @enum in enums)
            {
                ...
                else
                {
                    ...
                    if (!mergedEnums.ContainsKey(suffix))
                    {
                        ...
                        (
                            suffix,
                            new Enum{Name = suffix.CheckMemberName(GLXmlConverter.CliOptions.Prefix), ExtensionName = suffix}
                        );
                    }
