...
{
    [NativeName("Name", "VkMemoryWin32HandlePropertiesKHR")]
    public unsafe partial struct MemoryWin32HandlePropertiesKHR : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.MemoryWin32HandlePropertiesKhr;
        }
    }
}
