...
{
    [NativeName("Name", "VkMemoryZirconHandlePropertiesFUCHSIA")]
    public unsafe partial struct MemoryZirconHandlePropertiesFUCHSIA : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.MemoryZirconHandlePropertiesFuchsia;
        }
    }
}
