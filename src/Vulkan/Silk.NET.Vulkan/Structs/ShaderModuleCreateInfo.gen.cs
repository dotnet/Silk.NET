...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct ShaderModuleCreateInfo : IChainStart, IExtendsChain<PipelineShaderStageCreateInfo>, IExtendsChain<DataGraphPipelineCreateInfoARM>
    {
