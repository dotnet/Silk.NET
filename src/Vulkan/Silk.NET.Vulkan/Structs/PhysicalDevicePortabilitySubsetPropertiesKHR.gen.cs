...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct PhysicalDevicePortabilitySubsetPropertiesKHR : IExtendsChain<PhysicalDeviceProperties2>, IExtendsChain<PhysicalDeviceProperties2KHR>
    {
