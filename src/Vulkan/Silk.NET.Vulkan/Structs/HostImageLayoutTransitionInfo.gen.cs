...
{
    [NativeName("Name", "VkHostImageLayoutTransitionInfo")]
    [NativeName("Aliases", "VkHostImageLayoutTransitionInfoEXT")]
    public unsafe partial struct HostImageLayoutTransitionInfo : IChainable
    {
