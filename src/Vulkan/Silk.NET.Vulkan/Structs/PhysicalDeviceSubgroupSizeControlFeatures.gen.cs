...
{
    [NativeName("Name", "VkPhysicalDeviceSubgroupSizeControlFeatures")]
    [NativeName("Aliases", "VkPhysicalDeviceSubgroupSizeControlFeaturesEXT")]
    public unsafe partial struct PhysicalDeviceSubgroupSizeControlFeatures : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
