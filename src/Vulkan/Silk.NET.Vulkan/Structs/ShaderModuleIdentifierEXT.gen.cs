...
{
    [NativeName("Name", "VkShaderModuleIdentifierEXT")]
    public unsafe partial struct ShaderModuleIdentifierEXT : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.ShaderModuleIdentifierExt;
        }
