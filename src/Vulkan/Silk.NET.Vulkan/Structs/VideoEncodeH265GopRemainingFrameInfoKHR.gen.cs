...
{
    [NativeName("Name", "VkVideoEncodeH265GopRemainingFrameInfoKHR")]
    public unsafe partial struct VideoEncodeH265GopRemainingFrameInfoKHR : IExtendsChain<VideoBeginCodingInfoKHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH265GopRemainingFrameInfoKhr;
        }
