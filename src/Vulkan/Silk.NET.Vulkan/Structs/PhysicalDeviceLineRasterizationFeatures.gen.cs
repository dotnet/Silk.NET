...
{
    [NativeName("Name", "VkPhysicalDeviceLineRasterizationFeatures")]
    [NativeName("Aliases", "VkPhysicalDeviceLineRasterizationFeaturesKHR, VkPhysicalDeviceLineRasterizationFeaturesEXT")]
    public unsafe partial struct PhysicalDeviceLineRasterizationFeatures : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceLineRasterizationFeatures;
        }
