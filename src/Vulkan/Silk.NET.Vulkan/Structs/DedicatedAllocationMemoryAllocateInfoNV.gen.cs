...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct DedicatedAllocationMemoryAllocateInfoNV : IExtendsChain<MemoryAllocateInfo>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.DedicatedAllocationMemoryAllocateInfoNV;
        }
