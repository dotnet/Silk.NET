...
{
    [NativeName("Name", "VkExternalComputeQueueDataParamsNV")]
    public unsafe partial struct ExternalComputeQueueDataParamsNV : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.ExternalComputeQueueDataParamsNV;
        }
