...
{
    [NativeName("Name", "VkIndirectExecutionSetShaderLayoutInfoEXT")]
    public unsafe partial struct IndirectExecutionSetShaderLayoutInfoEXT : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.IndirectExecutionSetShaderLayoutInfoExt;
        }
