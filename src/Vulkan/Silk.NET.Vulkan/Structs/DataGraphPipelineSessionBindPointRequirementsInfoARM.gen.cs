...
{
    [NativeName("Name", "VkDataGraphPipelineSessionBindPointRequirementsInfoARM")]
    public unsafe partial struct DataGraphPipelineSessionBindPointRequirementsInfoARM : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.DataGraphPipelineSessionBindPointRequirementsInfoArm;
        }
