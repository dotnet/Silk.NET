...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct AccelerationStructureBuildGeometryInfoKHR : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.AccelerationStructureBuildGeometryInfoKhr;
        }
    }
}
