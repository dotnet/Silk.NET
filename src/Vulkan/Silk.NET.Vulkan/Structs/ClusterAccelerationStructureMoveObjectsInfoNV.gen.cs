...
{
    [NativeName("Name", "VkClusterAccelerationStructureMoveObjectsInfoNV")]
    public unsafe partial struct ClusterAccelerationStructureMoveObjectsInfoNV
    {
        public ClusterAccelerationStructureMoveObjectsInfoNV
        (
            ulong? srcAccelerationStructure = null
        ) : this()
        {
