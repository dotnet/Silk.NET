...
{
    [NativeName("Name", "VkDeviceImageSubresourceInfo")]
    [NativeName("Aliases", "VkDeviceImageSubresourceInfoKHR")]
    public unsafe partial struct DeviceImageSubresourceInfo : IChainable
    {
