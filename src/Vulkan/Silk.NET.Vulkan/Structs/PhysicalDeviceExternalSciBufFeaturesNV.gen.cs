...
{
    [NativeName("Name", "VkPhysicalDeviceExternalSciBufFeaturesNV")]
    [NativeName("AliasOf", "VkPhysicalDeviceExternalMemorySciBufFeaturesNV")]
    public unsafe partial struct PhysicalDeviceExternalSciBufFeaturesNV : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
        public PhysicalDeviceExternalSciBufFeaturesNV
        (
