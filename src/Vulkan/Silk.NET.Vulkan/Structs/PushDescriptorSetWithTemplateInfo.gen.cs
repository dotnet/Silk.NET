...
{
    [NativeName("Name", "VkPushDescriptorSetWithTemplateInfo")]
    [NativeName("Aliases", "VkPushDescriptorSetWithTemplateInfoKHR")]
    public unsafe partial struct PushDescriptorSetWithTemplateInfo : IChainStart
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PushDescriptorSetWithTemplateInfo;
        }
        ...
        public static unsafe ref PushDescriptorSetWithTemplateInfo Chain(
            out PushDescriptorSetWithTemplateInfo capture)
        {
            capture = new PushDescriptorSetWithTemplateInfo(StructureType.PushDescriptorSetWithTemplateInfo);
            return ref capture;
        }
    }
}
