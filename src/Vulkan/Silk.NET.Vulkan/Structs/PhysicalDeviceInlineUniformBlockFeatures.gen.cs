...
{
    [NativeName("Name", "VkPhysicalDeviceInlineUniformBlockFeatures")]
    [NativeName("Aliases", "VkPhysicalDeviceInlineUniformBlockFeaturesEXT")]
    public unsafe partial struct PhysicalDeviceInlineUniformBlockFeatures : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceInlineUniformBlockFeatures;
        }
