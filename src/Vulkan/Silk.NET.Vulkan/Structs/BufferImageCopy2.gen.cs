...
{
    [NativeName("Name", "VkBufferImageCopy2")]
    [NativeName("Aliases", "VkBufferImageCopy2KHR")]
    public unsafe partial struct BufferImageCopy2 : IChainStart
    {
...
/// <summary></summary>
        ...
        public static unsafe ref BufferImageCopy2 Chain(
            out BufferImageCopy2 capture)
        {
            capture = new BufferImageCopy2(StructureType.BufferImageCopy2);
            return ref capture;
        }
    }
}
