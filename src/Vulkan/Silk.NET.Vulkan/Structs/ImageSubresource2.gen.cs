...
{
    [NativeName("Name", "VkImageSubresource2")]
    [NativeName("Aliases", "VkImageSubresource2KHR, VkImageSubresource2EXT")]
    public unsafe partial struct ImageSubresource2 : IChainable
    {
