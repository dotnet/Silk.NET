...
{
    [NativeName("Name", "VkPhysicalDeviceMaintenance6Properties")]
    [NativeName("Aliases", "VkPhysicalDeviceMaintenance6PropertiesKHR")]
    public unsafe partial struct PhysicalDeviceMaintenance6Properties : IExtendsChain<PhysicalDeviceProperties2>, IExtendsChain<PhysicalDeviceProperties2KHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceMaintenance6Properties;
        }
