...
{
    [NativeName("Name", "VkNativeBufferFormatPropertiesOHOS")]
    public unsafe partial struct NativeBufferFormatPropertiesOHOS : IExtendsChain<NativeBufferPropertiesOHOS>
    {
        public NativeBufferFormatPropertiesOHOS
        (
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.NativeBufferFormatPropertiesOhos;
        }
