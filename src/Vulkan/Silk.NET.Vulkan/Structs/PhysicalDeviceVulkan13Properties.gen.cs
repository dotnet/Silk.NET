...
{
    [NativeName("Name", "VkPhysicalDeviceVulkan13Properties")]
    public unsafe partial struct PhysicalDeviceVulkan13Properties : IExtendsChain<PhysicalDeviceProperties2>, IExtendsChain<PhysicalDeviceProperties2KHR>
    {
        ...
        (
            ...
            uint? maxInlineUniformTotalSize = null,
        ...
        ) : this()
        {
            ...
            if (maxInlineUniformTotalSize is not null)
            {
                MaxInlineUniformTotalSize = maxInlineUniformTotalSize.Value;
            }
...
/// <summary></summary>
        [NativeName("Type", "uint32_t")]
        [NativeName("Type.Name", "uint32_t")]
        [NativeName("Name", "maxInlineUniformTotalSize")]
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceVulkan13Properties;
        }
