...
{
    [NativeName("Name", "VkVideoEncodeH265EmitPictureParametersInfoEXT")]
    public unsafe partial struct VideoEncodeH265EmitPictureParametersInfoEXT : IExtendsChain<VideoEncodeInfoKHR>
    {
        public VideoEncodeH265EmitPictureParametersInfoEXT
        (
            StructureType? sType = StructureType.VideoEncodeH265EmitPictureParametersInfoExt,
            void* pNext = null,
            byte? vpsId = null,
            byte? spsId = null,
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH265EmitPictureParametersInfoExt;
        }
