...
{
    [NativeName("Name", "VkMemoryToImageCopy")]
    [NativeName("Aliases", "VkMemoryToImageCopyEXT")]
    public unsafe partial struct MemoryToImageCopy : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.MemoryToImageCopy;
        }
