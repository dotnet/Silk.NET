...
namespace Silk.NET.Vulkan
{
    ...
    [NativeName("AliasOf", "VkPushDescriptorSetWithTemplateInfo")]
...
/// <summary></summary>
        ...
        {
            capture = new PushDescriptorSetWithTemplateInfoKHR(StructureType.PushDescriptorSetWithTemplateInfo);
            return ref capture;
        }
    }
}
