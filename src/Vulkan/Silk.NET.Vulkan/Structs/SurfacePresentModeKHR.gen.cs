...
{
    [NativeName("Name", "VkSurfacePresentModeKHR")]
    [NativeName("Aliases", "VkSurfacePresentModeEXT")]
    public unsafe partial struct SurfacePresentModeKHR : IExtendsChain<PhysicalDeviceSurfaceInfo2KHR>
    {
