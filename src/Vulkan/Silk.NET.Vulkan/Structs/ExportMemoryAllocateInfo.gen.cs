...
{
    [NativeName("Name", "VkExportMemoryAllocateInfo")]
    [NativeName("Aliases", "VkExportMemoryAllocateInfoKHR")]
    public unsafe partial struct ExportMemoryAllocateInfo : IExtendsChain<MemoryAllocateInfo>
    {
