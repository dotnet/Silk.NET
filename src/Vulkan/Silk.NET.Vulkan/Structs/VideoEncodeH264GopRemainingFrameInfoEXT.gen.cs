...
{
    [NativeName("Name", "VkVideoEncodeH264GopRemainingFrameInfoEXT")]
    public unsafe partial struct VideoEncodeH264GopRemainingFrameInfoEXT : IExtendsChain<VideoBeginCodingInfoKHR>
    {
        public VideoEncodeH264GopRemainingFrameInfoEXT
        (
            StructureType? sType = StructureType.VideoEncodeH264GopRemainingFrameInfoExt,
            void* pNext = null,
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH264GopRemainingFrameInfoExt;
        }
