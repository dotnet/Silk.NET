...
{
    [NativeName("Name", "VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT")]
    [NativeName("Aliases", "VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesARM")]
    public unsafe partial struct PhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
