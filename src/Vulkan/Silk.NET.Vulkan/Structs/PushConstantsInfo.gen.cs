...
{
    [NativeName("Name", "VkPushConstantsInfo")]
    [NativeName("Aliases", "VkPushConstantsInfoKHR")]
    public unsafe partial struct PushConstantsInfo : IChainStart
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PushConstantsInfo;
        }
        ...
        public static unsafe ref PushConstantsInfo Chain(
            out PushConstantsInfo capture)
        {
            capture = new PushConstantsInfo(StructureType.PushConstantsInfo);
            return ref capture;
        }
    }
}
