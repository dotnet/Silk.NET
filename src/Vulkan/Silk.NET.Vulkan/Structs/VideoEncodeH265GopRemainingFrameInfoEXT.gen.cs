...
{
    [NativeName("Name", "VkVideoEncodeH265GopRemainingFrameInfoEXT")]
    public unsafe partial struct VideoEncodeH265GopRemainingFrameInfoEXT : IExtendsChain<VideoBeginCodingInfoKHR>
    {
        public VideoEncodeH265GopRemainingFrameInfoEXT
        (
            StructureType? sType = StructureType.VideoEncodeH265GopRemainingFrameInfoExt,
            void* pNext = null,
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH265GopRemainingFrameInfoExt;
        }
