...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct VideoDecodeH264SessionCreateInfoEXT : IExtendsChain<VideoSessionCreateInfoKHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoDecodeH264SessionCreateInfoExt;
        }
