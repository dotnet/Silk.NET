...
{
    [NativeName("Name", "VkExportMetalIOSurfaceInfoEXT")]
    public unsafe partial struct ExportMetalIOSurfaceInfoEXT : IExtendsChain<ExportMetalObjectsInfoEXT>
    {
        public ExportMetalIOSurfaceInfoEXT
        (
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.ExportMetalIOSurfaceInfoExt;
        }
