...
{
    [NativeName("Name", "VkDeviceGroupPresentCapabilitiesKHR")]
    public unsafe partial struct DeviceGroupPresentCapabilitiesKHR : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.DeviceGroupPresentCapabilitiesKhr;
        }
    }
}
