...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct PhysicalDeviceTextureCompressionASTCHDRFeaturesEXT : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceTextureCompressionAstcHdrFeaturesExt;
        }
    }
}
