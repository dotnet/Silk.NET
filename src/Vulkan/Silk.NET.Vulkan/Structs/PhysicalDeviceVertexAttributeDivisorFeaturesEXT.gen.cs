...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct PhysicalDeviceVertexAttributeDivisorFeaturesEXT : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceVertexAttributeDivisorFeaturesExt;
        }
    }
}
