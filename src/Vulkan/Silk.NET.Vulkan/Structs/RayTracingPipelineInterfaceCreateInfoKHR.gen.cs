...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct RayTracingPipelineInterfaceCreateInfoKHR : IStructuredType
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.RayTracingPipelineInterfaceCreateInfoKhr;
        }
    }
}
