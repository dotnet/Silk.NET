...
{
    [NativeName("Name", "VkHostImageCopyDevicePerformanceQuery")]
    [NativeName("Aliases", "VkHostImageCopyDevicePerformanceQueryEXT")]
    public unsafe partial struct HostImageCopyDevicePerformanceQuery : IExtendsChain<ImageFormatProperties2>, IExtendsChain<ImageFormatProperties2KHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.HostImageCopyDevicePerformanceQuery;
        }
