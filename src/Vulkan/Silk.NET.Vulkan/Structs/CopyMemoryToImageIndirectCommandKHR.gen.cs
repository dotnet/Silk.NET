...
{
    [NativeName("Name", "VkCopyMemoryToImageIndirectCommandKHR")]
    [NativeName("Aliases", "VkCopyMemoryToImageIndirectCommandNV")]
    public unsafe partial struct CopyMemoryToImageIndirectCommandKHR
    {
