...
{
    [NativeName("Name", "VkDevicePrivateDataCreateInfo")]
    [NativeName("Aliases", "VkDevicePrivateDataCreateInfoEXT")]
    public unsafe partial struct DevicePrivateDataCreateInfo : IExtendsChain<DeviceCreateInfo>
    {
