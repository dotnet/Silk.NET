...
{
    [NativeName("Name", "VkPipelineIndirectDeviceAddressInfoNV")]
    public unsafe partial struct PipelineIndirectDeviceAddressInfoNV : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PipelineIndirectDeviceAddressInfoNV;
        }
