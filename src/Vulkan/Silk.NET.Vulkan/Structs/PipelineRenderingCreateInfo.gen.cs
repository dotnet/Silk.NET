...
{
    [NativeName("Name", "VkPipelineRenderingCreateInfo")]
    [NativeName("Aliases", "VkPipelineRenderingCreateInfoKHR")]
    public unsafe partial struct PipelineRenderingCreateInfo : IExtendsChain<GraphicsPipelineCreateInfo>
    {
