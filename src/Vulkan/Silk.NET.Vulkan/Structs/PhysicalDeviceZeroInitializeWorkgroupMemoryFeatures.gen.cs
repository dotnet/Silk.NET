...
{
    [NativeName("Name", "VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures")]
    [NativeName("Aliases", "VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeaturesKHR")]
    public unsafe partial struct PhysicalDeviceZeroInitializeWorkgroupMemoryFeatures : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceZeroInitializeWorkgroupMemoryFeatures;
        }
