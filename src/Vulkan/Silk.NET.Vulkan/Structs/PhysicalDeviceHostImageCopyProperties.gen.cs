...
{
    [NativeName("Name", "VkPhysicalDeviceHostImageCopyProperties")]
    [NativeName("Aliases", "VkPhysicalDeviceHostImageCopyPropertiesEXT")]
    public unsafe partial struct PhysicalDeviceHostImageCopyProperties : IExtendsChain<PhysicalDeviceProperties2>, IExtendsChain<PhysicalDeviceProperties2KHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.PhysicalDeviceHostImageCopyProperties;
        }
