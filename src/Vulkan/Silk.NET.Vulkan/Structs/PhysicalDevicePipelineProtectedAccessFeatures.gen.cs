...
{
    [NativeName("Name", "VkPhysicalDevicePipelineProtectedAccessFeatures")]
    [NativeName("Aliases", "VkPhysicalDevicePipelineProtectedAccessFeaturesEXT")]
    public unsafe partial struct PhysicalDevicePipelineProtectedAccessFeatures : IExtendsChain<PhysicalDeviceFeatures2>, IExtendsChain<PhysicalDeviceFeatures2KHR>, IExtendsChain<DeviceCreateInfo>
    {
