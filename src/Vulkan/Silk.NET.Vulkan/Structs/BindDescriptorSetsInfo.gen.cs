...
{
    [NativeName("Name", "VkBindDescriptorSetsInfo")]
    [NativeName("Aliases", "VkBindDescriptorSetsInfoKHR")]
    public unsafe partial struct BindDescriptorSetsInfo : IChainStart
    {
...
/// <summary></summary>
        ...
        public static unsafe ref BindDescriptorSetsInfo Chain(
            out BindDescriptorSetsInfo capture)
        {
            capture = new BindDescriptorSetsInfo(StructureType.BindDescriptorSetsInfo);
            return ref capture;
        }
    }
}
