...
{
    [NativeName("Name", "VkSwapchainPresentModeInfoKHR")]
    [NativeName("Aliases", "VkSwapchainPresentModeInfoEXT")]
    public unsafe partial struct SwapchainPresentModeInfoKHR : IExtendsChain<PresentInfoKHR>
    {
