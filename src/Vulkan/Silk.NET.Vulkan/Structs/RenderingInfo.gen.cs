...
{
    [NativeName("Name", "VkRenderingInfo")]
    [NativeName("Aliases", "VkRenderingInfoKHR")]
    public unsafe partial struct RenderingInfo : IChainStart
    {
...
/// <summary></summary>
        ...
        public static unsafe ref RenderingInfo Chain(
            out RenderingInfo capture)
        {
            capture = new RenderingInfo(StructureType.RenderingInfo);
            return ref capture;
        }
    }
}
