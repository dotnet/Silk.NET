...
{
    [NativeName("Name", "VkCopyMemoryIndirectCommandKHR")]
    [NativeName("Aliases", "VkCopyMemoryIndirectCommandNV")]
    public unsafe partial struct CopyMemoryIndirectCommandKHR
    {
