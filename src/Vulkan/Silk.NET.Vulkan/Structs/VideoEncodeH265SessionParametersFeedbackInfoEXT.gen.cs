...
{
    [NativeName("Name", "VkVideoEncodeH265SessionParametersFeedbackInfoEXT")]
    public unsafe partial struct VideoEncodeH265SessionParametersFeedbackInfoEXT : IExtendsChain<VideoEncodeSessionParametersFeedbackInfoKHR>
    {
        public VideoEncodeH265SessionParametersFeedbackInfoEXT
        (
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH265SessionParametersFeedbackInfoExt;
        }
