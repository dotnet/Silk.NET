...
{
    [NativeName("Name", "VkMemoryGetMetalHandleInfoEXT")]
    public unsafe partial struct MemoryGetMetalHandleInfoEXT : IChainable
    {
        public MemoryGetMetalHandleInfoEXT
        (
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.MemoryGetMetalHandleInfoExt;
        }
