...
{
    [NativeName("Name", "VkBufferDeviceAddressInfo")]
    [NativeName("Aliases", "VkBufferDeviceAddressInfoKHR, VkBufferDeviceAddressInfoEXT")]
    public unsafe partial struct BufferDeviceAddressInfo : IChainable
    {
