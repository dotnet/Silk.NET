...
{
    [NativeName("Name", "VkImageBlit2")]
    [NativeName("Aliases", "VkImageBlit2KHR")]
    public unsafe partial struct ImageBlit2 : IChainStart
    {
        public ImageBlit2
        (
...
/// <summary></summary>
        ...
        public static unsafe ref ImageBlit2 Chain(
            out ImageBlit2 capture)
        {
            capture = new ImageBlit2(StructureType.ImageBlit2);
            return ref capture;
        }
    }
}
