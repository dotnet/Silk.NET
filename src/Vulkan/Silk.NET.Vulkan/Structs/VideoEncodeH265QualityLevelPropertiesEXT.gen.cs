...
{
    [NativeName("Name", "VkVideoEncodeH265QualityLevelPropertiesEXT")]
    public unsafe partial struct VideoEncodeH265QualityLevelPropertiesEXT : IExtendsChain<VideoEncodeQualityLevelPropertiesKHR>
    {
        public VideoEncodeH265QualityLevelPropertiesEXT
        (
            StructureType? sType = StructureType.VideoEncodeH265QualityLevelPropertiesExt,
            void* pNext = null,
            VideoEncodeH265RateControlFlagsEXT? preferredRateControlFlags = null,
            ...
            VideoEncodeH265QpEXT? preferredConstantQp = null,
...
/// <summary></summary>
        ...
        public void* PNext;
/// <summary></summary>
        [NativeName("Type", "VkVideoEncodeH265RateControlFlagsEXT")]
        [NativeName("Type.Name", "VkVideoEncodeH265RateControlFlagsEXT")]
        [NativeName("Name", "preferredRateControlFlags")]
        public VideoEncodeH265RateControlFlagsEXT PreferredRateControlFlags;
/// <summary></summary>
...
/// <summary></summary>
        ...
        public VideoEncodeH265QpEXT PreferredConstantQp;
/// <summary></summary>
        [NativeName("Type", "uint32_t")]
        [NativeName("Type.Name", "uint32_t")]
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH265QualityLevelPropertiesExt;
        }
