...
{
    [NativeName("Name", "VkSubmitInfo2")]
    [NativeName("Aliases", "VkSubmitInfo2KHR")]
    public unsafe partial struct SubmitInfo2 : IChainStart
    {
        public SubmitInfo2
        (
...
/// <summary></summary>
        ...
        public static unsafe ref SubmitInfo2 Chain(
            out SubmitInfo2 capture)
        {
            capture = new SubmitInfo2(StructureType.SubmitInfo2);
            return ref capture;
        }
    }
}
