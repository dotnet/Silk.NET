...
{
    [NativeName("Name", "VkVideoFormatQuantizationMapPropertiesKHR")]
    public unsafe partial struct VideoFormatQuantizationMapPropertiesKHR : IExtendsChain<VideoFormatPropertiesKHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoFormatQuantizationMapPropertiesKhr;
        }
