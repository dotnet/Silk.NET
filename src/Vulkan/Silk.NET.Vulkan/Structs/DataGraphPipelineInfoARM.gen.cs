...
{
    [NativeName("Name", "VkDataGraphPipelineInfoARM")]
    public unsafe partial struct DataGraphPipelineInfoARM : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.DataGraphPipelineInfoArm;
        }
