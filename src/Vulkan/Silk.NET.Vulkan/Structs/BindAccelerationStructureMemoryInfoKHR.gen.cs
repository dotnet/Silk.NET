...
{
    [NativeName("Name", "VkBindAccelerationStructureMemoryInfoKHR")]
    public unsafe partial struct BindAccelerationStructureMemoryInfoKHR
    {
        ...
        {
            fixed (BindAccelerationStructureMemoryInfoKHR* @this = &this)
            {
