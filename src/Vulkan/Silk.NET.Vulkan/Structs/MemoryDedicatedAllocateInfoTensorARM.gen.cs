...
{
    [NativeName("Name", "VkMemoryDedicatedAllocateInfoTensorARM")]
    public unsafe partial struct MemoryDedicatedAllocateInfoTensorARM : IExtendsChain<MemoryAllocateInfo>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.MemoryDedicatedAllocateInfoTensorArm;
        }
