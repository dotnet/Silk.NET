...
{
    [NativeName("Name", "VkExternalMemoryTensorCreateInfoARM")]
    public unsafe partial struct ExternalMemoryTensorCreateInfoARM : IExtendsChain<TensorCreateInfoARM>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.ExternalMemoryTensorCreateInfoArm;
        }
