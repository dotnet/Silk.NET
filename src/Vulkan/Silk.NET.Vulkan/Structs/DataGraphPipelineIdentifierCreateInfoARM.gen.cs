...
{
    [NativeName("Name", "VkDataGraphPipelineIdentifierCreateInfoARM")]
    public unsafe partial struct DataGraphPipelineIdentifierCreateInfoARM : IExtendsChain<DataGraphPipelineCreateInfoARM>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.DataGraphPipelineIdentifierCreateInfoArm;
        }
