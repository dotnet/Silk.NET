...
{
    [NativeName("Name", "VkVideoEncodeH264SessionParametersGetInfoEXT")]
    public unsafe partial struct VideoEncodeH264SessionParametersGetInfoEXT : IExtendsChain<VideoEncodeSessionParametersGetInfoKHR>
    {
        public VideoEncodeH264SessionParametersGetInfoEXT
        (
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoEncodeH264SessionParametersGetInfoExt;
        }
