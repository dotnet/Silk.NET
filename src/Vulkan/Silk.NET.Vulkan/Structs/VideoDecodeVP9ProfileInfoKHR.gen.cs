...
{
    [NativeName("Name", "VkVideoDecodeVP9ProfileInfoKHR")]
    public unsafe partial struct VideoDecodeVP9ProfileInfoKHR : IExtendsChain<VideoProfileInfoKHR>, IExtendsChain<QueryPoolCreateInfo>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.VideoDecodeVP9ProfileInfoKhr;
        }
