...
{
    [NativeName("Name", "VkShaderRequiredSubgroupSizeCreateInfoEXT")]
    [NativeName("AliasOf", "VkPipelineShaderStageRequiredSubgroupSizeCreateInfo")]
    public unsafe partial struct ShaderRequiredSubgroupSizeCreateInfoEXT : IExtendsChain<PipelineShaderStageCreateInfo>, IExtendsChain<ShaderCreateInfoEXT>
    {
        public ShaderRequiredSubgroupSizeCreateInfoEXT
        (
