...
{
    [NativeName("Name", "VkClusterAccelerationStructureGetTemplateIndicesInfoNV")]
    public unsafe partial struct ClusterAccelerationStructureGetTemplateIndicesInfoNV
    {
