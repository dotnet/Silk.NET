...
{
    [NativeName("Name", "VkLatencySurfaceCapabilitiesNV")]
    public unsafe partial struct LatencySurfaceCapabilitiesNV : IExtendsChain<SurfaceCapabilities2KHR>
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.LatencySurfaceCapabilitiesNV;
        }
