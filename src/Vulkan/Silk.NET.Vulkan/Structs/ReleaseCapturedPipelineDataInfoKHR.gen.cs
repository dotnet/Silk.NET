...
{
    [NativeName("Name", "VkReleaseCapturedPipelineDataInfoKHR")]
    public unsafe partial struct ReleaseCapturedPipelineDataInfoKHR : IChainable
    {
...
/// <summary></summary>
        ...
        {
            return SType = StructureType.ReleaseCapturedPipelineDataInfoKhr;
        }
