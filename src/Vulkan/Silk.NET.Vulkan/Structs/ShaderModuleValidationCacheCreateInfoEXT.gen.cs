...
namespace Silk.NET.Vulkan
{
    ...
    public unsafe partial struct ShaderModuleValidationCacheCreateInfoEXT : IExtendsChain<ShaderModuleCreateInfo>, IExtendsChain<PipelineShaderStageCreateInfo>
    {
