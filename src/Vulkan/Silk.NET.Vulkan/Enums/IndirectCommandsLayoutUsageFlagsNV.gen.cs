...
namespace Silk.NET.Vulkan
{
    ...
    public enum IndirectCommandsLayoutUsageFlagsNV : int
    {
        [NativeName("Name", "")]
        None = 0,
        [Obsolete("Deprecated in favour of \"ExplicitPreprocessBitNV\"")]
        ...
        [Obsolete("Deprecated in favour of \"IndexedSequencesBitNV\"")]
        ...
        [Obsolete("Deprecated in favour of \"UnorderedSequencesBitNV\"")]
