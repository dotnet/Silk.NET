...
{
    [Flags]
    [NativeName("Name", "VkPipelineCreationFeedbackFlags")]
    public enum PipelineCreationFeedbackFlags : int
    {
        [NativeName("Name", "")]
        None = 0,
        ...
        [Obsolete("Deprecated in favour of \"ValidBitExt\"")]
        ...
        [Obsolete("Deprecated in favour of \"ApplicationPipelineCacheHitBitExt\"")]
        ...
        [Obsolete("Deprecated in favour of \"BasePipelineAccelerationBitExt\"")]
