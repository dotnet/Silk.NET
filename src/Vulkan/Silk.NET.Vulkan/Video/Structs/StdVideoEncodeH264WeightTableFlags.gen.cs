...
{
    [NativeName("Name", "StdVideoEncodeH264WeightTableFlags")]
    public unsafe partial struct StdVideoEncodeH264WeightTableFlags
    {
        public StdVideoEncodeH264WeightTableFlags
        (
            uint? lumaWeightL0Flag = null,
            uint? chromaWeightL0Flag = null,
            uint? lumaWeightL1Flag = null,
            uint? chromaWeightL1Flag = null
        ) : this()
        {
