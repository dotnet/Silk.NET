...
namespace Silk.NET.Vulkan.Extensions.FUCHSIA
{
    ...
    public unsafe partial class FuchsiaExternalSemaphore : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetSemaphoreZirconHandleFUCHSIA", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSemaphoreZirconHandleFuchsia([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in SemaphoreGetZirconHandleInfoFUCHSIA pGetZirconHandleInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] nint* pZirconHandle);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetSemaphoreZirconHandleFUCHSIA", Convention = CallingConvention.Winapi)]
        public partial Result GetSemaphoreZirconHandleFuchsia([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in SemaphoreGetZirconHandleInfoFUCHSIA pGetZirconHandleInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out nint pZirconHandle);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkImportSemaphoreZirconHandleFUCHSIA", Convention = CallingConvention.Winapi)]
        public partial Result ImportSemaphoreZirconHandleFuchsia([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in ImportSemaphoreZirconHandleInfoFUCHSIA pImportSemaphoreZirconHandleInfo);
