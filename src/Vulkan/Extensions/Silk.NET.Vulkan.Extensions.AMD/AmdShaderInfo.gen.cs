...
namespace Silk.NET.Vulkan.Extensions.AMD
{
    ...
    public unsafe partial class AmdShaderInfo : NativeExtension<Vk>
    {
        ...
        public unsafe partial Result GetShaderInfo([Count(Count = 0)] Device device, [Count(Count = 0)] Pipeline pipeline, [Count(Count = 0)] ShaderStageFlags shaderStage, [Count(Count = 0)] ShaderInfoTypeAMD infoType, [Count(Count = 0)] nuint* pInfoSize, [Count(Computed = "pInfoSize")] void* pInfo);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetShaderInfoAMD")]
        public unsafe partial Result GetShaderInfo<T0>([Count(Count = 0)] Device device, [Count(Count = 0)] Pipeline pipeline, [Count(Count = 0)] ShaderStageFlags shaderStage, [Count(Count = 0)] ShaderInfoTypeAMD infoType, [Count(Count = 0)] nuint* pInfoSize, [Count(Computed = "pInfoSize")] ref T0 pInfo) where T0 : unmanaged;
