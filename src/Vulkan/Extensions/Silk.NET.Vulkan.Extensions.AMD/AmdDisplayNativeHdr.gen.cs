...
namespace Silk.NET.Vulkan.Extensions.AMD
{
    ...
    public unsafe partial class AmdDisplayNativeHdr : NativeExtension<Vk>
    {
        ...
        public void SetLocalDimming([Count(Count = 0)] Device device, [Count(Count = 0)] SwapchainKHR swapChain, [Count(Count = 0)] Bool32 localDimmingEnable)
            => ImplSetLocalDimming(device, swapChain, localDimmingEnable);
