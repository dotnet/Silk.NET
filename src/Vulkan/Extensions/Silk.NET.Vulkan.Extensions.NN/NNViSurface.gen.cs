...
namespace Silk.NET.Vulkan.Extensions.NN
{
    ...
    public unsafe partial class NNViSurface : NativeExtension<Vk>
    {
        ...
        [NativeApi(EntryPoint = "vkCreateViSurfaceNN", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateViSurface([Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ViSurfaceCreateInfoNN* pCreateInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] SurfaceKHR* pSurface);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateViSurfaceNN", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateViSurface([Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ViSurfaceCreateInfoNN pCreateInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] SurfaceKHR* pSurface);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateViSurfaceNN", Convention = CallingConvention.Winapi)]
        public partial Result CreateViSurface([Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ViSurfaceCreateInfoNN pCreateInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AllocationCallbacks pAllocator, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out SurfaceKHR pSurface);
