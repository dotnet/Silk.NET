...
namespace Silk.NET.Vulkan.Extensions.ARM
{
    ...
    public unsafe partial class ArmDataGraph : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkBindDataGraphPipelineSessionMemoryARM", Convention = CallingConvention.Winapi)]
        public partial Result BindDataGraphPipelineSessionMemory([Count(Count = 0)] Device device, [Count(Count = 0)] uint bindInfoCount, [Count(Parameter = "bindInfoCount"), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BindDataGraphPipelineSessionMemoryInfoARM pBindInfos);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdDispatchDataGraphARM", Convention = CallingConvention.Winapi)]
        public partial void CmdDispatchDataGraph([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] DataGraphPipelineSessionARM session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DataGraphPipelineDispatchInfoARM pInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkDestroyDataGraphPipelineSessionARM", Convention = CallingConvention.Winapi)]
        public partial void DestroyDataGraphPipelineSession([Count(Count = 0)] Device device, [Count(Count = 0)] DataGraphPipelineSessionARM session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AllocationCallbacks pAllocator);
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pMemoryRequirements = new(StructureType.MemoryRequirements2);")]
        public unsafe MemoryRequirements2 GetDataGraphPipelineSessionMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DataGraphPipelineSessionMemoryRequirementsInfoARM pInfo)
        {
            // NonKhrReturnTypeOverloader
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pQueueFamilyDataGraphProcessingEngineProperties = new(StructureType.QueueFamilyDataGraphProcessingEnginePropertiesArm);")]
        public unsafe QueueFamilyDataGraphProcessingEnginePropertiesARM GetPhysicalDeviceQueueFamilyDataGraphProcessingEngineProperties([Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM pQueueFamilyDataGraphProcessingEngineInfo)
        {
            // NonKhrReturnTypeOverloader
