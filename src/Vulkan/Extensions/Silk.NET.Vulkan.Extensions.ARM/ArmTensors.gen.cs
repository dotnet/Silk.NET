...
namespace Silk.NET.Vulkan.Extensions.ARM
{
    ...
    public unsafe partial class ArmTensors : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkBindTensorMemoryARM", Convention = CallingConvention.Winapi)]
        public partial Result BindTensorMemory([Count(Count = 0)] Device device, [Count(Count = 0)] uint bindInfoCount, [Count(Parameter = "bindInfoCount"), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BindTensorMemoryInfoARM pBindInfos);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdCopyTensorARM", Convention = CallingConvention.Winapi)]
        public partial void CmdCopyTensor([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in CopyTensorInfoARM pCopyTensorInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkDestroyTensorARM", Convention = CallingConvention.Winapi)]
        public partial void DestroyTensor([Count(Count = 0)] Device device, [Count(Count = 0)] TensorARM tensor, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AllocationCallbacks pAllocator);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkDestroyTensorViewARM", Convention = CallingConvention.Winapi)]
        public partial void DestroyTensorView([Count(Count = 0)] Device device, [Count(Count = 0)] TensorViewARM tensorView, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AllocationCallbacks pAllocator);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetDeviceTensorMemoryRequirementsARM", Convention = CallingConvention.Winapi)]
        public unsafe partial void GetDeviceTensorMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DeviceTensorMemoryRequirementsARM pInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] MemoryRequirements2* pMemoryRequirements);

        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pMemoryRequirements = new(StructureType.MemoryRequirements2);")]
        [NativeApi(EntryPoint = "vkGetDeviceTensorMemoryRequirementsARM", Convention = CallingConvention.Winapi)]
        public partial void GetDeviceTensorMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DeviceTensorMemoryRequirementsARM pInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out MemoryRequirements2 pMemoryRequirements);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetTensorMemoryRequirementsARM", Convention = CallingConvention.Winapi)]
        public unsafe partial void GetTensorMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorMemoryRequirementsInfoARM pInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] MemoryRequirements2* pMemoryRequirements);

        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pMemoryRequirements = new(StructureType.MemoryRequirements2);")]
        [NativeApi(EntryPoint = "vkGetTensorMemoryRequirementsARM", Convention = CallingConvention.Winapi)]
        public partial void GetTensorMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorMemoryRequirementsInfoARM pInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out MemoryRequirements2 pMemoryRequirements);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetTensorOpaqueCaptureDescriptorDataARM", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetTensorOpaqueCaptureDescriptorData([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorCaptureDescriptorDataInfoARM pInfo, [Count(Count = 0)] void* pData);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetTensorOpaqueCaptureDescriptorDataARM", Convention = CallingConvention.Winapi)]
        public partial Result GetTensorOpaqueCaptureDescriptorData<T0>([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorCaptureDescriptorDataInfoARM pInfo, [Count(Count = 0)] ref T0 pData) where T0 : unmanaged;
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetTensorViewOpaqueCaptureDescriptorDataARM", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetTensorViewOpaqueCaptureDescriptorData([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorViewCaptureDescriptorDataInfoARM pInfo, [Count(Count = 0)] void* pData);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetTensorViewOpaqueCaptureDescriptorDataARM", Convention = CallingConvention.Winapi)]
        public partial Result GetTensorViewOpaqueCaptureDescriptorData<T0>([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorViewCaptureDescriptorDataInfoARM pInfo, [Count(Count = 0)] ref T0 pData) where T0 : unmanaged;
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pMemoryRequirements = new(StructureType.MemoryRequirements2);")]
        public unsafe MemoryRequirements2 GetDeviceTensorMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DeviceTensorMemoryRequirementsARM pInfo)
        {
            // NonKhrReturnTypeOverloader
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pExternalTensorProperties = new(StructureType.ExternalTensorPropertiesArm);")]
        public unsafe ExternalTensorPropertiesARM GetPhysicalDeviceExternalTensorProperties([Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PhysicalDeviceExternalTensorInfoARM pExternalTensorInfo)
        {
            // NonKhrReturnTypeOverloader
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pMemoryRequirements = new(StructureType.MemoryRequirements2);")]
        public unsafe MemoryRequirements2 GetTensorMemoryRequirements([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TensorMemoryRequirementsInfoARM pInfo)
        {
            // NonKhrReturnTypeOverloader
