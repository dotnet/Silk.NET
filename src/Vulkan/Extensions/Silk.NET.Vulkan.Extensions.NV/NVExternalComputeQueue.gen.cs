...
namespace Silk.NET.Vulkan.Extensions.NV
{
    ...
    public unsafe partial class NVExternalComputeQueue : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkDestroyExternalComputeQueueNV", Convention = CallingConvention.Winapi)]
        public partial void DestroyExternalComputeQueue([Count(Count = 0)] Device device, [Count(Count = 0)] ExternalComputeQueueNV externalQueue, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AllocationCallbacks pAllocator);
