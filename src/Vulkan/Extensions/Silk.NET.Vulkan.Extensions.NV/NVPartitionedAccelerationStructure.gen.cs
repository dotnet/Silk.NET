...
namespace Silk.NET.Vulkan.Extensions.NV
{
    ...
    public unsafe partial class NVPartitionedAccelerationStructure : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBuildPartitionedAccelerationStructuresNV", Convention = CallingConvention.Winapi)]
        public partial void CmdBuildPartitionedAccelerationStructures([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BuildPartitionedAccelerationStructureInfoNV pBuildInfo);
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pSizeInfo = new(StructureType.AccelerationStructureBuildSizesInfoKhr);")]
        public unsafe AccelerationStructureBuildSizesInfoKHR GetPartitionedAccelerationStructuresBuildSizes([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PartitionedAccelerationStructureInstancesInputNV pInfo)
        {
            // NonKhrReturnTypeOverloader
