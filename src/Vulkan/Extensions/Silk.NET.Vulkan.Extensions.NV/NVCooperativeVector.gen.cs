...
namespace Silk.NET.Vulkan.Extensions.NV
{
    ...
    public unsafe partial class NVCooperativeVector : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdConvertCooperativeVectorMatrixNV", Convention = CallingConvention.Winapi)]
        public partial void CmdConvertCooperativeVectorMatrix([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint infoCount, [Count(Parameter = "infoCount"), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ConvertCooperativeVectorMatrixInfoNV pInfos);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkConvertCooperativeVectorMatrixNV", Convention = CallingConvention.Winapi)]
        public partial Result ConvertCooperativeVectorMatrix([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ConvertCooperativeVectorMatrixInfoNV pInfo);
