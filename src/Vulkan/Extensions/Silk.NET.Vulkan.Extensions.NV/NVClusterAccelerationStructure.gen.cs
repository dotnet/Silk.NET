...
namespace Silk.NET.Vulkan.Extensions.NV
{
    ...
    public unsafe partial class NVClusterAccelerationStructure : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBuildClusterAccelerationStructureIndirectNV", Convention = CallingConvention.Winapi)]
        public partial void CmdBuildClusterAccelerationStructureIndirect([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ClusterAccelerationStructureCommandsInfoNV pCommandInfos);
        ...
        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pSizeInfo = new(StructureType.AccelerationStructureBuildSizesInfoKhr);")]
        public unsafe AccelerationStructureBuildSizesInfoKHR GetClusterAccelerationStructureBuildSizes([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ClusterAccelerationStructureInputInfoNV pInfo)
        {
            // NonKhrReturnTypeOverloader
