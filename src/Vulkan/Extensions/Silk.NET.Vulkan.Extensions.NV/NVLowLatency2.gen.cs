...
namespace Silk.NET.Vulkan.Extensions.NV
{
    ...
    public unsafe partial class NVLowLatency2 : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkLatencySleepNV", Convention = CallingConvention.Winapi)]
        public partial Result LatencySleep([Count(Count = 0)] Device device, [Count(Count = 0)] SwapchainKHR swapchain, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in LatencySleepInfoNV pSleepInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkQueueNotifyOutOfBandNV", Convention = CallingConvention.Winapi)]
        public partial void QueueNotifyOutOfBan([Count(Count = 0)] Queue queue, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in OutOfBandQueueTypeInfoNV pQueueTypeInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkSetLatencyMarkerNV", Convention = CallingConvention.Winapi)]
        public partial void SetLatencyMarker([Count(Count = 0)] Device device, [Count(Count = 0)] SwapchainKHR swapchain, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in SetLatencyMarkerInfoNV pLatencyMarkerInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkSetLatencySleepModeNV", Convention = CallingConvention.Winapi)]
        public partial Result SetLatencySleepMode([Count(Count = 0)] Device device, [Count(Count = 0)] SwapchainKHR swapchain, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in LatencySleepModeInfoNV pSleepModeInfo);
