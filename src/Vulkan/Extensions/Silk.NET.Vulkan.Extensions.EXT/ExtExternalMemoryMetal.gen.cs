...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    ...
    public unsafe partial class ExtExternalMemoryMetal : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetMemoryMetalHandleEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetMemoryMetalHandle([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in MemoryGetMetalHandleInfoEXT pGetMetalHandleInfo, [Count(Count = 0)] void** pHandle);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetMemoryMetalHandleEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetMemoryMetalHandle([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in MemoryGetMetalHandleInfoEXT pGetMetalHandleInfo, [Count(Count = 0)] ref void* pHandle);
