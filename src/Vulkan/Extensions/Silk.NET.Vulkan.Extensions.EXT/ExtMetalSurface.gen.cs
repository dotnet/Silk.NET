...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    ...
    public unsafe partial class ExtMetalSurface : NativeExtension<Vk>
    {
        ...
        /// <summary>To be added.</summary>
        [NativeApi(EntryPoint = "vkCreateMetalSurfaceEXT")]
        public partial Result CreateMetalSurface([Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] ref MetalSurfaceCreateInfoEXT pCreateInfo, [Count(Count = 0), Flow(FlowDirection.In)] ref AllocationCallbacks pAllocator, [Count(Count = 0), Flow(FlowDirection.Out)] out SurfaceKHR pSurface);
