...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    ...
    public unsafe partial class ExtSwapchainMaintenance1 : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkReleaseSwapchainImagesEXT", Convention = CallingConvention.Winapi)]
        public partial Result ReleaseSwapchainImages([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ReleaseSwapchainImagesInfoKHR pReleaseInfo);
