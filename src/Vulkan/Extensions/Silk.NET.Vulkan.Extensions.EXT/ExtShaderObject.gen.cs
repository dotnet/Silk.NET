...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    ...
    public unsafe partial class ExtShaderObject : NativeExtension<Vk>
    {
        ...
        public unsafe partial void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint stageCount, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ShaderStageFlags* pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ShaderEXT* pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBindShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint stageCount, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ShaderStageFlags* pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] in ShaderEXT pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBindShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint stageCount, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] in ShaderStageFlags pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ShaderEXT* pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBindShadersEXT", Convention = CallingConvention.Winapi)]
        public partial void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint stageCount, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] in ShaderStageFlags pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] in ShaderEXT pShaders);
        ...
        public unsafe partial void CmdSetColorBlendAdvance([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ColorBlendAdvancedEXT* pColorBlendAdvanced);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorBlendAdvancedEXT", Convention = CallingConvention.Winapi)]
        public partial void CmdSetColorBlendAdvance([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] in ColorBlendAdvancedEXT pColorBlendAdvanced);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorBlendEnableEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial void CmdSetColorBlendEnable([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] Bool32* pColorBlendEnables);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorBlendEnableEXT", Convention = CallingConvention.Winapi)]
        public partial void CmdSetColorBlendEnable([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] in Bool32 pColorBlendEnables);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorBlendEquationEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial void CmdSetColorBlendEquation([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ColorBlendEquationEXT* pColorBlendEquations);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorBlendEquationEXT", Convention = CallingConvention.Winapi)]
        public partial void CmdSetColorBlendEquation([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] in ColorBlendEquationEXT pColorBlendEquations);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorWriteMaskEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial void CmdSetColorWriteMask([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ColorComponentFlags* pColorWriteMasks);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetColorWriteMaskEXT", Convention = CallingConvention.Winapi)]
        public partial void CmdSetColorWriteMask([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Count = 0)] uint attachmentCount, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] in ColorComponentFlags pColorWriteMasks);
        ...
        public unsafe partial void CmdSetCoverageModulationTable([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint coverageModulationTableCount, [Count(Parameter = "coverageModulationTableCount"), Flow(FlowDirection.In)] float* pCoverageModulationTable);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetCoverageModulationTableNV", Convention = CallingConvention.Winapi)]
        public partial void CmdSetCoverageModulationTable([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint coverageModulationTableCount, [Count(Parameter = "coverageModulationTableCount"), Flow(FlowDirection.In)] in float pCoverageModulationTable);
        ...
        public unsafe partial void CmdSetSampleMask([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] SampleCountFlags samples, [Count(Computed = "latexmath:[\\lceil{\\mathit{samples} \\over 32}\\rceil]"), Flow(FlowDirection.In)] uint* pSampleMask);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetSampleMaskEXT", Convention = CallingConvention.Winapi)]
        public partial void CmdSetSampleMask([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] SampleCountFlags samples, [Count(Computed = "latexmath:[\\lceil{\\mathit{samples} \\over 32}\\rceil]"), Flow(FlowDirection.In)] in uint pSampleMask);
        ...
        public unsafe partial void CmdSetViewportSwizzle([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstViewport, [Count(Count = 0)] uint viewportCount, [Count(Parameter = "viewportCount"), Flow(FlowDirection.In)] ViewportSwizzleNV* pViewportSwizzles);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetViewportSwizzleNV", Convention = CallingConvention.Winapi)]
        public partial void CmdSetViewportSwizzle([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstViewport, [Count(Count = 0)] uint viewportCount, [Count(Parameter = "viewportCount"), Flow(FlowDirection.In)] in ViewportSwizzleNV pViewportSwizzles);
        ...
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ShaderCreateInfoEXT* pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] ShaderEXT* pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ShaderCreateInfoEXT* pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] out ShaderEXT pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ShaderCreateInfoEXT* pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] ShaderEXT* pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ShaderCreateInfoEXT* pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] out ShaderEXT pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] in ShaderCreateInfoEXT pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] ShaderEXT* pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] in ShaderCreateInfoEXT pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] out ShaderEXT pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] in ShaderCreateInfoEXT pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] ShaderEXT* pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCreateShadersEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateShaders([Count(Count = 0)] Device device, [Count(Count = 0)] uint createInfoCount, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] in ShaderCreateInfoEXT pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] out ShaderEXT pShaders);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkDestroyShaderEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial void DestroyShader([Count(Count = 0)] Device device, [Count(Count = 0)] ShaderEXT shader, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkDestroyShaderEXT", Convention = CallingConvention.Winapi)]
        public partial void DestroyShader([Count(Count = 0)] Device device, [Count(Count = 0)] ShaderEXT shader, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator);
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ShaderStageFlags* pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderEXT> pShaders)
        {
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderStageFlags> pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ShaderEXT* pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdBindShaders([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderStageFlags> pStages, [Count(Parameter = "stageCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderEXT> pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdSetColorBlendAdvance([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ReadOnlySpan<ColorBlendAdvancedEXT> pColorBlendAdvanced)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdSetColorBlendEnable([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ReadOnlySpan<Bool32> pColorBlendEnables)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdSetColorBlendEquation([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ReadOnlySpan<ColorBlendEquationEXT> pColorBlendEquations)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdSetColorWriteMask([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstAttachment, [Count(Parameter = "attachmentCount"), Flow(FlowDirection.In)] ReadOnlySpan<ColorComponentFlags> pColorWriteMasks)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdSetCoverageModulationTable([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Parameter = "coverageModulationTableCount"), Flow(FlowDirection.In)] ReadOnlySpan<float> pCoverageModulationTable)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe void CmdSetViewportSwizzle([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] uint firstViewport, [Count(Parameter = "viewportCount"), Flow(FlowDirection.In)] ReadOnlySpan<ViewportSwizzleNV> pViewportSwizzles)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result CreateShaders([Count(Count = 0)] Device device, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ShaderCreateInfoEXT* pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] Span<ShaderEXT> pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result CreateShaders([Count(Count = 0)] Device device, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ShaderCreateInfoEXT* pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] Span<ShaderEXT> pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result CreateShaders([Count(Count = 0)] Device device, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderCreateInfoEXT> pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] ShaderEXT* pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result CreateShaders([Count(Count = 0)] Device device, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderCreateInfoEXT> pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] Span<ShaderEXT> pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result CreateShaders([Count(Count = 0)] Device device, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderCreateInfoEXT> pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] ShaderEXT* pShaders)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result CreateShaders([Count(Count = 0)] Device device, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.In)] ReadOnlySpan<ShaderCreateInfoEXT> pCreateInfos, [Count(Count = 0), Flow(FlowDirection.In)] in AllocationCallbacks pAllocator, [Count(Parameter = "createInfoCount"), Flow(FlowDirection.Out)] Span<ShaderEXT> pShaders)
        {
            // ImplicitCountSpanOverloader
