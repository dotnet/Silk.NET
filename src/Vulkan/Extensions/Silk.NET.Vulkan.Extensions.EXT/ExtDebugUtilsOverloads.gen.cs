...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    public static class ExtDebugUtilsOverloads
    {
        ...
        public static unsafe void CmdBeginDebugUtilsLabel(this ExtDebugUtils thisApi, [Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<DebugUtilsLabelEXT> pLabelInfo)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result CreateDebugUtilsMessenger(this ExtDebugUtils thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] DebugUtilsMessengerCreateInfoEXT* pCreateInfo, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Count = 0), Flow(FlowDirection.Out)] Span<DebugUtilsMessengerEXT> pMessenger)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result CreateDebugUtilsMessenger(this ExtDebugUtils thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] DebugUtilsMessengerCreateInfoEXT* pCreateInfo, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<AllocationCallbacks> pAllocator, [Count(Count = 0), Flow(FlowDirection.Out)] DebugUtilsMessengerEXT* pMessenger)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result CreateDebugUtilsMessenger(this ExtDebugUtils thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<DebugUtilsMessengerCreateInfoEXT> pCreateInfo, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Count = 0), Flow(FlowDirection.Out)] DebugUtilsMessengerEXT* pMessenger)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result CreateDebugUtilsMessenger(this ExtDebugUtils thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<DebugUtilsMessengerCreateInfoEXT> pCreateInfo, [Count(Count = 0), Flow(FlowDirection.In)] AllocationCallbacks* pAllocator, [Count(Count = 0), Flow(FlowDirection.Out)] Span<DebugUtilsMessengerEXT> pMessenger)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void QueueBeginDebugUtilsLabel(this ExtDebugUtils thisApi, [Count(Count = 0)] Queue queue, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<DebugUtilsLabelEXT> pLabelInfo)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result SetDebugUtilsObjectName(this ExtDebugUtils thisApi, [Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<DebugUtilsObjectNameInfoEXT> pNameInfo)
        {
            // SpanOverloader
