...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    ...
    public unsafe partial class ExtFragmentDensityMapOffset : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdEndRendering2EXT", Convention = CallingConvention.Winapi)]
        public partial void CmdEndRendering2([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderingEndInfoEXT pRenderingEndInfo);
