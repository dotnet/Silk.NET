...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    ...
    public unsafe partial class ExtDepthBiasControl : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdSetDepthBias2EXT", Convention = CallingConvention.Winapi)]
        public partial void CmdSetDepthBias2([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in DepthBiasInfoEXT pDepthBiasInfo);
