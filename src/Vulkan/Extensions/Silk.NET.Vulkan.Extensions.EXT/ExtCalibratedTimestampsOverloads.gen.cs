...
namespace Silk.NET.Vulkan.Extensions.EXT
{
    public static class ExtCalibratedTimestampsOverloads
    {
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetPhysicalDeviceCalibrateableTimeDomain(this ExtCalibratedTimestamps thisApi, [Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0)] uint* pTimeDomainCount, [Count(Parameter = "pTimeDomainCount"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<TimeDomainEXT> pTimeDomains)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetPhysicalDeviceCalibrateableTimeDomain(this ExtCalibratedTimestamps thisApi, [Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0)] Span<uint> pTimeDomainCount, [Count(Parameter = "pTimeDomainCount"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] TimeDomainEXT* pTimeDomains)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetPhysicalDeviceCalibrateableTimeDomain(this ExtCalibratedTimestamps thisApi, [Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0)] Span<uint> pTimeDomainCount, [Count(Parameter = "pTimeDomainCount"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<TimeDomainEXT> pTimeDomains)
        {
            // SpanOverloader
