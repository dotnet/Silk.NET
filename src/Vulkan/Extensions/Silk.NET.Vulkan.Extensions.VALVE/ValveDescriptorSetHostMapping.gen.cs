...
namespace Silk.NET.Vulkan.Extensions.VALVE
{
    ...
    public unsafe partial class ValveDescriptorSetHostMapping : NativeExtension<Vk>
    {
        ...
        public unsafe partial void GetDescriptorSetLayoutHostMappingInfoValve([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] DescriptorSetBindingReferenceVALVE* pBindingReference, [Count(Count = 0), Flow(FlowDirection.Out)] DescriptorSetLayoutHostMappingInfoVALVE* pHostMapping);

        /// <summary>To be documented.</summary>
        [Inject(SilkTouchStage.Begin, "pHostMapping = new(StructureType.DescriptorSetLayoutHostMappingInfoValve);")]
        [NativeApi(EntryPoint = "vkGetDescriptorSetLayoutHostMappingInfoVALVE", Convention = CallingConvention.Winapi)]
        public unsafe partial void GetDescriptorSetLayoutHostMappingInfoValve([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] DescriptorSetBindingReferenceVALVE* pBindingReference, [Count(Count = 0), Flow(FlowDirection.Out)] out DescriptorSetLayoutHostMappingInfoVALVE pHostMapping);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetDescriptorSetLayoutHostMappingInfoVALVE", Convention = CallingConvention.Winapi)]
        public unsafe partial void GetDescriptorSetLayoutHostMappingInfoValve([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] in DescriptorSetBindingReferenceVALVE pBindingReference, [Count(Count = 0), Flow(FlowDirection.Out)] DescriptorSetLayoutHostMappingInfoVALVE* pHostMapping);
