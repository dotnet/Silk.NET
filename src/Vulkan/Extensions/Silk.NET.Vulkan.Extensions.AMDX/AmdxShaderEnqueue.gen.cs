...
namespace Silk.NET.Vulkan.Extensions.AMDX
{
    ...
    public unsafe partial class AmdxShaderEnqueue : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdDispatchGraphAMDX", Convention = CallingConvention.Winapi)]
        public partial void CmdDispatchGraph([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] ulong scratch, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in DispatchGraphCountInfoAMDX pCountInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdDispatchGraphIndirectAMDX", Convention = CallingConvention.Winapi)]
        public partial void CmdDispatchGraphIndirect([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0)] ulong scratch, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in DispatchGraphCountInfoAMDX pCountInfo);
