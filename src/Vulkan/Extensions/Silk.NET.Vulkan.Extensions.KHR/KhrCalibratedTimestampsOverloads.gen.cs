...
{
    public static class KhrCalibratedTimestampsOverloads
    {
        /// <summary>To be documented.</summary>
        public static unsafe Result GetCalibratedTimestamp(this KhrCalibratedTimestamps thisApi, [Count(Count = 0)] Device device, [Count(Count = 0)] uint timestampCount, [Count(Parameter = "timestampCount"), Flow(Silk.NET.Core.Native.FlowDirection.In)] CalibratedTimestampInfoKHR* pTimestampInfos, [Count(Parameter = "timestampCount")] ulong* pTimestamps, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<ulong> pMaxDeviation)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetPhysicalDeviceCalibrateableTimeDomain(this KhrCalibratedTimestamps thisApi, [Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0)] uint* pTimeDomainCount, [Count(Parameter = "pTimeDomainCount"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<TimeDomainKHR> pTimeDomains)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetPhysicalDeviceCalibrateableTimeDomain(this KhrCalibratedTimestamps thisApi, [Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0)] Span<uint> pTimeDomainCount, [Count(Parameter = "pTimeDomainCount"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] TimeDomainKHR* pTimeDomains)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetPhysicalDeviceCalibrateableTimeDomain(this KhrCalibratedTimestamps thisApi, [Count(Count = 0)] PhysicalDevice physicalDevice, [Count(Count = 0)] Span<uint> pTimeDomainCount, [Count(Parameter = "pTimeDomainCount"), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<TimeDomainKHR> pTimeDomains)
        {
            // SpanOverloader
