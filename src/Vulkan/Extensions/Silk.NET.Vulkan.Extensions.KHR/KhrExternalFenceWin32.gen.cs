...
namespace Silk.NET.Vulkan.Extensions.KHR
{
    ...
    public unsafe partial class KhrExternalFenceWin32 : NativeExtension<Vk>
    {
        ...
        public partial unsafe Result GetFenceWin32Handle([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] FenceGetWin32HandleInfoKHR* pGetWin32HandleInfo, [Count(Count = 0), Flow(FlowDirection.Out)] IntPtr* pHandle);
        ...
        public partial unsafe Result ImportFenceWin32Handle([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] ImportFenceWin32HandleInfoKHR* pImportFenceWin32HandleInfo);
