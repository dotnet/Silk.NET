...
namespace Silk.NET.Vulkan.Extensions.KHR
{
    ...
    public unsafe partial class KhrExternalFenceFd : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetFenceFdKHR", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetFenceF([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in FenceGetFdInfoKHR pGetFdInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] int* pFd);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkGetFenceFdKHR", Convention = CallingConvention.Winapi)]
        public partial Result GetFenceF([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in FenceGetFdInfoKHR pGetFdInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] out int pFd);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkImportFenceFdKHR", Convention = CallingConvention.Winapi)]
        public partial Result ImportFenceF([Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in ImportFenceFdInfoKHR pImportFenceFdInfo);
