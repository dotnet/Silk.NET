...
namespace Silk.NET.Vulkan.Extensions.KHR
{
    ...
    public unsafe partial class KhrPipelineExecutableProperties : NativeExtension<Vk>
    {
        ...
        /// <summary>To be added.</summary>
        [NativeApi(EntryPoint = "vkGetPipelineExecutableInternalRepresentationsKHR")]
        public partial Result GetPipelineExecutableInternalRepresentation([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] ref PipelineExecutableInfoKHR pExecutableInfo, [Count(Count = 0)] ref uint pInternalRepresentationCount, [Count(Computed = "pInternalRepresentationCount"), Flow(FlowDirection.Out)] out PipelineExecutableInternalRepresentationKHR pInternalRepresentations);
        ...
        /// <summary>To be added.</summary>
        [NativeApi(EntryPoint = "vkGetPipelineExecutablePropertiesKHR")]
        public partial Result GetPipelineExecutableProperties([Count(Count = 0)] Device device, [Count(Count = 0), Flow(FlowDirection.In)] ref PipelineInfoKHR pPipelineInfo, [Count(Count = 0)] ref uint pExecutableCount, [Count(Computed = "pExecutableCount"), Flow(FlowDirection.Out)] out PipelineExecutablePropertiesKHR pProperties);
