...
namespace Silk.NET.Vulkan.Extensions.KHR
{
    public static class KhrMaintenance6Overloads
    {
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void CmdBindDescriptorSets2(this KhrMaintenance6 thisApi, [Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<BindDescriptorSetsInfo> pBindDescriptorSetsInfo)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void CmdPushConstants2(this KhrMaintenance6 thisApi, [Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<PushConstantsInfo> pPushConstantsInfo)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void CmdPushDescriptorSet2(this KhrMaintenance6 thisApi, [Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<PushDescriptorSetInfo> pPushDescriptorSetInfo)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void CmdPushDescriptorSetWithTemplate2(this KhrMaintenance6 thisApi, [Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<PushDescriptorSetWithTemplateInfo> pPushDescriptorSetWithTemplateInfo)
        {
            // SpanOverloader
