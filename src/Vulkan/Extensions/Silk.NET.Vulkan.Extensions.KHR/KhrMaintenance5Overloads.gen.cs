...
namespace Silk.NET.Vulkan.Extensions.KHR
{
    public static class KhrMaintenance5Overloads
    {
        ...
        public static unsafe void GetDeviceImageSubresourceLayout(this KhrMaintenance5 thisApi, [Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] DeviceImageSubresourceInfo* pInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<SubresourceLayout2> pLayout)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void GetRenderingAreaGranularity(this KhrMaintenance5 thisApi, [Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] RenderingAreaInfo* pRenderingAreaInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Span<Extent2D> pGranularity)
        {
            // SpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public static unsafe void GetRenderingAreaGranularity(this KhrMaintenance5 thisApi, [Count(Count = 0)] Device device, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ReadOnlySpan<RenderingAreaInfo> pRenderingAreaInfo, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.Out)] Extent2D* pGranularity)
        {
            // SpanOverloader
