...
namespace Silk.NET.Vulkan.Extensions.QCOM
{
    ...
    public unsafe partial class QComTileShading : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBeginPerTileExecutionQCOM", Convention = CallingConvention.Winapi)]
        public partial void CmdBeginPerTileExecution([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PerTileBeginInfoQCOM pPerTileBeginInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdDispatchTileQCOM", Convention = CallingConvention.Winapi)]
        public partial void CmdDispatchTile([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DispatchTileInfoQCOM pDispatchTileInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdEndPerTileExecutionQCOM", Convention = CallingConvention.Winapi)]
        public partial void CmdEndPerTileExecution([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PerTileEndInfoQCOM pPerTileEndInfo);
