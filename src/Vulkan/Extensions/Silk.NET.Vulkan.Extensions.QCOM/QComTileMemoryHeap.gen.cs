...
namespace Silk.NET.Vulkan.Extensions.QCOM
{
    ...
    public unsafe partial class QComTileMemoryHeap : NativeExtension<Vk>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "vkCmdBindTileMemoryQCOM", Convention = CallingConvention.Winapi)]
        public partial void CmdBindTileMemory([Count(Count = 0)] CommandBuffer commandBuffer, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly TileMemoryBindInfoQCOM pTileMemoryBindInfo);
