...
namespace Silk.NET.OpenXR.Extensions.FB
{
    ...
    public unsafe partial class FBSpatialEntityQuery : NativeExtension<XR>
    {
        ...
        public unsafe partial Result QuerySpacesFB([Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] SpaceQueryInfoBaseHeaderFB* info, [Count(Count = 0)] ulong* requestId);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySpacesFB", Convention = CallingConvention.Winapi)]
        public unsafe partial Result QuerySpacesFB([Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] SpaceQueryInfoBaseHeaderFB* info, [Count(Count = 0)] ref ulong requestId);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySpacesFB", Convention = CallingConvention.Winapi)]
        public unsafe partial Result QuerySpacesFB([Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] in SpaceQueryInfoBaseHeaderFB info, [Count(Count = 0)] ulong* requestId);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySpacesFB", Convention = CallingConvention.Winapi)]
        public partial Result QuerySpacesFB([Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] in SpaceQueryInfoBaseHeaderFB info, [Count(Count = 0)] ref ulong requestId);
