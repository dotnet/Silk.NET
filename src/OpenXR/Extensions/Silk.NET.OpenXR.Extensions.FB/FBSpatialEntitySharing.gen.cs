...
namespace Silk.NET.OpenXR.Extensions.FB
{
    ...
    public unsafe partial class FBSpatialEntitySharing : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrShareSpacesFB", Convention = CallingConvention.Winapi)]
        public unsafe partial Result ShareSpacesFB([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SpaceShareInfoFB info, [Count(Count = 0)] ulong* requestId);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrShareSpacesFB", Convention = CallingConvention.Winapi)]
        public partial Result ShareSpacesFB([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SpaceShareInfoFB info, [Count(Count = 0)] ref ulong requestId);
