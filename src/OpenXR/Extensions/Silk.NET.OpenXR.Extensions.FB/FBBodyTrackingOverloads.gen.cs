...
namespace Silk.NET.OpenXR.Extensions.FB
{
    public static class FBBodyTrackingOverloads
    {
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetBodySkeletonFB(this FBBodyTracking thisApi, [Count(Count = 0)] BodyTrackerFB bodyTracker, [Count(Count = 0)] Span<BodySkeletonFB> skeleton)
        {
            // SpanOverloader
            return thisApi.GetBodySkeletonFB(bodyTracker, ref skeleton.GetPinnableReference());
        }
