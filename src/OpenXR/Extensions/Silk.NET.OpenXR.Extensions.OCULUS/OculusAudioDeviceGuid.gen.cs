...
namespace Silk.NET.OpenXR.Extensions.OCULUS
{
    ...
    public unsafe partial class OculusAudioDeviceGuid : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetAudioInputDeviceGuidOculus")]
        public partial Result GetAudioInputDeviceGuidOcul([Count(Count = 0)] Instance instance, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetAudioOutputDeviceGuidOculus")]
        public partial Result GetAudioOutputDeviceGuidOcul([Count(Count = 0)] Instance instance, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
