...
namespace Silk.NET.OpenXR.Extensions.ML
{
    ...
    public unsafe partial class MLMarkerUnderstanding : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateMarkerDetectorML", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateMarkerDetectorML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in MarkerDetectorCreateInfoML createInfo, [Count(Count = 0)] MarkerDetectorML* markerDetector);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateMarkerDetectorML", Convention = CallingConvention.Winapi)]
        public partial Result CreateMarkerDetectorML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in MarkerDetectorCreateInfoML createInfo, [Count(Count = 0)] ref MarkerDetectorML markerDetector);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateMarkerSpaceML", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateMarkerSpaceML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in MarkerSpaceCreateInfoML createInfo, [Count(Count = 0)] Space* space);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateMarkerSpaceML", Convention = CallingConvention.Winapi)]
        public partial Result CreateMarkerSpaceML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in MarkerSpaceCreateInfoML createInfo, [Count(Count = 0)] ref Space space);
