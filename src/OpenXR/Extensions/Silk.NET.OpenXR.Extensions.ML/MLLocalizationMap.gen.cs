...
namespace Silk.NET.OpenXR.Extensions.ML
{
    ...
    public unsafe partial class MLLocalizationMap : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateExportedLocalizationMapML", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateExportedLocalizationMapML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in UuidEXT mapUuid, [Count(Count = 0)] ExportedLocalizationMapML* map);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateExportedLocalizationMapML", Convention = CallingConvention.Winapi)]
        public partial Result CreateExportedLocalizationMapML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in UuidEXT mapUuid, [Count(Count = 0)] ref ExportedLocalizationMapML map);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrImportLocalizationMapML", Convention = CallingConvention.Winapi)]
        public unsafe partial Result ImportLocalizationMapML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in LocalizationMapImportInfoML importInfo, [Count(Count = 0)] UuidEXT* mapUuid);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrImportLocalizationMapML", Convention = CallingConvention.Winapi)]
        public partial Result ImportLocalizationMapML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in LocalizationMapImportInfoML importInfo, [Count(Count = 0)] ref UuidEXT mapUuid);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQueryLocalizationMapsML", Convention = CallingConvention.Winapi)]
        public unsafe partial Result QueryLocalizationMapsML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in LocalizationMapQueryInfoBaseHeaderML queryInfo, [Count(Count = 0)] uint mapCapacityInput, [Count(Count = 0)] uint mapCountOutput, [Count(Parameter = "mapCapacityInput")] LocalizationMapML* maps);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrRequestMapLocalizationML", Convention = CallingConvention.Winapi)]
        public partial Result RequestMapLocalizationML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in MapLocalizationRequestInfoML requestInfo);
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result QueryLocalizationMapsML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in LocalizationMapQueryInfoBaseHeaderML queryInfo, [Count(Count = 0)] uint mapCountOutput, [Count(Parameter = "mapCapacityInput")] Span<LocalizationMapML> maps)
        {
            // ImplicitCountSpanOverloader
