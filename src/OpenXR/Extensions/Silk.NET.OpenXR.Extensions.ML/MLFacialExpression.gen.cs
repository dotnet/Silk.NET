...
namespace Silk.NET.OpenXR.Extensions.ML
{
    ...
    public unsafe partial class MLFacialExpression : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateFacialExpressionClientML", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateFacialExpressionClientML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in FacialExpressionClientCreateInfoML createInfo, [Count(Count = 0)] FacialExpressionClientML* facialExpressionClient);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateFacialExpressionClientML", Convention = CallingConvention.Winapi)]
        public partial Result CreateFacialExpressionClientML([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in FacialExpressionClientCreateInfoML createInfo, [Count(Count = 0)] ref FacialExpressionClientML facialExpressionClient);
