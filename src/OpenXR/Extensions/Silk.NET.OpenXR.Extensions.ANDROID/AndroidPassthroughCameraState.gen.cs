...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidPassthroughCameraState : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetPassthroughCameraStateANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetPassthroughCameraState([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PassthroughCameraStateGetInfoANDROID getInfo, [Count(Count = 0)] PassthroughCameraStateANDROID* cameraStateOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetPassthroughCameraStateANDROID", Convention = CallingConvention.Winapi)]
        public partial Result GetPassthroughCameraState([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PassthroughCameraStateGetInfoANDROID getInfo, [Count(Count = 0)] ref PassthroughCameraStateANDROID cameraStateOutput);
