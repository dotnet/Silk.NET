...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidAnchorSharingExport : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrShareAnchorANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result ShareAnchor([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AnchorSharingInfoANDROID sharingInfo, [Count(Count = 0)] AnchorSharingTokenANDROID* anchorToken);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrShareAnchorANDROID", Convention = CallingConvention.Winapi)]
        public partial Result ShareAnchor([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AnchorSharingInfoANDROID sharingInfo, [Count(Count = 0)] ref AnchorSharingTokenANDROID anchorToken);
