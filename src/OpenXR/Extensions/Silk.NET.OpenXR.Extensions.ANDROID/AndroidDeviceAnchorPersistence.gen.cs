...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidDeviceAnchorPersistence : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateDeviceAnchorPersistenceANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateDeviceAnchorPersistence([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DeviceAnchorPersistenceCreateInfoANDROID createInfo, [Count(Count = 0)] DeviceAnchorPersistenceANDROID* outHandle);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateDeviceAnchorPersistenceANDROID", Convention = CallingConvention.Winapi)]
        public partial Result CreateDeviceAnchorPersistence([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in DeviceAnchorPersistenceCreateInfoANDROID createInfo, [Count(Count = 0)] ref DeviceAnchorPersistenceANDROID outHandle);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreatePersistedAnchorSpaceANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreatePersistedAnchorSpace([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PersistedAnchorSpaceCreateInfoANDROID createInfo, [Count(Count = 0)] Space* anchorOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreatePersistedAnchorSpaceANDROID", Convention = CallingConvention.Winapi)]
        public partial Result CreatePersistedAnchorSpace([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PersistedAnchorSpaceCreateInfoANDROID createInfo, [Count(Count = 0)] ref Space anchorOutput);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetAnchorPersistStateANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetAnchorPersistState([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in UuidEXT anchorId, [Count(Count = 0)] AnchorPersistStateANDROID* persistState);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetAnchorPersistStateANDROID", Convention = CallingConvention.Winapi)]
        public partial Result GetAnchorPersistState([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in UuidEXT anchorId, [Count(Count = 0)] ref AnchorPersistStateANDROID persistState);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrPersistAnchorANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result PersistAnchor([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PersistedAnchorSpaceInfoANDROID persistedInfo, [Count(Count = 0)] UuidEXT* anchorIdOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrPersistAnchorANDROID", Convention = CallingConvention.Winapi)]
        public partial Result PersistAnchor([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in PersistedAnchorSpaceInfoANDROID persistedInfo, [Count(Count = 0)] ref UuidEXT anchorIdOutput);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrUnpersistAnchorANDROID", Convention = CallingConvention.Winapi)]
        public partial Result UnpersistAnchor([Count(Count = 0)] DeviceAnchorPersistenceANDROID handle, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in UuidEXT anchorId);
