...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidTrackablesObject : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetTrackableObjectANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetTrackableObject([Count(Count = 0)] TrackableTrackerANDROID tracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableGetInfoANDROID getInfo, [Count(Count = 0)] TrackableObjectANDROID* objectOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetTrackableObjectANDROID", Convention = CallingConvention.Winapi)]
        public partial Result GetTrackableObject([Count(Count = 0)] TrackableTrackerANDROID tracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableGetInfoANDROID getInfo, [Count(Count = 0)] ref TrackableObjectANDROID objectOutput);
