...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidTrackables : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateAnchorSpaceANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateAnchorSpace([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AnchorSpaceCreateInfoANDROID createInfo, [Count(Count = 0)] Space* anchorOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateAnchorSpaceANDROID", Convention = CallingConvention.Winapi)]
        public partial Result CreateAnchorSpace([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AnchorSpaceCreateInfoANDROID createInfo, [Count(Count = 0)] ref Space anchorOutput);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateTrackableTrackerANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateTrackableTracker([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableTrackerCreateInfoANDROID createInfo, [Count(Count = 0)] TrackableTrackerANDROID* trackableTracker);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateTrackableTrackerANDROID", Convention = CallingConvention.Winapi)]
        public partial Result CreateTrackableTracker([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableTrackerCreateInfoANDROID createInfo, [Count(Count = 0)] ref TrackableTrackerANDROID trackableTracker);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetTrackablePlaneANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetTrackablePlane([Count(Count = 0)] TrackableTrackerANDROID trackableTracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableGetInfoANDROID getInfo, [Count(Count = 0)] TrackablePlaneANDROID* planeOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetTrackablePlaneANDROID", Convention = CallingConvention.Winapi)]
        public partial Result GetTrackablePlane([Count(Count = 0)] TrackableTrackerANDROID trackableTracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableGetInfoANDROID getInfo, [Count(Count = 0)] ref TrackablePlaneANDROID planeOutput);
