...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidTrackablesMarker : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetTrackableMarkerANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetTrackableMarker([Count(Count = 0)] TrackableTrackerANDROID tracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableGetInfoANDROID getInfo, [Count(Count = 0)] TrackableMarkerANDROID* markerOutput);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetTrackableMarkerANDROID", Convention = CallingConvention.Winapi)]
        public partial Result GetTrackableMarker([Count(Count = 0)] TrackableTrackerANDROID tracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in TrackableGetInfoANDROID getInfo, [Count(Count = 0)] ref TrackableMarkerANDROID markerOutput);
