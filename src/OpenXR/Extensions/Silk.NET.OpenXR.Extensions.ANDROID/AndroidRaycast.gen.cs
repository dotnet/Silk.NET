...
namespace Silk.NET.OpenXR.Extensions.ANDROID
{
    ...
    public unsafe partial class AndroidRaycast : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrRaycastANDROID", Convention = CallingConvention.Winapi)]
        public unsafe partial Result Raycast([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RaycastInfoANDROID rayInfo, [Count(Count = 0)] RaycastHitResultsANDROID* results);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrRaycastANDROID", Convention = CallingConvention.Winapi)]
        public partial Result Raycast([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RaycastInfoANDROID rayInfo, [Count(Count = 0)] ref RaycastHitResultsANDROID results);
