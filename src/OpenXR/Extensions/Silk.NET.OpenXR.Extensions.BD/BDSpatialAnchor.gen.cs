...
namespace Silk.NET.OpenXR.Extensions.BD
{
    ...
    public unsafe partial class BDSpatialAnchor : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorCreateInfoBD info, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorCreateInfoBD info, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrPersistSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result PersistSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorPersistInfoBD info, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrPersistSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result PersistSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorPersistInfoBD info, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrUnpersistSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result UnpersistSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorUnpersistInfoBD info, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrUnpersistSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result UnpersistSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorUnpersistInfoBD info, [Count(Count = 0)] ref FutureEXT future);
