...
namespace Silk.NET.OpenXR.Extensions.BD
{
    ...
    public unsafe partial class BDSpatialSensing : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateAnchorSpaceBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateAnchorSpaceBD([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AnchorSpaceCreateInfoBD createInfo, [Count(Count = 0)] Space* space);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateAnchorSpaceBD", Convention = CallingConvention.Winapi)]
        public partial Result CreateAnchorSpaceBD([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in AnchorSpaceCreateInfoBD createInfo, [Count(Count = 0)] ref Space space);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSenseDataProviderBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSenseDataProviderBD([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SenseDataProviderCreateInfoBD createInfo, [Count(Count = 0)] SenseDataProviderBD* provider);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSenseDataProviderBD", Convention = CallingConvention.Winapi)]
        public partial Result CreateSenseDataProviderBD([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SenseDataProviderCreateInfoBD createInfo, [Count(Count = 0)] ref SenseDataProviderBD provider);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialEntityAnchorBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialEntityAnchorBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityAnchorCreateInfoBD createInfo, [Count(Count = 0)] AnchorBD* anchor);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialEntityAnchorBD", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialEntityAnchorBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityAnchorCreateInfoBD createInfo, [Count(Count = 0)] ref AnchorBD anchor);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialEntityComponentDataBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialEntityComponentDataBD([Count(Count = 0)] SenseDataSnapshotBD snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityComponentGetInfoBD getInfo, [Count(Count = 0)] SpatialEntityComponentDataBaseHeaderBD* componentData);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialEntityComponentDataBD", Convention = CallingConvention.Winapi)]
        public partial Result GetSpatialEntityComponentDataBD([Count(Count = 0)] SenseDataSnapshotBD snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityComponentGetInfoBD getInfo, [Count(Count = 0)] ref SpatialEntityComponentDataBaseHeaderBD componentData);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySenseDataAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result QuerySenseDataAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SenseDataQueryInfoBD queryInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySenseDataAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result QuerySenseDataAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SenseDataQueryInfoBD queryInfo, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrStartSenseDataProviderAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result StartSenseDataProviderAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SenseDataProviderStartInfoBD startInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrStartSenseDataProviderAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result StartSenseDataProviderAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SenseDataProviderStartInfoBD startInfo, [Count(Count = 0)] ref FutureEXT future);
