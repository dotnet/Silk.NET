...
namespace Silk.NET.OpenXR.Extensions.BD
{
    ...
    public unsafe partial class BDBodyTracking : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateBodyTrackerBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateBodyTrackerBD([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BodyTrackerCreateInfoBD createInfo, [Count(Count = 0)] BodyTrackerBD* bodyTracker);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateBodyTrackerBD", Convention = CallingConvention.Winapi)]
        public partial Result CreateBodyTrackerBD([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BodyTrackerCreateInfoBD createInfo, [Count(Count = 0)] ref BodyTrackerBD bodyTracker);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrLocateBodyJointsBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result LocateBodyJointsBD([Count(Count = 0)] BodyTrackerBD bodyTracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BodyJointsLocateInfoBD locateInfo, [Count(Count = 0)] BodyJointLocationsBD* locations);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrLocateBodyJointsBD", Convention = CallingConvention.Winapi)]
        public partial Result LocateBodyJointsBD([Count(Count = 0)] BodyTrackerBD bodyTracker, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in BodyJointsLocateInfoBD locateInfo, [Count(Count = 0)] ref BodyJointLocationsBD locations);
