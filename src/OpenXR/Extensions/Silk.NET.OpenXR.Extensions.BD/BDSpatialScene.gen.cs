...
namespace Silk.NET.OpenXR.Extensions.BD
{
    ...
    public unsafe partial class BDSpatialScene : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCaptureSceneAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CaptureSceneAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SceneCaptureInfoBD info, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCaptureSceneAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result CaptureSceneAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SceneCaptureInfoBD info, [Count(Count = 0)] ref FutureEXT future);
