...
namespace Silk.NET.OpenXR.Extensions.BD
{
    ...
    public unsafe partial class BDSpatialAnchorSharing : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrDownloadSharedSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result DownloadSharedSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SharedSpatialAnchorDownloadInfoBD info, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrDownloadSharedSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result DownloadSharedSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SharedSpatialAnchorDownloadInfoBD info, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrShareSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public unsafe partial Result ShareSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorShareInfoBD info, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrShareSpatialAnchorAsyncBD", Convention = CallingConvention.Winapi)]
        public partial Result ShareSpatialAnchorAsyncBD([Count(Count = 0)] SenseDataProviderBD provider, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorShareInfoBD info, [Count(Count = 0)] ref FutureEXT future);
