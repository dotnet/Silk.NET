...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtSpatialEntity : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialContextAsyncEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialContextAsync([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialContextCreateInfoEXT createInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialContextAsyncEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialContextAsync([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialContextCreateInfoEXT createInfo, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialDiscoverySnapshotAsyncEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialDiscoverySnapshotAsync([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialDiscoverySnapshotCreateInfoEXT createInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialDiscoverySnapshotAsyncEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialDiscoverySnapshotAsync([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialDiscoverySnapshotCreateInfoEXT createInfo, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialDiscoverySnapshotCompleteEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialDiscoverySnapshotComplete([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in CreateSpatialDiscoverySnapshotCompletionInfoEXT createSnapshotCompletionInfo, [Count(Count = 0)] ref CreateSpatialDiscoverySnapshotCompletionEXT completion);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialEntityFromIdEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialEntityFromId([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityFromIdCreateInfoEXT createInfo, [Count(Count = 0)] SpatialEntityEXT* spatialEntity);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialEntityFromIdEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialEntityFromId([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityFromIdCreateInfoEXT createInfo, [Count(Count = 0)] ref SpatialEntityEXT spatialEntity);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialUpdateSnapshotEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialUpdateSnapshot([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialUpdateSnapshotCreateInfoEXT createInfo, [Count(Count = 0)] SpatialSnapshotEXT* snapshot);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialUpdateSnapshotEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialUpdateSnapshot([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialUpdateSnapshotCreateInfoEXT createInfo, [Count(Count = 0)] ref SpatialSnapshotEXT snapshot);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferFloatEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferFloat([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] float* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferFloatEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferFloat([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref float buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferFloatEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferFloat([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] float* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferFloatEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetSpatialBufferFloat([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref float buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferUint16EXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferUint16([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ushort* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferUint16EXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferUint16([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref ushort buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferUint16EXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferUint16([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ushort* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferUint16EXT", Convention = CallingConvention.Winapi)]
        public partial Result GetSpatialBufferUint16([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref ushort buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferVector2fEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferVector2([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref Vector2f buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferVector2fEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetSpatialBufferVector2([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref Vector2f buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferVector3fEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferVector3([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Vector3f* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferVector3fEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferVector3([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref Vector3f buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferVector3fEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSpatialBufferVector3([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Vector3f* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSpatialBufferVector3fEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetSpatialBufferVector3([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref Vector3f buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySpatialComponentDataEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result QuerySpatialComponentData([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialComponentDataQueryConditionEXT queryCondition, [Count(Count = 0)] SpatialComponentDataQueryResultEXT* queryResult);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrQuerySpatialComponentDataEXT", Convention = CallingConvention.Winapi)]
        public partial Result QuerySpatialComponentData([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialComponentDataQueryConditionEXT queryCondition, [Count(Count = 0)] ref SpatialComponentDataQueryResultEXT queryResult);
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferFloat([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<float> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferFloat([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<float> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferString([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferString([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferUint16([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<ushort> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferUint16([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<ushort> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferUint32([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<uint> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferUint32([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<uint> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferUint8([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferUint8([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferVector2([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<Vector2f> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferVector2([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<Vector2f> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferVector3([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<Vector3f> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSpatialBufferVector3([Count(Count = 0)] SpatialSnapshotEXT snapshot, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialBufferGetInfoEXT info, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<Vector3f> buffer)
        {
            // ImplicitCountSpanOverloader
