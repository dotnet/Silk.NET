...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtPlaneDetection : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrBeginPlaneDetectionEXT", Convention = CallingConvention.Winapi)]
        public partial Result BeginPlaneDetection([Count(Count = 0)] PlaneDetectorEXT planeDetector, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in PlaneDetectorBeginInfoEXT beginInfo);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreatePlaneDetectorEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreatePlaneDetector([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in PlaneDetectorCreateInfoEXT createInfo, [Count(Count = 0)] PlaneDetectorEXT* planeDetector);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreatePlaneDetectorEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreatePlaneDetector([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in PlaneDetectorCreateInfoEXT createInfo, [Count(Count = 0)] ref PlaneDetectorEXT planeDetector);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetPlaneDetectionsEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetPlaneDetection([Count(Count = 0)] PlaneDetectorEXT planeDetector, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in PlaneDetectorGetInfoEXT info, [Count(Count = 0)] PlaneDetectorLocationsEXT* locations);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetPlaneDetectionsEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetPlaneDetection([Count(Count = 0)] PlaneDetectorEXT planeDetector, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in PlaneDetectorGetInfoEXT info, [Count(Count = 0)] ref PlaneDetectorLocationsEXT locations);
