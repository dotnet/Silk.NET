...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtInteractionRenderModel : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelPoseTopLevelUserPathEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetRenderModelPoseTopLevelUserPath([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in InteractionRenderModelTopLevelUserPathGetInfoEXT info, [Count(Count = 0)] ulong* topLevelUserPath);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelPoseTopLevelUserPathEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetRenderModelPoseTopLevelUserPath([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in InteractionRenderModelTopLevelUserPathGetInfoEXT info, [Count(Count = 0)] ref ulong topLevelUserPath);
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result EnumerateRenderModelSubactionPath([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in InteractionRenderModelSubactionPathInfoEXT info, [Count(Count = 0)] uint* pathCountOutput, [Count(Parameter = "pathCapacityInput")] Span<ulong> paths)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result EnumerateRenderModelSubactionPath([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in InteractionRenderModelSubactionPathInfoEXT info, [Count(Count = 0)] ref uint pathCountOutput, [Count(Parameter = "pathCapacityInput")] Span<ulong> paths)
        {
            // ImplicitCountSpanOverloader
