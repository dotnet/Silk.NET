...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtRenderModel : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateRenderModelEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateRenderModel([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelCreateInfoEXT createInfo, [Count(Count = 0)] RenderModelEXT* renderModel);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateRenderModelEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateRenderModel([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelCreateInfoEXT createInfo, [Count(Count = 0)] ref RenderModelEXT renderModel);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateRenderModelAssetEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateRenderModelAsset([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelAssetCreateInfoEXT createInfo, [Count(Count = 0)] RenderModelAssetEXT* asset);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateRenderModelAssetEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateRenderModelAsset([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelAssetCreateInfoEXT createInfo, [Count(Count = 0)] ref RenderModelAssetEXT asset);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateRenderModelSpaceEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateRenderModelSpace([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelSpaceCreateInfoEXT createInfo, [Count(Count = 0)] Space* space);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateRenderModelSpaceEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateRenderModelSpace([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelSpaceCreateInfoEXT createInfo, [Count(Count = 0)] ref Space space);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelAssetDataEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetRenderModelAssetData([Count(Count = 0)] RenderModelAssetEXT asset, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelAssetDataGetInfoEXT getInfo, [Count(Count = 0)] RenderModelAssetDataEXT* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelAssetDataEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetRenderModelAssetData([Count(Count = 0)] RenderModelAssetEXT asset, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelAssetDataGetInfoEXT getInfo, [Count(Count = 0)] ref RenderModelAssetDataEXT buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelAssetPropertiesEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetRenderModelAssetProperties([Count(Count = 0)] RenderModelAssetEXT asset, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelAssetPropertiesGetInfoEXT getInfo, [Count(Count = 0)] RenderModelAssetPropertiesEXT* properties);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelAssetPropertiesEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetRenderModelAssetProperties([Count(Count = 0)] RenderModelAssetEXT asset, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelAssetPropertiesGetInfoEXT getInfo, [Count(Count = 0)] ref RenderModelAssetPropertiesEXT properties);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelPropertiesEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetRenderModelProperties([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelPropertiesGetInfoEXT getInfo, [Count(Count = 0)] RenderModelPropertiesEXT* properties);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelPropertiesEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetRenderModelProperties([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelPropertiesGetInfoEXT getInfo, [Count(Count = 0)] ref RenderModelPropertiesEXT properties);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelStateEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetRenderModelState([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelStateGetInfoEXT getInfo, [Count(Count = 0)] RenderModelStateEXT* state);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetRenderModelStateEXT", Convention = CallingConvention.Winapi)]
        public partial Result GetRenderModelState([Count(Count = 0)] RenderModelEXT renderModel, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in RenderModelStateGetInfoEXT getInfo, [Count(Count = 0)] ref RenderModelStateEXT state);
