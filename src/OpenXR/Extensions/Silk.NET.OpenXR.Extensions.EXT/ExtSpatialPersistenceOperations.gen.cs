...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtSpatialPersistenceOperations : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrPersistSpatialEntityAsyncEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result PersistSpatialEntityAsync([Count(Count = 0)] SpatialPersistenceContextEXT persistenceContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityPersistInfoEXT persistInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrPersistSpatialEntityAsyncEXT", Convention = CallingConvention.Winapi)]
        public partial Result PersistSpatialEntityAsync([Count(Count = 0)] SpatialPersistenceContextEXT persistenceContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityPersistInfoEXT persistInfo, [Count(Count = 0)] ref FutureEXT future);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrUnpersistSpatialEntityAsyncEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result UnpersistSpatialEntityAsync([Count(Count = 0)] SpatialPersistenceContextEXT persistenceContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityUnpersistInfoEXT unpersistInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrUnpersistSpatialEntityAsyncEXT", Convention = CallingConvention.Winapi)]
        public partial Result UnpersistSpatialEntityAsync([Count(Count = 0)] SpatialPersistenceContextEXT persistenceContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialEntityUnpersistInfoEXT unpersistInfo, [Count(Count = 0)] ref FutureEXT future);
