...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtSpatialAnchor : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialAnchor([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorCreateInfoEXT createInfo, [Count(Count = 0)] ulong* anchorEntityId, [Count(Count = 0)] SpatialEntityEXT* anchorEntity);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialAnchor([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorCreateInfoEXT createInfo, [Count(Count = 0)] ulong* anchorEntityId, [Count(Count = 0)] ref SpatialEntityEXT anchorEntity);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialAnchor([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorCreateInfoEXT createInfo, [Count(Count = 0)] ref ulong anchorEntityId, [Count(Count = 0)] SpatialEntityEXT* anchorEntity);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialAnchor([Count(Count = 0)] SpatialContextEXT spatialContext, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialAnchorCreateInfoEXT createInfo, [Count(Count = 0)] ref ulong anchorEntityId, [Count(Count = 0)] ref SpatialEntityEXT anchorEntity);
