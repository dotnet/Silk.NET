...
namespace Silk.NET.OpenXR.Extensions.EXT
{
    ...
    public unsafe partial class ExtSpatialPersistence : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialPersistenceContextAsyncEXT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialPersistenceContextAsync([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialPersistenceContextCreateInfoEXT createInfo, [Count(Count = 0)] FutureEXT* future);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialPersistenceContextAsyncEXT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialPersistenceContextAsync([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] [RequiresLocation] in SpatialPersistenceContextCreateInfoEXT createInfo, [Count(Count = 0)] ref FutureEXT future);
