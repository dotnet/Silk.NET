...
namespace Silk.NET.OpenXR.Extensions.HTC
{
    ...
    public unsafe partial class HtcAnchor : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorHTC", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialAnchorHtc([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in SpatialAnchorCreateInfoHTC createInfo, [Count(Count = 0)] Space* anchor);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialAnchorHTC", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialAnchorHtc([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in SpatialAnchorCreateInfoHTC createInfo, [Count(Count = 0)] ref Space anchor);
