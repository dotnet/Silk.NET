...
namespace Silk.NET.OpenXR.Extensions.MSFT
{
    ...
    public unsafe partial class MsftControllerModel : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrLoadControllerModelMSFT")]
        public unsafe partial Result LoadControllerModelMsft([Count(Count = 0)] Session session, [Count(Count = 0)] ulong modelKey, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrLoadControllerModelMSFT")]
        public partial Result LoadControllerModelMsft([Count(Count = 0)] Session session, [Count(Count = 0)] ulong modelKey, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
