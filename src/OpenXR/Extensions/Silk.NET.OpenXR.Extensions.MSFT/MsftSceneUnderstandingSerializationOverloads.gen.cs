...
namespace Silk.NET.OpenXR.Extensions.MSFT
{
    public static class MsftSceneUnderstandingSerializationOverloads
    {
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetSerializedSceneFragmentDataMsft(this MsftSceneUnderstandingSerialization thisApi, [Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] SerializedSceneFragmentDataGetInfoMSFT* getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] Span<uint> readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetSerializedSceneFragmentDataMsft(scene, getInfo, countInput, ref readOutput.GetPinnableReference(), buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetSerializedSceneFragmentDataMsft(this MsftSceneUnderstandingSerialization thisApi, [Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<SerializedSceneFragmentDataGetInfoMSFT> getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] uint* readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetSerializedSceneFragmentDataMsft(scene, in getInfo.GetPinnableReference(), countInput, readOutput, buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetSerializedSceneFragmentDataMsft(this MsftSceneUnderstandingSerialization thisApi, [Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<SerializedSceneFragmentDataGetInfoMSFT> getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] Span<uint> readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetSerializedSceneFragmentDataMsft(scene, in getInfo.GetPinnableReference(), countInput, ref readOutput.GetPinnableReference(), buffer);
        }
