...
namespace Silk.NET.OpenXR.Extensions.MSFT
{
    ...
    public unsafe partial class MsftSpatialGraphBridge : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialGraphNodeSpaceMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result CreateSpatialGraphNodeSpaceMsft([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SpatialGraphNodeSpaceCreateInfoMSFT createInfo, [Count(Count = 0)] Space* space);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrCreateSpatialGraphNodeSpaceMSFT", Convention = CallingConvention.Winapi)]
        public partial Result CreateSpatialGraphNodeSpaceMsft([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SpatialGraphNodeSpaceCreateInfoMSFT createInfo, [Count(Count = 0)] ref Space space);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrTryCreateSpatialGraphStaticNodeBindingMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result TryCreateSpatialGraphStaticNodeBindingMsft([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SpatialGraphStaticNodeBindingCreateInfoMSFT createInfo, [Count(Count = 0)] SpatialGraphNodeBindingMSFT* nodeBinding);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrTryCreateSpatialGraphStaticNodeBindingMSFT", Convention = CallingConvention.Winapi)]
        public partial Result TryCreateSpatialGraphStaticNodeBindingMsft([Count(Count = 0)] Session session, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] ref readonly SpatialGraphStaticNodeBindingCreateInfoMSFT createInfo, [Count(Count = 0)] ref SpatialGraphNodeBindingMSFT nodeBinding);
