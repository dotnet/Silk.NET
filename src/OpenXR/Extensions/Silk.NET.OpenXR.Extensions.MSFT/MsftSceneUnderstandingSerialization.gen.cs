...
namespace Silk.NET.OpenXR.Extensions.MSFT
{
    ...
    public unsafe partial class MsftSceneUnderstandingSerialization : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSerializedSceneFragmentDataMSFT")]
        public unsafe partial Result GetSerializedSceneFragmentDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] SerializedSceneFragmentDataGetInfoMSFT* getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] uint* readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSerializedSceneFragmentDataMSFT")]
        public unsafe partial Result GetSerializedSceneFragmentDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] SerializedSceneFragmentDataGetInfoMSFT* getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] ref uint readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSerializedSceneFragmentDataMSFT")]
        public unsafe partial Result GetSerializedSceneFragmentDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] in SerializedSceneFragmentDataGetInfoMSFT getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] uint* readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSerializedSceneFragmentDataMSFT")]
        public partial Result GetSerializedSceneFragmentDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(FlowDirection.In)] in SerializedSceneFragmentDataGetInfoMSFT getInfo, [Count(Count = 0)] uint countInput, [Count(Count = 0)] ref uint readOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
