...
namespace Silk.NET.OpenXR.Extensions.MSFT
{
    ...
    public unsafe partial class MsftSceneMarker : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerDecodedStringMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSceneMarkerDecodedStringMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] byte* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerDecodedStringMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSceneMarkerDecodedStringMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref byte buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerDecodedStringMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSceneMarkerDecodedStringMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] byte* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerDecodedStringMSFT", Convention = CallingConvention.Winapi)]
        public partial Result GetSceneMarkerDecodedStringMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref byte buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerRawDataMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSceneMarkerRawDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] byte* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerRawDataMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSceneMarkerRawDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref byte buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerRawDataMSFT", Convention = CallingConvention.Winapi)]
        public unsafe partial Result GetSceneMarkerRawDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] byte* buffer);

        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetSceneMarkerRawDataMSFT", Convention = CallingConvention.Winapi)]
        public partial Result GetSceneMarkerRawDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] ref byte buffer);
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSceneMarkerDecodedStringMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSceneMarkerDecodedStringMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSceneMarkerRawDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] uint* bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
        ...
        /// <summary>To be documented.</summary>
        public unsafe Result GetSceneMarkerRawDataMsft([Count(Count = 0)] SceneMSFT scene, [Count(Count = 0), Flow(Silk.NET.Core.Native.FlowDirection.In)] in Guid markerId, [Count(Count = 0)] ref uint bufferCountOutput, [Count(Parameter = "bufferCapacityInput")] Span<byte> buffer)
        {
            // ImplicitCountSpanOverloader
