...
namespace Silk.NET.OpenXR.Extensions.KHR
{
    public static class KhrVulkanEnableOverloads
    {
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetVulkanDeviceExtension(this KhrVulkanEnable thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong systemId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] Span<uint> bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetVulkanDeviceExtension(instance, systemId, bufferCapacityInput, ref bufferCountOutput.GetPinnableReference(), buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetVulkanInstanceExtension(this KhrVulkanEnable thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong systemId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] Span<uint> bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetVulkanInstanceExtension(instance, systemId, bufferCapacityInput, ref bufferCountOutput.GetPinnableReference(), buffer);
        }
