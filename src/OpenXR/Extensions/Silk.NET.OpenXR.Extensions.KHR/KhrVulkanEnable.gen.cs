...
namespace Silk.NET.OpenXR.Extensions.KHR
{
    ...
    public unsafe partial class KhrVulkanEnable : NativeExtension<XR>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetVulkanDeviceExtensionsKHR")]
        public unsafe partial Result GetVulkanDeviceExtension([Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong systemId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetVulkanDeviceExtensionsKHR")]
        public partial Result GetVulkanDeviceExtension([Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong systemId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetVulkanInstanceExtensionsKHR")]
        public unsafe partial Result GetVulkanInstanceExtension([Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong systemId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
        ...
        /// <summary>To be documented.</summary>
        [NativeApi(EntryPoint = "xrGetVulkanInstanceExtensionsKHR")]
        public partial Result GetVulkanInstanceExtension([Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong systemId, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] ref uint bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer);
