...
namespace Silk.NET.OpenXR.Extensions.KHR
{
    ...
    public abstract unsafe partial class KhrWin32ConvertPerformanceCounterTime : NativeExtension<XR>
    {
        ...
        public abstract unsafe Result ConvertTimeToWin32PerformanceCounter([Count(Count = 0)] Instance instance, [Count(Count = 0)] long time, [Count(Count = 0)] long* performanceCounter);

        /// <summary>To be added.</summary>
        [NativeApi(EntryPoint = "xrConvertTimeToWin32PerformanceCounterKHR")]
        public abstract Result ConvertTimeToWin32PerformanceCounter([Count(Count = 0)] Instance instance, [Count(Count = 0)] long time, [Count(Count = 0)] ref long performanceCounter);

        /// <summary>To be added.</summary>
        [NativeApi(EntryPoint = "xrConvertWin32PerformanceCounterToTimeKHR")]
        public abstract unsafe Result ConvertWin32PerformanceCounterToTime([Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] long* performanceCounter, [Count(Count = 0)] long* time);
