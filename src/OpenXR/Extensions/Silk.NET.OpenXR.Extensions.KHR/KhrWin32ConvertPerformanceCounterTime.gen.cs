...
namespace Silk.NET.OpenXR.Extensions.KHR
{
    ...
    public unsafe partial class KhrWin32ConvertPerformanceCounterTime : NativeExtension<XR>
    {
        ...
        /// <summary>To be added.</summary>
        [NativeApi(EntryPoint = "xrConvertWin32PerformanceCounterToTimeKHR")]
        public partial Result ConvertWin32PerformanceCounterToTime([Count(Count = 0)] Instance instance, [Count(Count = 0), Flow(FlowDirection.In)] ref long performanceCounter, [Count(Count = 0)] ref long time);
