...
namespace Silk.NET.OpenXR
{
    public static class XROverloads
    {
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result EnumerateInstanceExtensionProperties(this XR thisApi, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string layerName, [Count(Count = 0)] uint propertyCapacityInput, [Count(Count = 0)] uint* propertyCountOutput, [Count(Parameter = "propertyCapacityInput")] Span<ExtensionProperties> properties)
        {
            // SpanOverloader
            return thisApi.EnumerateInstanceExtensionProperties(layerName, propertyCapacityInput, propertyCountOutput, ref properties.GetPinnableReference());
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetInputSourceLocalizedName(this XR thisApi, [Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] InputSourceLocalizedNameGetInfo* getInfo, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] Span<uint> bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetInputSourceLocalizedName(session, getInfo, bufferCapacityInput, ref bufferCountOutput.GetPinnableReference(), buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetInputSourceLocalizedName(this XR thisApi, [Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<InputSourceLocalizedNameGetInfo> getInfo, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] uint* bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetInputSourceLocalizedName(session, in getInfo.GetPinnableReference(), bufferCapacityInput, bufferCountOutput, buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetInputSourceLocalizedName(this XR thisApi, [Count(Count = 0)] Session session, [Count(Count = 0), Flow(FlowDirection.In)] ReadOnlySpan<InputSourceLocalizedNameGetInfo> getInfo, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] Span<uint> bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.GetInputSourceLocalizedName(session, in getInfo.GetPinnableReference(), bufferCapacityInput, ref bufferCountOutput.GetPinnableReference(), buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result GetInstanceProcAddr(this XR thisApi, [Count(Count = 0)] Instance instance, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string name, [Count(Count = 0)] Span<PfnVoidFunction> function)
        {
            // SpanOverloader
            return thisApi.GetInstanceProcAddr(instance, name, ref function.GetPinnableReference());
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result PathToString(this XR thisApi, [Count(Count = 0)] Instance instance, [Count(Count = 0)] ulong path, [Count(Count = 0)] uint bufferCapacityInput, [Count(Count = 0)] Span<uint> bufferCountOutput, [UnmanagedType(UnmanagedType.LPUTF8Str)] string buffer)
        {
            // SpanOverloader
            return thisApi.PathToString(instance, path, bufferCapacityInput, ref bufferCountOutput.GetPinnableReference(), buffer);
        }
        ...
        /// <summary>To be documented.</summary>
        public static unsafe Result StringToPath(this XR thisApi, [Count(Count = 0)] Instance instance, [Flow(FlowDirection.In), UnmanagedType(UnmanagedType.LPUTF8Str)] string pathString, [Count(Count = 0)] Span<ulong> path)
        {
            // SpanOverloader
            return thisApi.StringToPath(instance, pathString, ref path.GetPinnableReference());
        }
