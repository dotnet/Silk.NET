...
{
    [NativeName("Name", "XrBodySkeletonHTC")]
    public unsafe partial struct BodySkeletonHTC
    {
        public BodySkeletonHTC
        (
            StructureType? type = StructureType.TypeBodySkeletonHtc,
            void* next = null,
            uint? jointCount = null,
            BodySkeletonJointHTC* joints = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        [NativeName("Type", "XrBodySkeletonJointHTC*")]
        [NativeName("Type.Name", "XrBodySkeletonJointHTC")]
