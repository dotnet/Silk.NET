...
{
    [NativeName("Name", "XrSpatialAnchorCreateInfoHTC")]
    public unsafe partial struct SpatialAnchorCreateInfoHTC
    {
        public SpatialAnchorCreateInfoHTC
        (
            StructureType? type = StructureType.TypeSpatialAnchorCreateInfoHtc,
            void* next = null,
            Space? space = null,
            Posef? poseInSpace = null,
            SpatialAnchorNameHTC? name = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        [NativeName("Type", "XrSpatialAnchorNameHTC")]
        [NativeName("Type.Name", "XrSpatialAnchorNameHTC")]
