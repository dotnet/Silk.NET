...
{
    [NativeName("Name", "XrFuturePollResultProgressBD")]
    public unsafe partial struct FuturePollResultProgressBD
    {
        public FuturePollResultProgressBD
        (
            StructureType? type = StructureType.TypeFuturePollResultProgressBD,
            void* next = null,
            uint? isSupported = null,
            uint? progressPercentage = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        ...
        [NativeName("Name", "progressPercentage")]
