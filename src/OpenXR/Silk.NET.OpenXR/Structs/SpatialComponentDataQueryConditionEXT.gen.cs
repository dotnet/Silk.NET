...
{
    [NativeName("Name", "XrSpatialComponentDataQueryConditionEXT")]
    public unsafe partial struct SpatialComponentDataQueryConditionEXT
    {
        public SpatialComponentDataQueryConditionEXT
        (
            StructureType? type = StructureType.TypeSpatialComponentDataQueryConditionExt,
            void* next = null,
