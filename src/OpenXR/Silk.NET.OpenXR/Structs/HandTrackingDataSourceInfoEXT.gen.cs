...
{
    [NativeName("Name", "XrHandTrackingDataSourceInfoEXT")]
    public unsafe partial struct HandTrackingDataSourceInfoEXT
    {
        public HandTrackingDataSourceInfoEXT
        (
            StructureType? type = StructureType.TypeHandTrackingDataSourceInfoExt,
            void* next = null,
            uint? requestedDataSourceCount = null,
            HandTrackingDataSourceEXT* requestedDataSources = null
        ) : this()
        {
            if (type is not null)
            {
