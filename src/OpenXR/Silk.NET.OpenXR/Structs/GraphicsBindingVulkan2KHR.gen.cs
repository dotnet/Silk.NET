...
{
    [NativeName("Name", "XrGraphicsBindingVulkan2KHR")]
    [NativeName("AliasOf", "XrGraphicsBindingVulkanKHR")]
    public unsafe partial struct GraphicsBindingVulkan2KHR
    {
        public GraphicsBindingVulkan2KHR
        (
