...
{
    [NativeName("Name", "XrSpaceEraseInfoFB")]
    public unsafe partial struct SpaceEraseInfoFB
    {
        public SpaceEraseInfoFB
        (
            StructureType? type = StructureType.TypeSpaceEraseInfoFB,
            void* next = null,
            Space? space = null,
