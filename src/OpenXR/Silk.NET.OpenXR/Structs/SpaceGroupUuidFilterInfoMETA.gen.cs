...
{
    [NativeName("Name", "XrSpaceGroupUuidFilterInfoMETA")]
    public unsafe partial struct SpaceGroupUuidFilterInfoMETA
    {
        public SpaceGroupUuidFilterInfoMETA
        (
            StructureType? type = StructureType.TypeSpaceGroupUuidFilterInfoMeta,
            void* next = null,
            Uuid? groupUuid = null
        ) : this()
        {
