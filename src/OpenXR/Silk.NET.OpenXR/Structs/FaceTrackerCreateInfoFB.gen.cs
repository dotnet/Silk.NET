...
{
    [NativeName("Name", "XrFaceTrackerCreateInfoFB")]
    public unsafe partial struct FaceTrackerCreateInfoFB
    {
        public FaceTrackerCreateInfoFB
        (
            StructureType? type = StructureType.TypeFaceTrackerCreateInfoFB,
            void* next = null,
            FaceExpressionSetFB? faceExpressionSet = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        ...
        public void* Next;
/// <summary></summary>
        [NativeName("Type", "XrFaceExpressionSetFB")]
        [NativeName("Type.Name", "XrFaceExpressionSetFB")]
