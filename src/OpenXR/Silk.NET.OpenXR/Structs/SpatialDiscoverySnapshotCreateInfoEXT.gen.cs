...
{
    [NativeName("Name", "XrSpatialDiscoverySnapshotCreateInfoEXT")]
    public unsafe partial struct SpatialDiscoverySnapshotCreateInfoEXT
    {
        public SpatialDiscoverySnapshotCreateInfoEXT
        (
            StructureType? type = StructureType.TypeSpatialDiscoverySnapshotCreateInfoExt,
            void* next = null,
