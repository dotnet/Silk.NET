...
{
    [NativeName("Name", "XrSpatialEntityComponentDataPlaneOrientationBD")]
    public unsafe partial struct SpatialEntityComponentDataPlaneOrientationBD
    {
        ...
        (
            StructureType? type = StructureType.TypeSpatialEntityComponentDataPlaneOrientationBD,
            void* next = null,
            PlaneOrientationBD? orientation = null
        ) : this()
        {
            if (type is not null)
            {
