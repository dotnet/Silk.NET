...
{
    [NativeName("Name", "XrForceFeedbackCurlApplyLocationsMNDX")]
    public unsafe partial struct ForceFeedbackCurlApplyLocationsMNDX
    {
        public ForceFeedbackCurlApplyLocationsMNDX
        (
            StructureType? type = StructureType.TypeForceFeedbackCurlApplyLocationsMndx,
            void* next = null,
            uint? locationCount = null,
            ForceFeedbackCurlApplyLocationMNDX* locations = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        [NativeName("Type", "XrForceFeedbackCurlApplyLocationMNDX*")]
