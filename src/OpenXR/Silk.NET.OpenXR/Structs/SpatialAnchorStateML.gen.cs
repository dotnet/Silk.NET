...
{
    [NativeName("Name", "XrSpatialAnchorStateML")]
    public unsafe partial struct SpatialAnchorStateML
    {
        public SpatialAnchorStateML
        (
            StructureType? type = StructureType.TypeSpatialAnchorStateML,
            void* next = null,
            SpatialAnchorConfidenceML? confidence = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        ...
        public void* Next;
/// <summary></summary>
        [NativeName("Type", "XrSpatialAnchorConfidenceML")]
