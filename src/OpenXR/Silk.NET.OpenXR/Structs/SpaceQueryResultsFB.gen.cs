...
{
    [NativeName("Name", "XrSpaceQueryResultsFB")]
    public unsafe partial struct SpaceQueryResultsFB
    {
        public SpaceQueryResultsFB
        (
            StructureType? type = StructureType.TypeSpaceQueryResultsFB,
            void* next = null,
            uint? resultCapacityInput = null,
            uint? resultCountOutput = null,
            SpaceQueryResultFB* results = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        [NativeName("Type", "XrSpaceQueryResultFB*")]
        [NativeName("Type.Name", "XrSpaceQueryResultFB")]
        [NativeName("Name", "results")]
        public SpaceQueryResultFB* Results;
