...
{
    [NativeName("Name", "XrEventDataStopColocationAdvertisementCompleteMETA")]
    public unsafe partial struct EventDataStopColocationAdvertisementCompleteMETA
    {
        ...
        (
            StructureType? type = StructureType.TypeEventDataStopColocationAdvertisementCompleteMeta,
            void* next = null,
