...
{
    [NativeName("Name", "XrMarkerDetectorStateML")]
    public unsafe partial struct MarkerDetectorStateML
    {
        public MarkerDetectorStateML
        (
            StructureType? type = StructureType.TypeMarkerDetectorStateML,
            void* next = null,
            MarkerDetectorStatusML? state = null
        ) : this()
        {
            if (type is not null)
            {
...
/// <summary></summary>
        ...
        public void* Next;
/// <summary></summary>
        [NativeName("Type", "XrMarkerDetectorStatusML")]
