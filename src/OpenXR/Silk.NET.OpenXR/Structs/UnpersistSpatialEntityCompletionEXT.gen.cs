...
{
    [NativeName("Name", "XrUnpersistSpatialEntityCompletionEXT")]
    public unsafe partial struct UnpersistSpatialEntityCompletionEXT
    {
        ...
        (
            ...
            SpatialPersistenceContextResultEXT? unpersistResult = null
        ) : this()
        {
            if (type is not null)
            {
            ...
            if (unpersistResult is not null)
            {
                UnpersistResult = unpersistResult.Value;
            }
        }
...
/// <summary></summary>
        ...
        [NativeName("Name", "unpersistResult")]
