...
namespace Silk.NET.WebGPU.Extensions.WGPU
{
    public static class WgpuOverloads
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 235, Column 8 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 240, Column 10 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 242, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 248, Column 6 in wgpu.h")]
