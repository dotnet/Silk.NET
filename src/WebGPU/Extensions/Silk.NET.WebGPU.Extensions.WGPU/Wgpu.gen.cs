...
namespace Silk.NET.WebGPU.Extensions.WGPU
{
    ...
    public unsafe partial class Wgpu : NativeExtension<WebGPU>
    {
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 237, Column 21 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 244, Column 6 in wgpu.h")]
        [NativeApi(EntryPoint = "wgpuSetLogLevel")]
        public partial void SetLogLevel(LogLevel level);

        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 246, Column 10 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 250, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 251, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 253, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 254, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 256, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 257, Column 6 in wgpu.h")]
        ...
        /// <summary>To be documented.</summary>
        [NativeName("Src", "Line 258, Column 6 in wgpu.h")]
