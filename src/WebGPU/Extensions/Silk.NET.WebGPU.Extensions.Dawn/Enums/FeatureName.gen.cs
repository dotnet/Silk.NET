...
namespace Silk.NET.WebGPU.Extensions.Dawn
{
    ...
    public enum FeatureName : int
    {
        ...
        [Obsolete("Deprecated in favour of \"DawnShaderFloat16\"")]
        [NativeName("Name", "WGPUFeatureName_DawnShaderFloat16")]
        FeatureNameDawnShaderFloat16 = 0x3E9,
        [Obsolete("Deprecated in favour of \"DawnInternalUsages\"")]
        [NativeName("Name", "WGPUFeatureName_DawnInternalUsages")]
        FeatureNameDawnInternalUsages = 0x3EA,
        [Obsolete("Deprecated in favour of \"DawnMultiPlanarFormats\"")]
        [NativeName("Name", "WGPUFeatureName_DawnMultiPlanarFormats")]
        FeatureNameDawnMultiPlanarFormats = 0x3EB,
        [Obsolete("Deprecated in favour of \"DawnNative\"")]
        [NativeName("Name", "WGPUFeatureName_DawnNative")]
        FeatureNameDawnNative = 0x3EC,
        [Obsolete("Deprecated in favour of \"ChromiumExperimentalDp4a\"")]
        [NativeName("Name", "WGPUFeatureName_ChromiumExperimentalDp4a")]
        FeatureNameChromiumExperimentalDp4a = 0x3ED,
        [Obsolete("Deprecated in favour of \"TimestampQueryInsidePasses\"")]
        [NativeName("Name", "WGPUFeatureName_TimestampQueryInsidePasses")]
        FeatureNameTimestampQueryInsidePasses = 0x3EE,
        ...
        DawnNative = 0x3EC,
        [NativeName("Name", "WGPUFeatureName_ChromiumExperimentalDp4a")]
        ChromiumExperimentalDp4a = 0x3ED,
        [NativeName("Name", "WGPUFeatureName_TimestampQueryInsidePasses")]
        TimestampQueryInsidePasses = 0x3EE,
        [NativeName("Name", "WGPUFeatureName_Force32")]
        Force32 = 0x7FFFFFFF,
    }
}
