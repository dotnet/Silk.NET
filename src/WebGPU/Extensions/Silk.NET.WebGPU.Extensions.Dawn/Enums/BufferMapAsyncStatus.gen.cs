...
namespace Silk.NET.WebGPU.Extensions.Dawn
{
    ...
    public enum BufferMapAsyncStatus : int
    {
        ...
        Success = 0x0,
        [NativeName("Name", "WGPUBufferMapAsyncStatus_InstanceDropped")]
        InstanceDropped = 0x1,
