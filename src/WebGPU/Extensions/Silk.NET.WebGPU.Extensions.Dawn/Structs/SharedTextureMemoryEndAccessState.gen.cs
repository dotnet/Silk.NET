...
{
    [NativeName("Name", "WGPUSharedTextureMemoryEndAccessState")]
    public unsafe partial struct SharedTextureMemoryEndAccessState
    {
        public SharedTextureMemoryEndAccessState
        (
