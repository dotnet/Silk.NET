...
namespace Silk.NET.WebGPU.Extensions.Dawn
{
    ...
    public unsafe partial struct AdapterProperties
    {
        ...
        (
            ...
            Silk.NET.Core.Bool32? compatibilityMode = null
        ) : this()
        {
            ...
            if (compatibilityMode is not null)
            {
        ...
        [NativeName("Name", "compatibilityMode")]
        public Silk.NET.Core.Bool32 CompatibilityMode;
    }
}
