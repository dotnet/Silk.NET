...
{
    [NativeName("Name", "WGPUSharedBufferMemoryEndAccessState")]
    public unsafe partial struct SharedBufferMemoryEndAccessState
    {
        public SharedBufferMemoryEndAccessState
        (
