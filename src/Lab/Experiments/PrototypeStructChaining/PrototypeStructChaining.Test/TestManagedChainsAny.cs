...
public class TestManagedChainsAny
{
    ...
    {
        using var chain = ManagedChain.CreateAny<PhysicalDeviceFeatures2, DeviceCreateInfo>
        (
    ...
    public unsafe void TestManagedChainLoadAny()
    {
        ...
        using var managedChain =
            ManagedChain.LoadAny<PhysicalDeviceFeatures2, PhysicalDeviceDescriptorIndexingFeatures,
