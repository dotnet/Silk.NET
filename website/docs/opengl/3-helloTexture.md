...
![A really messed up quad!](./assets/3-helloTexture/messed-up-quad.png)
...
![Buffer reading wrong data](./assets/3-helloTexture/wrong-pointers.png)
...
![Buffer reading right data](./assets/3-helloTexture/right-pointers.png)
...
![Quad with UVs](./assets/3-helloTexture/quad-with-uvs.png)
...
![UV values](./assets/3-helloTexture/quad-with-uvs-and-numbers.png)
...
![Quad with texture](./assets/3-helloTexture/quad-with-texture.png)
...
![Quad with texture and transparency](./assets/3-helloTexture/quad-with-transparency.png)
...
![Repeat](./assets/3-helloTexture/repeat.png)

#### `TextureWrapMode.MirroredRepeat`:
Mirror the texture for each 1 texture coordinate unit.  
![Mirrored](./assets/3-helloTexture/repeatMirrored.png)

#### `TextureWrapMode.ClampToEdge`:
Returns the pixel on the respective edge of the image.  
![A weird border](./assets/3-helloTexture/clampToEdge.png)
...
![linear filter](./assets/3-helloTexture/filter_linear.png)
...
![Nearest filter](./assets/3-helloTexture/filter_nearest.png)
...
![An example of a Mipmap texture](./assets/3-helloTexture/example_mipmap.png)
...
![Mipmap usage example](./assets/3-helloTexture/mipmap_comparation.png)
