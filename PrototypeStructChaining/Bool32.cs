...
/// <summary>A 32-bit boolean.</summary>
public readonly struct Bool32
{
    /// <summary>Gets the 32-bit value for this boolean.</summary>
    ...
    /// <summary>Converts this 32-bit boolean to a managed boolean.</summary>
    ...
    public static implicit operator uint(Bool32 val)
    {
        return val.Value;
    }
    ...
    /// </summary>
    /// <param name="val">The 32-bit unsigned integer value.</param>
    public static implicit operator Bool32(uint val)
    {
        return new Bool32(val);
    }
}